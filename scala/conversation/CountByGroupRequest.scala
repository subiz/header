...
@SerialVersionUID(0L)
final case class CountByGroupRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[CountByGroupRequest] with scalapb.lenses.Updatable[CountByGroupRequest] {
    @transient
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (groupId.isDefined) { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(4, groupId.get) }
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): conversation.CountByGroupRequest = {
    ...
    def clearIntegrationId: CountByGroupRequest = copy(integrationId = None)
    def withIntegrationId(__v: _root_.scala.Predef.String): CountByGroupRequest = copy(integrationId = Option(__v))
    def getGroupId: _root_.scala.Predef.String = groupId.getOrElse("")
    def clearGroupId: CountByGroupRequest = copy(groupId = None)
    def withGroupId(__v: _root_.scala.Predef.String): CountByGroupRequest = copy(groupId = Option(__v))
    def getFrom: _root_.scala.Int = from.getOrElse(0)
    def clearFrom: CountByGroupRequest = copy(from = None)
    def withFrom(__v: _root_.scala.Int): CountByGroupRequest = copy(from = Option(__v))
    def getTo: _root_.scala.Int = to.getOrElse(0)
    def clearTo: CountByGroupRequest = copy(to = None)
    def withTo(__v: _root_.scala.Int): CountByGroupRequest = copy(to = Option(__v))
    def getRange: _root_.scala.Predef.String = range.getOrElse("")
    def clearRange: CountByGroupRequest = copy(range = None)
    def withRange(__v: _root_.scala.Predef.String): CountByGroupRequest = copy(range = Option(__v))
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 3 => integrationId.orNull
        case 4 => groupId.orNull
        case 5 => from.orNull
        case 6 => to.orNull
        case 8 => range.orNull
      }
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => groupId.map(_root_.scalapb.descriptors.PString).getOrElse(_root_.scalapb.descriptors.PEmpty)
    ...
    def companion = conversation.CountByGroupRequest
}

object CountByGroupRequest extends scalapb.GeneratedMessageCompanion[conversation.CountByGroupRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[conversation.CountByGroupRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): conversation.CountByGroupRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[conversation.CountByGroupRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ConversationProto.javaDescriptor.getMessageTypes.get(47)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ConversationProto.scalaDescriptor.messages(47)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = conversation.CountByGroupRequest(
  )
  sealed trait Range extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Range] = conversation.CountByGroupRequest.Range
  }
  ...
  object Range extends _root_.scalapb.GeneratedEnumCompanion[Range] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = conversation.CountByGroupRequest.javaDescriptor.getEnumTypes.get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = conversation.CountByGroupRequest.scalaDescriptor.enums(0)
  }
  implicit class CountByGroupRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, conversation.CountByGroupRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, conversation.CountByGroupRequest](_l) {
  ...
  final val GROUP_ID_FIELD_NUMBER = 4
