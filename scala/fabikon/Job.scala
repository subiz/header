...
final case class Job(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): fabikon.Job = {
    ...
    def companion = fabikon.Job
}

object Job extends scalapb.GeneratedMessageCompanion[fabikon.Job] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[fabikon.Job] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): fabikon.Job = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[fabikon.Job] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = FabikonProto.javaDescriptor.getMessageTypes.get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = FabikonProto.scalaDescriptor.messages(2)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = fabikon.Job(
  )
  implicit class JobLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, fabikon.Job]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, fabikon.Job](_l) {
