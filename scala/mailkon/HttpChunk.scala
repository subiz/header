...
final case class HttpChunk(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): mailkon.HttpChunk = {
      var __id = this.id
    ...
    def companion = mailkon.HttpChunk
}

object HttpChunk extends scalapb.GeneratedMessageCompanion[mailkon.HttpChunk] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[mailkon.HttpChunk] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): mailkon.HttpChunk = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[mailkon.HttpChunk] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MailkonProto.javaDescriptor.getMessageTypes.get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MailkonProto.scalaDescriptor.messages(6)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = mailkon.HttpChunk(
  )
  implicit class HttpChunkLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, mailkon.HttpChunk]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, mailkon.HttpChunk](_l) {
