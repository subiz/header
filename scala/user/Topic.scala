...
final case class Topic(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): user.Topic = {
      var __ctx = this.ctx
    ...
    def clearCtx: Topic = copy(ctx = None)
    def withCtx(__v: common.Context): Topic = copy(ctx = Option(__v))
    def getAccountId: _root_.scala.Predef.String = accountId.getOrElse("")
    def clearAccountId: Topic = copy(accountId = None)
    def withAccountId(__v: _root_.scala.Predef.String): Topic = copy(accountId = Option(__v))
    def getTopic: _root_.scala.Predef.String = topic.getOrElse("")
    def clearTopic: Topic = copy(topic = None)
    def withTopic(__v: _root_.scala.Predef.String): Topic = copy(topic = Option(__v))
    def getType: _root_.scala.Predef.String = `type`.getOrElse("")
    def clearType: Topic = copy(`type` = None)
    def withType(__v: _root_.scala.Predef.String): Topic = copy(`type` = Option(__v))
    def getUpdated: _root_.scala.Long = updated.getOrElse(0L)
    def clearUpdated: Topic = copy(updated = None)
    def withUpdated(__v: _root_.scala.Long): Topic = copy(updated = Option(__v))
    def getUnread: _root_.scala.Int = unread.getOrElse(0)
    def clearUnread: Topic = copy(unread = None)
    def withUnread(__v: _root_.scala.Int): Topic = copy(unread = Option(__v))
    ...
    def companion = user.Topic
}

object Topic extends scalapb.GeneratedMessageCompanion[user.Topic] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[user.Topic] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): user.Topic = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[user.Topic] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = user.Topic(
  )
  implicit class TopicLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, user.Topic]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, user.Topic](_l) {
