...
final case class Condition(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): user.Condition = {
    ...
    def companion = user.Condition
}

object Condition extends scalapb.GeneratedMessageCompanion[user.Condition] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[user.Condition] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): user.Condition = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[user.Condition] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = user.Condition(
  )
  sealed trait JoinOperator extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[JoinOperator] = user.Condition.JoinOperator
  }
  ...
  object JoinOperator extends _root_.scalapb.GeneratedEnumCompanion[JoinOperator] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = user.Condition.javaDescriptor.getEnumTypes.get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = user.Condition.scalaDescriptor.enums(0)
  }
  implicit class ConditionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, user.Condition]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, user.Condition](_l) {
