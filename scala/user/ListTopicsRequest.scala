...
final case class ListTopicsRequest(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (unread.isDefined) { __size += _root_.com.google.protobuf.CodedOutputStream.computeBoolSize(8, unread.get) }
      __size
    }
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): user.ListTopicsRequest = {
      var __ctx = this.ctx
    ...
    def clearCtx: ListTopicsRequest = copy(ctx = None)
    def withCtx(__v: common.Context): ListTopicsRequest = copy(ctx = Option(__v))
    def getUserId: _root_.scala.Predef.String = userId.getOrElse("")
    def clearUserId: ListTopicsRequest = copy(userId = None)
    def withUserId(__v: _root_.scala.Predef.String): ListTopicsRequest = copy(userId = Option(__v))
    def getAgentId: _root_.scala.Predef.String = agentId.getOrElse("")
    def clearAgentId: ListTopicsRequest = copy(agentId = None)
    def withAgentId(__v: _root_.scala.Predef.String): ListTopicsRequest = copy(agentId = Option(__v))
    def getAnchor: _root_.scala.Predef.String = anchor.getOrElse("")
    def clearAnchor: ListTopicsRequest = copy(anchor = None)
    def withAnchor(__v: _root_.scala.Predef.String): ListTopicsRequest = copy(anchor = Option(__v))
    def getLimit: _root_.scala.Int = limit.getOrElse(0)
    def clearLimit: ListTopicsRequest = copy(limit = None)
    def withLimit(__v: _root_.scala.Int): ListTopicsRequest = copy(limit = Option(__v))
    def getUnread: _root_.scala.Boolean = unread.getOrElse(false)
    def clearUnread: ListTopicsRequest = copy(unread = None)
    def withUnread(__v: _root_.scala.Boolean): ListTopicsRequest = copy(unread = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 8 => unread.map(_root_.scalapb.descriptors.PBoolean).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion = user.ListTopicsRequest
}

object ListTopicsRequest extends scalapb.GeneratedMessageCompanion[user.ListTopicsRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[user.ListTopicsRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): user.ListTopicsRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[user.ListTopicsRequest] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = user.ListTopicsRequest(
  )
  implicit class ListTopicsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, user.ListTopicsRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, user.ListTopicsRequest](_l) {
  ...
  final val UNREAD_FIELD_NUMBER = 8
}
