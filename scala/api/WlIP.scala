...
final case class WlIP(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[WlIP] with scalapb.lenses.Updatable[WlIP] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): api.WlIP = {
      var __ctx = this.ctx
    ...
    def clearCtx: WlIP = copy(ctx = None)
    def withCtx(__v: common.Context): WlIP = copy(ctx = Option(__v))
    def getAccountId: _root_.scala.Predef.String = accountId.getOrElse("")
    def clearAccountId: WlIP = copy(accountId = None)
    def withAccountId(__v: _root_.scala.Predef.String): WlIP = copy(accountId = Option(__v))
    def getIp: _root_.scala.Predef.String = ip.getOrElse("")
    def clearIp: WlIP = copy(ip = None)
    def withIp(__v: _root_.scala.Predef.String): WlIP = copy(ip = Option(__v))
    def getCreated: _root_.scala.Long = created.getOrElse(0L)
    def clearCreated: WlIP = copy(created = None)
    def withCreated(__v: _root_.scala.Long): WlIP = copy(created = Option(__v))
    def getBy: _root_.scala.Predef.String = by.getOrElse("")
    def clearBy: WlIP = copy(by = None)
    def withBy(__v: _root_.scala.Predef.String): WlIP = copy(by = Option(__v))
    ...
    def companion = api.WlIP
}

object WlIP extends scalapb.GeneratedMessageCompanion[api.WlIP] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[api.WlIP] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): api.WlIP = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[api.WlIP] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = api.WlIP(
  )
  implicit class WlIPLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, api.WlIP]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, api.WlIP](_l) {
