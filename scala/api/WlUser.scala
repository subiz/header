...
final case class WlUser(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[WlUser] with scalapb.lenses.Updatable[WlUser] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): api.WlUser = {
      var __ctx = this.ctx
    ...
    def clearCtx: WlUser = copy(ctx = None)
    def withCtx(__v: common.Context): WlUser = copy(ctx = Option(__v))
    def getAccountId: _root_.scala.Predef.String = accountId.getOrElse("")
    def clearAccountId: WlUser = copy(accountId = None)
    def withAccountId(__v: _root_.scala.Predef.String): WlUser = copy(accountId = Option(__v))
    def getUserId: _root_.scala.Predef.String = userId.getOrElse("")
    def clearUserId: WlUser = copy(userId = None)
    def withUserId(__v: _root_.scala.Predef.String): WlUser = copy(userId = Option(__v))
    def getCreated: _root_.scala.Long = created.getOrElse(0L)
    def clearCreated: WlUser = copy(created = None)
    def withCreated(__v: _root_.scala.Long): WlUser = copy(created = Option(__v))
    def getBy: _root_.scala.Predef.String = by.getOrElse("")
    def clearBy: WlUser = copy(by = None)
    def withBy(__v: _root_.scala.Predef.String): WlUser = copy(by = Option(__v))
    ...
    def companion = api.WlUser
}

object WlUser extends scalapb.GeneratedMessageCompanion[api.WlUser] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[api.WlUser] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): api.WlUser = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[api.WlUser] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = api.WlUser(
  )
  implicit class WlUserLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, api.WlUser]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, api.WlUser](_l) {
