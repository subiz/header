...
type Device_AdsNetwork int32

const (
	Device_google_adwords Device_AdsNetwork = 0
)

// Enum value maps for Device_AdsNetwork.
var (
	Device_AdsNetwork_name = map[int32]string{
		0: "google_adwords",
	}
	Device_AdsNetwork_value = map[string]int32{
		"google_adwords": 0,
	}
)

func (x Device_AdsNetwork) Enum() *Device_AdsNetwork {
	p := new(Device_AdsNetwork)
	*p = x
	return p
}

func (x Device_AdsNetwork) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Device_AdsNetwork) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[2].Descriptor()
}

func (Device_AdsNetwork) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[2]
}

func (x Device_AdsNetwork) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Device_AdsNetwork.Descriptor instead.
func (Device_AdsNetwork) EnumDescriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{1, 1}
}

type Device_Source int32

const (
	Device_direct      Device_Source = 0
	Device_referring   Device_Source = 1
	Device_organic     Device_Source = 2
	Device_social      Device_Source = 3
	Device_advertising Device_Source = 4
)

// Enum value maps for Device_Source.
var (
	Device_Source_name = map[int32]string{
		0: "direct",
		1: "referring",
		2: "organic",
		3: "social",
	...
	Device_Source_value = map[string]int32{
		"direct":      0,
		"referring":   1,
		"organic":     2,
		"social":      3,
...
func (x Device_Source) Enum() *Device_Source {
	p := new(Device_Source)
	*p = x
	return p
}

func (x Device_Source) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Device_Source) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[3].Descriptor()
}

func (Device_Source) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[3]
}

func (x Device_Source) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Device_Source.Descriptor instead.
func (Device_Source) EnumDescriptor() ([]byte, []int) {
...
type Device struct {
	...
	Referrer         string   `protobuf:"bytes,8,opt,name=referrer,proto3" json:"referrer,omitempty"` //hash
	...
	AdsNetwork       string   `protobuf:"bytes,33,opt,name=ads_network,json=adsNetwork,proto3" json:"ads_network,omitempty"`
...
type By struct {
	...
	ProfileId     string  `protobuf:"bytes,10,opt,name=profile_id,json=profileId,proto3" json:"profile_id,omitempty"`      // only used if type = user
	Channel       string  `protobuf:"bytes,11,opt,name=channel,proto3" json:"channel,omitempty"`
	ChannelSource string  `protobuf:"bytes,12,opt,name=channel_source,json=channelSource,proto3" json:"channel_source,omitempty"`
}
...
func (x *By) GetChannelSource() string {
	if x != nil {
...
var file_common_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x9e, 0x07, 0x0a, 0x06, 0x44, 0x65, 0x76,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1b,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28,
	...
	,
	...
	0x62, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x20, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0b, 0x62, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	0x1f, 0x0a, 0x0b, 0x61, 0x64, 0x73, 0x5f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x18, 0x21,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x64, 0x73, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x22, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x3e, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	0x72, 0x74, 0x69, 0x73, 0x69, 0x6e, 0x67, 0x10, 0x04, 0x22, 0x8f, 0x02, 0x0a, 0x02, 0x42, 0x79,
	...
	0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70,
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xe2, 0x01, 0x0a, 0x0a,
	...
	,
...
var file_common_proto_goTypes = []interface{}{
	...
	(Device_AdsNetwork)(0), // 2: common.Device.AdsNetwork
	(Device_Source)(0),     // 3: common.Device.Source
...
var file_common_proto_depIdxs = []int32{
	...
	5, // 2: common.By.device:type_name -> common.Device
