...
var file_bot_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x6f, 0x10, 0x03, 0x2a, 0x38, 0x0a, 0x0b, 0x42, 0x6f, 0x74, 0x43, 0x61, 0x74, 0x65,
...
var file_bot_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_bot_proto_goTypes = []interface{}{
	...
	(*conversation.Message)(nil),     // 27: conversation.Message
	(*common.I18NText)(nil),          // 28: common.I18nText
	(*common.NumberParams)(nil),      // 29: common.NumberParams
	(*common.StringParams)(nil),      // 30: common.StringParams
}
var file_bot_proto_depIdxs = []int32{
	26, // 0: bot.BotRequest.ctx:type_name -> common.Context
	...
	26, // 4: bot.Bot.ctx:type_name -> common.Context
	...
	26, // 8: bot.Bots.ctx:type_name -> common.Context
	...
	27, // 23: bot.ActionAskQuestion.messages:type_name -> conversation.Message
	28, // 24: bot.ActionAskQuestion.validation_error_message:type_name -> common.I18nText
	27, // 25: bot.ActionSendMessage.messages:type_name -> conversation.Message
	25, // 26: bot.Condition.conditions:type_name -> bot.Condition
	29, // 27: bot.Condition.number:type_name -> common.NumberParams
	30, // 28: bot.Condition.string:type_name -> common.StringParams
