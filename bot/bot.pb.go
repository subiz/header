...
var file_bot_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x6f, 0x10, 0x03, 0x22, 0x87, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63,
...
var file_bot_proto_goTypes = []interface{}{
	...
	(*conversation.Message)(nil),     // 33: conversation.Message
	(*common.I18NText)(nil),          // 34: common.I18nText
	(*common.NumberParams)(nil),      // 35: common.NumberParams
	(*common.StringParams)(nil),      // 36: common.StringParams
}
var file_bot_proto_depIdxs = []int32{
	...
	33, // 23: bot.ActionAskQuestion.messages:type_name -> conversation.Message
	34, // 24: bot.ActionAskQuestion.validation_error_message:type_name -> common.I18nText
	33, // 25: bot.ActionSendMessage.messages:type_name -> conversation.Message
	25, // 26: bot.Condition.conditions:type_name -> bot.Condition
	35, // 27: bot.Condition.number:type_name -> common.NumberParams
	36, // 28: bot.Condition.string:type_name -> common.StringParams
	26, // 29: bot.Metric.submetrics:type_name -> bot.Metric
	26, // 30: bot.ReportBotResponse.metrics:type_name -> bot.Metric
	29, // 31: bot.ListObjectsResponse.list:type_name -> bot.ListObjectId
