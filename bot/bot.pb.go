...
func (x *Metric) GetObjectIds() []string {
	if x != nil {
		return x.ObjectIds
	}
	return nil
...
func (x *ListObjectsResponse) GetMetrics() []*Metric {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_bot_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x6f, 0x10, 0x03, 0x22, 0x79, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x64, 0x61, 0x79, 0x54, 0x6f, 0x22, 0x3a, 0x0a, 0x11,
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x25, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x62, 0x6f, 0x74, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x52,
	0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0x7c, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74,
	...
	0x05, 0x64, 0x61, 0x79, 0x54, 0x6f, 0x22, 0x3c, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a,
	...
	0x72, 0x69, 0x63, 0x73, 0x2a, 0x38, 0x0a, 0x0b, 0x42, 0x6f, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67,
...
var file_bot_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_bot_proto_goTypes = []interface{}{
	...
	(*ListObjectsRequest)(nil),       // 29: bot.ListObjectsRequest
	(*ListObjectsResponse)(nil),      // 30: bot.ListObjectsResponse
	(*common.Context)(nil),           // 31: common.Context
	(*conversation.Message)(nil),     // 32: conversation.Message
	(*common.I18NText)(nil),          // 33: common.I18nText
	(*common.NumberParams)(nil),      // 34: common.NumberParams
	(*common.StringParams)(nil),      // 35: common.StringParams
}
var file_bot_proto_depIdxs = []int32{
	31, // 0: bot.BotRequest.ctx:type_name -> common.Context
	...
	31, // 4: bot.Bot.ctx:type_name -> common.Context
	...
	31, // 8: bot.Bots.ctx:type_name -> common.Context
	...
	32, // 23: bot.ActionAskQuestion.messages:type_name -> conversation.Message
	33, // 24: bot.ActionAskQuestion.validation_error_message:type_name -> common.I18nText
	32, // 25: bot.ActionSendMessage.messages:type_name -> conversation.Message
	25, // 26: bot.Condition.conditions:type_name -> bot.Condition
	34, // 27: bot.Condition.number:type_name -> common.NumberParams
	35, // 28: bot.Condition.string:type_name -> common.StringParams
	26, // 29: bot.ReportBotResponse.metrics:type_name -> bot.Metric
	26, // 30: bot.ListObjectsResponse.metrics:type_name -> bot.Metric
