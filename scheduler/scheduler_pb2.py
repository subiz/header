...
_TASK = _descriptor.Descriptor(
  name='Task',
  full_name='scheduler.Task',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='scheduler.Task.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='callback_time', full_name='scheduler.Task.callback_time', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='topic', full_name='scheduler.Task.topic', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='scheduler.Task.data', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='key', full_name='scheduler.Task.key', index=4,
