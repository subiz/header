...
type Task struct {
	...
	Called int64  `protobuf:"varint,8,opt,name=called" json:"called,omitempty"`
	Sec    int64  `protobuf:"varint,9,opt,name=sec" json:"sec,omitempty"`
	Par    string `protobuf:"bytes,10,opt,name=par" json:"par,omitempty"`
}
