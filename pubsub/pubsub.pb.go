...
func (Event) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_e6bdd07165a6d1b5, []int{0}
}
...
func (*PublishMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_pubsub_e6bdd07165a6d1b5, []int{1}
}
...
func (dst *PublishMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PublishMessage.Merge(dst, src)
}
...
func init() { proto.RegisterFile("pubsub/pubsub.proto", fileDescriptor_pubsub_e6bdd07165a6d1b5) }

var fileDescriptor_pubsub_e6bdd07165a6d1b5 = []byte{
