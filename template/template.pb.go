...
func (Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_template_524ce96d62eb9614, []int{0}
}
...
func (*EmailTemplate) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_524ce96d62eb9614, []int{1}
}
...
func (dst *EmailTemplate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EmailTemplate.Merge(dst, src)
}
...
func (*WebPushTemplate) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_524ce96d62eb9614, []int{2}
}
...
func (dst *WebPushTemplate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WebPushTemplate.Merge(dst, src)
}
...
func (*NotificationTemplate) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_524ce96d62eb9614, []int{3}
}
...
func (dst *NotificationTemplate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotificationTemplate.Merge(dst, src)
}
...
func init() { proto.RegisterFile("template/template.proto", fileDescriptor_template_524ce96d62eb9614) }

var fileDescriptor_template_524ce96d62eb9614 = []byte{
