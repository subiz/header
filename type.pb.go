...
type FloatCondition struct {
	...
	EqVar      []float64         `protobuf:"fixed64,15,rep,packed,name=eq_var,json=eqVar,proto3" json:"eq_var,omitempty"`
	NeqVar     []float64         `protobuf:"fixed64,16,rep,packed,name=neq_var,json=neqVar,proto3" json:"neq_var,omitempty"`
	GtVar      float64           `protobuf:"fixed64,17,opt,name=gt_var,json=gtVar,proto3" json:"gt_var,omitempty"`
	GteVar     float64           `protobuf:"fixed64,18,opt,name=gte_var,json=gteVar,proto3" json:"gte_var,omitempty"`
	LtVar      float64           `protobuf:"fixed64,19,opt,name=lt_var,json=ltVar,proto3" json:"lt_var,omitempty"`
	LteVar     float64           `protobuf:"fixed64,20,opt,name=lte_var,json=lteVar,proto3" json:"lte_var,omitempty"`
}
...
func (x *FloatCondition) GetEqVar() []float64 {
	if x != nil {
		return x.EqVar
	}
	return nil
...
func (x *FloatCondition) GetNeqVar() []float64 {
	if x != nil {
		return x.NeqVar
	}
	return nil
...
func (x *FloatCondition) GetGtVar() float64 {
	if x != nil {
		return x.GtVar
	}
	return 0
...
func (x *FloatCondition) GetGteVar() float64 {
	if x != nil {
		return x.GteVar
	}
	return 0
...
func (x *FloatCondition) GetLtVar() float64 {
	if x != nil {
		return x.LtVar
	}
	return 0
...
func (x *FloatCondition) GetLteVar() float64 {
	if x != nil {
		return x.LteVar
	}
	return 0
...
var file_type_proto_rawDesc = []byte{
	...
	,
	...
	0x2a, 0x0a, 0x0c, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x65, 0x6e, 0x10, 0xad, 0x01, 0x12, 0x1f, 0x0a, 0x1a, 0x63,
	...
	0x6c, 0x65, 0x74, 0x65, 0x64, 0x10, 0xbf, 0x02, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68,
