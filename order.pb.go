...
type Product struct {
	...
	Handle      string          `protobuf:"bytes,4,opt,name=handle,proto3" json:"handle,omitempty"` // iphone-6-plus
	Vendor      string          `protobuf:"bytes,5,opt,name=vendor,proto3" json:"vendor,omitempty"` // brand name
	...
	Name        string          `protobuf:"bytes,8,opt,name=name,proto3" json:"name,omitempty"` // apple Ipone 6 plus
...
var file_order_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x12, 0x16,
