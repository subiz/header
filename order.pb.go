...
type OrderItem struct {
	...
	DerivedPrice          int64    `protobuf:"varint,19,opt,name=derived_price,json=derivedPrice,proto3" json:"derived_price,omitempty"`
	...
	DerivedDiscountAmount int64    `protobuf:"varint,21,opt,name=derived_discount_amount,json=derivedDiscountAmount,proto3" json:"derived_discount_amount,omitempty"`
	DiscountPercentage    float32  `protobuf:"fixed32,22,opt,name=discount_percentage,json=discountPercentage,proto3" json:"discount_percentage,omitempty"`
}
...
func (x *OrderItem) GetDerivedPrice() int64 {
	if x != nil {
		return x.DerivedPrice
	}
	return 0
}
...
func (x *OrderItem) GetDerivedDiscountAmount() int64 {
	if x != nil {
		return x.DerivedDiscountAmount
	}
	return 0
}
...
type ShippingInfo struct {
	...
	DerivedFee      int64            `protobuf:"varint,11,opt,name=derived_fee,json=derivedFee,proto3" json:"derived_fee,omitempty"`
...
func (x *ShippingInfo) GetDerivedFee() int64 {
	if x != nil {
		return x.DerivedFee
	}
	return 0
...
type Order struct {
	...
	DerivedSubtotal    int64                `protobuf:"varint,22,opt,name=derived_subtotal,json=derivedSubtotal,proto3" json:"derived_subtotal,omitempty"`
	TaxPercentage      float32              `protobuf:"fixed32,23,opt,name=tax_percentage,json=taxPercentage,proto3" json:"tax_percentage,omitempty"`
	Total              float32              `protobuf:"fixed32,24,opt,name=total,proto3" json:"total,omitempty"`
	DerivedTotal       int64                `protobuf:"varint,25,opt,name=derived_total,json=derivedTotal,proto3" json:"derived_total,omitempty"`
	PaymentMade        float32              `protobuf:"fixed32,26,opt,name=payment_made,json=paymentMade,proto3" json:"payment_made,omitempty"`
	DerivedPaymentMade int64                `protobuf:"varint,27,opt,name=derived_payment_made,json=derivedPaymentMade,proto3" json:"derived_payment_made,omitempty"`
	History            []*OrderHistoryEntry `protobuf:"bytes,28,rep,name=history,proto3" json:"history,omitempty"`
	CancellationNote   string               `protobuf:"bytes,29,opt,name=cancellation_note,json=cancellationNote,proto3" json:"cancellation_note,omitempty"`
	CancellationCode   string               `protobuf:"bytes,30,opt,name=cancellation_code,json=cancellationCode,proto3" json:"cancellation_code,omitempty"` // typing_error, user_rejected
	Currency           string               `protobuf:"bytes,31,opt,name=currency,proto3" json:"currency,omitempty"`
	Deposit            float32              `protobuf:"fixed32,32,opt,name=deposit,proto3" json:"deposit,omitempty"`
	DerivedDeposit     int64                `protobuf:"varint,33,opt,name=derived_deposit,json=derivedDeposit,proto3" json:"derived_deposit,omitempty"`
}
...
func (x *Order) GetDerivedSubtotal() int64 {
	if x != nil {
		return x.DerivedSubtotal
	}
	return 0
}
...
func (x *Order) GetDerivedTotal() int64 {
	if x != nil {
		return x.DerivedTotal
	}
	return 0
}
...
func (x *Order) GetDerivedPaymentMade() int64 {
	if x != nil {
		return x.DerivedPaymentMade
	}
	return 0
}
...
func (x *Order) GetDerivedDeposit() int64 {
	if x != nil {
		return x.DerivedDeposit
	}
	return 0
}
...
type Bill struct {
	...
	DerivedAmount string          `protobuf:"bytes,9,opt,name=derived_amount,json=derivedAmount,proto3" json:"derived_amount,omitempty"`
	Created       int64           `protobuf:"varint,10,opt,name=created,proto3" json:"created,omitempty"`
	Description   string          `protobuf:"bytes,11,opt,name=description,proto3" json:"description,omitempty"`
	PictureUrl    string          `protobuf:"bytes,12,opt,name=picture_url,json=pictureUrl,proto3" json:"picture_url,omitempty"`
}
...
func (x *Bill) GetDerivedAmount() string {
	if x != nil {
		return x.DerivedAmount
	}
	return ""
}
...
type Product struct {
	...
	Images           []string `protobuf:"bytes,27,rep,name=images,proto3" json:"images,omitempty"`                                             // (shared)
	AdditionalImages []string `protobuf:"bytes,28,rep,name=additional_images,json=additionalImages,proto3" json:"additional_images,omitempty"` // (shared)
	Videos           []string `protobuf:"bytes,29,rep,name=videos,proto3" json:"videos,omitempty"`                                             // (shared)
	AdditionalVideos []string `protobuf:"bytes,30,rep,name=additional_videos,json=additionalVideos,proto3" json:"additional_videos,omitempty"` // (shared)
	Image            string   `protobuf:"bytes,60,opt,name=image,proto3" json:"image,omitempty"`
	Note             string   `protobuf:"bytes,31,opt,name=note,proto3" json:"note,omitempty"` // (shared)
	// shipping
	...
	Taxable          bool         `protobuf:"varint,41,opt,name=taxable,proto3" json:"taxable,omitempty"`                                   // (shared)
	TaxPercentage    float32      `protobuf:"fixed32,58,opt,name=tax_percentage,json=taxPercentage,proto3" json:"tax_percentage,omitempty"` // (shared)
	Condition        string       `protobuf:"bytes,42,opt,name=condition,proto3" json:"condition,omitempty"`                                // (shared) new, refurbished, used
	Visibility       string       `protobuf:"bytes,43,opt,name=visibility,proto3" json:"visibility,omitempty"`                              // (shared) published, staging, hidden, deleted
	...
	DerivedPrice     int64        `protobuf:"varint,59,opt,name=derived_price,json=derivedPrice,proto3" json:"derived_price,omitempty"`
	SalePrice        float32      `protobuf:"fixed32,52,opt,name=sale_price,json=salePrice,proto3" json:"sale_price,omitempty"`  // (deprecated)
	PriceRules       []*PriceRule `protobuf:"bytes,53,rep,name=price_rules,json=priceRules,proto3" json:"price_rules,omitempty"` // (shared)
...
func (x *Product) GetDerivedPrice() int64 {
	if x != nil {
		return x.DerivedPrice
	}
	return 0
...
type ProductsRequest struct {
	...
	Anchor       string          `protobuf:"bytes,5,opt,name=anchor,proto3" json:"anchor,omitempty"`
	SalePriceGte int64           `protobuf:"varint,6,opt,name=sale_price_gte,json=salePriceGte,proto3" json:"sale_price_gte,omitempty"`
	SalePriceLte int64           `protobuf:"varint,7,opt,name=sale_price_lte,json=salePriceLte,proto3" json:"sale_price_lte,omitempty"`
...
func (x *ProductsRequest) GetSalePriceGte() int64 {
	if x != nil {
		return x.SalePriceGte
	}
	return 0
}

func (x *ProductsRequest) GetSalePriceLte() int64 {
	if x != nil {
		return x.SalePriceLte
	}
	return 0
}
...
var file_order_proto_rawDesc = []byte{
	...
	0x22, 0xd1, 0x03, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x19,
	...
	,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x77, 0x61, 0x72, 0x64, 0x12, 0x1a, 0x0a, 0x08,
	0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x75,
	0x6c, 0x6c, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x66, 0x75, 0x6c, 0x6c, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x18, 0x0a,
	...
	0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	...
	0x20, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x10,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x22, 0xe4, 0x01, 0x0a, 0x0c, 0x53, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x49, 0x6e,
	...
	0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x66, 0x65, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x03, 0x66, 0x65, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64, 0x5f,
	0x66, 0x65, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x64, 0x65, 0x72, 0x69, 0x76,
	0x65, 0x64, 0x46, 0x65, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x74, 0x61, 0x78, 0x5f, 0x69, 0x6e, 0x63,
	0x6c, 0x75, 0x64, 0x65, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x74, 0x61, 0x78,
	0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x22, 0x47, 0x0a, 0x0b, 0x50, 0x61, 0x79, 0x6d,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x22, 0xed, 0x01, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52,
	...
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x12, 0x1d, 0x0a, 0x0a,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x74, 0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x54, 0x6f, 0x12, 0x27, 0x0a, 0x0f, 0x69,
	...
	0x65, 0x74, 0x65, 0x64, 0x22, 0xc8, 0x07, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x21,
	...
	,
	...
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x72, 0x69, 0x76, 0x65,
	0x64, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d,
	0x64, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a,
	...
	0x74, 0x75, 0x72, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x70, 0x69, 0x63, 0x74, 0x75, 0x72, 0x65, 0x55, 0x72, 0x6c, 0x22, 0x87, 0x01, 0x0a, 0x11, 0x4f,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x62, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79,
	...
	0x74, 0x65, 0x12, 0x20, 0x0a, 0x04, 0x62, 0x69, 0x6c, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0c, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x52, 0x04,
	0x62, 0x69, 0x6c, 0x6c, 0x22, 0xc4, 0x0d, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x49, 0x64, 0x12, 0x36, 0x0a, 0x0e, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x5f, 0x76, 0x61, 0x72, 0x69,
	0x61, 0x6e, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x0d, 0x6f, 0x74, 0x68,
	0x65, 0x72, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x28, 0x0a, 0x10, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x05,
	...
	,
	...
	0x12, 0x3f, 0x0a, 0x11, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x68, 0x65,
	...
	0x6e, 0x12, 0x20, 0x0a, 0x05, 0x70, 0x72, 0x6f, 0x70, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b,
	...
	0x72, 0x61, 0x6e, 0x64, 0x12, 0x2f, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18,
	0x13, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x50,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x65, 0x18, 0x33, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x12, 0x23, 0x0a, 0x0d, 0x64, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64, 0x5f, 0x70, 0x72, 0x69, 0x63,
	0x65, 0x18, 0x3b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x64, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64,
	0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x61, 0x6c, 0x65, 0x5f, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x18, 0x34, 0x20, 0x01, 0x28, 0x02, 0x52, 0x09, 0x73, 0x61, 0x6c, 0x65, 0x50,
	0x72, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x0b, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x72, 0x75,
	0x6c, 0x65, 0x73, 0x18, 0x35, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x68, 0x65, 0x61, 0x64,
	...
	0x6b, 0x18, 0x36, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x1b,
	0x0a, 0x09, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x37, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x0d, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03,
	...
	0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x88, 0x01, 0x0a, 0x08, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x21, 0x0a, 0x03, 0x63, 0x74, 0x78, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f,
	0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x03, 0x63, 0x74, 0x78, 0x12, 0x2b, 0x0a, 0x08, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x08, 0x70,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x2a, 0x0a, 0x16, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x53,
	0x68, 0x65, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65, 0x65, 0x64, 0x12,
	0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72,
	0x6c, 0x22, 0x1a, 0x0a, 0x18, 0x57, 0x65, 0x62, 0x73, 0x69, 0x74, 0x65, 0x4a, 0x53, 0x4f, 0x4e,
	0x4c, 0x64, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65, 0x65, 0x64, 0x22, 0x36, 0x0a,
	0x11, 0x53, 0x68, 0x6f, 0x70, 0x65, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65,
	...
	,
	...
	0x22, 0xfe, 0x04, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65, 0x65, 0x64,
	0x12, 0x21, 0x0a, 0x03, 0x63, 0x74, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x03,
	0x63, 0x74, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6e, 0x63, 0x68, 0x6f, 0x72, 0x12, 0x24, 0x0a, 0x0e, 0x73,
	0x61, 0x6c, 0x65, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x67, 0x74, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0c, 0x73, 0x61, 0x6c, 0x65, 0x50, 0x72, 0x69, 0x63, 0x65, 0x47, 0x74,
	0x65, 0x12, 0x24, 0x0a, 0x0e, 0x73, 0x61, 0x6c, 0x65, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f,
	0x6c, 0x74, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x73, 0x61, 0x6c, 0x65, 0x50,
	...
	,
	...
	0x0a, 0x0f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6e, 0x63, 0x68, 0x6f,
	...
	,
...
var file_order_proto_goTypes = []interface{}{
	...
	(*I18NString)(nil),               // 29: header.I18nString
}
var file_order_proto_depIdxs = []int32{
	...
	28, // 3: header.InventoryProduct.ctx:type_name -> common.Context
	16, // 4: header.InventoryProduct.ref_product:type_name -> header.Product
	25, // 5: header.InventoryProduct.props:type_name -> header.KV
	16, // 6: header.OrderItem.product:type_name -> header.Product
	25, // 7: header.OrderItem.prop:type_name -> header.KV
	8,  // 8: header.ShippingInfo.address:type_name -> header.ShippingAddress
	28, // 9: header.Orders.ctx:type_name -> common.Context
	13, // 10: header.Orders.orders:type_name -> header.Order
	28, // 11: header.OrdersRequest.ctx:type_name -> common.Context
	28, // 12: header.Order.ctx:type_name -> common.Context
	9,  // 13: header.Order.shipping:type_name -> header.ShippingInfo
	10, // 14: header.Order.payment:type_name -> header.PaymentInfo
	7,  // 15: header.Order.items:type_name -> header.OrderItem
	15, // 16: header.Order.history:type_name -> header.OrderHistoryEntry
	28, // 17: header.Bill.ctx:type_name -> common.Context
	14, // 18: header.OrderHistoryEntry.bill:type_name -> header.Bill
	28, // 19: header.Product.ctx:type_name -> common.Context
	16, // 20: header.Product.other_variants:type_name -> header.Product
	29, // 21: header.Product.name:type_name -> header.I18nString
	29, // 22: header.Product.description_quill_delta:type_name -> header.I18nString
	29, // 23: header.Product.description:type_name -> header.I18nString
	29, // 24: header.Product.short_description:type_name -> header.I18nString
	25, // 25: header.Product.props:type_name -> header.KV
	17, // 26: header.Product.options:type_name -> header.ProductOption
	5,  // 27: header.Product.price_rules:type_name -> header.PriceRule
	28, // 28: header.Products.ctx:type_name -> common.Context
	16, // 29: header.Products.products:type_name -> header.Product
	28, // 30: header.ProductFeeds.ctx:type_name -> common.Context
	23, // 31: header.ProductFeeds.product_feeds:type_name -> header.ProductFeed
	28, // 32: header.ProductFeed.ctx:type_name -> common.Context
	21, // 33: header.ProductFeed.shopee:type_name -> header.ShopeeProductFeed
	20, // 34: header.ProductFeed.website_json_ld:type_name -> header.WebsiteJSONLdProductFeed
	19, // 35: header.ProductFeed.google_sheet:type_name -> header.GoogleSheetProductFeed
	28, // 36: header.ProductsRequest.ctx:type_name -> common.Context
	25, // 37: header.ProductsRequest.props:type_name -> header.KV
	25, // 38: header.KV.kvs:type_name -> header.KV
	28, // 39: header.ProductCategories.ctx:type_name -> common.Context
	28, // 40: header.ProductProps.ctx:type_name -> common.Context
	25, // 41: header.ProductProps.props:type_name -> header.KV
