...
const (
	NoteLink_conversation NoteLink_Type = 0
	NoteLink_ticket       NoteLink_Type = 1
	NoteLink_deal         NoteLink_Type = 2
	NoteLink_user         NoteLink_Type = 3
)

var NoteLink_Type_name = map[int32]string{
	0: "conversation",
	1: "ticket",
	2: "deal",
	3: "user",
...
var NoteLink_Type_value = map[string]int32{
	"conversation": 0,
	"ticket":       1,
	"deal":         2,
	"user":         3,
...
func (x NoteLink_Type) String() string {
	return proto.EnumName(NoteLink_Type_name, int32(x))
}

func (x *NoteLink_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(NoteLink_Type_value, data, "NoteLink_Type")
	if err != nil {
		return err
	}
	*x = NoteLink_Type(value)
	return nil
}
...
func (m *ListNotesRequest) GetLinks() []*NoteLink {
	if m != nil {
		return m.Links
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("user.NoteLink_Type", NoteLink_Type_name, NoteLink_Type_value)
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
