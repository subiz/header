...
var file_user3_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x10, 0x02, 0x2a, 0x27, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x50, 0x72,
...
var file_user3_proto_goTypes = []interface{}{
	...
	(*Condition)(nil),                               // 99: user.Condition
	(*SCondition)(nil),                              // 100: user.SCondition
	(*email.Email)(nil),                             // 101: email.Email
	(*conversation.Ticket)(nil),                     // 102: conversation.Ticket
	(*conversation.Member)(nil),                     // 103: conversation.Member
	(*account.Account)(nil),                         // 104: account.Account
	(*account.Agent)(nil),                           // 105: account.Agent
	(*conversation.Message)(nil),                    // 106: conversation.Message
	(*conversation.Conversation)(nil),               // 107: conversation.Conversation
	(*conversation.Postback)(nil),                   // 108: conversation.Postback
	(*content.Content)(nil),                         // 109: content.Content
	(*account.Presence)(nil),                        // 110: account.Presence
	(*notibox.Notification)(nil),                    // 111: notibox.Notification
	(*account.AgentPerm)(nil),                       // 112: account.AgentPerm
	(*account.GroupMember)(nil),                     // 113: account.GroupMember
	(*account.AgentGroup)(nil),                      // 114: account.AgentGroup
	(*payment.Limit)(nil),                           // 115: payment.Limit
	(*notibox.Notibox)(nil),                         // 116: notibox.Notibox
	(*noti5.Setting)(nil),                           // 117: noti5.Setting
	(*conversation.Rule)(nil),                       // 118: conversation.Rule
	(*conversation.Tag)(nil),                        // 119: conversation.Tag
}
var file_user3_proto_depIdxs = []int32{
	...
	99,  // 79: user.Automation.conditions:type_name -> user.Condition
	100, // 80: user.Automation.condition:type_name -> user.SCondition
	80,  // 81: user.Automation.actions:type_name -> user.AutomationAction
	20,  // 82: user.AutomationAction.user:type_name -> user.User
	101, // 83: user.AutomationAction.email:type_name -> email.Email
	49,  // 84: user.AutomationAction.user_note:type_name -> user.Note
	71,  // 85: user.AutomationAction.event:type_name -> user.Event
	71,  // 86: user.AutomationAction.events:type_name -> user.Event
	102, // 87: user.AutomationAction.ticket:type_name -> conversation.Ticket
	81,  // 88: user.AutomationAction.webhook_setting:type_name -> user.AutomationWebhookSetting
	96,  // 89: user.Automations.ctx:type_name -> common.Context
	79,  // 90: user.Automations.automations:type_name -> user.Automation
	96,  // 91: user.AutomationCreditsAggregate.ctx:type_name -> common.Context
	96,  // 92: user.AutomationCredit.ctx:type_name -> common.Context
	96,  // 93: user.Topic.ctx:type_name -> common.Context
	71,  // 94: user.Topic.by_event:type_name -> user.Event
	96,  // 95: user.UnreadTopic.ctx:type_name -> common.Context
	71,  // 96: user.UnreadTopic.by_event:type_name -> user.Event
	96,  // 97: user.ListTopicsRequest.ctx:type_name -> common.Context
	96,  // 98: user.ListTopicsResult.ctx:type_name -> common.Context
	86,  // 99: user.ListTopicsResult.topics:type_name -> user.Topic
	96,  // 100: user.UserSession.ctx:type_name -> common.Context
	71,  // 101: user.UserSession.start_event:type_name -> user.Event
	71,  // 102: user.UserSession.latest_event:type_name -> user.Event
	22,  // 103: user.UserSession.campaigns:type_name -> user.Campaign
	71,  // 104: user.UserSession.latest_content_view:type_name -> user.Event
	96,  // 105: user.AvailabilityCheckRequest.ctx:type_name -> common.Context
	20,  // 106: user.AvailabilityCheckRequest.user:type_name -> user.User
	96,  // 107: user.AvailabilityCheckResult.ctx:type_name -> common.Context
	96,  // 108: user.StartRequest.ctx:type_name -> common.Context
	20,  // 109: user.StartRequest.user:type_name -> user.User
	103, // 110: user.StartRequest.members:type_name -> conversation.Member
	104, // 111: user.Event.Data.account:type_name -> account.Account
	105, // 112: user.Event.Data.agent:type_name -> account.Agent
	106, // 113: user.Event.Data.message:type_name -> conversation.Message
	107, // 114: user.Event.Data.conversation:type_name -> conversation.Conversation
	108, // 115: user.Event.Data.postback:type_name -> conversation.Postback
	109, // 116: user.Event.Data.content:type_name -> content.Content
	86,  // 117: user.Event.Data.topic:type_name -> user.Topic
	110, // 118: user.Event.Data.presence:type_name -> account.Presence
	20,  // 119: user.Event.Data.user:type_name -> user.User
	87,  // 120: user.Event.Data.unread_topic:type_name -> user.UnreadTopic
	111, // 121: user.Event.Data.notification:type_name -> notibox.Notification
	112, // 122: user.Event.Data.agent_perm:type_name -> account.AgentPerm
	113, // 123: user.Event.Data.group_member:type_name -> account.GroupMember
	114, // 124: user.Event.Data.group:type_name -> account.AgentGroup
	115, // 125: user.Event.Data.limit:type_name -> payment.Limit
	48,  // 126: user.Event.Data.alias:type_name -> user.Identification
	49,  // 127: user.Event.Data.note:type_name -> user.Note
	102, // 128: user.Event.Data.ticket:type_name -> conversation.Ticket
	79,  // 129: user.Event.Data.automation:type_name -> user.Automation
	71,  // 130: user.Event.Data.event:type_name -> user.Event
	78,  // 131: user.Event.Data.automation_event:type_name -> user.AutomationEvent
	116, // 132: user.Event.Data.notibox:type_name -> notibox.Notibox
	117, // 133: user.Event.Data.notification_setting:type_name -> noti5.Setting
	48,  // 134: user.Event.Data.identification:type_name -> user.Identification
	118, // 135: user.Event.Data.rule:type_name -> conversation.Rule
	44,  // 136: user.Event.Data.user_attribute:type_name -> user.AttributeDefinition
	119, // 137: user.Event.Data.tag:type_name -> conversation.Tag
	64,  // 138: user.Event.Data.total_user:type_name -> user.UserMetric
