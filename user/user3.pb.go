...
func (UserSession_DeviceType) EnumDescriptor() ([]byte, []int) {
	return file_user3_proto_rawDescGZIP(), []int{59, 0}
}
...
func (UserSession_AdsNetwork) EnumDescriptor() ([]byte, []int) {
	return file_user3_proto_rawDescGZIP(), []int{59, 1}
}
...
func (UserSession_Source) EnumDescriptor() ([]byte, []int) {
	return file_user3_proto_rawDescGZIP(), []int{59, 2}
}
...
var file_user3_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x22, 0x94, 0x0a, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x73,
	...
	0x75, 0x73, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x2a, 0x42, 0x0a, 0x08, 0x48,
...
var file_user3_proto_goTypes = []interface{}{
	...
	(*UserSession)(nil),                    // 72: user.UserSession
	(*AvailabilityCheckRequest)(nil),       // 73: user.AvailabilityCheckRequest
	(*AvailabilityCheckResult)(nil),        // 74: user.AvailabilityCheckResult
	(*StartRequest)(nil),                   // 75: user.StartRequest
	(*PresencesRequest)(nil),               // 76: user.PresencesRequest
	(*PresencesResponse)(nil),              // 77: user.PresencesResponse
...
var file_user3_proto_depIdxs = []int32{
	...
	72,  // 2: user.User.session:type_name -> user.UserSession
	...
	80,  // 10: user.ReadTopicRequest.ctx:type_name -> common.Context
	80,  // 11: user.DeleteAttrRequest.ctx:type_name -> common.Context
	80,  // 12: user.AttributeDefinition.ctx:type_name -> common.Context
	80,  // 13: user.AttributeDefinitions.ctx:type_name -> common.Context
	26,  // 14: user.AttributeDefinitions.attributes:type_name -> user.AttributeDefinition
	80,  // 15: user.Identification.ctx:type_name -> common.Context
	80,  // 16: user.Note.ctx:type_name -> common.Context
	31,  // 17: user.Note.links:type_name -> user.NoteLink
	80,  // 18: user.Notes.ctx:type_name -> common.Context
	30,  // 19: user.Notes.notes:type_name -> user.Note
	80,  // 20: user.ListNotesRequest.ctx:type_name -> common.Context
	31,  // 21: user.ListNotesRequest.links:type_name -> user.NoteLink
	40,  // 22: user.Locations.locations:type_name -> user.Location
	81,  // 23: user.Locations.errors:type_name -> common.Error
	...
	80,  // 49: user.Events.ctx:type_name -> common.Context
	57,  // 50: user.Events.events:type_name -> user.Event
	80,  // 51: user.Event.ctx:type_name -> common.Context
	82,  // 52: user.Event.by:type_name -> common.By
	79,  // 53: user.Event.data:type_name -> user.Event.Data
	80,  // 54: user.ListEventsRequest.ctx:type_name -> common.Context
	80,  // 55: user.UserEvent.ctx:type_name -> common.Context
	57,  // 56: user.UserEvent.event:type_name -> user.Event
	14,  // 57: user.UserEvent.user:type_name -> user.User
	80,  // 58: user.AutomationCalledback.ctx:type_name -> common.Context
	...
	80,  // 61: user.AutomationEvent.ctx:type_name -> common.Context
	...
	80,  // 66: user.Automation.ctx:type_name -> common.Context
	83,  // 67: user.Automation.condition:type_name -> user.SCondition
	64,  // 68: user.Automation.actions:type_name -> user.AutomationAction
	14,  // 69: user.AutomationAction.user:type_name -> user.User
	84,  // 70: user.AutomationAction.email:type_name -> email.Email
	...
	85,  // 74: user.AutomationAction.ticket:type_name -> conversation.Ticket
	65,  // 75: user.AutomationAction.webhook_setting:type_name -> user.AutomationWebhookSetting
	80,  // 76: user.Automations.ctx:type_name -> common.Context
	63,  // 77: user.Automations.automations:type_name -> user.Automation
	80,  // 78: user.AutomationCreditsAggregate.ctx:type_name -> common.Context
	80,  // 79: user.AutomationCredit.ctx:type_name -> common.Context
	80,  // 80: user.Topic.ctx:type_name -> common.Context
	57,  // 81: user.Topic.by_event:type_name -> user.Event
	80,  // 82: user.UnreadTopic.ctx:type_name -> common.Context
	57,  // 83: user.UnreadTopic.by_event:type_name -> user.Event
	80,  // 84: user.UserSession.ctx:type_name -> common.Context
	57,  // 85: user.UserSession.start_event:type_name -> user.Event
	57,  // 86: user.UserSession.latest_event:type_name -> user.Event
	16,  // 87: user.UserSession.campaigns:type_name -> user.Campaign
	57,  // 88: user.UserSession.latest_content_view:type_name -> user.Event
	80,  // 89: user.AvailabilityCheckRequest.ctx:type_name -> common.Context
	14,  // 90: user.AvailabilityCheckRequest.user:type_name -> user.User
	80,  // 91: user.AvailabilityCheckResult.ctx:type_name -> common.Context
	80,  // 92: user.StartRequest.ctx:type_name -> common.Context
	14,  // 93: user.StartRequest.user:type_name -> user.User
	86,  // 94: user.StartRequest.members:type_name -> conversation.Member
	80,  // 95: user.PresencesRequest.ctx:type_name -> common.Context
	87,  // 96: user.Event.Data.account:type_name -> account.Account
	88,  // 97: user.Event.Data.agent:type_name -> account.Agent
	89,  // 98: user.Event.Data.message:type_name -> conversation.Message
	90,  // 99: user.Event.Data.conversation:type_name -> conversation.Conversation
	91,  // 100: user.Event.Data.postback:type_name -> conversation.Postback
	92,  // 101: user.Event.Data.content:type_name -> content.Content
	70,  // 102: user.Event.Data.topic:type_name -> user.Topic
	93,  // 103: user.Event.Data.presence:type_name -> account.Presence
	14,  // 104: user.Event.Data.user:type_name -> user.User
	71,  // 105: user.Event.Data.unread_topic:type_name -> user.UnreadTopic
	94,  // 106: user.Event.Data.notification:type_name -> notibox.Notification
	95,  // 107: user.Event.Data.agent_perm:type_name -> account.AgentPerm
	96,  // 108: user.Event.Data.group_member:type_name -> account.GroupMember
	97,  // 109: user.Event.Data.group:type_name -> account.AgentGroup
	98,  // 110: user.Event.Data.limit:type_name -> payment.Limit
	30,  // 111: user.Event.Data.note:type_name -> user.Note
	85,  // 112: user.Event.Data.ticket:type_name -> conversation.Ticket
	63,  // 113: user.Event.Data.automation:type_name -> user.Automation
	57,  // 114: user.Event.Data.event:type_name -> user.Event
	62,  // 115: user.Event.Data.automation_event:type_name -> user.AutomationEvent
	99,  // 116: user.Event.Data.notibox:type_name -> notibox.Notibox
	100, // 117: user.Event.Data.notification_setting:type_name -> noti5.Setting
	29,  // 118: user.Event.Data.identification:type_name -> user.Identification
	101, // 119: user.Event.Data.rule:type_name -> conversation.Rule
	26,  // 120: user.Event.Data.user_attribute:type_name -> user.AttributeDefinition
	102, // 121: user.Event.Data.tag:type_name -> conversation.Tag
	48,  // 122: user.Event.Data.total_user:type_name -> user.UserMetric
	103, // 123: user.Event.Data.bot:type_name -> bot.Bot
