...
var file_user3_proto_rawDesc = []byte{
	...
	0x64, 0x4c, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x42, 0x0a, 0x08, 0x48, 0x61,
	0x76, 0x65, 0x42, 0x65, 0x65, 0x6e, 0x12, 0x0b, 0x0a, 0x07, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77,
	0x6e, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x69, 0x6e, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x10,
	0x01, 0x12, 0x0c, 0x0a, 0x08, 0x64, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x10, 0x02, 0x12,
	0x0d, 0x0a, 0x09, 0x69, 0x6d, 0x6d, 0x75, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x10, 0x03, 0x42, 0x1e,
...
var file_user3_proto_depIdxs = []int32{
	...
	83,  // 9: user.DeleteAttrRequest.ctx:type_name -> common.Context
	83,  // 10: user.AttributeDefinition.ctx:type_name -> common.Context
	85,  // 11: user.AttributeDefinition.place_holder:type_name -> common.I18nText
	83,  // 12: user.AttributeDefinitions.ctx:type_name -> common.Context
	23,  // 13: user.AttributeDefinitions.attributes:type_name -> user.AttributeDefinition
	83,  // 14: user.Identification.ctx:type_name -> common.Context
	83,  // 15: user.Note.ctx:type_name -> common.Context
	28,  // 16: user.Note.links:type_name -> user.NoteLink
	83,  // 17: user.Notes.ctx:type_name -> common.Context
	27,  // 18: user.Notes.notes:type_name -> user.Note
	83,  // 19: user.ListNotesRequest.ctx:type_name -> common.Context
	28,  // 20: user.ListNotesRequest.links:type_name -> user.NoteLink
	37,  // 21: user.Locations.locations:type_name -> user.Location
	84,  // 22: user.Locations.errors:type_name -> common.Error
	...
	83,  // 46: user.Events.ctx:type_name -> common.Context
	53,  // 47: user.Events.events:type_name -> user.Event
	83,  // 48: user.Event.ctx:type_name -> common.Context
	86,  // 49: user.Event.by:type_name -> common.By
	82,  // 50: user.Event.data:type_name -> user.Event.Data
	83,  // 51: user.ListEventsRequest.ctx:type_name -> common.Context
	83,  // 52: user.UserEvent.ctx:type_name -> common.Context
	53,  // 53: user.UserEvent.event:type_name -> user.Event
	14,  // 54: user.UserEvent.user:type_name -> user.User
	83,  // 55: user.AutomationCalledback.ctx:type_name -> common.Context
	...
	83,  // 58: user.AutomationEvent.ctx:type_name -> common.Context
	...
	83,  // 63: user.Automation.ctx:type_name -> common.Context
	87,  // 64: user.Automation.condition:type_name -> user.SCondition
	60,  // 65: user.Automation.actions:type_name -> user.AutomationAction
	14,  // 66: user.AutomationAction.user:type_name -> user.User
	88,  // 67: user.AutomationAction.email:type_name -> email.Email
	...
	89,  // 71: user.AutomationAction.ticket:type_name -> conversation.Ticket
	61,  // 72: user.AutomationAction.webhook_setting:type_name -> user.AutomationWebhookSetting
	83,  // 73: user.Automations.ctx:type_name -> common.Context
	59,  // 74: user.Automations.automations:type_name -> user.Automation
	83,  // 75: user.AutomationCreditsAggregate.ctx:type_name -> common.Context
	83,  // 76: user.AutomationCredit.ctx:type_name -> common.Context
	83,  // 77: user.Topic.ctx:type_name -> common.Context
	53,  // 78: user.Topic.by_event:type_name -> user.Event
	83,  // 79: user.UnreadTopic.ctx:type_name -> common.Context
	53,  // 80: user.UnreadTopic.by_event:type_name -> user.Event
	83,  // 81: user.SourceTrace.ctx:type_name -> common.Context
	83,  // 82: user.UserSession.ctx:type_name -> common.Context
	...
	83,  // 88: user.AvailabilityCheckRequest.ctx:type_name -> common.Context
	14,  // 89: user.AvailabilityCheckRequest.user:type_name -> user.User
	83,  // 90: user.AvailabilityCheckResult.ctx:type_name -> common.Context
	83,  // 91: user.StartRequest.ctx:type_name -> common.Context
	14,  // 92: user.StartRequest.user:type_name -> user.User
	90,  // 93: user.StartRequest.members:type_name -> conversation.Member
	83,  // 94: user.PresencesRequest.ctx:type_name -> common.Context
	83,  // 95: user.LeadSearchRequest.ctx:type_name -> common.Context
	87,  // 96: user.LeadSearchRequest.condition:type_name -> user.SCondition
	...
	91,  // 105: user.Event.Data.account:type_name -> account.Account
	92,  // 106: user.Event.Data.agent:type_name -> account.Agent
	93,  // 107: user.Event.Data.message:type_name -> conversation.Message
	94,  // 108: user.Event.Data.conversation:type_name -> conversation.Conversation
	95,  // 109: user.Event.Data.postback:type_name -> conversation.Postback
	96,  // 110: user.Event.Data.content:type_name -> content.Content
	66,  // 111: user.Event.Data.topic:type_name -> user.Topic
	97,  // 112: user.Event.Data.presence:type_name -> account.Presence
	14,  // 113: user.Event.Data.user:type_name -> user.User
	67,  // 114: user.Event.Data.unread_topic:type_name -> user.UnreadTopic
	98,  // 115: user.Event.Data.notification:type_name -> notibox.Notification
	99,  // 116: user.Event.Data.agent_perm:type_name -> account.AgentPerm
	100, // 117: user.Event.Data.group_member:type_name -> account.GroupMember
	101, // 118: user.Event.Data.group:type_name -> account.AgentGroup
	102, // 119: user.Event.Data.limit:type_name -> payment.Limit
	27,  // 120: user.Event.Data.note:type_name -> user.Note
	89,  // 121: user.Event.Data.ticket:type_name -> conversation.Ticket
	59,  // 122: user.Event.Data.automation:type_name -> user.Automation
	53,  // 123: user.Event.Data.event:type_name -> user.Event
	58,  // 124: user.Event.Data.automation_event:type_name -> user.AutomationEvent
	103, // 125: user.Event.Data.notibox:type_name -> notibox.Notibox
	104, // 126: user.Event.Data.notification_setting:type_name -> noti5.Setting
	26,  // 127: user.Event.Data.identification:type_name -> user.Identification
	105, // 128: user.Event.Data.rule:type_name -> conversation.Rule
	23,  // 129: user.Event.Data.user_attribute:type_name -> user.AttributeDefinition
	106, // 130: user.Event.Data.tag:type_name -> conversation.Tag
	44,  // 131: user.Event.Data.total_user:type_name -> user.UserMetric
	107, // 132: user.Event.Data.bot:type_name -> bot.Bot
