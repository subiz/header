...
var file_user3_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x52, 0x09, 0x76, 0x69, 0x65, 0x77, 0x50, 0x61, 0x67, 0x65, 0x73, 0x22, 0xee,
	...
	0x69, 0x6e, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x24, 0x0a, 0x03, 0x75, 0x72, 0x6c,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22,
...
var file_user3_proto_depIdxs = []int32{
	...
	65,  // 57: user.UserInfoData.data:type_name -> user.UserInfo
	60,  // 58: user.LocationMetric.location:type_name -> user.Location
	63,  // 59: user.PageMetric.page:type_name -> user.Page
	68,  // 60: user.UserReport.total_user:type_name -> user.UserMetric
	69,  // 61: user.UserReport.top_source:type_name -> user.SourceMetric
	70,  // 62: user.UserReport.top_location:type_name -> user.LocationMetric
	71,  // 63: user.UserReport.top_page:type_name -> user.PageMetric
	69,  // 64: user.SourceMetrics.source_metrics:type_name -> user.SourceMetric
	70,  // 65: user.LocationMetrics.location_metrics:type_name -> user.LocationMetric
	71,  // 66: user.PageMetrics.page_metrics:type_name -> user.PageMetric
	103, // 67: user.RawEventCreatedPayload.ctx:type_name -> common.Context
	103, // 68: user.Events.ctx:type_name -> common.Context
	78,  // 69: user.Events.events:type_name -> user.Event
	103, // 70: user.Event.ctx:type_name -> common.Context
	105, // 71: user.Event.by:type_name -> common.By
	102, // 72: user.Event.data:type_name -> user.Event.Data
	103, // 73: user.Subscription.ctx:type_name -> common.Context
	103, // 74: user.ListEventsRequest.ctx:type_name -> common.Context
	103, // 75: user.UserEvent.ctx:type_name -> common.Context
	78,  // 76: user.UserEvent.event:type_name -> user.Event
	21,  // 77: user.UserEvent.user:type_name -> user.User
	103, // 78: user.SubscriptionResponse.ctx:type_name -> common.Context
	103, // 79: user.AutomationCalledback.ctx:type_name -> common.Context
	78,  // 80: user.AutomationCalledback.event:type_name -> user.Event
	87,  // 81: user.AutomationCalledback.action:type_name -> user.AutomationAction
	103, // 82: user.AutomationEvent.ctx:type_name -> common.Context
	86,  // 83: user.AutomationEvent.automation:type_name -> user.Automation
	21,  // 84: user.AutomationEvent.user:type_name -> user.User
	78,  // 85: user.AutomationEvent.event:type_name -> user.Event
	87,  // 86: user.AutomationEvent.action:type_name -> user.AutomationAction
	103, // 87: user.Automation.ctx:type_name -> common.Context
	106, // 88: user.Automation.conditions:type_name -> user.Condition
	107, // 89: user.Automation.condition:type_name -> user.SCondition
	87,  // 90: user.Automation.actions:type_name -> user.AutomationAction
	21,  // 91: user.AutomationAction.user:type_name -> user.User
	108, // 92: user.AutomationAction.email:type_name -> email.Email
	50,  // 93: user.AutomationAction.user_note:type_name -> user.Note
	78,  // 94: user.AutomationAction.event:type_name -> user.Event
	78,  // 95: user.AutomationAction.events:type_name -> user.Event
	109, // 96: user.AutomationAction.ticket:type_name -> conversation.Ticket
	88,  // 97: user.AutomationAction.webhook_setting:type_name -> user.AutomationWebhookSetting
	103, // 98: user.Automations.ctx:type_name -> common.Context
	86,  // 99: user.Automations.automations:type_name -> user.Automation
	103, // 100: user.AutomationCreditsAggregate.ctx:type_name -> common.Context
	103, // 101: user.AutomationCredit.ctx:type_name -> common.Context
	103, // 102: user.Topic.ctx:type_name -> common.Context
	78,  // 103: user.Topic.by_event:type_name -> user.Event
	103, // 104: user.UnreadTopic.ctx:type_name -> common.Context
	78,  // 105: user.UnreadTopic.by_event:type_name -> user.Event
	103, // 106: user.ListTopicsRequest.ctx:type_name -> common.Context
	103, // 107: user.ListTopicsResult.ctx:type_name -> common.Context
	93,  // 108: user.ListTopicsResult.topics:type_name -> user.Topic
	103, // 109: user.UserSession.ctx:type_name -> common.Context
	78,  // 110: user.UserSession.start_event:type_name -> user.Event
	78,  // 111: user.UserSession.latest_event:type_name -> user.Event
	23,  // 112: user.UserSession.campaigns:type_name -> user.Campaign
	78,  // 113: user.UserSession.latest_content_view:type_name -> user.Event
	103, // 114: user.AvailabilityCheckRequest.ctx:type_name -> common.Context
	21,  // 115: user.AvailabilityCheckRequest.user:type_name -> user.User
	103, // 116: user.AvailabilityCheckResult.ctx:type_name -> common.Context
	103, // 117: user.StartRequest.ctx:type_name -> common.Context
	21,  // 118: user.StartRequest.user:type_name -> user.User
	110, // 119: user.StartRequest.members:type_name -> conversation.Member
	111, // 120: user.Event.Data.account:type_name -> account.Account
	112, // 121: user.Event.Data.agent:type_name -> account.Agent
	113, // 122: user.Event.Data.message:type_name -> conversation.Message
	114, // 123: user.Event.Data.conversation:type_name -> conversation.Conversation
	115, // 124: user.Event.Data.postback:type_name -> conversation.Postback
	116, // 125: user.Event.Data.content:type_name -> content.Content
	93,  // 126: user.Event.Data.topic:type_name -> user.Topic
	117, // 127: user.Event.Data.presence:type_name -> account.Presence
	21,  // 128: user.Event.Data.user:type_name -> user.User
	94,  // 129: user.Event.Data.unread_topic:type_name -> user.UnreadTopic
	118, // 130: user.Event.Data.notification:type_name -> notibox.Notification
	119, // 131: user.Event.Data.agent_perm:type_name -> account.AgentPerm
	120, // 132: user.Event.Data.group_member:type_name -> account.GroupMember
	121, // 133: user.Event.Data.group:type_name -> account.AgentGroup
	122, // 134: user.Event.Data.limit:type_name -> payment.Limit
	49,  // 135: user.Event.Data.alias:type_name -> user.Identification
	50,  // 136: user.Event.Data.note:type_name -> user.Note
	109, // 137: user.Event.Data.ticket:type_name -> conversation.Ticket
	86,  // 138: user.Event.Data.automation:type_name -> user.Automation
	78,  // 139: user.Event.Data.event:type_name -> user.Event
	85,  // 140: user.Event.Data.automation_event:type_name -> user.AutomationEvent
	123, // 141: user.Event.Data.notibox:type_name -> notibox.Notibox
	124, // 142: user.Event.Data.notification_setting:type_name -> noti5.Setting
	49,  // 143: user.Event.Data.identification:type_name -> user.Identification
	125, // 144: user.Event.Data.rule:type_name -> conversation.Rule
	45,  // 145: user.Event.Data.user_attribute:type_name -> user.AttributeDefinition
	126, // 146: user.Event.Data.tag:type_name -> conversation.Tag
	68,  // 147: user.Event.Data.total_user:type_name -> user.UserMetric
