...
var file_user3_proto_rawDesc = []byte{
	...
	0x02, 0x42, 0x1e, 0x5a, 0x1c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_user3_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_user3_proto_goTypes = []interface{}{
	...
	nil,                                             // 47: user.UserSearchResult.UnreadCountsEntry
	(*common.Context)(nil),                          // 48: common.Context
	(*common.Error)(nil),                            // 49: common.Error
}
var file_user3_proto_depIdxs = []int32{
	48, // 0: user.TotalConvoUpdateRequest.ctx:type_name -> common.Context
	48, // 1: user.TotalOpenTicket.ctx:type_name -> common.Context
	48, // 2: user.User.ctx:type_name -> common.Context
	...
	49, // 7: user.Users.errors:type_name -> common.Error
	48, // 8: user.MyUser.ctx:type_name -> common.Context
	11, // 9: user.MyUser.user:type_name -> user.User
	48, // 10: user.CountTotalRequest.ctx:type_name -> common.Context
	48, // 11: user.MergeRequest.ctx:type_name -> common.Context
	21, // 12: user.Traces.traces:type_name -> user.Trace
	14, // 13: user.Trace.campaigns:type_name -> user.Campaign
	48, // 14: user.UserSearchResult.ctx:type_name -> common.Context
	11, // 15: user.UserSearchResult.users:type_name -> user.User
	47, // 16: user.UserSearchResult.unread_counts:type_name -> user.UserSearchResult.UnreadCountsEntry
	48, // 17: user.UnpickRequest.ctx:type_name -> common.Context
	48, // 18: user.PickRequest.ctx:type_name -> common.Context
	48, // 19: user.CountSegmentationUserByAttributeRequest.ctx:type_name -> common.Context
	48, // 20: user.Visitor.ctx:type_name -> common.Context
	11, // 21: user.Visitor.user:type_name -> user.User
	48, // 22: user.Visitors.ctx:type_name -> common.Context
	26, // 23: user.Visitors.visitors:type_name -> user.Visitor
	48, // 24: user.SubscribeTopic.ctx:type_name -> common.Context
	48, // 25: user.MuteRequest.ctx:type_name -> common.Context
	48, // 26: user.SubscribeUser.ctx:type_name -> common.Context
	48, // 27: user.ReadTopicRequest.ctx:type_name -> common.Context
	48, // 28: user.SubscribeRequest.ctx:type_name -> common.Context
	48, // 29: user.AddToMyRequest.ctx:type_name -> common.Context
	48, // 30: user.DeleteAttrRequest.ctx:type_name -> common.Context
	48, // 31: user.AttributeDefinition.ctx:type_name -> common.Context
	48, // 32: user.AttributeDefinitions.ctx:type_name -> common.Context
	36, // 33: user.AttributeDefinitions.attributes:type_name -> user.AttributeDefinition
	48, // 34: user.AddToMyList.ctx:type_name -> common.Context
	48, // 35: user.Identification.ctx:type_name -> common.Context
	48, // 36: user.Note.ctx:type_name -> common.Context
	42, // 37: user.Note.links:type_name -> user.NoteLink
	48, // 38: user.Notes.ctx:type_name -> common.Context
	41, // 39: user.Notes.notes:type_name -> user.Note
	48, // 40: user.ListNotesRequest.ctx:type_name -> common.Context
