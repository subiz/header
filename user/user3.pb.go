...
var file_user3_proto_rawDesc = []byte{
	...
	0x73, 0x2a, 0x4a, 0x0a, 0x0d, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x54, 0x79,
...
var file_user3_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_user3_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_user3_proto_goTypes = []interface{}{
	...
	(*TotalConvoUpdateRequest)(nil),                    // 7: user.TotalConvoUpdateRequest
	(*TotalOpenTicket)(nil),                            // 8: user.TotalOpenTicket
	(*AttributeData)(nil),                              // 9: user.AttributeData
	(*User)(nil),                                       // 10: user.User
	(*Users)(nil),                                      // 11: user.Users
	(*MyUser)(nil),                                     // 12: user.MyUser
	...
	(*Presences)(nil),                                  // 27: user.Presences
	(*Presence)(nil),                                   // 28: user.Presence
	...
	nil,                                                // 42: user.UserSearchResult.UnreadCountsEntry
	(*common.Context)(nil),                             // 43: common.Context
	(*common.Error)(nil),                               // 44: common.Error
}
var file_user3_proto_depIdxs = []int32{
	43, // 0: user.TotalConvoUpdateRequest.ctx:type_name -> common.Context
	43, // 1: user.TotalOpenTicket.ctx:type_name -> common.Context
	43, // 2: user.User.ctx:type_name -> common.Context
	20, // 3: user.User.traces:type_name -> user.Trace
	9,  // 4: user.User.attributes:type_name -> user.AttributeData
	41, // 5: user.User.identifications:type_name -> user.Identification
	10, // 6: user.Users.users:type_name -> user.User
	44, // 7: user.Users.errors:type_name -> common.Error
	43, // 8: user.MyUser.ctx:type_name -> common.Context
	10, // 9: user.MyUser.user:type_name -> user.User
	43, // 10: user.CountTotalRequest.ctx:type_name -> common.Context
	43, // 11: user.MergeRequest.ctx:type_name -> common.Context
	20, // 12: user.Traces.traces:type_name -> user.Trace
	13, // 13: user.Trace.campaigns:type_name -> user.Campaign
	43, // 14: user.UserSearchResult.ctx:type_name -> common.Context
	10, // 15: user.UserSearchResult.users:type_name -> user.User
	42, // 16: user.UserSearchResult.unread_counts:type_name -> user.UserSearchResult.UnreadCountsEntry
	43, // 17: user.UnpickRequest.ctx:type_name -> common.Context
	43, // 18: user.PickRequest.ctx:type_name -> common.Context
	43, // 19: user.CountSegmentationUserByAttributeRequest.ctx:type_name -> common.Context
	43, // 20: user.Visitor.ctx:type_name -> common.Context
	10, // 21: user.Visitor.user:type_name -> user.User
	43, // 22: user.Visitors.ctx:type_name -> common.Context
	25, // 23: user.Visitors.visitors:type_name -> user.Visitor
	43, // 24: user.Presences.ctx:type_name -> common.Context
	28, // 25: user.Presences.presences:type_name -> user.Presence
	43, // 26: user.Presence.ctx:type_name -> common.Context
	43, // 27: user.SubscribeTopic.ctx:type_name -> common.Context
	43, // 28: user.MuteRequest.ctx:type_name -> common.Context
	43, // 29: user.SubscribeUser.ctx:type_name -> common.Context
	43, // 30: user.ReadTopicRequest.ctx:type_name -> common.Context
	43, // 31: user.SubscribeRequest.ctx:type_name -> common.Context
	43, // 32: user.AddToMyRequest.ctx:type_name -> common.Context
	43, // 33: user.DeleteAttrRequest.ctx:type_name -> common.Context
	43, // 34: user.AttributeDefinition.ctx:type_name -> common.Context
	43, // 35: user.AttributeDefinitions.ctx:type_name -> common.Context
	37, // 36: user.AttributeDefinitions.attributes:type_name -> user.AttributeDefinition
	43, // 37: user.AddToMyList.ctx:type_name -> common.Context
	43, // 38: user.Identification.ctx:type_name -> common.Context
