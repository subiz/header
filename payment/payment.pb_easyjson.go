...
func easyjson3258bd9eDecodeGithubComSubizHeaderPayment53(in *jlexer.Lexer, out *Addon) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3258bd9eEncodeGithubComSubizHeaderPayment53(out *jwriter.Writer, in Addon) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Type != nil {
