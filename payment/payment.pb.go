...
var file_payment_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x22, 0xfc, 0x02, 0x0a, 0x0f, 0x50, 0x6c, 0x61, 0x6e, 0x49, 0x6e, 0x76, 0x6f,
	...
	0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x22, 0xbc, 0x05, 0x0a, 0x0b, 0x49,
	...
	0x55, 0x73, 0x64, 0x1a, 0xd3, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2f, 0x0a, 0x05,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x4b, 0x0a, 0x04, 0x4c,
...
var file_payment_proto_goTypes = []interface{}{
	...
	(*Logs)(nil),                 // 21: payment.Logs
	(*Log)(nil),                  // 22: payment.Log
	(*String)(nil),               // 23: payment.String
	(*PayRequest)(nil),           // 24: payment.PayRequest
	(*AutoPayRequest)(nil),       // 25: payment.AutoPayRequest
	...
	(*FreeTierPolicy)(nil),       // 30: payment.FreeTierPolicy
...
var file_payment_proto_depIdxs = []int32{
	...
	33, // 4: payment.Plan.limit:type_name -> common.Limit
	...
	32, // 9: payment.Bill.ctx:type_name -> common.Context
	32, // 10: payment.Bills.ctx:type_name -> common.Context
	9,  // 11: payment.Bills.bills:type_name -> payment.Bill
	32, // 12: payment.Note.ctx:type_name -> common.Context
	32, // 13: payment.Invoices.ctx:type_name -> common.Context
	14, // 14: payment.Invoices.invoices:type_name -> payment.Invoice
	32, // 15: payment.ListInvoiceRequest.ctx:type_name -> common.Context
	32, // 16: payment.Invoice.ctx:type_name -> common.Context
	...
	22, // 24: payment.Logs.logs:type_name -> payment.Log
	...
	32, // 28: payment.AutoPayRequest.ctx:type_name -> common.Context
	32, // 29: payment.InvoiceCreatedEmail.ctx:type_name -> common.Context
	32, // 30: payment.TrialEndingEmail.ctx:type_name -> common.Context
	32, // 31: payment.UpdatePlanEmail.ctx:type_name -> common.Context
	32, // 32: payment.PaidInvoiceEmail.ctx:type_name -> common.Context
	32, // 33: payment.FreeTierPolicy.ctx:type_name -> common.Context
	...
	17, // 36: payment.InvoiceItem.Data.plan:type_name -> payment.PlanInvoiceItem
	18, // 37: payment.InvoiceItem.Data.marketing:type_name -> payment.MarketingInvoiceItem
