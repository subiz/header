...
type Package struct {
	...
	Ctx              *common.Context `protobuf:"bytes,1,opt,name=ctx" json:"ctx,omitempty"`
	Name             *string         `protobuf:"bytes,2,opt,name=name" json:"name,omitempty"`
	IsUnlimitedAgent *bool           `protobuf:"varint,3,opt,name=is_unlimited_agent,json=isUnlimitedAgent" json:"is_unlimited_agent,omitempty"`
...
func (x *Package) GetCtx() *common.Context {
	if x != nil {
		return x.Ctx
	}
	return nil
...
func (x *Package) GetIsUnlimitedAgent() bool {
...
func (x *Package) GetUnitPrice() int64 {
...
var file_payment_proto_rawDesc = []byte{
	...
	,
...
var file_payment_proto_goTypes = []interface{}{
	...
	(*Package)(nil),                   // 58: payment.Package
...
var file_payment_proto_depIdxs = []int32{
	...
	60, // 10: payment.Subscription.ctx:type_name -> common.Context
	...
	60, // 14: payment.Bill.ctx:type_name -> common.Context
	29, // 15: payment.Bill.customer_info:type_name -> payment.Contact
	60, // 16: payment.Bills.ctx:type_name -> common.Context
	17, // 17: payment.Bills.bills:type_name -> payment.Bill
	60, // 18: payment.Note.ctx:type_name -> common.Context
	60, // 19: payment.Invoices.ctx:type_name -> common.Context
	22, // 20: payment.Invoices.invoices:type_name -> payment.Invoice
	60, // 21: payment.ListInvoiceRequest.ctx:type_name -> common.Context
	60, // 22: payment.Invoice.ctx:type_name -> common.Context
	...
	59, // 28: payment.InvoiceItem.data:type_name -> payment.InvoiceItem.Data
	60, // 29: payment.Contact.ctx:type_name -> common.Context
	...
	60, // 32: payment.Referral.ctx:type_name -> common.Context
	60, // 33: payment.LogAccountReferreds.ctx:type_name -> common.Context
	36, // 34: payment.LogAccountReferreds.log_account_referreds:type_name -> payment.LogAccountReferred
	60, // 35: payment.LogBillByAccountReferreds.ctx:type_name -> common.Context
	38, // 36: payment.LogBillByAccountReferreds.log_bill_by_account_referreds:type_name -> payment.LogBillByAccountReferred
	60, // 37: payment.LogPaidForAgentReferrer.ctx:type_name -> common.Context
	60, // 38: payment.LogPaidForAgentReferrers.ctx:type_name -> common.Context
	40, // 39: payment.LogPaidForAgentReferrers.log_paid_for_agent_referrers:type_name -> payment.LogPaidForAgentReferrer
	60, // 40: payment.ListLogsRequest.ctx:type_name -> common.Context
	60, // 41: payment.Logs.ctx:type_name -> common.Context
	44, // 42: payment.Logs.logs:type_name -> payment.Log
	60, // 43: payment.Log.ctx:type_name -> common.Context
	60, // 44: payment.SearchInvoiceRequest.ctx:type_name -> common.Context
	60, // 45: payment.DiffSubRequest.ctx:type_name -> common.Context
	...
	60, // 48: payment.ReferralResponse.ctx:type_name -> common.Context
	48, // 49: payment.ReferralResponse.top_referrals:type_name -> payment.NumberOfReferByAgent
	60, // 50: payment.SearchReferredRequest.ctx:type_name -> common.Context
	60, // 51: payment.String.ctx:type_name -> common.Context
	60, // 52: payment.PayRequest.ctx:type_name -> common.Context
	29, // 53: payment.PayRequest.CustomerInfo:type_name -> payment.Contact
	60, // 54: payment.AutoPayRequest.ctx:type_name -> common.Context
	60, // 55: payment.InvoiceCreatedEmail.ctx:type_name -> common.Context
	60, // 56: payment.TrialEndingEmail.ctx:type_name -> common.Context
	60, // 57: payment.UpdatePlanEmail.ctx:type_name -> common.Context
	60, // 58: payment.PaidInvoiceEmail.ctx:type_name -> common.Context
	60, // 59: payment.Package.ctx:type_name -> common.Context
	24, // 60: payment.InvoiceItem.Data.renew:type_name -> payment.RenewInvoiceItem
	23, // 61: payment.InvoiceItem.Data.agent:type_name -> payment.AgentInvoiceItem
	25, // 62: payment.InvoiceItem.Data.plan:type_name -> payment.PlanInvoiceItem
	26, // 63: payment.InvoiceItem.Data.marketing:type_name -> payment.MarketingInvoiceItem
