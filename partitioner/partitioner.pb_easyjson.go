...
func easyjsonEeb4d5ddDecodeGithubComSubizHeaderPartitioner6(in *jlexer.Lexer, out *Cluster) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEeb4d5ddEncodeGithubComSubizHeaderPartitioner6(out *jwriter.Writer, in Cluster) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Id != "" {
