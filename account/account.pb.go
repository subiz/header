...
var file_account_proto_depIdxs = []int32{
	...
	30, // 1: account.Agent.ctx:type_name -> common.Context
	6,  // 2: account.Agent.account:type_name -> account.Account
	26, // 3: account.Agent.last_seen:type_name -> account.Presence
	3,  // 4: account.Agent.dashboard_setting:type_name -> account.DashboardAgent
	30, // 5: account.ResetPasswordRequest.ctx:type_name -> common.Context
	30, // 6: account.Account.ctx:type_name -> common.Context
	31, // 7: account.Account.limit:type_name -> payment.Limit
	...
	30, // 13: account.CreateAccountRequest.ctx:type_name -> common.Context
	30, // 14: account.Agents.ctx:type_name -> common.Context
	4,  // 15: account.Agents.Agents:type_name -> account.Agent
	30, // 16: account.NewPassword.ctx:type_name -> common.Context
	30, // 17: account.Token.ctx:type_name -> common.Context
	30, // 18: account.WarnInactiveEmail.ctx:type_name -> common.Context
	30, // 19: account.InvoiceEmail.ctx:type_name -> common.Context
	30, // 20: account.SubscriptionUpgradedEmail.ctx:type_name -> common.Context
	30, // 21: account.BillCreatedEmail.ctx:type_name -> common.Context
	30, // 22: account.TrialEndingEmail.ctx:type_name -> common.Context
	30, // 23: account.DowngradedToFreeEmail.ctx:type_name -> common.Context
	30, // 24: account.InviteEmail.ctx:type_name -> common.Context
	30, // 25: account.ResetPasswordEmail.ctx:type_name -> common.Context
	30, // 26: account.BusinessHours.ctx:type_name -> common.Context
	28, // 27: account.BusinessHours.working_days:type_name -> account.BusinessHours.WorkingDay
	29, // 28: account.BusinessHours.holidays:type_name -> account.BusinessHours.Holiday
	30, // 29: account.SyncPublicHolidaysRequest.ctx:type_name -> common.Context
	30, // 30: account.SearchSubRequest.ctx:type_name -> common.Context
	30, // 31: account.Presences.ctx:type_name -> common.Context
	26, // 32: account.Presences.presences:type_name -> account.Presence
	30, // 33: account.Presence.ctx:type_name -> common.Context
