...
func (*BusinessHours_Holiday) Descriptor() ([]byte, []int) {
	return file_account_proto_rawDescGZIP(), []int{18, 1}
}
...
var file_account_proto_rawDesc = []byte{
	...
	0x0a, 0x07, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x10, 0x03, 0x22, 0xb5, 0x0a, 0x0a, 0x07,
	...
	0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x54, 0x74, 0x6c, 0x22, 0x3c, 0x0a, 0x15, 0x57, 0x65, 0x62,
	...
	0x79, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x22, 0xa4, 0x01, 0x0a, 0x0b, 0x4c, 0x65, 0x61, 0x64,
	...
	0x75, 0x74, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x53,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x03, 0x63, 0x74, 0x78, 0x12, 0x26, 0x0a, 0x06, 0x61,
	...
	0x6e, 0x74, 0x73, 0x22, 0x76, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x21, 0x0a, 0x03,
	...
	0x6c, 0x65, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_account_proto_goTypes = []interface{}{
	...
	(*Token)(nil),                     // 12: account.Token
	(*WarnInactiveEmail)(nil),         // 13: account.WarnInactiveEmail
	(*InvoiceEmail)(nil),              // 14: account.InvoiceEmail
	(*SubscriptionUpgradedEmail)(nil), // 15: account.SubscriptionUpgradedEmail
	(*BillCreatedEmail)(nil),          // 16: account.BillCreatedEmail
	(*TrialEndingEmail)(nil),          // 17: account.TrialEndingEmail
	(*DowngradedToFreeEmail)(nil),     // 18: account.DowngradedToFreeEmail
	(*InviteEmail)(nil),               // 19: account.InviteEmail
	(*ResetPasswordEmail)(nil),        // 20: account.ResetPasswordEmail
	(*BusinessHours)(nil),             // 21: account.BusinessHours
	(*SyncPublicHolidaysRequest)(nil), // 22: account.SyncPublicHolidaysRequest
	(*SearchSubRequest)(nil),          // 23: account.SearchSubRequest
	(*Presences)(nil),                 // 24: account.Presences
	(*Presence)(nil),                  // 25: account.Presence
...
var file_account_proto_depIdxs = []int32{
	...
	30, // 2: account.Agent.ctx:type_name -> common.Context
	5,  // 3: account.Agent.account:type_name -> account.Account
	25, // 4: account.Agent.last_seen:type_name -> account.Presence
	3,  // 5: account.Agent.dashboard_setting:type_name -> account.DashboardAgent
	30, // 6: account.Account.ctx:type_name -> common.Context
	21, // 7: account.Account.business_hours:type_name -> account.BusinessHours
	10, // 8: account.Account.lead_setting:type_name -> account.LeadSetting
	8,  // 9: account.Account.feature:type_name -> account.Feature
	8,  // 10: account.Account.force_feature:type_name -> account.Feature
	9,  // 11: account.Account.webpage_monitor_setting:type_name -> account.WebpageMonitorSetting
	7,  // 12: account.Account.user_attribute_setting:type_name -> account.UserAttributeSetting
	6,  // 13: account.Account.invoice_info:type_name -> account.InvoiceInfo
	30, // 14: account.InvoiceInfo.ctx:type_name -> common.Context
	30, // 15: account.Agents.ctx:type_name -> common.Context
	...
	25, // 32: account.Presences.presences:type_name -> account.Presence
