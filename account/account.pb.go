...
var file_account_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0xe0, 0x09, 0x0a, 0x07,
	...
	0x6e, 0x4c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x12, 0x22, 0x0a, 0x0d, 0x69, 0x73, 0x5f, 0x77, 0x61,
	0x72, 0x6e, 0x5f, 0x70, 0x6f, 0x70, 0x75, 0x70, 0x18, 0x2d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b,
	0x69, 0x73, 0x57, 0x61, 0x72, 0x6e, 0x50, 0x6f, 0x70, 0x75, 0x70, 0x22, 0x31, 0x0a, 0x05, 0x53,
	...
	0x12, 0x0c, 0x0a, 0x08, 0x69, 0x6e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x10, 0x04, 0x22, 0xb9,
	...
	0x41, 0x73, 0x4c, 0x65, 0x61, 0x64, 0x22, 0x9a, 0x03, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x28, 0x09, 0x52, 0x04, 0x6c, 0x61, 0x6e, 0x67, 0x22, 0xa8, 0x01, 0x0a, 0x10, 0x53, 0x65, 0x61,
...
var file_account_proto_depIdxs = []int32{
	...
	31, // 13: account.CreateAccountRequest.ctx:type_name -> common.Context
	31, // 14: account.Agents.ctx:type_name -> common.Context
	4,  // 15: account.Agents.Agents:type_name -> account.Agent
	31, // 16: account.NewPassword.ctx:type_name -> common.Context
	31, // 17: account.Token.ctx:type_name -> common.Context
	31, // 18: account.WarnInactiveEmail.ctx:type_name -> common.Context
	31, // 19: account.InvoiceEmail.ctx:type_name -> common.Context
	31, // 20: account.SubscriptionUpgradedEmail.ctx:type_name -> common.Context
	31, // 21: account.BillCreatedEmail.ctx:type_name -> common.Context
	31, // 22: account.TrialEndingEmail.ctx:type_name -> common.Context
	31, // 23: account.DowngradedToFreeEmail.ctx:type_name -> common.Context
	31, // 24: account.InviteEmail.ctx:type_name -> common.Context
	31, // 25: account.ResetPasswordEmail.ctx:type_name -> common.Context
	31, // 26: account.BusinessHours.ctx:type_name -> common.Context
	29, // 27: account.BusinessHours.working_days:type_name -> account.BusinessHours.WorkingDay
	30, // 28: account.BusinessHours.holidays:type_name -> account.BusinessHours.Holiday
	31, // 29: account.SyncPublicHolidaysRequest.ctx:type_name -> common.Context
	31, // 30: account.SearchSubRequest.ctx:type_name -> common.Context
	31, // 31: account.Presences.ctx:type_name -> common.Context
	26, // 32: account.Presences.presences:type_name -> account.Presence
	31, // 33: account.Presence.ctx:type_name -> common.Context
