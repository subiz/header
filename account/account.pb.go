...
type AccountMgrClient interface {
	...
	GetAgentPermission(ctx context.Context, in *common.Id, opts ...grpc.CallOption) (*AgentPerm, error)
	UpdateAgentPermission(ctx context.Context, in *AgentPerm, opts ...grpc.CallOption) (*AgentPerm, error)
...
func (c *accountMgrClient) GetAgentPermission(ctx context.Context, in *common.Id, opts ...grpc.CallOption) (*AgentPerm, error) {
	out := new(AgentPerm)
...
func (c *accountMgrClient) UpdateAgentPermission(ctx context.Context, in *AgentPerm, opts ...grpc.CallOption) (*AgentPerm, error) {
	out := new(AgentPerm)
...
type AccountMgrServer interface {
	...
	GetAgentPermission(context.Context, *common.Id) (*AgentPerm, error)
	UpdateAgentPermission(context.Context, *AgentPerm) (*AgentPerm, error)
...
var fileDescriptor0 = []byte{
	...
	,
}
