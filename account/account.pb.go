...
var file_account_proto_goTypes = []interface{}{
	...
	(*InviteEmail)(nil),               // 13: account.InviteEmail
	(*ResetPasswordEmail)(nil),        // 14: account.ResetPasswordEmail
	...
	nil,                               // 20: account.DashboardAgent.SegmentOrderByEntry
	nil,                               // 21: account.DashboardAgent.UserViewDisplayFieldEntry
	nil,                               // 22: account.DashboardAgent.SegmentUserViewsOrderEntry
	(*BusinessHours_WorkingDay)(nil),  // 23: account.BusinessHours.WorkingDay
	(*BusinessHours_Holiday)(nil),     // 24: account.BusinessHours.Holiday
	(*common.Context)(nil),            // 25: common.Context
}
var file_account_proto_depIdxs = []int32{
	20, // 0: account.DashboardAgent.segment_order_by:type_name -> account.DashboardAgent.SegmentOrderByEntry
	21, // 1: account.DashboardAgent.user_view_display_field:type_name -> account.DashboardAgent.UserViewDisplayFieldEntry
	22, // 2: account.DashboardAgent.segment_user_views_order:type_name -> account.DashboardAgent.SegmentUserViewsOrderEntry
	25, // 3: account.Agent.ctx:type_name -> common.Context
	5,  // 4: account.Agent.account:type_name -> account.Account
	19, // 5: account.Agent.last_seen:type_name -> account.Presence
	3,  // 6: account.Agent.dashboard_setting:type_name -> account.DashboardAgent
	25, // 7: account.Account.ctx:type_name -> common.Context
	15, // 8: account.Account.business_hours:type_name -> account.BusinessHours
	...
	25, // 12: account.InvoiceInfo.ctx:type_name -> common.Context
	25, // 13: account.Token.ctx:type_name -> common.Context
	25, // 14: account.WarnInactiveEmail.ctx:type_name -> common.Context
	25, // 15: account.InvoiceEmail.ctx:type_name -> common.Context
	25, // 16: account.TrialEndingEmail.ctx:type_name -> common.Context
	25, // 17: account.InviteEmail.ctx:type_name -> common.Context
	25, // 18: account.ResetPasswordEmail.ctx:type_name -> common.Context
	25, // 19: account.BusinessHours.ctx:type_name -> common.Context
	23, // 20: account.BusinessHours.working_days:type_name -> account.BusinessHours.WorkingDay
	24, // 21: account.BusinessHours.holidays:type_name -> account.BusinessHours.Holiday
	25, // 22: account.SyncPublicHolidaysRequest.ctx:type_name -> common.Context
	25, // 23: account.SearchSubRequest.ctx:type_name -> common.Context
	25, // 24: account.Presences.ctx:type_name -> common.Context
	19, // 25: account.Presences.presences:type_name -> account.Presence
	25, // 26: account.Presence.ctx:type_name -> common.Context
