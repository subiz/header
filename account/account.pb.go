...
func (*BusinessHours_Holiday) Descriptor() ([]byte, []int) {
	return file_account_proto_rawDescGZIP(), []int{16, 1}
}
...
var file_account_proto_rawDesc = []byte{
	...
	0xe9, 0x07, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x03, 0x63, 0x74, 0x78,
	...
	0x0a, 0x07, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x10, 0x03, 0x22, 0xdd, 0x09, 0x0a, 0x07,
	...
	0x75, 0x72, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x65, 0x18, 0x27, 0x20,
	...
	0x6c, 0x22, 0xa4, 0x01, 0x0a, 0x0b, 0x4c, 0x65, 0x61, 0x64, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e,
...
var file_account_proto_goTypes = []interface{}{
	...
	(*Token)(nil),                     // 10: account.Token
	(*WarnInactiveEmail)(nil),         // 11: account.WarnInactiveEmail
	(*InvoiceEmail)(nil),              // 12: account.InvoiceEmail
	(*SubscriptionUpgradedEmail)(nil), // 13: account.SubscriptionUpgradedEmail
	(*BillCreatedEmail)(nil),          // 14: account.BillCreatedEmail
	(*TrialEndingEmail)(nil),          // 15: account.TrialEndingEmail
	(*DowngradedToFreeEmail)(nil),     // 16: account.DowngradedToFreeEmail
	(*InviteEmail)(nil),               // 17: account.InviteEmail
	(*ResetPasswordEmail)(nil),        // 18: account.ResetPasswordEmail
	(*BusinessHours)(nil),             // 19: account.BusinessHours
	(*SyncPublicHolidaysRequest)(nil), // 20: account.SyncPublicHolidaysRequest
	(*SearchSubRequest)(nil),          // 21: account.SearchSubRequest
	(*Presences)(nil),                 // 22: account.Presences
	(*Presence)(nil),                  // 23: account.Presence
	nil,                               // 24: account.DashboardAgent.SegmentOrderByEntry
	nil,                               // 25: account.DashboardAgent.UserViewDisplayFieldEntry
...
var file_account_proto_depIdxs = []int32{
	24, // 0: account.DashboardAgent.segment_order_by:type_name -> account.DashboardAgent.SegmentOrderByEntry
	25, // 1: account.DashboardAgent.user_view_display_field:type_name -> account.DashboardAgent.UserViewDisplayFieldEntry
	28, // 2: account.Agent.ctx:type_name -> common.Context
	5,  // 3: account.Agent.account:type_name -> account.Account
	23, // 4: account.Agent.last_seen:type_name -> account.Presence
	3,  // 5: account.Agent.dashboard_setting:type_name -> account.DashboardAgent
	28, // 6: account.Account.ctx:type_name -> common.Context
	19, // 7: account.Account.business_hours:type_name -> account.BusinessHours
	9,  // 8: account.Account.lead_setting:type_name -> account.LeadSetting
	8,  // 9: account.Account.feature:type_name -> account.Feature
	8,  // 10: account.Account.force_feature:type_name -> account.Feature
	7,  // 11: account.Account.user_attribute_setting:type_name -> account.UserAttributeSetting
	6,  // 12: account.Account.invoice_info:type_name -> account.InvoiceInfo
	28, // 13: account.InvoiceInfo.ctx:type_name -> common.Context
	28, // 14: account.Token.ctx:type_name -> common.Context
	28, // 15: account.WarnInactiveEmail.ctx:type_name -> common.Context
	28, // 16: account.InvoiceEmail.ctx:type_name -> common.Context
	28, // 17: account.SubscriptionUpgradedEmail.ctx:type_name -> common.Context
	28, // 18: account.BillCreatedEmail.ctx:type_name -> common.Context
	28, // 19: account.TrialEndingEmail.ctx:type_name -> common.Context
	28, // 20: account.DowngradedToFreeEmail.ctx:type_name -> common.Context
	28, // 21: account.InviteEmail.ctx:type_name -> common.Context
	28, // 22: account.ResetPasswordEmail.ctx:type_name -> common.Context
	28, // 23: account.BusinessHours.ctx:type_name -> common.Context
	26, // 24: account.BusinessHours.working_days:type_name -> account.BusinessHours.WorkingDay
	27, // 25: account.BusinessHours.holidays:type_name -> account.BusinessHours.Holiday
	28, // 26: account.SyncPublicHolidaysRequest.ctx:type_name -> common.Context
	28, // 27: account.SearchSubRequest.ctx:type_name -> common.Context
	28, // 28: account.Presences.ctx:type_name -> common.Context
	23, // 29: account.Presences.presences:type_name -> account.Presence
	28, // 30: account.Presence.ctx:type_name -> common.Context
