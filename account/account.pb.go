...
var file_account_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x78, 0x12, 0x26, 0x0a, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x41, 0x67,
	0x65, 0x6e, 0x74, 0x52, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xa2, 0x01, 0x0a, 0x0b,
...
var file_account_proto_depIdxs = []int32{
	...
	32, // 14: account.InvoiceInfo.ctx:type_name -> common.Context
	32, // 15: account.CreateAccountRequest.ctx:type_name -> common.Context
	32, // 16: account.Agents.ctx:type_name -> common.Context
	4,  // 17: account.Agents.agents:type_name -> account.Agent
	32, // 18: account.NewPassword.ctx:type_name -> common.Context
	32, // 19: account.Token.ctx:type_name -> common.Context
	32, // 20: account.WarnInactiveEmail.ctx:type_name -> common.Context
	32, // 21: account.InvoiceEmail.ctx:type_name -> common.Context
	32, // 22: account.SubscriptionUpgradedEmail.ctx:type_name -> common.Context
	32, // 23: account.BillCreatedEmail.ctx:type_name -> common.Context
	32, // 24: account.TrialEndingEmail.ctx:type_name -> common.Context
	32, // 25: account.DowngradedToFreeEmail.ctx:type_name -> common.Context
	32, // 26: account.InviteEmail.ctx:type_name -> common.Context
	32, // 27: account.ResetPasswordEmail.ctx:type_name -> common.Context
	32, // 28: account.BusinessHours.ctx:type_name -> common.Context
	30, // 29: account.BusinessHours.working_days:type_name -> account.BusinessHours.WorkingDay
	31, // 30: account.BusinessHours.holidays:type_name -> account.BusinessHours.Holiday
	32, // 31: account.SyncPublicHolidaysRequest.ctx:type_name -> common.Context
	32, // 32: account.SearchSubRequest.ctx:type_name -> common.Context
	32, // 33: account.Presences.ctx:type_name -> common.Context
	27, // 34: account.Presences.presences:type_name -> account.Presence
	32, // 35: account.Presence.ctx:type_name -> common.Context
