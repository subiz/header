	...
	for !in.IsDelim('}') {
		...
		case "method":
			if in.IsNull() {
				...
				easyjsonC9b74c43DecodeGithubComSubizHeaderAuth1(in, &*out.Method)
			}
		case "perm":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonC9b74c43DecodeGithubComSubizHeaderAuth2(in, &*out.Perm)
			}
		case "client_id":
...
func easyjsonC9b74c43EncodeGithubComSubizHeaderAuth(out *jwriter.Writer, in auth.Credential) {
	...
	if in.Method != nil {
		...
		easyjsonC9b74c43EncodeGithubComSubizHeaderAuth1(out, *in.Method)
	}
	if in.Perm != nil {
		...
		easyjsonC9b74c43EncodeGithubComSubizHeaderAuth2(out, *in.Perm)
	}
	if in.ClientId != "" {
...
func easyjsonC9b74c43DecodeGithubComSubizHeaderAuth2(in *jlexer.Lexer, out *auth.Permission) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC9b74c43EncodeGithubComSubizHeaderAuth2(out *jwriter.Writer, in auth.Permission) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Account != 0 {
...
func easyjsonC9b74c43DecodeGithubComSubizHeaderAuth1(in *jlexer.Lexer, out *auth.Method) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC9b74c43EncodeGithubComSubizHeaderAuth1(out *jwriter.Writer, in auth.Method) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ping {
