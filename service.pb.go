...
var file_service_proto_rawDesc = []byte{
	...
	0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xa3, 0x01, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x79, 0x6e, 0x63, 0x4d, 0x67, 0x72, 0x12, 0x45,
	...
	0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xae,
	...
	0x12, 0x21, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x42, 0x6f, 0x74, 0x12, 0x0a, 0x2e, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x64, 0x1a, 0x0b, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x64, 0x1a, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a, 0x07, 0x4f, 0x6e, 0x45, 0x76,
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x30, 0x0a, 0x08, 0x53, 0x74, 0x61,
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a, 0x07, 0x53,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x31, 0x0a, 0x09,
...
var file_service_proto_depIdxs = []int32{
	...
	49,  // 96: header.ConversationSyncMgr.FireSendChatTranscriptEmail:input_type -> header.AutomationEvent
	49,  // 97: header.ConversationSyncMgr.FireUpdateConversationState:input_type -> header.AutomationEvent
	50,  // 98: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	50,  // 99: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	1,   // 100: header.TemplateMgr.DeleteTemplate:input_type -> common.Id
	1,   // 101: header.TemplateMgr.GetTemplate:input_type -> common.Id
	51,  // 102: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	1,   // 103: header.TemplateMgr.PickTemplate:input_type -> common.Id
	52,  // 104: header.TagMgr.CreateTag:input_type -> header.Tag
	52,  // 105: header.TagMgr.UpdateTag:input_type -> header.Tag
	1,   // 106: header.TagMgr.DeleteTag:input_type -> common.Id
	1,   // 107: header.TagMgr.ListTags:input_type -> common.Id
	1,   // 108: header.TagMgr.GetTag:input_type -> common.Id
	1,   // 109: header.IntegrationMgr.Deintegrate:input_type -> common.Id
	1,   // 110: header.IntegrationMgr.ListIntegrations:input_type -> common.Id
	53,  // 111: header.IntegrationMgr.Integrate:input_type -> header.Integration
	54,  // 112: header.ClientMgr.Create:input_type -> header.Client
	54,  // 113: header.ClientMgr.Update:input_type -> header.Client
	54,  // 114: header.ClientMgr.Read:input_type -> header.Client
	1,   // 115: header.ClientMgr.ListIntegratedClients:input_type -> common.Id
	1,   // 116: header.ClientMgr.ListAuthorizedClients:input_type -> common.Id
	55,  // 117: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	56,  // 118: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	39,  // 119: header.ConversationEventReader.SendMessage:input_type -> header.Event
	39,  // 120: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	57,  // 121: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	58,  // 122: header.ConversationEventReader.SearchEvents:input_type -> header.SearchMessageRequest
	59,  // 123: header.FileMgr.Presign:input_type -> header.FileHeader
	60,  // 124: header.FileMgr.Read:input_type -> header.FileRequest
	60,  // 125: header.FileMgr.Uploaded:input_type -> header.FileRequest
	1,   // 126: header.Noti5Service.ReadNotificationSetting:input_type -> common.Id
	61,  // 127: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	62,  // 128: header.Noti5Service.Noti:input_type -> noti5.PushNoti
	63,  // 129: header.Noti5Service.AddToken:input_type -> noti5.Token
	63,  // 130: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	63,  // 131: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	64,  // 132: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	65,  // 133: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	66,  // 134: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	66,  // 135: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 136: header.PaymentMgr.GetSubscription:input_type -> common.Id
	67,  // 137: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	67,  // 138: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	1,   // 139: header.PaymentMgr.DeletePaymentMethod:input_type -> common.Id
	1,   // 140: header.PaymentMgr.ListPaymentMethods:input_type -> common.Id
	68,  // 141: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	69,  // 142: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	69,  // 143: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	70,  // 144: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	66,  // 145: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	71,  // 146: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	72,  // 147: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	73,  // 148: header.PaymentMgr.AddComment:input_type -> payment.Comment
	29,  // 149: header.PaymentMgr.ListPlans:input_type -> common.Empty
	1,   // 150: header.PaymentMgr.ExportInvoice:input_type -> common.Id
	69,  // 151: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	74,  // 152: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	68,  // 153: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	75,  // 154: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	76,  // 155: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	77,  // 156: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	78,  // 157: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	78,  // 158: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	79,  // 159: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 160: header.PaymentMgr.DeletePromotionCode:input_type -> common.Id
	80,  // 161: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 162: header.PaymentMgr.GetReferral:input_type -> common.Id
	29,  // 163: header.PaymentMgr.ListTopReferral:input_type -> common.Empty
	81,  // 164: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	1,   // 165: header.PaymentMgr.ListAccountReferred:input_type -> common.Id
	1,   // 166: header.PaymentMgr.ListBillByAccountReferred:input_type -> common.Id
	1,   // 167: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> common.Id
	82,  // 168: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	83,  // 169: header.Pubsub.Publish:input_type -> header.PublishMessage
	83,  // 170: header.Realtime.ShardSend:input_type -> header.PublishMessage
	...
	29,  // 313: header.ConversationSyncMgr.FireSendChatTranscriptEmail:output_type -> common.Empty
	29,  // 314: header.ConversationSyncMgr.FireUpdateConversationState:output_type -> common.Empty
	50,  // 315: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	50,  // 316: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	29,  // 317: header.TemplateMgr.DeleteTemplate:output_type -> common.Empty
	50,  // 318: header.TemplateMgr.GetTemplate:output_type -> header.Template
	...
	52,  // 321: header.TagMgr.CreateTag:output_type -> header.Tag
	52,  // 322: header.TagMgr.UpdateTag:output_type -> header.Tag
	29,  // 323: header.TagMgr.DeleteTag:output_type -> common.Empty
	132, // 324: header.TagMgr.ListTags:output_type -> header.Tags
	52,  // 325: header.TagMgr.GetTag:output_type -> header.Tag
	...
	53,  // 328: header.IntegrationMgr.Integrate:output_type -> header.Integration
	54,  // 329: header.ClientMgr.Create:output_type -> header.Client
	54,  // 330: header.ClientMgr.Update:output_type -> header.Client
	54,  // 331: header.ClientMgr.Read:output_type -> header.Client
	...
	61,  // 343: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	61,  // 344: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	...
	64,  // 349: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 350: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	69,  // 351: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	66,  // 352: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	66,  // 353: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	67,  // 354: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	67,  // 355: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	...
	64,  // 358: header.PaymentMgr.Pay:output_type -> payment.Bill
	69,  // 359: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	69,  // 360: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 361: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	69,  // 362: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	69,  // 363: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 364: header.PaymentMgr.ListComments:output_type -> payment.Comments
	73,  // 365: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 366: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	77,  // 367: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	77,  // 368: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	74,  // 369: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	64,  // 370: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 371: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	76,  // 372: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	76,  // 373: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	29,  // 374: header.PaymentMgr.UsePromotionCode:output_type -> common.Empty
	76,  // 375: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	...
	81,  // 378: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	81,  // 379: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 380: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	81,  // 381: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
