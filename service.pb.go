...
var file_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9b, 0x0c, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72,
	...
	0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb7, 0x11, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*UserAlias)(nil),                         // 31: header.UserAlias
	...
	(*RouteResult)(nil),                       // 174: header.RouteResult
...
var file_service_proto_depIdxs = []int32{
	...
	31,  // 84: header.UserMgr.MergeUser:input_type -> header.UserAlias
	...
	30,  // 142: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	...
	94,  // 240: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	94,  // 241: header.MailkonService.SendEvent:input_type -> header.Events
	...
	95,  // 246: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	96,  // 249: header.WidgetService.SubmitImpression:input_type -> header.Impression
	97,  // 250: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	98,  // 251: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	99,  // 252: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	100, // 253: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	100, // 254: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	101, // 255: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 256: header.WidgetService.ListUploadedImage:input_type -> header.Id
	101, // 257: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 258: header.WidgetService.ListWebPlugins:input_type -> header.Id
	102, // 259: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	102, // 260: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	102, // 261: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 262: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	102, // 263: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	103, // 266: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	104, // 272: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	104, // 273: header.Bizbot.CreateBot:input_type -> header.Bot
	104, // 274: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 275: header.Bizbot.DeleteBot:input_type -> header.Id
	105, // 276: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	105, // 277: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	105, // 278: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	105, // 279: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	106, // 280: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	107, // 281: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	108, // 282: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	109, // 283: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	110, // 284: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	110, // 289: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 290: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	111, // 291: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	112, // 292: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	47,  // 293: header.Sendback.SendWebhookEvent:input_type -> header.Event
	113, // 294: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	114, // 295: header.Notibox.SendNoti:input_type -> header.Notification
	113, // 296: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 297: header.Notibox.MarkReadNoti:input_type -> header.Id
	115, // 298: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 299: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 300: header.Watchhttp.ListWebpages:input_type -> header.Id
	115, // 301: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 302: header.Watchhttp.ReadWebpage:input_type -> header.Id
	116, // 303: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	117, // 304: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	118, // 305: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	118, // 306: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 307: header.Holap.AppendAgentSet:input_type -> account.Agent
	63,  // 308: header.Holap.AppendTagSet:input_type -> header.Tag
	32,  // 309: header.Holap.UpdateUser:input_type -> header.User
	52,  // 310: header.Holap.UpdateConversation:input_type -> header.Conversation
	47,  // 311: header.Holap.OnConversationEvent:input_type -> header.Event
	119, // 312: header.Holap.FreeAccount:input_type -> header.AccountImage
	120, // 313: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	121, // 314: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	120, // 315: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	121, // 316: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	122, // 317: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 318: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	33,  // 319: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 320: header.Holap.UpdateOrder:input_type -> header.Order
	123, // 321: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	124, // 322: header.Proder.ReadProduct:input_type -> header.Product
	124, // 323: header.Proder.CreateProduct:input_type -> header.Product
	124, // 324: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 325: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 326: header.Proder.RestoreProduct:input_type -> header.Id
	125, // 327: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 328: header.Proder.ListProductIds:input_type -> header.Ids
	125, // 329: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	126, // 330: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 331: header.Proder.ListProductCollections:input_type -> header.Ids
	127, // 332: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	127, // 333: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	128, // 336: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	128, // 337: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	129, // 346: header.Proder.ListOrders:input_type -> header.OrdersRequest
	129, // 347: header.Proder.CountOrders:input_type -> header.OrdersRequest
	130, // 348: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	131, // 349: header.Proder.MakeOrderPayment:input_type -> header.Bill
	132, // 350: header.Proder.DeleteOrderPayment:input_type -> header.Key
	47,  // 351: header.Proder.AddOrderComment:input_type -> header.Event
	47,  // 352: header.Proder.EditOrderComment:input_type -> header.Event
	132, // 353: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 354: header.Proder.ListOrderEvents:input_type -> header.Id
	133, // 355: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 356: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	134, // 357: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 358: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	135, // 359: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	136, // 360: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	137, // 361: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	138, // 362: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	139, // 369: header.Proder.VisitProductSite:input_type -> header.VisitProductSiteRequest
	4,   // 370: header.Apiece.ReadTask:input_type -> header.Id
	140, // 371: header.Apiece.CreateTask:input_type -> header.Task
	140, // 372: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 373: header.Apiece.DeleteTask:input_type -> header.Id
	141, // 374: header.Apiece.ListTasks:input_type -> header.TasksRequest
	47,  // 375: header.Apiece.AddTaskComment:input_type -> header.Event
	47,  // 376: header.Apiece.EditTaskComment:input_type -> header.Event
	...
	142, // 380: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	142, // 381: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 382: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 383: header.Apiece.ListPipelines:input_type -> header.Ids
	143, // 384: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	44,  // 385: header.Search.Index:output_type -> header.Empty
	144, // 386: header.Search.Search:output_type -> header.DocSearchResponse
	44,  // 387: header.Search.AddOwner:output_type -> header.Empty
	145, // 388: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 389: header.Map.LookupAddress:output_type -> header.Address
	146, // 390: header.Map.PredictAddress:output_type -> header.Addresses
	146, // 391: header.Map.ListDistricts:output_type -> header.Addresses
	146, // 392: header.Map.ListProvinces:output_type -> header.Addresses
	146, // 393: header.Map.ListWards:output_type -> header.Addresses
	146, // 394: header.Map.ListStreets:output_type -> header.Addresses
	146, // 395: header.Map.ListAddresses:output_type -> header.Addresses
	...
	147, // 414: header.AccountMgr.ListAgents:output_type -> account.Agents
	44,  // 415: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	148, // 416: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	...
	149, // 420: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	150, // 423: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	150, // 424: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	151, // 427: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	152, // 430: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	153, // 433: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	44,  // 434: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	146, // 435: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	154, // 439: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	155, // 443: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	155, // 444: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	156, // 449: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	157, // 452: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	158, // 457: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	159, // 462: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	...
	160, // 466: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	161, // 467: header.UserMgr.SearchUsers:output_type -> header.Users
	31,  // 468: header.UserMgr.MergeUser:output_type -> header.UserAlias
	...
	32,  // 473: header.UserMgr.ReadUser:output_type -> header.User
	32,  // 474: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	162, // 475: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	161, // 476: header.UserMgr.MatchUsers:output_type -> header.Users
	34,  // 477: header.UserMgr.UpdateView:output_type -> header.UserView
	34,  // 478: header.UserMgr.CreateView:output_type -> header.UserView
	44,  // 479: header.UserMgr.DeleteView:output_type -> header.Empty
	34,  // 480: header.UserMgr.GetView:output_type -> header.UserView
	163, // 481: header.UserMgr.ListViews:output_type -> header.UserViews
	35,  // 482: header.UserMgr.UpsertLabel:output_type -> header.Label
	44,  // 483: header.UserMgr.DeleteLabel:output_type -> header.Empty
	164, // 484: header.UserMgr.ListLabels:output_type -> header.Labels
	35,  // 485: header.UserMgr.GetLabel:output_type -> header.Label
	44,  // 486: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	44,  // 487: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	44,  // 488: header.UserMgr.AddUserLabel:output_type -> header.Empty
	44,  // 489: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	...
	44,  // 492: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	165, // 493: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	44,  // 494: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	161, // 495: header.UserMgr.ListLeads:output_type -> header.Users
	161, // 496: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	161, // 497: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	166, // 498: header.LiveMgr.SearchLocations:output_type -> header.Locations
	161, // 499: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	94,  // 500: header.LiveMgr.TopEvents:output_type -> header.Events
	167, // 501: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	168, // 502: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	169, // 503: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	170, // 504: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	171, // 505: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	172, // 506: header.NoteMgr.ListNotes:output_type -> header.Notes
	42,  // 507: header.NoteMgr.AddNote:output_type -> header.Note
	42,  // 508: header.NoteMgr.UpdateNote:output_type -> header.Note
	44,  // 509: header.NoteMgr.DeleteNote:output_type -> header.Empty
	173, // 510: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	45,  // 511: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	45,  // 512: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	174, // 513: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	47,  // 514: header.ConversationMgr.PongMessage:output_type -> header.Event
	52,  // 515: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	52,  // 516: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	52,  // 517: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	175, // 518: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	175, // 519: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	44,  // 520: header.ConversationMgr.TagConversation:output_type -> header.Empty
	44,  // 521: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	44,  // 522: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	44,  // 523: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	44,  // 524: header.ConversationMgr.Typing:output_type -> header.Empty
	52,  // 525: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	175, // 526: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	44,  // 527: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	44,  // 528: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	44,  // 529: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	44,  // 530: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	53,  // 531: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	53,  // 532: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	47,  // 533: header.ConversationMgr.TerminateBot:output_type -> header.Event
	...
	44,  // 536: header.ConversationMgr.PinMessage:output_type -> header.Empty
	44,  // 537: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	94,  // 538: header.ConversationMgr.ListEvents:output_type -> header.Events
	44,  // 539: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	...
	44,  // 545: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	...
	44,  // 550: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	...
	44,  // 554: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	...
	44,  // 557: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	...
	44,  // 560: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	...
	44,  // 566: header.TagMgr.DeleteTag:output_type -> header.Empty
	...
	44,  // 576: header.Noti5Service.Noti:output_type -> header.Empty
	44,  // 577: header.Noti5Service.AddToken:output_type -> header.Empty
	44,  // 578: header.Noti5Service.RemoveToken:output_type -> header.Empty
	44,  // 579: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	...
	44,  // 587: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	...
	44,  // 605: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	...
	44,  // 608: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	...
	44,  // 616: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	44,  // 617: header.Pubsub.Publish:output_type -> header.Empty
	...
	44,  // 623: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	44,  // 624: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	44,  // 625: header.MailkonService.SendEvent:output_type -> header.Empty
	44,  // 626: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	44,  // 627: header.MailkonService.BlockEmail:output_type -> header.Empty
	44,  // 628: header.MailkonService.UnblockEmail:output_type -> header.Empty
	95,  // 629: header.WidgetService.Read:output_type -> header.WidgetSetting
	95,  // 630: header.WidgetService.Update:output_type -> header.WidgetSetting
	...
	96,  // 633: header.WidgetService.SubmitImpression:output_type -> header.Impression
	97,  // 634: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	98,  // 635: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	...
	101, // 639: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	...
	102, // 643: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	102, // 644: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	102, // 645: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	44,  // 646: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	102, // 647: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	...
	104, // 655: header.Bizbot.GetBot:output_type -> header.Bot
	104, // 656: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	104, // 657: header.Bizbot.CreateBot:output_type -> header.Bot
	104, // 658: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	110, // 668: header.Sendback.CreateWebhook:output_type -> header.Webhook
	...
	110, // 672: header.Sendback.ReadWebhook:output_type -> header.Webhook
	110, // 673: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	110, // 674: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	...
	115, // 682: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	...
	115, // 685: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	115, // 686: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	...
	175, // 700: header.Holap.ListConversationIds:output_type -> header.Conversations
	...
	124, // 706: header.Proder.ReadProduct:output_type -> header.Product
	124, // 707: header.Proder.CreateProduct:output_type -> header.Product
	124, // 708: header.Proder.UpdateProduct:output_type -> header.Product
	44,  // 709: header.Proder.DeleteProduct:output_type -> header.Empty
	124, // 710: header.Proder.RestoreProduct:output_type -> header.Product
	126, // 711: header.Proder.ListProducts:output_type -> header.Products
	5,   // 712: header.Proder.ListProductIds:output_type -> header.Ids
	126, // 713: header.Proder.ListGroupedProducts:output_type -> header.Products
	126, // 714: header.Proder.ImportProducts:output_type -> header.Products
	227, // 715: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	127, // 716: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	127, // 717: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	...
	128, // 720: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	128, // 721: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	...
	47,  // 733: header.Proder.MakeOrderPayment:output_type -> header.Event
	47,  // 734: header.Proder.DeleteOrderPayment:output_type -> header.Event
	47,  // 735: header.Proder.AddOrderComment:output_type -> header.Event
	47,  // 736: header.Proder.EditOrderComment:output_type -> header.Event
	47,  // 737: header.Proder.DeleteOrderComment:output_type -> header.Event
	...
	138, // 746: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	...
	126, // 753: header.Proder.VisitProductSite:output_type -> header.Products
	140, // 754: header.Apiece.ReadTask:output_type -> header.Task
	140, // 755: header.Apiece.CreateTask:output_type -> header.Task
	140, // 756: header.Apiece.UpdateTask:output_type -> header.Task
	44,  // 757: header.Apiece.DeleteTask:output_type -> header.Empty
	234, // 758: header.Apiece.ListTasks:output_type -> header.Tasks
	47,  // 759: header.Apiece.AddTaskComment:output_type -> header.Event
	47,  // 760: header.Apiece.EditTaskComment:output_type -> header.Event
	47,  // 761: header.Apiece.DeleteTaskComment:output_type -> header.Event
	235, // 762: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	142, // 763: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	142, // 764: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	142, // 765: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
