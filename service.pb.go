...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x6f, 0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf6, 0x08,
	...
	0x74, 0x12, 0x28, 0x0a, 0x0a, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12,
	...
	0x70, 0x73, 0x65, 0x72, 0x74, 0x56, 0x69, 0x65, 0x77, 0x12, 0x10, 0x2e, 0x68, 0x65, 0x61, 0x64,
	...
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x73, 0x12, 0x3b, 0x0a, 0x0f, 0x4c,
	0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x56, 0x69, 0x65, 0x77, 0x73, 0x12, 0x19,
	...
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x2b, 0x0a, 0x0b, 0x55, 0x70, 0x73, 0x65,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x71, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x50, 0x65,
	...
	0x65, 0x63, 0x6b, 0x73, 0x32, 0xc9, 0x05, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61, 0x70, 0x12, 0x2f,
	...
	0x32, 0xf5, 0x01, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x0c, 0x4c,
	0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x0b, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x73, 0x1a, 0x10, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x2a, 0x0a, 0x0b, 0x52, 0x65,
	0x61, 0x64, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64,
...
var file_service_proto_depIdxs = []int32{
	...
	42,  // 99: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	43,  // 100: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	43,  // 101: header.ConversationMgr.MarkReadConversation:input_type -> header.Conversation
	44,  // 102: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	1,   // 103: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	45,  // 104: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	1,   // 105: header.ConversationMgr.UpdatePresence:input_type -> header.Id
	46,  // 106: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	46,  // 107: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	1,   // 108: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	1,   // 109: header.TemplateMgr.GetTemplate:input_type -> header.Id
	47,  // 110: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	1,   // 111: header.TemplateMgr.PickTemplate:input_type -> header.Id
	48,  // 112: header.TagMgr.CreateTag:input_type -> header.Tag
	48,  // 113: header.TagMgr.UpdateTag:input_type -> header.Tag
	...
	49,  // 119: header.IntegrationMgr.Integrate:input_type -> header.Integration
	50,  // 120: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	51,  // 121: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	38,  // 122: header.ConversationEventReader.SendMessage:input_type -> header.Event
	38,  // 123: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	38,  // 124: header.ConversationEventReader.PinMessage:input_type -> header.Event
	38,  // 125: header.ConversationEventReader.UnpinMessage:input_type -> header.Event
	52,  // 126: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	53,  // 127: header.FileMgr.Presign:input_type -> header.FileHeader
	54,  // 128: header.FileMgr.Read:input_type -> header.FileRequest
	54,  // 129: header.FileMgr.Uploaded:input_type -> header.FileRequest
	...
	32,  // 153: header.PaymentMgr.ListPlans:input_type -> header.Empty
	...
	32,  // 167: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	...
	38,  // 227: header.Sendback.SendWebhookEvent:input_type -> header.Event
	...
	48,  // 242: header.Holap.AppendTagSet:input_type -> header.Tag
	17,  // 243: header.Holap.UpdateUser:input_type -> header.User
	43,  // 244: header.Holap.UpdateConversation:input_type -> header.Conversation
	38,  // 245: header.Holap.OnConversationEvent:input_type -> header.Event
	...
	19,  // 253: header.Proder.ListProducts:input_type -> header.Ids
	1,   // 254: header.Proder.ReadProduct:input_type -> header.Id
	106, // 255: header.Proder.CreateProduct:input_type -> header.Product
	106, // 256: header.Proder.UpdateProduct:input_type -> header.Product
	1,   // 257: header.Proder.DeleteProduct:input_type -> header.Id
	0,   // 258: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 259: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 260: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	32,  // 261: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 262: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 263: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 264: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	32,  // 265: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 266: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 267: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 268: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 269: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 270: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 271: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 272: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 273: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 274: header.AccountMgr.CreateAccount:output_type -> account.Account
	107, // 275: header.AccountMgr.ListAgents:output_type -> account.Agents
	32,  // 276: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	108, // 277: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	32,  // 278: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	32,  // 279: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 280: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	109, // 281: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 282: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 283: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	110, // 284: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	32,  // 285: header.AccountMgr.LogoutSession:output_type -> header.Empty
	111, // 286: header.AccountMgr.GetLanguage:output_type -> header.Lang
	11,  // 287: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	12,  // 288: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	112, // 289: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	113, // 290: header.UserMgr.SearchUsers:output_type -> header.Users
	114, // 291: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	114, // 292: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	16,  // 293: header.UserMgr.MergeUser:output_type -> header.UserAlias
	...
	115, // 298: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	113, // 299: header.UserMgr.MatchUsers:output_type -> header.Users
	20,  // 300: header.UserMgr.UpsertView:output_type -> header.UserView
	32,  // 301: header.UserMgr.DeleteView:output_type -> header.Empty
	20,  // 302: header.UserMgr.GetView:output_type -> header.UserView
	116, // 303: header.UserMgr.ListViews:output_type -> header.UserViews
	113, // 304: header.UserMgr.ListUserInViews:output_type -> header.Users
	22,  // 305: header.UserMgr.UpsertLabel:output_type -> header.Label
	32,  // 306: header.UserMgr.DeleteLabel:output_type -> header.Empty
	117, // 307: header.UserMgr.ListLabels:output_type -> header.Labels
	22,  // 308: header.UserMgr.GetLabel:output_type -> header.Label
	32,  // 309: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	32,  // 310: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	32,  // 311: header.UserMgr.AddUserLabel:output_type -> header.Empty
	32,  // 312: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	32,  // 313: header.UserPersist.UpdateUser:output_type -> header.Empty
	113, // 314: header.UserPersist.FilterUsers:output_type -> header.Users
	118, // 315: header.LiveMgr.SearchLocations:output_type -> header.Locations
	113, // 316: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	119, // 317: header.LiveMgr.TopEvents:output_type -> header.Events
	120, // 318: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	121, // 319: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	122, // 320: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	123, // 321: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	124, // 322: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	125, // 323: header.NoteMgr.ListNotes:output_type -> header.Notes
	29,  // 324: header.NoteMgr.AddNote:output_type -> header.Note
	29,  // 325: header.NoteMgr.UpdateNote:output_type -> header.Note
	32,  // 326: header.NoteMgr.DeleteNote:output_type -> header.Empty
	126, // 327: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	31,  // 328: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	32,  // 329: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	31,  // 330: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	31,  // 331: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	127, // 332: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	33,  // 333: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	33,  // 334: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	32,  // 335: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	128, // 336: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	36,  // 337: header.RuleMgr.UpdateRule:output_type -> header.Rule
	36,  // 338: header.RuleMgr.CreateRule:output_type -> header.Rule
	32,  // 339: header.RuleMgr.DeleteRule:output_type -> header.Empty
	36,  // 340: header.RuleMgr.ReadRule:output_type -> header.Rule
	129, // 341: header.RuleMgr.ListRules:output_type -> header.Route
	130, // 342: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 343: header.ConversationMgr.PongMessage:output_type -> header.Event
	43,  // 344: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	43,  // 345: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	43,  // 346: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	131, // 347: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	131, // 348: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	32,  // 349: header.ConversationMgr.TagConversation:output_type -> header.Empty
	32,  // 350: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	32,  // 351: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	32,  // 352: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	32,  // 353: header.ConversationMgr.Typing:output_type -> header.Empty
	43,  // 354: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	131, // 355: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	32,  // 356: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	32,  // 357: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	32,  // 358: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	32,  // 359: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	44,  // 360: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	44,  // 361: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 362: header.ConversationMgr.TerminateBot:output_type -> header.Event
	132, // 363: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 364: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	46,  // 365: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	32,  // 366: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	46,  // 367: header.TemplateMgr.GetTemplate:output_type -> header.Template
	133, // 368: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	32,  // 369: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	48,  // 370: header.TagMgr.CreateTag:output_type -> header.Tag
	48,  // 371: header.TagMgr.UpdateTag:output_type -> header.Tag
	32,  // 372: header.TagMgr.DeleteTag:output_type -> header.Empty
	134, // 373: header.TagMgr.ListTags:output_type -> header.Tags
	48,  // 374: header.TagMgr.GetTag:output_type -> header.Tag
	32,  // 375: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	135, // 376: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	49,  // 377: header.IntegrationMgr.Integrate:output_type -> header.Integration
	119, // 378: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 379: header.EventMgr.CreateEvent:output_type -> header.Event
	38,  // 380: header.ConversationEventReader.SendMessage:output_type -> header.Event
	38,  // 381: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	32,  // 382: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	32,  // 383: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	119, // 384: header.ConversationEventReader.ListEvents:output_type -> header.Events
	136, // 385: header.FileMgr.Presign:output_type -> header.PresignResult
	137, // 386: header.FileMgr.Read:output_type -> header.File
	137, // 387: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 388: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 389: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	32,  // 390: header.Noti5Service.Noti:output_type -> header.Empty
	32,  // 391: header.Noti5Service.AddToken:output_type -> header.Empty
	32,  // 392: header.Noti5Service.RemoveToken:output_type -> header.Empty
	32,  // 393: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 394: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	138, // 395: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 396: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 397: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 398: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 399: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 400: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	32,  // 401: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	139, // 402: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 403: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 404: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 405: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	140, // 406: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 407: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 408: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	141, // 409: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 410: header.PaymentMgr.AddComment:output_type -> payment.Comment
	142, // 411: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 412: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 413: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 414: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 415: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	143, // 416: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 417: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 418: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	32,  // 419: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 420: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	144, // 421: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	32,  // 422: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 423: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 424: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	145, // 425: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 426: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	146, // 427: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	147, // 428: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	148, // 429: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	32,  // 430: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	32,  // 431: header.Pubsub.Publish:output_type -> header.Empty
	32,  // 432: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 433: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 434: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	149, // 435: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	150, // 436: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 437: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 438: header.WidgetService.Update:output_type -> header.WidgetSetting
	151, // 439: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	152, // 440: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	80,  // 441: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 442: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 443: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	153, // 444: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	154, // 445: header.WidgetService.ListConversions:output_type -> header.Conversions
	155, // 446: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 447: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	156, // 448: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	32,  // 449: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	157, // 450: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	86,  // 451: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	86,  // 452: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	86,  // 453: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	32,  // 454: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	86,  // 455: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	157, // 456: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	32,  // 457: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	158, // 458: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	156, // 459: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	159, // 460: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	160, // 461: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	161, // 462: header.Bizbot.ListBots:output_type -> header.Bots
	88,  // 463: header.Bizbot.GetBot:output_type -> header.Bot
	88,  // 464: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	88,  // 465: header.Bizbot.CreateBot:output_type -> header.Bot
	88,  // 466: header.Bizbot.UpdateBot:output_type -> header.Bot
	32,  // 467: header.Bizbot.DeleteBot:output_type -> header.Empty
	32,  // 468: header.Bizbot.OnEvent:output_type -> header.Empty
	32,  // 469: header.Bizbot.StartBot:output_type -> header.Empty
	32,  // 470: header.Bizbot.StopBot:output_type -> header.Empty
	32,  // 471: header.Bizbot.TryAction:output_type -> header.Empty
	162, // 472: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	163, // 473: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	88,  // 474: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	161, // 475: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	92,  // 476: header.Sendback.CreateWebhook:output_type -> header.Webhook
	164, // 477: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	32,  // 478: header.Sendback.DeleteWebhook:output_type -> header.Empty
	165, // 479: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	92,  // 480: header.Sendback.ReadWebhook:output_type -> header.Webhook
	92,  // 481: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	92,  // 482: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	166, // 483: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	167, // 484: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	32,  // 485: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	32,  // 486: header.Notibox.Send:output_type -> header.Empty
	32,  // 487: header.Notibox.MarkRead:output_type -> header.Empty
	32,  // 488: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	168, // 489: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	98,  // 490: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	32,  // 491: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	169, // 492: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	98,  // 493: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	98,  // 494: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	170, // 495: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	171, // 496: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	172, // 497: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	170, // 498: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	32,  // 499: header.Holap.AppendAgentSet:output_type -> header.Empty
	32,  // 500: header.Holap.AppendTagSet:output_type -> header.Empty
	32,  // 501: header.Holap.UpdateUser:output_type -> header.Empty
	32,  // 502: header.Holap.UpdateConversation:output_type -> header.Empty
	32,  // 503: header.Holap.OnConversationEvent:output_type -> header.Empty
	32,  // 504: header.Holap.FreeAccount:output_type -> header.Empty
	173, // 505: header.Holap.ReportUser:output_type -> header.UserMetrics
	174, // 506: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 507: header.Holap.ListUserIds:output_type -> header.Ids
	131, // 508: header.Holap.ListConversationIds:output_type -> header.Conversations
	175, // 509: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 510: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	176, // 511: header.Proder.ListProducts:output_type -> header.Products
	106, // 512: header.Proder.ReadProduct:output_type -> header.Product
	106, // 513: header.Proder.CreateProduct:output_type -> header.Product
	106, // 514: header.Proder.UpdateProduct:output_type -> header.Product
	32,  // 515: header.Proder.DeleteProduct:output_type -> header.Empty
	258, // [258:516] is the sub-list for method output_type
	0,   // [0:258] is the sub-list for method input_type
