...
var file_service_proto_rawDesc = []byte{
	...
	0x1a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd1, 0x0f,
	...
	0x79, 0x32, 0xf0, 0x07, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72, 0x12, 0x33, 0x0a,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Currency)(nil),                          // 119: header.Currency
...
var file_service_proto_depIdxs = []int32{
	...
	15,  // 37: header.UserMgr.SearchUsers:input_type -> header.SearchRequest
	16,  // 38: header.UserMgr.MergeUser:input_type -> header.UserAlias
	17,  // 39: header.UserMgr.CreateUser:input_type -> header.User
	1,   // 40: header.UserMgr.CreateSbzUserByAgent:input_type -> header.Id
	17,  // 41: header.UserMgr.UpdateUser:input_type -> header.User
	1,   // 42: header.UserMgr.ReadUser:input_type -> header.Id
	18,  // 43: header.UserMgr.ReportUserEvents:input_type -> header.UserEventMetricsRequest
	19,  // 44: header.UserMgr.MatchUsers:input_type -> header.Ids
	20,  // 45: header.UserMgr.UpdateView:input_type -> header.UserView
	20,  // 46: header.UserMgr.CreateView:input_type -> header.UserView
	1,   // 47: header.UserMgr.DeleteView:input_type -> header.Id
	1,   // 48: header.UserMgr.GetView:input_type -> header.Id
	1,   // 49: header.UserMgr.ListViews:input_type -> header.Id
	21,  // 50: header.UserMgr.UpsertLabel:input_type -> header.Label
	1,   // 51: header.UserMgr.DeleteLabel:input_type -> header.Id
	1,   // 52: header.UserMgr.ListLabels:input_type -> header.Id
	1,   // 53: header.UserMgr.GetLabel:input_type -> header.Id
	22,  // 54: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	22,  // 55: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	22,  // 56: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	22,  // 57: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	20,  // 58: header.UserPersist.ListUsersInView:input_type -> header.UserView
	17,  // 59: header.UserPersist.UpdateUser:input_type -> header.User
	1,   // 60: header.UserPersist.ResyncUsers:input_type -> header.Id
	23,  // 61: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	24,  // 62: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	25,  // 63: header.LiveMgr.TopEvents:input_type -> header.EventParams
	1,   // 64: header.LiveMgr.TopLocations:input_type -> header.Id
	1,   // 65: header.LiveMgr.TopPages:input_type -> header.Id
	1,   // 66: header.LiveMgr.TopSources:input_type -> header.Id
	1,   // 67: header.LiveMgr.CountActiveUsers:input_type -> header.Id
	26,  // 68: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	27,  // 69: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	28,  // 70: header.NoteMgr.AddNote:input_type -> header.Note
	28,  // 71: header.NoteMgr.UpdateNote:input_type -> header.Note
	29,  // 72: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	1,   // 73: header.AutomationMgr.ListAutomations:input_type -> header.Id
	30,  // 74: header.AutomationMgr.UpdateAutomation:input_type -> header.Automation
	1,   // 75: header.AutomationMgr.DeleteAutomation:input_type -> header.Id
	1,   // 76: header.AutomationMgr.ReadAutomation:input_type -> header.Id
	31,  // 77: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	32,  // 78: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	32,  // 79: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	33,  // 80: header.AttributeMgr.DeleteAttributeDefinition:input_type -> header.DeleteAttrRequest
	34,  // 81: header.ConversationReporter.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	35,  // 82: header.RuleMgr.UpdateRule:input_type -> header.Rule
	35,  // 83: header.RuleMgr.CreateRule:input_type -> header.Rule
	1,   // 84: header.RuleMgr.DeleteRule:input_type -> header.Id
	1,   // 85: header.RuleMgr.ReadRule:input_type -> header.Id
	1,   // 86: header.RuleMgr.ListRules:input_type -> header.Id
	36,  // 87: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	37,  // 88: header.ConversationMgr.PongMessage:input_type -> header.Event
	38,  // 89: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	1,   // 90: header.ConversationMgr.EndConversation:input_type -> header.Id
	1,   // 91: header.ConversationMgr.GetConversation:input_type -> header.Id
	39,  // 92: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	19,  // 93: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	40,  // 94: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	40,  // 95: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	41,  // 96: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	41,  // 97: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	1,   // 98: header.ConversationMgr.Typing:input_type -> header.Id
	42,  // 99: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	15,  // 100: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	42,  // 101: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	41,  // 102: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	42,  // 103: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	42,  // 104: header.ConversationMgr.MarkReadConversation:input_type -> header.Conversation
	43,  // 105: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	1,   // 106: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	44,  // 107: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	1,   // 108: header.ConversationMgr.UpdatePresence:input_type -> header.Id
	45,  // 109: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	45,  // 110: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	1,   // 111: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	1,   // 112: header.TemplateMgr.GetTemplate:input_type -> header.Id
	46,  // 113: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	1,   // 114: header.TemplateMgr.PickTemplate:input_type -> header.Id
	47,  // 115: header.TagMgr.CreateTag:input_type -> header.Tag
	47,  // 116: header.TagMgr.UpdateTag:input_type -> header.Tag
	1,   // 117: header.TagMgr.DeleteTag:input_type -> header.Id
	1,   // 118: header.TagMgr.ListTags:input_type -> header.Id
	1,   // 119: header.TagMgr.GetTag:input_type -> header.Id
	1,   // 120: header.IntegrationMgr.Deintegrate:input_type -> header.Id
	1,   // 121: header.IntegrationMgr.ListIntegrations:input_type -> header.Id
	48,  // 122: header.IntegrationMgr.Integrate:input_type -> header.Integration
	49,  // 123: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	50,  // 124: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	37,  // 125: header.ConversationEventReader.SendMessage:input_type -> header.Event
	37,  // 126: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	37,  // 127: header.ConversationEventReader.PinMessage:input_type -> header.Event
	37,  // 128: header.ConversationEventReader.UnpinMessage:input_type -> header.Event
	51,  // 129: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	52,  // 130: header.FileMgr.Presign:input_type -> header.FileHeader
	53,  // 131: header.FileMgr.Uploaded:input_type -> header.FileRequest
	54,  // 132: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	1,   // 133: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	55,  // 134: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	56,  // 135: header.Noti5Service.Noti:input_type -> header.PushNoti
	57,  // 136: header.Noti5Service.AddToken:input_type -> noti5.Token
	57,  // 137: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	57,  // 138: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	58,  // 139: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	59,  // 140: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	60,  // 141: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	60,  // 142: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 143: header.PaymentMgr.GetSubscription:input_type -> header.Id
	61,  // 144: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	61,  // 145: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	1,   // 146: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	1,   // 147: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	62,  // 148: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	63,  // 149: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	63,  // 150: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	64,  // 151: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	60,  // 152: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	65,  // 153: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	66,  // 154: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	67,  // 155: header.PaymentMgr.AddComment:input_type -> payment.Comment
	31,  // 156: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 157: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	63,  // 158: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	68,  // 159: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	62,  // 160: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	69,  // 161: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	70,  // 162: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	71,  // 163: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	72,  // 164: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	72,  // 165: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	73,  // 166: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 167: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	74,  // 168: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 169: header.PaymentMgr.GetReferral:input_type -> header.Id
	31,  // 170: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	75,  // 171: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	1,   // 172: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	1,   // 173: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	1,   // 174: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	76,  // 175: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	77,  // 176: header.Pubsub.Publish:input_type -> header.PublishMessage
	77,  // 177: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 178: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	78,  // 179: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	1,   // 180: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	1,   // 181: header.FabikonService.ListFbPosts:input_type -> header.Id
	1,   // 182: header.WidgetService.Read:input_type -> header.Id
	79,  // 183: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 184: header.WidgetService.ReadUserSetting:input_type -> header.Id
	1,   // 185: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	80,  // 186: header.WidgetService.SubmitImpression:input_type -> header.Impression
	81,  // 187: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	82,  // 188: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	83,  // 189: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	84,  // 190: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	84,  // 191: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	85,  // 192: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 193: header.WidgetService.ListUploadedImage:input_type -> header.Id
	85,  // 194: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 195: header.WidgetService.ListWebPlugins:input_type -> header.Id
	86,  // 196: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	86,  // 197: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	86,  // 198: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 199: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	86,  // 200: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	1,   // 201: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	1,   // 202: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	87,  // 203: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	1,   // 204: header.WidgetService.SearchImages:input_type -> header.Id
	1,   // 205: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	1,   // 206: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	1,   // 207: header.Bizbot.ListBots:input_type -> header.Id
	1,   // 208: header.Bizbot.GetBot:input_type -> header.Id
	88,  // 209: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	88,  // 210: header.Bizbot.CreateBot:input_type -> header.Bot
	88,  // 211: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 212: header.Bizbot.DeleteBot:input_type -> header.Id
	89,  // 213: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	89,  // 214: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	89,  // 215: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	89,  // 216: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	90,  // 217: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	91,  // 218: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	88,  // 219: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 220: header.Bizbot.ListBotRevisions:input_type -> header.Id
	92,  // 221: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 222: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 223: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 224: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 225: header.Sendback.ReadWebhook:input_type -> header.Id
	92,  // 226: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 227: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	93,  // 228: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	94,  // 229: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	37,  // 230: header.Sendback.SendWebhookEvent:input_type -> header.Event
	95,  // 231: header.Notibox.Send:input_type -> header.Notification
	1,   // 232: header.Notibox.MarkRead:input_type -> header.Id
	96,  // 233: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	97,  // 234: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	98,  // 235: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 236: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 237: header.Watchhttp.ListWebpages:input_type -> header.Id
	98,  // 238: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 239: header.Watchhttp.ReadWebpage:input_type -> header.Id
	99,  // 240: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	100, // 241: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	101, // 242: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	101, // 243: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	4,   // 244: header.Holap.AppendAgentSet:input_type -> account.Agent
	47,  // 245: header.Holap.AppendTagSet:input_type -> header.Tag
	17,  // 246: header.Holap.UpdateUser:input_type -> header.User
	42,  // 247: header.Holap.UpdateConversation:input_type -> header.Conversation
	37,  // 248: header.Holap.OnConversationEvent:input_type -> header.Event
	102, // 249: header.Holap.FreeAccount:input_type -> header.AccountImage
	103, // 250: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	104, // 251: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	103, // 252: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	104, // 253: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	105, // 254: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	19,  // 255: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	18,  // 256: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	106, // 257: header.Proder.ReadProduct:input_type -> header.Product
	106, // 258: header.Proder.CreateProduct:input_type -> header.Product
	106, // 259: header.Proder.UpdateProduct:input_type -> header.Product
	1,   // 260: header.Proder.DeleteProduct:input_type -> header.Id
	107, // 261: header.Proder.ListProducts:input_type -> header.ProductsRequest
	19,  // 262: header.Proder.ListProductIds:input_type -> header.Ids
	107, // 263: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	19,  // 264: header.Proder.ListProductCollections:input_type -> header.Ids
	108, // 265: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	108, // 266: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	1,   // 267: header.Proder.DeleteProductCollection:input_type -> header.Id
	19,  // 268: header.Proder.ListProductFeeds:input_type -> header.Ids
	109, // 269: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	109, // 270: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	1,   // 271: header.Proder.DeleteProductFeed:input_type -> header.Id
	19,  // 272: header.Proder.ListProductCategories:input_type -> header.Ids
	19,  // 273: header.Proder.ListProductProps:input_type -> header.Ids
	1,   // 274: header.Proder.ReadOrder:input_type -> header.Id
	110, // 275: header.Proder.CreateOrder:input_type -> header.Order
	110, // 276: header.Proder.UpdateOrder:input_type -> header.Order
	1,   // 277: header.Proder.DeleteOrder:input_type -> header.Id
	111, // 278: header.Proder.ListOrders:input_type -> header.OrdersRequest
	112, // 279: header.Proder.MakePayment:input_type -> header.Bill
	1,   // 280: header.Proder.DeleteOrderHistoryEntry:input_type -> header.Id
	0,   // 281: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 282: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 283: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	31,  // 284: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 285: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 286: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 287: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	31,  // 288: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 289: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 290: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 291: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 292: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 293: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 294: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 295: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 296: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 297: header.AccountMgr.CreateAccount:output_type -> account.Account
	113, // 298: header.AccountMgr.ListAgents:output_type -> account.Agents
	31,  // 299: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	114, // 300: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	31,  // 301: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	31,  // 302: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 303: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	115, // 304: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 305: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 306: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	116, // 307: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	116, // 308: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	31,  // 309: header.AccountMgr.LogoutSession:output_type -> header.Empty
	10,  // 310: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	117, // 311: header.AccountMgr.GetLanguage:output_type -> header.Lang
	11,  // 312: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	12,  // 313: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	118, // 314: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	14,  // 315: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	14,  // 316: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	119, // 317: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	120, // 318: header.UserMgr.SearchUsers:output_type -> header.Users
	16,  // 319: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 320: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 321: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	1,   // 322: header.UserMgr.UpdateUser:output_type -> header.Id
	17,  // 323: header.UserMgr.ReadUser:output_type -> header.User
	121, // 324: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	120, // 325: header.UserMgr.MatchUsers:output_type -> header.Users
	20,  // 326: header.UserMgr.UpdateView:output_type -> header.UserView
	20,  // 327: header.UserMgr.CreateView:output_type -> header.UserView
	31,  // 328: header.UserMgr.DeleteView:output_type -> header.Empty
	20,  // 329: header.UserMgr.GetView:output_type -> header.UserView
	122, // 330: header.UserMgr.ListViews:output_type -> header.UserViews
	21,  // 331: header.UserMgr.UpsertLabel:output_type -> header.Label
	31,  // 332: header.UserMgr.DeleteLabel:output_type -> header.Empty
	123, // 333: header.UserMgr.ListLabels:output_type -> header.Labels
	21,  // 334: header.UserMgr.GetLabel:output_type -> header.Label
	31,  // 335: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	31,  // 336: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	31,  // 337: header.UserMgr.AddUserLabel:output_type -> header.Empty
	31,  // 338: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	120, // 339: header.UserPersist.ListUsersInView:output_type -> header.Users
	31,  // 340: header.UserPersist.UpdateUser:output_type -> header.Empty
	31,  // 341: header.UserPersist.ResyncUsers:output_type -> header.Empty
	124, // 342: header.LiveMgr.SearchLocations:output_type -> header.Locations
	120, // 343: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	125, // 344: header.LiveMgr.TopEvents:output_type -> header.Events
	126, // 345: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	127, // 346: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	128, // 347: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	129, // 348: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	130, // 349: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	131, // 350: header.NoteMgr.ListNotes:output_type -> header.Notes
	28,  // 351: header.NoteMgr.AddNote:output_type -> header.Note
	28,  // 352: header.NoteMgr.UpdateNote:output_type -> header.Note
	31,  // 353: header.NoteMgr.DeleteNote:output_type -> header.Empty
	132, // 354: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	30,  // 355: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	31,  // 356: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	30,  // 357: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	133, // 358: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	32,  // 359: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	32,  // 360: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	31,  // 361: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	134, // 362: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	35,  // 363: header.RuleMgr.UpdateRule:output_type -> header.Rule
	35,  // 364: header.RuleMgr.CreateRule:output_type -> header.Rule
	31,  // 365: header.RuleMgr.DeleteRule:output_type -> header.Empty
	35,  // 366: header.RuleMgr.ReadRule:output_type -> header.Rule
	135, // 367: header.RuleMgr.ListRules:output_type -> header.Route
	136, // 368: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	37,  // 369: header.ConversationMgr.PongMessage:output_type -> header.Event
	42,  // 370: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	42,  // 371: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	42,  // 372: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	137, // 373: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	137, // 374: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	31,  // 375: header.ConversationMgr.TagConversation:output_type -> header.Empty
	31,  // 376: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	31,  // 377: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	31,  // 378: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	31,  // 379: header.ConversationMgr.Typing:output_type -> header.Empty
	42,  // 380: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	137, // 381: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	31,  // 382: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	31,  // 383: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	31,  // 384: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	31,  // 385: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	43,  // 386: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	43,  // 387: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	37,  // 388: header.ConversationMgr.TerminateBot:output_type -> header.Event
	138, // 389: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	45,  // 390: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	45,  // 391: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	31,  // 392: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	45,  // 393: header.TemplateMgr.GetTemplate:output_type -> header.Template
	139, // 394: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	31,  // 395: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	47,  // 396: header.TagMgr.CreateTag:output_type -> header.Tag
	47,  // 397: header.TagMgr.UpdateTag:output_type -> header.Tag
	31,  // 398: header.TagMgr.DeleteTag:output_type -> header.Empty
	140, // 399: header.TagMgr.ListTags:output_type -> header.Tags
	47,  // 400: header.TagMgr.GetTag:output_type -> header.Tag
	31,  // 401: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	141, // 402: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	48,  // 403: header.IntegrationMgr.Integrate:output_type -> header.Integration
	125, // 404: header.EventMgr.SearchEvents:output_type -> header.Events
	37,  // 405: header.EventMgr.CreateEvent:output_type -> header.Event
	37,  // 406: header.ConversationEventReader.SendMessage:output_type -> header.Event
	37,  // 407: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	31,  // 408: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	31,  // 409: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	125, // 410: header.ConversationEventReader.ListEvents:output_type -> header.Events
	142, // 411: header.FileMgr.Presign:output_type -> header.PresignResult
	143, // 412: header.FileMgr.Uploaded:output_type -> header.File
	143, // 413: header.FileMgr.DownloadFileUrl:output_type -> header.File
	55,  // 414: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 415: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	31,  // 416: header.Noti5Service.Noti:output_type -> header.Empty
	31,  // 417: header.Noti5Service.AddToken:output_type -> header.Empty
	31,  // 418: header.Noti5Service.RemoveToken:output_type -> header.Empty
	31,  // 419: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 420: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	144, // 421: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 422: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 423: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 424: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 425: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 426: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	31,  // 427: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	145, // 428: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 429: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 430: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 431: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	146, // 432: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 433: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 434: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	147, // 435: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 436: header.PaymentMgr.AddComment:output_type -> payment.Comment
	148, // 437: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 438: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 439: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 440: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 441: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	149, // 442: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 443: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 444: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	31,  // 445: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 446: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	150, // 447: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	31,  // 448: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 449: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 450: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	151, // 451: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 452: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	152, // 453: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	153, // 454: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	154, // 455: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	31,  // 456: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	31,  // 457: header.Pubsub.Publish:output_type -> header.Empty
	31,  // 458: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 459: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 460: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	155, // 461: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	156, // 462: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 463: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 464: header.WidgetService.Update:output_type -> header.WidgetSetting
	157, // 465: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	158, // 466: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	80,  // 467: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 468: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 469: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	159, // 470: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	160, // 471: header.WidgetService.ListConversions:output_type -> header.Conversions
	161, // 472: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 473: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	162, // 474: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	31,  // 475: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	163, // 476: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	86,  // 477: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	86,  // 478: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	86,  // 479: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	31,  // 480: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	86,  // 481: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	163, // 482: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	31,  // 483: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	164, // 484: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	162, // 485: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	165, // 486: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	166, // 487: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	167, // 488: header.Bizbot.ListBots:output_type -> header.Bots
	88,  // 489: header.Bizbot.GetBot:output_type -> header.Bot
	88,  // 490: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	88,  // 491: header.Bizbot.CreateBot:output_type -> header.Bot
	88,  // 492: header.Bizbot.UpdateBot:output_type -> header.Bot
	31,  // 493: header.Bizbot.DeleteBot:output_type -> header.Empty
	31,  // 494: header.Bizbot.OnEvent:output_type -> header.Empty
	31,  // 495: header.Bizbot.StartBot:output_type -> header.Empty
	31,  // 496: header.Bizbot.StopBot:output_type -> header.Empty
	31,  // 497: header.Bizbot.TryAction:output_type -> header.Empty
	168, // 498: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	169, // 499: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	88,  // 500: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	167, // 501: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	92,  // 502: header.Sendback.CreateWebhook:output_type -> header.Webhook
	170, // 503: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	31,  // 504: header.Sendback.DeleteWebhook:output_type -> header.Empty
	171, // 505: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	92,  // 506: header.Sendback.ReadWebhook:output_type -> header.Webhook
	92,  // 507: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	92,  // 508: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	172, // 509: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	173, // 510: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	31,  // 511: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	31,  // 512: header.Notibox.Send:output_type -> header.Empty
	31,  // 513: header.Notibox.MarkRead:output_type -> header.Empty
	31,  // 514: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	174, // 515: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	98,  // 516: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	31,  // 517: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	175, // 518: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	98,  // 519: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	98,  // 520: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	176, // 521: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	177, // 522: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	178, // 523: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	176, // 524: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	31,  // 525: header.Holap.AppendAgentSet:output_type -> header.Empty
	31,  // 526: header.Holap.AppendTagSet:output_type -> header.Empty
	31,  // 527: header.Holap.UpdateUser:output_type -> header.Empty
	31,  // 528: header.Holap.UpdateConversation:output_type -> header.Empty
	31,  // 529: header.Holap.OnConversationEvent:output_type -> header.Empty
	31,  // 530: header.Holap.FreeAccount:output_type -> header.Empty
	179, // 531: header.Holap.ReportUser:output_type -> header.UserMetrics
	180, // 532: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 533: header.Holap.ListUserIds:output_type -> header.Ids
	137, // 534: header.Holap.ListConversationIds:output_type -> header.Conversations
	181, // 535: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 536: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	121, // 537: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	106, // 538: header.Proder.ReadProduct:output_type -> header.Product
	106, // 539: header.Proder.CreateProduct:output_type -> header.Product
	106, // 540: header.Proder.UpdateProduct:output_type -> header.Product
	31,  // 541: header.Proder.DeleteProduct:output_type -> header.Empty
	182, // 542: header.Proder.ListProducts:output_type -> header.Products
	19,  // 543: header.Proder.ListProductIds:output_type -> header.Ids
	182, // 544: header.Proder.ListGroupedProducts:output_type -> header.Products
	183, // 545: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	108, // 546: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	108, // 547: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	31,  // 548: header.Proder.DeleteProductCollection:output_type -> header.Empty
	184, // 549: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	109, // 550: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	109, // 551: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	31,  // 552: header.Proder.DeleteProductFeed:output_type -> header.Empty
	185, // 553: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	186, // 554: header.Proder.ListProductProps:output_type -> header.ProductProps
	110, // 555: header.Proder.ReadOrder:output_type -> header.Order
	110, // 556: header.Proder.CreateOrder:output_type -> header.Order
	110, // 557: header.Proder.UpdateOrder:output_type -> header.Order
	31,  // 558: header.Proder.DeleteOrder:output_type -> header.Empty
	187, // 559: header.Proder.ListOrders:output_type -> header.Orders
	112, // 560: header.Proder.MakePayment:output_type -> header.Bill
	31,  // 561: header.Proder.DeleteOrderHistoryEntry:output_type -> header.Empty
