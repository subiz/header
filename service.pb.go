...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb6, 0x19, 0x0a, 0x0f, 0x43, 0x6f,
	...
	0x2e, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2f, 0x0a, 0x0c,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x0a, 0x2e, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x13, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65,
	...
	0x89, 0x04, 0x0a, 0x0e, 0x46, 0x61, 0x62, 0x69, 0x6b, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x32, 0xac, 0x03, 0x0a, 0x0e,
...
var file_service_proto_depIdxs = []int32{
	...
	14,  // 212: header.ConversationMgr.ActiveNumber:input_type -> header.Id
...
type ConversationMgrClient interface {
	...
	ActiveNumber(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Integration, error)
...
func (c *conversationMgrClient) ActiveNumber(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Integration, error) {
	out := new(Integration)
...
type ConversationMgrServer interface {
	...
	ActiveNumber(context.Context, *Id) (*Integration, error)
...
func (*UnimplementedConversationMgrServer) ActiveNumber(context.Context, *Id) (*Integration, error) {
...
func _ConversationMgr_ActiveNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationMgrServer).ActiveNumber(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
