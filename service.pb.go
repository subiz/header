...
var file_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x92, 0x0c, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72,
	0x12, 0x29, 0x0a, 0x0a, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x55, 0x73, 0x65, 0x72, 0x32, 0x12, 0x0d,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x1a, 0x0c, 0x2e,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x0a, 0x43,
	...
	0x72, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x32, 0xbe, 0x03, 0x0a, 0x07, 0x4c, 0x69,
	...
	0x75, 0x74, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb7, 0x11,
	...
	0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xab, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x6d, 0x70,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*LocationParams)(nil),                    // 37: header.LocationParams
	(*UserInfoParams)(nil),                    // 38: header.UserInfoParams
	(*EventParams)(nil),                       // 39: header.EventParams
	(*PresencesRequest)(nil),                  // 40: header.PresencesRequest
	(*ListNotesRequest)(nil),                  // 41: header.ListNotesRequest
	(*Note)(nil),                              // 42: header.Note
	(*DeleteNoteRequest)(nil),                 // 43: header.DeleteNoteRequest
	(*Empty)(nil),                             // 44: header.Empty
	(*AttributeDefinition)(nil),               // 45: header.AttributeDefinition
	(*AssignRequest)(nil),                     // 46: header.AssignRequest
	(*Event)(nil),                             // 47: header.Event
	(*StartRequest)(nil),                      // 48: header.StartRequest
	(*ListConversationsRequest)(nil),          // 49: header.ListConversationsRequest
	(*TagRequest)(nil),                        // 50: header.TagRequest
	(*ConversationMember)(nil),                // 51: header.ConversationMember
	(*Conversation)(nil),                      // 52: header.Conversation
	(*SearchRequest)(nil),                     // 53: header.SearchRequest
...
var file_service_proto_depIdxs = []int32{
	...
	37,  // 114: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	38,  // 115: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	39,  // 116: header.LiveMgr.TopEvents:input_type -> header.EventParams
	4,   // 117: header.LiveMgr.TopLocations:input_type -> header.Id
	4,   // 118: header.LiveMgr.TopPages:input_type -> header.Id
	4,   // 119: header.LiveMgr.TopSources:input_type -> header.Id
	4,   // 120: header.LiveMgr.CountActiveUsers:input_type -> header.Id
	40,  // 121: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	41,  // 122: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	42,  // 123: header.NoteMgr.AddNote:input_type -> header.Note
	42,  // 124: header.NoteMgr.UpdateNote:input_type -> header.Note
	43,  // 125: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	44,  // 126: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	45,  // 127: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	45,  // 128: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	46,  // 129: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	47,  // 130: header.ConversationMgr.PongMessage:input_type -> header.Event
	48,  // 131: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	4,   // 132: header.ConversationMgr.EndConversation:input_type -> header.Id
	4,   // 133: header.ConversationMgr.GetConversation:input_type -> header.Id
	49,  // 134: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	5,   // 135: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	50,  // 136: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	50,  // 137: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	51,  // 138: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	51,  // 139: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	4,   // 140: header.ConversationMgr.Typing:input_type -> header.Id
	52,  // 141: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	53,  // 142: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	52,  // 143: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	51,  // 144: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	52,  // 145: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	52,  // 146: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	54,  // 147: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	4,   // 148: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	55,  // 149: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	47,  // 150: header.ConversationMgr.SendMessage:input_type -> header.Event
	47,  // 151: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	47,  // 152: header.ConversationMgr.PinMessage:input_type -> header.Event
	47,  // 153: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	56,  // 154: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	4,   // 155: header.ConversationMgr.Deintegrate:input_type -> header.Id
	4,   // 156: header.ConversationMgr.ListIntegrations:input_type -> header.Id
	57,  // 157: header.ConversationMgr.Integrate:input_type -> header.Integration
	4,   // 158: header.ConversationMgr.GetIntegration:input_type -> header.Id
	58,  // 159: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	58,  // 160: header.ConversationMgr.CreateRule:input_type -> header.Rule
	4,   // 161: header.ConversationMgr.DeleteRule:input_type -> header.Id
	4,   // 162: header.ConversationMgr.ReadRule:input_type -> header.Id
	4,   // 163: header.ConversationMgr.ListRules:input_type -> header.Id
	4,   // 164: header.ConversationMgr.ListConversationAutomations:input_type -> header.Id
	59,  // 165: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	4,   // 166: header.ConversationMgr.DeleteConversationAutomation:input_type -> header.Id
	4,   // 167: header.ConversationMgr.ReadConversationAutomation:input_type -> header.Id
	60,  // 168: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	60,  // 169: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 170: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 171: header.TemplateMgr.GetTemplate:input_type -> header.Id
	61,  // 172: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 173: header.TemplateMgr.PickTemplate:input_type -> header.Id
	62,  // 174: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	62,  // 175: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	4,   // 176: header.TemplateMgr.DeleteModal:input_type -> header.Id
	4,   // 177: header.TemplateMgr.GetModal:input_type -> header.Id
	4,   // 178: header.TemplateMgr.ListModals:input_type -> header.Id
	63,  // 179: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	64,  // 180: header.TagMgr.CreateTag:input_type -> header.Tag
	64,  // 181: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 182: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 183: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 184: header.TagMgr.GetTag:input_type -> header.Id
	65,  // 185: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	66,  // 186: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	67,  // 187: header.FileMgr.Presign:input_type -> header.FileHeader
	68,  // 188: header.FileMgr.Uploaded:input_type -> header.FileRequest
	69,  // 189: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 190: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	70,  // 191: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	71,  // 192: header.Noti5Service.Noti:input_type -> header.PushNoti
	72,  // 193: header.Noti5Service.AddToken:input_type -> noti5.Token
	72,  // 194: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	72,  // 195: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	73,  // 196: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	74,  // 197: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	75,  // 198: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	75,  // 199: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 200: header.PaymentMgr.GetSubscription:input_type -> header.Id
	76,  // 201: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	76,  // 202: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	4,   // 203: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	4,   // 204: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	77,  // 205: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	78,  // 206: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	78,  // 207: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	79,  // 208: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	75,  // 209: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	80,  // 210: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	81,  // 211: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	82,  // 212: header.PaymentMgr.AddComment:input_type -> payment.Comment
	44,  // 213: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 214: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	78,  // 215: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	83,  // 216: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	77,  // 217: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	84,  // 218: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	85,  // 219: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	86,  // 220: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	87,  // 221: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	87,  // 222: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	88,  // 223: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 224: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	89,  // 225: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 226: header.PaymentMgr.GetReferral:input_type -> header.Id
	44,  // 227: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	90,  // 228: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	4,   // 229: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	4,   // 230: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	4,   // 231: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	91,  // 232: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	92,  // 233: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 234: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	93,  // 235: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	4,   // 236: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	4,   // 237: header.FabikonService.ListFbPosts:input_type -> header.Id
	94,  // 238: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	95,  // 239: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	95,  // 240: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	95,  // 241: header.MailkonService.SendEvent:input_type -> header.Events
	4,   // 242: header.MailkonService.ListBlockedEmails:input_type -> header.Id
	4,   // 243: header.MailkonService.BlockEmail:input_type -> header.Id
	4,   // 244: header.MailkonService.UnblockEmail:input_type -> header.Id
	...
	47,  // 293: header.Sendback.SendWebhookEvent:input_type -> header.Event
	114, // 294: header.Notibox.SendNoti:input_type -> header.Notification
	115, // 295: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 296: header.Notibox.MarkReadNoti:input_type -> header.Id
	116, // 297: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 298: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 299: header.Watchhttp.ListWebpages:input_type -> header.Id
	116, // 300: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 301: header.Watchhttp.ReadWebpage:input_type -> header.Id
	117, // 302: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	118, // 303: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	119, // 304: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	119, // 305: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 306: header.Holap.AppendAgentSet:input_type -> account.Agent
	64,  // 307: header.Holap.AppendTagSet:input_type -> header.Tag
	31,  // 308: header.Holap.UpdateUser:input_type -> header.User
	52,  // 309: header.Holap.UpdateConversation:input_type -> header.Conversation
	47,  // 310: header.Holap.OnConversationEvent:input_type -> header.Event
	120, // 311: header.Holap.FreeAccount:input_type -> header.AccountImage
	121, // 312: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	122, // 313: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	121, // 314: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	122, // 315: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	123, // 316: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 317: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	32,  // 318: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 319: header.Holap.UpdateOrder:input_type -> header.Order
	124, // 320: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	36,  // 321: header.Proder.ReadProduct:input_type -> header.Product
	36,  // 322: header.Proder.CreateProduct:input_type -> header.Product
	36,  // 323: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 324: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 325: header.Proder.RestoreProduct:input_type -> header.Id
	125, // 326: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 327: header.Proder.ListProductIds:input_type -> header.Ids
	125, // 328: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	126, // 329: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 330: header.Proder.ListProductCollections:input_type -> header.Ids
	127, // 331: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	127, // 332: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 333: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 334: header.Proder.ListProductFeeds:input_type -> header.Id
	128, // 335: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	128, // 336: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 337: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 338: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 339: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 340: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 341: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 342: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 343: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 344: header.Proder.RestoreOrder:input_type -> header.Id
	129, // 345: header.Proder.ListOrders:input_type -> header.OrdersRequest
	129, // 346: header.Proder.CountOrders:input_type -> header.OrdersRequest
	130, // 347: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	131, // 348: header.Proder.MakeOrderPayment:input_type -> header.Bill
	132, // 349: header.Proder.DeleteOrderPayment:input_type -> header.Key
	47,  // 350: header.Proder.AddOrderComment:input_type -> header.Event
	47,  // 351: header.Proder.EditOrderComment:input_type -> header.Event
	132, // 352: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 353: header.Proder.ListOrderEvents:input_type -> header.Id
	133, // 354: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 355: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	134, // 356: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 357: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	135, // 358: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	136, // 359: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	137, // 360: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	138, // 361: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 362: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 363: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 364: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 365: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 366: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 367: header.Proder.UnfollowOrder:input_type -> header.Id
	139, // 368: header.Proder.VisitProductSite:input_type -> header.VisitProductSiteRequest
	4,   // 369: header.Apiece.ReadTask:input_type -> header.Id
	140, // 370: header.Apiece.CreateTask:input_type -> header.Task
	140, // 371: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 372: header.Apiece.DeleteTask:input_type -> header.Id
	141, // 373: header.Apiece.ListTasks:input_type -> header.TasksRequest
	47,  // 374: header.Apiece.AddTaskComment:input_type -> header.Event
	47,  // 375: header.Apiece.EditTaskComment:input_type -> header.Event
	132, // 376: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 377: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 378: header.Apiece.ReadPipeline:input_type -> header.Id
	142, // 379: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	142, // 380: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 381: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 382: header.Apiece.ListPipelines:input_type -> header.Ids
	143, // 383: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	44,  // 384: header.Search.Index:output_type -> header.Empty
	144, // 385: header.Search.Search:output_type -> header.DocSearchResponse
	44,  // 386: header.Search.AddOwner:output_type -> header.Empty
	145, // 387: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 388: header.Map.LookupAddress:output_type -> header.Address
	146, // 389: header.Map.PredictAddress:output_type -> header.Addresses
	146, // 390: header.Map.ListDistricts:output_type -> header.Addresses
	146, // 391: header.Map.ListProvinces:output_type -> header.Addresses
	146, // 392: header.Map.ListWards:output_type -> header.Addresses
	146, // 393: header.Map.ListStreets:output_type -> header.Addresses
	146, // 394: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 395: header.Map.ReadAddress:output_type -> header.Address
	6,   // 396: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 397: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 398: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	44,  // 399: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 400: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 401: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 402: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	44,  // 403: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 404: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 405: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 406: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 407: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 408: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 409: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 410: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 411: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 412: header.AccountMgr.CreateAccount:output_type -> account.Account
	147, // 413: header.AccountMgr.ListAgents:output_type -> account.Agents
	44,  // 414: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	148, // 415: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	44,  // 416: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	44,  // 417: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 418: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	149, // 419: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 420: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 421: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	150, // 422: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	150, // 423: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	44,  // 424: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 425: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	151, // 426: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 427: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 428: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	152, // 429: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 430: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 431: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	153, // 432: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	44,  // 433: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	146, // 434: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 435: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 436: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	44,  // 437: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	154, // 438: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 439: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 440: header.AccountMgr.UpdateTax:output_type -> header.Tax
	44,  // 441: header.AccountMgr.DeleteTax:output_type -> header.Empty
	155, // 442: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	155, // 443: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 444: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 445: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	44,  // 446: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 447: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	156, // 448: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 449: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	44,  // 450: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	157, // 451: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	25,  // 452: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	25,  // 453: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	44,  // 454: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	44,  // 455: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	158, // 456: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	44,  // 457: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	26,  // 458: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	26,  // 459: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	26,  // 460: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	159, // 461: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 462: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	44,  // 463: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	28,  // 464: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	160, // 465: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	31,  // 466: header.UserMgr.MergeUser2:output_type -> header.User
	...
	31,  // 471: header.UserMgr.ReadUser:output_type -> header.User
	31,  // 472: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	161, // 473: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	30,  // 474: header.UserMgr.MatchUsers:output_type -> header.Users
	33,  // 475: header.UserMgr.UpdateView:output_type -> header.UserView
	33,  // 476: header.UserMgr.CreateView:output_type -> header.UserView
	44,  // 477: header.UserMgr.DeleteView:output_type -> header.Empty
	33,  // 478: header.UserMgr.GetView:output_type -> header.UserView
	162, // 479: header.UserMgr.ListViews:output_type -> header.UserViews
	34,  // 480: header.UserMgr.UpsertLabel:output_type -> header.Label
	44,  // 481: header.UserMgr.DeleteLabel:output_type -> header.Empty
	163, // 482: header.UserMgr.ListLabels:output_type -> header.Labels
	34,  // 483: header.UserMgr.GetLabel:output_type -> header.Label
	...
	164, // 491: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	44,  // 492: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	30,  // 493: header.UserMgr.ListLeads:output_type -> header.Users
	30,  // 494: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	30,  // 495: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	36,  // 496: header.UserMgr.LinkProductUrl:output_type -> header.Product
	165, // 497: header.LiveMgr.SearchLocations:output_type -> header.Locations
	30,  // 498: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	95,  // 499: header.LiveMgr.TopEvents:output_type -> header.Events
	166, // 500: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	167, // 501: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	168, // 502: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	169, // 503: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	170, // 504: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	171, // 505: header.NoteMgr.ListNotes:output_type -> header.Notes
	42,  // 506: header.NoteMgr.AddNote:output_type -> header.Note
	42,  // 507: header.NoteMgr.UpdateNote:output_type -> header.Note
	44,  // 508: header.NoteMgr.DeleteNote:output_type -> header.Empty
	172, // 509: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	45,  // 510: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	45,  // 511: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	173, // 512: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	47,  // 513: header.ConversationMgr.PongMessage:output_type -> header.Event
	52,  // 514: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	52,  // 515: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	52,  // 516: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	174, // 517: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	174, // 518: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	44,  // 519: header.ConversationMgr.TagConversation:output_type -> header.Empty
	44,  // 520: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	44,  // 521: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	44,  // 522: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	44,  // 523: header.ConversationMgr.Typing:output_type -> header.Empty
	52,  // 524: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	174, // 525: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	44,  // 526: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	44,  // 527: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	44,  // 528: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	44,  // 529: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	54,  // 530: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	54,  // 531: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	47,  // 532: header.ConversationMgr.TerminateBot:output_type -> header.Event
	47,  // 533: header.ConversationMgr.SendMessage:output_type -> header.Event
	47,  // 534: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	44,  // 535: header.ConversationMgr.PinMessage:output_type -> header.Empty
	44,  // 536: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	95,  // 537: header.ConversationMgr.ListEvents:output_type -> header.Events
	44,  // 538: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	175, // 539: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	57,  // 540: header.ConversationMgr.Integrate:output_type -> header.Integration
	57,  // 541: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	58,  // 542: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	58,  // 543: header.ConversationMgr.CreateRule:output_type -> header.Rule
	44,  // 544: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	58,  // 545: header.ConversationMgr.ReadRule:output_type -> header.Rule
	176, // 546: header.ConversationMgr.ListRules:output_type -> header.Route
	177, // 547: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	59,  // 548: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	44,  // 549: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	59,  // 550: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	60,  // 551: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	60,  // 552: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	44,  // 553: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	60,  // 554: header.TemplateMgr.GetTemplate:output_type -> header.Template
	178, // 555: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	44,  // 556: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	62,  // 557: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	62,  // 558: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	44,  // 559: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	62,  // 560: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	179, // 561: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	180, // 562: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	64,  // 563: header.TagMgr.CreateTag:output_type -> header.Tag
	64,  // 564: header.TagMgr.UpdateTag:output_type -> header.Tag
	44,  // 565: header.TagMgr.DeleteTag:output_type -> header.Empty
	181, // 566: header.TagMgr.ListTags:output_type -> header.Tags
	64,  // 567: header.TagMgr.GetTag:output_type -> header.Tag
	95,  // 568: header.EventMgr.SearchEvents:output_type -> header.Events
	47,  // 569: header.EventMgr.CreateEvent:output_type -> header.Event
	182, // 570: header.FileMgr.Presign:output_type -> header.PresignResult
	183, // 571: header.FileMgr.Uploaded:output_type -> header.File
	183, // 572: header.FileMgr.DownloadFileUrl:output_type -> header.File
	70,  // 573: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	70,  // 574: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	44,  // 575: header.Noti5Service.Noti:output_type -> header.Empty
	44,  // 576: header.Noti5Service.AddToken:output_type -> header.Empty
	44,  // 577: header.Noti5Service.RemoveToken:output_type -> header.Empty
	44,  // 578: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	73,  // 579: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	184, // 580: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	78,  // 581: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	75,  // 582: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	75,  // 583: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	76,  // 584: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	76,  // 585: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	44,  // 586: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	185, // 587: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	73,  // 588: header.PaymentMgr.Pay:output_type -> payment.Bill
	78,  // 589: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	78,  // 590: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	186, // 591: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	78,  // 592: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	78,  // 593: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	187, // 594: header.PaymentMgr.ListComments:output_type -> payment.Comments
	82,  // 595: header.PaymentMgr.AddComment:output_type -> payment.Comment
	188, // 596: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	86,  // 597: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	86,  // 598: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	83,  // 599: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	73,  // 600: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	189, // 601: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	85,  // 602: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	85,  // 603: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	44,  // 604: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	85,  // 605: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	190, // 606: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	44,  // 607: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	90,  // 608: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	90,  // 609: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	191, // 610: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	90,  // 611: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	192, // 612: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	193, // 613: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	194, // 614: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	44,  // 615: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	44,  // 616: header.Pubsub.Publish:output_type -> header.Empty
	93,  // 617: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	93,  // 618: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	195, // 619: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	196, // 620: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	94,  // 621: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	44,  // 622: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	44,  // 623: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	44,  // 624: header.MailkonService.SendEvent:output_type -> header.Empty
	44,  // 625: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	44,  // 626: header.MailkonService.BlockEmail:output_type -> header.Empty
	44,  // 627: header.MailkonService.UnblockEmail:output_type -> header.Empty
	96,  // 628: header.WidgetService.Read:output_type -> header.WidgetSetting
	96,  // 629: header.WidgetService.Update:output_type -> header.WidgetSetting
	197, // 630: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	198, // 631: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	97,  // 632: header.WidgetService.SubmitImpression:output_type -> header.Impression
	98,  // 633: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	99,  // 634: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	199, // 635: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	200, // 636: header.WidgetService.ListConversions:output_type -> header.Conversions
	201, // 637: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	102, // 638: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	202, // 639: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	44,  // 640: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	203, // 641: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	103, // 642: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	103, // 643: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	103, // 644: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	44,  // 645: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	103, // 646: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	203, // 647: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	44,  // 648: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	204, // 649: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	202, // 650: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	205, // 651: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	206, // 652: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	207, // 653: header.Bizbot.ListBots:output_type -> header.Bots
	105, // 654: header.Bizbot.GetBot:output_type -> header.Bot
	105, // 655: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	105, // 656: header.Bizbot.CreateBot:output_type -> header.Bot
	105, // 657: header.Bizbot.UpdateBot:output_type -> header.Bot
	44,  // 658: header.Bizbot.DeleteBot:output_type -> header.Empty
	44,  // 659: header.Bizbot.OnEvent:output_type -> header.Empty
	44,  // 660: header.Bizbot.StartBot:output_type -> header.Empty
	44,  // 661: header.Bizbot.StopBot:output_type -> header.Empty
	44,  // 662: header.Bizbot.TryAction:output_type -> header.Empty
	208, // 663: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	209, // 664: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	210, // 665: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	211, // 666: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	111, // 667: header.Sendback.CreateWebhook:output_type -> header.Webhook
	212, // 668: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	44,  // 669: header.Sendback.DeleteWebhook:output_type -> header.Empty
	213, // 670: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	111, // 671: header.Sendback.ReadWebhook:output_type -> header.Webhook
	111, // 672: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	111, // 673: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	214, // 674: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	215, // 675: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	44,  // 676: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	44,  // 677: header.Notibox.SendNoti:output_type -> header.Empty
	216, // 678: header.Notibox.ListNoties:output_type -> header.Notifications
	44,  // 679: header.Notibox.MarkReadNoti:output_type -> header.Empty
	116, // 680: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	44,  // 681: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	217, // 682: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	116, // 683: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	116, // 684: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	218, // 685: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	219, // 686: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	220, // 687: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	218, // 688: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	44,  // 689: header.Holap.AppendAgentSet:output_type -> header.Empty
	44,  // 690: header.Holap.AppendTagSet:output_type -> header.Empty
	44,  // 691: header.Holap.UpdateUser:output_type -> header.Empty
	44,  // 692: header.Holap.UpdateConversation:output_type -> header.Empty
	44,  // 693: header.Holap.OnConversationEvent:output_type -> header.Empty
	44,  // 694: header.Holap.FreeAccount:output_type -> header.Empty
	221, // 695: header.Holap.ReportUser:output_type -> header.UserMetrics
	222, // 696: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 697: header.Holap.ListUserIds:output_type -> header.Ids
	174, // 698: header.Holap.ListConversationIds:output_type -> header.Conversations
	223, // 699: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 700: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	161, // 701: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	44,  // 702: header.Holap.UpdateOrder:output_type -> header.Empty
	224, // 703: header.Holap.ReportOrder:output_type -> header.Orders
	36,  // 704: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 705: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 706: header.Proder.UpdateProduct:output_type -> header.Product
	44,  // 707: header.Proder.DeleteProduct:output_type -> header.Empty
	36,  // 708: header.Proder.RestoreProduct:output_type -> header.Product
	126, // 709: header.Proder.ListProducts:output_type -> header.Products
	5,   // 710: header.Proder.ListProductIds:output_type -> header.Ids
	126, // 711: header.Proder.ListGroupedProducts:output_type -> header.Products
	126, // 712: header.Proder.ImportProducts:output_type -> header.Products
	225, // 713: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	127, // 714: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	127, // 715: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	44,  // 716: header.Proder.DeleteProductCollection:output_type -> header.Empty
	226, // 717: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	128, // 718: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	128, // 719: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	44,  // 720: header.Proder.DeleteProductFeed:output_type -> header.Empty
	227, // 721: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	228, // 722: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 723: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 724: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 725: header.Proder.UpdateOrder:output_type -> header.Order
	44,  // 726: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 727: header.Proder.RestoreOrder:output_type -> header.Order
	224, // 728: header.Proder.ListOrders:output_type -> header.Orders
	224, // 729: header.Proder.CountOrders:output_type -> header.Orders
	44,  // 730: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	47,  // 731: header.Proder.MakeOrderPayment:output_type -> header.Event
	47,  // 732: header.Proder.DeleteOrderPayment:output_type -> header.Event
	47,  // 733: header.Proder.AddOrderComment:output_type -> header.Event
	47,  // 734: header.Proder.EditOrderComment:output_type -> header.Event
	47,  // 735: header.Proder.DeleteOrderComment:output_type -> header.Event
	229, // 736: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	183, // 737: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 738: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	230, // 739: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	44,  // 740: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	231, // 741: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	44,  // 742: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	44,  // 743: header.Proder.GHNShippingStatus:output_type -> header.Empty
	138, // 744: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 745: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 746: header.Proder.CancelShippingOrder:output_type -> header.Order
	183, // 747: header.Proder.PrintShippingOrders:output_type -> header.File
	44,  // 748: header.Proder.SeenOrder:output_type -> header.Empty
	44,  // 749: header.Proder.FollowOrder:output_type -> header.Empty
	44,  // 750: header.Proder.UnfollowOrder:output_type -> header.Empty
	126, // 751: header.Proder.VisitProductSite:output_type -> header.Products
	140, // 752: header.Apiece.ReadTask:output_type -> header.Task
	140, // 753: header.Apiece.CreateTask:output_type -> header.Task
	140, // 754: header.Apiece.UpdateTask:output_type -> header.Task
	44,  // 755: header.Apiece.DeleteTask:output_type -> header.Empty
	232, // 756: header.Apiece.ListTasks:output_type -> header.Tasks
	47,  // 757: header.Apiece.AddTaskComment:output_type -> header.Event
	47,  // 758: header.Apiece.EditTaskComment:output_type -> header.Event
	47,  // 759: header.Apiece.DeleteTaskComment:output_type -> header.Event
	233, // 760: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	142, // 761: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	142, // 762: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	142, // 763: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	44,  // 764: header.Apiece.DeletePipeline:output_type -> header.Empty
	234, // 765: header.Apiece.ListPipelines:output_type -> header.Pipelines
	383, // [383:766] is the sub-list for method output_type
	0,   // [0:383] is the sub-list for method input_type
