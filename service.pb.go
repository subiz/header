...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd4, 0x01, 0x0a, 0x07, 0x52, 0x75,
	0x6c, 0x65, 0x4d, 0x67, 0x72, 0x12, 0x28, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52,
	...
	0x32, 0xa7, 0x0a, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3b, 0x0a, 0x14, 0x4d, 0x61, 0x72, 0x6b, 0x52, 0x65, 0x61,
	0x64, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x2e,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70,
	...
	0x74, 0x2e, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x32, 0xba, 0x02, 0x0a, 0x0b, 0x54,
	...
	0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xc7, 0x01, 0x0a, 0x06, 0x54, 0x61, 0x67, 0x4d,
	...
	0x67, 0x32, 0xa7, 0x01, 0x0a, 0x0e, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x7a, 0x0a, 0x08, 0x45,
	...
	0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0x94, 0x02, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x76,
	0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x32, 0xaf,
	...
	0x61, 0x63, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x50, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x34, 0x0a, 0x13,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Route)(nil),                             // 166: header.Route
	(*RouteResult)(nil),                       // 167: header.RouteResult
	(*Conversations)(nil),                     // 168: header.Conversations
	(*account.Presence)(nil),                  // 169: account.Presence
	(*Templates)(nil),                         // 170: header.Templates
	(*Tags)(nil),                              // 171: header.Tags
...
var file_service_proto_depIdxs = []int32{
	...
	44,  // 122: header.RuleMgr.UpdateRule:input_type -> header.Rule
	44,  // 123: header.RuleMgr.CreateRule:input_type -> header.Rule
	4,   // 124: header.RuleMgr.DeleteRule:input_type -> header.Id
	4,   // 125: header.RuleMgr.ReadRule:input_type -> header.Id
	4,   // 126: header.RuleMgr.ListRules:input_type -> header.Id
	...
	26,  // 140: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	...
	51,  // 144: header.ConversationMgr.MarkReadConversation:input_type -> header.Conversation
	...
	54,  // 149: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	54,  // 150: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 151: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 152: header.TemplateMgr.GetTemplate:input_type -> header.Id
	55,  // 153: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 154: header.TemplateMgr.PickTemplate:input_type -> header.Id
	56,  // 155: header.TagMgr.CreateTag:input_type -> header.Tag
	56,  // 156: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 157: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 158: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 159: header.TagMgr.GetTag:input_type -> header.Id
	4,   // 160: header.IntegrationMgr.Deintegrate:input_type -> header.Id
	4,   // 161: header.IntegrationMgr.ListIntegrations:input_type -> header.Id
	57,  // 162: header.IntegrationMgr.Integrate:input_type -> header.Integration
	58,  // 163: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	59,  // 164: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	46,  // 165: header.ConversationEventReader.SendMessage:input_type -> header.Event
	46,  // 166: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	46,  // 167: header.ConversationEventReader.PinMessage:input_type -> header.Event
	46,  // 168: header.ConversationEventReader.UnpinMessage:input_type -> header.Event
	60,  // 169: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	...
	46,  // 271: header.Sendback.SendWebhookEvent:input_type -> header.Event
	...
	56,  // 289: header.Holap.AppendTagSet:input_type -> header.Tag
	28,  // 290: header.Holap.UpdateUser:input_type -> header.User
	51,  // 291: header.Holap.UpdateConversation:input_type -> header.Conversation
	46,  // 292: header.Holap.OnConversationEvent:input_type -> header.Event
	...
	46,  // 332: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 333: header.Proder.EditOrderComment:input_type -> header.Event
	...
	46,  // 355: header.Apiece.AddTaskComment:input_type -> header.Event
	46,  // 356: header.Apiece.EditTaskComment:input_type -> header.Event
	...
	44,  // 486: header.RuleMgr.UpdateRule:output_type -> header.Rule
	44,  // 487: header.RuleMgr.CreateRule:output_type -> header.Rule
	41,  // 488: header.RuleMgr.DeleteRule:output_type -> header.Empty
	44,  // 489: header.RuleMgr.ReadRule:output_type -> header.Rule
	166, // 490: header.RuleMgr.ListRules:output_type -> header.Route
	167, // 491: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 492: header.ConversationMgr.PongMessage:output_type -> header.Event
	51,  // 493: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	51,  // 494: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	51,  // 495: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	168, // 496: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	168, // 497: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	41,  // 498: header.ConversationMgr.TagConversation:output_type -> header.Empty
	41,  // 499: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	41,  // 500: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	41,  // 501: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	41,  // 502: header.ConversationMgr.Typing:output_type -> header.Empty
	51,  // 503: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	168, // 504: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	41,  // 505: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	41,  // 506: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	41,  // 507: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	41,  // 508: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	52,  // 509: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	52,  // 510: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 511: header.ConversationMgr.TerminateBot:output_type -> header.Event
	169, // 512: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	54,  // 513: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	54,  // 514: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	41,  // 515: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	54,  // 516: header.TemplateMgr.GetTemplate:output_type -> header.Template
	170, // 517: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	41,  // 518: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	56,  // 519: header.TagMgr.CreateTag:output_type -> header.Tag
	56,  // 520: header.TagMgr.UpdateTag:output_type -> header.Tag
	41,  // 521: header.TagMgr.DeleteTag:output_type -> header.Empty
	171, // 522: header.TagMgr.ListTags:output_type -> header.Tags
	56,  // 523: header.TagMgr.GetTag:output_type -> header.Tag
	41,  // 524: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	172, // 525: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	57,  // 526: header.IntegrationMgr.Integrate:output_type -> header.Integration
	88,  // 527: header.EventMgr.SearchEvents:output_type -> header.Events
	46,  // 528: header.EventMgr.CreateEvent:output_type -> header.Event
	46,  // 529: header.ConversationEventReader.SendMessage:output_type -> header.Event
	46,  // 530: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	41,  // 531: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	41,  // 532: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	88,  // 533: header.ConversationEventReader.ListEvents:output_type -> header.Events
	...
	168, // 661: header.Holap.ListConversationIds:output_type -> header.Conversations
	...
	46,  // 694: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 695: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 696: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 697: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 698: header.Proder.DeleteOrderComment:output_type -> header.Event
	...
	46,  // 719: header.Apiece.AddTaskComment:output_type -> header.Event
	46,  // 720: header.Apiece.EditTaskComment:output_type -> header.Event
	46,  // 721: header.Apiece.DeleteTaskComment:output_type -> header.Event
