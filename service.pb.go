...
var file_service_proto_goTypes = []interface{}{
	...
	(*AccountImage)(nil),                      // 133: header.AccountImage
	(*UserMetricsRequest)(nil),                // 134: header.UserMetricsRequest
	(*ConversationMetricsRequest)(nil),        // 135: header.ConversationMetricsRequest
	(*AgentMetricsRequest)(nil),               // 136: header.AgentMetricsRequest
	(*UserEventMetricsRequest)(nil),           // 137: header.UserEventMetricsRequest
	(*OrderMetricsRequest)(nil),               // 138: header.OrderMetricsRequest
	(*CallMetricsRequest)(nil),                // 139: header.CallMetricsRequest
	...
	(*Pipeline)(nil),                          // 156: header.Pipeline
	(*PipelineStage)(nil),                     // 157: header.PipelineStage
	(*TTSVoiceSelection)(nil),                 // 158: header.TTSVoiceSelection
	(*Campaign)(nil),                          // 159: header.Campaign
	(*CampaignSendMessagesRequest)(nil),       // 160: header.CampaignSendMessagesRequest
	...
	(*OutboundCallByAgentReport)(nil),         // 274: header.OutboundCallByAgentReport
	(*OutboundCallReport)(nil),                // 275: header.OutboundCallReport
	(*CreditSpendReportResponse)(nil),         // 276: header.CreditSpendReportResponse
	(*CreditSpendEntries)(nil),                // 277: header.CreditSpendEntries
	(*Forms)(nil),                             // 278: header.Forms
	(*FormReportResponse)(nil),                // 279: header.FormReportResponse
	(*FormSubmissions)(nil),                   // 280: header.FormSubmissions
}
var file_service_proto_depIdxs = []int32{
	...
	78,  // 348: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 349: header.Holap.UpdateUser:input_type -> header.User
	61,  // 350: header.Holap.UpdateConversation:input_type -> header.Conversation
	41,  // 351: header.Holap.OnConversationEvent:input_type -> header.Event
	133, // 352: header.Holap.FreeAccount:input_type -> header.AccountImage
	134, // 353: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	135, // 354: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	134, // 355: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	135, // 356: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	136, // 357: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 358: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	137, // 359: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	21,  // 360: header.Holap.UpdateOrder:input_type -> header.Order
	138, // 361: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	139, // 362: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	139, // 363: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	39,  // 364: header.Proder.ReadProduct:input_type -> header.Product
	39,  // 365: header.Proder.CreateProduct:input_type -> header.Product
	39,  // 366: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 367: header.Proder.DeleteProduct:input_type -> header.Id
	140, // 368: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	141, // 369: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	5,   // 370: header.Proder.ListProductCollections:input_type -> header.Ids
	142, // 371: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	142, // 372: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 373: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 374: header.Proder.ListProductFeeds:input_type -> header.Id
	143, // 375: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	143, // 376: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 377: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 378: header.Proder.ListProductCategories:input_type -> header.Ids
	...
	144, // 383: header.Proder.ListOrders:input_type -> header.OrdersRequest
	145, // 384: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	146, // 385: header.Proder.ImportOrders:input_type -> header.Orders
	147, // 386: header.Proder.MakeOrderPayment:input_type -> header.Bill
	148, // 387: header.Proder.DeleteOrderPayment:input_type -> header.Key
	41,  // 388: header.Proder.AddOrderComment:input_type -> header.Event
	41,  // 389: header.Proder.EditOrderComment:input_type -> header.Event
	148, // 390: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 391: header.Proder.ListOrderEvents:input_type -> header.Id
	149, // 392: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 393: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	150, // 394: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 395: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	151, // 396: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	152, // 397: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	153, // 398: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	154, // 399: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 400: header.Proder.ShipOrder:input_type -> header.Id
	21,  // 401: header.Proder.UpdateShippingCode:input_type -> header.Order
	4,   // 402: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 403: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 404: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 405: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 406: header.Proder.UnfollowOrder:input_type -> header.Id
	59,  // 407: header.Proder.TagOrder:input_type -> header.TagRequest
	59,  // 408: header.Proder.UntagOrder:input_type -> header.TagRequest
	4,   // 409: header.Apiece.ReadTask:input_type -> header.Id
	46,  // 410: header.Apiece.CreateTask:input_type -> header.Task
	46,  // 411: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 412: header.Apiece.DeleteTask:input_type -> header.Id
	155, // 413: header.Apiece.ListTasks:input_type -> header.TasksRequest
	4,   // 414: header.Apiece.SeenTask:input_type -> header.Id
	4,   // 415: header.Apiece.CloseTaskReminder:input_type -> header.Id
	4,   // 416: header.Apiece.MuteTask:input_type -> header.Id
	4,   // 417: header.Apiece.UnmuteTask:input_type -> header.Id
	41,  // 418: header.Apiece.AddTaskComment:input_type -> header.Event
	41,  // 419: header.Apiece.EditTaskComment:input_type -> header.Event
	148, // 420: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 421: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 422: header.Apiece.ReadPipeline:input_type -> header.Id
	156, // 423: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	156, // 424: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 425: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 426: header.Apiece.ListPipelines:input_type -> header.Ids
	157, // 427: header.Apiece.DeletePipelineStage:input_type -> header.PipelineStage
	4,   // 428: header.Apiece.PreselectPipeline:input_type -> header.Id
	158, // 429: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	5,   // 430: header.Campion.ListCampaigns:input_type -> header.Ids
	4,   // 431: header.Campion.ReadCampaign:input_type -> header.Id
	159, // 432: header.Campion.CreateCampaign:input_type -> header.Campaign
	159, // 433: header.Campion.UpdateCampaign:input_type -> header.Campaign
	4,   // 434: header.Campion.DeleteCampaign:input_type -> header.Id
	41,  // 435: header.Campion.OnEvent:input_type -> header.Event
	160, // 436: header.Campion.ListCampaignSendMessages:input_type -> header.CampaignSendMessagesRequest
	4,   // 437: header.Campion.ReportCampaign:input_type -> header.Id
	161, // 438: header.Campion.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	162, // 439: header.Campion.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	162, // 440: header.Campion.GetOutboundCall:input_type -> header.OutboundCallEntry
	162, // 441: header.Campion.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	163, // 442: header.Campion.ReportOutboundCallByAgents:input_type -> header.OutboundCallReportRequest
	163, // 443: header.Campion.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	164, // 444: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	165, // 445: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	86,  // 446: header.CreditMgr.AddCredit:input_type -> payment.Bill
	4,   // 447: header.FormMgr.ListForms:input_type -> header.Id
	166, // 448: header.FormMgr.CreateForm:input_type -> header.Form
	166, // 449: header.FormMgr.UpdateForm:input_type -> header.Form
	4,   // 450: header.FormMgr.DeleteForm:input_type -> header.Id
	167, // 451: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	168, // 452: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	169, // 453: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	54,  // 454: header.Search.Index:output_type -> header.Empty
	170, // 455: header.Search.Search:output_type -> header.DocSearchResponse
	54,  // 456: header.Search.AddOwner:output_type -> header.Empty
	171, // 457: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 458: header.Map.LookupAddress:output_type -> header.Address
	172, // 459: header.Map.PredictAddress:output_type -> header.Addresses
	172, // 460: header.Map.ListDistricts:output_type -> header.Addresses
	172, // 461: header.Map.ListProvinces:output_type -> header.Addresses
	172, // 462: header.Map.ListWards:output_type -> header.Addresses
	172, // 463: header.Map.ListStreets:output_type -> header.Addresses
	172, // 464: header.Map.ListAddresses:output_type -> header.Addresses
	...
	173, // 483: header.AccountMgr.ListAgents:output_type -> account.Agents
	54,  // 484: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	174, // 485: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 486: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	175, // 487: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	176, // 490: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	176, // 491: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	177, // 494: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	178, // 497: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	179, // 500: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	54,  // 501: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	172, // 502: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	180, // 506: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	181, // 510: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	181, // 511: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	182, // 516: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	183, // 519: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	184, // 524: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	185, // 529: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	...
	186, // 533: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	...
	187, // 553: header.UserMgr.ListViews:output_type -> header.UserViews
	...
	188, // 558: header.UserMgr.ListSegments:output_type -> header.Segments
	...
	189, // 567: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	190, // 577: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	...
	191, // 580: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	...
	192, // 587: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	193, // 588: header.UserMgr.ListEventTypes:output_type -> header.EventTypes
	...
	194, // 591: header.LiveMgr.SearchLocations:output_type -> header.Locations
	...
	195, // 594: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	196, // 595: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	197, // 596: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	198, // 597: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	199, // 598: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	200, // 599: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	201, // 603: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	202, // 606: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	203, // 611: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	203, // 612: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	203, // 619: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	204, // 634: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	205, // 641: header.ConversationMgr.ListRules:output_type -> header.Route
	206, // 642: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	207, // 646: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	208, // 652: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	209, // 655: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	54,  // 656: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	210, // 657: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	211, // 660: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	212, // 666: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	213, // 672: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	214, // 673: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	215, // 677: header.TagMgr.ListTags:output_type -> header.Tags
	78,  // 678: header.TagMgr.GetTag:output_type -> header.Tag
	216, // 679: header.FileMgr.Presign:output_type -> header.PresignResult
	...
	217, // 690: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	218, // 697: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	219, // 701: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	220, // 704: header.PaymentMgr.ListComments:output_type -> payment.Comments
	95,  // 705: header.PaymentMgr.AddComment:output_type -> payment.Comment
	221, // 706: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	222, // 711: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	223, // 716: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	224, // 720: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	103, // 721: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	225, // 722: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	226, // 723: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	227, // 724: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	228, // 729: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	229, // 730: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	230, // 736: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	231, // 743: header.MailkonService.VerifySenderDomain:output_type -> header.VerificationResult
	232, // 744: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	...
	233, // 749: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	234, // 750: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	235, // 754: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	236, // 755: header.WidgetService.ListConversions:output_type -> header.Conversions
	237, // 756: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	118, // 757: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	238, // 758: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	54,  // 759: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	239, // 760: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	239, // 766: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	54,  // 767: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	240, // 768: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	238, // 769: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	241, // 770: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	242, // 771: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	243, // 772: header.Bizbot.ListBots:output_type -> header.Bots
	...
	244, // 782: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	245, // 783: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	246, // 784: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	247, // 785: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	128, // 786: header.Sendback.CreateWebhook:output_type -> header.Webhook
	248, // 787: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	54,  // 788: header.Sendback.DeleteWebhook:output_type -> header.Empty
	249, // 789: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	250, // 793: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	251, // 794: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	54,  // 795: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	54,  // 796: header.Notibox.SendNoti:output_type -> header.Empty
	252, // 797: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	54,  // 800: header.Holap.AppendAgentSet:output_type -> header.Empty
	54,  // 801: header.Holap.AppendTagSet:output_type -> header.Empty
	54,  // 802: header.Holap.UpdateUser:output_type -> header.Empty
	54,  // 803: header.Holap.UpdateConversation:output_type -> header.Empty
	54,  // 804: header.Holap.OnConversationEvent:output_type -> header.Empty
	54,  // 805: header.Holap.FreeAccount:output_type -> header.Empty
	253, // 806: header.Holap.ReportUser:output_type -> header.UserMetrics
	254, // 807: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 808: header.Holap.ListUserIds:output_type -> header.Ids
	203, // 809: header.Holap.ListConversationIds:output_type -> header.Conversations
	255, // 810: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 811: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	256, // 812: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	54,  // 813: header.Holap.UpdateOrder:output_type -> header.Empty
	146, // 814: header.Holap.ReportOrder:output_type -> header.Orders
	257, // 815: header.Holap.ReportCall:output_type -> header.CallMetrics
	203, // 816: header.Holap.ListCallIds:output_type -> header.Conversations
	39,  // 817: header.Proder.ReadProduct:output_type -> header.Product
	39,  // 818: header.Proder.CreateProduct:output_type -> header.Product
	39,  // 819: header.Proder.UpdateProduct:output_type -> header.Product
	54,  // 820: header.Proder.DeleteProduct:output_type -> header.Empty
	258, // 821: header.Proder.ListProducts2:output_type -> header.Products
	259, // 822: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	260, // 823: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	142, // 824: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	142, // 825: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	54,  // 826: header.Proder.DeleteProductCollection:output_type -> header.Empty
	261, // 827: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	143, // 828: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	143, // 829: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	54,  // 830: header.Proder.DeleteProductFeed:output_type -> header.Empty
	262, // 831: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	...
	146, // 836: header.Proder.ListOrders:output_type -> header.Orders
	263, // 837: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	146, // 838: header.Proder.ImportOrders:output_type -> header.Orders
	...
	264, // 844: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	82,  // 845: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 846: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	265, // 847: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	54,  // 848: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	266, // 849: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	154, // 852: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	...
	267, // 866: header.Apiece.ListTasks:output_type -> header.Tasks
	...
	268, // 874: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	156, // 875: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	156, // 876: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	156, // 877: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	54,  // 878: header.Apiece.DeletePipeline:output_type -> header.Empty
	269, // 879: header.Apiece.ListPipelines:output_type -> header.Pipelines
	54,  // 880: header.Apiece.DeletePipelineStage:output_type -> header.Empty
	156, // 881: header.Apiece.PreselectPipeline:output_type -> header.Pipeline
	158, // 882: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	270, // 883: header.Campion.ListCampaigns:output_type -> header.Campaigns
	159, // 884: header.Campion.ReadCampaign:output_type -> header.Campaign
	159, // 885: header.Campion.CreateCampaign:output_type -> header.Campaign
	159, // 886: header.Campion.UpdateCampaign:output_type -> header.Campaign
	54,  // 887: header.Campion.DeleteCampaign:output_type -> header.Empty
	54,  // 888: header.Campion.OnEvent:output_type -> header.Empty
	271, // 889: header.Campion.ListCampaignSendMessages:output_type -> header.CampaignSendMessages
	272, // 890: header.Campion.ReportCampaign:output_type -> header.CampaignMetrics
	273, // 891: header.Campion.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	162, // 892: header.Campion.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	162, // 893: header.Campion.GetOutboundCall:output_type -> header.OutboundCallEntry
	54,  // 894: header.Campion.RemoveOutboudCall:output_type -> header.Empty
	274, // 895: header.Campion.ReportOutboundCallByAgents:output_type -> header.OutboundCallByAgentReport
	275, // 896: header.Campion.ReportOutboundCalls:output_type -> header.OutboundCallReport
	276, // 897: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	277, // 898: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	86,  // 899: header.CreditMgr.AddCredit:output_type -> payment.Bill
	278, // 900: header.FormMgr.ListForms:output_type -> header.Forms
	166, // 901: header.FormMgr.CreateForm:output_type -> header.Form
	166, // 902: header.FormMgr.UpdateForm:output_type -> header.Form
	54,  // 903: header.FormMgr.DeleteForm:output_type -> header.Empty
	279, // 904: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	280, // 905: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
