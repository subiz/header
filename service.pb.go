...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x6f, 0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf7, 0x09,
	...
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x73, 0x12, 0x3b, 0x0a, 0x0f,
	0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x56, 0x69, 0x65, 0x77, 0x73, 0x12,
	...
	0x64, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x2b, 0x0a, 0x0b, 0x55, 0x70, 0x73,
	...
	0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x71, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x50,
	...
	0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0x97, 0x06, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61, 0x70, 0x12,
	...
	0x73, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x32,
...
var file_service_proto_depIdxs = []int32{
	...
	22,  // 48: header.UserMgr.ListUserInViews:input_type -> header.UserViewCondition
	23,  // 49: header.UserMgr.UpsertLabel:input_type -> header.Label
	1,   // 50: header.UserMgr.DeleteLabel:input_type -> header.Id
	1,   // 51: header.UserMgr.ListLabels:input_type -> header.Id
	1,   // 52: header.UserMgr.GetLabel:input_type -> header.Id
	24,  // 53: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	24,  // 54: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	24,  // 55: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	24,  // 56: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	17,  // 57: header.UserPersist.UpdateUser:input_type -> header.User
	22,  // 58: header.UserPersist.FilterUsers:input_type -> header.UserViewCondition
	...
	114, // 309: header.UserMgr.ListUserInViews:output_type -> header.Users
	23,  // 310: header.UserMgr.UpsertLabel:output_type -> header.Label
	33,  // 311: header.UserMgr.DeleteLabel:output_type -> header.Empty
	119, // 312: header.UserMgr.ListLabels:output_type -> header.Labels
	23,  // 313: header.UserMgr.GetLabel:output_type -> header.Label
	33,  // 314: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	33,  // 315: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	33,  // 316: header.UserMgr.AddUserLabel:output_type -> header.Empty
	33,  // 317: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
