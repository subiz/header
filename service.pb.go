...
var file_service_proto_rawDesc = []byte{
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x9d, 0x0e,
...
var file_service_proto_depIdxs = []int32{
	...
	58,  // 263: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 264: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	89,  // 265: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	94,  // 266: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	88,  // 267: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	95,  // 268: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	96,  // 269: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 270: header.PaymentMgr.GetReferral:input_type -> header.Id
	58,  // 271: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	97,  // 272: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	1,   // 273: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	1,   // 274: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	1,   // 275: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	98,  // 276: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	99,  // 277: header.Pubsub.Fire:input_type -> header.PsMessage
	100, // 278: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	100, // 279: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	1,   // 280: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	101, // 281: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	1,   // 282: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	1,   // 283: header.FabikonService.ListFbPosts:input_type -> header.Id
	102, // 284: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	0,   // 285: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	35,  // 286: header.FabikonService.RemoveFbUserLabel:input_type -> header.User
	35,  // 287: header.FabikonService.AddFbUserLabel:input_type -> header.User
	1,   // 288: header.FabikonService.GenerateRefLink:input_type -> header.Id
	103, // 289: header.FabikonService.LinkPageWithAccount:input_type -> header.FacebookPageLinkRequest
	1,   // 290: header.FabikonService.ListFacebookPages:input_type -> header.Id
	0,   // 291: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	1,   // 292: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	104, // 293: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	104, // 294: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	104, // 295: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	104, // 296: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	105, // 297: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	0,   // 298: header.MailkonService.SendEmail:input_type -> header.Events
	70,  // 299: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	70,  // 300: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	70,  // 301: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	70,  // 302: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	1,   // 303: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	106, // 304: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	1,   // 305: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	107, // 306: header.MailkonService.TrackLink:input_type -> header.LinkData
	108, // 307: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	108, // 308: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	1,   // 309: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	109, // 310: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	109, // 311: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	1,   // 312: header.MailkonService.UnblockEmail:input_type -> header.Id
	1,   // 313: header.WidgetService.Read:input_type -> header.Id
	110, // 314: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 315: header.WidgetService.ReadUserSetting:input_type -> header.Id
	1,   // 316: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	111, // 317: header.WidgetService.SubmitImpression:input_type -> header.Impression
	112, // 318: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	113, // 319: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	114, // 320: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	115, // 321: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	115, // 322: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	116, // 323: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 324: header.WidgetService.ListUploadedImage:input_type -> header.Id
	116, // 325: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 326: header.WidgetService.ListWebPlugins:input_type -> header.Id
	117, // 327: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	117, // 328: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	117, // 329: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 330: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	117, // 331: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	1,   // 332: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	1,   // 333: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	118, // 334: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	1,   // 335: header.WidgetService.SearchImages:input_type -> header.Id
	1,   // 336: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	1,   // 337: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	119, // 338: header.Bizbot.ListBots:input_type -> header.BotsRequest
	1,   // 339: header.Bizbot.GetBot:input_type -> header.Id
	120, // 340: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	120, // 341: header.Bizbot.CreateBot:input_type -> header.Bot
	120, // 342: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 343: header.Bizbot.DeleteBot:input_type -> header.Id
	121, // 344: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	121, // 345: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	121, // 346: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	121, // 347: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	122, // 348: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	123, // 349: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	124, // 350: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	125, // 351: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	126, // 352: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 353: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 354: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 355: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 356: header.Sendback.ReadWebhook:input_type -> header.Id
	126, // 357: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 358: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	127, // 359: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	128, // 360: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 361: header.Sendback.SendWebhookEvent:input_type -> header.Event
	129, // 362: header.Notibox.SendNoti:input_type -> header.Notification
	130, // 363: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	1,   // 364: header.Notibox.MarkReadNoti:input_type -> header.Id
	1,   // 365: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	44,  // 366: header.Proder.ReadProduct:input_type -> header.Product
	44,  // 367: header.Proder.CreateProduct:input_type -> header.Product
	44,  // 368: header.Proder.UpdateProduct:input_type -> header.Product
	1,   // 369: header.Proder.DeleteProduct:input_type -> header.Id
	131, // 370: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	132, // 371: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	14,  // 372: header.Proder.ListProductCollections:input_type -> header.Ids
	133, // 373: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	133, // 374: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	1,   // 375: header.Proder.DeleteProductCollection:input_type -> header.Id
	1,   // 376: header.Proder.ListProductFeeds:input_type -> header.Id
	134, // 377: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	134, // 378: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	1,   // 379: header.Proder.DeleteProductFeed:input_type -> header.Id
	14,  // 380: header.Proder.ListProductCategories:input_type -> header.Ids
	1,   // 381: header.Proder.ReadOrder:input_type -> header.Id
	27,  // 382: header.Proder.CreateOrder:input_type -> header.Order
	27,  // 383: header.Proder.UpdateOrder:input_type -> header.Order
	1,   // 384: header.Proder.DeleteOrder:input_type -> header.Id
	135, // 385: header.Proder.ListOrders:input_type -> header.OrdersRequest
	136, // 386: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	137, // 387: header.Proder.ImportOrders:input_type -> header.Orders
	138, // 388: header.Proder.MakeOrderPayment:input_type -> header.Bill
	139, // 389: header.Proder.DeleteOrderPayment:input_type -> header.Key
	46,  // 390: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 391: header.Proder.EditOrderComment:input_type -> header.Event
	139, // 392: header.Proder.DeleteOrderComment:input_type -> header.Key
	1,   // 393: header.Proder.ListOrderEvents:input_type -> header.Id
	140, // 394: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	1,   // 395: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	141, // 396: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	1,   // 397: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	142, // 398: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	143, // 399: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	144, // 400: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	145, // 401: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	1,   // 402: header.Proder.ShipOrder:input_type -> header.Id
	27,  // 403: header.Proder.UpdateShippingCode:input_type -> header.Order
	1,   // 404: header.Proder.CancelShippingOrder:input_type -> header.Id
	14,  // 405: header.Proder.PrintShippingOrders:input_type -> header.Ids
	1,   // 406: header.Proder.SeenOrder:input_type -> header.Id
	1,   // 407: header.Proder.FollowOrder:input_type -> header.Id
	1,   // 408: header.Proder.UnfollowOrder:input_type -> header.Id
	63,  // 409: header.Proder.TagOrder:input_type -> header.TagRequest
	63,  // 410: header.Proder.UntagOrder:input_type -> header.TagRequest
	1,   // 411: header.Proder.ReadPipeline:input_type -> header.Id
	146, // 412: header.Proder.CreatePipeline:input_type -> header.Pipeline
	146, // 413: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	1,   // 414: header.Proder.DeletePipeline:input_type -> header.Id
	14,  // 415: header.Proder.ListPipelines:input_type -> header.Ids
	147, // 416: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	1,   // 417: header.Proder.PreselectPipeline:input_type -> header.Id
	148, // 418: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	14,  // 419: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	1,   // 420: header.TaskMgr.ReadTask:input_type -> header.Id
	49,  // 421: header.TaskMgr.CreateTask:input_type -> header.Task
	49,  // 422: header.TaskMgr.UpdateTask:input_type -> header.Task
	1,   // 423: header.TaskMgr.DeleteTask:input_type -> header.Id
	149, // 424: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	1,   // 425: header.TaskMgr.SeenTask:input_type -> header.Id
	1,   // 426: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	1,   // 427: header.TaskMgr.MuteTask:input_type -> header.Id
	1,   // 428: header.TaskMgr.UnmuteTask:input_type -> header.Id
	46,  // 429: header.TaskMgr.AddTaskComment:input_type -> header.Event
	46,  // 430: header.TaskMgr.EditTaskComment:input_type -> header.Event
	139, // 431: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	1,   // 432: header.TaskMgr.ListTaskComments:input_type -> header.Id
	150, // 433: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	14,  // 434: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	1,   // 435: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	151, // 436: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	151, // 437: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	1,   // 438: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	46,  // 439: header.CampaignMgr.OnEvent:input_type -> header.Event
	152, // 440: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	1,   // 441: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	153, // 442: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	154, // 443: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	155, // 444: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	...
	153, // 448: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	...
	58,  // 464: header.GooglekonService.SendEventToGoogle:output_type -> header.Empty
	2,   // 465: header.GooglekonService.ReadGoogleLocationSetting:output_type -> googlekon.GoogleLocationSetting
	2,   // 466: header.GooglekonService.UpdateGoogleLocationSetting:output_type -> googlekon.GoogleLocationSetting
	165, // 467: header.GooglekonService.ListGoogleLocationSettings:output_type -> googlekon.GoogleLocationSettings
	166, // 468: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	58,  // 469: header.DocSearch.IndexConvo:output_type -> header.Empty
	167, // 470: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	168, // 471: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	169, // 472: header.DocSearch.Report:output_type -> header.ConvoReportResponse
	170, // 473: header.DocSearch.ListIds:output_type -> header.Conversations
	170, // 474: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	171, // 475: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	170, // 476: header.DocSearch.ListCallIds:output_type -> header.Conversations
	172, // 477: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	11,  // 478: header.NumberRegistry.Compact:output_type -> header.Number
	10,  // 479: header.NumberRegistry.Uncompact:output_type -> header.String
	12,  // 480: header.NumberRegistry.CompactM:output_type -> header.StrNumM
	11,  // 481: header.NumberRegistry.Shorten:output_type -> header.Number
	10,  // 482: header.NumberRegistry.Lookup:output_type -> header.String
	173, // 483: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	25,  // 484: header.Map.LookupAddress:output_type -> header.Address
	174, // 485: header.Map.PredictAddress:output_type -> header.Addresses
	174, // 486: header.Map.ListDistricts:output_type -> header.Addresses
	174, // 487: header.Map.ListProvinces:output_type -> header.Addresses
	174, // 488: header.Map.ListWards:output_type -> header.Addresses
	174, // 489: header.Map.ListStreets:output_type -> header.Addresses
	174, // 490: header.Map.ListAddresses:output_type -> header.Addresses
	25,  // 491: header.Map.ReadAddress:output_type -> header.Address
	15,  // 492: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	15,  // 493: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	15,  // 494: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	58,  // 495: header.AccountMgr.RequestPassword:output_type -> header.Empty
	17,  // 496: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	17,  // 497: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	17,  // 498: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	18,  // 499: header.AccountMgr.DeleteAccount:output_type -> account.Account
	18,  // 500: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	58,  // 501: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	17,  // 502: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	17,  // 503: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	17,  // 504: header.AccountMgr.GetInvitation:output_type -> account.Agent
	17,  // 505: header.AccountMgr.InviteAgent:output_type -> account.Agent
	17,  // 506: header.AccountMgr.GetAgent:output_type -> account.Agent
	17,  // 507: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	18,  // 508: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	18,  // 509: header.AccountMgr.GetAccount:output_type -> account.Account
	18,  // 510: header.AccountMgr.UpdateAccount:output_type -> account.Account
	18,  // 511: header.AccountMgr.CreateAccount:output_type -> account.Account
	175, // 512: header.AccountMgr.ListAgents:output_type -> account.Agents
	58,  // 513: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	176, // 514: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	17,  // 515: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	177, // 516: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	17,  // 517: header.AccountMgr.TransferOwner:output_type -> account.Agent
	22,  // 518: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	178, // 519: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	178, // 520: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	58,  // 521: header.AccountMgr.LogoutSession:output_type -> header.Empty
	22,  // 522: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	179, // 523: header.AccountMgr.GetLanguage:output_type -> header.Lang
	23,  // 524: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	24,  // 525: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	24,  // 526: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	180, // 527: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	58,  // 528: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	174, // 529: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	25,  // 530: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	25,  // 531: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	58,  // 532: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	181, // 533: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	26,  // 534: header.AccountMgr.CreateTax:output_type -> header.Tax
	26,  // 535: header.AccountMgr.UpdateTax:output_type -> header.Tax
	58,  // 536: header.AccountMgr.DeleteTax:output_type -> header.Empty
	182, // 537: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	182, // 538: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	28,  // 539: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	28,  // 540: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	58,  // 541: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	29,  // 542: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	183, // 543: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	29,  // 544: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	58,  // 545: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	184, // 546: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	30,  // 547: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	30,  // 548: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	58,  // 549: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	58,  // 550: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	185, // 551: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	58,  // 552: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	31,  // 553: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	31,  // 554: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	31,  // 555: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	32,  // 556: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	186, // 557: header.AccountMgr.ListAgentPresences:output_type -> account.Presences
	187, // 558: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	1,   // 559: header.AccountMgr.NewID:output_type -> header.Id
	1,   // 560: header.AccountMgr.LockLogin:output_type -> header.Id
	1,   // 561: header.AccountMgr.UnlockLogin:output_type -> header.Id
	188, // 562: header.AccountMgr.ListBills:output_type -> payment.Bills
	35,  // 563: header.UserMgr.MergeUser:output_type -> header.User
	58,  // 564: header.UserMgr.DetachUser:output_type -> header.Empty
	35,  // 565: header.UserMgr.CreateUser2:output_type -> header.User
	35,  // 566: header.UserMgr.UpdateUser:output_type -> header.User
	189, // 567: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	58,  // 568: header.UserMgr.RemoveUser:output_type -> header.Empty
	58,  // 569: header.UserMgr.RestoreUser:output_type -> header.Empty
	35,  // 570: header.UserMgr.ReadUser:output_type -> header.User
	35,  // 571: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	34,  // 572: header.UserMgr.MatchUsers:output_type -> header.Users
	35,  // 573: header.UserMgr.BanUser:output_type -> header.User
	35,  // 574: header.UserMgr.UnbanUser:output_type -> header.User
	34,  // 575: header.UserMgr.LookupByPhone:output_type -> header.Users
	36,  // 576: header.UserMgr.UpdateView:output_type -> header.UserView
	36,  // 577: header.UserMgr.CreateView:output_type -> header.UserView
	58,  // 578: header.UserMgr.DeleteView:output_type -> header.Empty
	36,  // 579: header.UserMgr.GetView:output_type -> header.UserView
	190, // 580: header.UserMgr.ListViews:output_type -> header.UserViews
	37,  // 581: header.UserMgr.UpdateSegment:output_type -> header.Segment
	37,  // 582: header.UserMgr.CreateSegment:output_type -> header.Segment
	58,  // 583: header.UserMgr.DeleteSegment:output_type -> header.Empty
	37,  // 584: header.UserMgr.GetSegment:output_type -> header.Segment
	191, // 585: header.UserMgr.ListSegments:output_type -> header.Segments
	34,  // 586: header.UserMgr.ListUsers:output_type -> header.Users
	58,  // 587: header.UserMgr.AddToSegment:output_type -> header.Empty
	58,  // 588: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	58,  // 589: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	41,  // 590: header.UserMgr.UpsertLabel:output_type -> header.Label
	58,  // 591: header.UserMgr.DeleteLabel:output_type -> header.Empty
	192, // 592: header.UserMgr.ListLabels:output_type -> header.Labels
	41,  // 593: header.UserMgr.GetLabel:output_type -> header.Label
	58,  // 594: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	58,  // 595: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	58,  // 596: header.UserMgr.AddUserLabel:output_type -> header.Empty
	58,  // 597: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	58,  // 598: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	25,  // 599: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	25,  // 600: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	58,  // 601: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	193, // 602: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	58,  // 603: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	34,  // 604: header.UserMgr.ListLeads:output_type -> header.Users
	194, // 605: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	44,  // 606: header.UserMgr.LinkProductUrl:output_type -> header.Product
	0,   // 607: header.UserMgr.ListUserEvents:output_type -> header.Events
	46,  // 608: header.UserMgr.CreateUserEvent:output_type -> header.Event
	47,  // 609: header.UserMgr.FillDevice:output_type -> common.Device
	195, // 610: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	58,  // 611: header.UserMgr.LinkTask:output_type -> header.Empty
	196, // 612: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	14,  // 613: header.UserMgr.ListUserIds:output_type -> header.Ids
	34,  // 614: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	167, // 615: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	197, // 616: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	198, // 617: header.LiveMgr.SearchLocations:output_type -> header.Locations
	34,  // 618: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	199, // 619: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	200, // 620: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	201, // 621: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	202, // 622: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	203, // 623: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	204, // 624: header.NoteMgr.ListNotes:output_type -> header.Notes
	56,  // 625: header.NoteMgr.AddNote:output_type -> header.Note
	56,  // 626: header.NoteMgr.UpdateNote:output_type -> header.Note
	58,  // 627: header.NoteMgr.DeleteNote:output_type -> header.Empty
	205, // 628: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	59,  // 629: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	59,  // 630: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	206, // 631: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 632: header.ConversationMgr.PongMessage:output_type -> header.Event
	65,  // 633: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	65,  // 634: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	65,  // 635: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	170, // 636: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	170, // 637: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	58,  // 638: header.ConversationMgr.TagConversation:output_type -> header.Empty
	58,  // 639: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	58,  // 640: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	58,  // 641: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	65,  // 642: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	58,  // 643: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	58,  // 644: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	58,  // 645: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	58,  // 646: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	66,  // 647: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	66,  // 648: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 649: header.ConversationMgr.TerminateBot:output_type -> header.Event
	46,  // 650: header.ConversationMgr.SendMessage:output_type -> header.Event
	46,  // 651: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	46,  // 652: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	58,  // 653: header.ConversationMgr.PinMessage:output_type -> header.Empty
	58,  // 654: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	0,   // 655: header.ConversationMgr.ListEvents:output_type -> header.Events
	58,  // 656: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	207, // 657: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	70,  // 658: header.ConversationMgr.Integrate:output_type -> header.Integration
	70,  // 659: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	71,  // 660: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	71,  // 661: header.ConversationMgr.CreateRule:output_type -> header.Rule
	58,  // 662: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	71,  // 663: header.ConversationMgr.ReadRule:output_type -> header.Rule
	208, // 664: header.ConversationMgr.ListRules:output_type -> header.Route
	209, // 665: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	72,  // 666: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	58,  // 667: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	72,  // 668: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	210, // 669: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	73,  // 670: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	73,  // 671: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	58,  // 672: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	73,  // 673: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	70,  // 674: header.ConversationMgr.TestNumber:output_type -> header.Integration
	70,  // 675: header.ConversationMgr.ActiveNumber:output_type -> header.Integration
	211, // 676: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	74,  // 677: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	75,  // 678: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	212, // 679: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	58,  // 680: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	213, // 681: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	76,  // 682: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	65,  // 683: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	214, // 684: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	46,  // 685: header.ConversationMgr.SaveMessage:output_type -> header.Event
	46,  // 686: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	77,  // 687: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	77,  // 688: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	58,  // 689: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	77,  // 690: header.TemplateMgr.GetTemplate:output_type -> header.Template
	215, // 691: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	58,  // 692: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	79,  // 693: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	79,  // 694: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	58,  // 695: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	79,  // 696: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	216, // 697: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	217, // 698: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	81,  // 699: header.TagMgr.CreateTag:output_type -> header.Tag
	81,  // 700: header.TagMgr.UpdateTag:output_type -> header.Tag
	58,  // 701: header.TagMgr.DeleteTag:output_type -> header.Empty
	218, // 702: header.TagMgr.ListTags:output_type -> header.Tags
	81,  // 703: header.TagMgr.GetTag:output_type -> header.Tag
	82,  // 704: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	82,  // 705: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	58,  // 706: header.Noti5Service.Noti:output_type -> header.Empty
	58,  // 707: header.Noti5Service.AddToken:output_type -> header.Empty
	58,  // 708: header.Noti5Service.RemoveToken:output_type -> header.Empty
	58,  // 709: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	219, // 710: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	220, // 711: header.PaymentMgr.GetSub:output_type -> header.AccSub
	89,  // 712: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	86,  // 713: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	86,  // 714: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	87,  // 715: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	87,  // 716: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	58,  // 717: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	221, // 718: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	222, // 719: header.PaymentMgr.Pay:output_type -> payment.Bill
	89,  // 720: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	89,  // 721: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	223, // 722: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	89,  // 723: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	89,  // 724: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	224, // 725: header.PaymentMgr.ListComments:output_type -> payment.Comments
	93,  // 726: header.PaymentMgr.AddComment:output_type -> payment.Comment
	225, // 727: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	226, // 728: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	226, // 729: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	94,  // 730: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	222, // 731: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	227, // 732: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	97,  // 733: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	97,  // 734: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	228, // 735: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	97,  // 736: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	229, // 737: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	230, // 738: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	231, // 739: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	58,  // 740: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	58,  // 741: header.Pubsub.Fire:output_type -> header.Empty
	232, // 742: header.Pubsub.Poll:output_type -> header.PollResult
	100, // 743: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	101, // 744: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	101, // 745: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	233, // 746: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	234, // 747: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	102, // 748: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	58,  // 749: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	58,  // 750: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	58,  // 751: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	1,   // 752: header.FabikonService.GenerateRefLink:output_type -> header.Id
	58,  // 753: header.FabikonService.LinkPageWithAccount:output_type -> header.Empty
	235, // 754: header.FabikonService.ListFacebookPages:output_type -> header.FacebookPages
	58,  // 755: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	236, // 756: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	58,  // 757: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	58,  // 758: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	58,  // 759: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	237, // 760: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	46,  // 761: header.ZalokonService.SendZNS:output_type -> header.Event
	58,  // 762: header.MailkonService.SendEmail:output_type -> header.Empty
	70,  // 763: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	58,  // 764: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	58,  // 765: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	238, // 766: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	239, // 767: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	106, // 768: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	58,  // 769: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	237, // 770: header.MailkonService.TrackLink:output_type -> header.Response
	237, // 771: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	108, // 772: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	237, // 773: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	237, // 774: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	237, // 775: header.MailkonService.BlockEmail:output_type -> header.Response
	237, // 776: header.MailkonService.UnblockEmail:output_type -> header.Response
	110, // 777: header.WidgetService.Read:output_type -> header.WidgetSetting
	110, // 778: header.WidgetService.Update:output_type -> header.WidgetSetting
	240, // 779: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	241, // 780: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	111, // 781: header.WidgetService.SubmitImpression:output_type -> header.Impression
	112, // 782: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	113, // 783: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	242, // 784: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	243, // 785: header.WidgetService.ListConversions:output_type -> header.Conversions
	244, // 786: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	116, // 787: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	245, // 788: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	58,  // 789: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	246, // 790: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	117, // 791: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	117, // 792: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	117, // 793: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	58,  // 794: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	117, // 795: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	246, // 796: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	58,  // 797: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	247, // 798: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	245, // 799: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	248, // 800: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	249, // 801: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	250, // 802: header.Bizbot.ListBots:output_type -> header.Bots
	120, // 803: header.Bizbot.GetBot:output_type -> header.Bot
	120, // 804: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	120, // 805: header.Bizbot.CreateBot:output_type -> header.Bot
	120, // 806: header.Bizbot.UpdateBot:output_type -> header.Bot
	58,  // 807: header.Bizbot.DeleteBot:output_type -> header.Empty
	58,  // 808: header.Bizbot.OnEvent:output_type -> header.Empty
	58,  // 809: header.Bizbot.StartBot:output_type -> header.Empty
	58,  // 810: header.Bizbot.StopBot:output_type -> header.Empty
	58,  // 811: header.Bizbot.TryAction:output_type -> header.Empty
	251, // 812: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	252, // 813: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	253, // 814: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	254, // 815: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	126, // 816: header.Sendback.CreateWebhook:output_type -> header.Webhook
	255, // 817: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	58,  // 818: header.Sendback.DeleteWebhook:output_type -> header.Empty
	256, // 819: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	126, // 820: header.Sendback.ReadWebhook:output_type -> header.Webhook
	126, // 821: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	126, // 822: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	257, // 823: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	258, // 824: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	58,  // 825: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	58,  // 826: header.Notibox.SendNoti:output_type -> header.Empty
	259, // 827: header.Notibox.ListNoties:output_type -> header.Notifications
	58,  // 828: header.Notibox.MarkReadNoti:output_type -> header.Empty
	58,  // 829: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	44,  // 830: header.Proder.ReadProduct:output_type -> header.Product
	44,  // 831: header.Proder.CreateProduct:output_type -> header.Product
	44,  // 832: header.Proder.UpdateProduct:output_type -> header.Product
	58,  // 833: header.Proder.DeleteProduct:output_type -> header.Empty
	260, // 834: header.Proder.ListProducts2:output_type -> header.Products
	261, // 835: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	262, // 836: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	133, // 837: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	133, // 838: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	58,  // 839: header.Proder.DeleteProductCollection:output_type -> header.Empty
	263, // 840: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	134, // 841: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	134, // 842: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	58,  // 843: header.Proder.DeleteProductFeed:output_type -> header.Empty
	264, // 844: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	27,  // 845: header.Proder.ReadOrder:output_type -> header.Order
	27,  // 846: header.Proder.CreateOrder:output_type -> header.Order
	27,  // 847: header.Proder.UpdateOrder:output_type -> header.Order
	58,  // 848: header.Proder.DeleteOrder:output_type -> header.Empty
	137, // 849: header.Proder.ListOrders:output_type -> header.Orders
	265, // 850: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	137, // 851: header.Proder.ImportOrders:output_type -> header.Orders
	46,  // 852: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 853: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 854: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 855: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 856: header.Proder.DeleteOrderComment:output_type -> header.Event
	266, // 857: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	267, // 858: header.Proder.DownloadOrder:output_type -> header.File
	1,   // 859: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	268, // 860: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	58,  // 861: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	269, // 862: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	58,  // 863: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	58,  // 864: header.Proder.GHNShippingStatus:output_type -> header.Empty
	145, // 865: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	27,  // 866: header.Proder.ShipOrder:output_type -> header.Order
	27,  // 867: header.Proder.UpdateShippingCode:output_type -> header.Order
	27,  // 868: header.Proder.CancelShippingOrder:output_type -> header.Order
	267, // 869: header.Proder.PrintShippingOrders:output_type -> header.File
	58,  // 870: header.Proder.SeenOrder:output_type -> header.Empty
	58,  // 871: header.Proder.FollowOrder:output_type -> header.Empty
	58,  // 872: header.Proder.UnfollowOrder:output_type -> header.Empty
	58,  // 873: header.Proder.TagOrder:output_type -> header.Empty
	58,  // 874: header.Proder.UntagOrder:output_type -> header.Empty
	146, // 875: header.Proder.ReadPipeline:output_type -> header.Pipeline
	146, // 876: header.Proder.CreatePipeline:output_type -> header.Pipeline
	146, // 877: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	58,  // 878: header.Proder.DeletePipeline:output_type -> header.Empty
	270, // 879: header.Proder.ListPipelines:output_type -> header.Pipelines
	58,  // 880: header.Proder.DeletePipelineStage:output_type -> header.Empty
	146, // 881: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	137, // 882: header.Proder.ReportOrder:output_type -> header.Orders
	58,  // 883: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	49,  // 884: header.TaskMgr.ReadTask:output_type -> header.Task
	49,  // 885: header.TaskMgr.CreateTask:output_type -> header.Task
	49,  // 886: header.TaskMgr.UpdateTask:output_type -> header.Task
	58,  // 887: header.TaskMgr.DeleteTask:output_type -> header.Empty
	271, // 888: header.TaskMgr.ListTasks:output_type -> header.Tasks
	58,  // 889: header.TaskMgr.SeenTask:output_type -> header.Empty
	58,  // 890: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	58,  // 891: header.TaskMgr.MuteTask:output_type -> header.Empty
	58,  // 892: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	46,  // 893: header.TaskMgr.AddTaskComment:output_type -> header.Event
	46,  // 894: header.TaskMgr.EditTaskComment:output_type -> header.Event
	46,  // 895: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	272, // 896: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	150, // 897: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	273, // 898: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	151, // 899: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	151, // 900: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	151, // 901: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	58,  // 902: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	58,  // 903: header.CampaignMgr.OnEvent:output_type -> header.Empty
	274, // 904: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	275, // 905: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	276, // 906: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	154, // 907: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	277, // 908: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	154, // 909: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	58,  // 910: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	278, // 911: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	58,  // 912: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	279, // 913: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	280, // 914: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	281, // 915: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	237, // 916: header.CreditMgr.ListCredits:output_type -> header.Response
	237, // 917: header.CreditMgr.AddCredit:output_type -> header.Response
	237, // 918: header.CreditMgr.DeleteCredit:output_type -> header.Response
	237, // 919: header.CreditMgr.UpdateCredit:output_type -> header.Response
	282, // 920: header.FormMgr.ListForms:output_type -> header.Forms
	161, // 921: header.FormMgr.CreateForm:output_type -> header.Form
	161, // 922: header.FormMgr.UpdateForm:output_type -> header.Form
	58,  // 923: header.FormMgr.DeleteForm:output_type -> header.Empty
	283, // 924: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	284, // 925: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	164, // 926: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	237, // 927: header.Scheduler.UnregisterTask:output_type -> header.Response
