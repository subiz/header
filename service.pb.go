...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x32, 0xe7, 0x0a, 0x0a, 0x0f, 0x43, 0x6f, 0x6e,
	...
	0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x44, 0x0a, 0x14, 0x53,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6f, 0x6e,
	...
	0x73, 0x12, 0x3f, 0x0a, 0x16, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x15, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x73, 0x12, 0x3d, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x75, 0x74, 0x65,
	...
	0x65, 0x72, 0x2e, 0x55, 0x72, 0x6c, 0x73, 0x32, 0xa4, 0x05, 0x0a, 0x06, 0x42, 0x69, 0x7a, 0x62,
	...
	0x32, 0xfd, 0x01, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x2b, 0x0a, 0x04,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0xc9, 0x05, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61, 0x70,
	...
	0x64, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_service_proto_depIdxs = []int32{
	...
	14,  // 98: header.ConversationMgr.SearchInternalConvos:input_type -> header.SearchRequest
	14,  // 99: header.ConversationMgr.SearchInternalMessages:input_type -> header.SearchRequest
	43,  // 100: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	...
	56,  // 133: header.Noti5Service.Noti:input_type -> noti5.PushNoti
	...
	0,   // 254: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 255: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 256: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	32,  // 257: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 258: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 259: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 260: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	32,  // 261: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 262: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 263: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 264: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 265: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 266: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 267: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 268: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 269: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 270: header.AccountMgr.CreateAccount:output_type -> account.Account
	106, // 271: header.AccountMgr.ListAgents:output_type -> account.Agents
	32,  // 272: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	107, // 273: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	32,  // 274: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	32,  // 275: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 276: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	108, // 277: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 278: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 279: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	109, // 280: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	32,  // 281: header.AccountMgr.LogoutSession:output_type -> header.Empty
	110, // 282: header.AccountMgr.GetLanguage:output_type -> header.Lang
	11,  // 283: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	12,  // 284: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	111, // 285: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	112, // 286: header.UserMgr.SearchUsers:output_type -> header.Users
	113, // 287: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	113, // 288: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	16,  // 289: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 290: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 291: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	1,   // 292: header.UserMgr.UpdateUser:output_type -> header.Id
	17,  // 293: header.UserMgr.ReadUser:output_type -> header.User
	114, // 294: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	112, // 295: header.UserMgr.MatchUsers:output_type -> header.Users
	20,  // 296: header.UserMgr.UpsertView:output_type -> header.UserView
	32,  // 297: header.UserMgr.DeleteView:output_type -> header.Empty
	20,  // 298: header.UserMgr.GetView:output_type -> header.UserView
	115, // 299: header.UserMgr.ListViews:output_type -> header.UserViews
	112, // 300: header.UserMgr.ListUserInViews:output_type -> header.Users
	22,  // 301: header.UserMgr.UpsertLabel:output_type -> header.Label
	32,  // 302: header.UserMgr.DeleteLabel:output_type -> header.Empty
	116, // 303: header.UserMgr.ListLabels:output_type -> header.Labels
	22,  // 304: header.UserMgr.GetLabel:output_type -> header.Label
	32,  // 305: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	32,  // 306: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	32,  // 307: header.UserMgr.AddUserLabel:output_type -> header.Empty
	32,  // 308: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	32,  // 309: header.UserPersist.UpdateUser:output_type -> header.Empty
	112, // 310: header.UserPersist.FilterUsers:output_type -> header.Users
	117, // 311: header.LiveMgr.SearchLocations:output_type -> header.Locations
	112, // 312: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	118, // 313: header.LiveMgr.TopEvents:output_type -> header.Events
	119, // 314: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	120, // 315: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	121, // 316: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	122, // 317: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	123, // 318: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	124, // 319: header.NoteMgr.ListNotes:output_type -> header.Notes
	29,  // 320: header.NoteMgr.AddNote:output_type -> header.Note
	29,  // 321: header.NoteMgr.UpdateNote:output_type -> header.Note
	32,  // 322: header.NoteMgr.DeleteNote:output_type -> header.Empty
	125, // 323: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	31,  // 324: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	32,  // 325: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	31,  // 326: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	31,  // 327: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	126, // 328: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	33,  // 329: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	33,  // 330: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	32,  // 331: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	127, // 332: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	36,  // 333: header.RuleMgr.UpdateRule:output_type -> header.Rule
	36,  // 334: header.RuleMgr.CreateRule:output_type -> header.Rule
	32,  // 335: header.RuleMgr.DeleteRule:output_type -> header.Empty
	36,  // 336: header.RuleMgr.ReadRule:output_type -> header.Rule
	128, // 337: header.RuleMgr.ListRules:output_type -> header.Route
	129, // 338: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 339: header.ConversationMgr.PongMessage:output_type -> header.Event
	43,  // 340: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	43,  // 341: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	43,  // 342: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	130, // 343: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	130, // 344: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	32,  // 345: header.ConversationMgr.TagConversation:output_type -> header.Empty
	32,  // 346: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	32,  // 347: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	32,  // 348: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	32,  // 349: header.ConversationMgr.Typing:output_type -> header.Empty
	43,  // 350: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	130, // 351: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	130, // 352: header.ConversationMgr.SearchInternalConvos:output_type -> header.Conversations
	118, // 353: header.ConversationMgr.SearchInternalMessages:output_type -> header.Events
	32,  // 354: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	32,  // 355: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	32,  // 356: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	44,  // 357: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	44,  // 358: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 359: header.ConversationMgr.TerminateBot:output_type -> header.Event
	131, // 360: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 361: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	46,  // 362: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	32,  // 363: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	46,  // 364: header.TemplateMgr.GetTemplate:output_type -> header.Template
	132, // 365: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	32,  // 366: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	48,  // 367: header.TagMgr.CreateTag:output_type -> header.Tag
	48,  // 368: header.TagMgr.UpdateTag:output_type -> header.Tag
	32,  // 369: header.TagMgr.DeleteTag:output_type -> header.Empty
	133, // 370: header.TagMgr.ListTags:output_type -> header.Tags
	48,  // 371: header.TagMgr.GetTag:output_type -> header.Tag
	32,  // 372: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	134, // 373: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	49,  // 374: header.IntegrationMgr.Integrate:output_type -> header.Integration
	118, // 375: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 376: header.EventMgr.CreateEvent:output_type -> header.Event
	38,  // 377: header.ConversationEventReader.SendMessage:output_type -> header.Event
	38,  // 378: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	32,  // 379: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	32,  // 380: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	118, // 381: header.ConversationEventReader.ListEvents:output_type -> header.Events
	135, // 382: header.FileMgr.Presign:output_type -> header.PresignResult
	136, // 383: header.FileMgr.Read:output_type -> header.File
	136, // 384: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 385: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 386: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	32,  // 387: header.Noti5Service.Noti:output_type -> header.Empty
	32,  // 388: header.Noti5Service.AddToken:output_type -> header.Empty
	32,  // 389: header.Noti5Service.RemoveToken:output_type -> header.Empty
	32,  // 390: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 391: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 392: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 393: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 394: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 395: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 396: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 397: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	32,  // 398: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	138, // 399: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 400: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 401: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 402: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 403: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 404: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 405: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 406: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 407: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 408: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 409: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 410: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 411: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 412: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 413: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 414: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 415: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	32,  // 416: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 417: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	143, // 418: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	32,  // 419: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 420: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 421: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 422: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 423: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	145, // 424: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	146, // 425: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	147, // 426: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	32,  // 427: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	32,  // 428: header.Pubsub.Publish:output_type -> header.Empty
	32,  // 429: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 430: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 431: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	148, // 432: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	149, // 433: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 434: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 435: header.WidgetService.Update:output_type -> header.WidgetSetting
	150, // 436: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	151, // 437: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	80,  // 438: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 439: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 440: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	152, // 441: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	153, // 442: header.WidgetService.ListConversions:output_type -> header.Conversions
	154, // 443: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 444: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	155, // 445: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	32,  // 446: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	156, // 447: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	86,  // 448: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	86,  // 449: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	86,  // 450: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	32,  // 451: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	86,  // 452: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	156, // 453: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	32,  // 454: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	157, // 455: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	155, // 456: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	158, // 457: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	159, // 458: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	160, // 459: header.Bizbot.ListBots:output_type -> header.Bots
	88,  // 460: header.Bizbot.GetBot:output_type -> header.Bot
	88,  // 461: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	88,  // 462: header.Bizbot.CreateBot:output_type -> header.Bot
	88,  // 463: header.Bizbot.UpdateBot:output_type -> header.Bot
	32,  // 464: header.Bizbot.DeleteBot:output_type -> header.Empty
	32,  // 465: header.Bizbot.OnEvent:output_type -> header.Empty
	32,  // 466: header.Bizbot.StartBot:output_type -> header.Empty
	32,  // 467: header.Bizbot.StopBot:output_type -> header.Empty
	32,  // 468: header.Bizbot.TryAction:output_type -> header.Empty
	161, // 469: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	162, // 470: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	88,  // 471: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	160, // 472: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	92,  // 473: header.Sendback.CreateWebhook:output_type -> header.Webhook
	163, // 474: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	32,  // 475: header.Sendback.DeleteWebhook:output_type -> header.Empty
	164, // 476: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	92,  // 477: header.Sendback.ReadWebhook:output_type -> header.Webhook
	92,  // 478: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	92,  // 479: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	165, // 480: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	166, // 481: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	32,  // 482: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	32,  // 483: header.Notibox.Send:output_type -> header.Empty
	32,  // 484: header.Notibox.MarkRead:output_type -> header.Empty
	32,  // 485: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	167, // 486: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	98,  // 487: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	32,  // 488: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	168, // 489: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	98,  // 490: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	98,  // 491: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	169, // 492: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	170, // 493: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	171, // 494: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	169, // 495: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	32,  // 496: header.Holap.AppendAgentSet:output_type -> header.Empty
	32,  // 497: header.Holap.AppendTagSet:output_type -> header.Empty
	32,  // 498: header.Holap.UpdateUser:output_type -> header.Empty
	32,  // 499: header.Holap.UpdateConversation:output_type -> header.Empty
	32,  // 500: header.Holap.OnConversationEvent:output_type -> header.Empty
	32,  // 501: header.Holap.FreeAccount:output_type -> header.Empty
	172, // 502: header.Holap.ReportUser:output_type -> header.UserMetrics
	173, // 503: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 504: header.Holap.ListUserIds:output_type -> header.Ids
	130, // 505: header.Holap.ListConversationIds:output_type -> header.Conversations
	174, // 506: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 507: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
...
type ConversationMgrClient interface {
	...
	SearchInternalConvos(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Conversations, error)
	SearchInternalMessages(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Events, error)
...
func (c *conversationMgrClient) SearchInternalConvos(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Conversations, error) {
	out := new(Conversations)
	err := c.cc.Invoke(ctx, "/header.ConversationMgr/SearchInternalConvos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationMgrClient) SearchInternalMessages(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Events, error) {
	out := new(Events)
	err := c.cc.Invoke(ctx, "/header.ConversationMgr/SearchInternalMessages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationMgrServer interface {
	...
	SearchInternalConvos(context.Context, *SearchRequest) (*Conversations, error)
	SearchInternalMessages(context.Context, *SearchRequest) (*Events, error)
...
func (*UnimplementedConversationMgrServer) SearchInternalConvos(context.Context, *SearchRequest) (*Conversations, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchInternalConvos not implemented")
}
func (*UnimplementedConversationMgrServer) SearchInternalMessages(context.Context, *SearchRequest) (*Events, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchInternalMessages not implemented")
}
...
func _ConversationMgr_SearchInternalConvos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationMgrServer).SearchInternalConvos(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.ConversationMgr/SearchInternalConvos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationMgrServer).SearchInternalConvos(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ConversationMgr_SearchInternalMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationMgrServer).SearchInternalMessages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.ConversationMgr/SearchInternalMessages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationMgrServer).SearchInternalMessages(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ConversationMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchInternalConvos",
			Handler:    _ConversationMgr_SearchInternalConvos_Handler,
		},
		{
			MethodName: "SearchInternalMessages",
			Handler:    _ConversationMgr_SearchInternalMessages_Handler,
		},
		{
