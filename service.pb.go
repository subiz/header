...
var file_service_proto_depIdxs = []int32{
	...
	12,  // 291: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	107, // 292: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	107, // 293: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	107, // 294: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	107, // 295: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	108, // 296: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	...
	12,  // 302: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	109, // 303: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	12,  // 304: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	110, // 305: header.MailkonService.TrackLink:input_type -> header.LinkData
	111, // 306: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	111, // 307: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	12,  // 308: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	112, // 309: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	112, // 310: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	12,  // 311: header.MailkonService.UnblockEmail:input_type -> header.Id
	12,  // 312: header.WidgetService.Read:input_type -> header.Id
	113, // 313: header.WidgetService.Update:input_type -> header.WidgetSetting
	12,  // 314: header.WidgetService.ReadUserSetting:input_type -> header.Id
	12,  // 315: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	114, // 316: header.WidgetService.SubmitImpression:input_type -> header.Impression
	115, // 317: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	116, // 318: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	117, // 319: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	118, // 320: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	118, // 321: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	119, // 322: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	12,  // 323: header.WidgetService.ListUploadedImage:input_type -> header.Id
	119, // 324: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	12,  // 325: header.WidgetService.ListWebPlugins:input_type -> header.Id
	120, // 326: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	120, // 327: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	120, // 328: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	12,  // 329: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	120, // 330: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	12,  // 331: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	12,  // 332: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	121, // 333: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	12,  // 334: header.WidgetService.SearchImages:input_type -> header.Id
	12,  // 335: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	12,  // 336: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	122, // 337: header.Bizbot.ListBots:input_type -> header.BotsRequest
	12,  // 338: header.Bizbot.GetBot:input_type -> header.Id
	123, // 339: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	123, // 340: header.Bizbot.CreateBot:input_type -> header.Bot
	123, // 341: header.Bizbot.UpdateBot:input_type -> header.Bot
	12,  // 342: header.Bizbot.DeleteBot:input_type -> header.Id
	124, // 343: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	124, // 344: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	124, // 345: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	124, // 346: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	125, // 347: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	126, // 348: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	127, // 349: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	128, // 350: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	129, // 351: header.Sendback.CreateWebhook:input_type -> header.Webhook
	12,  // 352: header.Sendback.PingWebhook:input_type -> header.Id
	12,  // 353: header.Sendback.DeleteWebhook:input_type -> header.Id
	12,  // 354: header.Sendback.ListWebhooks:input_type -> header.Id
	12,  // 355: header.Sendback.ReadWebhook:input_type -> header.Id
	129, // 356: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	12,  // 357: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	130, // 358: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	131, // 359: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 360: header.Sendback.SendWebhookEvent:input_type -> header.Event
	132, // 361: header.Notibox.SendNoti:input_type -> header.Notification
	133, // 362: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	12,  // 363: header.Notibox.MarkReadNoti:input_type -> header.Id
	12,  // 364: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	...
	12,  // 368: header.Proder.DeleteProduct:input_type -> header.Id
	...
	13,  // 371: header.Proder.ListProductCollections:input_type -> header.Ids
	...
	12,  // 374: header.Proder.DeleteProductCollection:input_type -> header.Id
	12,  // 375: header.Proder.ListProductFeeds:input_type -> header.Id
	...
	12,  // 378: header.Proder.DeleteProductFeed:input_type -> header.Id
	13,  // 379: header.Proder.ListProductCategories:input_type -> header.Ids
	12,  // 380: header.Proder.ReadOrder:input_type -> header.Id
	27,  // 381: header.Proder.CreateOrder:input_type -> header.Order
	27,  // 382: header.Proder.UpdateOrder:input_type -> header.Order
	12,  // 383: header.Proder.DeleteOrder:input_type -> header.Id
	...
	12,  // 392: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 393: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	12,  // 394: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 395: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	12,  // 396: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	...
	12,  // 401: header.Proder.ShipOrder:input_type -> header.Id
	27,  // 402: header.Proder.UpdateShippingCode:input_type -> header.Order
	12,  // 403: header.Proder.CancelShippingOrder:input_type -> header.Id
	13,  // 404: header.Proder.PrintShippingOrders:input_type -> header.Ids
	12,  // 405: header.Proder.SeenOrder:input_type -> header.Id
	12,  // 406: header.Proder.FollowOrder:input_type -> header.Id
	12,  // 407: header.Proder.UnfollowOrder:input_type -> header.Id
	63,  // 408: header.Proder.TagOrder:input_type -> header.TagRequest
	63,  // 409: header.Proder.UntagOrder:input_type -> header.TagRequest
	12,  // 410: header.Proder.ReadPipeline:input_type -> header.Id
	...
	12,  // 413: header.Proder.DeletePipeline:input_type -> header.Id
	13,  // 414: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 415: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	12,  // 416: header.Proder.PreselectPipeline:input_type -> header.Id
	151, // 417: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	13,  // 418: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	12,  // 419: header.TaskMgr.ReadTask:input_type -> header.Id
	49,  // 420: header.TaskMgr.CreateTask:input_type -> header.Task
	49,  // 421: header.TaskMgr.UpdateTask:input_type -> header.Task
	12,  // 422: header.TaskMgr.DeleteTask:input_type -> header.Id
	152, // 423: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	12,  // 424: header.TaskMgr.SeenTask:input_type -> header.Id
	12,  // 425: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	12,  // 426: header.TaskMgr.MuteTask:input_type -> header.Id
	12,  // 427: header.TaskMgr.UnmuteTask:input_type -> header.Id
	...
	142, // 430: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	12,  // 431: header.TaskMgr.ListTaskComments:input_type -> header.Id
	153, // 432: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	13,  // 433: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	12,  // 434: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	154, // 435: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	154, // 436: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	12,  // 437: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	46,  // 438: header.CampaignMgr.OnEvent:input_type -> header.Event
	155, // 439: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	12,  // 440: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	156, // 441: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	157, // 442: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	158, // 443: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	157, // 444: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	157, // 445: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	159, // 446: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	156, // 447: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	160, // 448: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	161, // 449: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	162, // 450: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	12,  // 451: header.CreditMgr.ListCredits:input_type -> header.Id
	163, // 452: header.CreditMgr.AddCredit:input_type -> header.Credit
	12,  // 453: header.CreditMgr.DeleteCredit:input_type -> header.Id
	163, // 454: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	12,  // 455: header.FormMgr.ListForms:input_type -> header.Id
	164, // 456: header.FormMgr.CreateForm:input_type -> header.Form
	164, // 457: header.FormMgr.UpdateForm:input_type -> header.Form
	12,  // 458: header.FormMgr.DeleteForm:input_type -> header.Id
	165, // 459: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	166, // 460: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	167, // 461: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	167, // 462: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	58,  // 463: header.GooglekonService.SendEventToGoogle:output_type -> header.Empty
	168, // 464: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	58,  // 465: header.DocSearch.IndexConvo:output_type -> header.Empty
	169, // 466: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	170, // 467: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	171, // 468: header.DocSearch.Report:output_type -> header.ConvoReportResponse
	172, // 469: header.DocSearch.ListIds:output_type -> header.Conversations
	172, // 470: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	173, // 471: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	172, // 472: header.DocSearch.ListCallIds:output_type -> header.Conversations
	174, // 473: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	9,   // 474: header.NumberRegistry.Compact:output_type -> header.Number
	8,   // 475: header.NumberRegistry.Uncompact:output_type -> header.String
	10,  // 476: header.NumberRegistry.CompactM:output_type -> header.StrNumM
	175, // 477: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	25,  // 478: header.Map.LookupAddress:output_type -> header.Address
	176, // 479: header.Map.PredictAddress:output_type -> header.Addresses
	176, // 480: header.Map.ListDistricts:output_type -> header.Addresses
	176, // 481: header.Map.ListProvinces:output_type -> header.Addresses
	176, // 482: header.Map.ListWards:output_type -> header.Addresses
	176, // 483: header.Map.ListStreets:output_type -> header.Addresses
	176, // 484: header.Map.ListAddresses:output_type -> header.Addresses
	25,  // 485: header.Map.ReadAddress:output_type -> header.Address
	...
	58,  // 489: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	17,  // 490: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	17,  // 491: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	17,  // 492: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	18,  // 493: header.AccountMgr.DeleteAccount:output_type -> account.Account
	18,  // 494: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	58,  // 495: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	17,  // 496: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	17,  // 497: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	17,  // 498: header.AccountMgr.GetInvitation:output_type -> account.Agent
	17,  // 499: header.AccountMgr.InviteAgent:output_type -> account.Agent
	17,  // 500: header.AccountMgr.GetAgent:output_type -> account.Agent
	17,  // 501: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	18,  // 502: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	18,  // 503: header.AccountMgr.GetAccount:output_type -> account.Account
	18,  // 504: header.AccountMgr.UpdateAccount:output_type -> account.Account
	18,  // 505: header.AccountMgr.CreateAccount:output_type -> account.Account
	177, // 506: header.AccountMgr.ListAgents:output_type -> account.Agents
	58,  // 507: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	178, // 508: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	17,  // 509: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	179, // 510: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	17,  // 511: header.AccountMgr.TransferOwner:output_type -> account.Agent
	22,  // 512: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	180, // 513: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	180, // 514: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	58,  // 515: header.AccountMgr.LogoutSession:output_type -> header.Empty
	22,  // 516: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	181, // 517: header.AccountMgr.GetLanguage:output_type -> header.Lang
	23,  // 518: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	24,  // 519: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	24,  // 520: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	182, // 521: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	58,  // 522: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	176, // 523: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	25,  // 524: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	25,  // 525: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	58,  // 526: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	183, // 527: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	26,  // 528: header.AccountMgr.CreateTax:output_type -> header.Tax
	26,  // 529: header.AccountMgr.UpdateTax:output_type -> header.Tax
	58,  // 530: header.AccountMgr.DeleteTax:output_type -> header.Empty
	184, // 531: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	184, // 532: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	28,  // 533: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	28,  // 534: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	58,  // 535: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	29,  // 536: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	185, // 537: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	29,  // 538: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	58,  // 539: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	186, // 540: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	30,  // 541: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	30,  // 542: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	58,  // 543: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	58,  // 544: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	187, // 545: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	58,  // 546: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	31,  // 547: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	31,  // 548: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	31,  // 549: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	32,  // 550: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	188, // 551: header.AccountMgr.ListAgentPresences:output_type -> account.Presences
	189, // 552: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	...
	35,  // 556: header.UserMgr.MergeUser:output_type -> header.User
	58,  // 557: header.UserMgr.DetachUser:output_type -> header.Empty
	35,  // 558: header.UserMgr.CreateUser2:output_type -> header.User
	35,  // 559: header.UserMgr.UpdateUser:output_type -> header.User
	190, // 560: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	58,  // 561: header.UserMgr.RemoveUser:output_type -> header.Empty
	58,  // 562: header.UserMgr.RestoreUser:output_type -> header.Empty
	35,  // 563: header.UserMgr.ReadUser:output_type -> header.User
	35,  // 564: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	34,  // 565: header.UserMgr.MatchUsers:output_type -> header.Users
	35,  // 566: header.UserMgr.BanUser:output_type -> header.User
	35,  // 567: header.UserMgr.UnbanUser:output_type -> header.User
	34,  // 568: header.UserMgr.LookupByPhone:output_type -> header.Users
	36,  // 569: header.UserMgr.UpdateView:output_type -> header.UserView
	36,  // 570: header.UserMgr.CreateView:output_type -> header.UserView
	58,  // 571: header.UserMgr.DeleteView:output_type -> header.Empty
	36,  // 572: header.UserMgr.GetView:output_type -> header.UserView
	191, // 573: header.UserMgr.ListViews:output_type -> header.UserViews
	37,  // 574: header.UserMgr.UpdateSegment:output_type -> header.Segment
	37,  // 575: header.UserMgr.CreateSegment:output_type -> header.Segment
	58,  // 576: header.UserMgr.DeleteSegment:output_type -> header.Empty
	37,  // 577: header.UserMgr.GetSegment:output_type -> header.Segment
	192, // 578: header.UserMgr.ListSegments:output_type -> header.Segments
	34,  // 579: header.UserMgr.ListUsers:output_type -> header.Users
	58,  // 580: header.UserMgr.AddToSegment:output_type -> header.Empty
	58,  // 581: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	58,  // 582: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	41,  // 583: header.UserMgr.UpsertLabel:output_type -> header.Label
	58,  // 584: header.UserMgr.DeleteLabel:output_type -> header.Empty
	193, // 585: header.UserMgr.ListLabels:output_type -> header.Labels
	41,  // 586: header.UserMgr.GetLabel:output_type -> header.Label
	58,  // 587: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	58,  // 588: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	58,  // 589: header.UserMgr.AddUserLabel:output_type -> header.Empty
	58,  // 590: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	58,  // 591: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	25,  // 592: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	25,  // 593: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	58,  // 594: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	194, // 595: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	58,  // 596: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	34,  // 597: header.UserMgr.ListLeads:output_type -> header.Users
	195, // 598: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	44,  // 599: header.UserMgr.LinkProductUrl:output_type -> header.Product
	0,   // 600: header.UserMgr.ListUserEvents:output_type -> header.Events
	46,  // 601: header.UserMgr.CreateUserEvent:output_type -> header.Event
	47,  // 602: header.UserMgr.FillDevice:output_type -> common.Device
	196, // 603: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	58,  // 604: header.UserMgr.LinkTask:output_type -> header.Empty
	197, // 605: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	13,  // 606: header.UserMgr.ListUserIds:output_type -> header.Ids
	34,  // 607: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	169, // 608: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	198, // 609: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	199, // 610: header.LiveMgr.SearchLocations:output_type -> header.Locations
	34,  // 611: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	200, // 612: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	201, // 613: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	202, // 614: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	203, // 615: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	204, // 616: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	205, // 617: header.NoteMgr.ListNotes:output_type -> header.Notes
	56,  // 618: header.NoteMgr.AddNote:output_type -> header.Note
	56,  // 619: header.NoteMgr.UpdateNote:output_type -> header.Note
	58,  // 620: header.NoteMgr.DeleteNote:output_type -> header.Empty
	206, // 621: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	59,  // 622: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	59,  // 623: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	207, // 624: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 625: header.ConversationMgr.PongMessage:output_type -> header.Event
	65,  // 626: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	65,  // 627: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	65,  // 628: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	172, // 629: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	172, // 630: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	58,  // 631: header.ConversationMgr.TagConversation:output_type -> header.Empty
	58,  // 632: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	58,  // 633: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	58,  // 634: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	58,  // 635: header.ConversationMgr.Typing:output_type -> header.Empty
	65,  // 636: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	58,  // 637: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	58,  // 638: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	58,  // 639: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	58,  // 640: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	66,  // 641: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	66,  // 642: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 643: header.ConversationMgr.TerminateBot:output_type -> header.Event
	46,  // 644: header.ConversationMgr.SendMessage:output_type -> header.Event
	46,  // 645: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	46,  // 646: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	58,  // 647: header.ConversationMgr.PinMessage:output_type -> header.Empty
	58,  // 648: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	0,   // 649: header.ConversationMgr.ListEvents:output_type -> header.Events
	58,  // 650: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	208, // 651: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	70,  // 652: header.ConversationMgr.Integrate:output_type -> header.Integration
	70,  // 653: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	71,  // 654: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	71,  // 655: header.ConversationMgr.CreateRule:output_type -> header.Rule
	58,  // 656: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	71,  // 657: header.ConversationMgr.ReadRule:output_type -> header.Rule
	209, // 658: header.ConversationMgr.ListRules:output_type -> header.Route
	210, // 659: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	72,  // 660: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	58,  // 661: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	72,  // 662: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	211, // 663: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	73,  // 664: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	73,  // 665: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	58,  // 666: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	73,  // 667: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	70,  // 668: header.ConversationMgr.TestNumber:output_type -> header.Integration
	70,  // 669: header.ConversationMgr.ActiveNumber:output_type -> header.Integration
	212, // 670: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	74,  // 671: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	75,  // 672: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	213, // 673: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	58,  // 674: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	214, // 675: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	76,  // 676: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	65,  // 677: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	215, // 678: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	46,  // 679: header.ConversationMgr.SaveMessage:output_type -> header.Event
	46,  // 680: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	77,  // 681: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	77,  // 682: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	58,  // 683: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	77,  // 684: header.TemplateMgr.GetTemplate:output_type -> header.Template
	216, // 685: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	58,  // 686: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	79,  // 687: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	79,  // 688: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	58,  // 689: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	79,  // 690: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	217, // 691: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	218, // 692: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	81,  // 693: header.TagMgr.CreateTag:output_type -> header.Tag
	81,  // 694: header.TagMgr.UpdateTag:output_type -> header.Tag
	58,  // 695: header.TagMgr.DeleteTag:output_type -> header.Empty
	219, // 696: header.TagMgr.ListTags:output_type -> header.Tags
	81,  // 697: header.TagMgr.GetTag:output_type -> header.Tag
	82,  // 698: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	82,  // 699: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	58,  // 700: header.Noti5Service.Noti:output_type -> header.Empty
	58,  // 701: header.Noti5Service.AddToken:output_type -> header.Empty
	58,  // 702: header.Noti5Service.RemoveToken:output_type -> header.Empty
	58,  // 703: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	220, // 704: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	221, // 705: header.PaymentMgr.GetSub:output_type -> header.AccSub
	89,  // 706: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	86,  // 707: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	86,  // 708: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	87,  // 709: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	87,  // 710: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	58,  // 711: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	222, // 712: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	223, // 713: header.PaymentMgr.Pay:output_type -> payment.Bill
	89,  // 714: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	89,  // 715: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	224, // 716: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	89,  // 717: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	89,  // 718: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	225, // 719: header.PaymentMgr.ListComments:output_type -> payment.Comments
	93,  // 720: header.PaymentMgr.AddComment:output_type -> payment.Comment
	226, // 721: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	97,  // 722: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	97,  // 723: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	94,  // 724: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	223, // 725: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	227, // 726: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	96,  // 727: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	96,  // 728: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	58,  // 729: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	96,  // 730: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	228, // 731: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	58,  // 732: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	101, // 733: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	101, // 734: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	229, // 735: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	101, // 736: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	230, // 737: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	231, // 738: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	232, // 739: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	58,  // 740: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	58,  // 741: header.Pubsub.Fire:output_type -> header.Empty
	233, // 742: header.Pubsub.Poll:output_type -> header.PollResult
	104, // 743: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	105, // 744: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	105, // 745: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	234, // 746: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	235, // 747: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	106, // 748: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	...
	12,  // 752: header.FabikonService.GenerateRefLink:output_type -> header.Id
	58,  // 753: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	236, // 754: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	237, // 758: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	...
	238, // 764: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	239, // 765: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	109, // 766: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	58,  // 767: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	237, // 768: header.MailkonService.TrackLink:output_type -> header.Response
	237, // 769: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	111, // 770: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	237, // 771: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	237, // 772: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	237, // 773: header.MailkonService.BlockEmail:output_type -> header.Response
	237, // 774: header.MailkonService.UnblockEmail:output_type -> header.Response
	113, // 775: header.WidgetService.Read:output_type -> header.WidgetSetting
	113, // 776: header.WidgetService.Update:output_type -> header.WidgetSetting
	240, // 777: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	241, // 778: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	114, // 779: header.WidgetService.SubmitImpression:output_type -> header.Impression
	115, // 780: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	116, // 781: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	242, // 782: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	243, // 783: header.WidgetService.ListConversions:output_type -> header.Conversions
	244, // 784: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	119, // 785: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	245, // 786: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	58,  // 787: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	246, // 788: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	120, // 789: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	120, // 790: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	120, // 791: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	58,  // 792: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	120, // 793: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	246, // 794: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	58,  // 795: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	247, // 796: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	245, // 797: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	248, // 798: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	249, // 799: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	250, // 800: header.Bizbot.ListBots:output_type -> header.Bots
	123, // 801: header.Bizbot.GetBot:output_type -> header.Bot
	123, // 802: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	123, // 803: header.Bizbot.CreateBot:output_type -> header.Bot
	123, // 804: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	251, // 810: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	252, // 811: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	253, // 812: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	254, // 813: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	129, // 814: header.Sendback.CreateWebhook:output_type -> header.Webhook
	255, // 815: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	58,  // 816: header.Sendback.DeleteWebhook:output_type -> header.Empty
	256, // 817: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	129, // 818: header.Sendback.ReadWebhook:output_type -> header.Webhook
	129, // 819: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	129, // 820: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	257, // 821: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	258, // 822: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	58,  // 823: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	58,  // 824: header.Notibox.SendNoti:output_type -> header.Empty
	259, // 825: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	260, // 832: header.Proder.ListProducts2:output_type -> header.Products
	261, // 833: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	262, // 834: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 835: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 836: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	58,  // 837: header.Proder.DeleteProductCollection:output_type -> header.Empty
	263, // 838: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 839: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 840: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	58,  // 841: header.Proder.DeleteProductFeed:output_type -> header.Empty
	264, // 842: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	...
	140, // 847: header.Proder.ListOrders:output_type -> header.Orders
	265, // 848: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 849: header.Proder.ImportOrders:output_type -> header.Orders
	...
	266, // 855: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	267, // 856: header.Proder.DownloadOrder:output_type -> header.File
	12,  // 857: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	268, // 858: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	58,  // 859: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	269, // 860: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	148, // 863: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	...
	267, // 867: header.Proder.PrintShippingOrders:output_type -> header.File
	...
	149, // 873: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 874: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 875: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	58,  // 876: header.Proder.DeletePipeline:output_type -> header.Empty
	270, // 877: header.Proder.ListPipelines:output_type -> header.Pipelines
	58,  // 878: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 879: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 880: header.Proder.ReportOrder:output_type -> header.Orders
	...
	271, // 886: header.TaskMgr.ListTasks:output_type -> header.Tasks
	...
	272, // 894: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	153, // 895: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	273, // 896: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	154, // 897: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	154, // 898: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	154, // 899: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	...
	274, // 902: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	275, // 903: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	276, // 904: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	157, // 905: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	277, // 906: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	157, // 907: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	58,  // 908: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	278, // 909: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	58,  // 910: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	279, // 911: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	280, // 912: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	281, // 913: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	237, // 914: header.CreditMgr.ListCredits:output_type -> header.Response
	237, // 915: header.CreditMgr.AddCredit:output_type -> header.Response
	237, // 916: header.CreditMgr.DeleteCredit:output_type -> header.Response
	237, // 917: header.CreditMgr.UpdateCredit:output_type -> header.Response
	282, // 918: header.FormMgr.ListForms:output_type -> header.Forms
	164, // 919: header.FormMgr.CreateForm:output_type -> header.Form
	164, // 920: header.FormMgr.UpdateForm:output_type -> header.Form
	58,  // 921: header.FormMgr.DeleteForm:output_type -> header.Empty
	283, // 922: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	284, // 923: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	167, // 924: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	237, // 925: header.Scheduler.UnregisterTask:output_type -> header.Response
