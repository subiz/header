...
var file_service_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xa5, 0x01, 0x0a, 0x0b, 0x55,
	0x73, 0x65, 0x72, 0x50, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x0f, 0x4c, 0x69,
	0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x56, 0x69, 0x65, 0x77, 0x73, 0x12, 0x10, 0x2e,
	...
	0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x37, 0x0a, 0x0b, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x19, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
	...
	0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x9c,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x32, 0x99, 0x01, 0x0a,
	...
	0x2e, 0x50, 0x72, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x29,
	0x0a, 0x04, 0x52, 0x65, 0x61, 0x64, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x2d, 0x0a, 0x08, 0x55, 0x70, 0x6c,
	...
	0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x32, 0xf5, 0x01, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64,
	0x65, 0x72, 0x12, 0x2d, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x73, 0x12, 0x2a, 0x0a, 0x0b, 0x52, 0x65, 0x61, 0x64, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*UserViewCondition)(nil),                 // 24: header.UserViewCondition
...
var file_service_proto_depIdxs = []int32{
	...
	21,  // 56: header.UserPersist.ListUserInViews:input_type -> header.UserView
	17,  // 57: header.UserPersist.UpdateUser:input_type -> header.User
	24,  // 58: header.UserPersist.FilterUsers:input_type -> header.UserViewCondition
	25,  // 59: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	26,  // 60: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	27,  // 61: header.LiveMgr.TopEvents:input_type -> header.EventParams
	1,   // 62: header.LiveMgr.TopLocations:input_type -> header.Id
	1,   // 63: header.LiveMgr.TopPages:input_type -> header.Id
	1,   // 64: header.LiveMgr.TopSources:input_type -> header.Id
	1,   // 65: header.LiveMgr.CountActiveUsers:input_type -> header.Id
	28,  // 66: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	29,  // 67: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	30,  // 68: header.NoteMgr.AddNote:input_type -> header.Note
	30,  // 69: header.NoteMgr.UpdateNote:input_type -> header.Note
	31,  // 70: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	1,   // 71: header.AutomationMgr.ListAutomations:input_type -> header.Id
	32,  // 72: header.AutomationMgr.UpdateAutomation:input_type -> header.Automation
	1,   // 73: header.AutomationMgr.DeleteAutomation:input_type -> header.Id
	1,   // 74: header.AutomationMgr.ReadAutomation:input_type -> header.Id
	32,  // 75: header.AutomationMgr.CreateAutomation:input_type -> header.Automation
	33,  // 76: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	34,  // 77: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	34,  // 78: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	35,  // 79: header.AttributeMgr.DeleteAttributeDefinition:input_type -> header.DeleteAttrRequest
	36,  // 80: header.ConversationReporter.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	37,  // 81: header.RuleMgr.UpdateRule:input_type -> header.Rule
	37,  // 82: header.RuleMgr.CreateRule:input_type -> header.Rule
	1,   // 83: header.RuleMgr.DeleteRule:input_type -> header.Id
	1,   // 84: header.RuleMgr.ReadRule:input_type -> header.Id
	1,   // 85: header.RuleMgr.ListRules:input_type -> header.Id
	38,  // 86: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	39,  // 87: header.ConversationMgr.PongMessage:input_type -> header.Event
	40,  // 88: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	...
	41,  // 91: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	20,  // 92: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	42,  // 93: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	42,  // 94: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	43,  // 95: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	43,  // 96: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	1,   // 97: header.ConversationMgr.Typing:input_type -> header.Id
	44,  // 98: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	14,  // 99: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	44,  // 100: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	43,  // 101: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	44,  // 102: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	44,  // 103: header.ConversationMgr.MarkReadConversation:input_type -> header.Conversation
	45,  // 104: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	1,   // 105: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	46,  // 106: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	1,   // 107: header.ConversationMgr.UpdatePresence:input_type -> header.Id
	47,  // 108: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	47,  // 109: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	1,   // 110: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	1,   // 111: header.TemplateMgr.GetTemplate:input_type -> header.Id
	48,  // 112: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	1,   // 113: header.TemplateMgr.PickTemplate:input_type -> header.Id
	49,  // 114: header.TagMgr.CreateTag:input_type -> header.Tag
	49,  // 115: header.TagMgr.UpdateTag:input_type -> header.Tag
	1,   // 116: header.TagMgr.DeleteTag:input_type -> header.Id
	1,   // 117: header.TagMgr.ListTags:input_type -> header.Id
	1,   // 118: header.TagMgr.GetTag:input_type -> header.Id
	1,   // 119: header.IntegrationMgr.Deintegrate:input_type -> header.Id
	1,   // 120: header.IntegrationMgr.ListIntegrations:input_type -> header.Id
	50,  // 121: header.IntegrationMgr.Integrate:input_type -> header.Integration
	51,  // 122: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	52,  // 123: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	39,  // 124: header.ConversationEventReader.SendMessage:input_type -> header.Event
	39,  // 125: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	39,  // 126: header.ConversationEventReader.PinMessage:input_type -> header.Event
	39,  // 127: header.ConversationEventReader.UnpinMessage:input_type -> header.Event
	53,  // 128: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	54,  // 129: header.FileMgr.Presign:input_type -> header.FileHeader
	55,  // 130: header.FileMgr.Read:input_type -> header.FileRequest
	55,  // 131: header.FileMgr.Uploaded:input_type -> header.FileRequest
	1,   // 132: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	56,  // 133: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	57,  // 134: header.Noti5Service.Noti:input_type -> header.PushNoti
	58,  // 135: header.Noti5Service.AddToken:input_type -> noti5.Token
	58,  // 136: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	58,  // 137: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	59,  // 138: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	60,  // 139: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	61,  // 140: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	61,  // 141: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 142: header.PaymentMgr.GetSubscription:input_type -> header.Id
	62,  // 143: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	62,  // 144: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	63,  // 147: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	64,  // 148: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	64,  // 149: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	65,  // 150: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	61,  // 151: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	66,  // 152: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	67,  // 153: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	68,  // 154: header.PaymentMgr.AddComment:input_type -> payment.Comment
	33,  // 155: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 156: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	64,  // 157: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	69,  // 158: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	63,  // 159: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	70,  // 160: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	71,  // 161: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	72,  // 162: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	73,  // 163: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	73,  // 164: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	74,  // 165: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 166: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	75,  // 167: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 168: header.PaymentMgr.GetReferral:input_type -> header.Id
	33,  // 169: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	76,  // 170: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	77,  // 174: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	78,  // 175: header.Pubsub.Publish:input_type -> header.PublishMessage
	78,  // 176: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 177: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	79,  // 178: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	80,  // 182: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 183: header.WidgetService.ReadUserSetting:input_type -> header.Id
	1,   // 184: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	81,  // 185: header.WidgetService.SubmitImpression:input_type -> header.Impression
	82,  // 186: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	83,  // 187: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	84,  // 188: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	85,  // 189: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	85,  // 190: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	86,  // 191: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 192: header.WidgetService.ListUploadedImage:input_type -> header.Id
	86,  // 193: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 194: header.WidgetService.ListWebPlugins:input_type -> header.Id
	87,  // 195: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	87,  // 196: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	87,  // 197: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 198: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	87,  // 199: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	1,   // 200: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	1,   // 201: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	88,  // 202: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	1,   // 203: header.WidgetService.SearchImages:input_type -> header.Id
	1,   // 204: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	1,   // 205: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	1,   // 206: header.Bizbot.ListBots:input_type -> header.Id
	1,   // 207: header.Bizbot.GetBot:input_type -> header.Id
	89,  // 208: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	89,  // 209: header.Bizbot.CreateBot:input_type -> header.Bot
	89,  // 210: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 211: header.Bizbot.DeleteBot:input_type -> header.Id
	90,  // 212: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	90,  // 213: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	90,  // 214: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	90,  // 215: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	91,  // 216: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	92,  // 217: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	89,  // 218: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 219: header.Bizbot.ListBotRevisions:input_type -> header.Id
	93,  // 220: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 221: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 222: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 223: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 224: header.Sendback.ReadWebhook:input_type -> header.Id
	93,  // 225: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 226: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	94,  // 227: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	95,  // 228: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	39,  // 229: header.Sendback.SendWebhookEvent:input_type -> header.Event
	96,  // 230: header.Notibox.Send:input_type -> header.Notification
	1,   // 231: header.Notibox.MarkRead:input_type -> header.Id
	97,  // 232: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	98,  // 233: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	99,  // 234: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 235: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 236: header.Watchhttp.ListWebpages:input_type -> header.Id
	99,  // 237: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 238: header.Watchhttp.ReadWebpage:input_type -> header.Id
	100, // 239: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	101, // 240: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	102, // 241: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	102, // 242: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	4,   // 243: header.Holap.AppendAgentSet:input_type -> account.Agent
	49,  // 244: header.Holap.AppendTagSet:input_type -> header.Tag
	17,  // 245: header.Holap.UpdateUser:input_type -> header.User
	44,  // 246: header.Holap.UpdateConversation:input_type -> header.Conversation
	39,  // 247: header.Holap.OnConversationEvent:input_type -> header.Event
	103, // 248: header.Holap.FreeAccount:input_type -> header.AccountImage
	104, // 249: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	105, // 250: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	104, // 251: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	105, // 252: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	106, // 253: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	20,  // 254: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	19,  // 255: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	20,  // 256: header.Proder.ListProducts:input_type -> header.Ids
	1,   // 257: header.Proder.ReadProduct:input_type -> header.Id
	107, // 258: header.Proder.CreateProduct:input_type -> header.Product
	107, // 259: header.Proder.UpdateProduct:input_type -> header.Product
	...
	33,  // 264: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	33,  // 268: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	33,  // 279: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	109, // 280: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	33,  // 281: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	33,  // 282: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	...
	33,  // 288: header.AccountMgr.LogoutSession:output_type -> header.Empty
	...
	115, // 294: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	115, // 295: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	16,  // 296: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 297: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 298: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	1,   // 299: header.UserMgr.UpdateUser:output_type -> header.Id
	17,  // 300: header.UserMgr.ReadUser:output_type -> header.User
	116, // 301: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	117, // 302: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	114, // 303: header.UserMgr.MatchUsers:output_type -> header.Users
	21,  // 304: header.UserMgr.UpdateView:output_type -> header.UserView
	21,  // 305: header.UserMgr.CreateView:output_type -> header.UserView
	33,  // 306: header.UserMgr.DeleteView:output_type -> header.Empty
	21,  // 307: header.UserMgr.GetView:output_type -> header.UserView
	118, // 308: header.UserMgr.ListViews:output_type -> header.UserViews
	22,  // 309: header.UserMgr.UpsertLabel:output_type -> header.Label
	33,  // 310: header.UserMgr.DeleteLabel:output_type -> header.Empty
	119, // 311: header.UserMgr.ListLabels:output_type -> header.Labels
	22,  // 312: header.UserMgr.GetLabel:output_type -> header.Label
	33,  // 313: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	33,  // 314: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	33,  // 315: header.UserMgr.AddUserLabel:output_type -> header.Empty
	33,  // 316: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	114, // 317: header.UserPersist.ListUserInViews:output_type -> header.Users
	33,  // 318: header.UserPersist.UpdateUser:output_type -> header.Empty
	114, // 319: header.UserPersist.FilterUsers:output_type -> header.Users
	120, // 320: header.LiveMgr.SearchLocations:output_type -> header.Locations
	114, // 321: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	121, // 322: header.LiveMgr.TopEvents:output_type -> header.Events
	122, // 323: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	123, // 324: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	124, // 325: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	125, // 326: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	126, // 327: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	127, // 328: header.NoteMgr.ListNotes:output_type -> header.Notes
	30,  // 329: header.NoteMgr.AddNote:output_type -> header.Note
	30,  // 330: header.NoteMgr.UpdateNote:output_type -> header.Note
	33,  // 331: header.NoteMgr.DeleteNote:output_type -> header.Empty
	128, // 332: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	32,  // 333: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	33,  // 334: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	32,  // 335: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	32,  // 336: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	129, // 337: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	34,  // 338: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	34,  // 339: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	33,  // 340: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	130, // 341: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	37,  // 342: header.RuleMgr.UpdateRule:output_type -> header.Rule
	37,  // 343: header.RuleMgr.CreateRule:output_type -> header.Rule
	33,  // 344: header.RuleMgr.DeleteRule:output_type -> header.Empty
	37,  // 345: header.RuleMgr.ReadRule:output_type -> header.Rule
	131, // 346: header.RuleMgr.ListRules:output_type -> header.Route
	132, // 347: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	39,  // 348: header.ConversationMgr.PongMessage:output_type -> header.Event
	44,  // 349: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	44,  // 350: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	44,  // 351: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	133, // 352: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	133, // 353: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	33,  // 354: header.ConversationMgr.TagConversation:output_type -> header.Empty
	33,  // 355: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	33,  // 356: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	33,  // 357: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	33,  // 358: header.ConversationMgr.Typing:output_type -> header.Empty
	44,  // 359: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	133, // 360: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	33,  // 361: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	33,  // 362: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	33,  // 363: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	33,  // 364: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	45,  // 365: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	45,  // 366: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	39,  // 367: header.ConversationMgr.TerminateBot:output_type -> header.Event
	134, // 368: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	47,  // 369: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	47,  // 370: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	33,  // 371: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	47,  // 372: header.TemplateMgr.GetTemplate:output_type -> header.Template
	135, // 373: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	33,  // 374: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	49,  // 375: header.TagMgr.CreateTag:output_type -> header.Tag
	49,  // 376: header.TagMgr.UpdateTag:output_type -> header.Tag
	33,  // 377: header.TagMgr.DeleteTag:output_type -> header.Empty
	136, // 378: header.TagMgr.ListTags:output_type -> header.Tags
	49,  // 379: header.TagMgr.GetTag:output_type -> header.Tag
	33,  // 380: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	137, // 381: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	50,  // 382: header.IntegrationMgr.Integrate:output_type -> header.Integration
	121, // 383: header.EventMgr.SearchEvents:output_type -> header.Events
	39,  // 384: header.EventMgr.CreateEvent:output_type -> header.Event
	39,  // 385: header.ConversationEventReader.SendMessage:output_type -> header.Event
	39,  // 386: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	33,  // 387: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	33,  // 388: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	121, // 389: header.ConversationEventReader.ListEvents:output_type -> header.Events
	138, // 390: header.FileMgr.Presign:output_type -> header.PresignResult
	139, // 391: header.FileMgr.Read:output_type -> header.File
	139, // 392: header.FileMgr.Uploaded:output_type -> header.File
	56,  // 393: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	56,  // 394: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	33,  // 395: header.Noti5Service.Noti:output_type -> header.Empty
	33,  // 396: header.Noti5Service.AddToken:output_type -> header.Empty
	33,  // 397: header.Noti5Service.RemoveToken:output_type -> header.Empty
	33,  // 398: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	59,  // 399: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	140, // 400: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	64,  // 401: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	61,  // 402: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	61,  // 403: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	62,  // 404: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	62,  // 405: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	33,  // 406: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	141, // 407: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	59,  // 408: header.PaymentMgr.Pay:output_type -> payment.Bill
	64,  // 409: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	64,  // 410: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	142, // 411: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	64,  // 412: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	64,  // 413: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	143, // 414: header.PaymentMgr.ListComments:output_type -> payment.Comments
	68,  // 415: header.PaymentMgr.AddComment:output_type -> payment.Comment
	144, // 416: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	72,  // 417: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	72,  // 418: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	69,  // 419: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	59,  // 420: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	145, // 421: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	71,  // 422: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	71,  // 423: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	33,  // 424: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	71,  // 425: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	146, // 426: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	33,  // 427: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	76,  // 428: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	76,  // 429: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	147, // 430: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	76,  // 431: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	148, // 432: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	149, // 433: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	150, // 434: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	33,  // 435: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	33,  // 436: header.Pubsub.Publish:output_type -> header.Empty
	33,  // 437: header.Realtime.ShardSend:output_type -> header.Empty
	79,  // 438: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	79,  // 439: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	151, // 440: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	152, // 441: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	80,  // 442: header.WidgetService.Read:output_type -> header.WidgetSetting
	80,  // 443: header.WidgetService.Update:output_type -> header.WidgetSetting
	153, // 444: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	154, // 445: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	81,  // 446: header.WidgetService.SubmitImpression:output_type -> header.Impression
	82,  // 447: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	83,  // 448: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	155, // 449: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	156, // 450: header.WidgetService.ListConversions:output_type -> header.Conversions
	157, // 451: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	86,  // 452: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	158, // 453: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	33,  // 454: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	159, // 455: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	87,  // 456: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	87,  // 457: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	87,  // 458: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	33,  // 459: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	87,  // 460: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	159, // 461: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	33,  // 462: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	160, // 463: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	158, // 464: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	161, // 465: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	162, // 466: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	163, // 467: header.Bizbot.ListBots:output_type -> header.Bots
	89,  // 468: header.Bizbot.GetBot:output_type -> header.Bot
	89,  // 469: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	89,  // 470: header.Bizbot.CreateBot:output_type -> header.Bot
	89,  // 471: header.Bizbot.UpdateBot:output_type -> header.Bot
	33,  // 472: header.Bizbot.DeleteBot:output_type -> header.Empty
	33,  // 473: header.Bizbot.OnEvent:output_type -> header.Empty
	33,  // 474: header.Bizbot.StartBot:output_type -> header.Empty
	33,  // 475: header.Bizbot.StopBot:output_type -> header.Empty
	33,  // 476: header.Bizbot.TryAction:output_type -> header.Empty
	164, // 477: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	165, // 478: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	89,  // 479: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	163, // 480: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	93,  // 481: header.Sendback.CreateWebhook:output_type -> header.Webhook
	166, // 482: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	33,  // 483: header.Sendback.DeleteWebhook:output_type -> header.Empty
	167, // 484: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	93,  // 485: header.Sendback.ReadWebhook:output_type -> header.Webhook
	93,  // 486: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	93,  // 487: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	168, // 488: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	169, // 489: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	33,  // 490: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	33,  // 491: header.Notibox.Send:output_type -> header.Empty
	33,  // 492: header.Notibox.MarkRead:output_type -> header.Empty
	33,  // 493: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	170, // 494: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	99,  // 495: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	33,  // 496: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	171, // 497: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	99,  // 498: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	99,  // 499: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	172, // 500: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	173, // 501: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	174, // 502: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	172, // 503: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	33,  // 504: header.Holap.AppendAgentSet:output_type -> header.Empty
	33,  // 505: header.Holap.AppendTagSet:output_type -> header.Empty
	33,  // 506: header.Holap.UpdateUser:output_type -> header.Empty
	33,  // 507: header.Holap.UpdateConversation:output_type -> header.Empty
	33,  // 508: header.Holap.OnConversationEvent:output_type -> header.Empty
	33,  // 509: header.Holap.FreeAccount:output_type -> header.Empty
	175, // 510: header.Holap.ReportUser:output_type -> header.UserMetrics
	176, // 511: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	20,  // 512: header.Holap.ListUserIds:output_type -> header.Ids
	133, // 513: header.Holap.ListConversationIds:output_type -> header.Conversations
	177, // 514: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	20,  // 515: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	117, // 516: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	178, // 517: header.Proder.ListProducts:output_type -> header.Products
	107, // 518: header.Proder.ReadProduct:output_type -> header.Product
	107, // 519: header.Proder.CreateProduct:output_type -> header.Product
	107, // 520: header.Proder.UpdateProduct:output_type -> header.Product
	33,  // 521: header.Proder.DeleteProduct:output_type -> header.Empty
...
type UserPersistClient interface {
	ListUserInViews(ctx context.Context, in *UserView, opts ...grpc.CallOption) (*Users, error)
...
func (c *userPersistClient) ListUserInViews(ctx context.Context, in *UserView, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
	err := c.cc.Invoke(ctx, "/header.UserPersist/ListUserInViews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserPersistServer interface {
	ListUserInViews(context.Context, *UserView) (*Users, error)
...
func (*UnimplementedUserPersistServer) ListUserInViews(context.Context, *UserView) (*Users, error) {
...
func _UserPersist_ListUserInViews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserView)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserPersistServer).ListUserInViews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.UserPersist/ListUserInViews",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserPersistServer).ListUserInViews(ctx, req.(*UserView))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UserPersist_ListUserInViews_Handler,
		},
		{
			MethodName: "UpdateUser",
