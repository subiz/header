...
var file_service_proto_depIdxs = []int32{
	...
	4,   // 221: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	88,  // 222: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	4,   // 223: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	4,   // 224: header.FabikonService.ListFbPosts:input_type -> header.Id
	89,  // 225: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	4,   // 226: header.WidgetService.Read:input_type -> header.Id
	90,  // 227: header.WidgetService.Update:input_type -> header.WidgetSetting
	4,   // 228: header.WidgetService.ReadUserSetting:input_type -> header.Id
	4,   // 229: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	91,  // 230: header.WidgetService.SubmitImpression:input_type -> header.Impression
	92,  // 231: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	93,  // 232: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	94,  // 233: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	95,  // 234: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	95,  // 235: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	96,  // 236: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 237: header.WidgetService.ListUploadedImage:input_type -> header.Id
	96,  // 238: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 239: header.WidgetService.ListWebPlugins:input_type -> header.Id
	97,  // 240: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	97,  // 241: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	97,  // 242: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 243: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	97,  // 244: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	4,   // 245: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	4,   // 246: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	98,  // 247: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	4,   // 248: header.WidgetService.SearchImages:input_type -> header.Id
	4,   // 249: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	4,   // 250: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	4,   // 251: header.Bizbot.ListBots:input_type -> header.Id
	4,   // 252: header.Bizbot.GetBot:input_type -> header.Id
	99,  // 253: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	99,  // 254: header.Bizbot.CreateBot:input_type -> header.Bot
	99,  // 255: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 256: header.Bizbot.DeleteBot:input_type -> header.Id
	100, // 257: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	100, // 258: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	100, // 259: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	100, // 260: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	101, // 261: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	102, // 262: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	103, // 263: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	104, // 264: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	105, // 265: header.Sendback.CreateWebhook:input_type -> header.Webhook
	4,   // 266: header.Sendback.PingWebhook:input_type -> header.Id
	4,   // 267: header.Sendback.DeleteWebhook:input_type -> header.Id
	4,   // 268: header.Sendback.ListWebhooks:input_type -> header.Id
	4,   // 269: header.Sendback.ReadWebhook:input_type -> header.Id
	105, // 270: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 271: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	106, // 272: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	107, // 273: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 274: header.Sendback.SendWebhookEvent:input_type -> header.Event
	108, // 275: header.Notibox.Send:input_type -> header.Notification
	4,   // 276: header.Notibox.MarkRead:input_type -> header.Id
	109, // 277: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	110, // 278: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	108, // 279: header.Notibox.SendNoti:input_type -> header.Notification
	110, // 280: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 281: header.Notibox.MarkReadNoti:input_type -> header.Id
	111, // 282: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 283: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 284: header.Watchhttp.ListWebpages:input_type -> header.Id
	111, // 285: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 286: header.Watchhttp.ReadWebpage:input_type -> header.Id
	112, // 287: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	113, // 288: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	114, // 289: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	114, // 290: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 291: header.Holap.AppendAgentSet:input_type -> account.Agent
	59,  // 292: header.Holap.AppendTagSet:input_type -> header.Tag
	29,  // 293: header.Holap.UpdateUser:input_type -> header.User
	51,  // 294: header.Holap.UpdateConversation:input_type -> header.Conversation
	46,  // 295: header.Holap.OnConversationEvent:input_type -> header.Event
	115, // 296: header.Holap.FreeAccount:input_type -> header.AccountImage
	116, // 297: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	117, // 298: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	116, // 299: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	117, // 300: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	118, // 301: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 302: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	30,  // 303: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 304: header.Holap.UpdateOrder:input_type -> header.Order
	119, // 305: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	120, // 306: header.Proder.ReadProduct:input_type -> header.Product
	120, // 307: header.Proder.CreateProduct:input_type -> header.Product
	120, // 308: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 309: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 310: header.Proder.RestoreProduct:input_type -> header.Id
	121, // 311: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 312: header.Proder.ListProductIds:input_type -> header.Ids
	121, // 313: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	122, // 314: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 315: header.Proder.ListProductCollections:input_type -> header.Ids
	123, // 316: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	123, // 317: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 318: header.Proder.DeleteProductCollection:input_type -> header.Id
	5,   // 319: header.Proder.ListProductFeeds:input_type -> header.Ids
	124, // 320: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	124, // 321: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 322: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 323: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 324: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 325: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 326: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 327: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 328: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 329: header.Proder.RestoreOrder:input_type -> header.Id
	125, // 330: header.Proder.ListOrders:input_type -> header.OrdersRequest
	125, // 331: header.Proder.CountOrders:input_type -> header.OrdersRequest
	126, // 332: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	127, // 333: header.Proder.MakeOrderPayment:input_type -> header.Bill
	128, // 334: header.Proder.DeleteOrderPayment:input_type -> header.Key
	46,  // 335: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 336: header.Proder.EditOrderComment:input_type -> header.Event
	128, // 337: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 338: header.Proder.ListOrderEvents:input_type -> header.Id
	129, // 339: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 340: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	130, // 341: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 342: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	131, // 343: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	132, // 344: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	133, // 345: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	134, // 346: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 347: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 348: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 349: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 350: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 351: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 352: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 353: header.Apiece.ReadTask:input_type -> header.Id
	135, // 354: header.Apiece.CreateTask:input_type -> header.Task
	135, // 355: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 356: header.Apiece.DeleteTask:input_type -> header.Id
	136, // 357: header.Apiece.ListTasks:input_type -> header.TasksRequest
	46,  // 358: header.Apiece.AddTaskComment:input_type -> header.Event
	46,  // 359: header.Apiece.EditTaskComment:input_type -> header.Event
	128, // 360: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 361: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 362: header.Apiece.ReadPipeline:input_type -> header.Id
	137, // 363: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	137, // 364: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 365: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 366: header.Apiece.ListPipelines:input_type -> header.Ids
	138, // 367: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	42,  // 368: header.Search.Index:output_type -> header.Empty
	139, // 369: header.Search.Search:output_type -> header.DocSearchResponse
	42,  // 370: header.Search.AddOwner:output_type -> header.Empty
	140, // 371: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 372: header.Map.LookupAddress:output_type -> header.Address
	141, // 373: header.Map.PredictAddress:output_type -> header.Addresses
	141, // 374: header.Map.ListDistricts:output_type -> header.Addresses
	141, // 375: header.Map.ListProvinces:output_type -> header.Addresses
	141, // 376: header.Map.ListWards:output_type -> header.Addresses
	141, // 377: header.Map.ListStreets:output_type -> header.Addresses
	141, // 378: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 379: header.Map.ReadAddress:output_type -> header.Address
	6,   // 380: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 381: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 382: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	42,  // 383: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 384: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 385: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 386: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	42,  // 387: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 388: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 389: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 390: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 391: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 392: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 393: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 394: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 395: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 396: header.AccountMgr.CreateAccount:output_type -> account.Account
	142, // 397: header.AccountMgr.ListAgents:output_type -> account.Agents
	42,  // 398: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	143, // 399: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	42,  // 400: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	42,  // 401: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 402: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	144, // 403: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 404: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 405: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	145, // 406: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	145, // 407: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	42,  // 408: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 409: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	146, // 410: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 411: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 412: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	147, // 413: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 414: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 415: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	148, // 416: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	42,  // 417: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	141, // 418: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 419: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 420: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	42,  // 421: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	149, // 422: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 423: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 424: header.AccountMgr.UpdateTax:output_type -> header.Tax
	42,  // 425: header.AccountMgr.DeleteTax:output_type -> header.Empty
	150, // 426: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	150, // 427: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 428: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 429: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	42,  // 430: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 431: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	151, // 432: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 433: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	42,  // 434: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	152, // 435: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	25,  // 436: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	25,  // 437: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	42,  // 438: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	42,  // 439: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	153, // 440: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	42,  // 441: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	26,  // 442: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	26,  // 443: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	26,  // 444: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	154, // 445: header.UserMgr.SearchUsers:output_type -> header.Users
	28,  // 446: header.UserMgr.MergeUser:output_type -> header.UserAlias
	4,   // 447: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 448: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	4,   // 449: header.UserMgr.UpdateUser:output_type -> header.Id
	29,  // 450: header.UserMgr.ReadUser:output_type -> header.User
	155, // 451: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	154, // 452: header.UserMgr.MatchUsers:output_type -> header.Users
	31,  // 453: header.UserMgr.UpdateView:output_type -> header.UserView
	31,  // 454: header.UserMgr.CreateView:output_type -> header.UserView
	42,  // 455: header.UserMgr.DeleteView:output_type -> header.Empty
	31,  // 456: header.UserMgr.GetView:output_type -> header.UserView
	156, // 457: header.UserMgr.ListViews:output_type -> header.UserViews
	32,  // 458: header.UserMgr.UpsertLabel:output_type -> header.Label
	42,  // 459: header.UserMgr.DeleteLabel:output_type -> header.Empty
	157, // 460: header.UserMgr.ListLabels:output_type -> header.Labels
	32,  // 461: header.UserMgr.GetLabel:output_type -> header.Label
	42,  // 462: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	42,  // 463: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	42,  // 464: header.UserMgr.AddUserLabel:output_type -> header.Empty
	42,  // 465: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	20,  // 466: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	20,  // 467: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	42,  // 468: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	29,  // 469: header.UserMgr.ListShippingAddress:output_type -> header.User
	42,  // 470: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	154, // 471: header.UserMgr.ListLeads:output_type -> header.Users
	158, // 472: header.LiveMgr.SearchLocations:output_type -> header.Locations
	154, // 473: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	89,  // 474: header.LiveMgr.TopEvents:output_type -> header.Events
	159, // 475: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	160, // 476: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	161, // 477: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	162, // 478: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	163, // 479: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	164, // 480: header.NoteMgr.ListNotes:output_type -> header.Notes
	39,  // 481: header.NoteMgr.AddNote:output_type -> header.Note
	39,  // 482: header.NoteMgr.UpdateNote:output_type -> header.Note
	42,  // 483: header.NoteMgr.DeleteNote:output_type -> header.Empty
	165, // 484: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	41,  // 485: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	42,  // 486: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	41,  // 487: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	166, // 488: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	43,  // 489: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	43,  // 490: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	167, // 491: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	168, // 492: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 493: header.ConversationMgr.PongMessage:output_type -> header.Event
	51,  // 494: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	51,  // 495: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	51,  // 496: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	169, // 497: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	169, // 498: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	42,  // 499: header.ConversationMgr.TagConversation:output_type -> header.Empty
	42,  // 500: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	42,  // 501: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	42,  // 502: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	42,  // 503: header.ConversationMgr.Typing:output_type -> header.Empty
	51,  // 504: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	169, // 505: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	42,  // 506: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	42,  // 507: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	42,  // 508: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	42,  // 509: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	52,  // 510: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	52,  // 511: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 512: header.ConversationMgr.TerminateBot:output_type -> header.Event
	170, // 513: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 514: header.ConversationMgr.SendMessage:output_type -> header.Event
	46,  // 515: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	42,  // 516: header.ConversationMgr.PinMessage:output_type -> header.Empty
	42,  // 517: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	89,  // 518: header.ConversationMgr.ListEvents:output_type -> header.Events
	42,  // 519: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	171, // 520: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	55,  // 521: header.ConversationMgr.Integrate:output_type -> header.Integration
	55,  // 522: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	56,  // 523: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	56,  // 524: header.ConversationMgr.CreateRule:output_type -> header.Rule
	42,  // 525: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	56,  // 526: header.ConversationMgr.ReadRule:output_type -> header.Rule
	172, // 527: header.ConversationMgr.ListRules:output_type -> header.Route
	57,  // 528: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	57,  // 529: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	42,  // 530: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	57,  // 531: header.TemplateMgr.GetTemplate:output_type -> header.Template
	173, // 532: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	42,  // 533: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	59,  // 534: header.TagMgr.CreateTag:output_type -> header.Tag
	59,  // 535: header.TagMgr.UpdateTag:output_type -> header.Tag
	42,  // 536: header.TagMgr.DeleteTag:output_type -> header.Empty
	174, // 537: header.TagMgr.ListTags:output_type -> header.Tags
	59,  // 538: header.TagMgr.GetTag:output_type -> header.Tag
	89,  // 539: header.EventMgr.SearchEvents:output_type -> header.Events
	46,  // 540: header.EventMgr.CreateEvent:output_type -> header.Event
	175, // 541: header.FileMgr.Presign:output_type -> header.PresignResult
	176, // 542: header.FileMgr.Uploaded:output_type -> header.File
	176, // 543: header.FileMgr.DownloadFileUrl:output_type -> header.File
	65,  // 544: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	65,  // 545: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	42,  // 546: header.Noti5Service.Noti:output_type -> header.Empty
	42,  // 547: header.Noti5Service.AddToken:output_type -> header.Empty
	42,  // 548: header.Noti5Service.RemoveToken:output_type -> header.Empty
	42,  // 549: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	68,  // 550: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	177, // 551: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	73,  // 552: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	70,  // 553: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	70,  // 554: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	71,  // 555: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	71,  // 556: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	42,  // 557: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	178, // 558: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	68,  // 559: header.PaymentMgr.Pay:output_type -> payment.Bill
	73,  // 560: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	73,  // 561: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	179, // 562: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	73,  // 563: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	73,  // 564: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	180, // 565: header.PaymentMgr.ListComments:output_type -> payment.Comments
	77,  // 566: header.PaymentMgr.AddComment:output_type -> payment.Comment
	181, // 567: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	81,  // 568: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	81,  // 569: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	78,  // 570: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	68,  // 571: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	182, // 572: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	80,  // 573: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	80,  // 574: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	42,  // 575: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	80,  // 576: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	183, // 577: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	42,  // 578: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	85,  // 579: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	85,  // 580: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	184, // 581: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	85,  // 582: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	185, // 583: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	186, // 584: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	187, // 585: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	42,  // 586: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	42,  // 587: header.Pubsub.Publish:output_type -> header.Empty
	88,  // 588: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	88,  // 589: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	188, // 590: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	189, // 591: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	42,  // 592: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	90,  // 593: header.WidgetService.Read:output_type -> header.WidgetSetting
	90,  // 594: header.WidgetService.Update:output_type -> header.WidgetSetting
	190, // 595: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	191, // 596: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	91,  // 597: header.WidgetService.SubmitImpression:output_type -> header.Impression
	92,  // 598: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	93,  // 599: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	192, // 600: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	193, // 601: header.WidgetService.ListConversions:output_type -> header.Conversions
	194, // 602: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	96,  // 603: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	195, // 604: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	42,  // 605: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	196, // 606: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	97,  // 607: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	97,  // 608: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	97,  // 609: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	42,  // 610: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	97,  // 611: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	196, // 612: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	42,  // 613: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	197, // 614: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	195, // 615: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	198, // 616: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	199, // 617: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	200, // 618: header.Bizbot.ListBots:output_type -> header.Bots
	99,  // 619: header.Bizbot.GetBot:output_type -> header.Bot
	99,  // 620: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	99,  // 621: header.Bizbot.CreateBot:output_type -> header.Bot
	99,  // 622: header.Bizbot.UpdateBot:output_type -> header.Bot
	42,  // 623: header.Bizbot.DeleteBot:output_type -> header.Empty
	42,  // 624: header.Bizbot.OnEvent:output_type -> header.Empty
	42,  // 625: header.Bizbot.StartBot:output_type -> header.Empty
	42,  // 626: header.Bizbot.StopBot:output_type -> header.Empty
	42,  // 627: header.Bizbot.TryAction:output_type -> header.Empty
	201, // 628: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	202, // 629: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	203, // 630: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	204, // 631: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	105, // 632: header.Sendback.CreateWebhook:output_type -> header.Webhook
	205, // 633: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	42,  // 634: header.Sendback.DeleteWebhook:output_type -> header.Empty
	206, // 635: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	105, // 636: header.Sendback.ReadWebhook:output_type -> header.Webhook
	105, // 637: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	105, // 638: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	207, // 639: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	208, // 640: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	42,  // 641: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	42,  // 642: header.Notibox.Send:output_type -> header.Empty
	42,  // 643: header.Notibox.MarkRead:output_type -> header.Empty
	42,  // 644: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	209, // 645: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	42,  // 646: header.Notibox.SendNoti:output_type -> header.Empty
	210, // 647: header.Notibox.ListNoties:output_type -> header.Notifications
	42,  // 648: header.Notibox.MarkReadNoti:output_type -> header.Empty
	111, // 649: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	42,  // 650: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	211, // 651: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	111, // 652: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	111, // 653: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	212, // 654: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	213, // 655: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	214, // 656: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	212, // 657: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	42,  // 658: header.Holap.AppendAgentSet:output_type -> header.Empty
	42,  // 659: header.Holap.AppendTagSet:output_type -> header.Empty
	42,  // 660: header.Holap.UpdateUser:output_type -> header.Empty
	42,  // 661: header.Holap.UpdateConversation:output_type -> header.Empty
	42,  // 662: header.Holap.OnConversationEvent:output_type -> header.Empty
	42,  // 663: header.Holap.FreeAccount:output_type -> header.Empty
	215, // 664: header.Holap.ReportUser:output_type -> header.UserMetrics
	216, // 665: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 666: header.Holap.ListUserIds:output_type -> header.Ids
	169, // 667: header.Holap.ListConversationIds:output_type -> header.Conversations
	217, // 668: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 669: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	155, // 670: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	42,  // 671: header.Holap.UpdateOrder:output_type -> header.Empty
	218, // 672: header.Holap.ReportOrder:output_type -> header.Orders
	120, // 673: header.Proder.ReadProduct:output_type -> header.Product
	120, // 674: header.Proder.CreateProduct:output_type -> header.Product
	120, // 675: header.Proder.UpdateProduct:output_type -> header.Product
	42,  // 676: header.Proder.DeleteProduct:output_type -> header.Empty
	120, // 677: header.Proder.RestoreProduct:output_type -> header.Product
	122, // 678: header.Proder.ListProducts:output_type -> header.Products
	5,   // 679: header.Proder.ListProductIds:output_type -> header.Ids
	122, // 680: header.Proder.ListGroupedProducts:output_type -> header.Products
	122, // 681: header.Proder.ImportProducts:output_type -> header.Products
	219, // 682: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	123, // 683: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	123, // 684: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	42,  // 685: header.Proder.DeleteProductCollection:output_type -> header.Empty
	220, // 686: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	124, // 687: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	124, // 688: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	42,  // 689: header.Proder.DeleteProductFeed:output_type -> header.Empty
	221, // 690: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	222, // 691: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 692: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 693: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 694: header.Proder.UpdateOrder:output_type -> header.Order
	42,  // 695: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 696: header.Proder.RestoreOrder:output_type -> header.Order
	218, // 697: header.Proder.ListOrders:output_type -> header.Orders
	218, // 698: header.Proder.CountOrders:output_type -> header.Orders
	42,  // 699: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	46,  // 700: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 701: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 702: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 703: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 704: header.Proder.DeleteOrderComment:output_type -> header.Event
	223, // 705: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	176, // 706: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 707: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	224, // 708: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	42,  // 709: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	225, // 710: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	42,  // 711: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	42,  // 712: header.Proder.GHNShippingStatus:output_type -> header.Empty
	134, // 713: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 714: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 715: header.Proder.CancelShippingOrder:output_type -> header.Order
	176, // 716: header.Proder.PrintShippingOrders:output_type -> header.File
	42,  // 717: header.Proder.SeenOrder:output_type -> header.Empty
	42,  // 718: header.Proder.FollowOrder:output_type -> header.Empty
	42,  // 719: header.Proder.UnfollowOrder:output_type -> header.Empty
	135, // 720: header.Apiece.ReadTask:output_type -> header.Task
	135, // 721: header.Apiece.CreateTask:output_type -> header.Task
	135, // 722: header.Apiece.UpdateTask:output_type -> header.Task
	42,  // 723: header.Apiece.DeleteTask:output_type -> header.Empty
	226, // 724: header.Apiece.ListTasks:output_type -> header.Tasks
	46,  // 725: header.Apiece.AddTaskComment:output_type -> header.Event
	46,  // 726: header.Apiece.EditTaskComment:output_type -> header.Event
	46,  // 727: header.Apiece.DeleteTaskComment:output_type -> header.Event
	227, // 728: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	137, // 729: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	137, // 730: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	137, // 731: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	42,  // 732: header.Apiece.DeletePipeline:output_type -> header.Empty
	228, // 733: header.Apiece.ListPipelines:output_type -> header.Pipelines
	367, // [367:734] is the sub-list for method output_type
	0,   // [0:367] is the sub-list for method input_type
