...
var file_service_proto_depIdxs = []int32{
	...
	11,  // 279: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	...
	37,  // 294: header.FabikonService.RemoveFbUserLabel:input_type -> header.User
	37,  // 295: header.FabikonService.AddFbUserLabel:input_type -> header.User
	...
	48,  // 369: header.Sendback.SendWebhookEvent:input_type -> header.Event
	...
	46,  // 374: header.Proder.ReadProduct:input_type -> header.Product
	46,  // 375: header.Proder.CreateProduct:input_type -> header.Product
	46,  // 376: header.Proder.UpdateProduct:input_type -> header.Product
	...
	16,  // 380: header.Proder.ListProductCollections:input_type -> header.Ids
	...
	16,  // 388: header.Proder.ListProductCategories:input_type -> header.Ids
	1,   // 389: header.Proder.ReadOrder:input_type -> header.Id
	29,  // 390: header.Proder.CreateOrder:input_type -> header.Order
	29,  // 391: header.Proder.UpdateOrder:input_type -> header.Order
	...
	48,  // 398: header.Proder.AddOrderComment:input_type -> header.Event
	48,  // 399: header.Proder.EditOrderComment:input_type -> header.Event
	...
	29,  // 411: header.Proder.UpdateShippingCode:input_type -> header.Order
	1,   // 412: header.Proder.CancelShippingOrder:input_type -> header.Id
	16,  // 413: header.Proder.PrintShippingOrders:input_type -> header.Ids
	...
	16,  // 423: header.Proder.ListPipelines:input_type -> header.Ids
	...
	16,  // 427: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	1,   // 428: header.TaskMgr.ReadTask:input_type -> header.Id
	51,  // 429: header.TaskMgr.CreateTask:input_type -> header.Task
	51,  // 430: header.TaskMgr.UpdateTask:input_type -> header.Task
	...
	48,  // 437: header.TaskMgr.AddTaskComment:input_type -> header.Event
	48,  // 438: header.TaskMgr.EditTaskComment:input_type -> header.Event
	...
	16,  // 442: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	...
	48,  // 447: header.CampaignMgr.OnEvent:input_type -> header.Event
	...
	11,  // 472: header.GooglekonService.SendEventToGoogle:output_type -> header.Empty
	...
	11,  // 476: header.KafkaConsumer.Consume:output_type -> header.Empty
	169, // 477: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	11,  // 478: header.DocSearch.IndexConvo:output_type -> header.Empty
	...
	11,  // 487: header.DocSearch.HealthCheckReport:output_type -> header.Empty
	11,  // 488: header.DocSearch.HealthCheckIndex:output_type -> header.Empty
	13,  // 489: header.NumberRegistry.Compact:output_type -> header.Number
	12,  // 490: header.NumberRegistry.Uncompact:output_type -> header.String
	14,  // 491: header.NumberRegistry.CompactM:output_type -> header.StrNumM
	13,  // 492: header.NumberRegistry.Shorten:output_type -> header.Number
	12,  // 493: header.NumberRegistry.Lookup:output_type -> header.String
	176, // 494: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	27,  // 495: header.Map.LookupAddress:output_type -> header.Address
	...
	27,  // 502: header.Map.ReadAddress:output_type -> header.Address
	17,  // 503: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	17,  // 504: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	17,  // 505: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	11,  // 506: header.AccountMgr.RequestPassword:output_type -> header.Empty
	19,  // 507: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	19,  // 508: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	19,  // 509: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	20,  // 510: header.AccountMgr.DeleteAccount:output_type -> account.Account
	20,  // 511: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	11,  // 512: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	19,  // 513: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	19,  // 514: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	19,  // 515: header.AccountMgr.GetInvitation:output_type -> account.Agent
	19,  // 516: header.AccountMgr.InviteAgent:output_type -> account.Agent
	19,  // 517: header.AccountMgr.GetAgent:output_type -> account.Agent
	19,  // 518: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	20,  // 519: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	20,  // 520: header.AccountMgr.GetAccount:output_type -> account.Account
	20,  // 521: header.AccountMgr.UpdateAccount:output_type -> account.Account
	20,  // 522: header.AccountMgr.CreateAccount:output_type -> account.Account
	178, // 523: header.AccountMgr.ListAgents:output_type -> header.Response
	11,  // 524: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	179, // 525: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	19,  // 526: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	180, // 527: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	19,  // 528: header.AccountMgr.TransferOwner:output_type -> account.Agent
	24,  // 529: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	...
	11,  // 532: header.AccountMgr.LogoutSession:output_type -> header.Empty
	24,  // 533: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	182, // 534: header.AccountMgr.GetLanguage:output_type -> header.Lang
	25,  // 535: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	26,  // 536: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	26,  // 537: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	183, // 538: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	11,  // 539: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	177, // 540: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	27,  // 541: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	27,  // 542: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	11,  // 543: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	184, // 544: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	28,  // 545: header.AccountMgr.CreateTax:output_type -> header.Tax
	28,  // 546: header.AccountMgr.UpdateTax:output_type -> header.Tax
	11,  // 547: header.AccountMgr.DeleteTax:output_type -> header.Empty
	...
	30,  // 550: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	30,  // 551: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	11,  // 552: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	31,  // 553: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	186, // 554: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	31,  // 555: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	11,  // 556: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	187, // 557: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	32,  // 558: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	32,  // 559: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	11,  // 560: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	11,  // 561: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	188, // 562: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	11,  // 563: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	33,  // 564: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	33,  // 565: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	33,  // 566: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	34,  // 567: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	...
	37,  // 574: header.UserMgr.MergeUser:output_type -> header.User
	11,  // 575: header.UserMgr.DetachUser:output_type -> header.Empty
	37,  // 576: header.UserMgr.CreateUser2:output_type -> header.User
	37,  // 577: header.UserMgr.UpdateUser:output_type -> header.User
	192, // 578: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	11,  // 579: header.UserMgr.RemoveUser:output_type -> header.Empty
	11,  // 580: header.UserMgr.RestoreUser:output_type -> header.Empty
	37,  // 581: header.UserMgr.ReadUser:output_type -> header.User
	37,  // 582: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	36,  // 583: header.UserMgr.MatchUsers:output_type -> header.Users
	37,  // 584: header.UserMgr.BanUser:output_type -> header.User
	37,  // 585: header.UserMgr.UnbanUser:output_type -> header.User
	36,  // 586: header.UserMgr.LookupByPhone:output_type -> header.Users
	38,  // 587: header.UserMgr.UpdateView:output_type -> header.UserView
	38,  // 588: header.UserMgr.CreateView:output_type -> header.UserView
	11,  // 589: header.UserMgr.DeleteView:output_type -> header.Empty
	38,  // 590: header.UserMgr.GetView:output_type -> header.UserView
	193, // 591: header.UserMgr.ListViews:output_type -> header.UserViews
	39,  // 592: header.UserMgr.UpdateSegment:output_type -> header.Segment
	39,  // 593: header.UserMgr.CreateSegment:output_type -> header.Segment
	11,  // 594: header.UserMgr.DeleteSegment:output_type -> header.Empty
	39,  // 595: header.UserMgr.GetSegment:output_type -> header.Segment
	194, // 596: header.UserMgr.ListSegments:output_type -> header.Segments
	36,  // 597: header.UserMgr.ListUsers:output_type -> header.Users
	11,  // 598: header.UserMgr.AddToSegment:output_type -> header.Empty
	11,  // 599: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	11,  // 600: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	43,  // 601: header.UserMgr.UpsertLabel:output_type -> header.Label
	11,  // 602: header.UserMgr.DeleteLabel:output_type -> header.Empty
	195, // 603: header.UserMgr.ListLabels:output_type -> header.Labels
	43,  // 604: header.UserMgr.GetLabel:output_type -> header.Label
	11,  // 605: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	11,  // 606: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	11,  // 607: header.UserMgr.AddUserLabel:output_type -> header.Empty
	11,  // 608: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	11,  // 609: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	27,  // 610: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	27,  // 611: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	11,  // 612: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	196, // 613: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	11,  // 614: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	36,  // 615: header.UserMgr.ListLeads:output_type -> header.Users
	197, // 616: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	46,  // 617: header.UserMgr.LinkProductUrl:output_type -> header.Product
	0,   // 618: header.UserMgr.ListUserEvents:output_type -> header.Events
	48,  // 619: header.UserMgr.CreateUserEvent:output_type -> header.Event
	49,  // 620: header.UserMgr.FillDevice:output_type -> common.Device
	198, // 621: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	11,  // 622: header.UserMgr.LinkTask:output_type -> header.Empty
	199, // 623: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	16,  // 624: header.UserMgr.ListUserIds:output_type -> header.Ids
	36,  // 625: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	...
	36,  // 629: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	...
	58,  // 636: header.NoteMgr.AddNote:output_type -> header.Note
	58,  // 637: header.NoteMgr.UpdateNote:output_type -> header.Note
	11,  // 638: header.NoteMgr.DeleteNote:output_type -> header.Empty
	...
	48,  // 649: header.ConversationMgr.PongMessage:output_type -> header.Event
	...
	11,  // 655: header.ConversationMgr.TagConversation:output_type -> header.Empty
	11,  // 656: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	11,  // 657: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	11,  // 658: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	68,  // 659: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	11,  // 660: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	11,  // 661: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	11,  // 662: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	11,  // 663: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	...
	48,  // 666: header.ConversationMgr.TerminateBot:output_type -> header.Event
	48,  // 667: header.ConversationMgr.SendMessage:output_type -> header.Event
	48,  // 668: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	48,  // 669: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	11,  // 670: header.ConversationMgr.PinMessage:output_type -> header.Empty
	11,  // 671: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	0,   // 672: header.ConversationMgr.ListEvents:output_type -> header.Events
	11,  // 673: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	...
	11,  // 679: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	...
	11,  // 684: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	...
	11,  // 689: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	...
	11,  // 697: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	...
	48,  // 702: header.ConversationMgr.SaveMessage:output_type -> header.Event
	48,  // 703: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	...
	11,  // 706: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	...
	11,  // 709: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	...
	11,  // 712: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	...
	11,  // 718: header.TagMgr.DeleteTag:output_type -> header.Empty
	...
	11,  // 723: header.Noti5Service.Noti:output_type -> header.Empty
	11,  // 724: header.Noti5Service.AddToken:output_type -> header.Empty
	11,  // 725: header.Noti5Service.RemoveToken:output_type -> header.Empty
	11,  // 726: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	...
	11,  // 734: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	...
	11,  // 756: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	11,  // 757: header.Pubsub.Fire:output_type -> header.Empty
	...
	11,  // 765: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	11,  // 766: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	11,  // 767: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	1,   // 768: header.FabikonService.GenerateRefLink:output_type -> header.Id
	11,  // 769: header.FabikonService.LinkPageWithAccount:output_type -> header.Empty
	237, // 770: header.FabikonService.ListFacebookPages:output_type -> header.FacebookPages
	11,  // 771: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	238, // 772: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	11,  // 773: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	11,  // 774: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	11,  // 775: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	178, // 776: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	48,  // 777: header.ZalokonService.SendZNS:output_type -> header.Event
	11,  // 778: header.MailkonService.SendEmail:output_type -> header.Empty
	73,  // 779: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	11,  // 780: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	11,  // 781: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	...
	11,  // 785: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	...
	11,  // 805: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	...
	11,  // 810: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	...
	11,  // 813: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	...
	11,  // 823: header.Bizbot.DeleteBot:output_type -> header.Empty
	11,  // 824: header.Bizbot.OnEvent:output_type -> header.Empty
	11,  // 825: header.Bizbot.StartBot:output_type -> header.Empty
	11,  // 826: header.Bizbot.StopBot:output_type -> header.Empty
	11,  // 827: header.Bizbot.TryAction:output_type -> header.Empty
	...
	11,  // 834: header.Sendback.DeleteWebhook:output_type -> header.Empty
	...
	11,  // 841: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	11,  // 842: header.Notibox.SendNoti:output_type -> header.Empty
	260, // 843: header.Notibox.ListNoties:output_type -> header.Notifications
	11,  // 844: header.Notibox.MarkReadNoti:output_type -> header.Empty
	11,  // 845: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	46,  // 846: header.Proder.ReadProduct:output_type -> header.Product
	46,  // 847: header.Proder.CreateProduct:output_type -> header.Product
	46,  // 848: header.Proder.UpdateProduct:output_type -> header.Product
	11,  // 849: header.Proder.DeleteProduct:output_type -> header.Empty
	...
	11,  // 855: header.Proder.DeleteProductCollection:output_type -> header.Empty
	...
	11,  // 859: header.Proder.DeleteProductFeed:output_type -> header.Empty
	265, // 860: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	29,  // 861: header.Proder.ReadOrder:output_type -> header.Order
	29,  // 862: header.Proder.CreateOrder:output_type -> header.Order
	29,  // 863: header.Proder.UpdateOrder:output_type -> header.Order
	11,  // 864: header.Proder.DeleteOrder:output_type -> header.Empty
	...
	48,  // 868: header.Proder.MakeOrderPayment:output_type -> header.Event
	48,  // 869: header.Proder.DeleteOrderPayment:output_type -> header.Event
	48,  // 870: header.Proder.AddOrderComment:output_type -> header.Event
	48,  // 871: header.Proder.EditOrderComment:output_type -> header.Event
	48,  // 872: header.Proder.DeleteOrderComment:output_type -> header.Event
	...
	11,  // 877: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	270, // 878: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	11,  // 879: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	11,  // 880: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 881: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	29,  // 882: header.Proder.ShipOrder:output_type -> header.Order
	29,  // 883: header.Proder.UpdateShippingCode:output_type -> header.Order
	29,  // 884: header.Proder.CancelShippingOrder:output_type -> header.Order
	268, // 885: header.Proder.PrintShippingOrders:output_type -> header.File
	11,  // 886: header.Proder.SeenOrder:output_type -> header.Empty
	11,  // 887: header.Proder.FollowOrder:output_type -> header.Empty
	11,  // 888: header.Proder.UnfollowOrder:output_type -> header.Empty
	11,  // 889: header.Proder.TagOrder:output_type -> header.Empty
	11,  // 890: header.Proder.UntagOrder:output_type -> header.Empty
	...
	11,  // 894: header.Proder.DeletePipeline:output_type -> header.Empty
	271, // 895: header.Proder.ListPipelines:output_type -> header.Pipelines
	11,  // 896: header.Proder.DeletePipelineStage:output_type -> header.Empty
	...
	11,  // 899: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	51,  // 900: header.TaskMgr.ReadTask:output_type -> header.Task
	51,  // 901: header.TaskMgr.CreateTask:output_type -> header.Task
	51,  // 902: header.TaskMgr.UpdateTask:output_type -> header.Task
	11,  // 903: header.TaskMgr.DeleteTask:output_type -> header.Empty
	272, // 904: header.TaskMgr.ListTasks:output_type -> header.Tasks
	11,  // 905: header.TaskMgr.SeenTask:output_type -> header.Empty
	11,  // 906: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	11,  // 907: header.TaskMgr.MuteTask:output_type -> header.Empty
	11,  // 908: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	48,  // 909: header.TaskMgr.AddTaskComment:output_type -> header.Event
	48,  // 910: header.TaskMgr.EditTaskComment:output_type -> header.Event
	48,  // 911: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	...
	11,  // 918: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	11,  // 919: header.CampaignMgr.OnEvent:output_type -> header.Empty
	...
	11,  // 926: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	279, // 927: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	11,  // 928: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	...
	11,  // 939: header.FormMgr.DeleteForm:output_type -> header.Empty
