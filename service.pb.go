...
var file_service_proto_depIdxs = []int32{
	...
	67,  // 189: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	67,  // 190: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 191: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 192: header.TemplateMgr.GetTemplate:input_type -> header.Id
	68,  // 193: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 194: header.TemplateMgr.PickTemplate:input_type -> header.Id
	69,  // 195: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	69,  // 196: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	4,   // 197: header.TemplateMgr.DeleteModal:input_type -> header.Id
	4,   // 198: header.TemplateMgr.GetModal:input_type -> header.Id
	4,   // 199: header.TemplateMgr.ListModals:input_type -> header.Id
	70,  // 200: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	71,  // 201: header.TagMgr.CreateTag:input_type -> header.Tag
	71,  // 202: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 203: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 204: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 205: header.TagMgr.GetTag:input_type -> header.Id
	...
	102, // 262: header.ZalokonService.SendZns:input_type -> header.ZnsRequest
	...
	4,   // 319: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	123, // 320: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 321: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 322: header.Watchhttp.ListWebpages:input_type -> header.Id
	123, // 323: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 324: header.Watchhttp.ReadWebpage:input_type -> header.Id
	124, // 325: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	125, // 326: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	126, // 327: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	126, // 328: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	...
	127, // 334: header.Holap.FreeAccount:input_type -> header.AccountImage
	128, // 335: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	129, // 336: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	128, // 337: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	129, // 338: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	130, // 339: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	...
	131, // 343: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	132, // 344: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	132, // 345: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	...
	133, // 351: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 352: header.Proder.ListProductIds:input_type -> header.Ids
	133, // 353: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	134, // 354: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 355: header.Proder.ListProductCollections:input_type -> header.Ids
	135, // 356: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	135, // 357: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	136, // 360: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	136, // 361: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	137, // 370: header.Proder.ListOrders:input_type -> header.OrdersRequest
	137, // 371: header.Proder.CountOrders:input_type -> header.OrdersRequest
	138, // 372: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	139, // 373: header.Proder.ImportOrders:input_type -> header.Orders
	140, // 374: header.Proder.MakeOrderPayment:input_type -> header.Bill
	141, // 375: header.Proder.DeleteOrderPayment:input_type -> header.Key
	...
	141, // 378: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 379: header.Proder.ListOrderEvents:input_type -> header.Id
	142, // 380: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 381: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	143, // 382: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 383: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	144, // 384: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	145, // 385: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	146, // 386: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	147, // 387: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	148, // 398: header.Apiece.CreateTask:input_type -> header.Task
	148, // 399: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 400: header.Apiece.DeleteTask:input_type -> header.Id
	149, // 401: header.Apiece.ListTasks:input_type -> header.TasksRequest
	4,   // 402: header.Apiece.SeenTask:input_type -> header.Id
	38,  // 403: header.Apiece.AddTaskComment:input_type -> header.Event
	38,  // 404: header.Apiece.EditTaskComment:input_type -> header.Event
	141, // 405: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 406: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 407: header.Apiece.ReadPipeline:input_type -> header.Id
	150, // 408: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	150, // 409: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 410: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 411: header.Apiece.ListPipelines:input_type -> header.Ids
	151, // 412: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	152, // 413: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	47,  // 414: header.Search.Index:output_type -> header.Empty
	153, // 415: header.Search.Search:output_type -> header.DocSearchResponse
	47,  // 416: header.Search.AddOwner:output_type -> header.Empty
	154, // 417: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 418: header.Map.LookupAddress:output_type -> header.Address
	155, // 419: header.Map.PredictAddress:output_type -> header.Addresses
	155, // 420: header.Map.ListDistricts:output_type -> header.Addresses
	155, // 421: header.Map.ListProvinces:output_type -> header.Addresses
	155, // 422: header.Map.ListWards:output_type -> header.Addresses
	155, // 423: header.Map.ListStreets:output_type -> header.Addresses
	155, // 424: header.Map.ListAddresses:output_type -> header.Addresses
	19,  // 425: header.Map.ReadAddress:output_type -> header.Address
	6,   // 426: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 427: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 428: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	47,  // 429: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 430: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 431: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 432: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	47,  // 433: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 434: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 435: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 436: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 437: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 438: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 439: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 440: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 441: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 442: header.AccountMgr.CreateAccount:output_type -> account.Account
	156, // 443: header.AccountMgr.ListAgents:output_type -> account.Agents
	47,  // 444: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	157, // 445: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 446: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	158, // 447: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 448: header.AccountMgr.TransferOwner:output_type -> account.Agent
	14,  // 449: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	159, // 450: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	159, // 451: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	47,  // 452: header.AccountMgr.LogoutSession:output_type -> header.Empty
	14,  // 453: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	160, // 454: header.AccountMgr.GetLanguage:output_type -> header.Lang
	15,  // 455: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	16,  // 456: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	161, // 457: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	18,  // 458: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	18,  // 459: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	162, // 460: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	47,  // 461: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	155, // 462: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	19,  // 463: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	19,  // 464: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	47,  // 465: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	163, // 466: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	20,  // 467: header.AccountMgr.CreateTax:output_type -> header.Tax
	20,  // 468: header.AccountMgr.UpdateTax:output_type -> header.Tax
	47,  // 469: header.AccountMgr.DeleteTax:output_type -> header.Empty
	164, // 470: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	164, // 471: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	22,  // 472: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	22,  // 473: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	47,  // 474: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	23,  // 475: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	165, // 476: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	23,  // 477: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	47,  // 478: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	166, // 479: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 480: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 481: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	47,  // 482: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	47,  // 483: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	167, // 484: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	47,  // 485: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 486: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 487: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 488: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	168, // 489: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	26,  // 490: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	47,  // 491: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	27,  // 492: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	169, // 493: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	30,  // 494: header.UserMgr.MergeUser:output_type -> header.User
	47,  // 495: header.UserMgr.DetachUser:output_type -> header.Empty
	4,   // 496: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 497: header.UserMgr.CreateUserFromWeb:output_type -> header.Id
	4,   // 498: header.UserMgr.UpdateUser:output_type -> header.Id
	30,  // 499: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 500: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	170, // 501: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	29,  // 502: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 503: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 504: header.UserMgr.CreateView:output_type -> header.UserView
	47,  // 505: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 506: header.UserMgr.GetView:output_type -> header.UserView
	171, // 507: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 508: header.UserMgr.UpsertLabel:output_type -> header.Label
	47,  // 509: header.UserMgr.DeleteLabel:output_type -> header.Empty
	172, // 510: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 511: header.UserMgr.GetLabel:output_type -> header.Label
	47,  // 512: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	47,  // 513: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	47,  // 514: header.UserMgr.AddUserLabel:output_type -> header.Empty
	47,  // 515: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	47,  // 516: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	19,  // 517: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	19,  // 518: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	47,  // 519: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	173, // 520: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	47,  // 521: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	29,  // 522: header.UserMgr.ListLeads:output_type -> header.Users
	174, // 523: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	29,  // 524: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	29,  // 525: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	36,  // 526: header.UserMgr.LinkProductUrl:output_type -> header.Product
	100, // 527: header.UserMgr.ListUserEvents:output_type -> header.Events
	38,  // 528: header.UserMgr.CreateUserEvent:output_type -> header.Event
	39,  // 529: header.UserMgr.FillDevice:output_type -> common.Device
	175, // 530: header.LiveMgr.SearchLocations:output_type -> header.Locations
	29,  // 531: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	100, // 532: header.LiveMgr.TopEvents:output_type -> header.Events
	176, // 533: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	177, // 534: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	178, // 535: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	179, // 536: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	180, // 537: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	181, // 538: header.NoteMgr.ListNotes:output_type -> header.Notes
	45,  // 539: header.NoteMgr.AddNote:output_type -> header.Note
	45,  // 540: header.NoteMgr.UpdateNote:output_type -> header.Note
	47,  // 541: header.NoteMgr.DeleteNote:output_type -> header.Empty
	182, // 542: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	48,  // 543: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	48,  // 544: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	183, // 545: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 546: header.ConversationMgr.PongMessage:output_type -> header.Event
	54,  // 547: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	54,  // 548: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	54,  // 549: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	184, // 550: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	184, // 551: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	47,  // 552: header.ConversationMgr.TagConversation:output_type -> header.Empty
	47,  // 553: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	47,  // 554: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	47,  // 555: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	47,  // 556: header.ConversationMgr.Typing:output_type -> header.Empty
	54,  // 557: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	184, // 558: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	47,  // 559: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	47,  // 560: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	47,  // 561: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	47,  // 562: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	56,  // 563: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	56,  // 564: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 565: header.ConversationMgr.TerminateBot:output_type -> header.Event
	38,  // 566: header.ConversationMgr.SendMessage:output_type -> header.Event
	38,  // 567: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	47,  // 568: header.ConversationMgr.PinMessage:output_type -> header.Empty
	47,  // 569: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	100, // 570: header.ConversationMgr.ListEvents:output_type -> header.Events
	47,  // 571: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	185, // 572: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	59,  // 573: header.ConversationMgr.Integrate:output_type -> header.Integration
	59,  // 574: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	60,  // 575: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	60,  // 576: header.ConversationMgr.CreateRule:output_type -> header.Rule
	47,  // 577: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	60,  // 578: header.ConversationMgr.ReadRule:output_type -> header.Rule
	186, // 579: header.ConversationMgr.ListRules:output_type -> header.Route
	187, // 580: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	61,  // 581: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	47,  // 582: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	61,  // 583: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	188, // 584: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	62,  // 585: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	62,  // 586: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	47,  // 587: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	62,  // 588: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	59,  // 589: header.ConversationMgr.TestNumber:output_type -> header.Integration
	189, // 590: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	63,  // 591: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	64,  // 592: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	190, // 593: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	47,  // 594: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	191, // 595: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	65,  // 596: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	54,  // 597: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	47,  // 598: header.ConversationMgr.PingAppPhone:output_type -> header.Empty
	47,  // 599: header.ConversationMgr.ReplyRingRequest:output_type -> header.Empty
	192, // 600: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	38,  // 601: header.ConversationMgr.SaveMessage:output_type -> header.Event
	67,  // 602: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	67,  // 603: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	47,  // 604: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	67,  // 605: header.TemplateMgr.GetTemplate:output_type -> header.Template
	193, // 606: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	47,  // 607: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	69,  // 608: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	69,  // 609: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	47,  // 610: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	69,  // 611: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	194, // 612: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	195, // 613: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	71,  // 614: header.TagMgr.CreateTag:output_type -> header.Tag
	71,  // 615: header.TagMgr.UpdateTag:output_type -> header.Tag
	47,  // 616: header.TagMgr.DeleteTag:output_type -> header.Empty
	196, // 617: header.TagMgr.ListTags:output_type -> header.Tags
	71,  // 618: header.TagMgr.GetTag:output_type -> header.Tag
	197, // 619: header.FileMgr.Presign:output_type -> header.PresignResult
	198, // 620: header.FileMgr.Uploaded:output_type -> header.File
	198, // 621: header.FileMgr.DownloadFileUrl:output_type -> header.File
	75,  // 622: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	75,  // 623: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	...
	78,  // 628: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	199, // 629: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	83,  // 630: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	80,  // 631: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	80,  // 632: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	81,  // 633: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	81,  // 634: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	47,  // 635: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	200, // 636: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	78,  // 637: header.PaymentMgr.Pay:output_type -> payment.Bill
	83,  // 638: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	83,  // 639: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	201, // 640: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	83,  // 641: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	83,  // 642: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	202, // 643: header.PaymentMgr.ListComments:output_type -> payment.Comments
	87,  // 644: header.PaymentMgr.AddComment:output_type -> payment.Comment
	203, // 645: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	91,  // 646: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	91,  // 647: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	88,  // 648: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	78,  // 649: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	204, // 650: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	90,  // 651: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	90,  // 652: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	47,  // 653: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	90,  // 654: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	205, // 655: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	47,  // 656: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	95,  // 657: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	95,  // 658: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	206, // 659: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	95,  // 660: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	207, // 661: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	208, // 662: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	209, // 663: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	98,  // 666: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	98,  // 667: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	210, // 668: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	211, // 669: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	99,  // 670: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	...
	212, // 673: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	103, // 680: header.WidgetService.Read:output_type -> header.WidgetSetting
	103, // 681: header.WidgetService.Update:output_type -> header.WidgetSetting
	213, // 682: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	214, // 683: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	104, // 684: header.WidgetService.SubmitImpression:output_type -> header.Impression
	105, // 685: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	106, // 686: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	215, // 687: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	216, // 688: header.WidgetService.ListConversions:output_type -> header.Conversions
	217, // 689: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	109, // 690: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	218, // 691: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	47,  // 692: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	219, // 693: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	110, // 694: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	110, // 695: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	110, // 696: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	47,  // 697: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	110, // 698: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	219, // 699: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	47,  // 700: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	220, // 701: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	218, // 702: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	221, // 703: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	222, // 704: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	223, // 705: header.Bizbot.ListBots:output_type -> header.Bots
	112, // 706: header.Bizbot.GetBot:output_type -> header.Bot
	112, // 707: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	112, // 708: header.Bizbot.CreateBot:output_type -> header.Bot
	112, // 709: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	224, // 715: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	225, // 716: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	226, // 717: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	227, // 718: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	118, // 719: header.Sendback.CreateWebhook:output_type -> header.Webhook
	228, // 720: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	47,  // 721: header.Sendback.DeleteWebhook:output_type -> header.Empty
	229, // 722: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	118, // 723: header.Sendback.ReadWebhook:output_type -> header.Webhook
	118, // 724: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	118, // 725: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	230, // 726: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	231, // 727: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	47,  // 728: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	47,  // 729: header.Notibox.SendNoti:output_type -> header.Empty
	232, // 730: header.Notibox.ListNoties:output_type -> header.Notifications
	47,  // 731: header.Notibox.MarkReadNoti:output_type -> header.Empty
	47,  // 732: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	123, // 733: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	47,  // 734: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	233, // 735: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	123, // 736: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	123, // 737: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	234, // 738: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	235, // 739: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	236, // 740: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	234, // 741: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	47,  // 742: header.Holap.AppendAgentSet:output_type -> header.Empty
	47,  // 743: header.Holap.AppendTagSet:output_type -> header.Empty
	47,  // 744: header.Holap.UpdateUser:output_type -> header.Empty
	47,  // 745: header.Holap.UpdateConversation:output_type -> header.Empty
	47,  // 746: header.Holap.OnConversationEvent:output_type -> header.Empty
	47,  // 747: header.Holap.FreeAccount:output_type -> header.Empty
	237, // 748: header.Holap.ReportUser:output_type -> header.UserMetrics
	238, // 749: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 750: header.Holap.ListUserIds:output_type -> header.Ids
	184, // 751: header.Holap.ListConversationIds:output_type -> header.Conversations
	239, // 752: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 753: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	170, // 754: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	47,  // 755: header.Holap.UpdateOrder:output_type -> header.Empty
	139, // 756: header.Holap.ReportOrder:output_type -> header.Orders
	240, // 757: header.Holap.ReportCall:output_type -> header.CallMetrics
	184, // 758: header.Holap.ListCallIds:output_type -> header.Conversations
	36,  // 759: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 760: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 761: header.Proder.UpdateProduct:output_type -> header.Product
	47,  // 762: header.Proder.DeleteProduct:output_type -> header.Empty
	36,  // 763: header.Proder.RestoreProduct:output_type -> header.Product
	134, // 764: header.Proder.ListProducts:output_type -> header.Products
	5,   // 765: header.Proder.ListProductIds:output_type -> header.Ids
	134, // 766: header.Proder.ListGroupedProducts:output_type -> header.Products
	134, // 767: header.Proder.ImportProducts:output_type -> header.Products
	241, // 768: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	135, // 769: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	135, // 770: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	47,  // 771: header.Proder.DeleteProductCollection:output_type -> header.Empty
	242, // 772: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	136, // 773: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	136, // 774: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	47,  // 775: header.Proder.DeleteProductFeed:output_type -> header.Empty
	243, // 776: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	244, // 777: header.Proder.ListProductProps:output_type -> header.ProductProps
	21,  // 778: header.Proder.ReadOrder:output_type -> header.Order
	21,  // 779: header.Proder.CreateOrder:output_type -> header.Order
	21,  // 780: header.Proder.UpdateOrder:output_type -> header.Order
	47,  // 781: header.Proder.DeleteOrder:output_type -> header.Empty
	21,  // 782: header.Proder.RestoreOrder:output_type -> header.Order
	139, // 783: header.Proder.ListOrders:output_type -> header.Orders
	139, // 784: header.Proder.CountOrders:output_type -> header.Orders
	47,  // 785: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	139, // 786: header.Proder.ImportOrders:output_type -> header.Orders
	38,  // 787: header.Proder.MakeOrderPayment:output_type -> header.Event
	38,  // 788: header.Proder.DeleteOrderPayment:output_type -> header.Event
	38,  // 789: header.Proder.AddOrderComment:output_type -> header.Event
	38,  // 790: header.Proder.EditOrderComment:output_type -> header.Event
	38,  // 791: header.Proder.DeleteOrderComment:output_type -> header.Event
	245, // 792: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	198, // 793: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 794: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	246, // 795: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	47,  // 796: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	247, // 797: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	47,  // 798: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	47,  // 799: header.Proder.GHNShippingStatus:output_type -> header.Empty
	147, // 800: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 801: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 802: header.Proder.UpdateShippingCode:output_type -> header.Order
	21,  // 803: header.Proder.CancelShippingOrder:output_type -> header.Order
	198, // 804: header.Proder.PrintShippingOrders:output_type -> header.File
	47,  // 805: header.Proder.SeenOrder:output_type -> header.Empty
	47,  // 806: header.Proder.FollowOrder:output_type -> header.Empty
	47,  // 807: header.Proder.UnfollowOrder:output_type -> header.Empty
	47,  // 808: header.Proder.TagOrder:output_type -> header.Empty
	47,  // 809: header.Proder.UntagOrder:output_type -> header.Empty
	148, // 810: header.Apiece.ReadTask:output_type -> header.Task
	148, // 811: header.Apiece.CreateTask:output_type -> header.Task
	148, // 812: header.Apiece.UpdateTask:output_type -> header.Task
	47,  // 813: header.Apiece.DeleteTask:output_type -> header.Empty
	248, // 814: header.Apiece.ListTasks:output_type -> header.Tasks
	47,  // 815: header.Apiece.SeenTask:output_type -> header.Empty
	38,  // 816: header.Apiece.AddTaskComment:output_type -> header.Event
	38,  // 817: header.Apiece.EditTaskComment:output_type -> header.Event
	38,  // 818: header.Apiece.DeleteTaskComment:output_type -> header.Event
	249, // 819: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	150, // 820: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	150, // 821: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	150, // 822: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	47,  // 823: header.Apiece.DeletePipeline:output_type -> header.Empty
	250, // 824: header.Apiece.ListPipelines:output_type -> header.Pipelines
	151, // 825: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	413, // [413:826] is the sub-list for method output_type
	0,   // [0:413] is the sub-list for method input_type
