...
var file_service_proto_rawDesc = []byte{
	...
	0x12, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a,
	0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x8c,
	0x03, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x2b, 0x0a, 0x04, 0x53, 0x65,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x4d, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x63, 0x65,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Notification)(nil),                      // 114: header.Notification
	(*CompactedNotiRequest)(nil),              // 115: header.CompactedNotiRequest
...
var file_service_proto_depIdxs = []int32{
	...
	114, // 293: header.Notibox.Send:input_type -> header.Notification
	4,   // 294: header.Notibox.MarkRead:input_type -> header.Id
	115, // 295: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	116, // 296: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	114, // 297: header.Notibox.SendNoti:input_type -> header.Notification
	...
	64,  // 310: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 311: header.Holap.UpdateUser:input_type -> header.User
	53,  // 312: header.Holap.UpdateConversation:input_type -> header.Conversation
	48,  // 313: header.Holap.OnConversationEvent:input_type -> header.Event
	...
	31,  // 321: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	...
	126, // 324: header.Proder.ReadProduct:input_type -> header.Product
	126, // 325: header.Proder.CreateProduct:input_type -> header.Product
	126, // 326: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 327: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 328: header.Proder.RestoreProduct:input_type -> header.Id
	127, // 329: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 330: header.Proder.ListProductIds:input_type -> header.Ids
	127, // 331: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	128, // 332: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 333: header.Proder.ListProductCollections:input_type -> header.Ids
	129, // 334: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	129, // 335: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	130, // 338: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	130, // 339: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	131, // 348: header.Proder.ListOrders:input_type -> header.OrdersRequest
	131, // 349: header.Proder.CountOrders:input_type -> header.OrdersRequest
	132, // 350: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	133, // 351: header.Proder.MakeOrderPayment:input_type -> header.Bill
	134, // 352: header.Proder.DeleteOrderPayment:input_type -> header.Key
	48,  // 353: header.Proder.AddOrderComment:input_type -> header.Event
	48,  // 354: header.Proder.EditOrderComment:input_type -> header.Event
	134, // 355: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 356: header.Proder.ListOrderEvents:input_type -> header.Id
	135, // 357: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 358: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	136, // 359: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 360: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	137, // 361: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	138, // 362: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	139, // 363: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	140, // 364: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	141, // 371: header.Proder.VisitProductSite:input_type -> header.VisitProductSiteRequest
	4,   // 372: header.Apiece.ReadTask:input_type -> header.Id
	142, // 373: header.Apiece.CreateTask:input_type -> header.Task
	142, // 374: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 375: header.Apiece.DeleteTask:input_type -> header.Id
	143, // 376: header.Apiece.ListTasks:input_type -> header.TasksRequest
	48,  // 377: header.Apiece.AddTaskComment:input_type -> header.Event
	48,  // 378: header.Apiece.EditTaskComment:input_type -> header.Event
	134, // 379: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 380: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 381: header.Apiece.ReadPipeline:input_type -> header.Id
	144, // 382: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	144, // 383: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 384: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 385: header.Apiece.ListPipelines:input_type -> header.Ids
	145, // 386: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	44,  // 387: header.Search.Index:output_type -> header.Empty
	146, // 388: header.Search.Search:output_type -> header.DocSearchResponse
	44,  // 389: header.Search.AddOwner:output_type -> header.Empty
	147, // 390: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 391: header.Map.LookupAddress:output_type -> header.Address
	148, // 392: header.Map.PredictAddress:output_type -> header.Addresses
	148, // 393: header.Map.ListDistricts:output_type -> header.Addresses
	148, // 394: header.Map.ListProvinces:output_type -> header.Addresses
	148, // 395: header.Map.ListWards:output_type -> header.Addresses
	148, // 396: header.Map.ListStreets:output_type -> header.Addresses
	148, // 397: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 398: header.Map.ReadAddress:output_type -> header.Address
	6,   // 399: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 400: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 401: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	44,  // 402: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 403: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 404: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 405: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	44,  // 406: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 407: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 408: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 409: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 410: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 411: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 412: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 413: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 414: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 415: header.AccountMgr.CreateAccount:output_type -> account.Account
	149, // 416: header.AccountMgr.ListAgents:output_type -> account.Agents
	44,  // 417: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	150, // 418: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	44,  // 419: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	44,  // 420: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 421: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	151, // 422: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 423: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 424: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	152, // 425: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	152, // 426: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	44,  // 427: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 428: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	153, // 429: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 430: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 431: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	154, // 432: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 433: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 434: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	155, // 435: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	44,  // 436: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	148, // 437: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 438: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 439: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	44,  // 440: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	156, // 441: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 442: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 443: header.AccountMgr.UpdateTax:output_type -> header.Tax
	44,  // 444: header.AccountMgr.DeleteTax:output_type -> header.Empty
	157, // 445: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	157, // 446: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 447: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 448: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	44,  // 449: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 450: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	158, // 451: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 452: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	44,  // 453: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	159, // 454: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	25,  // 455: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	25,  // 456: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	44,  // 457: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	44,  // 458: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	160, // 459: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	44,  // 460: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	26,  // 461: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	26,  // 462: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	26,  // 463: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	161, // 464: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 465: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	44,  // 466: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	162, // 467: header.UserMgr.SearchUsers:output_type -> header.Users
	29,  // 468: header.UserMgr.MergeUser:output_type -> header.UserAlias
	...
	163, // 473: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	162, // 474: header.UserMgr.MatchUsers:output_type -> header.Users
	...
	164, // 479: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 480: header.UserMgr.UpsertLabel:output_type -> header.Label
	44,  // 481: header.UserMgr.DeleteLabel:output_type -> header.Empty
	165, // 482: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	166, // 491: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	44,  // 492: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	162, // 493: header.UserMgr.ListLeads:output_type -> header.Users
	167, // 494: header.UserMgr.ListUserContactProfiles:output_type -> common.ContactProfiles
	30,  // 495: header.UserMgr.GetOrCreateUserByContactProfile:output_type -> header.User
	35,  // 496: header.UserMgr.UpsertContactProfile:output_type -> common.ContactProfile
	168, // 497: header.LiveMgr.SearchLocations:output_type -> header.Locations
	162, // 498: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	95,  // 499: header.LiveMgr.TopEvents:output_type -> header.Events
	169, // 500: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	170, // 501: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	171, // 502: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	172, // 503: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	173, // 504: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	174, // 505: header.NoteMgr.ListNotes:output_type -> header.Notes
	41,  // 506: header.NoteMgr.AddNote:output_type -> header.Note
	41,  // 507: header.NoteMgr.UpdateNote:output_type -> header.Note
	44,  // 508: header.NoteMgr.DeleteNote:output_type -> header.Empty
	175, // 509: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	43,  // 510: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	44,  // 511: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	43,  // 512: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	176, // 513: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	45,  // 514: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	45,  // 515: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	177, // 516: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	178, // 517: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	48,  // 518: header.ConversationMgr.PongMessage:output_type -> header.Event
	53,  // 519: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	53,  // 520: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	53,  // 521: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	179, // 522: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	179, // 523: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	44,  // 524: header.ConversationMgr.TagConversation:output_type -> header.Empty
	44,  // 525: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	44,  // 526: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	44,  // 527: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	44,  // 528: header.ConversationMgr.Typing:output_type -> header.Empty
	53,  // 529: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	179, // 530: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	44,  // 531: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	44,  // 532: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	44,  // 533: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	44,  // 534: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	44,  // 535: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	...
	180, // 539: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	...
	181, // 546: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	182, // 553: header.ConversationMgr.ListRules:output_type -> header.Route
	183, // 554: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	184, // 562: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	185, // 568: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	186, // 569: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	187, // 573: header.TagMgr.ListTags:output_type -> header.Tags
	...
	188, // 577: header.FileMgr.Presign:output_type -> header.PresignResult
	189, // 578: header.FileMgr.Uploaded:output_type -> header.File
	189, // 579: header.FileMgr.DownloadFileUrl:output_type -> header.File
	...
	190, // 587: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	191, // 594: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	192, // 598: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	193, // 601: header.PaymentMgr.ListComments:output_type -> payment.Comments
	82,  // 602: header.PaymentMgr.AddComment:output_type -> payment.Comment
	194, // 603: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	195, // 608: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	196, // 613: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	197, // 617: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	90,  // 618: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	198, // 619: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	199, // 620: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	200, // 621: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	201, // 626: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	202, // 627: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	96,  // 630: header.WidgetService.Read:output_type -> header.WidgetSetting
	96,  // 631: header.WidgetService.Update:output_type -> header.WidgetSetting
	203, // 632: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	204, // 633: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	97,  // 634: header.WidgetService.SubmitImpression:output_type -> header.Impression
	98,  // 635: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	99,  // 636: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	205, // 637: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	206, // 638: header.WidgetService.ListConversions:output_type -> header.Conversions
	207, // 639: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	102, // 640: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	208, // 641: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	44,  // 642: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	209, // 643: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	103, // 644: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	103, // 645: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	103, // 646: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	44,  // 647: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	103, // 648: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	209, // 649: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	44,  // 650: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	210, // 651: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	208, // 652: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	211, // 653: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	212, // 654: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	213, // 655: header.Bizbot.ListBots:output_type -> header.Bots
	105, // 656: header.Bizbot.GetBot:output_type -> header.Bot
	105, // 657: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	105, // 658: header.Bizbot.CreateBot:output_type -> header.Bot
	105, // 659: header.Bizbot.UpdateBot:output_type -> header.Bot
	44,  // 660: header.Bizbot.DeleteBot:output_type -> header.Empty
	44,  // 661: header.Bizbot.OnEvent:output_type -> header.Empty
	44,  // 662: header.Bizbot.StartBot:output_type -> header.Empty
	44,  // 663: header.Bizbot.StopBot:output_type -> header.Empty
	44,  // 664: header.Bizbot.TryAction:output_type -> header.Empty
	214, // 665: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	215, // 666: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	216, // 667: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	217, // 668: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	111, // 669: header.Sendback.CreateWebhook:output_type -> header.Webhook
	218, // 670: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	44,  // 671: header.Sendback.DeleteWebhook:output_type -> header.Empty
	219, // 672: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	111, // 673: header.Sendback.ReadWebhook:output_type -> header.Webhook
	111, // 674: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	111, // 675: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	220, // 676: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	221, // 677: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	44,  // 678: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	44,  // 679: header.Notibox.Send:output_type -> header.Empty
	44,  // 680: header.Notibox.MarkRead:output_type -> header.Empty
	44,  // 681: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	222, // 682: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	44,  // 683: header.Notibox.SendNoti:output_type -> header.Empty
	223, // 684: header.Notibox.ListNoties:output_type -> header.Notifications
	44,  // 685: header.Notibox.MarkReadNoti:output_type -> header.Empty
	117, // 686: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	44,  // 687: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	224, // 688: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	117, // 689: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	117, // 690: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	225, // 691: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	226, // 692: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	227, // 693: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	225, // 694: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	44,  // 695: header.Holap.AppendAgentSet:output_type -> header.Empty
	44,  // 696: header.Holap.AppendTagSet:output_type -> header.Empty
	44,  // 697: header.Holap.UpdateUser:output_type -> header.Empty
	44,  // 698: header.Holap.UpdateConversation:output_type -> header.Empty
	44,  // 699: header.Holap.OnConversationEvent:output_type -> header.Empty
	44,  // 700: header.Holap.FreeAccount:output_type -> header.Empty
	228, // 701: header.Holap.ReportUser:output_type -> header.UserMetrics
	229, // 702: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 703: header.Holap.ListUserIds:output_type -> header.Ids
	179, // 704: header.Holap.ListConversationIds:output_type -> header.Conversations
	230, // 705: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 706: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	163, // 707: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	44,  // 708: header.Holap.UpdateOrder:output_type -> header.Empty
	231, // 709: header.Holap.ReportOrder:output_type -> header.Orders
	126, // 710: header.Proder.ReadProduct:output_type -> header.Product
	126, // 711: header.Proder.CreateProduct:output_type -> header.Product
	126, // 712: header.Proder.UpdateProduct:output_type -> header.Product
	44,  // 713: header.Proder.DeleteProduct:output_type -> header.Empty
	126, // 714: header.Proder.RestoreProduct:output_type -> header.Product
	128, // 715: header.Proder.ListProducts:output_type -> header.Products
	5,   // 716: header.Proder.ListProductIds:output_type -> header.Ids
	128, // 717: header.Proder.ListGroupedProducts:output_type -> header.Products
	128, // 718: header.Proder.ImportProducts:output_type -> header.Products
	232, // 719: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	129, // 720: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	129, // 721: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	44,  // 722: header.Proder.DeleteProductCollection:output_type -> header.Empty
	233, // 723: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	130, // 724: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	130, // 725: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	44,  // 726: header.Proder.DeleteProductFeed:output_type -> header.Empty
	234, // 727: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	235, // 728: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 729: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 730: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 731: header.Proder.UpdateOrder:output_type -> header.Order
	44,  // 732: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 733: header.Proder.RestoreOrder:output_type -> header.Order
	231, // 734: header.Proder.ListOrders:output_type -> header.Orders
	231, // 735: header.Proder.CountOrders:output_type -> header.Orders
	44,  // 736: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	48,  // 737: header.Proder.MakeOrderPayment:output_type -> header.Event
	48,  // 738: header.Proder.DeleteOrderPayment:output_type -> header.Event
	48,  // 739: header.Proder.AddOrderComment:output_type -> header.Event
	48,  // 740: header.Proder.EditOrderComment:output_type -> header.Event
	48,  // 741: header.Proder.DeleteOrderComment:output_type -> header.Event
	236, // 742: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	189, // 743: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 744: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	237, // 745: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	44,  // 746: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	238, // 747: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	44,  // 748: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	44,  // 749: header.Proder.GHNShippingStatus:output_type -> header.Empty
	140, // 750: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 751: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 752: header.Proder.CancelShippingOrder:output_type -> header.Order
	189, // 753: header.Proder.PrintShippingOrders:output_type -> header.File
	44,  // 754: header.Proder.SeenOrder:output_type -> header.Empty
	44,  // 755: header.Proder.FollowOrder:output_type -> header.Empty
	44,  // 756: header.Proder.UnfollowOrder:output_type -> header.Empty
	128, // 757: header.Proder.VisitProductSite:output_type -> header.Products
	142, // 758: header.Apiece.ReadTask:output_type -> header.Task
	142, // 759: header.Apiece.CreateTask:output_type -> header.Task
	142, // 760: header.Apiece.UpdateTask:output_type -> header.Task
	44,  // 761: header.Apiece.DeleteTask:output_type -> header.Empty
	239, // 762: header.Apiece.ListTasks:output_type -> header.Tasks
	48,  // 763: header.Apiece.AddTaskComment:output_type -> header.Event
	48,  // 764: header.Apiece.EditTaskComment:output_type -> header.Event
	48,  // 765: header.Apiece.DeleteTaskComment:output_type -> header.Event
	240, // 766: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	144, // 767: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	144, // 768: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	144, // 769: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	44,  // 770: header.Apiece.DeletePipeline:output_type -> header.Empty
	241, // 771: header.Apiece.ListPipelines:output_type -> header.Pipelines
	386, // [386:772] is the sub-list for method output_type
	0,   // [0:386] is the sub-list for method input_type
