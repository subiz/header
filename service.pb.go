...
var file_service_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0xfd, 0x0c, 0x0a, 0x06, 0x50, 0x72, 0x6f,
	...
	0x79, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68,
...
var file_service_proto_depIdxs = []int32{
	...
	93,  // 240: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 241: header.Bizbot.ListBotRevisions:input_type -> header.Id
	97,  // 242: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 243: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 244: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 245: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 246: header.Sendback.ReadWebhook:input_type -> header.Id
	97,  // 247: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 248: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	98,  // 249: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	99,  // 250: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	42,  // 251: header.Sendback.SendWebhookEvent:input_type -> header.Event
	100, // 252: header.Notibox.Send:input_type -> header.Notification
	1,   // 253: header.Notibox.MarkRead:input_type -> header.Id
	101, // 254: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	102, // 255: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	103, // 256: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 257: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 258: header.Watchhttp.ListWebpages:input_type -> header.Id
	103, // 259: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 260: header.Watchhttp.ReadWebpage:input_type -> header.Id
	104, // 261: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	105, // 262: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	106, // 263: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	106, // 264: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	4,   // 265: header.Holap.AppendAgentSet:input_type -> account.Agent
	52,  // 266: header.Holap.AppendTagSet:input_type -> header.Tag
	21,  // 267: header.Holap.UpdateUser:input_type -> header.User
	47,  // 268: header.Holap.UpdateConversation:input_type -> header.Conversation
	42,  // 269: header.Holap.OnConversationEvent:input_type -> header.Event
	107, // 270: header.Holap.FreeAccount:input_type -> header.AccountImage
	108, // 271: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	109, // 272: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	108, // 273: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	109, // 274: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	110, // 275: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	23,  // 276: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	22,  // 277: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	111, // 278: header.Holap.UpdateOrder:input_type -> header.Order
	112, // 279: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	113, // 280: header.Proder.ReadProduct:input_type -> header.Product
	113, // 281: header.Proder.CreateProduct:input_type -> header.Product
	113, // 282: header.Proder.UpdateProduct:input_type -> header.Product
	1,   // 283: header.Proder.DeleteProduct:input_type -> header.Id
	114, // 284: header.Proder.ListProducts:input_type -> header.ProductsRequest
	23,  // 285: header.Proder.ListProductIds:input_type -> header.Ids
	114, // 286: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	23,  // 287: header.Proder.ListProductCollections:input_type -> header.Ids
	115, // 288: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	115, // 289: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	1,   // 290: header.Proder.DeleteProductCollection:input_type -> header.Id
	23,  // 291: header.Proder.ListProductFeeds:input_type -> header.Ids
	116, // 292: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	116, // 293: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	1,   // 294: header.Proder.DeleteProductFeed:input_type -> header.Id
	23,  // 295: header.Proder.ListProductCategories:input_type -> header.Ids
	23,  // 296: header.Proder.ListProductProps:input_type -> header.Ids
	1,   // 297: header.Proder.ReadOrder:input_type -> header.Id
	111, // 298: header.Proder.CreateOrder:input_type -> header.Order
	111, // 299: header.Proder.UpdateOrder:input_type -> header.Order
	1,   // 300: header.Proder.DeleteOrder:input_type -> header.Id
	117, // 301: header.Proder.ListOrders:input_type -> header.OrdersRequest
	117, // 302: header.Proder.CountOrders:input_type -> header.OrdersRequest
	118, // 303: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	119, // 304: header.Proder.MakeOrderPayment:input_type -> header.Bill
	120, // 305: header.Proder.DeleteOrderPayment:input_type -> header.Key
	42,  // 306: header.Proder.AddOrderComment:input_type -> header.Event
	42,  // 307: header.Proder.EditOrderComment:input_type -> header.Event
	120, // 308: header.Proder.DeleteOrderComment:input_type -> header.Key
	1,   // 309: header.Proder.ListOrderEvents:input_type -> header.Id
	0,   // 310: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 311: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 312: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	36,  // 313: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 314: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 315: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 316: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	36,  // 317: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 318: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 319: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 320: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 321: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 322: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 323: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 324: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 325: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 326: header.AccountMgr.CreateAccount:output_type -> account.Account
	121, // 327: header.AccountMgr.ListAgents:output_type -> account.Agents
	36,  // 328: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	122, // 329: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	36,  // 330: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	36,  // 331: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 332: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	123, // 333: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 334: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 335: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	124, // 336: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	124, // 337: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	36,  // 338: header.AccountMgr.LogoutSession:output_type -> header.Empty
	10,  // 339: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	125, // 340: header.AccountMgr.GetLanguage:output_type -> header.Lang
	11,  // 341: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	12,  // 342: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	126, // 343: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	14,  // 344: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	14,  // 345: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	127, // 346: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	36,  // 347: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	128, // 348: header.AccountMgr.ListPOSes:output_type -> header.POSes
	15,  // 349: header.AccountMgr.CreatePOS:output_type -> header.POS
	15,  // 350: header.AccountMgr.UpdatePOS:output_type -> header.POS
	36,  // 351: header.AccountMgr.DeletePOS:output_type -> header.Empty
	129, // 352: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	16,  // 353: header.AccountMgr.CreateTax:output_type -> header.Tax
	16,  // 354: header.AccountMgr.UpdateTax:output_type -> header.Tax
	36,  // 355: header.AccountMgr.DeleteTax:output_type -> header.Empty
	36,  // 356: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	130, // 357: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	17,  // 358: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	17,  // 359: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	36,  // 360: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	36,  // 361: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	131, // 362: header.AccountMgr.DownloadOrder:output_type -> header.File
	132, // 363: header.UserMgr.SearchUsers:output_type -> header.Users
	20,  // 364: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 365: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 366: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	1,   // 367: header.UserMgr.UpdateUser:output_type -> header.Id
	21,  // 368: header.UserMgr.ReadUser:output_type -> header.User
	133, // 369: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	132, // 370: header.UserMgr.MatchUsers:output_type -> header.Users
	24,  // 371: header.UserMgr.UpdateView:output_type -> header.UserView
	24,  // 372: header.UserMgr.CreateView:output_type -> header.UserView
	36,  // 373: header.UserMgr.DeleteView:output_type -> header.Empty
	24,  // 374: header.UserMgr.GetView:output_type -> header.UserView
	134, // 375: header.UserMgr.ListViews:output_type -> header.UserViews
	25,  // 376: header.UserMgr.UpsertLabel:output_type -> header.Label
	36,  // 377: header.UserMgr.DeleteLabel:output_type -> header.Empty
	135, // 378: header.UserMgr.ListLabels:output_type -> header.Labels
	25,  // 379: header.UserMgr.GetLabel:output_type -> header.Label
	36,  // 380: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	36,  // 381: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	36,  // 382: header.UserMgr.AddUserLabel:output_type -> header.Empty
	36,  // 383: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	27,  // 384: header.UserMgr.CreateShippingAddress:output_type -> header.ShippingAddress
	27,  // 385: header.UserMgr.UpdateShippingAddress:output_type -> header.ShippingAddress
	36,  // 386: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	21,  // 387: header.UserMgr.ListShippingAddress:output_type -> header.User
	36,  // 388: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	132, // 389: header.UserPersist.ListUsersInView:output_type -> header.Users
	36,  // 390: header.UserPersist.UpdateUser:output_type -> header.Empty
	36,  // 391: header.UserPersist.ResyncUsers:output_type -> header.Empty
	136, // 392: header.LiveMgr.SearchLocations:output_type -> header.Locations
	132, // 393: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	137, // 394: header.LiveMgr.TopEvents:output_type -> header.Events
	138, // 395: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	139, // 396: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	140, // 397: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	141, // 398: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	142, // 399: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	143, // 400: header.NoteMgr.ListNotes:output_type -> header.Notes
	33,  // 401: header.NoteMgr.AddNote:output_type -> header.Note
	33,  // 402: header.NoteMgr.UpdateNote:output_type -> header.Note
	36,  // 403: header.NoteMgr.DeleteNote:output_type -> header.Empty
	144, // 404: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	35,  // 405: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	36,  // 406: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	35,  // 407: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	145, // 408: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	37,  // 409: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	37,  // 410: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	36,  // 411: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	146, // 412: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	40,  // 413: header.RuleMgr.UpdateRule:output_type -> header.Rule
	40,  // 414: header.RuleMgr.CreateRule:output_type -> header.Rule
	36,  // 415: header.RuleMgr.DeleteRule:output_type -> header.Empty
	40,  // 416: header.RuleMgr.ReadRule:output_type -> header.Rule
	147, // 417: header.RuleMgr.ListRules:output_type -> header.Route
	148, // 418: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	42,  // 419: header.ConversationMgr.PongMessage:output_type -> header.Event
	47,  // 420: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	47,  // 421: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	47,  // 422: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	149, // 423: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	149, // 424: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	36,  // 425: header.ConversationMgr.TagConversation:output_type -> header.Empty
	36,  // 426: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	36,  // 427: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	36,  // 428: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	36,  // 429: header.ConversationMgr.Typing:output_type -> header.Empty
	47,  // 430: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	149, // 431: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	36,  // 432: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	36,  // 433: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	36,  // 434: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	36,  // 435: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	48,  // 436: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	48,  // 437: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	42,  // 438: header.ConversationMgr.TerminateBot:output_type -> header.Event
	150, // 439: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	50,  // 440: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	50,  // 441: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	36,  // 442: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	50,  // 443: header.TemplateMgr.GetTemplate:output_type -> header.Template
	151, // 444: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	36,  // 445: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	52,  // 446: header.TagMgr.CreateTag:output_type -> header.Tag
	52,  // 447: header.TagMgr.UpdateTag:output_type -> header.Tag
	36,  // 448: header.TagMgr.DeleteTag:output_type -> header.Empty
	152, // 449: header.TagMgr.ListTags:output_type -> header.Tags
	52,  // 450: header.TagMgr.GetTag:output_type -> header.Tag
	36,  // 451: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	153, // 452: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	53,  // 453: header.IntegrationMgr.Integrate:output_type -> header.Integration
	137, // 454: header.EventMgr.SearchEvents:output_type -> header.Events
	42,  // 455: header.EventMgr.CreateEvent:output_type -> header.Event
	42,  // 456: header.ConversationEventReader.SendMessage:output_type -> header.Event
	42,  // 457: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	36,  // 458: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	36,  // 459: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	137, // 460: header.ConversationEventReader.ListEvents:output_type -> header.Events
	154, // 461: header.FileMgr.Presign:output_type -> header.PresignResult
	131, // 462: header.FileMgr.Uploaded:output_type -> header.File
	131, // 463: header.FileMgr.DownloadFileUrl:output_type -> header.File
	60,  // 464: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	60,  // 465: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	36,  // 466: header.Noti5Service.Noti:output_type -> header.Empty
	36,  // 467: header.Noti5Service.AddToken:output_type -> header.Empty
	36,  // 468: header.Noti5Service.RemoveToken:output_type -> header.Empty
	36,  // 469: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	63,  // 470: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	155, // 471: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	68,  // 472: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	65,  // 473: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	65,  // 474: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	66,  // 475: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	66,  // 476: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	36,  // 477: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	156, // 478: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	63,  // 479: header.PaymentMgr.Pay:output_type -> payment.Bill
	68,  // 480: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	68,  // 481: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	157, // 482: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	68,  // 483: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	68,  // 484: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	158, // 485: header.PaymentMgr.ListComments:output_type -> payment.Comments
	72,  // 486: header.PaymentMgr.AddComment:output_type -> payment.Comment
	159, // 487: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	76,  // 488: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	76,  // 489: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	73,  // 490: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	63,  // 491: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	160, // 492: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	75,  // 493: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	75,  // 494: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	36,  // 495: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	75,  // 496: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	161, // 497: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	36,  // 498: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	80,  // 499: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	80,  // 500: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	162, // 501: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	80,  // 502: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	163, // 503: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	164, // 504: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	165, // 505: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	36,  // 506: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	36,  // 507: header.Pubsub.Publish:output_type -> header.Empty
	36,  // 508: header.Realtime.ShardSend:output_type -> header.Empty
	83,  // 509: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	83,  // 510: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	166, // 511: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	167, // 512: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	84,  // 513: header.WidgetService.Read:output_type -> header.WidgetSetting
	84,  // 514: header.WidgetService.Update:output_type -> header.WidgetSetting
	168, // 515: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	169, // 516: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	85,  // 517: header.WidgetService.SubmitImpression:output_type -> header.Impression
	86,  // 518: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	87,  // 519: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	170, // 520: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	171, // 521: header.WidgetService.ListConversions:output_type -> header.Conversions
	172, // 522: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	90,  // 523: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	173, // 524: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	36,  // 525: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	174, // 526: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	91,  // 527: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	91,  // 528: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	91,  // 529: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	36,  // 530: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	91,  // 531: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	174, // 532: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	36,  // 533: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	175, // 534: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	173, // 535: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	176, // 536: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	177, // 537: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	178, // 538: header.Bizbot.ListBots:output_type -> header.Bots
	93,  // 539: header.Bizbot.GetBot:output_type -> header.Bot
	93,  // 540: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	93,  // 541: header.Bizbot.CreateBot:output_type -> header.Bot
	93,  // 542: header.Bizbot.UpdateBot:output_type -> header.Bot
	36,  // 543: header.Bizbot.DeleteBot:output_type -> header.Empty
	36,  // 544: header.Bizbot.OnEvent:output_type -> header.Empty
	36,  // 545: header.Bizbot.StartBot:output_type -> header.Empty
	36,  // 546: header.Bizbot.StopBot:output_type -> header.Empty
	36,  // 547: header.Bizbot.TryAction:output_type -> header.Empty
	179, // 548: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	180, // 549: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	93,  // 550: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	178, // 551: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	97,  // 552: header.Sendback.CreateWebhook:output_type -> header.Webhook
	181, // 553: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	36,  // 554: header.Sendback.DeleteWebhook:output_type -> header.Empty
	182, // 555: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	97,  // 556: header.Sendback.ReadWebhook:output_type -> header.Webhook
	97,  // 557: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	97,  // 558: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	183, // 559: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	184, // 560: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	36,  // 561: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	36,  // 562: header.Notibox.Send:output_type -> header.Empty
	36,  // 563: header.Notibox.MarkRead:output_type -> header.Empty
	36,  // 564: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	185, // 565: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	103, // 566: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	36,  // 567: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	186, // 568: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	103, // 569: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	103, // 570: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	187, // 571: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	188, // 572: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	189, // 573: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	187, // 574: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	36,  // 575: header.Holap.AppendAgentSet:output_type -> header.Empty
	36,  // 576: header.Holap.AppendTagSet:output_type -> header.Empty
	36,  // 577: header.Holap.UpdateUser:output_type -> header.Empty
	36,  // 578: header.Holap.UpdateConversation:output_type -> header.Empty
	36,  // 579: header.Holap.OnConversationEvent:output_type -> header.Empty
	36,  // 580: header.Holap.FreeAccount:output_type -> header.Empty
	190, // 581: header.Holap.ReportUser:output_type -> header.UserMetrics
	191, // 582: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	23,  // 583: header.Holap.ListUserIds:output_type -> header.Ids
	149, // 584: header.Holap.ListConversationIds:output_type -> header.Conversations
	192, // 585: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	23,  // 586: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	133, // 587: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	36,  // 588: header.Holap.UpdateOrder:output_type -> header.Empty
	193, // 589: header.Holap.ReportOrder:output_type -> header.Orders
	113, // 590: header.Proder.ReadProduct:output_type -> header.Product
	113, // 591: header.Proder.CreateProduct:output_type -> header.Product
	113, // 592: header.Proder.UpdateProduct:output_type -> header.Product
	36,  // 593: header.Proder.DeleteProduct:output_type -> header.Empty
	194, // 594: header.Proder.ListProducts:output_type -> header.Products
	23,  // 595: header.Proder.ListProductIds:output_type -> header.Ids
	194, // 596: header.Proder.ListGroupedProducts:output_type -> header.Products
	195, // 597: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	115, // 598: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	115, // 599: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	36,  // 600: header.Proder.DeleteProductCollection:output_type -> header.Empty
	196, // 601: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	116, // 602: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	116, // 603: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	36,  // 604: header.Proder.DeleteProductFeed:output_type -> header.Empty
	197, // 605: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	198, // 606: header.Proder.ListProductProps:output_type -> header.ProductProps
	111, // 607: header.Proder.ReadOrder:output_type -> header.Order
	111, // 608: header.Proder.CreateOrder:output_type -> header.Order
	111, // 609: header.Proder.UpdateOrder:output_type -> header.Order
	36,  // 610: header.Proder.DeleteOrder:output_type -> header.Empty
	193, // 611: header.Proder.ListOrders:output_type -> header.Orders
	193, // 612: header.Proder.CountOrders:output_type -> header.Orders
	36,  // 613: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	42,  // 614: header.Proder.MakeOrderPayment:output_type -> header.Event
	42,  // 615: header.Proder.DeleteOrderPayment:output_type -> header.Event
	42,  // 616: header.Proder.AddOrderComment:output_type -> header.Event
	42,  // 617: header.Proder.EditOrderComment:output_type -> header.Event
	42,  // 618: header.Proder.DeleteOrderComment:output_type -> header.Event
	199, // 619: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	310, // [310:620] is the sub-list for method output_type
	0,   // [0:310] is the sub-list for method input_type
