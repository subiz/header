...
var file_service_proto_rawDesc = []byte{
	...
	,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*SchedulerTask)(nil),                     // 163: header.SchedulerTask
...
var file_service_proto_depIdxs = []int32{
	...
	129, // 351: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	130, // 352: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	129, // 353: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	130, // 354: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	131, // 355: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 356: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	19,  // 357: header.Holap.UpdateOrder:input_type -> header.Order
	132, // 358: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	133, // 359: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	133, // 360: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	...
	134, // 365: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	135, // 366: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	5,   // 367: header.Proder.ListProductCollections:input_type -> header.Ids
	136, // 368: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	136, // 369: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	137, // 372: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	137, // 373: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	138, // 380: header.Proder.ListOrders:input_type -> header.OrdersRequest
	139, // 381: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	140, // 382: header.Proder.ImportOrders:input_type -> header.Orders
	141, // 383: header.Proder.MakeOrderPayment:input_type -> header.Bill
	142, // 384: header.Proder.DeleteOrderPayment:input_type -> header.Key
	...
	142, // 387: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 388: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 389: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 390: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 391: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 392: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	145, // 393: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	146, // 394: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	147, // 395: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	148, // 396: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	149, // 407: header.Proder.CreatePipeline:input_type -> header.Pipeline
	149, // 408: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	4,   // 409: header.Proder.DeletePipeline:input_type -> header.Id
	5,   // 410: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 411: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	4,   // 412: header.Proder.PreselectPipeline:input_type -> header.Id
	132, // 413: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	...
	151, // 418: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	...
	142, // 425: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	4,   // 426: header.TaskMgr.ListTaskComments:input_type -> header.Id
	152, // 427: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	5,   // 428: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	4,   // 429: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	153, // 430: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	153, // 431: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	4,   // 432: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	38,  // 433: header.CampaignMgr.OnEvent:input_type -> header.Event
	154, // 434: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	4,   // 435: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	155, // 436: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	156, // 437: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	156, // 438: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	156, // 439: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	157, // 440: header.CampaignMgr.ReportOutboundCallByAgents:input_type -> header.OutboundCallReportRequest
	157, // 441: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	158, // 442: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	159, // 443: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	79,  // 444: header.CreditMgr.AddCredit:input_type -> payment.Bill
	4,   // 445: header.FormMgr.ListForms:input_type -> header.Id
	160, // 446: header.FormMgr.CreateForm:input_type -> header.Form
	160, // 447: header.FormMgr.UpdateForm:input_type -> header.Form
	4,   // 448: header.FormMgr.DeleteForm:input_type -> header.Id
	161, // 449: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	162, // 450: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	163, // 451: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	163, // 452: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	...
	51,  // 801: header.Holap.UpdateUser:output_type -> header.Empty
	51,  // 802: header.Holap.UpdateConversation:output_type -> header.Empty
	51,  // 803: header.Holap.OnConversationEvent:output_type -> header.Empty
	247, // 804: header.Holap.ReportUser:output_type -> header.UserMetrics
	248, // 805: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 806: header.Holap.ListUserIds:output_type -> header.Ids
	197, // 807: header.Holap.ListConversationIds:output_type -> header.Conversations
	249, // 808: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 809: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	51,  // 810: header.Holap.UpdateOrder:output_type -> header.Empty
	140, // 811: header.Holap.ReportOrder:output_type -> header.Orders
	250, // 812: header.Holap.ReportCall:output_type -> header.CallMetrics
	197, // 813: header.Holap.ListCallIds:output_type -> header.Conversations
	36,  // 814: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 815: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 816: header.Proder.UpdateProduct:output_type -> header.Product
	51,  // 817: header.Proder.DeleteProduct:output_type -> header.Empty
	251, // 818: header.Proder.ListProducts2:output_type -> header.Products
	252, // 819: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	253, // 820: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 821: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 822: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	51,  // 823: header.Proder.DeleteProductCollection:output_type -> header.Empty
	254, // 824: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 825: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 826: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	51,  // 827: header.Proder.DeleteProductFeed:output_type -> header.Empty
	255, // 828: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	19,  // 829: header.Proder.ReadOrder:output_type -> header.Order
	19,  // 830: header.Proder.CreateOrder:output_type -> header.Order
	19,  // 831: header.Proder.UpdateOrder:output_type -> header.Order
	51,  // 832: header.Proder.DeleteOrder:output_type -> header.Empty
	140, // 833: header.Proder.ListOrders:output_type -> header.Orders
	256, // 834: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 835: header.Proder.ImportOrders:output_type -> header.Orders
	38,  // 836: header.Proder.MakeOrderPayment:output_type -> header.Event
	38,  // 837: header.Proder.DeleteOrderPayment:output_type -> header.Event
	38,  // 838: header.Proder.AddOrderComment:output_type -> header.Event
	38,  // 839: header.Proder.EditOrderComment:output_type -> header.Event
	38,  // 840: header.Proder.DeleteOrderComment:output_type -> header.Event
	257, // 841: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	258, // 842: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 843: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	259, // 844: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	51,  // 845: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	260, // 846: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	51,  // 847: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	51,  // 848: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 849: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	19,  // 850: header.Proder.ShipOrder:output_type -> header.Order
	19,  // 851: header.Proder.UpdateShippingCode:output_type -> header.Order
	19,  // 852: header.Proder.CancelShippingOrder:output_type -> header.Order
	258, // 853: header.Proder.PrintShippingOrders:output_type -> header.File
	51,  // 854: header.Proder.SeenOrder:output_type -> header.Empty
	51,  // 855: header.Proder.FollowOrder:output_type -> header.Empty
	51,  // 856: header.Proder.UnfollowOrder:output_type -> header.Empty
	51,  // 857: header.Proder.TagOrder:output_type -> header.Empty
	51,  // 858: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 859: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 860: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 861: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	51,  // 862: header.Proder.DeletePipeline:output_type -> header.Empty
	261, // 863: header.Proder.ListPipelines:output_type -> header.Pipelines
	51,  // 864: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 865: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 866: header.Proder.ReportOrder:output_type -> header.Orders
	43,  // 867: header.TaskMgr.ReadTask:output_type -> header.Task
	43,  // 868: header.TaskMgr.CreateTask:output_type -> header.Task
	43,  // 869: header.TaskMgr.UpdateTask:output_type -> header.Task
	51,  // 870: header.TaskMgr.DeleteTask:output_type -> header.Empty
	262, // 871: header.TaskMgr.ListTasks:output_type -> header.Tasks
	51,  // 872: header.TaskMgr.SeenTask:output_type -> header.Empty
	51,  // 873: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	51,  // 874: header.TaskMgr.MuteTask:output_type -> header.Empty
	51,  // 875: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	38,  // 876: header.TaskMgr.AddTaskComment:output_type -> header.Event
	38,  // 877: header.TaskMgr.EditTaskComment:output_type -> header.Event
	38,  // 878: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	263, // 879: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	152, // 880: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	264, // 881: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	153, // 882: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	153, // 883: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	153, // 884: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	51,  // 885: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	51,  // 886: header.CampaignMgr.OnEvent:output_type -> header.Empty
	265, // 887: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	266, // 888: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	267, // 889: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	156, // 890: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	156, // 891: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	51,  // 892: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	268, // 893: header.CampaignMgr.ReportOutboundCallByAgents:output_type -> header.OutboundCallByAgentReport
	269, // 894: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReport
	270, // 895: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	271, // 896: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	79,  // 897: header.CreditMgr.AddCredit:output_type -> payment.Bill
	272, // 898: header.FormMgr.ListForms:output_type -> header.Forms
	160, // 899: header.FormMgr.CreateForm:output_type -> header.Form
	160, // 900: header.FormMgr.UpdateForm:output_type -> header.Form
	51,  // 901: header.FormMgr.DeleteForm:output_type -> header.Empty
	273, // 902: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	274, // 903: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	163, // 904: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	224, // 905: header.Scheduler.UnregisterTask:output_type -> header.Response
