...
var file_service_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x1a, 0x1a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x65, 0x64, 0x53, 0x68, 0x69, 0x70, 0x70, 0x69,
	0x6e, 0x67, 0x32, 0xda, 0x0b, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72, 0x12, 0x33,
	...
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x47, 0x0a, 0x15, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74,
...
var file_service_proto_depIdxs = []int32{
	...
	34,  // 106: header.UserMgr.UpsertContactProfiles:input_type -> common.ContactProfile
	...
	34,  // 488: header.UserMgr.UpsertContactProfiles:output_type -> common.ContactProfile
...
type UserMgrClient interface {
	...
	UpsertContactProfiles(ctx context.Context, in *common.ContactProfile, opts ...grpc.CallOption) (*common.ContactProfile, error)
}
...
func (c *userMgrClient) UpsertContactProfiles(ctx context.Context, in *common.ContactProfile, opts ...grpc.CallOption) (*common.ContactProfile, error) {
	out := new(common.ContactProfile)
	err := c.cc.Invoke(ctx, "/header.UserMgr/UpsertContactProfiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserMgrServer interface {
	...
	UpsertContactProfiles(context.Context, *common.ContactProfile) (*common.ContactProfile, error)
}
...
func (*UnimplementedUserMgrServer) UpsertContactProfiles(context.Context, *common.ContactProfile) (*common.ContactProfile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpsertContactProfiles not implemented")
}
...
func _UserMgr_UpsertContactProfiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(common.ContactProfile)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserMgrServer).UpsertContactProfiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.UserMgr/UpsertContactProfiles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserMgrServer).UpsertContactProfiles(ctx, req.(*common.ContactProfile))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UserMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpsertContactProfiles",
			Handler:    _UserMgr_UpsertContactProfiles_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service.proto",
