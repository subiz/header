...
var file_service_proto_rawDesc = []byte{
	...
	0x32, 0xb2, 0x13, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x0b, 0x52,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x4d, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x74, 0x61, 0x67, 0x65, 0x12, 0x1a, 0x2e,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65,
	0x6c, 0x69, 0x6e, 0x65, 0x53, 0x74, 0x61, 0x67, 0x65, 0x1a, 0x1a, 0x2e, 0x68, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65,
	0x53, 0x74, 0x61, 0x67, 0x65, 0x32, 0xa3, 0x05, 0x0a, 0x06, 0x41, 0x70, 0x69, 0x65, 0x63, 0x65,
...
var file_service_proto_depIdxs = []int32{
	...
	130, // 339: header.Proder.UpdatePipelineStage:input_type -> header.OrderPipelineStage
	...
	130, // 693: header.Proder.UpdatePipelineStage:output_type -> header.OrderPipelineStage
...
type ProderClient interface {
	...
	UpdatePipelineStage(ctx context.Context, in *OrderPipelineStage, opts ...grpc.CallOption) (*OrderPipelineStage, error)
}
...
func (c *proderClient) UpdatePipelineStage(ctx context.Context, in *OrderPipelineStage, opts ...grpc.CallOption) (*OrderPipelineStage, error) {
	out := new(OrderPipelineStage)
	err := c.cc.Invoke(ctx, "/header.Proder/UpdatePipelineStage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProderServer interface {
	...
	// used to update tasks and agent id
	UpdatePipelineStage(context.Context, *OrderPipelineStage) (*OrderPipelineStage, error)
}
...
func (*UnimplementedProderServer) UpdatePipelineStage(context.Context, *OrderPipelineStage) (*OrderPipelineStage, error) {
...
func _Proder_UpdatePipelineStage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderPipelineStage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProderServer).UpdatePipelineStage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.Proder/UpdatePipelineStage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProderServer).UpdatePipelineStage(ctx, req.(*OrderPipelineStage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Proder_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Proder_UpdatePipelineStage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service.proto",
