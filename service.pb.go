...
var file_service_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xde, 0x03, 0x0a,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xac, 0x03,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xb1, 0x07, 0x0a,
	...
	0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x32, 0xa2, 0x06, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61, 0x70, 0x12, 0x29, 0x0a,
	...
	0x61, 0x6c, 0x6c, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x15, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0xd2, 0x16, 0x0a, 0x06, 0x50, 0x72, 0x6f,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0xd3, 0x04,
	...
	0x6f, 0x6e, 0x32, 0x89, 0x07, 0x0a, 0x0b, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x4d,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x64, 0x4e,
	0x65, 0x78, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x49, 0x64, 0x1a, 0x19, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x75, 0x74,
	0x62, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x61, 0x6c, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x32, 0xbe,
...
var file_service_proto_depIdxs = []int32{
	...
	156, // 439: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	4,   // 440: header.CampaignMgr.FindNextCall:input_type -> header.Id
	...
	100, // 579: header.UserMgr.ListUserEvents:output_type -> header.Events
	...
	100, // 629: header.ConversationMgr.ListEvents:output_type -> header.Events
	...
	211, // 682: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	212, // 683: header.PaymentMgr.GetSub:output_type -> header.AccSub
	...
	214, // 691: header.PaymentMgr.Pay:output_type -> payment.Bill
	...
	215, // 694: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	216, // 697: header.PaymentMgr.ListComments:output_type -> payment.Comments
	87,  // 698: header.PaymentMgr.AddComment:output_type -> payment.Comment
	217, // 699: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	214, // 703: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	218, // 704: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	219, // 709: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	220, // 713: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	95,  // 714: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	221, // 715: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	222, // 716: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	223, // 717: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	224, // 722: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	225, // 723: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	226, // 729: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	227, // 733: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	...
	228, // 739: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	229, // 740: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	...
	227, // 743: header.MailkonService.TrackLink:output_type -> header.Response
	227, // 744: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	105, // 745: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	227, // 746: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	227, // 747: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	227, // 748: header.MailkonService.BlockEmail:output_type -> header.Response
	227, // 749: header.MailkonService.UnblockEmail:output_type -> header.Response
	...
	230, // 752: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	231, // 753: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	232, // 757: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	233, // 758: header.WidgetService.ListConversions:output_type -> header.Conversions
	234, // 759: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	113, // 760: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	235, // 761: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	51,  // 762: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	236, // 763: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	236, // 769: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	51,  // 770: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	237, // 771: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	235, // 772: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	238, // 773: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	239, // 774: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	240, // 775: header.Bizbot.ListBots:output_type -> header.Bots
	...
	241, // 785: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	242, // 786: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	243, // 787: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	244, // 788: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	123, // 789: header.Sendback.CreateWebhook:output_type -> header.Webhook
	245, // 790: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	51,  // 791: header.Sendback.DeleteWebhook:output_type -> header.Empty
	246, // 792: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	247, // 796: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	248, // 797: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	51,  // 798: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	51,  // 799: header.Notibox.SendNoti:output_type -> header.Empty
	249, // 800: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	250, // 806: header.Holap.ReportUser:output_type -> header.UserMetrics
	251, // 807: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	...
	252, // 810: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	...
	253, // 814: header.Holap.ReportCall:output_type -> header.CallMetrics
	...
	254, // 820: header.Proder.ListProducts2:output_type -> header.Products
	255, // 821: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	256, // 822: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	...
	257, // 826: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	...
	258, // 830: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	...
	259, // 836: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	...
	260, // 843: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	261, // 844: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 845: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	262, // 846: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	51,  // 847: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	263, // 848: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	261, // 855: header.Proder.PrintShippingOrders:output_type -> header.File
	...
	264, // 865: header.Proder.ListPipelines:output_type -> header.Pipelines
	...
	265, // 873: header.TaskMgr.ListTasks:output_type -> header.Tasks
	...
	266, // 881: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	151, // 882: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	267, // 883: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	...
	268, // 889: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	269, // 890: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	270, // 891: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	...
	271, // 895: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	155, // 896: header.CampaignMgr.FindNextCall:output_type -> header.OutboundCallEntry
	...
	227, // 900: header.CreditMgr.ListCredits:output_type -> header.Response
	227, // 901: header.CreditMgr.AddCredit:output_type -> header.Response
	227, // 902: header.CreditMgr.DeleteCredit:output_type -> header.Response
	227, // 903: header.CreditMgr.UpdateCredit:output_type -> header.Response
	...
	227, // 911: header.Scheduler.UnregisterTask:output_type -> header.Response
