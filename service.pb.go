...
var file_service_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x73, 0x74, 0x73, 0x32, 0x94, 0x0c, 0x0a, 0x0d, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x65, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x32, 0xa4, 0x05, 0x0a,
	...
	0x2e, 0x57, 0x65, 0x62, 0x70, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x42, 0x19,
...
var file_service_proto_depIdxs = []int32{
	...
	1,   // 191: header.Bizbot.ListBots:input_type -> header.Id
	1,   // 192: header.Bizbot.GetBot:input_type -> header.Id
	89,  // 193: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	89,  // 194: header.Bizbot.CreateBot:input_type -> header.Bot
	89,  // 195: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 196: header.Bizbot.DeleteBot:input_type -> header.Id
	90,  // 197: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	90,  // 198: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	90,  // 199: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	90,  // 200: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	91,  // 201: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	92,  // 202: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	89,  // 203: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 204: header.Bizbot.ListBotRevisions:input_type -> header.Id
	93,  // 205: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 206: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 207: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 208: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 209: header.Sendback.ReadWebhook:input_type -> header.Id
	93,  // 210: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 211: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	94,  // 212: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	95,  // 213: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	35,  // 214: header.Sendback.SendWebhookEvent:input_type -> header.Event
	96,  // 215: header.Notibox.Send:input_type -> header.Notification
	1,   // 216: header.Notibox.MarkRead:input_type -> header.Id
	97,  // 217: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	98,  // 218: header.Notibox.GetCompactedNoti:input_type -> header.CompactedNotiRequest
	99,  // 219: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 220: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 221: header.Watchhttp.ListWebpages:input_type -> header.Id
	99,  // 222: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 223: header.Watchhttp.ReadWebpage:input_type -> header.Id
	100, // 224: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	101, // 225: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	102, // 226: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	102, // 227: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	...
	103, // 245: header.AccountMgr.ListAgents:output_type -> account.Agents
	25,  // 246: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	104, // 247: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	...
	105, // 251: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	106, // 254: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	25,  // 255: header.AccountMgr.LogoutSession:output_type -> header.Empty
	107, // 256: header.UserMgr.SearchUsers:output_type -> header.Users
	108, // 257: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	108, // 258: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	...
	109, // 263: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	107, // 264: header.UserMgr.MatchUsers:output_type -> header.Users
	110, // 265: header.LiveMgr.SearchLocations:output_type -> header.Locations
	107, // 266: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	111, // 267: header.LiveMgr.TopEvents:output_type -> header.Events
	112, // 268: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	113, // 269: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	114, // 270: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	115, // 271: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	116, // 272: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	117, // 273: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	118, // 277: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	...
	119, // 282: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	120, // 286: header.ConversationReporter.CountConversationsByTags:output_type -> conversation.CountByTagsResponse
	121, // 287: header.ConversationReporter.GetAvgResponseTimes:output_type -> conversation.AvgResponseTimeResponse
	122, // 288: header.ConversationReporter.GetTotalConversation:output_type -> conversation.TotalConversationResponse
	123, // 289: header.ConversationReporter.ReportConversations:output_type -> conversation.ReportResponse
	123, // 290: header.ConversationReporter.ReportConversations2:output_type -> conversation.ReportResponse
	123, // 291: header.ConversationReporter.ReportAvailibilities:output_type -> conversation.ReportResponse
	...
	124, // 296: header.RuleMgr.ListRules:output_type -> header.Route
	125, // 297: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	126, // 303: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	126, // 304: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	126, // 311: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	127, // 312: header.ConversationMgr.SearchConversation:output_type -> conversation.SearchConversationResponse
	128, // 313: header.ConversationMgr.ListConversations2:output_type -> conversation.ConversationListResponse
	...
	129, // 320: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	...
	130, // 325: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	131, // 330: header.TagMgr.ListTags:output_type -> header.Tags
	47,  // 331: header.TagMgr.GetTag:output_type -> header.Tag
	25,  // 332: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	132, // 333: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	48,  // 334: header.IntegrationMgr.Integrate:output_type -> header.Integration
	111, // 335: header.EventMgr.SearchEvents:output_type -> header.Events
	...
	111, // 339: header.ConversationEventReader.ListEvents:output_type -> header.Events
	111, // 340: header.ConversationEventReader.SearchEvents:output_type -> header.Events
	133, // 341: header.FileMgr.Presign:output_type -> header.PresignResult
	134, // 342: header.FileMgr.Read:output_type -> header.File
	134, // 343: header.FileMgr.Uploaded:output_type -> header.File
	...
	135, // 351: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	136, // 358: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	137, // 362: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	138, // 365: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 366: header.PaymentMgr.AddComment:output_type -> payment.Comment
	139, // 367: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	140, // 372: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	141, // 377: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	142, // 381: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 382: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	143, // 383: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	144, // 384: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	145, // 385: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	146, // 391: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	147, // 392: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 393: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 394: header.WidgetService.Update:output_type -> header.WidgetSetting
	148, // 395: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	80,  // 396: header.WidgetService.ReadCampaign:output_type -> header.Campaign
	149, // 397: header.WidgetService.ListCampaigns:output_type -> header.Campaigns
	80,  // 398: header.WidgetService.CreateCampaign:output_type -> header.Campaign
	80,  // 399: header.WidgetService.UpdateCampaign:output_type -> header.Campaign
	25,  // 400: header.WidgetService.DeleteCampaign:output_type -> header.Empty
	81,  // 401: header.WidgetService.SubmitImpression:output_type -> header.Impression
	82,  // 402: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	83,  // 403: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	150, // 404: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	151, // 405: header.WidgetService.ListConversions:output_type -> header.Conversions
	152, // 406: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	86,  // 407: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	153, // 408: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	25,  // 409: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	154, // 410: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	87,  // 411: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	87,  // 412: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	25,  // 413: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	87,  // 414: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	154, // 415: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	25,  // 416: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	155, // 417: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	153, // 418: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	156, // 419: header.Bizbot.ListBots:output_type -> header.Bots
	89,  // 420: header.Bizbot.GetBot:output_type -> header.Bot
	89,  // 421: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	89,  // 422: header.Bizbot.CreateBot:output_type -> header.Bot
	89,  // 423: header.Bizbot.UpdateBot:output_type -> header.Bot
	25,  // 424: header.Bizbot.DeleteBot:output_type -> header.Empty
	25,  // 425: header.Bizbot.OnEvent:output_type -> header.Empty
	25,  // 426: header.Bizbot.StartBot:output_type -> header.Empty
	25,  // 427: header.Bizbot.StopBot:output_type -> header.Empty
	25,  // 428: header.Bizbot.TryAction:output_type -> header.Empty
	157, // 429: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	158, // 430: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	89,  // 431: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	156, // 432: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	93,  // 433: header.Sendback.CreateWebhook:output_type -> header.Webhook
	159, // 434: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	25,  // 435: header.Sendback.DeleteWebhook:output_type -> header.Empty
	160, // 436: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	93,  // 437: header.Sendback.ReadWebhook:output_type -> header.Webhook
	93,  // 438: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	93,  // 439: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	161, // 440: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	162, // 441: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	25,  // 442: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	25,  // 443: header.Notibox.Send:output_type -> header.Empty
	25,  // 444: header.Notibox.MarkRead:output_type -> header.Empty
	163, // 445: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	164, // 446: header.Notibox.GetCompactedNoti:output_type -> header.CompactedNoti
	99,  // 447: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	25,  // 448: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	165, // 449: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	99,  // 450: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	99,  // 451: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	166, // 452: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	167, // 453: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	168, // 454: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	166, // 455: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
