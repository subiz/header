...
var file_service_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x32, 0xc0, 0x03, 0x0a, 0x07, 0x43, 0x61, 0x6d, 0x70, 0x69, 0x6f, 0x6e, 0x12,
	...
	,
	...
	0x12, 0x2f, 0x0a, 0x07, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x75, 0x12, 0x11, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x75, 0x55, 0x73, 0x65, 0x64, 0x4c, 0x6f, 0x67, 0x1a, 0x11,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x75, 0x55, 0x73, 0x65, 0x64, 0x4c, 0x6f,
	0x67, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_service_proto_depIdxs = []int32{
	...
	4,   // 453: header.Hodor.ReadSu:input_type -> header.Id
	165, // 454: header.Hodor.ChangeSuLimit:input_type -> header.SuLimitChangeRequest
	166, // 455: header.Hodor.RequestSu:input_type -> header.SuUsedLog
	166, // 456: header.Hodor.CountSu:input_type -> header.SuUsedLog
	167, // 457: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	54,  // 458: header.Search.Index:output_type -> header.Empty
	168, // 459: header.Search.Search:output_type -> header.DocSearchResponse
	54,  // 460: header.Search.AddOwner:output_type -> header.Empty
	169, // 461: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 462: header.Map.LookupAddress:output_type -> header.Address
	170, // 463: header.Map.PredictAddress:output_type -> header.Addresses
	170, // 464: header.Map.ListDistricts:output_type -> header.Addresses
	170, // 465: header.Map.ListProvinces:output_type -> header.Addresses
	170, // 466: header.Map.ListWards:output_type -> header.Addresses
	170, // 467: header.Map.ListStreets:output_type -> header.Addresses
	170, // 468: header.Map.ListAddresses:output_type -> header.Addresses
	...
	171, // 487: header.AccountMgr.ListAgents:output_type -> account.Agents
	54,  // 488: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	172, // 489: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 490: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	173, // 491: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	174, // 494: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	174, // 495: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	175, // 498: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	176, // 501: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	177, // 504: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	54,  // 505: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	170, // 506: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	178, // 510: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	179, // 514: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	179, // 515: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	180, // 520: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	181, // 523: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	182, // 528: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	183, // 533: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	...
	184, // 537: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	...
	185, // 557: header.UserMgr.ListViews:output_type -> header.UserViews
	...
	186, // 562: header.UserMgr.ListSegments:output_type -> header.Segments
	...
	187, // 571: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	188, // 581: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	...
	189, // 584: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	...
	190, // 591: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	191, // 592: header.UserMgr.ListEventTypes:output_type -> header.EventTypes
	...
	192, // 595: header.LiveMgr.SearchLocations:output_type -> header.Locations
	...
	193, // 598: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	194, // 599: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	195, // 600: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	196, // 601: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	197, // 602: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	198, // 603: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	199, // 607: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	200, // 610: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	201, // 615: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	201, // 616: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	201, // 623: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	202, // 638: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	203, // 645: header.ConversationMgr.ListRules:output_type -> header.Route
	204, // 646: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	205, // 650: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	206, // 656: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	207, // 659: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	54,  // 660: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	208, // 661: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	209, // 664: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	210, // 670: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	211, // 676: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	212, // 677: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	213, // 681: header.TagMgr.ListTags:output_type -> header.Tags
	78,  // 682: header.TagMgr.GetTag:output_type -> header.Tag
	214, // 683: header.FileMgr.Presign:output_type -> header.PresignResult
	...
	215, // 694: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	216, // 701: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	217, // 705: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	218, // 708: header.PaymentMgr.ListComments:output_type -> payment.Comments
	95,  // 709: header.PaymentMgr.AddComment:output_type -> payment.Comment
	219, // 710: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	220, // 715: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	221, // 720: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	222, // 724: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	103, // 725: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	223, // 726: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	224, // 727: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	225, // 728: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	226, // 733: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	227, // 734: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	228, // 740: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	229, // 747: header.MailkonService.VerifySenderDomain:output_type -> header.VerificationResult
	230, // 748: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	...
	231, // 753: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	232, // 754: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	233, // 758: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	234, // 759: header.WidgetService.ListConversions:output_type -> header.Conversions
	235, // 760: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	118, // 761: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	236, // 762: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	54,  // 763: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	237, // 764: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	237, // 770: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	54,  // 771: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	238, // 772: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	236, // 773: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	239, // 774: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	240, // 775: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	241, // 776: header.Bizbot.ListBots:output_type -> header.Bots
	...
	242, // 786: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	243, // 787: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	244, // 788: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	245, // 789: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	128, // 790: header.Sendback.CreateWebhook:output_type -> header.Webhook
	246, // 791: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	54,  // 792: header.Sendback.DeleteWebhook:output_type -> header.Empty
	247, // 793: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	248, // 797: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	249, // 798: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	54,  // 799: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	54,  // 800: header.Notibox.SendNoti:output_type -> header.Empty
	250, // 801: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	251, // 806: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	...
	252, // 809: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	253, // 810: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	254, // 811: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	252, // 812: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	...
	255, // 819: header.Holap.ReportUser:output_type -> header.UserMetrics
	256, // 820: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 821: header.Holap.ListUserIds:output_type -> header.Ids
	201, // 822: header.Holap.ListConversationIds:output_type -> header.Conversations
	257, // 823: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 824: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	258, // 825: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	54,  // 826: header.Holap.UpdateOrder:output_type -> header.Empty
	150, // 827: header.Holap.ReportOrder:output_type -> header.Orders
	259, // 828: header.Holap.ReportCall:output_type -> header.CallMetrics
	201, // 829: header.Holap.ListCallIds:output_type -> header.Conversations
	...
	263, // 848: header.Proder.ListProductProps:output_type -> header.ProductProps
	...
	264, // 863: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	82,  // 864: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 865: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	265, // 866: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	54,  // 867: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	266, // 868: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	267, // 885: header.Apiece.ListTasks:output_type -> header.Tasks
	...
	268, // 893: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	...
	269, // 898: header.Apiece.ListPipelines:output_type -> header.Pipelines
	...
	270, // 902: header.Campion.ListCampaigns:output_type -> header.Campaigns
	...
	271, // 908: header.Campion.ListCampaignSendMessages:output_type -> header.CampaignSendMessages
	272, // 909: header.Campion.ReportCampaign:output_type -> header.CampaignMetrics
	273, // 910: header.Hodor.ReadSu:output_type -> header.Su
	273, // 911: header.Hodor.ChangeSuLimit:output_type -> header.Su
	166, // 912: header.Hodor.RequestSu:output_type -> header.SuUsedLog
	166, // 913: header.Hodor.CountSu:output_type -> header.SuUsedLog
