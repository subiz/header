...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x32, 0xa6, 0x0a, 0x0a, 0x0f, 0x43, 0x6f, 0x6e,
	...
	0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0xc9, 0x05, 0x0a, 0x05, 0x48, 0x6f,
	...
	0x72, 0x2e, 0x49, 0x64, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_service_proto_depIdxs = []int32{
	...
	39,  // 86: header.ConversationMgr.SeenConversation:input_type -> header.ConversationMember
	...
	19,  // 91: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	...
	39,  // 94: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	39,  // 95: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	...
	52,  // 124: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	53,  // 125: header.ConversationEventReader.SearchEvents:input_type -> header.SearchMessageRequest
	54,  // 126: header.FileMgr.Presign:input_type -> header.FileHeader
	55,  // 127: header.FileMgr.Read:input_type -> header.FileRequest
	55,  // 128: header.FileMgr.Uploaded:input_type -> header.FileRequest
	1,   // 129: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	56,  // 130: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	57,  // 131: header.Noti5Service.Noti:input_type -> noti5.PushNoti
	58,  // 132: header.Noti5Service.AddToken:input_type -> noti5.Token
	58,  // 133: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	58,  // 134: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	59,  // 135: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	60,  // 136: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	61,  // 137: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	61,  // 138: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 139: header.PaymentMgr.GetSubscription:input_type -> header.Id
	62,  // 140: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	62,  // 141: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	63,  // 144: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	64,  // 145: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	64,  // 146: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	65,  // 147: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	61,  // 148: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	66,  // 149: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	67,  // 150: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	68,  // 151: header.PaymentMgr.AddComment:input_type -> payment.Comment
	32,  // 152: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 153: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	64,  // 154: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	69,  // 155: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	63,  // 156: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	70,  // 157: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	71,  // 158: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	72,  // 159: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	73,  // 160: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	73,  // 161: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	74,  // 162: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 163: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	75,  // 164: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 165: header.PaymentMgr.GetReferral:input_type -> header.Id
	32,  // 166: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	76,  // 167: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	77,  // 171: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	78,  // 172: header.Pubsub.Publish:input_type -> header.PublishMessage
	78,  // 173: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 174: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	79,  // 175: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	80,  // 179: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	81,  // 182: header.WidgetService.SubmitImpression:input_type -> header.Impression
	82,  // 183: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	83,  // 184: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	84,  // 185: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	85,  // 186: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	85,  // 187: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	86,  // 188: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 189: header.WidgetService.ListUploadedImage:input_type -> header.Id
	86,  // 190: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 191: header.WidgetService.ListWebPlugins:input_type -> header.Id
	87,  // 192: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	87,  // 193: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	87,  // 194: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 195: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	87,  // 196: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	88,  // 199: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	89,  // 205: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	89,  // 206: header.Bizbot.CreateBot:input_type -> header.Bot
	89,  // 207: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 208: header.Bizbot.DeleteBot:input_type -> header.Id
	90,  // 209: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	90,  // 210: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	90,  // 211: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	90,  // 212: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	91,  // 213: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	92,  // 214: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	89,  // 215: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 216: header.Bizbot.ListBotRevisions:input_type -> header.Id
	93,  // 217: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	93,  // 222: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 223: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	94,  // 224: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	95,  // 225: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	38,  // 226: header.Sendback.SendWebhookEvent:input_type -> header.Event
	96,  // 227: header.Notibox.Send:input_type -> header.Notification
	1,   // 228: header.Notibox.MarkRead:input_type -> header.Id
	97,  // 229: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	98,  // 230: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	99,  // 231: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 232: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 233: header.Watchhttp.ListWebpages:input_type -> header.Id
	99,  // 234: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 235: header.Watchhttp.ReadWebpage:input_type -> header.Id
	100, // 236: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	101, // 237: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	102, // 238: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	102, // 239: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	4,   // 240: header.Holap.AppendAgentSet:input_type -> account.Agent
	48,  // 241: header.Holap.AppendTagSet:input_type -> header.Tag
	17,  // 242: header.Holap.UpdateUser:input_type -> header.User
	43,  // 243: header.Holap.UpdateConversation:input_type -> header.Conversation
	38,  // 244: header.Holap.OnConversationEvent:input_type -> header.Event
	103, // 245: header.Holap.FreeAccount:input_type -> header.AccountImage
	104, // 246: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	105, // 247: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	104, // 248: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	105, // 249: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	106, // 250: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	19,  // 251: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	...
	32,  // 255: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	32,  // 259: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	107, // 269: header.AccountMgr.ListAgents:output_type -> account.Agents
	32,  // 270: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	108, // 271: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	32,  // 272: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	32,  // 273: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 274: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	109, // 275: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	110, // 278: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	32,  // 279: header.AccountMgr.LogoutSession:output_type -> header.Empty
	111, // 280: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	112, // 283: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	113, // 284: header.UserMgr.SearchUsers:output_type -> header.Users
	114, // 285: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	114, // 286: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	...
	115, // 292: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	113, // 293: header.UserMgr.MatchUsers:output_type -> header.Users
	20,  // 294: header.UserMgr.UpsertView:output_type -> header.UserView
	32,  // 295: header.UserMgr.DeleteView:output_type -> header.Empty
	20,  // 296: header.UserMgr.GetView:output_type -> header.UserView
	116, // 297: header.UserMgr.ListViews:output_type -> header.UserViews
	113, // 298: header.UserMgr.ListUserInViews:output_type -> header.Users
	22,  // 299: header.UserMgr.UpsertLabel:output_type -> header.Label
	32,  // 300: header.UserMgr.DeleteLabel:output_type -> header.Empty
	117, // 301: header.UserMgr.ListLabels:output_type -> header.Labels
	22,  // 302: header.UserMgr.GetLabel:output_type -> header.Label
	32,  // 303: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	32,  // 304: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	32,  // 305: header.UserMgr.AddUserLabel:output_type -> header.Empty
	32,  // 306: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	32,  // 307: header.UserPersist.UpdateUser:output_type -> header.Empty
	113, // 308: header.UserPersist.FilterUsers:output_type -> header.Users
	118, // 309: header.LiveMgr.SearchLocations:output_type -> header.Locations
	113, // 310: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	119, // 311: header.LiveMgr.TopEvents:output_type -> header.Events
	120, // 312: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	121, // 313: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	122, // 314: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	123, // 315: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	124, // 316: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	125, // 317: header.NoteMgr.ListNotes:output_type -> header.Notes
	29,  // 318: header.NoteMgr.AddNote:output_type -> header.Note
	29,  // 319: header.NoteMgr.UpdateNote:output_type -> header.Note
	32,  // 320: header.NoteMgr.DeleteNote:output_type -> header.Empty
	126, // 321: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	31,  // 322: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	32,  // 323: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	31,  // 324: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	31,  // 325: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	127, // 326: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	33,  // 327: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	33,  // 328: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	32,  // 329: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	128, // 330: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	36,  // 331: header.RuleMgr.UpdateRule:output_type -> header.Rule
	36,  // 332: header.RuleMgr.CreateRule:output_type -> header.Rule
	32,  // 333: header.RuleMgr.DeleteRule:output_type -> header.Empty
	36,  // 334: header.RuleMgr.ReadRule:output_type -> header.Rule
	129, // 335: header.RuleMgr.ListRules:output_type -> header.Route
	130, // 336: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 337: header.ConversationMgr.PongMessage:output_type -> header.Event
	43,  // 338: header.ConversationMgr.SeenConversation:output_type -> header.Conversation
	43,  // 339: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	43,  // 340: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	43,  // 341: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	131, // 342: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	131, // 343: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	32,  // 344: header.ConversationMgr.TagConversation:output_type -> header.Empty
	32,  // 345: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	32,  // 346: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	32,  // 347: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	32,  // 348: header.ConversationMgr.Typing:output_type -> header.Empty
	43,  // 349: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	131, // 350: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	32,  // 351: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	32,  // 352: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	32,  // 353: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	44,  // 354: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	44,  // 355: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 356: header.ConversationMgr.TerminateBot:output_type -> header.Event
	132, // 357: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 358: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	46,  // 359: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	32,  // 360: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	46,  // 361: header.TemplateMgr.GetTemplate:output_type -> header.Template
	133, // 362: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	32,  // 363: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	48,  // 364: header.TagMgr.CreateTag:output_type -> header.Tag
	48,  // 365: header.TagMgr.UpdateTag:output_type -> header.Tag
	32,  // 366: header.TagMgr.DeleteTag:output_type -> header.Empty
	134, // 367: header.TagMgr.ListTags:output_type -> header.Tags
	48,  // 368: header.TagMgr.GetTag:output_type -> header.Tag
	32,  // 369: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	135, // 370: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	49,  // 371: header.IntegrationMgr.Integrate:output_type -> header.Integration
	119, // 372: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 373: header.EventMgr.CreateEvent:output_type -> header.Event
	38,  // 374: header.ConversationEventReader.SendMessage:output_type -> header.Event
	38,  // 375: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	119, // 376: header.ConversationEventReader.ListEvents:output_type -> header.Events
	119, // 377: header.ConversationEventReader.SearchEvents:output_type -> header.Events
	136, // 378: header.FileMgr.Presign:output_type -> header.PresignResult
	137, // 379: header.FileMgr.Read:output_type -> header.File
	137, // 380: header.FileMgr.Uploaded:output_type -> header.File
	56,  // 381: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	56,  // 382: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	32,  // 383: header.Noti5Service.Noti:output_type -> header.Empty
	32,  // 384: header.Noti5Service.AddToken:output_type -> header.Empty
	32,  // 385: header.Noti5Service.RemoveToken:output_type -> header.Empty
	32,  // 386: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	59,  // 387: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	138, // 388: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	64,  // 389: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	61,  // 390: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	61,  // 391: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	62,  // 392: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	62,  // 393: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	32,  // 394: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	139, // 395: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	59,  // 396: header.PaymentMgr.Pay:output_type -> payment.Bill
	64,  // 397: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	64,  // 398: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	140, // 399: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	64,  // 400: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	64,  // 401: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	141, // 402: header.PaymentMgr.ListComments:output_type -> payment.Comments
	68,  // 403: header.PaymentMgr.AddComment:output_type -> payment.Comment
	142, // 404: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	72,  // 405: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	72,  // 406: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	69,  // 407: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	59,  // 408: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	143, // 409: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	71,  // 410: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	71,  // 411: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	32,  // 412: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	71,  // 413: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	144, // 414: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	32,  // 415: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	76,  // 416: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	76,  // 417: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	145, // 418: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	76,  // 419: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	146, // 420: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	147, // 421: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	148, // 422: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	32,  // 423: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	32,  // 424: header.Pubsub.Publish:output_type -> header.Empty
	32,  // 425: header.Realtime.ShardSend:output_type -> header.Empty
	79,  // 426: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	79,  // 427: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	149, // 428: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	150, // 429: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	80,  // 430: header.WidgetService.Read:output_type -> header.WidgetSetting
	80,  // 431: header.WidgetService.Update:output_type -> header.WidgetSetting
	151, // 432: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	152, // 433: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	81,  // 434: header.WidgetService.SubmitImpression:output_type -> header.Impression
	82,  // 435: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	83,  // 436: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	153, // 437: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	154, // 438: header.WidgetService.ListConversions:output_type -> header.Conversions
	155, // 439: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	86,  // 440: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	156, // 441: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	32,  // 442: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	157, // 443: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	87,  // 444: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	87,  // 445: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	87,  // 446: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	32,  // 447: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	87,  // 448: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	157, // 449: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	32,  // 450: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	158, // 451: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	156, // 452: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	159, // 453: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	160, // 454: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	161, // 455: header.Bizbot.ListBots:output_type -> header.Bots
	89,  // 456: header.Bizbot.GetBot:output_type -> header.Bot
	89,  // 457: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	89,  // 458: header.Bizbot.CreateBot:output_type -> header.Bot
	89,  // 459: header.Bizbot.UpdateBot:output_type -> header.Bot
	32,  // 460: header.Bizbot.DeleteBot:output_type -> header.Empty
	32,  // 461: header.Bizbot.OnEvent:output_type -> header.Empty
	32,  // 462: header.Bizbot.StartBot:output_type -> header.Empty
	32,  // 463: header.Bizbot.StopBot:output_type -> header.Empty
	32,  // 464: header.Bizbot.TryAction:output_type -> header.Empty
	162, // 465: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	163, // 466: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	89,  // 467: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	161, // 468: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	93,  // 469: header.Sendback.CreateWebhook:output_type -> header.Webhook
	164, // 470: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	32,  // 471: header.Sendback.DeleteWebhook:output_type -> header.Empty
	165, // 472: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	93,  // 473: header.Sendback.ReadWebhook:output_type -> header.Webhook
	93,  // 474: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	93,  // 475: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	166, // 476: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	167, // 477: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	32,  // 478: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	32,  // 479: header.Notibox.Send:output_type -> header.Empty
	32,  // 480: header.Notibox.MarkRead:output_type -> header.Empty
	32,  // 481: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	168, // 482: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	99,  // 483: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	32,  // 484: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	169, // 485: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	99,  // 486: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	99,  // 487: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	170, // 488: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	171, // 489: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	172, // 490: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	170, // 491: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	32,  // 492: header.Holap.AppendAgentSet:output_type -> header.Empty
	32,  // 493: header.Holap.AppendTagSet:output_type -> header.Empty
	32,  // 494: header.Holap.UpdateUser:output_type -> header.Empty
	32,  // 495: header.Holap.UpdateConversation:output_type -> header.Empty
	32,  // 496: header.Holap.OnConversationEvent:output_type -> header.Empty
	32,  // 497: header.Holap.FreeAccount:output_type -> header.Empty
	173, // 498: header.Holap.ReportUser:output_type -> header.UserMetrics
	174, // 499: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 500: header.Holap.ListUserIds:output_type -> header.Ids
	131, // 501: header.Holap.ListConversationIds:output_type -> header.Conversations
	175, // 502: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 503: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
