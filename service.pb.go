...
var file_service_proto_rawDesc = []byte{
	...
	,
	...
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8c,
	...
	0x32, 0x95, 0x19, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
...
var file_service_proto_depIdxs = []int32{
	...
	27,  // 85: header.UserMgr.UpdateUser2:input_type -> header.User
	27,  // 86: header.UserMgr.UpdateUser:input_type -> header.User
	27,  // 87: header.UserMgr.TryUpdateUser:input_type -> header.User
	...
	28,  // 96: header.UserMgr.UpdateView:input_type -> header.UserView
	28,  // 97: header.UserMgr.CreateView:input_type -> header.UserView
	...
	29,  // 101: header.UserMgr.UpdateSegment:input_type -> header.Segment
	29,  // 102: header.UserMgr.CreateSegment:input_type -> header.Segment
	...
	30,  // 106: header.UserMgr.ListUsers:input_type -> header.ListUserRequest
	31,  // 107: header.UserMgr.AddToSegment:input_type -> header.SegmentUsers
	31,  // 108: header.UserMgr.RemoveFromSegment:input_type -> header.SegmentUsers
	32,  // 109: header.UserMgr.UpdateUserCampaignStatus:input_type -> header.UserCampaign
	33,  // 110: header.UserMgr.UpsertLabel:input_type -> header.Label
	...
	34,  // 114: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	34,  // 115: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	34,  // 116: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	34,  // 117: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	34,  // 118: header.UserMgr.AddLeadConversionBy:input_type -> header.UserRequest
	...
	28,  // 124: header.UserMgr.ListLeads:input_type -> header.UserView
	35,  // 125: header.UserMgr.SuggestLeadField:input_type -> header.SuggestLeadFieldRequest
	36,  // 126: header.UserMgr.LinkProductUrl:input_type -> header.Product
	37,  // 127: header.UserMgr.ListUserEvents:input_type -> header.ListUserEventsRequest
	38,  // 128: header.UserMgr.CreateUserEvent:input_type -> header.Event
	39,  // 129: header.UserMgr.FillDevice:input_type -> common.Device
	40,  // 130: header.UserMgr.ImportLead:input_type -> header.ImportLeadRequest
	41,  // 131: header.UserMgr.LinkTask:input_type -> header.Task
	42,  // 132: header.UserMgr.CountUserProfiles:input_type -> header.UsersRequest
	42,  // 133: header.UserMgr.ListUserIds:input_type -> header.UsersRequest
	42,  // 134: header.UserMgr.ListUserIdWithPhones:input_type -> header.UsersRequest
	4,   // 135: header.UserMgr.ListRelatedUsers:input_type -> header.Id
	43,  // 136: header.UserMgr.RemoveRelatedUsers:input_type -> header.RelatedUser
	2,   // 137: header.UserMgr.SearchUsers:input_type -> header.DocSearchRequest
	...
	50,  // 469: header.DocSearch.IndexUser:output_type -> header.Empty
	167, // 470: header.DocSearch.Search:output_type -> header.DocPartSearchResponse
	166, // 471: header.DocSearch.SearchTest:output_type -> header.DocSearchResponse
	168, // 472: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	17,  // 473: header.Map.LookupAddress:output_type -> header.Address
	169, // 474: header.Map.PredictAddress:output_type -> header.Addresses
	169, // 475: header.Map.ListDistricts:output_type -> header.Addresses
	169, // 476: header.Map.ListProvinces:output_type -> header.Addresses
	169, // 477: header.Map.ListWards:output_type -> header.Addresses
	169, // 478: header.Map.ListStreets:output_type -> header.Addresses
	169, // 479: header.Map.ListAddresses:output_type -> header.Addresses
	...
	170, // 499: header.AccountMgr.ListAgents:output_type -> account.Agents
	50,  // 500: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	171, // 501: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 502: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	172, // 503: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	173, // 506: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	173, // 507: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	174, // 510: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	175, // 514: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	50,  // 515: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	169, // 516: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	176, // 520: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	177, // 524: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	177, // 525: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	178, // 530: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	179, // 533: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	180, // 538: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	181, // 544: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	4,   // 545: header.AccountMgr.NewID:output_type -> header.Id
	27,  // 546: header.UserMgr.MergeUser:output_type -> header.User
	50,  // 547: header.UserMgr.DetachUser:output_type -> header.Empty
	4,   // 548: header.UserMgr.CreateUser:output_type -> header.Id
	27,  // 549: header.UserMgr.UpdateUser2:output_type -> header.User
	27,  // 550: header.UserMgr.UpdateUser:output_type -> header.User
	182, // 551: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	50,  // 552: header.UserMgr.RemoveUser:output_type -> header.Empty
	50,  // 553: header.UserMgr.RestoreUser:output_type -> header.Empty
	27,  // 554: header.UserMgr.ReadUser:output_type -> header.User
	27,  // 555: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	26,  // 556: header.UserMgr.MatchUsers:output_type -> header.Users
	27,  // 557: header.UserMgr.BanUser:output_type -> header.User
	27,  // 558: header.UserMgr.UnbanUser:output_type -> header.User
	26,  // 559: header.UserMgr.LookupByPhone:output_type -> header.Users
	28,  // 560: header.UserMgr.UpdateView:output_type -> header.UserView
	28,  // 561: header.UserMgr.CreateView:output_type -> header.UserView
	50,  // 562: header.UserMgr.DeleteView:output_type -> header.Empty
	28,  // 563: header.UserMgr.GetView:output_type -> header.UserView
	183, // 564: header.UserMgr.ListViews:output_type -> header.UserViews
	29,  // 565: header.UserMgr.UpdateSegment:output_type -> header.Segment
	29,  // 566: header.UserMgr.CreateSegment:output_type -> header.Segment
	50,  // 567: header.UserMgr.DeleteSegment:output_type -> header.Empty
	29,  // 568: header.UserMgr.GetSegment:output_type -> header.Segment
	184, // 569: header.UserMgr.ListSegments:output_type -> header.Segments
	26,  // 570: header.UserMgr.ListUsers:output_type -> header.Users
	50,  // 571: header.UserMgr.AddToSegment:output_type -> header.Empty
	50,  // 572: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	50,  // 573: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	33,  // 574: header.UserMgr.UpsertLabel:output_type -> header.Label
	50,  // 575: header.UserMgr.DeleteLabel:output_type -> header.Empty
	185, // 576: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 577: header.UserMgr.GetLabel:output_type -> header.Label
	50,  // 578: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	50,  // 579: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	50,  // 580: header.UserMgr.AddUserLabel:output_type -> header.Empty
	50,  // 581: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	50,  // 582: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	17,  // 583: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	17,  // 584: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	50,  // 585: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	186, // 586: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	50,  // 587: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	26,  // 588: header.UserMgr.ListLeads:output_type -> header.Users
	187, // 589: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	36,  // 590: header.UserMgr.LinkProductUrl:output_type -> header.Product
	100, // 591: header.UserMgr.ListUserEvents:output_type -> header.Events
	38,  // 592: header.UserMgr.CreateUserEvent:output_type -> header.Event
	39,  // 593: header.UserMgr.FillDevice:output_type -> common.Device
	188, // 594: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	50,  // 595: header.UserMgr.LinkTask:output_type -> header.Empty
	189, // 596: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	5,   // 597: header.UserMgr.ListUserIds:output_type -> header.Ids
	26,  // 598: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	190, // 599: header.UserMgr.ListRelatedUsers:output_type -> header.RelatedUsers
	50,  // 600: header.UserMgr.RemoveRelatedUsers:output_type -> header.Empty
	166, // 601: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	191, // 602: header.LiveMgr.SearchLocations:output_type -> header.Locations
	26,  // 603: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	192, // 604: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	193, // 605: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	194, // 606: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	195, // 607: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	196, // 608: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	197, // 609: header.NoteMgr.ListNotes:output_type -> header.Notes
	48,  // 610: header.NoteMgr.AddNote:output_type -> header.Note
	48,  // 611: header.NoteMgr.UpdateNote:output_type -> header.Note
	50,  // 612: header.NoteMgr.DeleteNote:output_type -> header.Empty
	198, // 613: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	51,  // 614: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	51,  // 615: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	199, // 616: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 617: header.ConversationMgr.PongMessage:output_type -> header.Event
	57,  // 618: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	57,  // 619: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	57,  // 620: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	200, // 621: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	200, // 622: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	50,  // 623: header.ConversationMgr.TagConversation:output_type -> header.Empty
	50,  // 624: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	50,  // 625: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	50,  // 626: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	50,  // 627: header.ConversationMgr.Typing:output_type -> header.Empty
	57,  // 628: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	200, // 629: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	50,  // 630: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	50,  // 631: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	50,  // 632: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	50,  // 633: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	59,  // 634: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	59,  // 635: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	...
	50,  // 640: header.ConversationMgr.PinMessage:output_type -> header.Empty
	50,  // 641: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	100, // 642: header.ConversationMgr.ListEvents:output_type -> header.Events
	50,  // 643: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	201, // 644: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	63,  // 645: header.ConversationMgr.Integrate:output_type -> header.Integration
	63,  // 646: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	64,  // 647: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	64,  // 648: header.ConversationMgr.CreateRule:output_type -> header.Rule
	50,  // 649: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	64,  // 650: header.ConversationMgr.ReadRule:output_type -> header.Rule
	202, // 651: header.ConversationMgr.ListRules:output_type -> header.Route
	203, // 652: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	65,  // 653: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	50,  // 654: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	65,  // 655: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	204, // 656: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	66,  // 657: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	66,  // 658: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	50,  // 659: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	66,  // 660: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	63,  // 661: header.ConversationMgr.TestNumber:output_type -> header.Integration
	205, // 662: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	67,  // 663: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	68,  // 664: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	206, // 665: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	50,  // 666: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	207, // 667: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	69,  // 668: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	57,  // 669: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	208, // 670: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
