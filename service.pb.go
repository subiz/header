...
var file_service_proto_rawDesc = []byte{
	...
	0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0f, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xc6, 0x1e, 0x0a,
	...
	0x6e, 0x32, 0xdc, 0x01, 0x0a, 0x0d, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x6e, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x10,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x2e, 0x0a, 0x0e, 0x52, 0x65, 0x61, 0x64, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x10,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xab, 0x05,
	...
	0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf1, 0x0d, 0x0a, 0x0a, 0x50, 0x61,
	...
	0x2e, 0x41, 0x63, 0x63, 0x53, 0x75, 0x62, 0x12, 0x33, 0x0a, 0x08, 0x50, 0x75, 0x72, 0x63, 0x68,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Response)(nil),                          // 207: header.Response
	...
	(*payment.String)(nil),                    // 227: payment.String
	(*payment.Logs)(nil),                      // 228: payment.Logs
	(*payment.ReferralResponse)(nil),          // 229: payment.ReferralResponse
	(*payment.LogAccountReferreds)(nil),       // 230: payment.LogAccountReferreds
	(*payment.LogBillByAccountReferreds)(nil), // 231: payment.LogBillByAccountReferreds
	(*payment.LogPaidForAgentReferrers)(nil),  // 232: payment.LogPaidForAgentReferrers
	(*PollResult)(nil),                        // 233: header.PollResult
	(*FbFanpageSettings)(nil),                 // 234: header.FbFanpageSettings
	(*FacebookPosts)(nil),                     // 235: header.FacebookPosts
	(*FacebookPages)(nil),                     // 236: header.FacebookPages
	...
	(*CampaignSendLog)(nil),                   // 274: header.CampaignSendLog
	(*BroadcastCampaignMetrics)(nil),          // 275: header.BroadcastCampaignMetrics
	(*OutboundCallEntries)(nil),               // 276: header.OutboundCallEntries
	(*ImportOutboundCallEntryResponse)(nil),   // 277: header.ImportOutboundCallEntryResponse
	(*OutboundCallReportResponse)(nil),        // 278: header.OutboundCallReportResponse
	(*TrySpendCreditResponse)(nil),            // 279: header.TrySpendCreditResponse
	(*CreditSpendReportResponse)(nil),         // 280: header.CreditSpendReportResponse
	(*CreditSpendEntries)(nil),                // 281: header.CreditSpendEntries
	(*Forms)(nil),                             // 282: header.Forms
	(*FormReportResponse)(nil),                // 283: header.FormReportResponse
	(*FormSubmissions)(nil),                   // 284: header.FormSubmissions
}
var file_service_proto_depIdxs = []int32{
	...
	176, // 515: header.AccountMgr.ListAgents:output_type -> account.Agents
	...
	207, // 634: header.AutomationMgr.ListAutomations:output_type -> header.Response
	207, // 635: header.AutomationMgr.UpdateAutomation:output_type -> header.Response
	207, // 636: header.AutomationMgr.DeleteAutomation:output_type -> header.Response
	207, // 637: header.AutomationMgr.ReadAutomation:output_type -> header.Response
	208, // 638: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	209, // 664: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	210, // 671: header.ConversationMgr.ListRules:output_type -> header.Route
	211, // 672: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	212, // 676: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	213, // 683: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	214, // 686: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	58,  // 687: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	215, // 688: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	216, // 691: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	217, // 698: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	218, // 704: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	219, // 705: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	220, // 709: header.TagMgr.ListTags:output_type -> header.Tags
	...
	221, // 717: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	222, // 718: header.PaymentMgr.GetSub:output_type -> header.AccSub
	...
	223, // 725: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	224, // 726: header.PaymentMgr.Pay:output_type -> payment.Bill
	...
	225, // 729: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	226, // 732: header.PaymentMgr.ListComments:output_type -> payment.Comments
	94,  // 733: header.PaymentMgr.AddComment:output_type -> payment.Comment
	227, // 734: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	227, // 735: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	95,  // 736: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	224, // 737: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	228, // 738: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	229, // 741: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	98,  // 742: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	230, // 743: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	231, // 744: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	232, // 745: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	58,  // 746: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	58,  // 747: header.Pubsub.Fire:output_type -> header.Empty
	233, // 748: header.Pubsub.Poll:output_type -> header.PollResult
	...
	234, // 752: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	235, // 753: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	236, // 760: header.FabikonService.ListFacebookPages:output_type -> header.FacebookPages
	58,  // 761: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	237, // 762: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	207, // 766: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	...
	238, // 772: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	239, // 773: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	...
	207, // 776: header.MailkonService.TrackLink:output_type -> header.Response
	207, // 777: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	109, // 778: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	207, // 779: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	207, // 780: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	207, // 781: header.MailkonService.BlockEmail:output_type -> header.Response
	207, // 782: header.MailkonService.UnblockEmail:output_type -> header.Response
	...
	240, // 785: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	241, // 786: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	242, // 790: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	243, // 791: header.WidgetService.ListConversions:output_type -> header.Conversions
	244, // 792: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	117, // 793: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	245, // 794: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	58,  // 795: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	246, // 796: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	246, // 802: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	58,  // 803: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	247, // 804: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	245, // 805: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	248, // 806: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	249, // 807: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	250, // 808: header.Bizbot.ListBots:output_type -> header.Bots
	...
	251, // 818: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	252, // 819: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	253, // 820: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	254, // 821: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	127, // 822: header.Sendback.CreateWebhook:output_type -> header.Webhook
	255, // 823: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	58,  // 824: header.Sendback.DeleteWebhook:output_type -> header.Empty
	256, // 825: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	257, // 829: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	258, // 830: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	58,  // 831: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	58,  // 832: header.Notibox.SendNoti:output_type -> header.Empty
	259, // 833: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	260, // 840: header.Proder.ListProducts2:output_type -> header.Products
	261, // 841: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	262, // 842: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	...
	263, // 846: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	...
	264, // 850: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	...
	265, // 856: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	...
	266, // 863: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	267, // 864: header.Proder.DownloadOrder:output_type -> header.File
	1,   // 865: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	268, // 866: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	58,  // 867: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	269, // 868: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	267, // 875: header.Proder.PrintShippingOrders:output_type -> header.File
	...
	270, // 885: header.Proder.ListPipelines:output_type -> header.Pipelines
	...
	271, // 894: header.TaskMgr.ListTasks:output_type -> header.Tasks
	...
	272, // 902: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	151, // 903: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	273, // 904: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	...
	274, // 910: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	275, // 911: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	276, // 912: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	155, // 913: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	277, // 914: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	...
	278, // 917: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	58,  // 918: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	279, // 919: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	280, // 920: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	281, // 921: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	207, // 922: header.CreditMgr.ListCredits:output_type -> header.Response
	207, // 923: header.CreditMgr.AddCredit:output_type -> header.Response
	207, // 924: header.CreditMgr.DeleteCredit:output_type -> header.Response
	207, // 925: header.CreditMgr.UpdateCredit:output_type -> header.Response
	282, // 926: header.FormMgr.ListForms:output_type -> header.Forms
	...
	283, // 930: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	284, // 931: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	165, // 932: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	207, // 933: header.Scheduler.UnregisterTask:output_type -> header.Response
