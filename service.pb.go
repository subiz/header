...
var file_service_proto_rawDesc = []byte{
	...
	0x6e, 0x32, 0xdc, 0x17, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x0d, 0x2e,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xa3, 0x01, 0x0a,
	...
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x83, 0x14, 0x0a,
	...
	0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a, 0x10, 0x4d, 0x61, 0x6b, 0x65, 0x4f,
...
var file_service_proto_depIdxs = []int32{
	...
	65,  // 184: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	65,  // 185: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 186: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 187: header.TemplateMgr.GetTemplate:input_type -> header.Id
	66,  // 188: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 189: header.TemplateMgr.PickTemplate:input_type -> header.Id
	67,  // 190: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	67,  // 191: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	...
	68,  // 195: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	69,  // 196: header.TagMgr.CreateTag:input_type -> header.Tag
	69,  // 197: header.TagMgr.UpdateTag:input_type -> header.Tag
	...
	36,  // 201: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	70,  // 202: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	71,  // 203: header.FileMgr.Presign:input_type -> header.FileHeader
	72,  // 204: header.FileMgr.Uploaded:input_type -> header.FileRequest
	73,  // 205: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 206: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	74,  // 207: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	75,  // 208: header.Noti5Service.Noti:input_type -> header.PushNoti
	76,  // 209: header.Noti5Service.AddToken:input_type -> noti5.Token
	76,  // 210: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	76,  // 211: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	77,  // 212: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	78,  // 213: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	79,  // 214: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	79,  // 215: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 216: header.PaymentMgr.GetSubscription:input_type -> header.Id
	80,  // 217: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	80,  // 218: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	81,  // 221: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	82,  // 222: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	82,  // 223: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	83,  // 224: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	79,  // 225: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	84,  // 226: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	85,  // 227: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	86,  // 228: header.PaymentMgr.AddComment:input_type -> payment.Comment
	46,  // 229: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 230: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	82,  // 231: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	87,  // 232: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	81,  // 233: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	88,  // 234: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	89,  // 235: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	90,  // 236: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	91,  // 237: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	91,  // 238: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	92,  // 239: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 240: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	93,  // 241: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 242: header.PaymentMgr.GetReferral:input_type -> header.Id
	46,  // 243: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	94,  // 244: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	95,  // 248: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	96,  // 249: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 250: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	97,  // 251: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	98,  // 254: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	99,  // 255: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	99,  // 256: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	99,  // 257: header.MailkonService.SendEvent:input_type -> header.Events
	...
	100, // 262: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	101, // 265: header.WidgetService.SubmitImpression:input_type -> header.Impression
	102, // 266: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	103, // 267: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	104, // 268: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	105, // 269: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	105, // 270: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	106, // 271: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 272: header.WidgetService.ListUploadedImage:input_type -> header.Id
	106, // 273: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 274: header.WidgetService.ListWebPlugins:input_type -> header.Id
	107, // 275: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	107, // 276: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	107, // 277: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 278: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	107, // 279: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	108, // 282: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	109, // 288: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	109, // 289: header.Bizbot.CreateBot:input_type -> header.Bot
	109, // 290: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 291: header.Bizbot.DeleteBot:input_type -> header.Id
	110, // 292: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	110, // 293: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	110, // 294: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	110, // 295: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	111, // 296: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	112, // 297: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	113, // 298: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	114, // 299: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	115, // 300: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	115, // 305: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 306: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	116, // 307: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	117, // 308: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	37,  // 309: header.Sendback.SendWebhookEvent:input_type -> header.Event
	118, // 310: header.Notibox.SendNoti:input_type -> header.Notification
	119, // 311: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 312: header.Notibox.MarkReadNoti:input_type -> header.Id
	120, // 313: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 314: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 315: header.Watchhttp.ListWebpages:input_type -> header.Id
	120, // 316: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 317: header.Watchhttp.ReadWebpage:input_type -> header.Id
	121, // 318: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	122, // 319: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	123, // 320: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	123, // 321: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 322: header.Holap.AppendAgentSet:input_type -> account.Agent
	69,  // 323: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 324: header.Holap.UpdateUser:input_type -> header.User
	53,  // 325: header.Holap.UpdateConversation:input_type -> header.Conversation
	37,  // 326: header.Holap.OnConversationEvent:input_type -> header.Event
	124, // 327: header.Holap.FreeAccount:input_type -> header.AccountImage
	125, // 328: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	126, // 329: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	125, // 330: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	126, // 331: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	127, // 332: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 333: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	31,  // 334: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	21,  // 335: header.Holap.UpdateOrder:input_type -> header.Order
	128, // 336: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	129, // 337: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	129, // 338: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	35,  // 339: header.Proder.ReadProduct:input_type -> header.Product
	35,  // 340: header.Proder.CreateProduct:input_type -> header.Product
	35,  // 341: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 342: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 343: header.Proder.RestoreProduct:input_type -> header.Id
	130, // 344: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 345: header.Proder.ListProductIds:input_type -> header.Ids
	130, // 346: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	131, // 347: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 348: header.Proder.ListProductCollections:input_type -> header.Ids
	132, // 349: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	132, // 350: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 351: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 352: header.Proder.ListProductFeeds:input_type -> header.Id
	133, // 353: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	133, // 354: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 355: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 356: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 357: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 358: header.Proder.ReadOrder:input_type -> header.Id
	21,  // 359: header.Proder.CreateOrder:input_type -> header.Order
	21,  // 360: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 361: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 362: header.Proder.RestoreOrder:input_type -> header.Id
	134, // 363: header.Proder.ListOrders:input_type -> header.OrdersRequest
	134, // 364: header.Proder.CountOrders:input_type -> header.OrdersRequest
	135, // 365: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	136, // 366: header.Proder.MakeOrderPayment:input_type -> header.Bill
	137, // 367: header.Proder.DeleteOrderPayment:input_type -> header.Key
	37,  // 368: header.Proder.AddOrderComment:input_type -> header.Event
	37,  // 369: header.Proder.EditOrderComment:input_type -> header.Event
	137, // 370: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 371: header.Proder.ListOrderEvents:input_type -> header.Id
	138, // 372: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 373: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	139, // 374: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 375: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	140, // 376: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	141, // 377: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	142, // 378: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	143, // 379: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 380: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 381: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 382: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 383: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 384: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 385: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 386: header.Apiece.ReadTask:input_type -> header.Id
	144, // 387: header.Apiece.CreateTask:input_type -> header.Task
	144, // 388: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 389: header.Apiece.DeleteTask:input_type -> header.Id
	145, // 390: header.Apiece.ListTasks:input_type -> header.TasksRequest
	37,  // 391: header.Apiece.AddTaskComment:input_type -> header.Event
	37,  // 392: header.Apiece.EditTaskComment:input_type -> header.Event
	137, // 393: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 394: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 395: header.Apiece.ReadPipeline:input_type -> header.Id
	146, // 396: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	146, // 397: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 398: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 399: header.Apiece.ListPipelines:input_type -> header.Ids
	147, // 400: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	148, // 401: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	46,  // 402: header.Search.Index:output_type -> header.Empty
	149, // 403: header.Search.Search:output_type -> header.DocSearchResponse
	46,  // 404: header.Search.AddOwner:output_type -> header.Empty
	150, // 405: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 406: header.Map.LookupAddress:output_type -> header.Address
	151, // 407: header.Map.PredictAddress:output_type -> header.Addresses
	151, // 408: header.Map.ListDistricts:output_type -> header.Addresses
	151, // 409: header.Map.ListProvinces:output_type -> header.Addresses
	151, // 410: header.Map.ListWards:output_type -> header.Addresses
	151, // 411: header.Map.ListStreets:output_type -> header.Addresses
	151, // 412: header.Map.ListAddresses:output_type -> header.Addresses
	19,  // 413: header.Map.ReadAddress:output_type -> header.Address
	6,   // 414: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 415: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 416: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	46,  // 417: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 418: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 419: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 420: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	46,  // 421: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 422: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 423: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 424: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 425: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 426: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 427: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 428: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 429: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 430: header.AccountMgr.CreateAccount:output_type -> account.Account
	152, // 431: header.AccountMgr.ListAgents:output_type -> account.Agents
	46,  // 432: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	153, // 433: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	...
	14,  // 437: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	...
	46,  // 440: header.AccountMgr.LogoutSession:output_type -> header.Empty
	14,  // 441: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	156, // 442: header.AccountMgr.GetLanguage:output_type -> header.Lang
	15,  // 443: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	16,  // 444: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	157, // 445: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	18,  // 446: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	18,  // 447: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	158, // 448: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	46,  // 449: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	151, // 450: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	19,  // 451: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	19,  // 452: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	46,  // 453: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	159, // 454: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	20,  // 455: header.AccountMgr.CreateTax:output_type -> header.Tax
	20,  // 456: header.AccountMgr.UpdateTax:output_type -> header.Tax
	46,  // 457: header.AccountMgr.DeleteTax:output_type -> header.Empty
	...
	22,  // 460: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	22,  // 461: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	46,  // 462: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	23,  // 463: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	161, // 464: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	23,  // 465: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	46,  // 466: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	162, // 467: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 468: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 469: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	46,  // 470: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	46,  // 471: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	163, // 472: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	46,  // 473: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 474: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 475: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 476: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	164, // 477: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	26,  // 478: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	46,  // 479: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	27,  // 480: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	165, // 481: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	30,  // 482: header.UserMgr.MergeUser2:output_type -> header.User
	...
	30,  // 487: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 488: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	166, // 489: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	29,  // 490: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 491: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 492: header.UserMgr.CreateView:output_type -> header.UserView
	46,  // 493: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 494: header.UserMgr.GetView:output_type -> header.UserView
	167, // 495: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 496: header.UserMgr.UpsertLabel:output_type -> header.Label
	46,  // 497: header.UserMgr.DeleteLabel:output_type -> header.Empty
	168, // 498: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 499: header.UserMgr.GetLabel:output_type -> header.Label
	46,  // 500: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	46,  // 501: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	46,  // 502: header.UserMgr.AddUserLabel:output_type -> header.Empty
	46,  // 503: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	46,  // 504: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	19,  // 505: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	19,  // 506: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	46,  // 507: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	169, // 508: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	46,  // 509: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	29,  // 510: header.UserMgr.ListLeads:output_type -> header.Users
	29,  // 511: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	29,  // 512: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	35,  // 513: header.UserMgr.LinkProductUrl:output_type -> header.Product
	99,  // 514: header.UserMgr.ListUserEvents:output_type -> header.Events
	37,  // 515: header.UserMgr.CreateUserEvent:output_type -> header.Event
	38,  // 516: header.UserMgr.FillDevice:output_type -> common.Device
	170, // 517: header.LiveMgr.SearchLocations:output_type -> header.Locations
	29,  // 518: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	99,  // 519: header.LiveMgr.TopEvents:output_type -> header.Events
	171, // 520: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	172, // 521: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	173, // 522: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	174, // 523: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	175, // 524: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	176, // 525: header.NoteMgr.ListNotes:output_type -> header.Notes
	44,  // 526: header.NoteMgr.AddNote:output_type -> header.Note
	44,  // 527: header.NoteMgr.UpdateNote:output_type -> header.Note
	46,  // 528: header.NoteMgr.DeleteNote:output_type -> header.Empty
	177, // 529: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	47,  // 530: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	47,  // 531: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	178, // 532: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	37,  // 533: header.ConversationMgr.PongMessage:output_type -> header.Event
	53,  // 534: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	53,  // 535: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	53,  // 536: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	179, // 537: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	179, // 538: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	46,  // 539: header.ConversationMgr.TagConversation:output_type -> header.Empty
	46,  // 540: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	46,  // 541: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	46,  // 542: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	46,  // 543: header.ConversationMgr.Typing:output_type -> header.Empty
	53,  // 544: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	179, // 545: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	46,  // 546: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	46,  // 547: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	46,  // 548: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	46,  // 549: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	55,  // 550: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	55,  // 551: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	37,  // 552: header.ConversationMgr.TerminateBot:output_type -> header.Event
	37,  // 553: header.ConversationMgr.SendMessage:output_type -> header.Event
	37,  // 554: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	46,  // 555: header.ConversationMgr.PinMessage:output_type -> header.Empty
	46,  // 556: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	99,  // 557: header.ConversationMgr.ListEvents:output_type -> header.Events
	46,  // 558: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	180, // 559: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	58,  // 560: header.ConversationMgr.Integrate:output_type -> header.Integration
	58,  // 561: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	59,  // 562: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	59,  // 563: header.ConversationMgr.CreateRule:output_type -> header.Rule
	46,  // 564: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	59,  // 565: header.ConversationMgr.ReadRule:output_type -> header.Rule
	181, // 566: header.ConversationMgr.ListRules:output_type -> header.Route
	182, // 567: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	60,  // 568: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	46,  // 569: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	60,  // 570: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	183, // 571: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	61,  // 572: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	61,  // 573: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	46,  // 574: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	61,  // 575: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	58,  // 576: header.ConversationMgr.TestNumber:output_type -> header.Integration
	184, // 577: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	62,  // 578: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	63,  // 579: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	185, // 580: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	46,  // 581: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	186, // 582: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	64,  // 583: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	53,  // 584: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	65,  // 585: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	65,  // 586: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	46,  // 587: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	65,  // 588: header.TemplateMgr.GetTemplate:output_type -> header.Template
	187, // 589: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	46,  // 590: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	67,  // 591: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	67,  // 592: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	46,  // 593: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	67,  // 594: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	188, // 595: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	189, // 596: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	69,  // 597: header.TagMgr.CreateTag:output_type -> header.Tag
	69,  // 598: header.TagMgr.UpdateTag:output_type -> header.Tag
	46,  // 599: header.TagMgr.DeleteTag:output_type -> header.Empty
	190, // 600: header.TagMgr.ListTags:output_type -> header.Tags
	69,  // 601: header.TagMgr.GetTag:output_type -> header.Tag
	99,  // 602: header.EventMgr.SearchEvents:output_type -> header.Events
	37,  // 603: header.EventMgr.CreateEvent:output_type -> header.Event
	191, // 604: header.FileMgr.Presign:output_type -> header.PresignResult
	192, // 605: header.FileMgr.Uploaded:output_type -> header.File
	192, // 606: header.FileMgr.DownloadFileUrl:output_type -> header.File
	74,  // 607: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	74,  // 608: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	46,  // 609: header.Noti5Service.Noti:output_type -> header.Empty
	46,  // 610: header.Noti5Service.AddToken:output_type -> header.Empty
	46,  // 611: header.Noti5Service.RemoveToken:output_type -> header.Empty
	46,  // 612: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	77,  // 613: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	193, // 614: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	82,  // 615: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	79,  // 616: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	79,  // 617: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	80,  // 618: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	80,  // 619: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	46,  // 620: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	194, // 621: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	77,  // 622: header.PaymentMgr.Pay:output_type -> payment.Bill
	82,  // 623: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	82,  // 624: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	195, // 625: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	82,  // 626: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	82,  // 627: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	196, // 628: header.PaymentMgr.ListComments:output_type -> payment.Comments
	86,  // 629: header.PaymentMgr.AddComment:output_type -> payment.Comment
	197, // 630: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	90,  // 631: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	90,  // 632: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	87,  // 633: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	77,  // 634: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	198, // 635: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	89,  // 636: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	89,  // 637: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	46,  // 638: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	89,  // 639: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	199, // 640: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	46,  // 641: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	94,  // 642: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	94,  // 643: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	200, // 644: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	94,  // 645: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	201, // 646: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	202, // 647: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	203, // 648: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	46,  // 649: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	46,  // 650: header.Pubsub.Publish:output_type -> header.Empty
	97,  // 651: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	97,  // 652: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	204, // 653: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	205, // 654: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	98,  // 655: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	46,  // 656: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	46,  // 657: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	46,  // 658: header.MailkonService.SendEvent:output_type -> header.Empty
	46,  // 659: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	46,  // 660: header.MailkonService.BlockEmail:output_type -> header.Empty
	46,  // 661: header.MailkonService.UnblockEmail:output_type -> header.Empty
	100, // 662: header.WidgetService.Read:output_type -> header.WidgetSetting
	100, // 663: header.WidgetService.Update:output_type -> header.WidgetSetting
	206, // 664: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	207, // 665: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	101, // 666: header.WidgetService.SubmitImpression:output_type -> header.Impression
	102, // 667: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	103, // 668: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	208, // 669: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	209, // 670: header.WidgetService.ListConversions:output_type -> header.Conversions
	210, // 671: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	106, // 672: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	211, // 673: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	46,  // 674: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	212, // 675: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	107, // 676: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	107, // 677: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	107, // 678: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	46,  // 679: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	107, // 680: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	212, // 681: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	46,  // 682: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	213, // 683: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	211, // 684: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	214, // 685: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	215, // 686: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	216, // 687: header.Bizbot.ListBots:output_type -> header.Bots
	109, // 688: header.Bizbot.GetBot:output_type -> header.Bot
	109, // 689: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	109, // 690: header.Bizbot.CreateBot:output_type -> header.Bot
	109, // 691: header.Bizbot.UpdateBot:output_type -> header.Bot
	46,  // 692: header.Bizbot.DeleteBot:output_type -> header.Empty
	46,  // 693: header.Bizbot.OnEvent:output_type -> header.Empty
	46,  // 694: header.Bizbot.StartBot:output_type -> header.Empty
	46,  // 695: header.Bizbot.StopBot:output_type -> header.Empty
	46,  // 696: header.Bizbot.TryAction:output_type -> header.Empty
	217, // 697: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	218, // 698: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	219, // 699: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	220, // 700: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	115, // 701: header.Sendback.CreateWebhook:output_type -> header.Webhook
	221, // 702: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	46,  // 703: header.Sendback.DeleteWebhook:output_type -> header.Empty
	222, // 704: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	115, // 705: header.Sendback.ReadWebhook:output_type -> header.Webhook
	115, // 706: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	115, // 707: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	223, // 708: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	224, // 709: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	46,  // 710: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	46,  // 711: header.Notibox.SendNoti:output_type -> header.Empty
	225, // 712: header.Notibox.ListNoties:output_type -> header.Notifications
	46,  // 713: header.Notibox.MarkReadNoti:output_type -> header.Empty
	120, // 714: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	46,  // 715: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	226, // 716: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	120, // 717: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	120, // 718: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	227, // 719: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	228, // 720: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	229, // 721: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	227, // 722: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	46,  // 723: header.Holap.AppendAgentSet:output_type -> header.Empty
	46,  // 724: header.Holap.AppendTagSet:output_type -> header.Empty
	46,  // 725: header.Holap.UpdateUser:output_type -> header.Empty
	46,  // 726: header.Holap.UpdateConversation:output_type -> header.Empty
	46,  // 727: header.Holap.OnConversationEvent:output_type -> header.Empty
	46,  // 728: header.Holap.FreeAccount:output_type -> header.Empty
	230, // 729: header.Holap.ReportUser:output_type -> header.UserMetrics
	231, // 730: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 731: header.Holap.ListUserIds:output_type -> header.Ids
	179, // 732: header.Holap.ListConversationIds:output_type -> header.Conversations
	232, // 733: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 734: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	166, // 735: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	46,  // 736: header.Holap.UpdateOrder:output_type -> header.Empty
	233, // 737: header.Holap.ReportOrder:output_type -> header.Orders
	234, // 738: header.Holap.ReportCall:output_type -> header.CallMetrics
	179, // 739: header.Holap.ListCallIds:output_type -> header.Conversations
	35,  // 740: header.Proder.ReadProduct:output_type -> header.Product
	35,  // 741: header.Proder.CreateProduct:output_type -> header.Product
	35,  // 742: header.Proder.UpdateProduct:output_type -> header.Product
	46,  // 743: header.Proder.DeleteProduct:output_type -> header.Empty
	35,  // 744: header.Proder.RestoreProduct:output_type -> header.Product
	131, // 745: header.Proder.ListProducts:output_type -> header.Products
	5,   // 746: header.Proder.ListProductIds:output_type -> header.Ids
	131, // 747: header.Proder.ListGroupedProducts:output_type -> header.Products
	131, // 748: header.Proder.ImportProducts:output_type -> header.Products
	235, // 749: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	132, // 750: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	132, // 751: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	46,  // 752: header.Proder.DeleteProductCollection:output_type -> header.Empty
	236, // 753: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	133, // 754: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	133, // 755: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	46,  // 756: header.Proder.DeleteProductFeed:output_type -> header.Empty
	237, // 757: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	238, // 758: header.Proder.ListProductProps:output_type -> header.ProductProps
	21,  // 759: header.Proder.ReadOrder:output_type -> header.Order
	21,  // 760: header.Proder.CreateOrder:output_type -> header.Order
	21,  // 761: header.Proder.UpdateOrder:output_type -> header.Order
	46,  // 762: header.Proder.DeleteOrder:output_type -> header.Empty
	21,  // 763: header.Proder.RestoreOrder:output_type -> header.Order
	233, // 764: header.Proder.ListOrders:output_type -> header.Orders
	233, // 765: header.Proder.CountOrders:output_type -> header.Orders
	46,  // 766: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	37,  // 767: header.Proder.MakeOrderPayment:output_type -> header.Event
	37,  // 768: header.Proder.DeleteOrderPayment:output_type -> header.Event
	37,  // 769: header.Proder.AddOrderComment:output_type -> header.Event
	37,  // 770: header.Proder.EditOrderComment:output_type -> header.Event
	37,  // 771: header.Proder.DeleteOrderComment:output_type -> header.Event
	239, // 772: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	192, // 773: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 774: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	240, // 775: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	46,  // 776: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	241, // 777: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	46,  // 778: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	46,  // 779: header.Proder.GHNShippingStatus:output_type -> header.Empty
	143, // 780: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 781: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 782: header.Proder.CancelShippingOrder:output_type -> header.Order
	192, // 783: header.Proder.PrintShippingOrders:output_type -> header.File
	46,  // 784: header.Proder.SeenOrder:output_type -> header.Empty
	46,  // 785: header.Proder.FollowOrder:output_type -> header.Empty
	46,  // 786: header.Proder.UnfollowOrder:output_type -> header.Empty
	144, // 787: header.Apiece.ReadTask:output_type -> header.Task
	144, // 788: header.Apiece.CreateTask:output_type -> header.Task
	144, // 789: header.Apiece.UpdateTask:output_type -> header.Task
	46,  // 790: header.Apiece.DeleteTask:output_type -> header.Empty
	242, // 791: header.Apiece.ListTasks:output_type -> header.Tasks
	37,  // 792: header.Apiece.AddTaskComment:output_type -> header.Event
	37,  // 793: header.Apiece.EditTaskComment:output_type -> header.Event
	37,  // 794: header.Apiece.DeleteTaskComment:output_type -> header.Event
	243, // 795: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	146, // 796: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	146, // 797: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	146, // 798: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	46,  // 799: header.Apiece.DeletePipeline:output_type -> header.Empty
	244, // 800: header.Apiece.ListPipelines:output_type -> header.Pipelines
	147, // 801: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
