...
var file_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x32, 0xfd, 0x01, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x2b, 0x0a,
	...
	0x73, 0x32, 0xb3, 0x04, 0x0a, 0x09, 0x57, 0x61, 0x74, 0x63, 0x68, 0x68, 0x74, 0x74, 0x70, 0x12,
	...
	0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0xc9, 0x05, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61,
	...
	0x49, 0x64, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_service_proto_depIdxs = []int32{
	...
	32,  // 256: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	32,  // 260: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	106, // 270: header.AccountMgr.ListAgents:output_type -> account.Agents
	32,  // 271: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	107, // 272: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	32,  // 273: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	32,  // 274: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 275: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	108, // 276: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	109, // 279: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	32,  // 280: header.AccountMgr.LogoutSession:output_type -> header.Empty
	110, // 281: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	111, // 284: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	112, // 285: header.UserMgr.SearchUsers:output_type -> header.Users
	113, // 286: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	113, // 287: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	...
	114, // 293: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	112, // 294: header.UserMgr.MatchUsers:output_type -> header.Users
	20,  // 295: header.UserMgr.UpsertView:output_type -> header.UserView
	32,  // 296: header.UserMgr.DeleteView:output_type -> header.Empty
	20,  // 297: header.UserMgr.GetView:output_type -> header.UserView
	115, // 298: header.UserMgr.ListViews:output_type -> header.UserViews
	112, // 299: header.UserMgr.ListUserInViews:output_type -> header.Users
	22,  // 300: header.UserMgr.UpsertLabel:output_type -> header.Label
	32,  // 301: header.UserMgr.DeleteLabel:output_type -> header.Empty
	116, // 302: header.UserMgr.ListLabels:output_type -> header.Labels
	22,  // 303: header.UserMgr.GetLabel:output_type -> header.Label
	32,  // 304: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	32,  // 305: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	32,  // 306: header.UserMgr.AddUserLabel:output_type -> header.Empty
	32,  // 307: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	32,  // 308: header.UserPersist.UpdateUser:output_type -> header.Empty
	112, // 309: header.UserPersist.FilterUsers:output_type -> header.Users
	117, // 310: header.LiveMgr.SearchLocations:output_type -> header.Locations
	112, // 311: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	118, // 312: header.LiveMgr.TopEvents:output_type -> header.Events
	119, // 313: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	120, // 314: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	121, // 315: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	122, // 316: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	123, // 317: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	124, // 318: header.NoteMgr.ListNotes:output_type -> header.Notes
	29,  // 319: header.NoteMgr.AddNote:output_type -> header.Note
	29,  // 320: header.NoteMgr.UpdateNote:output_type -> header.Note
	32,  // 321: header.NoteMgr.DeleteNote:output_type -> header.Empty
	125, // 322: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	31,  // 323: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	32,  // 324: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	31,  // 325: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	31,  // 326: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	126, // 327: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	32,  // 330: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	127, // 331: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	36,  // 332: header.RuleMgr.UpdateRule:output_type -> header.Rule
	36,  // 333: header.RuleMgr.CreateRule:output_type -> header.Rule
	32,  // 334: header.RuleMgr.DeleteRule:output_type -> header.Empty
	36,  // 335: header.RuleMgr.ReadRule:output_type -> header.Rule
	128, // 336: header.RuleMgr.ListRules:output_type -> header.Route
	129, // 337: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 338: header.ConversationMgr.PongMessage:output_type -> header.Event
	...
	130, // 342: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	130, // 343: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	130, // 350: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	32,  // 351: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	32,  // 352: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	32,  // 353: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	32,  // 354: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	44,  // 355: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	44,  // 356: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 357: header.ConversationMgr.TerminateBot:output_type -> header.Event
	131, // 358: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 359: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	46,  // 360: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	32,  // 361: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	46,  // 362: header.TemplateMgr.GetTemplate:output_type -> header.Template
	132, // 363: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	32,  // 364: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	48,  // 365: header.TagMgr.CreateTag:output_type -> header.Tag
	48,  // 366: header.TagMgr.UpdateTag:output_type -> header.Tag
	32,  // 367: header.TagMgr.DeleteTag:output_type -> header.Empty
	133, // 368: header.TagMgr.ListTags:output_type -> header.Tags
	48,  // 369: header.TagMgr.GetTag:output_type -> header.Tag
	32,  // 370: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	134, // 371: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	49,  // 372: header.IntegrationMgr.Integrate:output_type -> header.Integration
	118, // 373: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 374: header.EventMgr.CreateEvent:output_type -> header.Event
	38,  // 375: header.ConversationEventReader.SendMessage:output_type -> header.Event
	38,  // 376: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	32,  // 377: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	32,  // 378: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	118, // 379: header.ConversationEventReader.ListEvents:output_type -> header.Events
	135, // 380: header.FileMgr.Presign:output_type -> header.PresignResult
	136, // 381: header.FileMgr.Read:output_type -> header.File
	136, // 382: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 383: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 384: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	32,  // 385: header.Noti5Service.Noti:output_type -> header.Empty
	32,  // 386: header.Noti5Service.AddToken:output_type -> header.Empty
	32,  // 387: header.Noti5Service.RemoveToken:output_type -> header.Empty
	32,  // 388: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 389: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 390: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 391: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 392: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 393: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 394: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 395: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	32,  // 396: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	138, // 397: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 398: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 399: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 400: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 401: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 402: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 403: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 404: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 405: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 406: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 407: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 408: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 409: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 410: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 411: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 412: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 413: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	32,  // 414: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 415: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	143, // 416: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	32,  // 417: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 418: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 419: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 420: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 421: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	145, // 422: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	146, // 423: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	147, // 424: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	32,  // 425: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	32,  // 426: header.Pubsub.Publish:output_type -> header.Empty
	32,  // 427: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 428: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 429: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	148, // 430: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	149, // 431: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 432: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 433: header.WidgetService.Update:output_type -> header.WidgetSetting
	150, // 434: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	151, // 435: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	80,  // 436: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 437: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 438: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	152, // 439: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	153, // 440: header.WidgetService.ListConversions:output_type -> header.Conversions
	154, // 441: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 442: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	155, // 443: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	32,  // 444: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	156, // 445: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	86,  // 446: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	86,  // 447: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	86,  // 448: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	32,  // 449: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	86,  // 450: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	156, // 451: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	32,  // 452: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	157, // 453: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	155, // 454: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	158, // 455: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	159, // 456: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	160, // 457: header.Bizbot.ListBots:output_type -> header.Bots
	88,  // 458: header.Bizbot.GetBot:output_type -> header.Bot
	88,  // 459: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	88,  // 460: header.Bizbot.CreateBot:output_type -> header.Bot
	88,  // 461: header.Bizbot.UpdateBot:output_type -> header.Bot
	32,  // 462: header.Bizbot.DeleteBot:output_type -> header.Empty
	32,  // 463: header.Bizbot.OnEvent:output_type -> header.Empty
	32,  // 464: header.Bizbot.StartBot:output_type -> header.Empty
	32,  // 465: header.Bizbot.StopBot:output_type -> header.Empty
	32,  // 466: header.Bizbot.TryAction:output_type -> header.Empty
	161, // 467: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	162, // 468: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	88,  // 469: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	160, // 470: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	92,  // 471: header.Sendback.CreateWebhook:output_type -> header.Webhook
	163, // 472: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	32,  // 473: header.Sendback.DeleteWebhook:output_type -> header.Empty
	164, // 474: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	92,  // 475: header.Sendback.ReadWebhook:output_type -> header.Webhook
	92,  // 476: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	92,  // 477: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	165, // 478: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	166, // 479: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	32,  // 480: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	32,  // 481: header.Notibox.Send:output_type -> header.Empty
	32,  // 482: header.Notibox.MarkRead:output_type -> header.Empty
	32,  // 483: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	167, // 484: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	98,  // 485: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	32,  // 486: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	168, // 487: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	98,  // 488: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	98,  // 489: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	169, // 490: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	170, // 491: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	171, // 492: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	169, // 493: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	32,  // 494: header.Holap.AppendAgentSet:output_type -> header.Empty
	32,  // 495: header.Holap.AppendTagSet:output_type -> header.Empty
	32,  // 496: header.Holap.UpdateUser:output_type -> header.Empty
	32,  // 497: header.Holap.UpdateConversation:output_type -> header.Empty
	32,  // 498: header.Holap.OnConversationEvent:output_type -> header.Empty
	32,  // 499: header.Holap.FreeAccount:output_type -> header.Empty
	172, // 500: header.Holap.ReportUser:output_type -> header.UserMetrics
	173, // 501: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 502: header.Holap.ListUserIds:output_type -> header.Ids
	130, // 503: header.Holap.ListConversationIds:output_type -> header.Conversations
	174, // 504: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 505: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
