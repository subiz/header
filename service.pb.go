...
var file_service_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x9c, 0x07, 0x0a, 0x0b, 0x43, 0x61,
	...
	0x69, 0x67, 0x6e, 0x53, 0x65, 0x6e, 0x64, 0x4c, 0x6f, 0x67, 0x12, 0x35, 0x0a, 0x0e, 0x52, 0x65,
	...
	0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x62,
	0x0a, 0x1a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64,
	0x43, 0x61, 0x6c, 0x6c, 0x42, 0x79, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x21, 0x2e, 0x68,
	...
	0x64, 0x43, 0x61, 0x6c, 0x6c, 0x42, 0x79, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x12, 0x54, 0x0a, 0x13, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4f, 0x75, 0x74, 0x62,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x61,
	0x6c, 0x6c, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xe1, 0x01, 0x0a, 0x09, 0x43, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x4d, 0x67, 0x72, 0x12, 0x58, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
	...
	0x73, 0x12, 0x29, 0x0a, 0x09, 0x41, 0x64, 0x64, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x12, 0x0d,
	0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x1a, 0x0d, 0x2e,
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x32, 0xc6, 0x02, 0x0a,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_service_proto_depIdxs = []int32{
	...
	5,   // 423: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	4,   // 424: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	152, // 425: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	152, // 426: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	4,   // 427: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	39,  // 428: header.CampaignMgr.OnEvent:input_type -> header.Event
	153, // 429: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	4,   // 430: header.CampaignMgr.ReportCampaign:input_type -> header.Id
	154, // 431: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	155, // 432: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	155, // 433: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	155, // 434: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	156, // 435: header.CampaignMgr.ReportOutboundCallByAgents:input_type -> header.OutboundCallReportRequest
	156, // 436: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	...
	261, // 869: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	152, // 870: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	152, // 871: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	152, // 872: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	51,  // 873: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	51,  // 874: header.CampaignMgr.OnEvent:output_type -> header.Empty
	262, // 875: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	263, // 876: header.CampaignMgr.ReportCampaign:output_type -> header.CampaignMetrics
	264, // 877: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	155, // 878: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	155, // 879: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	51,  // 880: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	265, // 881: header.CampaignMgr.ReportOutboundCallByAgents:output_type -> header.OutboundCallByAgentReport
	266, // 882: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReport
...
func (c *campaignMgrClient) ReportCampaign(ctx context.Context, in *Id, opts ...grpc.CallOption) (*CampaignMetrics, error) {
	out := new(CampaignMetrics)
	err := c.cc.Invoke(ctx, "/header.CampaignMgr/ReportCampaign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCampaignMgrServer) ReportCampaign(context.Context, *Id) (*CampaignMetrics, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportCampaign not implemented")
}
...
func _CampaignMgr_ReportCampaign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CampaignMgrServer).ReportCampaign(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.CampaignMgr/ReportCampaign",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CampaignMgrServer).ReportCampaign(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CampaignMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportCampaign",
			Handler:    _CampaignMgr_ReportCampaign_Handler,
		},
		{
