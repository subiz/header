...
var file_service_proto_rawDesc = []byte{
	...
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x32, 0xf4, 0x06, 0x0a,
...
var file_service_proto_depIdxs = []int32{
	...
	0,   // 269: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 270: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 271: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	30,  // 272: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 273: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 274: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 275: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	30,  // 276: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 277: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 278: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 279: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 280: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 281: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 282: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 283: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 284: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 285: header.AccountMgr.CreateAccount:output_type -> account.Account
	109, // 286: header.AccountMgr.ListAgents:output_type -> account.Agents
	30,  // 287: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	110, // 288: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	30,  // 289: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	30,  // 290: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 291: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	111, // 292: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 293: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 294: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	112, // 295: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	112, // 296: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	30,  // 297: header.AccountMgr.LogoutSession:output_type -> header.Empty
	10,  // 298: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	113, // 299: header.AccountMgr.GetLanguage:output_type -> header.Lang
	11,  // 300: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	12,  // 301: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	114, // 302: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	115, // 303: header.UserMgr.SearchUsers:output_type -> header.Users
	15,  // 304: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 305: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 306: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	1,   // 307: header.UserMgr.UpdateUser:output_type -> header.Id
	16,  // 308: header.UserMgr.ReadUser:output_type -> header.User
	116, // 309: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	115, // 310: header.UserMgr.MatchUsers:output_type -> header.Users
	19,  // 311: header.UserMgr.UpdateView:output_type -> header.UserView
	19,  // 312: header.UserMgr.CreateView:output_type -> header.UserView
	30,  // 313: header.UserMgr.DeleteView:output_type -> header.Empty
	19,  // 314: header.UserMgr.GetView:output_type -> header.UserView
	117, // 315: header.UserMgr.ListViews:output_type -> header.UserViews
	20,  // 316: header.UserMgr.UpsertLabel:output_type -> header.Label
	30,  // 317: header.UserMgr.DeleteLabel:output_type -> header.Empty
	118, // 318: header.UserMgr.ListLabels:output_type -> header.Labels
	20,  // 319: header.UserMgr.GetLabel:output_type -> header.Label
	30,  // 320: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	30,  // 321: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	30,  // 322: header.UserMgr.AddUserLabel:output_type -> header.Empty
	30,  // 323: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	115, // 324: header.UserPersist.ListUsersInView:output_type -> header.Users
	30,  // 325: header.UserPersist.UpdateUser:output_type -> header.Empty
	30,  // 326: header.UserPersist.ResyncUsers:output_type -> header.Empty
	119, // 327: header.LiveMgr.SearchLocations:output_type -> header.Locations
	115, // 328: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	120, // 329: header.LiveMgr.TopEvents:output_type -> header.Events
	121, // 330: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	122, // 331: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	123, // 332: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	124, // 333: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	125, // 334: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	126, // 335: header.NoteMgr.ListNotes:output_type -> header.Notes
	27,  // 336: header.NoteMgr.AddNote:output_type -> header.Note
	27,  // 337: header.NoteMgr.UpdateNote:output_type -> header.Note
	30,  // 338: header.NoteMgr.DeleteNote:output_type -> header.Empty
	127, // 339: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	29,  // 340: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	30,  // 341: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	29,  // 342: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	128, // 343: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	31,  // 344: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	31,  // 345: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	30,  // 346: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	129, // 347: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	34,  // 348: header.RuleMgr.UpdateRule:output_type -> header.Rule
	34,  // 349: header.RuleMgr.CreateRule:output_type -> header.Rule
	30,  // 350: header.RuleMgr.DeleteRule:output_type -> header.Empty
	34,  // 351: header.RuleMgr.ReadRule:output_type -> header.Rule
	130, // 352: header.RuleMgr.ListRules:output_type -> header.Route
	131, // 353: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	36,  // 354: header.ConversationMgr.PongMessage:output_type -> header.Event
	41,  // 355: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	41,  // 356: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	41,  // 357: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	132, // 358: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	132, // 359: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	30,  // 360: header.ConversationMgr.TagConversation:output_type -> header.Empty
	30,  // 361: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	30,  // 362: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	30,  // 363: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	30,  // 364: header.ConversationMgr.Typing:output_type -> header.Empty
	41,  // 365: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	132, // 366: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	30,  // 367: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	30,  // 368: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	30,  // 369: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	30,  // 370: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	42,  // 371: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	42,  // 372: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	36,  // 373: header.ConversationMgr.TerminateBot:output_type -> header.Event
	133, // 374: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	44,  // 375: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	44,  // 376: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	30,  // 377: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	44,  // 378: header.TemplateMgr.GetTemplate:output_type -> header.Template
	134, // 379: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	30,  // 380: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	46,  // 381: header.TagMgr.CreateTag:output_type -> header.Tag
	46,  // 382: header.TagMgr.UpdateTag:output_type -> header.Tag
	30,  // 383: header.TagMgr.DeleteTag:output_type -> header.Empty
	135, // 384: header.TagMgr.ListTags:output_type -> header.Tags
	46,  // 385: header.TagMgr.GetTag:output_type -> header.Tag
	30,  // 386: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	136, // 387: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	47,  // 388: header.IntegrationMgr.Integrate:output_type -> header.Integration
	120, // 389: header.EventMgr.SearchEvents:output_type -> header.Events
	36,  // 390: header.EventMgr.CreateEvent:output_type -> header.Event
	36,  // 391: header.ConversationEventReader.SendMessage:output_type -> header.Event
	36,  // 392: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	30,  // 393: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	30,  // 394: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	120, // 395: header.ConversationEventReader.ListEvents:output_type -> header.Events
	137, // 396: header.FileMgr.Presign:output_type -> header.PresignResult
	138, // 397: header.FileMgr.Uploaded:output_type -> header.File
	138, // 398: header.FileMgr.DownloadFileUrl:output_type -> header.File
	54,  // 399: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	54,  // 400: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	30,  // 401: header.Noti5Service.Noti:output_type -> header.Empty
	30,  // 402: header.Noti5Service.AddToken:output_type -> header.Empty
	30,  // 403: header.Noti5Service.RemoveToken:output_type -> header.Empty
	30,  // 404: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	57,  // 405: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	139, // 406: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	62,  // 407: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	59,  // 408: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	59,  // 409: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	60,  // 410: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	60,  // 411: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	30,  // 412: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	140, // 413: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	57,  // 414: header.PaymentMgr.Pay:output_type -> payment.Bill
	62,  // 415: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	62,  // 416: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	141, // 417: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	62,  // 418: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	62,  // 419: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	142, // 420: header.PaymentMgr.ListComments:output_type -> payment.Comments
	66,  // 421: header.PaymentMgr.AddComment:output_type -> payment.Comment
	143, // 422: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	70,  // 423: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	70,  // 424: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	67,  // 425: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	57,  // 426: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	144, // 427: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	69,  // 428: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	69,  // 429: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	30,  // 430: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	69,  // 431: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	145, // 432: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	30,  // 433: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	74,  // 434: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	74,  // 435: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	146, // 436: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	74,  // 437: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	147, // 438: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	148, // 439: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	149, // 440: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	30,  // 441: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	30,  // 442: header.Pubsub.Publish:output_type -> header.Empty
	30,  // 443: header.Realtime.ShardSend:output_type -> header.Empty
	77,  // 444: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	77,  // 445: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	150, // 446: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	151, // 447: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	78,  // 448: header.WidgetService.Read:output_type -> header.WidgetSetting
	78,  // 449: header.WidgetService.Update:output_type -> header.WidgetSetting
	152, // 450: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	153, // 451: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	79,  // 452: header.WidgetService.SubmitImpression:output_type -> header.Impression
	80,  // 453: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	81,  // 454: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	154, // 455: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	155, // 456: header.WidgetService.ListConversions:output_type -> header.Conversions
	156, // 457: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	84,  // 458: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	157, // 459: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	30,  // 460: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	158, // 461: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	85,  // 462: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	85,  // 463: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	85,  // 464: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	30,  // 465: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	85,  // 466: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	158, // 467: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	30,  // 468: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	159, // 469: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	157, // 470: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	160, // 471: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	161, // 472: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	162, // 473: header.Bizbot.ListBots:output_type -> header.Bots
	87,  // 474: header.Bizbot.GetBot:output_type -> header.Bot
	87,  // 475: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	87,  // 476: header.Bizbot.CreateBot:output_type -> header.Bot
	87,  // 477: header.Bizbot.UpdateBot:output_type -> header.Bot
	30,  // 478: header.Bizbot.DeleteBot:output_type -> header.Empty
	30,  // 479: header.Bizbot.OnEvent:output_type -> header.Empty
	30,  // 480: header.Bizbot.StartBot:output_type -> header.Empty
	30,  // 481: header.Bizbot.StopBot:output_type -> header.Empty
	30,  // 482: header.Bizbot.TryAction:output_type -> header.Empty
	163, // 483: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	164, // 484: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	87,  // 485: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	162, // 486: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	91,  // 487: header.Sendback.CreateWebhook:output_type -> header.Webhook
	165, // 488: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	30,  // 489: header.Sendback.DeleteWebhook:output_type -> header.Empty
	166, // 490: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	91,  // 491: header.Sendback.ReadWebhook:output_type -> header.Webhook
	91,  // 492: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	91,  // 493: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	167, // 494: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	168, // 495: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	30,  // 496: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	30,  // 497: header.Notibox.Send:output_type -> header.Empty
	30,  // 498: header.Notibox.MarkRead:output_type -> header.Empty
	30,  // 499: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	169, // 500: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	97,  // 501: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	30,  // 502: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	170, // 503: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	97,  // 504: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	97,  // 505: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	171, // 506: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	172, // 507: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	173, // 508: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	171, // 509: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	30,  // 510: header.Holap.AppendAgentSet:output_type -> header.Empty
	30,  // 511: header.Holap.AppendTagSet:output_type -> header.Empty
	30,  // 512: header.Holap.UpdateUser:output_type -> header.Empty
	30,  // 513: header.Holap.UpdateConversation:output_type -> header.Empty
	30,  // 514: header.Holap.OnConversationEvent:output_type -> header.Empty
	30,  // 515: header.Holap.FreeAccount:output_type -> header.Empty
	174, // 516: header.Holap.ReportUser:output_type -> header.UserMetrics
	175, // 517: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	18,  // 518: header.Holap.ListUserIds:output_type -> header.Ids
	132, // 519: header.Holap.ListConversationIds:output_type -> header.Conversations
	176, // 520: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	18,  // 521: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	116, // 522: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	105, // 523: header.Proder.ReadProduct:output_type -> header.Product
	105, // 524: header.Proder.CreateProduct:output_type -> header.Product
	105, // 525: header.Proder.UpdateProduct:output_type -> header.Product
	30,  // 526: header.Proder.DeleteProduct:output_type -> header.Empty
	177, // 527: header.Proder.ListProducts:output_type -> header.Products
	18,  // 528: header.Proder.ListProductIds:output_type -> header.Ids
	177, // 529: header.Proder.ListGroupedProducts:output_type -> header.Products
	178, // 530: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	107, // 531: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	107, // 532: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	30,  // 533: header.Proder.DeleteProductCollection:output_type -> header.Empty
	179, // 534: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	108, // 535: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	108, // 536: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	30,  // 537: header.Proder.DeleteProductFeed:output_type -> header.Empty
