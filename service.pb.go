...
var file_service_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x74, 0x65, 0x32, 0x85, 0x0b, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73,
	...
	0x44, 0x0a, 0x10, 0x53, 0x65, 0x65, 0x6e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x72, 0x74, 0x43, 0x6f,
	...
	0x6f, 0x6e, 0x2e, 0x49, 0x64, 0x1a, 0x14, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x43,
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x44, 0x0a, 0x16, 0x55, 0x70, 0x64,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3a, 0x0a, 0x13,
	...
	0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3b, 0x0a, 0x14, 0x4d, 0x61, 0x72, 0x6b,
	...
	0x6e, 0x67, 0x12, 0x0a, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x64, 0x1a, 0x16,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xba, 0x02, 0x0a,
	...
	0x72, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x85, 0x02,
	...
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x32, 0x7a, 0x0a, 0x08, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x67,
	...
	0x73, 0x74, 0x73, 0x32, 0x89, 0x08, 0x0a, 0x0d, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x53, 0x65,
...
var file_service_proto_depIdxs = []int32{
	...
	53,  // 111: header.ClientMgr.Create:input_type -> header.Client
	53,  // 112: header.ClientMgr.Update:input_type -> header.Client
	53,  // 113: header.ClientMgr.Read:input_type -> header.Client
	1,   // 114: header.ClientMgr.ListIntegratedClients:input_type -> common.Id
	1,   // 115: header.ClientMgr.ListAuthorizedClients:input_type -> common.Id
	54,  // 116: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	55,  // 117: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	39,  // 118: header.ConversationEventReader.SendMessage:input_type -> header.Event
	39,  // 119: header.ConversationEventReader.UpdateMessage:input_type -> header.Event
	56,  // 120: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	57,  // 121: header.ConversationEventReader.SearchEvents:input_type -> header.SearchMessageRequest
	58,  // 122: header.FileMgr.Presign:input_type -> header.FileHeader
	59,  // 123: header.FileMgr.Read:input_type -> header.FileRequest
	59,  // 124: header.FileMgr.Uploaded:input_type -> header.FileRequest
	1,   // 125: header.Noti5Service.ReadNotificationSetting:input_type -> common.Id
	60,  // 126: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	61,  // 127: header.Noti5Service.Noti:input_type -> noti5.PushNoti
	62,  // 128: header.Noti5Service.AddToken:input_type -> noti5.Token
	62,  // 129: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	62,  // 130: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	63,  // 131: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	64,  // 132: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	65,  // 133: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	65,  // 134: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 135: header.PaymentMgr.GetSubscription:input_type -> common.Id
	66,  // 136: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	66,  // 137: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	1,   // 138: header.PaymentMgr.DeletePaymentMethod:input_type -> common.Id
	1,   // 139: header.PaymentMgr.ListPaymentMethods:input_type -> common.Id
	67,  // 140: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	68,  // 141: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	68,  // 142: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	69,  // 143: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	65,  // 144: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	70,  // 145: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	71,  // 146: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	72,  // 147: header.PaymentMgr.AddComment:input_type -> payment.Comment
	29,  // 148: header.PaymentMgr.ListPlans:input_type -> common.Empty
	1,   // 149: header.PaymentMgr.ExportInvoice:input_type -> common.Id
	68,  // 150: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	73,  // 151: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	67,  // 152: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	74,  // 153: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	75,  // 154: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	76,  // 155: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	77,  // 156: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	77,  // 157: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	78,  // 158: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 159: header.PaymentMgr.DeletePromotionCode:input_type -> common.Id
	79,  // 160: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 161: header.PaymentMgr.GetReferral:input_type -> common.Id
	29,  // 162: header.PaymentMgr.ListTopReferral:input_type -> common.Empty
	80,  // 163: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	1,   // 164: header.PaymentMgr.ListAccountReferred:input_type -> common.Id
	1,   // 165: header.PaymentMgr.ListBillByAccountReferred:input_type -> common.Id
	1,   // 166: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> common.Id
	81,  // 167: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	82,  // 168: header.Pubsub.Publish:input_type -> header.PublishMessage
	82,  // 169: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 170: header.FabikonService.ReadFbFanpageSetting:input_type -> common.Id
	83,  // 171: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	1,   // 172: header.FabikonService.ListFbFanpageSettings:input_type -> common.Id
	1,   // 173: header.FabikonService.ListFbPosts:input_type -> common.Id
	1,   // 174: header.WidgetService.Read:input_type -> common.Id
	84,  // 175: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 176: header.WidgetService.ReadUserSetting:input_type -> common.Id
	1,   // 177: header.WidgetService.ReadCampaign:input_type -> common.Id
	1,   // 178: header.WidgetService.ListCampaigns:input_type -> common.Id
	85,  // 179: header.WidgetService.CreateCampaign:input_type -> header.Campaign
	85,  // 180: header.WidgetService.UpdateCampaign:input_type -> header.Campaign
	85,  // 181: header.WidgetService.DeleteCampaign:input_type -> header.Campaign
	86,  // 182: header.WidgetService.SubmitImpression:input_type -> header.Impression
	87,  // 183: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	88,  // 184: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	89,  // 185: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	90,  // 186: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	90,  // 187: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	91,  // 188: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 189: header.WidgetService.ListUploadedImage:input_type -> common.Id
	91,  // 190: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	92,  // 191: header.Bqreport.AggregateConversations:input_type -> bqreport.ConversationFilter
	93,  // 192: header.Bqreport.AggregateConversationRates:input_type -> bqreport.DimensionFilter
	93,  // 193: header.Bqreport.AggregateConversationTags:input_type -> bqreport.DimensionFilter
	94,  // 194: header.Bqreport.AggregateConversationAgents:input_type -> bqreport.ConversationAgentFilter
	93,  // 195: header.Bqreport.AggregateMessageOfAgents:input_type -> bqreport.DimensionFilter
	93,  // 196: header.Bqreport.AggregateAgentAvailabilities:input_type -> bqreport.DimensionFilter
	1,   // 197: header.Bizbot.ListBots:input_type -> common.Id
	1,   // 198: header.Bizbot.GetBot:input_type -> common.Id
	95,  // 199: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	95,  // 200: header.Bizbot.CreateBot:input_type -> header.Bot
	95,  // 201: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 202: header.Bizbot.DeleteBot:input_type -> common.Id
	96,  // 203: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	96,  // 204: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	96,  // 205: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	96,  // 206: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	97,  // 207: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	98,  // 208: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	95,  // 209: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 210: header.Bizbot.ListBotRevisions:input_type -> common.Id
	99,  // 211: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	99,  // 216: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 217: header.Sendback.UpdateWebhookSecret:input_type -> common.Id
	100, // 218: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	...
	101, // 237: header.AccountMgr.ListAgents:output_type -> account.Agents
	102, // 238: header.AccountMgr.CountAccount:output_type -> account.Count
	29,  // 239: header.AccountMgr.DeleteGroup:output_type -> common.Empty
	103, // 240: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	29,  // 241: header.AccountMgr.AddAgentToGroup:output_type -> common.Empty
	29,  // 242: header.AccountMgr.RemoveAgentFromGroup:output_type -> common.Empty
	4,   // 243: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	4,   // 244: header.AccountMgr.IntegrateBot:output_type -> account.Agent
	104, // 245: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 246: header.AccountMgr.TransferOwner:output_type -> account.Agent
	29,  // 247: header.AccountMgr.UpdatePerm:output_type -> common.Empty
	105, // 248: header.AccountMgr.ReadPerm:output_type -> common.Permission
	106, // 249: header.UserMgr.SearchUsers:output_type -> header.UserSearchResult
	107, // 250: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	107, // 251: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	15,  // 252: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 253: header.UserMgr.CreateUser:output_type -> common.Id
	1,   // 254: header.UserMgr.UpdateUser:output_type -> common.Id
	16,  // 255: header.UserMgr.ReadUser:output_type -> header.User
	108, // 256: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	109, // 257: header.UserMgr.SearchNote:output_type -> header.SearchNoteResponse
	110, // 258: header.UserMgr.MatchUsers:output_type -> header.Users
	111, // 259: header.LiveMgr.SearchLocations:output_type -> header.Locations
	110, // 260: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	112, // 261: header.LiveMgr.TopEvents:output_type -> header.Events
	113, // 262: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	114, // 263: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	115, // 264: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	116, // 265: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	117, // 266: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	118, // 267: header.NoteMgr.ListNotes:output_type -> header.Notes
	25,  // 268: header.NoteMgr.AddNote:output_type -> header.Note
	25,  // 269: header.NoteMgr.UpdateNote:output_type -> header.Note
	29,  // 270: header.NoteMgr.DeleteNote:output_type -> common.Empty
	25,  // 271: header.NoteMgr.GetNote:output_type -> header.Note
	109, // 272: header.NoteMgr.SearchNote:output_type -> header.SearchNoteResponse
	119, // 273: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	28,  // 274: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	29,  // 275: header.AutomationMgr.DeleteAutomation:output_type -> common.Empty
	28,  // 276: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	28,  // 277: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	120, // 278: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	30,  // 279: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	30,  // 280: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	29,  // 281: header.AttributeMgr.DeleteAttributeDefinition:output_type -> common.Empty
	121, // 282: header.ConversationReporter.CountConversationsByTags:output_type -> conversation.CountByTagsResponse
	122, // 283: header.ConversationReporter.GetAvgResponseTimes:output_type -> conversation.AvgResponseTimeResponse
	123, // 284: header.ConversationReporter.GetTotalConversation:output_type -> conversation.TotalConversationResponse
	124, // 285: header.ConversationReporter.ReportConversations:output_type -> conversation.ReportResponse
	124, // 286: header.ConversationReporter.ReportConversations2:output_type -> conversation.ReportResponse
	124, // 287: header.ConversationReporter.ReportAvailibilities:output_type -> conversation.ReportResponse
	125, // 288: header.AgentPresenceMgr.ReadPresence:output_type -> account.Presence
	125, // 289: header.AgentPresenceMgr.UpdatePresence:output_type -> account.Presence
	...
	126, // 294: header.RuleMgr.ListRules:output_type -> header.Route
	127, // 295: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	128, // 301: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	128, // 302: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	129, // 309: header.ConversationMgr.SearchConversation:output_type -> conversation.SearchConversationResponse
	130, // 310: header.ConversationMgr.ListConversations2:output_type -> conversation.ConversationListResponse
	...
	131, // 321: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	132, // 326: header.TagMgr.ListTags:output_type -> header.Tags
	51,  // 327: header.TagMgr.GetTag:output_type -> header.Tag
	29,  // 328: header.IntegrationMgr.Deintegrate:output_type -> common.Empty
	133, // 329: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	52,  // 330: header.IntegrationMgr.Integrate:output_type -> header.Integration
	53,  // 331: header.ClientMgr.Create:output_type -> header.Client
	53,  // 332: header.ClientMgr.Update:output_type -> header.Client
	53,  // 333: header.ClientMgr.Read:output_type -> header.Client
	134, // 334: header.ClientMgr.ListIntegratedClients:output_type -> header.AuthorizedClient
	134, // 335: header.ClientMgr.ListAuthorizedClients:output_type -> header.AuthorizedClient
	112, // 336: header.EventMgr.SearchEvents:output_type -> header.Events
	39,  // 337: header.EventMgr.CreateEvent:output_type -> header.Event
	39,  // 338: header.ConversationEventReader.SendMessage:output_type -> header.Event
	39,  // 339: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	112, // 340: header.ConversationEventReader.ListEvents:output_type -> header.Events
	112, // 341: header.ConversationEventReader.SearchEvents:output_type -> header.Events
	135, // 342: header.FileMgr.Presign:output_type -> header.PresignResult
	136, // 343: header.FileMgr.Read:output_type -> header.File
	136, // 344: header.FileMgr.Uploaded:output_type -> header.File
	60,  // 345: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	60,  // 346: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	29,  // 347: header.Noti5Service.Noti:output_type -> common.Empty
	29,  // 348: header.Noti5Service.AddToken:output_type -> common.Empty
	29,  // 349: header.Noti5Service.RemoveToken:output_type -> common.Empty
	29,  // 350: header.Noti5Service.CheckTokenExists:output_type -> common.Empty
	63,  // 351: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 352: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	68,  // 353: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	65,  // 354: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	65,  // 355: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	66,  // 356: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	66,  // 357: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	29,  // 358: header.PaymentMgr.DeletePaymentMethod:output_type -> common.Empty
	138, // 359: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	63,  // 360: header.PaymentMgr.Pay:output_type -> payment.Bill
	68,  // 361: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	68,  // 362: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 363: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	68,  // 364: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	68,  // 365: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 366: header.PaymentMgr.ListComments:output_type -> payment.Comments
	72,  // 367: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 368: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	76,  // 369: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	76,  // 370: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	73,  // 371: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	63,  // 372: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 373: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	75,  // 374: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	75,  // 375: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	29,  // 376: header.PaymentMgr.UsePromotionCode:output_type -> common.Empty
	75,  // 377: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	143, // 378: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	29,  // 379: header.PaymentMgr.DeletePromotionCode:output_type -> common.Empty
	80,  // 380: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	80,  // 381: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 382: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	80,  // 383: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	145, // 384: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	146, // 385: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	147, // 386: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	29,  // 387: header.PaymentMgr.PaidForAgentReferrer:output_type -> common.Empty
	29,  // 388: header.Pubsub.Publish:output_type -> common.Empty
	29,  // 389: header.Realtime.ShardSend:output_type -> common.Empty
	83,  // 390: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	83,  // 391: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	148, // 392: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	149, // 393: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	84,  // 394: header.WidgetService.Read:output_type -> header.WidgetSetting
	84,  // 395: header.WidgetService.Update:output_type -> header.WidgetSetting
	150, // 396: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	85,  // 397: header.WidgetService.ReadCampaign:output_type -> header.Campaign
	151, // 398: header.WidgetService.ListCampaigns:output_type -> header.Campaigns
	85,  // 399: header.WidgetService.CreateCampaign:output_type -> header.Campaign
	85,  // 400: header.WidgetService.UpdateCampaign:output_type -> header.Campaign
	29,  // 401: header.WidgetService.DeleteCampaign:output_type -> common.Empty
	86,  // 402: header.WidgetService.SubmitImpression:output_type -> header.Impression
	87,  // 403: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	88,  // 404: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	152, // 405: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	153, // 406: header.WidgetService.ListConversions:output_type -> header.Conversions
	154, // 407: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	91,  // 408: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	155, // 409: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	29,  // 410: header.WidgetService.DeleteUploadedImage:output_type -> common.Empty
	156, // 411: header.Bqreport.AggregateConversations:output_type -> bqreport.ConversationReport
	157, // 412: header.Bqreport.AggregateConversationRates:output_type -> bqreport.ConversationRateReport
	158, // 413: header.Bqreport.AggregateConversationTags:output_type -> bqreport.ConversationTagReport
	159, // 414: header.Bqreport.AggregateConversationAgents:output_type -> bqreport.ConversationAgentReport
	160, // 415: header.Bqreport.AggregateMessageOfAgents:output_type -> bqreport.MessageOfAgentReport
	161, // 416: header.Bqreport.AggregateAgentAvailabilities:output_type -> bqreport.AgentAvailabilityReport
	162, // 417: header.Bizbot.ListBots:output_type -> header.Bots
	95,  // 418: header.Bizbot.GetBot:output_type -> header.Bot
	95,  // 419: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	95,  // 420: header.Bizbot.CreateBot:output_type -> header.Bot
	95,  // 421: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	163, // 427: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	164, // 428: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	95,  // 429: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	162, // 430: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	99,  // 431: header.Sendback.CreateWebhook:output_type -> header.Webhook
	165, // 432: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	29,  // 433: header.Sendback.DeleteWebhook:output_type -> common.Empty
	166, // 434: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	99,  // 435: header.Sendback.ReadWebhook:output_type -> header.Webhook
	99,  // 436: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	99,  // 437: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	167, // 438: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
