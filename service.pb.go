...
var file_service_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x32, 0xc6, 0x01,
	...
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x0f, 0x44, 0x6f, 0x77,
	0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x0a, 0x2e, 0x68,
	...
	0x74, 0x72, 0x69, 0x63, 0x73, 0x32, 0xf5, 0x01, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72,
	0x12, 0x2d, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73,
	...
	0x2a, 0x0a, 0x0b, 0x52, 0x65, 0x61, 0x64, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x0a,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*UserReportResult)(nil),                  // 113: header.UserReportResult
	(*UserEventMetrics)(nil),                  // 114: header.UserEventMetrics
	...
	(*Products)(nil),                          // 175: header.Products
}
var file_service_proto_depIdxs = []int32{
	...
	1,   // 130: header.FileMgr.DownloadFileUrl:input_type -> header.Id
	1,   // 131: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	54,  // 132: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	55,  // 133: header.Noti5Service.Noti:input_type -> header.PushNoti
	56,  // 134: header.Noti5Service.AddToken:input_type -> noti5.Token
	56,  // 135: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	56,  // 136: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	57,  // 137: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	58,  // 138: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	59,  // 139: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	59,  // 140: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 141: header.PaymentMgr.GetSubscription:input_type -> header.Id
	60,  // 142: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	60,  // 143: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	61,  // 146: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	62,  // 147: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	62,  // 148: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	63,  // 149: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	59,  // 150: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	64,  // 151: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	65,  // 152: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	66,  // 153: header.PaymentMgr.AddComment:input_type -> payment.Comment
	31,  // 154: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 155: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	62,  // 156: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	67,  // 157: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	61,  // 158: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	68,  // 159: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	69,  // 160: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	70,  // 161: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	71,  // 162: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	71,  // 163: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	72,  // 164: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 165: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	73,  // 166: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 167: header.PaymentMgr.GetReferral:input_type -> header.Id
	31,  // 168: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	74,  // 169: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	75,  // 173: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	76,  // 174: header.Pubsub.Publish:input_type -> header.PublishMessage
	76,  // 175: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 176: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	77,  // 177: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	78,  // 181: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	79,  // 184: header.WidgetService.SubmitImpression:input_type -> header.Impression
	80,  // 185: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	81,  // 186: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	82,  // 187: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	83,  // 188: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	83,  // 189: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	84,  // 190: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 191: header.WidgetService.ListUploadedImage:input_type -> header.Id
	84,  // 192: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 193: header.WidgetService.ListWebPlugins:input_type -> header.Id
	85,  // 194: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	85,  // 195: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	85,  // 196: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 197: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	85,  // 198: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	86,  // 201: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	87,  // 207: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	87,  // 208: header.Bizbot.CreateBot:input_type -> header.Bot
	87,  // 209: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 210: header.Bizbot.DeleteBot:input_type -> header.Id
	88,  // 211: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	88,  // 212: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	88,  // 213: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	88,  // 214: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	89,  // 215: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	90,  // 216: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	87,  // 217: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 218: header.Bizbot.ListBotRevisions:input_type -> header.Id
	91,  // 219: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	91,  // 224: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 225: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	92,  // 226: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	93,  // 227: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	37,  // 228: header.Sendback.SendWebhookEvent:input_type -> header.Event
	94,  // 229: header.Notibox.Send:input_type -> header.Notification
	1,   // 230: header.Notibox.MarkRead:input_type -> header.Id
	95,  // 231: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	96,  // 232: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	97,  // 233: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 234: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 235: header.Watchhttp.ListWebpages:input_type -> header.Id
	97,  // 236: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 237: header.Watchhttp.ReadWebpage:input_type -> header.Id
	98,  // 238: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	99,  // 239: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	100, // 240: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	100, // 241: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	...
	101, // 247: header.Holap.FreeAccount:input_type -> header.AccountImage
	102, // 248: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	103, // 249: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	102, // 250: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	103, // 251: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	104, // 252: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	...
	105, // 257: header.Proder.CreateProduct:input_type -> header.Product
	105, // 258: header.Proder.UpdateProduct:input_type -> header.Product
	...
	106, // 277: header.AccountMgr.ListAgents:output_type -> account.Agents
	31,  // 278: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	107, // 279: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	...
	108, // 283: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	109, // 286: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	31,  // 287: header.AccountMgr.LogoutSession:output_type -> header.Empty
	110, // 288: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	111, // 291: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	112, // 292: header.UserMgr.SearchUsers:output_type -> header.Users
	...
	113, // 298: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	114, // 299: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	112, // 300: header.UserMgr.MatchUsers:output_type -> header.Users
	...
	115, // 305: header.UserMgr.ListViews:output_type -> header.UserViews
	21,  // 306: header.UserMgr.UpsertLabel:output_type -> header.Label
	31,  // 307: header.UserMgr.DeleteLabel:output_type -> header.Empty
	116, // 308: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	112, // 314: header.UserPersist.ListUsersInView:output_type -> header.Users
	...
	117, // 317: header.LiveMgr.SearchLocations:output_type -> header.Locations
	112, // 318: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	118, // 319: header.LiveMgr.TopEvents:output_type -> header.Events
	119, // 320: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	120, // 321: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	121, // 322: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	122, // 323: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	123, // 324: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	124, // 325: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	125, // 329: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	...
	126, // 334: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	127, // 338: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	...
	128, // 343: header.RuleMgr.ListRules:output_type -> header.Route
	129, // 344: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	130, // 349: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	130, // 350: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	130, // 357: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	131, // 365: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	...
	132, // 370: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	133, // 375: header.TagMgr.ListTags:output_type -> header.Tags
	47,  // 376: header.TagMgr.GetTag:output_type -> header.Tag
	31,  // 377: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	134, // 378: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	48,  // 379: header.IntegrationMgr.Integrate:output_type -> header.Integration
	118, // 380: header.EventMgr.SearchEvents:output_type -> header.Events
	...
	118, // 386: header.ConversationEventReader.ListEvents:output_type -> header.Events
	135, // 387: header.FileMgr.Presign:output_type -> header.PresignResult
	136, // 388: header.FileMgr.Read:output_type -> header.File
	136, // 389: header.FileMgr.Uploaded:output_type -> header.File
	136, // 390: header.FileMgr.DownloadFileUrl:output_type -> header.File
	54,  // 391: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	54,  // 392: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	...
	57,  // 397: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 398: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	62,  // 399: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	59,  // 400: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	59,  // 401: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	60,  // 402: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	60,  // 403: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	31,  // 404: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	138, // 405: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	57,  // 406: header.PaymentMgr.Pay:output_type -> payment.Bill
	62,  // 407: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	62,  // 408: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 409: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	62,  // 410: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	62,  // 411: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 412: header.PaymentMgr.ListComments:output_type -> payment.Comments
	66,  // 413: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 414: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	70,  // 415: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	70,  // 416: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	67,  // 417: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	57,  // 418: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 419: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	69,  // 420: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	69,  // 421: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	31,  // 422: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	69,  // 423: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	143, // 424: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	31,  // 425: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	74,  // 426: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	74,  // 427: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 428: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	74,  // 429: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	145, // 430: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	146, // 431: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	147, // 432: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	77,  // 436: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	77,  // 437: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	148, // 438: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	149, // 439: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	78,  // 440: header.WidgetService.Read:output_type -> header.WidgetSetting
	78,  // 441: header.WidgetService.Update:output_type -> header.WidgetSetting
	150, // 442: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	151, // 443: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	79,  // 444: header.WidgetService.SubmitImpression:output_type -> header.Impression
	80,  // 445: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	81,  // 446: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	152, // 447: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	153, // 448: header.WidgetService.ListConversions:output_type -> header.Conversions
	154, // 449: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	84,  // 450: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	155, // 451: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	31,  // 452: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	156, // 453: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	85,  // 454: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	85,  // 455: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	85,  // 456: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	31,  // 457: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	85,  // 458: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	156, // 459: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	31,  // 460: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	157, // 461: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	155, // 462: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	158, // 463: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	159, // 464: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	160, // 465: header.Bizbot.ListBots:output_type -> header.Bots
	87,  // 466: header.Bizbot.GetBot:output_type -> header.Bot
	87,  // 467: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	87,  // 468: header.Bizbot.CreateBot:output_type -> header.Bot
	87,  // 469: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	161, // 475: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	162, // 476: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	87,  // 477: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	160, // 478: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	91,  // 479: header.Sendback.CreateWebhook:output_type -> header.Webhook
	163, // 480: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	31,  // 481: header.Sendback.DeleteWebhook:output_type -> header.Empty
	164, // 482: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	91,  // 483: header.Sendback.ReadWebhook:output_type -> header.Webhook
	91,  // 484: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	91,  // 485: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	165, // 486: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	166, // 487: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	...
	167, // 492: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	97,  // 493: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	31,  // 494: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	168, // 495: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	97,  // 496: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	97,  // 497: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	169, // 498: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	170, // 499: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	171, // 500: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	169, // 501: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	...
	172, // 508: header.Holap.ReportUser:output_type -> header.UserMetrics
	173, // 509: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 510: header.Holap.ListUserIds:output_type -> header.Ids
	130, // 511: header.Holap.ListConversationIds:output_type -> header.Conversations
	174, // 512: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	19,  // 513: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	114, // 514: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	175, // 515: header.Proder.ListProducts:output_type -> header.Products
	105, // 516: header.Proder.ReadProduct:output_type -> header.Product
	105, // 517: header.Proder.CreateProduct:output_type -> header.Product
	105, // 518: header.Proder.UpdateProduct:output_type -> header.Product
...
type FileMgrClient interface {
	...
	DownloadFileUrl(ctx context.Context, in *Id, opts ...grpc.CallOption) (*File, error)
}
...
func (c *fileMgrClient) DownloadFileUrl(ctx context.Context, in *Id, opts ...grpc.CallOption) (*File, error) {
	out := new(File)
...
type FileMgrServer interface {
	...
	DownloadFileUrl(context.Context, *Id) (*File, error)
}
...
func (*UnimplementedFileMgrServer) DownloadFileUrl(context.Context, *Id) (*File, error) {
...
func _FileMgr_DownloadFileUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileMgrServer).DownloadFileUrl(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
