...
var file_service_proto_rawDesc = []byte{
	...
	0x90, 0x19, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x64, 0x73, 0x32, 0xab, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x4d,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x54, 0x61, 0x67, 0x32, 0x7a, 0x0a, 0x08, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x4d, 0x67, 0x72, 0x12, 0x3d, 0x0a, 0x0c, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x2f, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x11, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xaf, 0x01, 0x0a, 0x07, 0x46, 0x69, 0x6c, 0x65, 0x4d,
...
var file_service_proto_depIdxs = []int32{
	...
	37,  // 205: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	...
	124, // 320: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 321: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 322: header.Watchhttp.ListWebpages:input_type -> header.Id
	124, // 323: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 324: header.Watchhttp.ReadWebpage:input_type -> header.Id
	125, // 325: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	126, // 326: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	127, // 327: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	127, // 328: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 329: header.Holap.AppendAgentSet:input_type -> account.Agent
	71,  // 330: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 331: header.Holap.UpdateUser:input_type -> header.User
	54,  // 332: header.Holap.UpdateConversation:input_type -> header.Conversation
	38,  // 333: header.Holap.OnConversationEvent:input_type -> header.Event
	128, // 334: header.Holap.FreeAccount:input_type -> header.AccountImage
	129, // 335: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	130, // 336: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	129, // 337: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	130, // 338: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	131, // 339: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 340: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	31,  // 341: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	21,  // 342: header.Holap.UpdateOrder:input_type -> header.Order
	132, // 343: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	133, // 344: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	133, // 345: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	36,  // 346: header.Proder.ReadProduct:input_type -> header.Product
	36,  // 347: header.Proder.CreateProduct:input_type -> header.Product
	36,  // 348: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 349: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 350: header.Proder.RestoreProduct:input_type -> header.Id
	134, // 351: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 352: header.Proder.ListProductIds:input_type -> header.Ids
	134, // 353: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	135, // 354: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 355: header.Proder.ListProductCollections:input_type -> header.Ids
	136, // 356: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	136, // 357: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 358: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 359: header.Proder.ListProductFeeds:input_type -> header.Id
	137, // 360: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	137, // 361: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 362: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 363: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 364: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 365: header.Proder.ReadOrder:input_type -> header.Id
	21,  // 366: header.Proder.CreateOrder:input_type -> header.Order
	21,  // 367: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 368: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 369: header.Proder.RestoreOrder:input_type -> header.Id
	138, // 370: header.Proder.ListOrders:input_type -> header.OrdersRequest
	138, // 371: header.Proder.CountOrders:input_type -> header.OrdersRequest
	139, // 372: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	140, // 373: header.Proder.ImportOrders:input_type -> header.Orders
	141, // 374: header.Proder.MakeOrderPayment:input_type -> header.Bill
	142, // 375: header.Proder.DeleteOrderPayment:input_type -> header.Key
	38,  // 376: header.Proder.AddOrderComment:input_type -> header.Event
	38,  // 377: header.Proder.EditOrderComment:input_type -> header.Event
	142, // 378: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 379: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 380: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 381: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 382: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 383: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	145, // 384: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	146, // 385: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	147, // 386: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	148, // 387: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 388: header.Proder.ShipOrder:input_type -> header.Id
	21,  // 389: header.Proder.UpdateShippingCode:input_type -> header.Order
	4,   // 390: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 391: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 392: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 393: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 394: header.Proder.UnfollowOrder:input_type -> header.Id
	52,  // 395: header.Proder.TagOrder:input_type -> header.TagRequest
	52,  // 396: header.Proder.UntagOrder:input_type -> header.TagRequest
	4,   // 397: header.Apiece.ReadTask:input_type -> header.Id
	149, // 398: header.Apiece.CreateTask:input_type -> header.Task
	149, // 399: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 400: header.Apiece.DeleteTask:input_type -> header.Id
	150, // 401: header.Apiece.ListTasks:input_type -> header.TasksRequest
	38,  // 402: header.Apiece.AddTaskComment:input_type -> header.Event
	38,  // 403: header.Apiece.EditTaskComment:input_type -> header.Event
	142, // 404: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 405: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 406: header.Apiece.ReadPipeline:input_type -> header.Id
	151, // 407: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	151, // 408: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 409: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 410: header.Apiece.ListPipelines:input_type -> header.Ids
	152, // 411: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	153, // 412: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	47,  // 413: header.Search.Index:output_type -> header.Empty
	154, // 414: header.Search.Search:output_type -> header.DocSearchResponse
	47,  // 415: header.Search.AddOwner:output_type -> header.Empty
	155, // 416: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 417: header.Map.LookupAddress:output_type -> header.Address
	156, // 418: header.Map.PredictAddress:output_type -> header.Addresses
	156, // 419: header.Map.ListDistricts:output_type -> header.Addresses
	156, // 420: header.Map.ListProvinces:output_type -> header.Addresses
	156, // 421: header.Map.ListWards:output_type -> header.Addresses
	156, // 422: header.Map.ListStreets:output_type -> header.Addresses
	156, // 423: header.Map.ListAddresses:output_type -> header.Addresses
	19,  // 424: header.Map.ReadAddress:output_type -> header.Address
	6,   // 425: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 426: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 427: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	47,  // 428: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 429: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 430: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 431: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	47,  // 432: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 433: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 434: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 435: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 436: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 437: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 438: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 439: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 440: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 441: header.AccountMgr.CreateAccount:output_type -> account.Account
	157, // 442: header.AccountMgr.ListAgents:output_type -> account.Agents
	47,  // 443: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	158, // 444: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 445: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	159, // 446: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 447: header.AccountMgr.TransferOwner:output_type -> account.Agent
	14,  // 448: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	160, // 449: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	160, // 450: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	47,  // 451: header.AccountMgr.LogoutSession:output_type -> header.Empty
	14,  // 452: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	161, // 453: header.AccountMgr.GetLanguage:output_type -> header.Lang
	15,  // 454: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	16,  // 455: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	162, // 456: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	18,  // 457: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	18,  // 458: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	163, // 459: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	47,  // 460: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	156, // 461: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	19,  // 462: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	19,  // 463: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	47,  // 464: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	164, // 465: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	20,  // 466: header.AccountMgr.CreateTax:output_type -> header.Tax
	20,  // 467: header.AccountMgr.UpdateTax:output_type -> header.Tax
	47,  // 468: header.AccountMgr.DeleteTax:output_type -> header.Empty
	165, // 469: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	165, // 470: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	22,  // 471: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	22,  // 472: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	47,  // 473: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	23,  // 474: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	166, // 475: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	23,  // 476: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	47,  // 477: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	167, // 478: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 479: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 480: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	47,  // 481: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	47,  // 482: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	168, // 483: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	47,  // 484: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 485: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 486: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 487: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	169, // 488: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	26,  // 489: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	47,  // 490: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	27,  // 491: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	170, // 492: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	30,  // 493: header.UserMgr.MergeUser:output_type -> header.User
	47,  // 494: header.UserMgr.DetachUser:output_type -> header.Empty
	4,   // 495: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 496: header.UserMgr.CreateUserFromWeb:output_type -> header.Id
	4,   // 497: header.UserMgr.UpdateUser:output_type -> header.Id
	30,  // 498: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 499: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	171, // 500: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	29,  // 501: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 502: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 503: header.UserMgr.CreateView:output_type -> header.UserView
	47,  // 504: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 505: header.UserMgr.GetView:output_type -> header.UserView
	172, // 506: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 507: header.UserMgr.UpsertLabel:output_type -> header.Label
	47,  // 508: header.UserMgr.DeleteLabel:output_type -> header.Empty
	173, // 509: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 510: header.UserMgr.GetLabel:output_type -> header.Label
	47,  // 511: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	47,  // 512: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	47,  // 513: header.UserMgr.AddUserLabel:output_type -> header.Empty
	47,  // 514: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	47,  // 515: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	19,  // 516: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	19,  // 517: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	47,  // 518: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	174, // 519: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	47,  // 520: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	29,  // 521: header.UserMgr.ListLeads:output_type -> header.Users
	175, // 522: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	29,  // 523: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	29,  // 524: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	36,  // 525: header.UserMgr.LinkProductUrl:output_type -> header.Product
	101, // 526: header.UserMgr.ListUserEvents:output_type -> header.Events
	38,  // 527: header.UserMgr.CreateUserEvent:output_type -> header.Event
	39,  // 528: header.UserMgr.FillDevice:output_type -> common.Device
	176, // 529: header.LiveMgr.SearchLocations:output_type -> header.Locations
	29,  // 530: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	101, // 531: header.LiveMgr.TopEvents:output_type -> header.Events
	177, // 532: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	178, // 533: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	179, // 534: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	180, // 535: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	181, // 536: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	182, // 537: header.NoteMgr.ListNotes:output_type -> header.Notes
	45,  // 538: header.NoteMgr.AddNote:output_type -> header.Note
	45,  // 539: header.NoteMgr.UpdateNote:output_type -> header.Note
	47,  // 540: header.NoteMgr.DeleteNote:output_type -> header.Empty
	183, // 541: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	48,  // 542: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	48,  // 543: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	184, // 544: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 545: header.ConversationMgr.PongMessage:output_type -> header.Event
	54,  // 546: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	54,  // 547: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	54,  // 548: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	185, // 549: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	185, // 550: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	47,  // 551: header.ConversationMgr.TagConversation:output_type -> header.Empty
	47,  // 552: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	47,  // 553: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	47,  // 554: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	47,  // 555: header.ConversationMgr.Typing:output_type -> header.Empty
	54,  // 556: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	185, // 557: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	47,  // 558: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	47,  // 559: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	47,  // 560: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	47,  // 561: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	56,  // 562: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	56,  // 563: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 564: header.ConversationMgr.TerminateBot:output_type -> header.Event
	38,  // 565: header.ConversationMgr.SendMessage:output_type -> header.Event
	38,  // 566: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	47,  // 567: header.ConversationMgr.PinMessage:output_type -> header.Empty
	47,  // 568: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	101, // 569: header.ConversationMgr.ListEvents:output_type -> header.Events
	47,  // 570: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	186, // 571: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	59,  // 572: header.ConversationMgr.Integrate:output_type -> header.Integration
	59,  // 573: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	60,  // 574: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	60,  // 575: header.ConversationMgr.CreateRule:output_type -> header.Rule
	47,  // 576: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	60,  // 577: header.ConversationMgr.ReadRule:output_type -> header.Rule
	187, // 578: header.ConversationMgr.ListRules:output_type -> header.Route
	188, // 579: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	61,  // 580: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	47,  // 581: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	61,  // 582: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	189, // 583: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	62,  // 584: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	62,  // 585: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	47,  // 586: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	62,  // 587: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	59,  // 588: header.ConversationMgr.TestNumber:output_type -> header.Integration
	190, // 589: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	63,  // 590: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	64,  // 591: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	191, // 592: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	47,  // 593: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	192, // 594: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	65,  // 595: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	54,  // 596: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	47,  // 597: header.ConversationMgr.PingAppPhone:output_type -> header.Empty
	47,  // 598: header.ConversationMgr.ReplyRingRequest:output_type -> header.Empty
	193, // 599: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	67,  // 600: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	67,  // 601: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	47,  // 602: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	67,  // 603: header.TemplateMgr.GetTemplate:output_type -> header.Template
	194, // 604: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	47,  // 605: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	69,  // 606: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	69,  // 607: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	47,  // 608: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	69,  // 609: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	195, // 610: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	196, // 611: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	71,  // 612: header.TagMgr.CreateTag:output_type -> header.Tag
	71,  // 613: header.TagMgr.UpdateTag:output_type -> header.Tag
	47,  // 614: header.TagMgr.DeleteTag:output_type -> header.Empty
	197, // 615: header.TagMgr.ListTags:output_type -> header.Tags
	71,  // 616: header.TagMgr.GetTag:output_type -> header.Tag
	101, // 617: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 618: header.EventMgr.CreateEvent:output_type -> header.Event
	198, // 619: header.FileMgr.Presign:output_type -> header.PresignResult
	199, // 620: header.FileMgr.Uploaded:output_type -> header.File
	199, // 621: header.FileMgr.DownloadFileUrl:output_type -> header.File
	76,  // 622: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	76,  // 623: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	47,  // 624: header.Noti5Service.Noti:output_type -> header.Empty
	47,  // 625: header.Noti5Service.AddToken:output_type -> header.Empty
	47,  // 626: header.Noti5Service.RemoveToken:output_type -> header.Empty
	47,  // 627: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	79,  // 628: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	200, // 629: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	84,  // 630: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	81,  // 631: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	81,  // 632: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	82,  // 633: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	82,  // 634: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	47,  // 635: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	201, // 636: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	79,  // 637: header.PaymentMgr.Pay:output_type -> payment.Bill
	84,  // 638: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	84,  // 639: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	202, // 640: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	84,  // 641: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	84,  // 642: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	203, // 643: header.PaymentMgr.ListComments:output_type -> payment.Comments
	88,  // 644: header.PaymentMgr.AddComment:output_type -> payment.Comment
	204, // 645: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	92,  // 646: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	92,  // 647: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	89,  // 648: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	79,  // 649: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	205, // 650: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	91,  // 651: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	91,  // 652: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	47,  // 653: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	91,  // 654: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	206, // 655: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	47,  // 656: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	96,  // 657: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	96,  // 658: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	207, // 659: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	96,  // 660: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	208, // 661: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	209, // 662: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	210, // 663: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	47,  // 664: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	47,  // 665: header.Pubsub.Publish:output_type -> header.Empty
	99,  // 666: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	99,  // 667: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	211, // 668: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	212, // 669: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	100, // 670: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	47,  // 671: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	47,  // 672: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	213, // 673: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	47,  // 674: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	47,  // 675: header.ZalokonService.SendZns:output_type -> header.Empty
	47,  // 676: header.MailkonService.SendEvent:output_type -> header.Empty
	47,  // 677: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	47,  // 678: header.MailkonService.BlockEmail:output_type -> header.Empty
	47,  // 679: header.MailkonService.UnblockEmail:output_type -> header.Empty
	104, // 680: header.WidgetService.Read:output_type -> header.WidgetSetting
	104, // 681: header.WidgetService.Update:output_type -> header.WidgetSetting
	214, // 682: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	215, // 683: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	105, // 684: header.WidgetService.SubmitImpression:output_type -> header.Impression
	106, // 685: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	107, // 686: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	216, // 687: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	217, // 688: header.WidgetService.ListConversions:output_type -> header.Conversions
	218, // 689: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	110, // 690: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	219, // 691: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	47,  // 692: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	220, // 693: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	111, // 694: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	111, // 695: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	111, // 696: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	47,  // 697: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	111, // 698: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	220, // 699: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	47,  // 700: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	221, // 701: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	219, // 702: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	222, // 703: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	223, // 704: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	224, // 705: header.Bizbot.ListBots:output_type -> header.Bots
	113, // 706: header.Bizbot.GetBot:output_type -> header.Bot
	113, // 707: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	113, // 708: header.Bizbot.CreateBot:output_type -> header.Bot
	113, // 709: header.Bizbot.UpdateBot:output_type -> header.Bot
	47,  // 710: header.Bizbot.DeleteBot:output_type -> header.Empty
	47,  // 711: header.Bizbot.OnEvent:output_type -> header.Empty
	47,  // 712: header.Bizbot.StartBot:output_type -> header.Empty
	47,  // 713: header.Bizbot.StopBot:output_type -> header.Empty
	47,  // 714: header.Bizbot.TryAction:output_type -> header.Empty
	225, // 715: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	226, // 716: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	227, // 717: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	228, // 718: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	119, // 719: header.Sendback.CreateWebhook:output_type -> header.Webhook
	229, // 720: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	47,  // 721: header.Sendback.DeleteWebhook:output_type -> header.Empty
	230, // 722: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	119, // 723: header.Sendback.ReadWebhook:output_type -> header.Webhook
	119, // 724: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	119, // 725: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	231, // 726: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	232, // 727: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	47,  // 728: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	47,  // 729: header.Notibox.SendNoti:output_type -> header.Empty
	233, // 730: header.Notibox.ListNoties:output_type -> header.Notifications
	47,  // 731: header.Notibox.MarkReadNoti:output_type -> header.Empty
	124, // 732: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	47,  // 733: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	234, // 734: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	124, // 735: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	124, // 736: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	235, // 737: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	236, // 738: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	237, // 739: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	235, // 740: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	47,  // 741: header.Holap.AppendAgentSet:output_type -> header.Empty
	47,  // 742: header.Holap.AppendTagSet:output_type -> header.Empty
	47,  // 743: header.Holap.UpdateUser:output_type -> header.Empty
	47,  // 744: header.Holap.UpdateConversation:output_type -> header.Empty
	47,  // 745: header.Holap.OnConversationEvent:output_type -> header.Empty
	47,  // 746: header.Holap.FreeAccount:output_type -> header.Empty
	238, // 747: header.Holap.ReportUser:output_type -> header.UserMetrics
	239, // 748: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 749: header.Holap.ListUserIds:output_type -> header.Ids
	185, // 750: header.Holap.ListConversationIds:output_type -> header.Conversations
	240, // 751: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 752: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	171, // 753: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	47,  // 754: header.Holap.UpdateOrder:output_type -> header.Empty
	140, // 755: header.Holap.ReportOrder:output_type -> header.Orders
	241, // 756: header.Holap.ReportCall:output_type -> header.CallMetrics
	185, // 757: header.Holap.ListCallIds:output_type -> header.Conversations
	36,  // 758: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 759: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 760: header.Proder.UpdateProduct:output_type -> header.Product
	47,  // 761: header.Proder.DeleteProduct:output_type -> header.Empty
	36,  // 762: header.Proder.RestoreProduct:output_type -> header.Product
	135, // 763: header.Proder.ListProducts:output_type -> header.Products
	5,   // 764: header.Proder.ListProductIds:output_type -> header.Ids
	135, // 765: header.Proder.ListGroupedProducts:output_type -> header.Products
	135, // 766: header.Proder.ImportProducts:output_type -> header.Products
	242, // 767: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 768: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 769: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	47,  // 770: header.Proder.DeleteProductCollection:output_type -> header.Empty
	243, // 771: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 772: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 773: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	47,  // 774: header.Proder.DeleteProductFeed:output_type -> header.Empty
	244, // 775: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	245, // 776: header.Proder.ListProductProps:output_type -> header.ProductProps
	21,  // 777: header.Proder.ReadOrder:output_type -> header.Order
	21,  // 778: header.Proder.CreateOrder:output_type -> header.Order
	21,  // 779: header.Proder.UpdateOrder:output_type -> header.Order
	47,  // 780: header.Proder.DeleteOrder:output_type -> header.Empty
	21,  // 781: header.Proder.RestoreOrder:output_type -> header.Order
	140, // 782: header.Proder.ListOrders:output_type -> header.Orders
	140, // 783: header.Proder.CountOrders:output_type -> header.Orders
	47,  // 784: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	140, // 785: header.Proder.ImportOrders:output_type -> header.Orders
	38,  // 786: header.Proder.MakeOrderPayment:output_type -> header.Event
	38,  // 787: header.Proder.DeleteOrderPayment:output_type -> header.Event
	38,  // 788: header.Proder.AddOrderComment:output_type -> header.Event
	38,  // 789: header.Proder.EditOrderComment:output_type -> header.Event
	38,  // 790: header.Proder.DeleteOrderComment:output_type -> header.Event
	246, // 791: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	199, // 792: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 793: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	247, // 794: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	47,  // 795: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	248, // 796: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	47,  // 797: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	47,  // 798: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 799: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 800: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 801: header.Proder.UpdateShippingCode:output_type -> header.Order
	21,  // 802: header.Proder.CancelShippingOrder:output_type -> header.Order
	199, // 803: header.Proder.PrintShippingOrders:output_type -> header.File
	47,  // 804: header.Proder.SeenOrder:output_type -> header.Empty
	47,  // 805: header.Proder.FollowOrder:output_type -> header.Empty
	47,  // 806: header.Proder.UnfollowOrder:output_type -> header.Empty
	47,  // 807: header.Proder.TagOrder:output_type -> header.Empty
	47,  // 808: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 809: header.Apiece.ReadTask:output_type -> header.Task
	149, // 810: header.Apiece.CreateTask:output_type -> header.Task
	149, // 811: header.Apiece.UpdateTask:output_type -> header.Task
	47,  // 812: header.Apiece.DeleteTask:output_type -> header.Empty
	249, // 813: header.Apiece.ListTasks:output_type -> header.Tasks
	38,  // 814: header.Apiece.AddTaskComment:output_type -> header.Event
	38,  // 815: header.Apiece.EditTaskComment:output_type -> header.Event
	38,  // 816: header.Apiece.DeleteTaskComment:output_type -> header.Event
	250, // 817: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	151, // 818: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	151, // 819: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	151, // 820: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	47,  // 821: header.Apiece.DeletePipeline:output_type -> header.Empty
	251, // 822: header.Apiece.ListPipelines:output_type -> header.Pipelines
	152, // 823: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	412, // [412:824] is the sub-list for method output_type
	0,   // [0:412] is the sub-list for method input_type
