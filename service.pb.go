...
var file_service_proto_rawDesc = []byte{
	...
	0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x98,
	0x02, 0x0a, 0x0e, 0x5a, 0x61, 0x6c, 0x6f, 0x6b, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x69, 0x63, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_service_proto_depIdxs = []int32{
	...
	165, // 452: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	54,  // 453: header.Search.Index:output_type -> header.Empty
	166, // 454: header.Search.Search:output_type -> header.DocSearchResponse
	54,  // 455: header.Search.AddOwner:output_type -> header.Empty
	167, // 456: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 457: header.Map.LookupAddress:output_type -> header.Address
	168, // 458: header.Map.PredictAddress:output_type -> header.Addresses
	168, // 459: header.Map.ListDistricts:output_type -> header.Addresses
	168, // 460: header.Map.ListProvinces:output_type -> header.Addresses
	168, // 461: header.Map.ListWards:output_type -> header.Addresses
	168, // 462: header.Map.ListStreets:output_type -> header.Addresses
	168, // 463: header.Map.ListAddresses:output_type -> header.Addresses
	19,  // 464: header.Map.ReadAddress:output_type -> header.Address
	6,   // 465: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 466: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 467: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	54,  // 468: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 469: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 470: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 471: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	54,  // 472: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 473: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 474: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 475: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 476: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 477: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 478: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 479: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 480: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 481: header.AccountMgr.CreateAccount:output_type -> account.Account
	169, // 482: header.AccountMgr.ListAgents:output_type -> account.Agents
	54,  // 483: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	170, // 484: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 485: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	171, // 486: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 487: header.AccountMgr.TransferOwner:output_type -> account.Agent
	14,  // 488: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	172, // 489: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	172, // 490: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	54,  // 491: header.AccountMgr.LogoutSession:output_type -> header.Empty
	14,  // 492: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	173, // 493: header.AccountMgr.GetLanguage:output_type -> header.Lang
	15,  // 494: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	16,  // 495: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	174, // 496: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	18,  // 497: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	18,  // 498: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	175, // 499: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	54,  // 500: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	168, // 501: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	19,  // 502: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	19,  // 503: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	54,  // 504: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	176, // 505: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	20,  // 506: header.AccountMgr.CreateTax:output_type -> header.Tax
	20,  // 507: header.AccountMgr.UpdateTax:output_type -> header.Tax
	54,  // 508: header.AccountMgr.DeleteTax:output_type -> header.Empty
	177, // 509: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	177, // 510: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	22,  // 511: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	22,  // 512: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	54,  // 513: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	23,  // 514: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	178, // 515: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	23,  // 516: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	54,  // 517: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	179, // 518: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 519: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 520: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	54,  // 521: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	54,  // 522: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	180, // 523: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	54,  // 524: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 525: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 526: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 527: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	181, // 528: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	26,  // 529: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	54,  // 530: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	27,  // 531: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	182, // 532: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	4,   // 533: header.AccountMgr.NewID:output_type -> header.Id
	30,  // 534: header.UserMgr.MergeUser:output_type -> header.User
	54,  // 535: header.UserMgr.DetachUser:output_type -> header.Empty
	54,  // 536: header.UserMgr.DeleteUser:output_type -> header.Empty
	4,   // 537: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 538: header.UserMgr.UpdateUser:output_type -> header.Id
	30,  // 539: header.UserMgr.UpdateUser2:output_type -> header.User
	54,  // 540: header.UserMgr.RemoveUser:output_type -> header.Empty
	54,  // 541: header.UserMgr.RestoreUser:output_type -> header.Empty
	30,  // 542: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 543: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	29,  // 544: header.UserMgr.MatchUsers:output_type -> header.Users
	30,  // 545: header.UserMgr.BanUser:output_type -> header.User
	30,  // 546: header.UserMgr.UnbanUser:output_type -> header.User
	29,  // 547: header.UserMgr.LookupByPhone:output_type -> header.Users
	31,  // 548: header.UserMgr.UpdateView:output_type -> header.UserView
	31,  // 549: header.UserMgr.CreateView:output_type -> header.UserView
	54,  // 550: header.UserMgr.DeleteView:output_type -> header.Empty
	31,  // 551: header.UserMgr.GetView:output_type -> header.UserView
	183, // 552: header.UserMgr.ListViews:output_type -> header.UserViews
	32,  // 553: header.UserMgr.UpdateSegment:output_type -> header.Segment
	32,  // 554: header.UserMgr.CreateSegment:output_type -> header.Segment
	54,  // 555: header.UserMgr.DeleteSegment:output_type -> header.Empty
	32,  // 556: header.UserMgr.GetSegment:output_type -> header.Segment
	184, // 557: header.UserMgr.ListSegments:output_type -> header.Segments
	29,  // 558: header.UserMgr.ListUsers:output_type -> header.Users
	5,   // 559: header.UserMgr.ListSegmentUserIds:output_type -> header.Ids
	29,  // 560: header.UserMgr.ListAllSegmentUsers:output_type -> header.Users
	54,  // 561: header.UserMgr.AddToSegment:output_type -> header.Empty
	54,  // 562: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	54,  // 563: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	36,  // 564: header.UserMgr.UpsertLabel:output_type -> header.Label
	54,  // 565: header.UserMgr.DeleteLabel:output_type -> header.Empty
	185, // 566: header.UserMgr.ListLabels:output_type -> header.Labels
	36,  // 567: header.UserMgr.GetLabel:output_type -> header.Label
	54,  // 568: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	54,  // 569: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	54,  // 570: header.UserMgr.AddUserLabel:output_type -> header.Empty
	54,  // 571: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	54,  // 572: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	19,  // 573: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	19,  // 574: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	54,  // 575: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	186, // 576: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	54,  // 577: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	29,  // 578: header.UserMgr.ListLeads:output_type -> header.Users
	187, // 579: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	29,  // 580: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	29,  // 581: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	39,  // 582: header.UserMgr.LinkProductUrl:output_type -> header.Product
	108, // 583: header.UserMgr.ListUserEvents:output_type -> header.Events
	41,  // 584: header.UserMgr.CreateUserEvent:output_type -> header.Event
	42,  // 585: header.UserMgr.FillDevice:output_type -> common.Device
	188, // 586: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	189, // 587: header.UserMgr.ListEventTypes:output_type -> header.EventTypes
	45,  // 588: header.UserMgr.UpdateEventType:output_type -> header.EventType
	54,  // 589: header.UserMgr.LinkTask:output_type -> header.Empty
	190, // 590: header.LiveMgr.SearchLocations:output_type -> header.Locations
	29,  // 591: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	108, // 592: header.LiveMgr.TopEvents:output_type -> header.Events
	191, // 593: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	192, // 594: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	193, // 595: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	194, // 596: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	195, // 597: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	196, // 598: header.NoteMgr.ListNotes:output_type -> header.Notes
	52,  // 599: header.NoteMgr.AddNote:output_type -> header.Note
	52,  // 600: header.NoteMgr.UpdateNote:output_type -> header.Note
	54,  // 601: header.NoteMgr.DeleteNote:output_type -> header.Empty
	197, // 602: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	55,  // 603: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	55,  // 604: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	198, // 605: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	41,  // 606: header.ConversationMgr.PongMessage:output_type -> header.Event
	61,  // 607: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	61,  // 608: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	61,  // 609: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	199, // 610: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	199, // 611: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	54,  // 612: header.ConversationMgr.TagConversation:output_type -> header.Empty
	54,  // 613: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	54,  // 614: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	54,  // 615: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	54,  // 616: header.ConversationMgr.Typing:output_type -> header.Empty
	61,  // 617: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	199, // 618: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	54,  // 619: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	54,  // 620: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	54,  // 621: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	54,  // 622: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	63,  // 623: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	63,  // 624: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	41,  // 625: header.ConversationMgr.TerminateBot:output_type -> header.Event
	41,  // 626: header.ConversationMgr.SendMessage:output_type -> header.Event
	41,  // 627: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	41,  // 628: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	54,  // 629: header.ConversationMgr.PinMessage:output_type -> header.Empty
	54,  // 630: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	108, // 631: header.ConversationMgr.ListEvents:output_type -> header.Events
	54,  // 632: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	200, // 633: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	67,  // 634: header.ConversationMgr.Integrate:output_type -> header.Integration
	67,  // 635: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	68,  // 636: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	68,  // 637: header.ConversationMgr.CreateRule:output_type -> header.Rule
	54,  // 638: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	68,  // 639: header.ConversationMgr.ReadRule:output_type -> header.Rule
	201, // 640: header.ConversationMgr.ListRules:output_type -> header.Route
	202, // 641: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	69,  // 642: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	54,  // 643: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	69,  // 644: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	203, // 645: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	70,  // 646: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	70,  // 647: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	54,  // 648: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	70,  // 649: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	67,  // 650: header.ConversationMgr.TestNumber:output_type -> header.Integration
	204, // 651: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	71,  // 652: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	72,  // 653: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	205, // 654: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	54,  // 655: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	206, // 656: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	73,  // 657: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	61,  // 658: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	207, // 659: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	41,  // 660: header.ConversationMgr.SaveMessage:output_type -> header.Event
	74,  // 661: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	74,  // 662: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	54,  // 663: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	74,  // 664: header.TemplateMgr.GetTemplate:output_type -> header.Template
	208, // 665: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	54,  // 666: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	76,  // 667: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	76,  // 668: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	54,  // 669: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	76,  // 670: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	209, // 671: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	210, // 672: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	78,  // 673: header.TagMgr.CreateTag:output_type -> header.Tag
	78,  // 674: header.TagMgr.UpdateTag:output_type -> header.Tag
	54,  // 675: header.TagMgr.DeleteTag:output_type -> header.Empty
	211, // 676: header.TagMgr.ListTags:output_type -> header.Tags
	78,  // 677: header.TagMgr.GetTag:output_type -> header.Tag
	212, // 678: header.FileMgr.Presign:output_type -> header.PresignResult
	82,  // 679: header.FileMgr.Uploaded:output_type -> header.File
	82,  // 680: header.FileMgr.DownloadFileUrl:output_type -> header.File
	82,  // 681: header.FileMgr.FileAvatar:output_type -> header.File
	83,  // 682: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	83,  // 683: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	54,  // 684: header.Noti5Service.Noti:output_type -> header.Empty
	54,  // 685: header.Noti5Service.AddToken:output_type -> header.Empty
	54,  // 686: header.Noti5Service.RemoveToken:output_type -> header.Empty
	54,  // 687: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	86,  // 688: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	213, // 689: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	91,  // 690: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	88,  // 691: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	88,  // 692: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	89,  // 693: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	89,  // 694: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	54,  // 695: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	214, // 696: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	86,  // 697: header.PaymentMgr.Pay:output_type -> payment.Bill
	91,  // 698: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	91,  // 699: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	215, // 700: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	91,  // 701: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	91,  // 702: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	216, // 703: header.PaymentMgr.ListComments:output_type -> payment.Comments
	95,  // 704: header.PaymentMgr.AddComment:output_type -> payment.Comment
	217, // 705: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	99,  // 706: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	99,  // 707: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	96,  // 708: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	86,  // 709: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	218, // 710: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	98,  // 711: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	98,  // 712: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	54,  // 713: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	98,  // 714: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	219, // 715: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	54,  // 716: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	103, // 717: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	103, // 718: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	220, // 719: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	103, // 720: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	221, // 721: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	222, // 722: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	223, // 723: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	54,  // 724: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	54,  // 725: header.Pubsub.Publish:output_type -> header.Empty
	106, // 726: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	106, // 727: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	224, // 728: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	225, // 729: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	107, // 730: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	54,  // 731: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	54,  // 732: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	226, // 733: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	54,  // 734: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	54,  // 735: header.ZalokonService.SendZns:output_type -> header.Empty
	41,  // 736: header.ZalokonService.SendZNS:output_type -> header.Event
	54,  // 737: header.MailkonService.SendEmail:output_type -> header.Empty
	67,  // 738: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	54,  // 739: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	54,  // 740: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	227, // 741: header.MailkonService.VerifySenderDomain:output_type -> header.VerificationResult
	228, // 742: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	111, // 743: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	54,  // 744: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	112, // 745: header.WidgetService.Read:output_type -> header.WidgetSetting
	112, // 746: header.WidgetService.Update:output_type -> header.WidgetSetting
	229, // 747: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	230, // 748: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	113, // 749: header.WidgetService.SubmitImpression:output_type -> header.Impression
	114, // 750: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	115, // 751: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	231, // 752: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	232, // 753: header.WidgetService.ListConversions:output_type -> header.Conversions
	233, // 754: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	118, // 755: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	234, // 756: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	54,  // 757: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	235, // 758: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	119, // 759: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	119, // 760: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	119, // 761: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	54,  // 762: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	119, // 763: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	235, // 764: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	54,  // 765: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	236, // 766: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	234, // 767: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	237, // 768: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	238, // 769: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	239, // 770: header.Bizbot.ListBots:output_type -> header.Bots
	122, // 771: header.Bizbot.GetBot:output_type -> header.Bot
	122, // 772: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	122, // 773: header.Bizbot.CreateBot:output_type -> header.Bot
	122, // 774: header.Bizbot.UpdateBot:output_type -> header.Bot
	54,  // 775: header.Bizbot.DeleteBot:output_type -> header.Empty
	54,  // 776: header.Bizbot.OnEvent:output_type -> header.Empty
	54,  // 777: header.Bizbot.StartBot:output_type -> header.Empty
	54,  // 778: header.Bizbot.StopBot:output_type -> header.Empty
	54,  // 779: header.Bizbot.TryAction:output_type -> header.Empty
	240, // 780: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	241, // 781: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	242, // 782: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	243, // 783: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	128, // 784: header.Sendback.CreateWebhook:output_type -> header.Webhook
	244, // 785: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	54,  // 786: header.Sendback.DeleteWebhook:output_type -> header.Empty
	245, // 787: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	128, // 788: header.Sendback.ReadWebhook:output_type -> header.Webhook
	128, // 789: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	128, // 790: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	246, // 791: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	247, // 792: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	54,  // 793: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	54,  // 794: header.Notibox.SendNoti:output_type -> header.Empty
	248, // 795: header.Notibox.ListNoties:output_type -> header.Notifications
	54,  // 796: header.Notibox.MarkReadNoti:output_type -> header.Empty
	54,  // 797: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	133, // 798: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	54,  // 799: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	249, // 800: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	133, // 801: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	133, // 802: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	250, // 803: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	251, // 804: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	252, // 805: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	250, // 806: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	54,  // 807: header.Holap.AppendAgentSet:output_type -> header.Empty
	54,  // 808: header.Holap.AppendTagSet:output_type -> header.Empty
	54,  // 809: header.Holap.UpdateUser:output_type -> header.Empty
	54,  // 810: header.Holap.UpdateConversation:output_type -> header.Empty
	54,  // 811: header.Holap.OnConversationEvent:output_type -> header.Empty
	54,  // 812: header.Holap.FreeAccount:output_type -> header.Empty
	253, // 813: header.Holap.ReportUser:output_type -> header.UserMetrics
	254, // 814: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 815: header.Holap.ListUserIds:output_type -> header.Ids
	199, // 816: header.Holap.ListConversationIds:output_type -> header.Conversations
	255, // 817: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 818: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	256, // 819: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	54,  // 820: header.Holap.UpdateOrder:output_type -> header.Empty
	150, // 821: header.Holap.ReportOrder:output_type -> header.Orders
	257, // 822: header.Holap.ReportCall:output_type -> header.CallMetrics
	199, // 823: header.Holap.ListCallIds:output_type -> header.Conversations
	39,  // 824: header.Proder.ReadProduct:output_type -> header.Product
	39,  // 825: header.Proder.CreateProduct:output_type -> header.Product
	39,  // 826: header.Proder.UpdateProduct:output_type -> header.Product
	54,  // 827: header.Proder.DeleteProduct:output_type -> header.Empty
	39,  // 828: header.Proder.RestoreProduct:output_type -> header.Product
	145, // 829: header.Proder.ListProducts:output_type -> header.Products
	5,   // 830: header.Proder.ListProductIds:output_type -> header.Ids
	145, // 831: header.Proder.ListGroupedProducts:output_type -> header.Products
	145, // 832: header.Proder.ImportProducts:output_type -> header.Products
	258, // 833: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	146, // 834: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	146, // 835: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	54,  // 836: header.Proder.DeleteProductCollection:output_type -> header.Empty
	259, // 837: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	147, // 838: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	147, // 839: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	54,  // 840: header.Proder.DeleteProductFeed:output_type -> header.Empty
	260, // 841: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	261, // 842: header.Proder.ListProductProps:output_type -> header.ProductProps
	...
	21,  // 847: header.Proder.RestoreOrder:output_type -> header.Order
	150, // 848: header.Proder.ListOrders:output_type -> header.Orders
	150, // 849: header.Proder.CountOrders:output_type -> header.Orders
	54,  // 850: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	150, // 851: header.Proder.ImportOrders:output_type -> header.Orders
	41,  // 852: header.Proder.MakeOrderPayment:output_type -> header.Event
	41,  // 853: header.Proder.DeleteOrderPayment:output_type -> header.Event
	41,  // 854: header.Proder.AddOrderComment:output_type -> header.Event
	41,  // 855: header.Proder.EditOrderComment:output_type -> header.Event
	41,  // 856: header.Proder.DeleteOrderComment:output_type -> header.Event
	262, // 857: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	82,  // 858: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 859: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	263, // 860: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	54,  // 861: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	264, // 862: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	54,  // 863: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	54,  // 864: header.Proder.GHNShippingStatus:output_type -> header.Empty
	158, // 865: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 866: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 867: header.Proder.UpdateShippingCode:output_type -> header.Order
	21,  // 868: header.Proder.CancelShippingOrder:output_type -> header.Order
	82,  // 869: header.Proder.PrintShippingOrders:output_type -> header.File
	54,  // 870: header.Proder.SeenOrder:output_type -> header.Empty
	54,  // 871: header.Proder.FollowOrder:output_type -> header.Empty
	54,  // 872: header.Proder.UnfollowOrder:output_type -> header.Empty
	54,  // 873: header.Proder.TagOrder:output_type -> header.Empty
	54,  // 874: header.Proder.UntagOrder:output_type -> header.Empty
	46,  // 875: header.Apiece.ReadTask:output_type -> header.Task
	46,  // 876: header.Apiece.CreateTask:output_type -> header.Task
	46,  // 877: header.Apiece.UpdateTask:output_type -> header.Task
	54,  // 878: header.Apiece.DeleteTask:output_type -> header.Empty
	265, // 879: header.Apiece.ListTasks:output_type -> header.Tasks
	54,  // 880: header.Apiece.SeenTask:output_type -> header.Empty
	54,  // 881: header.Apiece.CloseTaskReminder:output_type -> header.Empty
	54,  // 882: header.Apiece.MuteTask:output_type -> header.Empty
	54,  // 883: header.Apiece.UnmuteTask:output_type -> header.Empty
	41,  // 884: header.Apiece.AddTaskComment:output_type -> header.Event
	41,  // 885: header.Apiece.EditTaskComment:output_type -> header.Event
	41,  // 886: header.Apiece.DeleteTaskComment:output_type -> header.Event
	266, // 887: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	160, // 888: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	160, // 889: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	160, // 890: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	54,  // 891: header.Apiece.DeletePipeline:output_type -> header.Empty
	267, // 892: header.Apiece.ListPipelines:output_type -> header.Pipelines
	54,  // 893: header.Apiece.DeletePipelineStage:output_type -> header.Empty
	160, // 894: header.Apiece.PreselectPipeline:output_type -> header.Pipeline
	162, // 895: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	268, // 896: header.Campion.ListCampaigns:output_type -> header.Campaigns
	163, // 897: header.Campion.ReadCampaign:output_type -> header.Campaign
	163, // 898: header.Campion.CreateCampaign:output_type -> header.Campaign
	163, // 899: header.Campion.UpdateCampaign:output_type -> header.Campaign
	54,  // 900: header.Campion.DeleteCampaign:output_type -> header.Empty
	54,  // 901: header.Campion.OnEvent:output_type -> header.Empty
	269, // 902: header.Campion.ListCampaignSendMessages:output_type -> header.CampaignSendMessages
	270, // 903: header.Campion.ReportCampaign:output_type -> header.CampaignMetrics
	452, // [452:904] is the sub-list for method output_type
	0,   // [0:452] is the sub-list for method input_type
