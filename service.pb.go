...
var file_service_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x73, 0x74, 0x73, 0x32, 0xf0, 0x06, 0x0a, 0x10, 0x57, 0x65, 0x62, 0x50, 0x6c, 0x75,
	...
	0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x0b,
	0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x43, 0x6c, 0x69, 0x63, 0x6b, 0x12, 0x12, 0x2e, 0x68, 0x65,
	...
	0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x32, 0xe3, 0x0a, 0x0a, 0x0d, 0x57, 0x69, 0x64,
	...
	0x70, 0x61, 0x69, 0x67, 0x6e, 0x73, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	...
	0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x32, 0xa4,
	...
	0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x80, 0x02, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x58, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x65, 0x63, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x65, 0x64, 0x4e, 0x6f,
	0x74, 0x69, 0x65, 0x73, 0x12, 0x22, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x52, 0x65,
	...
	0x73, 0x12, 0x47, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x65,
	...
	0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6d,
	0x70, 0x61, 0x63, 0x74, 0x65, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x32, 0xb3, 0x04, 0x0a, 0x09, 0x57,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*account.Agents)(nil),                          // 103: account.Agents
	(*account.AgentGroups)(nil),                     // 104: account.AgentGroups
	(*account.BusinessHours)(nil),                   // 105: account.BusinessHours
	(*LoginSessions)(nil),                           // 106: header.LoginSessions
	(*Users)(nil),                                   // 107: header.Users
	(*LeadSearchResult)(nil),                        // 108: header.LeadSearchResult
	(*UserReportResult)(nil),                        // 109: header.UserReportResult
	(*Locations)(nil),                               // 110: header.Locations
	(*Events)(nil),                                  // 111: header.Events
	(*LocationMetrics)(nil),                         // 112: header.LocationMetrics
	(*PageMetrics)(nil),                             // 113: header.PageMetrics
	(*SourceMetrics)(nil),                           // 114: header.SourceMetrics
	(*UserMetric)(nil),                              // 115: header.UserMetric
	(*PresencesResponse)(nil),                       // 116: header.PresencesResponse
	(*Notes)(nil),                                   // 117: header.Notes
	(*Automations)(nil),                             // 118: header.Automations
	(*AttributeDefinitions)(nil),                    // 119: header.AttributeDefinitions
	(*conversation.CountByTagsResponse)(nil),        // 120: conversation.CountByTagsResponse
	(*conversation.AvgResponseTimeResponse)(nil),    // 121: conversation.AvgResponseTimeResponse
	(*conversation.TotalConversationResponse)(nil),  // 122: conversation.TotalConversationResponse
	(*conversation.ReportResponse)(nil),             // 123: conversation.ReportResponse
	(*Route)(nil),                                   // 124: header.Route
	(*RouteResult)(nil),                             // 125: header.RouteResult
	(*Conversations)(nil),                           // 126: header.Conversations
	(*conversation.SearchConversationResponse)(nil), // 127: conversation.SearchConversationResponse
	(*conversation.ConversationListResponse)(nil),   // 128: conversation.ConversationListResponse
	(*account.Presence)(nil),                        // 129: account.Presence
	(*Templates)(nil),                               // 130: header.Templates
	(*Tags)(nil),                                    // 131: header.Tags
	(*Integrations)(nil),                            // 132: header.Integrations
	(*PresignResult)(nil),                           // 133: header.PresignResult
	(*File)(nil),                                    // 134: header.File
	(*account.AccSubs)(nil),                         // 135: account.AccSubs
	(*payment.PaymentMethods)(nil),                  // 136: payment.PaymentMethods
	(*payment.Invoices)(nil),                        // 137: payment.Invoices
	(*payment.Comments)(nil),                        // 138: payment.Comments
	(*payment.Plans)(nil),                           // 139: payment.Plans
	(*payment.Logs)(nil),                            // 140: payment.Logs
	(*payment.PromotionCodes)(nil),                  // 141: payment.PromotionCodes
	(*payment.ReferralResponse)(nil),                // 142: payment.ReferralResponse
	(*payment.LogAccountReferreds)(nil),             // 143: payment.LogAccountReferreds
	(*payment.LogBillByAccountReferreds)(nil),       // 144: payment.LogBillByAccountReferreds
	(*payment.LogPaidForAgentReferrers)(nil),        // 145: payment.LogPaidForAgentReferrers
	(*FbFanpageSettings)(nil),                       // 146: header.FbFanpageSettings
	(*FacebookPosts)(nil),                           // 147: header.FacebookPosts
	(*WebPlugins)(nil),                              // 148: header.WebPlugins
	(*ReportCampaignResponse)(nil),                  // 149: header.ReportCampaignResponse
	(*Conversions)(nil),                             // 150: header.Conversions
	(*ConversionsExported)(nil),                     // 151: header.ConversionsExported
	(*WidgetUserSetting)(nil),                       // 152: header.WidgetUserSetting
	(*Campaigns)(nil),                               // 153: header.Campaigns
	(*UploadedImages)(nil),                          // 154: header.UploadedImages
	(*ReportWebPluginResponse)(nil),                 // 155: header.ReportWebPluginResponse
	(*Bots)(nil),                                    // 156: header.Bots
	(*ReportBotResponse)(nil),                       // 157: header.ReportBotResponse
	(*ListObjectsResponse)(nil),                     // 158: header.ListObjectsResponse
	(*WebhookTestResult)(nil),                       // 159: header.WebhookTestResult
	(*Webhooks)(nil),                                // 160: header.Webhooks
	(*WebhookDeliveries)(nil),                       // 161: header.WebhookDeliveries
	(*WebhookDelivery)(nil),                         // 162: header.WebhookDelivery
	(*CompactedNoties)(nil),                         // 163: header.CompactedNoties
	(*CompactedNoti)(nil),                           // 164: header.CompactedNoti
	(*Webpages)(nil),                                // 165: header.Webpages
	(*WebpageChecks)(nil),                           // 166: header.WebpageChecks
	(*WebpageCheck)(nil),                            // 167: header.WebpageCheck
	(*WebpageReportDataSet)(nil),                    // 168: header.WebpageReportDataSet
}
var file_service_proto_depIdxs = []int32{
	...
	79,  // 169: header.WebPluginService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	1,   // 170: header.WebPluginService.ListWebPluginTemplates:input_type -> header.Id
	1,   // 171: header.WebPluginService.DeleteWebPluginTemplate:input_type -> header.Id
	80,  // 172: header.WebPluginService.SubmitImpression:input_type -> header.Impression
	81,  // 173: header.WebPluginService.SubmitConversion:input_type -> header.Conversion
	81,  // 174: header.WebPluginService.SubmitClick:input_type -> header.Conversion
	82,  // 175: header.WebPluginService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	83,  // 176: header.WebPluginService.ReportCampaign:input_type -> header.ReportCampaignRequest
	84,  // 177: header.WebPluginService.ListConversions:input_type -> header.ConversionRequest
	84,  // 178: header.WebPluginService.ExportConversions:input_type -> header.ConversionRequest
	1,   // 179: header.WidgetService.Read:input_type -> header.Id
	85,  // 180: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 181: header.WidgetService.ReadUserSetting:input_type -> header.Id
	1,   // 182: header.WidgetService.ReadCampaign:input_type -> header.Id
	1,   // 183: header.WidgetService.ListCampaigns:input_type -> header.Id
	86,  // 184: header.WidgetService.CreateCampaign:input_type -> header.Campaign
	86,  // 185: header.WidgetService.UpdateCampaign:input_type -> header.Campaign
	86,  // 186: header.WidgetService.DeleteCampaign:input_type -> header.Campaign
	...
	87,  // 193: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 194: header.WidgetService.ListUploadedImage:input_type -> header.Id
	87,  // 195: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 196: header.WidgetService.ListWebPlugins:input_type -> header.Id
	79,  // 197: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	79,  // 198: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 199: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	88,  // 200: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	89,  // 204: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	89,  // 205: header.Bizbot.CreateBot:input_type -> header.Bot
	89,  // 206: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 207: header.Bizbot.DeleteBot:input_type -> header.Id
	90,  // 208: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	90,  // 209: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	90,  // 210: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	90,  // 211: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	91,  // 212: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	92,  // 213: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	89,  // 214: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 215: header.Bizbot.ListBotRevisions:input_type -> header.Id
	93,  // 216: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	93,  // 221: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 222: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	94,  // 223: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	95,  // 224: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	35,  // 225: header.Sendback.SendWebhookEvent:input_type -> header.Event
	96,  // 226: header.Notibox.Send:input_type -> header.Notification
	...
	98,  // 229: header.Notibox.GetCompactedNoti:input_type -> header.CompactedNotiRequest
	99,  // 230: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 231: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 232: header.Watchhttp.ListWebpages:input_type -> header.Id
	99,  // 233: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 234: header.Watchhttp.ReadWebpage:input_type -> header.Id
	100, // 235: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	101, // 236: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	102, // 237: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	102, // 238: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	0,   // 239: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	0,   // 240: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	0,   // 241: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	25,  // 242: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	4,   // 243: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	4,   // 244: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	4,   // 245: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	25,  // 246: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	4,   // 247: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	4,   // 248: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	4,   // 249: header.AccountMgr.GetInvitation:output_type -> account.Agent
	4,   // 250: header.AccountMgr.InviteAgent:output_type -> account.Agent
	4,   // 251: header.AccountMgr.GetAgent:output_type -> account.Agent
	6,   // 252: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	6,   // 253: header.AccountMgr.GetAccount:output_type -> account.Account
	6,   // 254: header.AccountMgr.UpdateAccount:output_type -> account.Account
	6,   // 255: header.AccountMgr.CreateAccount:output_type -> account.Account
	103, // 256: header.AccountMgr.ListAgents:output_type -> account.Agents
	25,  // 257: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	104, // 258: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	25,  // 259: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	25,  // 260: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 261: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	105, // 262: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	4,   // 263: header.AccountMgr.TransferOwner:output_type -> account.Agent
	10,  // 264: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	106, // 265: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	25,  // 266: header.AccountMgr.LogoutSession:output_type -> header.Empty
	107, // 267: header.UserMgr.SearchUsers:output_type -> header.Users
	108, // 268: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	108, // 269: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	13,  // 270: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 271: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 272: header.UserMgr.UpdateUser:output_type -> header.Id
	14,  // 273: header.UserMgr.ReadUser:output_type -> header.User
	109, // 274: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	107, // 275: header.UserMgr.MatchUsers:output_type -> header.Users
	110, // 276: header.LiveMgr.SearchLocations:output_type -> header.Locations
	107, // 277: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	111, // 278: header.LiveMgr.TopEvents:output_type -> header.Events
	112, // 279: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	113, // 280: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	114, // 281: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	115, // 282: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	116, // 283: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	117, // 284: header.NoteMgr.ListNotes:output_type -> header.Notes
	22,  // 285: header.NoteMgr.AddNote:output_type -> header.Note
	22,  // 286: header.NoteMgr.UpdateNote:output_type -> header.Note
	25,  // 287: header.NoteMgr.DeleteNote:output_type -> header.Empty
	118, // 288: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	24,  // 289: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	25,  // 290: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	24,  // 291: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	24,  // 292: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	119, // 293: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	26,  // 294: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	26,  // 295: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	25,  // 296: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	120, // 297: header.ConversationReporter.CountConversationsByTags:output_type -> conversation.CountByTagsResponse
	121, // 298: header.ConversationReporter.GetAvgResponseTimes:output_type -> conversation.AvgResponseTimeResponse
	122, // 299: header.ConversationReporter.GetTotalConversation:output_type -> conversation.TotalConversationResponse
	123, // 300: header.ConversationReporter.ReportConversations:output_type -> conversation.ReportResponse
	123, // 301: header.ConversationReporter.ReportConversations2:output_type -> conversation.ReportResponse
	123, // 302: header.ConversationReporter.ReportAvailibilities:output_type -> conversation.ReportResponse
	33,  // 303: header.RuleMgr.UpdateRule:output_type -> header.Rule
	33,  // 304: header.RuleMgr.CreateRule:output_type -> header.Rule
	25,  // 305: header.RuleMgr.DeleteRule:output_type -> header.Empty
	33,  // 306: header.RuleMgr.ReadRule:output_type -> header.Rule
	124, // 307: header.RuleMgr.ListRules:output_type -> header.Route
	125, // 308: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	35,  // 309: header.ConversationMgr.PongMessage:output_type -> header.Event
	40,  // 310: header.ConversationMgr.SeenConversation:output_type -> header.Conversation
	40,  // 311: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	40,  // 312: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	40,  // 313: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	126, // 314: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	126, // 315: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	25,  // 316: header.ConversationMgr.TagConversation:output_type -> header.Empty
	25,  // 317: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	25,  // 318: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	25,  // 319: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	25,  // 320: header.ConversationMgr.Typing:output_type -> header.Empty
	40,  // 321: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	126, // 322: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	127, // 323: header.ConversationMgr.SearchConversation:output_type -> conversation.SearchConversationResponse
	128, // 324: header.ConversationMgr.ListConversations2:output_type -> conversation.ConversationListResponse
	25,  // 325: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	25,  // 326: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	25,  // 327: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	43,  // 328: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	43,  // 329: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	35,  // 330: header.ConversationMgr.TerminateBot:output_type -> header.Event
	129, // 331: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	45,  // 332: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	45,  // 333: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	25,  // 334: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	45,  // 335: header.TemplateMgr.GetTemplate:output_type -> header.Template
	130, // 336: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	25,  // 337: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	47,  // 338: header.TagMgr.CreateTag:output_type -> header.Tag
	47,  // 339: header.TagMgr.UpdateTag:output_type -> header.Tag
	25,  // 340: header.TagMgr.DeleteTag:output_type -> header.Empty
	131, // 341: header.TagMgr.ListTags:output_type -> header.Tags
	47,  // 342: header.TagMgr.GetTag:output_type -> header.Tag
	25,  // 343: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	132, // 344: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	48,  // 345: header.IntegrationMgr.Integrate:output_type -> header.Integration
	111, // 346: header.EventMgr.SearchEvents:output_type -> header.Events
	35,  // 347: header.EventMgr.CreateEvent:output_type -> header.Event
	35,  // 348: header.ConversationEventReader.SendMessage:output_type -> header.Event
	35,  // 349: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	111, // 350: header.ConversationEventReader.ListEvents:output_type -> header.Events
	111, // 351: header.ConversationEventReader.SearchEvents:output_type -> header.Events
	133, // 352: header.FileMgr.Presign:output_type -> header.PresignResult
	134, // 353: header.FileMgr.Read:output_type -> header.File
	134, // 354: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 355: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 356: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	25,  // 357: header.Noti5Service.Noti:output_type -> header.Empty
	25,  // 358: header.Noti5Service.AddToken:output_type -> header.Empty
	25,  // 359: header.Noti5Service.RemoveToken:output_type -> header.Empty
	25,  // 360: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 361: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	135, // 362: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 363: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 364: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 365: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 366: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 367: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	25,  // 368: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	136, // 369: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 370: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 371: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 372: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	137, // 373: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 374: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 375: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	138, // 376: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 377: header.PaymentMgr.AddComment:output_type -> payment.Comment
	139, // 378: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 379: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 380: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 381: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 382: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	140, // 383: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 384: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 385: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	25,  // 386: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 387: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	141, // 388: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	25,  // 389: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 390: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 391: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	142, // 392: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 393: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	143, // 394: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	144, // 395: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	145, // 396: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	25,  // 397: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	25,  // 398: header.Pubsub.Publish:output_type -> header.Empty
	25,  // 399: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 400: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 401: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	146, // 402: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	147, // 403: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 404: header.WebPluginService.ReadWebPlugin:output_type -> header.WebPlugin
	79,  // 405: header.WebPluginService.UpdateWebPlugin:output_type -> header.WebPlugin
	148, // 406: header.WebPluginService.ListWebPlugins:output_type -> header.WebPlugins
	25,  // 407: header.WebPluginService.DeleteWebPlugin:output_type -> header.Empty
	79,  // 408: header.WebPluginService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	148, // 409: header.WebPluginService.ListWebPluginTemplates:output_type -> header.WebPlugins
	25,  // 410: header.WebPluginService.DeleteWebPluginTemplate:output_type -> header.Empty
	80,  // 411: header.WebPluginService.SubmitImpression:output_type -> header.Impression
	81,  // 412: header.WebPluginService.SubmitConversion:output_type -> header.Conversion
	81,  // 413: header.WebPluginService.SubmitClick:output_type -> header.Conversion
	82,  // 414: header.WebPluginService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	149, // 415: header.WebPluginService.ReportCampaign:output_type -> header.ReportCampaignResponse
	150, // 416: header.WebPluginService.ListConversions:output_type -> header.Conversions
	151, // 417: header.WebPluginService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 418: header.WidgetService.Read:output_type -> header.WidgetSetting
	85,  // 419: header.WidgetService.Update:output_type -> header.WidgetSetting
	152, // 420: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	86,  // 421: header.WidgetService.ReadCampaign:output_type -> header.Campaign
	153, // 422: header.WidgetService.ListCampaigns:output_type -> header.Campaigns
	86,  // 423: header.WidgetService.CreateCampaign:output_type -> header.Campaign
	86,  // 424: header.WidgetService.UpdateCampaign:output_type -> header.Campaign
	25,  // 425: header.WidgetService.DeleteCampaign:output_type -> header.Empty
	80,  // 426: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 427: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 428: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	149, // 429: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	150, // 430: header.WidgetService.ListConversions:output_type -> header.Conversions
	151, // 431: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	87,  // 432: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	154, // 433: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	25,  // 434: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	148, // 435: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	79,  // 436: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	79,  // 437: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	25,  // 438: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	155, // 439: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	154, // 440: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	156, // 441: header.Bizbot.ListBots:output_type -> header.Bots
	89,  // 442: header.Bizbot.GetBot:output_type -> header.Bot
	89,  // 443: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	89,  // 444: header.Bizbot.CreateBot:output_type -> header.Bot
	89,  // 445: header.Bizbot.UpdateBot:output_type -> header.Bot
	25,  // 446: header.Bizbot.DeleteBot:output_type -> header.Empty
	25,  // 447: header.Bizbot.OnEvent:output_type -> header.Empty
	25,  // 448: header.Bizbot.StartBot:output_type -> header.Empty
	25,  // 449: header.Bizbot.StopBot:output_type -> header.Empty
	25,  // 450: header.Bizbot.TryAction:output_type -> header.Empty
	157, // 451: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	158, // 452: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	89,  // 453: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	156, // 454: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	93,  // 455: header.Sendback.CreateWebhook:output_type -> header.Webhook
	159, // 456: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	25,  // 457: header.Sendback.DeleteWebhook:output_type -> header.Empty
	160, // 458: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	93,  // 459: header.Sendback.ReadWebhook:output_type -> header.Webhook
	93,  // 460: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	93,  // 461: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	161, // 462: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	162, // 463: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	25,  // 464: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	25,  // 465: header.Notibox.Send:output_type -> header.Empty
	25,  // 466: header.Notibox.MarkRead:output_type -> header.Empty
	163, // 467: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	164, // 468: header.Notibox.GetCompactedNoti:output_type -> header.CompactedNoti
	99,  // 469: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	25,  // 470: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	165, // 471: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	99,  // 472: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	99,  // 473: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	166, // 474: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	167, // 475: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	168, // 476: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	166, // 477: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
...
func (c *webPluginServiceClient) UpdateWebPluginTemplate(ctx context.Context, in *WebPlugin, opts ...grpc.CallOption) (*WebPlugin, error) {
	out := new(WebPlugin)
	err := c.cc.Invoke(ctx, "/header.WebPluginService/UpdateWebPluginTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webPluginServiceClient) ListWebPluginTemplates(ctx context.Context, in *Id, opts ...grpc.CallOption) (*WebPlugins, error) {
	out := new(WebPlugins)
	err := c.cc.Invoke(ctx, "/header.WebPluginService/ListWebPluginTemplates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webPluginServiceClient) DeleteWebPluginTemplate(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/header.WebPluginService/DeleteWebPluginTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedWebPluginServiceServer) UpdateWebPluginTemplate(context.Context, *WebPlugin) (*WebPlugin, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateWebPluginTemplate not implemented")
}
func (*UnimplementedWebPluginServiceServer) ListWebPluginTemplates(context.Context, *Id) (*WebPlugins, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListWebPluginTemplates not implemented")
}
func (*UnimplementedWebPluginServiceServer) DeleteWebPluginTemplate(context.Context, *Id) (*Empty, error) {
...
func _WebPluginService_UpdateWebPluginTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WebPlugin)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebPluginServiceServer).UpdateWebPluginTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.WebPluginService/UpdateWebPluginTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebPluginServiceServer).UpdateWebPluginTemplate(ctx, req.(*WebPlugin))
	}
	return interceptor(ctx, in, info, handler)
}

func _WebPluginService_ListWebPluginTemplates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebPluginServiceServer).ListWebPluginTemplates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.WebPluginService/ListWebPluginTemplates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebPluginServiceServer).ListWebPluginTemplates(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}

func _WebPluginService_DeleteWebPluginTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebPluginServiceServer).DeleteWebPluginTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.WebPluginService/DeleteWebPluginTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebPluginServiceServer).DeleteWebPluginTemplate(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WebPluginService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WebPluginService_UpdateWebPluginTemplate_Handler,
		},
		{
			MethodName: "ListWebPluginTemplates",
			Handler:    _WebPluginService_ListWebPluginTemplates_Handler,
		},
		{
			MethodName: "DeleteWebPluginTemplate",
			Handler:    _WebPluginService_DeleteWebPluginTemplate_Handler,
		},
		{
