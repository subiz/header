...
var file_service_proto_goTypes = []interface{}{
	...
	(*ImportOutboundCallEntryResponse)(nil),   // 273: header.ImportOutboundCallEntryResponse
...
var file_service_proto_depIdxs = []int32{
	...
	41,  // 361: header.Proder.ReadProduct:input_type -> header.Product
	41,  // 362: header.Proder.CreateProduct:input_type -> header.Product
	41,  // 363: header.Proder.UpdateProduct:input_type -> header.Product
	9,   // 364: header.Proder.DeleteProduct:input_type -> header.Id
	132, // 365: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	133, // 366: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	10,  // 367: header.Proder.ListProductCollections:input_type -> header.Ids
	134, // 368: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	134, // 369: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	9,   // 370: header.Proder.DeleteProductCollection:input_type -> header.Id
	9,   // 371: header.Proder.ListProductFeeds:input_type -> header.Id
	135, // 372: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	135, // 373: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	9,   // 374: header.Proder.DeleteProductFeed:input_type -> header.Id
	10,  // 375: header.Proder.ListProductCategories:input_type -> header.Ids
	9,   // 376: header.Proder.ReadOrder:input_type -> header.Id
	24,  // 377: header.Proder.CreateOrder:input_type -> header.Order
	24,  // 378: header.Proder.UpdateOrder:input_type -> header.Order
	9,   // 379: header.Proder.DeleteOrder:input_type -> header.Id
	136, // 380: header.Proder.ListOrders:input_type -> header.OrdersRequest
	137, // 381: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	138, // 382: header.Proder.ImportOrders:input_type -> header.Orders
	139, // 383: header.Proder.MakeOrderPayment:input_type -> header.Bill
	140, // 384: header.Proder.DeleteOrderPayment:input_type -> header.Key
	43,  // 385: header.Proder.AddOrderComment:input_type -> header.Event
	43,  // 386: header.Proder.EditOrderComment:input_type -> header.Event
	140, // 387: header.Proder.DeleteOrderComment:input_type -> header.Key
	9,   // 388: header.Proder.ListOrderEvents:input_type -> header.Id
	141, // 389: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	9,   // 390: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	142, // 391: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	9,   // 392: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	143, // 393: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	144, // 394: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	145, // 395: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	146, // 396: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	9,   // 397: header.Proder.ShipOrder:input_type -> header.Id
	24,  // 398: header.Proder.UpdateShippingCode:input_type -> header.Order
	9,   // 399: header.Proder.CancelShippingOrder:input_type -> header.Id
	10,  // 400: header.Proder.PrintShippingOrders:input_type -> header.Ids
	9,   // 401: header.Proder.SeenOrder:input_type -> header.Id
	9,   // 402: header.Proder.FollowOrder:input_type -> header.Id
	9,   // 403: header.Proder.UnfollowOrder:input_type -> header.Id
	60,  // 404: header.Proder.TagOrder:input_type -> header.TagRequest
	60,  // 405: header.Proder.UntagOrder:input_type -> header.TagRequest
	9,   // 406: header.Proder.ReadPipeline:input_type -> header.Id
	147, // 407: header.Proder.CreatePipeline:input_type -> header.Pipeline
	147, // 408: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	9,   // 409: header.Proder.DeletePipeline:input_type -> header.Id
	10,  // 410: header.Proder.ListPipelines:input_type -> header.Ids
	148, // 411: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	9,   // 412: header.Proder.PreselectPipeline:input_type -> header.Id
	149, // 413: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	10,  // 414: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	9,   // 415: header.TaskMgr.ReadTask:input_type -> header.Id
	46,  // 416: header.TaskMgr.CreateTask:input_type -> header.Task
	46,  // 417: header.TaskMgr.UpdateTask:input_type -> header.Task
	9,   // 418: header.TaskMgr.DeleteTask:input_type -> header.Id
	150, // 419: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	9,   // 420: header.TaskMgr.SeenTask:input_type -> header.Id
	9,   // 421: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	9,   // 422: header.TaskMgr.MuteTask:input_type -> header.Id
	9,   // 423: header.TaskMgr.UnmuteTask:input_type -> header.Id
	43,  // 424: header.TaskMgr.AddTaskComment:input_type -> header.Event
	43,  // 425: header.TaskMgr.EditTaskComment:input_type -> header.Event
	140, // 426: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	9,   // 427: header.TaskMgr.ListTaskComments:input_type -> header.Id
	151, // 428: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	10,  // 429: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	9,   // 430: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	152, // 431: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	152, // 432: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	9,   // 433: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	43,  // 434: header.CampaignMgr.OnEvent:input_type -> header.Event
	153, // 435: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	9,   // 436: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	154, // 437: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	155, // 438: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	156, // 439: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	155, // 440: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	155, // 441: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	157, // 442: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	154, // 443: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	158, // 444: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	159, // 445: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	160, // 446: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	9,   // 447: header.CreditMgr.ListCredits:input_type -> header.Id
	161, // 448: header.CreditMgr.AddCredit:input_type -> header.Credit
	9,   // 449: header.CreditMgr.DeleteCredit:input_type -> header.Id
	161, // 450: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	9,   // 451: header.FormMgr.ListForms:input_type -> header.Id
	162, // 452: header.FormMgr.CreateForm:input_type -> header.Form
	162, // 453: header.FormMgr.UpdateForm:input_type -> header.Form
	9,   // 454: header.FormMgr.DeleteForm:input_type -> header.Id
	163, // 455: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	164, // 456: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	165, // 457: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	165, // 458: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	166, // 459: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	55,  // 460: header.DocSearch.IndexConvo:output_type -> header.Empty
	167, // 461: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	168, // 462: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	169, // 463: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	170, // 464: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	169, // 465: header.DocSearch.ListCallIds:output_type -> header.Conversations
	171, // 466: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	7,   // 467: header.NumberRegistry.Compact:output_type -> header.Number
	6,   // 468: header.NumberRegistry.Uncompact:output_type -> header.String
	172, // 469: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	22,  // 470: header.Map.LookupAddress:output_type -> header.Address
	173, // 471: header.Map.PredictAddress:output_type -> header.Addresses
	173, // 472: header.Map.ListDistricts:output_type -> header.Addresses
	173, // 473: header.Map.ListProvinces:output_type -> header.Addresses
	173, // 474: header.Map.ListWards:output_type -> header.Addresses
	173, // 475: header.Map.ListStreets:output_type -> header.Addresses
	173, // 476: header.Map.ListAddresses:output_type -> header.Addresses
	22,  // 477: header.Map.ReadAddress:output_type -> header.Address
	11,  // 478: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	11,  // 479: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	11,  // 480: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	55,  // 481: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	14,  // 482: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	14,  // 483: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	14,  // 484: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	15,  // 485: header.AccountMgr.DeleteAccount:output_type -> account.Account
	15,  // 486: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	55,  // 487: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	14,  // 488: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	14,  // 489: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	14,  // 490: header.AccountMgr.GetInvitation:output_type -> account.Agent
	14,  // 491: header.AccountMgr.InviteAgent:output_type -> account.Agent
	14,  // 492: header.AccountMgr.GetAgent:output_type -> account.Agent
	14,  // 493: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	15,  // 494: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	15,  // 495: header.AccountMgr.GetAccount:output_type -> account.Account
	15,  // 496: header.AccountMgr.UpdateAccount:output_type -> account.Account
	15,  // 497: header.AccountMgr.CreateAccount:output_type -> account.Account
	174, // 498: header.AccountMgr.ListAgents:output_type -> account.Agents
	55,  // 499: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	175, // 500: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	14,  // 501: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	176, // 502: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	14,  // 503: header.AccountMgr.TransferOwner:output_type -> account.Agent
	19,  // 504: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	177, // 505: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	177, // 506: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	55,  // 507: header.AccountMgr.LogoutSession:output_type -> header.Empty
	19,  // 508: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	178, // 509: header.AccountMgr.GetLanguage:output_type -> header.Lang
	20,  // 510: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	21,  // 511: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	21,  // 512: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	179, // 513: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	55,  // 514: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	173, // 515: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	22,  // 516: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	22,  // 517: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	55,  // 518: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	180, // 519: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	23,  // 520: header.AccountMgr.CreateTax:output_type -> header.Tax
	23,  // 521: header.AccountMgr.UpdateTax:output_type -> header.Tax
	55,  // 522: header.AccountMgr.DeleteTax:output_type -> header.Empty
	181, // 523: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	181, // 524: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	25,  // 525: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	25,  // 526: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	55,  // 527: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	26,  // 528: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	182, // 529: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	26,  // 530: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	55,  // 531: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	183, // 532: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	27,  // 533: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	27,  // 534: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	55,  // 535: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	55,  // 536: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	184, // 537: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	55,  // 538: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	28,  // 539: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	28,  // 540: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	28,  // 541: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	29,  // 542: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	185, // 543: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	9,   // 544: header.AccountMgr.NewID:output_type -> header.Id
	9,   // 545: header.AccountMgr.LockLogin:output_type -> header.Id
	9,   // 546: header.AccountMgr.UnlockLogin:output_type -> header.Id
	32,  // 547: header.UserMgr.MergeUser:output_type -> header.User
	55,  // 548: header.UserMgr.DetachUser:output_type -> header.Empty
	9,   // 549: header.UserMgr.CreateUser:output_type -> header.Id
	32,  // 550: header.UserMgr.CreateUser2:output_type -> header.User
	32,  // 551: header.UserMgr.UpdateUser2:output_type -> header.User
	32,  // 552: header.UserMgr.UpdateUser:output_type -> header.User
	186, // 553: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	55,  // 554: header.UserMgr.RemoveUser:output_type -> header.Empty
	55,  // 555: header.UserMgr.RestoreUser:output_type -> header.Empty
	32,  // 556: header.UserMgr.ReadUser:output_type -> header.User
	32,  // 557: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	31,  // 558: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 559: header.UserMgr.BanUser:output_type -> header.User
	32,  // 560: header.UserMgr.UnbanUser:output_type -> header.User
	31,  // 561: header.UserMgr.LookupByPhone:output_type -> header.Users
	33,  // 562: header.UserMgr.UpdateView:output_type -> header.UserView
	33,  // 563: header.UserMgr.CreateView:output_type -> header.UserView
	55,  // 564: header.UserMgr.DeleteView:output_type -> header.Empty
	33,  // 565: header.UserMgr.GetView:output_type -> header.UserView
	187, // 566: header.UserMgr.ListViews:output_type -> header.UserViews
	34,  // 567: header.UserMgr.UpdateSegment:output_type -> header.Segment
	34,  // 568: header.UserMgr.CreateSegment:output_type -> header.Segment
	55,  // 569: header.UserMgr.DeleteSegment:output_type -> header.Empty
	34,  // 570: header.UserMgr.GetSegment:output_type -> header.Segment
	188, // 571: header.UserMgr.ListSegments:output_type -> header.Segments
	31,  // 572: header.UserMgr.ListUsers:output_type -> header.Users
	55,  // 573: header.UserMgr.AddToSegment:output_type -> header.Empty
	55,  // 574: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	55,  // 575: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	38,  // 576: header.UserMgr.UpsertLabel:output_type -> header.Label
	55,  // 577: header.UserMgr.DeleteLabel:output_type -> header.Empty
	189, // 578: header.UserMgr.ListLabels:output_type -> header.Labels
	38,  // 579: header.UserMgr.GetLabel:output_type -> header.Label
	55,  // 580: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	55,  // 581: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	55,  // 582: header.UserMgr.AddUserLabel:output_type -> header.Empty
	55,  // 583: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	55,  // 584: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	22,  // 585: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	22,  // 586: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	55,  // 587: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	190, // 588: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	55,  // 589: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	31,  // 590: header.UserMgr.ListLeads:output_type -> header.Users
	191, // 591: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	41,  // 592: header.UserMgr.LinkProductUrl:output_type -> header.Product
	104, // 593: header.UserMgr.ListUserEvents:output_type -> header.Events
	43,  // 594: header.UserMgr.CreateUserEvent:output_type -> header.Event
	44,  // 595: header.UserMgr.FillDevice:output_type -> common.Device
	192, // 596: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	55,  // 597: header.UserMgr.LinkTask:output_type -> header.Empty
	193, // 598: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	10,  // 599: header.UserMgr.ListUserIds:output_type -> header.Ids
	31,  // 600: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	167, // 601: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	194, // 602: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	195, // 603: header.LiveMgr.SearchLocations:output_type -> header.Locations
	31,  // 604: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	196, // 605: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	197, // 606: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	198, // 607: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	199, // 608: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	200, // 609: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	201, // 610: header.NoteMgr.ListNotes:output_type -> header.Notes
	53,  // 611: header.NoteMgr.AddNote:output_type -> header.Note
	53,  // 612: header.NoteMgr.UpdateNote:output_type -> header.Note
	55,  // 613: header.NoteMgr.DeleteNote:output_type -> header.Empty
	202, // 614: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	56,  // 615: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	56,  // 616: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	203, // 617: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	43,  // 618: header.ConversationMgr.PongMessage:output_type -> header.Event
	62,  // 619: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	62,  // 620: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	62,  // 621: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	169, // 622: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	169, // 623: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	55,  // 624: header.ConversationMgr.TagConversation:output_type -> header.Empty
	55,  // 625: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	55,  // 626: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	55,  // 627: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	55,  // 628: header.ConversationMgr.Typing:output_type -> header.Empty
	62,  // 629: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	55,  // 630: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	55,  // 631: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	55,  // 632: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	55,  // 633: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	63,  // 634: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	63,  // 635: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	43,  // 636: header.ConversationMgr.TerminateBot:output_type -> header.Event
	43,  // 637: header.ConversationMgr.SendMessage:output_type -> header.Event
	43,  // 638: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	43,  // 639: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	55,  // 640: header.ConversationMgr.PinMessage:output_type -> header.Empty
	55,  // 641: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	104, // 642: header.ConversationMgr.ListEvents:output_type -> header.Events
	55,  // 643: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	204, // 644: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	67,  // 645: header.ConversationMgr.Integrate:output_type -> header.Integration
	67,  // 646: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	68,  // 647: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	68,  // 648: header.ConversationMgr.CreateRule:output_type -> header.Rule
	55,  // 649: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	68,  // 650: header.ConversationMgr.ReadRule:output_type -> header.Rule
	205, // 651: header.ConversationMgr.ListRules:output_type -> header.Route
	206, // 652: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	69,  // 653: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	55,  // 654: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	69,  // 655: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	207, // 656: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	70,  // 657: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	70,  // 658: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	55,  // 659: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	70,  // 660: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	67,  // 661: header.ConversationMgr.TestNumber:output_type -> header.Integration
	208, // 662: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	71,  // 663: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	72,  // 664: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	209, // 665: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	55,  // 666: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	210, // 667: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	73,  // 668: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	62,  // 669: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	211, // 670: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	43,  // 671: header.ConversationMgr.SaveMessage:output_type -> header.Event
	43,  // 672: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	74,  // 673: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	74,  // 674: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	55,  // 675: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	74,  // 676: header.TemplateMgr.GetTemplate:output_type -> header.Template
	212, // 677: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	55,  // 678: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	76,  // 679: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	76,  // 680: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	55,  // 681: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	76,  // 682: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	213, // 683: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	214, // 684: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	78,  // 685: header.TagMgr.CreateTag:output_type -> header.Tag
	78,  // 686: header.TagMgr.UpdateTag:output_type -> header.Tag
	55,  // 687: header.TagMgr.DeleteTag:output_type -> header.Empty
	215, // 688: header.TagMgr.ListTags:output_type -> header.Tags
	78,  // 689: header.TagMgr.GetTag:output_type -> header.Tag
	79,  // 690: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	79,  // 691: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	55,  // 692: header.Noti5Service.Noti:output_type -> header.Empty
	55,  // 693: header.Noti5Service.AddToken:output_type -> header.Empty
	55,  // 694: header.Noti5Service.RemoveToken:output_type -> header.Empty
	55,  // 695: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	216, // 696: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	217, // 697: header.PaymentMgr.GetSub:output_type -> header.AccSub
	86,  // 698: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	83,  // 699: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	83,  // 700: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	84,  // 701: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	84,  // 702: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	55,  // 703: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	218, // 704: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	219, // 705: header.PaymentMgr.Pay:output_type -> payment.Bill
	86,  // 706: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	86,  // 707: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	220, // 708: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	86,  // 709: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	86,  // 710: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	221, // 711: header.PaymentMgr.ListComments:output_type -> payment.Comments
	90,  // 712: header.PaymentMgr.AddComment:output_type -> payment.Comment
	222, // 713: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	94,  // 714: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	94,  // 715: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	91,  // 716: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	219, // 717: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	223, // 718: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	93,  // 719: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	93,  // 720: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	55,  // 721: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	93,  // 722: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	224, // 723: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	55,  // 724: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	98,  // 725: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	98,  // 726: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	225, // 727: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	98,  // 728: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	...
	55,  // 732: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	55,  // 733: header.Pubsub.Fire:output_type -> header.Empty
	229, // 734: header.Pubsub.Poll:output_type -> header.PollResult
	101, // 735: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	102, // 736: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	102, // 737: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	...
	103, // 740: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	55,  // 741: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	55,  // 742: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	55,  // 743: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	9,   // 744: header.FabikonService.GenerateRefLink:output_type -> header.Id
	55,  // 745: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	232, // 746: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	55,  // 747: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	55,  // 748: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	55,  // 749: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	233, // 750: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	43,  // 751: header.ZalokonService.SendZNS:output_type -> header.Event
	55,  // 752: header.MailkonService.SendEmail:output_type -> header.Empty
	67,  // 753: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	55,  // 754: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	55,  // 755: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	234, // 756: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	235, // 757: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	107, // 758: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	55,  // 759: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	233, // 760: header.MailkonService.TrackLink:output_type -> header.Response
	233, // 761: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	109, // 762: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	233, // 763: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	233, // 764: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	233, // 765: header.MailkonService.BlockEmail:output_type -> header.Response
	233, // 766: header.MailkonService.UnblockEmail:output_type -> header.Response
	111, // 767: header.WidgetService.Read:output_type -> header.WidgetSetting
	111, // 768: header.WidgetService.Update:output_type -> header.WidgetSetting
	236, // 769: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	237, // 770: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	112, // 771: header.WidgetService.SubmitImpression:output_type -> header.Impression
	113, // 772: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	114, // 773: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	238, // 774: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	239, // 775: header.WidgetService.ListConversions:output_type -> header.Conversions
	240, // 776: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	117, // 777: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	241, // 778: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	55,  // 779: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	242, // 780: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	118, // 781: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	118, // 782: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	118, // 783: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	55,  // 784: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	118, // 785: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	242, // 786: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	55,  // 787: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	243, // 788: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	241, // 789: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	244, // 790: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	245, // 791: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	246, // 792: header.Bizbot.ListBots:output_type -> header.Bots
	121, // 793: header.Bizbot.GetBot:output_type -> header.Bot
	121, // 794: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	121, // 795: header.Bizbot.CreateBot:output_type -> header.Bot
	121, // 796: header.Bizbot.UpdateBot:output_type -> header.Bot
	55,  // 797: header.Bizbot.DeleteBot:output_type -> header.Empty
	55,  // 798: header.Bizbot.OnEvent:output_type -> header.Empty
	55,  // 799: header.Bizbot.StartBot:output_type -> header.Empty
	55,  // 800: header.Bizbot.StopBot:output_type -> header.Empty
	55,  // 801: header.Bizbot.TryAction:output_type -> header.Empty
	247, // 802: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	248, // 803: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	249, // 804: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	250, // 805: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	127, // 806: header.Sendback.CreateWebhook:output_type -> header.Webhook
	251, // 807: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	55,  // 808: header.Sendback.DeleteWebhook:output_type -> header.Empty
	252, // 809: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	127, // 810: header.Sendback.ReadWebhook:output_type -> header.Webhook
	127, // 811: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	127, // 812: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	253, // 813: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	254, // 814: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	55,  // 815: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	55,  // 816: header.Notibox.SendNoti:output_type -> header.Empty
	255, // 817: header.Notibox.ListNoties:output_type -> header.Notifications
	55,  // 818: header.Notibox.MarkReadNoti:output_type -> header.Empty
	55,  // 819: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	41,  // 820: header.Proder.ReadProduct:output_type -> header.Product
	41,  // 821: header.Proder.CreateProduct:output_type -> header.Product
	41,  // 822: header.Proder.UpdateProduct:output_type -> header.Product
	55,  // 823: header.Proder.DeleteProduct:output_type -> header.Empty
	...
	134, // 827: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	134, // 828: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	55,  // 829: header.Proder.DeleteProductCollection:output_type -> header.Empty
	259, // 830: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	135, // 831: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	135, // 832: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	55,  // 833: header.Proder.DeleteProductFeed:output_type -> header.Empty
	260, // 834: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	24,  // 835: header.Proder.ReadOrder:output_type -> header.Order
	24,  // 836: header.Proder.CreateOrder:output_type -> header.Order
	24,  // 837: header.Proder.UpdateOrder:output_type -> header.Order
	55,  // 838: header.Proder.DeleteOrder:output_type -> header.Empty
	138, // 839: header.Proder.ListOrders:output_type -> header.Orders
	261, // 840: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	138, // 841: header.Proder.ImportOrders:output_type -> header.Orders
	43,  // 842: header.Proder.MakeOrderPayment:output_type -> header.Event
	43,  // 843: header.Proder.DeleteOrderPayment:output_type -> header.Event
	43,  // 844: header.Proder.AddOrderComment:output_type -> header.Event
	43,  // 845: header.Proder.EditOrderComment:output_type -> header.Event
	43,  // 846: header.Proder.DeleteOrderComment:output_type -> header.Event
	...
	9,   // 849: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	264, // 850: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	55,  // 851: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	265, // 852: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	55,  // 853: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	55,  // 854: header.Proder.GHNShippingStatus:output_type -> header.Empty
	146, // 855: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	24,  // 856: header.Proder.ShipOrder:output_type -> header.Order
	24,  // 857: header.Proder.UpdateShippingCode:output_type -> header.Order
	24,  // 858: header.Proder.CancelShippingOrder:output_type -> header.Order
	263, // 859: header.Proder.PrintShippingOrders:output_type -> header.File
	55,  // 860: header.Proder.SeenOrder:output_type -> header.Empty
	55,  // 861: header.Proder.FollowOrder:output_type -> header.Empty
	55,  // 862: header.Proder.UnfollowOrder:output_type -> header.Empty
	55,  // 863: header.Proder.TagOrder:output_type -> header.Empty
	55,  // 864: header.Proder.UntagOrder:output_type -> header.Empty
	147, // 865: header.Proder.ReadPipeline:output_type -> header.Pipeline
	147, // 866: header.Proder.CreatePipeline:output_type -> header.Pipeline
	147, // 867: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	55,  // 868: header.Proder.DeletePipeline:output_type -> header.Empty
	266, // 869: header.Proder.ListPipelines:output_type -> header.Pipelines
	55,  // 870: header.Proder.DeletePipelineStage:output_type -> header.Empty
	147, // 871: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	138, // 872: header.Proder.ReportOrder:output_type -> header.Orders
	55,  // 873: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	46,  // 874: header.TaskMgr.ReadTask:output_type -> header.Task
	46,  // 875: header.TaskMgr.CreateTask:output_type -> header.Task
	46,  // 876: header.TaskMgr.UpdateTask:output_type -> header.Task
	55,  // 877: header.TaskMgr.DeleteTask:output_type -> header.Empty
	267, // 878: header.TaskMgr.ListTasks:output_type -> header.Tasks
	55,  // 879: header.TaskMgr.SeenTask:output_type -> header.Empty
	55,  // 880: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	55,  // 881: header.TaskMgr.MuteTask:output_type -> header.Empty
	55,  // 882: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	43,  // 883: header.TaskMgr.AddTaskComment:output_type -> header.Event
	43,  // 884: header.TaskMgr.EditTaskComment:output_type -> header.Event
	43,  // 885: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	268, // 886: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	151, // 887: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	269, // 888: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	...
	55,  // 892: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	55,  // 893: header.CampaignMgr.OnEvent:output_type -> header.Empty
	270, // 894: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	271, // 895: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	272, // 896: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	155, // 897: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	273, // 898: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	155, // 899: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	55,  // 900: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	274, // 901: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	55,  // 902: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	275, // 903: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	276, // 904: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	277, // 905: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	233, // 906: header.CreditMgr.ListCredits:output_type -> header.Response
	233, // 907: header.CreditMgr.AddCredit:output_type -> header.Response
	233, // 908: header.CreditMgr.DeleteCredit:output_type -> header.Response
	233, // 909: header.CreditMgr.UpdateCredit:output_type -> header.Response
	278, // 910: header.FormMgr.ListForms:output_type -> header.Forms
	162, // 911: header.FormMgr.CreateForm:output_type -> header.Form
	162, // 912: header.FormMgr.UpdateForm:output_type -> header.Form
	55,  // 913: header.FormMgr.DeleteForm:output_type -> header.Empty
	279, // 914: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	280, // 915: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	165, // 916: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	233, // 917: header.Scheduler.UnregisterTask:output_type -> header.Response
