...
var file_service_proto_rawDesc = []byte{
	...
	0x32, 0xe7, 0x01, 0x0a, 0x06, 0x50, 0x75, 0x62, 0x73, 0x75, 0x62, 0x12, 0x30, 0x0a, 0x07, 0x50,
...
var file_service_proto_depIdxs = []int32{
	...
	98,  // 264: header.Pubsub.Fire:input_type -> header.PsMessage
	99,  // 265: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	99,  // 266: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	4,   // 267: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	100, // 268: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	101, // 271: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	102, // 272: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	...
	102, // 275: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	4,   // 276: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	103, // 277: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	103, // 278: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	103, // 279: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	103, // 280: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	104, // 281: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	102, // 282: header.MailkonService.SendEmail:input_type -> header.Events
	...
	105, // 288: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	4,   // 289: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	106, // 290: header.MailkonService.TrackLink:input_type -> header.LinkData
	107, // 291: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	107, // 292: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	4,   // 293: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	108, // 294: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	108, // 295: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	4,   // 296: header.MailkonService.UnblockEmail:input_type -> header.Id
	4,   // 297: header.WidgetService.Read:input_type -> header.Id
	109, // 298: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	110, // 301: header.WidgetService.SubmitImpression:input_type -> header.Impression
	111, // 302: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	112, // 303: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	113, // 304: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	114, // 305: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	114, // 306: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	115, // 307: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 308: header.WidgetService.ListUploadedImage:input_type -> header.Id
	115, // 309: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 310: header.WidgetService.ListWebPlugins:input_type -> header.Id
	116, // 311: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	116, // 312: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	116, // 313: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 314: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	116, // 315: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	117, // 318: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	118, // 322: header.Bizbot.ListBots:input_type -> header.BotsRequest
	4,   // 323: header.Bizbot.GetBot:input_type -> header.Id
	119, // 324: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	119, // 325: header.Bizbot.CreateBot:input_type -> header.Bot
	119, // 326: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 327: header.Bizbot.DeleteBot:input_type -> header.Id
	120, // 328: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	120, // 329: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	120, // 330: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	120, // 331: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	121, // 332: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	122, // 333: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	123, // 334: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	124, // 335: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	125, // 336: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	125, // 341: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 342: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	126, // 343: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	127, // 344: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	38,  // 345: header.Sendback.SendWebhookEvent:input_type -> header.Event
	128, // 346: header.Notibox.SendNoti:input_type -> header.Notification
	129, // 347: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	...
	130, // 353: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	131, // 354: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	130, // 355: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	131, // 356: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	132, // 357: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 358: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	19,  // 359: header.Holap.UpdateOrder:input_type -> header.Order
	133, // 360: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	134, // 361: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	134, // 362: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	...
	135, // 367: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	136, // 368: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	5,   // 369: header.Proder.ListProductCollections:input_type -> header.Ids
	137, // 370: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	137, // 371: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	138, // 374: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	138, // 375: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	139, // 382: header.Proder.ListOrders:input_type -> header.OrdersRequest
	140, // 383: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	141, // 384: header.Proder.ImportOrders:input_type -> header.Orders
	142, // 385: header.Proder.MakeOrderPayment:input_type -> header.Bill
	143, // 386: header.Proder.DeleteOrderPayment:input_type -> header.Key
	...
	143, // 389: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 390: header.Proder.ListOrderEvents:input_type -> header.Id
	144, // 391: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 392: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	145, // 393: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 394: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	146, // 395: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	147, // 396: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	148, // 397: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	149, // 398: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	150, // 409: header.Proder.CreatePipeline:input_type -> header.Pipeline
	150, // 410: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	4,   // 411: header.Proder.DeletePipeline:input_type -> header.Id
	5,   // 412: header.Proder.ListPipelines:input_type -> header.Ids
	151, // 413: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	4,   // 414: header.Proder.PreselectPipeline:input_type -> header.Id
	133, // 415: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	...
	158, // 442: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	4,   // 443: header.CampaignMgr.FindNextCall:input_type -> header.Id
	159, // 444: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	160, // 445: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	161, // 446: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	4,   // 447: header.CreditMgr.ListCredits:input_type -> header.Id
	162, // 448: header.CreditMgr.AddCredit:input_type -> header.Credit
	4,   // 449: header.CreditMgr.DeleteCredit:input_type -> header.Id
	162, // 450: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	4,   // 451: header.FormMgr.ListForms:input_type -> header.Id
	163, // 452: header.FormMgr.CreateForm:input_type -> header.Form
	163, // 453: header.FormMgr.UpdateForm:input_type -> header.Form
	4,   // 454: header.FormMgr.DeleteForm:input_type -> header.Id
	164, // 455: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	165, // 456: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	166, // 457: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	166, // 458: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	167, // 459: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	51,  // 460: header.Search.Index:output_type -> header.Empty
	168, // 461: header.Search.Search:output_type -> header.DocSearchResponse
	51,  // 462: header.Search.AddOwner:output_type -> header.Empty
	169, // 463: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	17,  // 464: header.Map.LookupAddress:output_type -> header.Address
	170, // 465: header.Map.PredictAddress:output_type -> header.Addresses
	170, // 466: header.Map.ListDistricts:output_type -> header.Addresses
	170, // 467: header.Map.ListProvinces:output_type -> header.Addresses
	170, // 468: header.Map.ListWards:output_type -> header.Addresses
	170, // 469: header.Map.ListStreets:output_type -> header.Addresses
	170, // 470: header.Map.ListAddresses:output_type -> header.Addresses
	...
	171, // 489: header.AccountMgr.ListAgents:output_type -> account.Agents
	51,  // 490: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	172, // 491: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 492: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	173, // 493: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	174, // 496: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	174, // 497: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	175, // 500: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	176, // 504: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	...
	177, // 510: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	178, // 514: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	178, // 515: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	179, // 520: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	180, // 523: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	181, // 528: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	182, // 534: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	...
	102, // 582: header.UserMgr.ListUserEvents:output_type -> header.Events
	...
	190, // 589: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	...
	191, // 592: header.LiveMgr.SearchLocations:output_type -> header.Locations
	26,  // 593: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	192, // 594: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	193, // 595: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	194, // 596: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	195, // 597: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	196, // 598: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	197, // 599: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	198, // 603: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	199, // 606: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	200, // 611: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	200, // 612: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	200, // 619: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	102, // 632: header.ConversationMgr.ListEvents:output_type -> header.Events
	51,  // 633: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	201, // 634: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	202, // 641: header.ConversationMgr.ListRules:output_type -> header.Route
	203, // 642: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	204, // 646: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	205, // 652: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	206, // 655: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	51,  // 656: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	207, // 657: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	208, // 660: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	209, // 666: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	210, // 672: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	211, // 673: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	212, // 677: header.TagMgr.ListTags:output_type -> header.Tags
	...
	213, // 685: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	214, // 686: header.PaymentMgr.GetSub:output_type -> header.AccSub
	...
	215, // 693: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	216, // 694: header.PaymentMgr.Pay:output_type -> payment.Bill
	...
	217, // 697: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	218, // 700: header.PaymentMgr.ListComments:output_type -> payment.Comments
	87,  // 701: header.PaymentMgr.AddComment:output_type -> payment.Comment
	219, // 702: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	216, // 706: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	220, // 707: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	221, // 712: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	222, // 716: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	95,  // 717: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	223, // 718: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	224, // 719: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	225, // 720: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	226, // 724: header.Pubsub.Poll:output_type -> header.PollResult
	99,  // 725: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	100, // 726: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	100, // 727: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	227, // 728: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	228, // 729: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	101, // 730: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	...
	229, // 735: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	230, // 739: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	...
	231, // 745: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	232, // 746: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	105, // 747: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	51,  // 748: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	230, // 749: header.MailkonService.TrackLink:output_type -> header.Response
	230, // 750: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	107, // 751: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	230, // 752: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	230, // 753: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	230, // 754: header.MailkonService.BlockEmail:output_type -> header.Response
	230, // 755: header.MailkonService.UnblockEmail:output_type -> header.Response
	109, // 756: header.WidgetService.Read:output_type -> header.WidgetSetting
	109, // 757: header.WidgetService.Update:output_type -> header.WidgetSetting
	233, // 758: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	234, // 759: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	110, // 760: header.WidgetService.SubmitImpression:output_type -> header.Impression
	111, // 761: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	112, // 762: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	235, // 763: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	236, // 764: header.WidgetService.ListConversions:output_type -> header.Conversions
	237, // 765: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	115, // 766: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	238, // 767: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	51,  // 768: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	239, // 769: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	116, // 770: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	116, // 771: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	116, // 772: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	51,  // 773: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	116, // 774: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	239, // 775: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	51,  // 776: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	240, // 777: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	238, // 778: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	241, // 779: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	242, // 780: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	243, // 781: header.Bizbot.ListBots:output_type -> header.Bots
	119, // 782: header.Bizbot.GetBot:output_type -> header.Bot
	119, // 783: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	119, // 784: header.Bizbot.CreateBot:output_type -> header.Bot
	119, // 785: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	244, // 791: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	245, // 792: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	246, // 793: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	247, // 794: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	125, // 795: header.Sendback.CreateWebhook:output_type -> header.Webhook
	248, // 796: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	51,  // 797: header.Sendback.DeleteWebhook:output_type -> header.Empty
	249, // 798: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	125, // 799: header.Sendback.ReadWebhook:output_type -> header.Webhook
	125, // 800: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	125, // 801: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	250, // 802: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	251, // 803: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	51,  // 804: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	51,  // 805: header.Notibox.SendNoti:output_type -> header.Empty
	252, // 806: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	253, // 812: header.Holap.ReportUser:output_type -> header.UserMetrics
	254, // 813: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 814: header.Holap.ListUserIds:output_type -> header.Ids
	200, // 815: header.Holap.ListConversationIds:output_type -> header.Conversations
	255, // 816: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 817: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	51,  // 818: header.Holap.UpdateOrder:output_type -> header.Empty
	141, // 819: header.Holap.ReportOrder:output_type -> header.Orders
	256, // 820: header.Holap.ReportCall:output_type -> header.CallMetrics
	200, // 821: header.Holap.ListCallIds:output_type -> header.Conversations
	...
	137, // 829: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	137, // 830: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	...
	138, // 833: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	138, // 834: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	...
	141, // 841: header.Proder.ListOrders:output_type -> header.Orders
	262, // 842: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	141, // 843: header.Proder.ImportOrders:output_type -> header.Orders
	...
	149, // 857: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	...
	150, // 867: header.Proder.ReadPipeline:output_type -> header.Pipeline
	150, // 868: header.Proder.CreatePipeline:output_type -> header.Pipeline
	150, // 869: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	...
	150, // 873: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	141, // 874: header.Proder.ReportOrder:output_type -> header.Orders
	...
	268, // 879: header.TaskMgr.ListTasks:output_type -> header.Tasks
	...
	269, // 887: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	153, // 888: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	270, // 889: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	154, // 890: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	154, // 891: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	154, // 892: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	...
	271, // 895: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	272, // 896: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	273, // 897: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	157, // 898: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	157, // 899: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	...
	157, // 902: header.CampaignMgr.FindNextCall:output_type -> header.OutboundCallEntry
	...
	230, // 906: header.CreditMgr.ListCredits:output_type -> header.Response
	230, // 907: header.CreditMgr.AddCredit:output_type -> header.Response
	230, // 908: header.CreditMgr.DeleteCredit:output_type -> header.Response
	230, // 909: header.CreditMgr.UpdateCredit:output_type -> header.Response
	278, // 910: header.FormMgr.ListForms:output_type -> header.Forms
	163, // 911: header.FormMgr.CreateForm:output_type -> header.Form
	163, // 912: header.FormMgr.UpdateForm:output_type -> header.Form
	...
	166, // 916: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	230, // 917: header.Scheduler.UnregisterTask:output_type -> header.Response
