...
var file_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xcf, 0x0c, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x32, 0xbe, 0x03, 0x0a, 0x07, 0x4c, 0x69, 0x76, 0x65, 0x4d,
	...
	0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb7, 0x11, 0x0a, 0x0f, 0x43,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x32, 0xab, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	...
	0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x32, 0xf2, 0x01, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x4d, 0x0a, 0x19,
...
var file_service_proto_depIdxs = []int32{
	...
	161, // 468: header.UserMgr.SearchUsers:output_type -> header.Users
	31,  // 469: header.UserMgr.MergeUser:output_type -> header.UserAlias
	...
	162, // 476: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	161, // 477: header.UserMgr.MatchUsers:output_type -> header.Users
	...
	163, // 482: header.UserMgr.ListViews:output_type -> header.UserViews
	35,  // 483: header.UserMgr.UpsertLabel:output_type -> header.Label
	45,  // 484: header.UserMgr.DeleteLabel:output_type -> header.Empty
	164, // 485: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	165, // 494: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	45,  // 495: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	161, // 496: header.UserMgr.ListLeads:output_type -> header.Users
	161, // 497: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	161, // 498: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	37,  // 499: header.UserMgr.LinkProductUrl:output_type -> header.Product
	166, // 500: header.LiveMgr.SearchLocations:output_type -> header.Locations
	161, // 501: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	95,  // 502: header.LiveMgr.TopEvents:output_type -> header.Events
	167, // 503: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	168, // 504: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	169, // 505: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	170, // 506: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	171, // 507: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	172, // 508: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	173, // 512: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	174, // 515: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	175, // 520: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	175, // 521: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	175, // 528: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	176, // 542: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	177, // 549: header.ConversationMgr.ListRules:output_type -> header.Route
	178, // 550: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	179, // 558: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	180, // 564: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	181, // 565: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	182, // 569: header.TagMgr.ListTags:output_type -> header.Tags
	...
	183, // 573: header.FileMgr.Presign:output_type -> header.PresignResult
	184, // 574: header.FileMgr.Uploaded:output_type -> header.File
	184, // 575: header.FileMgr.DownloadFileUrl:output_type -> header.File
	...
	185, // 583: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	186, // 590: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	187, // 594: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	188, // 597: header.PaymentMgr.ListComments:output_type -> payment.Comments
	82,  // 598: header.PaymentMgr.AddComment:output_type -> payment.Comment
	189, // 599: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	190, // 604: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	191, // 609: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	192, // 613: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	90,  // 614: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	193, // 615: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	194, // 616: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	195, // 617: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	196, // 622: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	197, // 623: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	198, // 633: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	199, // 634: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	200, // 638: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	201, // 639: header.WidgetService.ListConversions:output_type -> header.Conversions
	202, // 640: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	102, // 641: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	203, // 642: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	45,  // 643: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	204, // 644: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	204, // 650: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	45,  // 651: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	205, // 652: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	203, // 653: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	206, // 654: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	207, // 655: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	208, // 656: header.Bizbot.ListBots:output_type -> header.Bots
	...
	209, // 666: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	210, // 667: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	211, // 668: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	212, // 669: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	111, // 670: header.Sendback.CreateWebhook:output_type -> header.Webhook
	213, // 671: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	45,  // 672: header.Sendback.DeleteWebhook:output_type -> header.Empty
	214, // 673: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	215, // 677: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	216, // 678: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	45,  // 679: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	217, // 680: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	45,  // 681: header.Notibox.SendNoti:output_type -> header.Empty
	218, // 682: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	219, // 686: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	...
	220, // 689: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	221, // 690: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	222, // 691: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	220, // 692: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	...
	223, // 699: header.Holap.ReportUser:output_type -> header.UserMetrics
	224, // 700: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 701: header.Holap.ListUserIds:output_type -> header.Ids
	175, // 702: header.Holap.ListConversationIds:output_type -> header.Conversations
	225, // 703: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	...
	226, // 707: header.Holap.ReportOrder:output_type -> header.Orders
	...
	227, // 717: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	...
	228, // 721: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	...
	229, // 725: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	230, // 726: header.Proder.ListProductProps:output_type -> header.ProductProps
	...
	226, // 732: header.Proder.ListOrders:output_type -> header.Orders
	226, // 733: header.Proder.CountOrders:output_type -> header.Orders
	...
	231, // 740: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	184, // 741: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 742: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	232, // 743: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	45,  // 744: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	233, // 745: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	...
	184, // 751: header.Proder.PrintShippingOrders:output_type -> header.File
	...
	234, // 760: header.Apiece.ListTasks:output_type -> header.Tasks
	...
	235, // 764: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	...
	236, // 769: header.Apiece.ListPipelines:output_type -> header.Pipelines
