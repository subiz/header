...
var file_service_proto_rawDesc = []byte{
	...
	0x32, 0xc9, 0x05, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61, 0x70, 0x12, 0x2f, 0x0a, 0x0e, 0x41, 0x70,
	...
	0x0b, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x73, 0x42, 0x19, 0x5a, 0x17,
...
var file_service_proto_depIdxs = []int32{
	...
	38,  // 123: header.ConversationEventReader.PinMessage:input_type -> header.Event
	38,  // 124: header.ConversationEventReader.UnpinMessage:input_type -> header.Event
	52,  // 125: header.ConversationEventReader.ListEvents:input_type -> header.ListConversationEventsRequest
	53,  // 126: header.FileMgr.Presign:input_type -> header.FileHeader
	54,  // 127: header.FileMgr.Read:input_type -> header.FileRequest
	54,  // 128: header.FileMgr.Uploaded:input_type -> header.FileRequest
	1,   // 129: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	55,  // 130: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	56,  // 131: header.Noti5Service.Noti:input_type -> header.PushNoti
	57,  // 132: header.Noti5Service.AddToken:input_type -> noti5.Token
	57,  // 133: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	57,  // 134: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	58,  // 135: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	59,  // 136: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	60,  // 137: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	60,  // 138: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 139: header.PaymentMgr.GetSubscription:input_type -> header.Id
	61,  // 140: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	61,  // 141: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	62,  // 144: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	63,  // 145: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	63,  // 146: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	64,  // 147: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	60,  // 148: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	65,  // 149: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	66,  // 150: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	67,  // 151: header.PaymentMgr.AddComment:input_type -> payment.Comment
	32,  // 152: header.PaymentMgr.ListPlans:input_type -> header.Empty
	1,   // 153: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	63,  // 154: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	68,  // 155: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	62,  // 156: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	69,  // 157: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	70,  // 158: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	71,  // 159: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	72,  // 160: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	72,  // 161: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	73,  // 162: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	1,   // 163: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	74,  // 164: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 165: header.PaymentMgr.GetReferral:input_type -> header.Id
	32,  // 166: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	75,  // 167: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	76,  // 171: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	77,  // 172: header.Pubsub.Publish:input_type -> header.PublishMessage
	77,  // 173: header.Realtime.ShardSend:input_type -> header.PublishMessage
	1,   // 174: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	78,  // 175: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	79,  // 179: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	80,  // 182: header.WidgetService.SubmitImpression:input_type -> header.Impression
	81,  // 183: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	82,  // 184: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	83,  // 185: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	84,  // 186: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	84,  // 187: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	85,  // 188: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 189: header.WidgetService.ListUploadedImage:input_type -> header.Id
	85,  // 190: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 191: header.WidgetService.ListWebPlugins:input_type -> header.Id
	86,  // 192: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	86,  // 193: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	86,  // 194: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 195: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	86,  // 196: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	87,  // 199: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	88,  // 205: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	88,  // 206: header.Bizbot.CreateBot:input_type -> header.Bot
	88,  // 207: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 208: header.Bizbot.DeleteBot:input_type -> header.Id
	89,  // 209: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	89,  // 210: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	89,  // 211: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	89,  // 212: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	90,  // 213: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	91,  // 214: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	88,  // 215: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 216: header.Bizbot.ListBotRevisions:input_type -> header.Id
	92,  // 217: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	92,  // 222: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 223: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	93,  // 224: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	94,  // 225: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	38,  // 226: header.Sendback.SendWebhookEvent:input_type -> header.Event
	95,  // 227: header.Notibox.Send:input_type -> header.Notification
	1,   // 228: header.Notibox.MarkRead:input_type -> header.Id
	96,  // 229: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	97,  // 230: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	98,  // 231: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 232: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 233: header.Watchhttp.ListWebpages:input_type -> header.Id
	98,  // 234: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 235: header.Watchhttp.ReadWebpage:input_type -> header.Id
	99,  // 236: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	100, // 237: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	101, // 238: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	101, // 239: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	...
	102, // 245: header.Holap.FreeAccount:input_type -> header.AccountImage
	103, // 246: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	104, // 247: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	103, // 248: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	104, // 249: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	105, // 250: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	...
	106, // 269: header.AccountMgr.ListAgents:output_type -> account.Agents
	32,  // 270: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	107, // 271: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	...
	108, // 275: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	109, // 278: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	32,  // 279: header.AccountMgr.LogoutSession:output_type -> header.Empty
	110, // 280: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	111, // 283: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	112, // 284: header.UserMgr.SearchUsers:output_type -> header.Users
	113, // 285: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	113, // 286: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	...
	114, // 292: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	112, // 293: header.UserMgr.MatchUsers:output_type -> header.Users
	...
	115, // 297: header.UserMgr.ListViews:output_type -> header.UserViews
	112, // 298: header.UserMgr.ListUserInViews:output_type -> header.Users
	22,  // 299: header.UserMgr.UpsertLabel:output_type -> header.Label
	32,  // 300: header.UserMgr.DeleteLabel:output_type -> header.Empty
	116, // 301: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	112, // 308: header.UserPersist.FilterUsers:output_type -> header.Users
	117, // 309: header.LiveMgr.SearchLocations:output_type -> header.Locations
	112, // 310: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	118, // 311: header.LiveMgr.TopEvents:output_type -> header.Events
	119, // 312: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	120, // 313: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	121, // 314: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	122, // 315: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	123, // 316: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	124, // 317: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	125, // 321: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	...
	126, // 326: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	127, // 330: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	...
	128, // 335: header.RuleMgr.ListRules:output_type -> header.Route
	129, // 336: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 337: header.ConversationMgr.PongMessage:output_type -> header.Event
	43,  // 338: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	43,  // 339: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	43,  // 340: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	130, // 341: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	130, // 342: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	32,  // 343: header.ConversationMgr.TagConversation:output_type -> header.Empty
	32,  // 344: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	32,  // 345: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	32,  // 346: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	32,  // 347: header.ConversationMgr.Typing:output_type -> header.Empty
	43,  // 348: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	130, // 349: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	32,  // 350: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	32,  // 351: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	32,  // 352: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	44,  // 353: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	44,  // 354: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 355: header.ConversationMgr.TerminateBot:output_type -> header.Event
	131, // 356: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 357: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	46,  // 358: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	32,  // 359: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	46,  // 360: header.TemplateMgr.GetTemplate:output_type -> header.Template
	132, // 361: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	32,  // 362: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	48,  // 363: header.TagMgr.CreateTag:output_type -> header.Tag
	48,  // 364: header.TagMgr.UpdateTag:output_type -> header.Tag
	32,  // 365: header.TagMgr.DeleteTag:output_type -> header.Empty
	133, // 366: header.TagMgr.ListTags:output_type -> header.Tags
	48,  // 367: header.TagMgr.GetTag:output_type -> header.Tag
	32,  // 368: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	134, // 369: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	49,  // 370: header.IntegrationMgr.Integrate:output_type -> header.Integration
	118, // 371: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 372: header.EventMgr.CreateEvent:output_type -> header.Event
	38,  // 373: header.ConversationEventReader.SendMessage:output_type -> header.Event
	38,  // 374: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	32,  // 375: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	32,  // 376: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	118, // 377: header.ConversationEventReader.ListEvents:output_type -> header.Events
	135, // 378: header.FileMgr.Presign:output_type -> header.PresignResult
	136, // 379: header.FileMgr.Read:output_type -> header.File
	136, // 380: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 381: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 382: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	...
	58,  // 387: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	137, // 388: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 389: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 390: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 391: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 392: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 393: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	32,  // 394: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	138, // 395: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 396: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 397: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 398: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	139, // 399: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 400: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 401: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	140, // 402: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 403: header.PaymentMgr.AddComment:output_type -> payment.Comment
	141, // 404: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 405: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 406: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 407: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 408: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	142, // 409: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 410: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 411: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	32,  // 412: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 413: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	143, // 414: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	32,  // 415: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 416: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 417: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	144, // 418: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 419: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	145, // 420: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	146, // 421: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	147, // 422: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	78,  // 426: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 427: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	148, // 428: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	149, // 429: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 430: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 431: header.WidgetService.Update:output_type -> header.WidgetSetting
	150, // 432: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	151, // 433: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	80,  // 434: header.WidgetService.SubmitImpression:output_type -> header.Impression
	81,  // 435: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	82,  // 436: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	152, // 437: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	153, // 438: header.WidgetService.ListConversions:output_type -> header.Conversions
	154, // 439: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	85,  // 440: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	155, // 441: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	32,  // 442: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	156, // 443: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	86,  // 444: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	86,  // 445: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	86,  // 446: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	32,  // 447: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	86,  // 448: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	156, // 449: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	32,  // 450: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	157, // 451: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	155, // 452: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	158, // 453: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	159, // 454: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	160, // 455: header.Bizbot.ListBots:output_type -> header.Bots
	88,  // 456: header.Bizbot.GetBot:output_type -> header.Bot
	88,  // 457: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	88,  // 458: header.Bizbot.CreateBot:output_type -> header.Bot
	88,  // 459: header.Bizbot.UpdateBot:output_type -> header.Bot
	...
	161, // 465: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	162, // 466: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	88,  // 467: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	160, // 468: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	92,  // 469: header.Sendback.CreateWebhook:output_type -> header.Webhook
	163, // 470: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	32,  // 471: header.Sendback.DeleteWebhook:output_type -> header.Empty
	164, // 472: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	92,  // 473: header.Sendback.ReadWebhook:output_type -> header.Webhook
	92,  // 474: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	92,  // 475: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	165, // 476: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	166, // 477: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	...
	167, // 482: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	98,  // 483: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	32,  // 484: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	168, // 485: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	98,  // 486: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	98,  // 487: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	169, // 488: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	170, // 489: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	171, // 490: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	169, // 491: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	...
	172, // 498: header.Holap.ReportUser:output_type -> header.UserMetrics
	173, // 499: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	19,  // 500: header.Holap.ListUserIds:output_type -> header.Ids
	130, // 501: header.Holap.ListConversationIds:output_type -> header.Conversations
	174, // 502: header.Holap.ReportAgent:output_type -> header.AgentMetrics
