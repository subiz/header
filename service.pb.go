...
var file_service_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xdd, 0x01, 0x0a, 0x09, 0x44, 0x6f, 0x63,
	...
	0x6e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x32, 0x68, 0x0a, 0x0e, 0x4e, 0x75, 0x6d, 0x62,
	...
	0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0f, 0x2e, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0x82, 0x1e,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*account.Token)(nil),                     // 14: account.Token
...
var file_service_proto_depIdxs = []int32{
	...
	4,   // 4: header.NumberRegistry.Compact:input_type -> header.String
	5,   // 5: header.NumberRegistry.Uncompact:input_type -> header.Number
	6,   // 6: header.Map.Predict:input_type -> header.AddressAutocompleteRequest
	7,   // 7: header.Map.LookupAddress:input_type -> header.Id
	6,   // 8: header.Map.PredictAddress:input_type -> header.AddressAutocompleteRequest
	7,   // 9: header.Map.ListDistricts:input_type -> header.Id
	7,   // 10: header.Map.ListProvinces:input_type -> header.Id
	7,   // 11: header.Map.ListWards:input_type -> header.Id
	7,   // 12: header.Map.ListStreets:input_type -> header.Id
	8,   // 13: header.Map.ListAddresses:input_type -> header.Ids
	7,   // 14: header.Map.ReadAddress:input_type -> header.Id
	9,   // 15: header.AccountMgr.CreateGroup:input_type -> header.AgentGroup
	9,   // 16: header.AccountMgr.UpdateGroup:input_type -> header.AgentGroup
	7,   // 17: header.AccountMgr.GetGroup:input_type -> header.Id
	10,  // 18: header.AccountMgr.RequestResetPassword:input_type -> account.ResetPasswordRequest
	11,  // 19: header.AccountMgr.UpdatePassword:input_type -> account.NewPassword
	...
	14,  // 27: header.AccountMgr.GetInvitation:input_type -> account.Token
	...
	14,  // 31: header.AccountMgr.ConfirmAccount:input_type -> account.Token
	...
	60,  // 167: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	59,  // 168: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	60,  // 169: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	60,  // 170: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	61,  // 171: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	7,   // 172: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	62,  // 173: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	41,  // 174: header.ConversationMgr.SendMessage:input_type -> header.Event
	63,  // 175: header.ConversationMgr.SendOmniChannelMessage:input_type -> header.SendOmniChannelMessageRequest
	...
	64,  // 179: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	7,   // 180: header.ConversationMgr.Deintegrate:input_type -> header.Id
	7,   // 181: header.ConversationMgr.ListIntegrations:input_type -> header.Id
	65,  // 182: header.ConversationMgr.Integrate:input_type -> header.Integration
	7,   // 183: header.ConversationMgr.GetIntegration:input_type -> header.Id
	66,  // 184: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	66,  // 185: header.ConversationMgr.CreateRule:input_type -> header.Rule
	7,   // 186: header.ConversationMgr.DeleteRule:input_type -> header.Id
	7,   // 187: header.ConversationMgr.ReadRule:input_type -> header.Id
	7,   // 188: header.ConversationMgr.ListRules:input_type -> header.Id
	7,   // 189: header.ConversationMgr.ListConversationAutomations:input_type -> header.Id
	67,  // 190: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	7,   // 191: header.ConversationMgr.DeleteConversationAutomation:input_type -> header.Id
	7,   // 192: header.ConversationMgr.ReadConversationAutomation:input_type -> header.Id
	7,   // 193: header.ConversationMgr.ListPhoneDevices:input_type -> header.Id
	68,  // 194: header.ConversationMgr.CreatePhoneDevice:input_type -> header.PhoneDevice
	68,  // 195: header.ConversationMgr.UpdatePhoneDevice:input_type -> header.PhoneDevice
	7,   // 196: header.ConversationMgr.DeletePhoneDevice:input_type -> header.Id
	7,   // 197: header.ConversationMgr.ReadPhoneDevice:input_type -> header.Id
	7,   // 198: header.ConversationMgr.TestNumber:input_type -> header.Id
	7,   // 199: header.ConversationMgr.ListCallSettings:input_type -> header.Id
	69,  // 200: header.ConversationMgr.UpdateCallSetting:input_type -> header.CallSetting
	70,  // 201: header.ConversationMgr.BlockNumber:input_type -> header.BlockedNumber
	7,   // 202: header.ConversationMgr.ListBlockedNumbers:input_type -> header.Id
	70,  // 203: header.ConversationMgr.UnblockNumber:input_type -> header.BlockedNumber
	7,   // 204: header.ConversationMgr.ListGreetingAudio:input_type -> header.Id
	71,  // 205: header.ConversationMgr.CreateGreetingAudio:input_type -> header.GreetingAudio
	56,  // 206: header.ConversationMgr.OriginateCall:input_type -> header.StartRequest
	7,   // 207: header.ConversationMgr.ListMyRecentCalls:input_type -> header.Id
	41,  // 208: header.ConversationMgr.SaveMessage:input_type -> header.Event
	41,  // 209: header.ConversationMgr.ApplyMessage:input_type -> header.Event
	72,  // 210: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	72,  // 211: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	7,   // 212: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	7,   // 213: header.TemplateMgr.GetTemplate:input_type -> header.Id
	73,  // 214: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	7,   // 215: header.TemplateMgr.PickTemplate:input_type -> header.Id
	74,  // 216: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	74,  // 217: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	7,   // 218: header.TemplateMgr.DeleteModal:input_type -> header.Id
	7,   // 219: header.TemplateMgr.GetModal:input_type -> header.Id
	7,   // 220: header.TemplateMgr.ListModals:input_type -> header.Id
	75,  // 221: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	76,  // 222: header.TagMgr.CreateTag:input_type -> header.Tag
	76,  // 223: header.TagMgr.UpdateTag:input_type -> header.Tag
	7,   // 224: header.TagMgr.DeleteTag:input_type -> header.Id
	7,   // 225: header.TagMgr.ListTags:input_type -> header.Id
	7,   // 226: header.TagMgr.GetTag:input_type -> header.Id
	7,   // 227: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	77,  // 228: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	78,  // 229: header.Noti5Service.Noti:input_type -> header.PushNoti
	79,  // 230: header.Noti5Service.AddToken:input_type -> noti5.Token
	79,  // 231: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	79,  // 232: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	80,  // 233: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	7,   // 234: header.PaymentMgr.GetSub:input_type -> header.Id
	81,  // 235: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	81,  // 236: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	7,   // 237: header.PaymentMgr.GetSubscription:input_type -> header.Id
	82,  // 238: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	82,  // 239: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	7,   // 240: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	7,   // 241: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	83,  // 242: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	84,  // 243: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	84,  // 244: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	85,  // 245: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	81,  // 246: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	86,  // 247: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	87,  // 248: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	88,  // 249: header.PaymentMgr.AddComment:input_type -> payment.Comment
	53,  // 250: header.PaymentMgr.ListPlans:input_type -> header.Empty
	7,   // 251: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	84,  // 252: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	89,  // 253: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	83,  // 254: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	90,  // 255: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	91,  // 256: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	92,  // 257: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	93,  // 258: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	93,  // 259: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	94,  // 260: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	7,   // 261: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	95,  // 262: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	7,   // 263: header.PaymentMgr.GetReferral:input_type -> header.Id
	53,  // 264: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	96,  // 265: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	7,   // 266: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	7,   // 267: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	7,   // 268: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	97,  // 269: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	98,  // 270: header.Pubsub.Fire:input_type -> header.PsMessage
	99,  // 271: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	99,  // 272: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	7,   // 273: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	100, // 274: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	7,   // 275: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	7,   // 276: header.FabikonService.ListFbPosts:input_type -> header.Id
	101, // 277: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	102, // 278: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	...
	7,   // 281: header.FabikonService.GenerateRefLink:input_type -> header.Id
	102, // 282: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	7,   // 283: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	103, // 284: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	103, // 285: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	103, // 286: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	103, // 287: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	104, // 288: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	102, // 289: header.MailkonService.SendEmail:input_type -> header.Events
	65,  // 290: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	65,  // 291: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	65,  // 292: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	65,  // 293: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	7,   // 294: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	105, // 295: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	7,   // 296: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	106, // 297: header.MailkonService.TrackLink:input_type -> header.LinkData
	107, // 298: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	107, // 299: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	7,   // 300: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	108, // 301: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	108, // 302: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	7,   // 303: header.MailkonService.UnblockEmail:input_type -> header.Id
	7,   // 304: header.WidgetService.Read:input_type -> header.Id
	109, // 305: header.WidgetService.Update:input_type -> header.WidgetSetting
	7,   // 306: header.WidgetService.ReadUserSetting:input_type -> header.Id
	7,   // 307: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	110, // 308: header.WidgetService.SubmitImpression:input_type -> header.Impression
	111, // 309: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	112, // 310: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	113, // 311: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	114, // 312: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	114, // 313: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	115, // 314: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	7,   // 315: header.WidgetService.ListUploadedImage:input_type -> header.Id
	115, // 316: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	7,   // 317: header.WidgetService.ListWebPlugins:input_type -> header.Id
	116, // 318: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	116, // 319: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	116, // 320: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	7,   // 321: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	116, // 322: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	7,   // 323: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	7,   // 324: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	117, // 325: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	7,   // 326: header.WidgetService.SearchImages:input_type -> header.Id
	7,   // 327: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	7,   // 328: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	118, // 329: header.Bizbot.ListBots:input_type -> header.BotsRequest
	7,   // 330: header.Bizbot.GetBot:input_type -> header.Id
	119, // 331: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	119, // 332: header.Bizbot.CreateBot:input_type -> header.Bot
	119, // 333: header.Bizbot.UpdateBot:input_type -> header.Bot
	7,   // 334: header.Bizbot.DeleteBot:input_type -> header.Id
	120, // 335: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	120, // 336: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	120, // 337: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	120, // 338: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	121, // 339: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	122, // 340: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	123, // 341: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	124, // 342: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	125, // 343: header.Sendback.CreateWebhook:input_type -> header.Webhook
	7,   // 344: header.Sendback.PingWebhook:input_type -> header.Id
	7,   // 345: header.Sendback.DeleteWebhook:input_type -> header.Id
	7,   // 346: header.Sendback.ListWebhooks:input_type -> header.Id
	7,   // 347: header.Sendback.ReadWebhook:input_type -> header.Id
	125, // 348: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	7,   // 349: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	126, // 350: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	127, // 351: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	41,  // 352: header.Sendback.SendWebhookEvent:input_type -> header.Event
	128, // 353: header.Notibox.SendNoti:input_type -> header.Notification
	129, // 354: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	7,   // 355: header.Notibox.MarkReadNoti:input_type -> header.Id
	7,   // 356: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	30,  // 357: header.Holap.UpdateUser:input_type -> header.User
	60,  // 358: header.Holap.UpdateConversation:input_type -> header.Conversation
	41,  // 359: header.Holap.OnConversationEvent:input_type -> header.Event
	130, // 360: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	3,   // 361: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	130, // 362: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	3,   // 363: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	131, // 364: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	8,   // 365: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	22,  // 366: header.Holap.UpdateOrder:input_type -> header.Order
	132, // 367: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	133, // 368: header.Holap.ReportCall:input_type -> header.CallMetricsRequest
	133, // 369: header.Holap.ListCallIds:input_type -> header.CallMetricsRequest
	39,  // 370: header.Proder.ReadProduct:input_type -> header.Product
	39,  // 371: header.Proder.CreateProduct:input_type -> header.Product
	39,  // 372: header.Proder.UpdateProduct:input_type -> header.Product
	7,   // 373: header.Proder.DeleteProduct:input_type -> header.Id
	134, // 374: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	135, // 375: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	8,   // 376: header.Proder.ListProductCollections:input_type -> header.Ids
	136, // 377: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	136, // 378: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	7,   // 379: header.Proder.DeleteProductCollection:input_type -> header.Id
	7,   // 380: header.Proder.ListProductFeeds:input_type -> header.Id
	137, // 381: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	137, // 382: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	7,   // 383: header.Proder.DeleteProductFeed:input_type -> header.Id
	8,   // 384: header.Proder.ListProductCategories:input_type -> header.Ids
	7,   // 385: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 386: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 387: header.Proder.UpdateOrder:input_type -> header.Order
	7,   // 388: header.Proder.DeleteOrder:input_type -> header.Id
	138, // 389: header.Proder.ListOrders:input_type -> header.OrdersRequest
	139, // 390: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	140, // 391: header.Proder.ImportOrders:input_type -> header.Orders
	141, // 392: header.Proder.MakeOrderPayment:input_type -> header.Bill
	142, // 393: header.Proder.DeleteOrderPayment:input_type -> header.Key
	41,  // 394: header.Proder.AddOrderComment:input_type -> header.Event
	41,  // 395: header.Proder.EditOrderComment:input_type -> header.Event
	142, // 396: header.Proder.DeleteOrderComment:input_type -> header.Key
	7,   // 397: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 398: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	7,   // 399: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 400: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	7,   // 401: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	145, // 402: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	146, // 403: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	147, // 404: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	148, // 405: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	7,   // 406: header.Proder.ShipOrder:input_type -> header.Id
	22,  // 407: header.Proder.UpdateShippingCode:input_type -> header.Order
	7,   // 408: header.Proder.CancelShippingOrder:input_type -> header.Id
	8,   // 409: header.Proder.PrintShippingOrders:input_type -> header.Ids
	7,   // 410: header.Proder.SeenOrder:input_type -> header.Id
	7,   // 411: header.Proder.FollowOrder:input_type -> header.Id
	7,   // 412: header.Proder.UnfollowOrder:input_type -> header.Id
	58,  // 413: header.Proder.TagOrder:input_type -> header.TagRequest
	58,  // 414: header.Proder.UntagOrder:input_type -> header.TagRequest
	7,   // 415: header.Proder.ReadPipeline:input_type -> header.Id
	149, // 416: header.Proder.CreatePipeline:input_type -> header.Pipeline
	149, // 417: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	7,   // 418: header.Proder.DeletePipeline:input_type -> header.Id
	8,   // 419: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 420: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	7,   // 421: header.Proder.PreselectPipeline:input_type -> header.Id
	132, // 422: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	8,   // 423: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	7,   // 424: header.TaskMgr.ReadTask:input_type -> header.Id
	44,  // 425: header.TaskMgr.CreateTask:input_type -> header.Task
	44,  // 426: header.TaskMgr.UpdateTask:input_type -> header.Task
	7,   // 427: header.TaskMgr.DeleteTask:input_type -> header.Id
	151, // 428: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	7,   // 429: header.TaskMgr.SeenTask:input_type -> header.Id
	7,   // 430: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	7,   // 431: header.TaskMgr.MuteTask:input_type -> header.Id
	7,   // 432: header.TaskMgr.UnmuteTask:input_type -> header.Id
	41,  // 433: header.TaskMgr.AddTaskComment:input_type -> header.Event
	41,  // 434: header.TaskMgr.EditTaskComment:input_type -> header.Event
	142, // 435: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	7,   // 436: header.TaskMgr.ListTaskComments:input_type -> header.Id
	152, // 437: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	8,   // 438: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	7,   // 439: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	153, // 440: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	153, // 441: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	7,   // 442: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	41,  // 443: header.CampaignMgr.OnEvent:input_type -> header.Event
	154, // 444: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	7,   // 445: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	155, // 446: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	156, // 447: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	157, // 448: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	156, // 449: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	156, // 450: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	158, // 451: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	155, // 452: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	...
	53,  // 469: header.DocSearch.IndexConvo:output_type -> header.Empty
	168, // 470: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	169, // 471: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 472: header.NumberRegistry.Compact:output_type -> header.Number
	4,   // 473: header.NumberRegistry.Uncompact:output_type -> header.String
	170, // 474: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 475: header.Map.LookupAddress:output_type -> header.Address
	171, // 476: header.Map.PredictAddress:output_type -> header.Addresses
	171, // 477: header.Map.ListDistricts:output_type -> header.Addresses
	171, // 478: header.Map.ListProvinces:output_type -> header.Addresses
	171, // 479: header.Map.ListWards:output_type -> header.Addresses
	171, // 480: header.Map.ListStreets:output_type -> header.Addresses
	171, // 481: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 482: header.Map.ReadAddress:output_type -> header.Address
	9,   // 483: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	9,   // 484: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	9,   // 485: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	53,  // 486: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	12,  // 487: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	...
	202, // 627: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	202, // 628: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	53,  // 635: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	53,  // 636: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	53,  // 637: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	53,  // 638: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	61,  // 639: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	61,  // 640: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	41,  // 641: header.ConversationMgr.TerminateBot:output_type -> header.Event
	41,  // 642: header.ConversationMgr.SendMessage:output_type -> header.Event
	41,  // 643: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	41,  // 644: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	53,  // 645: header.ConversationMgr.PinMessage:output_type -> header.Empty
	53,  // 646: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	102, // 647: header.ConversationMgr.ListEvents:output_type -> header.Events
	53,  // 648: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	203, // 649: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	65,  // 650: header.ConversationMgr.Integrate:output_type -> header.Integration
	65,  // 651: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	66,  // 652: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	66,  // 653: header.ConversationMgr.CreateRule:output_type -> header.Rule
	53,  // 654: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	66,  // 655: header.ConversationMgr.ReadRule:output_type -> header.Rule
	204, // 656: header.ConversationMgr.ListRules:output_type -> header.Route
	205, // 657: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	67,  // 658: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	53,  // 659: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	67,  // 660: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	206, // 661: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	68,  // 662: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	68,  // 663: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	53,  // 664: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	68,  // 665: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	65,  // 666: header.ConversationMgr.TestNumber:output_type -> header.Integration
	207, // 667: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	69,  // 668: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	70,  // 669: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	208, // 670: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	53,  // 671: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	209, // 672: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	71,  // 673: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	60,  // 674: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	210, // 675: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	41,  // 676: header.ConversationMgr.SaveMessage:output_type -> header.Event
	41,  // 677: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	72,  // 678: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	72,  // 679: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	53,  // 680: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	72,  // 681: header.TemplateMgr.GetTemplate:output_type -> header.Template
	211, // 682: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	53,  // 683: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	74,  // 684: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	74,  // 685: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	53,  // 686: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	74,  // 687: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	212, // 688: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	213, // 689: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	76,  // 690: header.TagMgr.CreateTag:output_type -> header.Tag
	76,  // 691: header.TagMgr.UpdateTag:output_type -> header.Tag
	53,  // 692: header.TagMgr.DeleteTag:output_type -> header.Empty
	214, // 693: header.TagMgr.ListTags:output_type -> header.Tags
	76,  // 694: header.TagMgr.GetTag:output_type -> header.Tag
	77,  // 695: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	77,  // 696: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	53,  // 697: header.Noti5Service.Noti:output_type -> header.Empty
	53,  // 698: header.Noti5Service.AddToken:output_type -> header.Empty
	53,  // 699: header.Noti5Service.RemoveToken:output_type -> header.Empty
	53,  // 700: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	215, // 701: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	216, // 702: header.PaymentMgr.GetSub:output_type -> header.AccSub
	84,  // 703: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	81,  // 704: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	81,  // 705: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	82,  // 706: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	82,  // 707: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	53,  // 708: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	217, // 709: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	218, // 710: header.PaymentMgr.Pay:output_type -> payment.Bill
	84,  // 711: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	84,  // 712: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	219, // 713: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	84,  // 714: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	84,  // 715: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	220, // 716: header.PaymentMgr.ListComments:output_type -> payment.Comments
	88,  // 717: header.PaymentMgr.AddComment:output_type -> payment.Comment
	221, // 718: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	92,  // 719: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	92,  // 720: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	89,  // 721: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	218, // 722: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	222, // 723: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	91,  // 724: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	91,  // 725: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	53,  // 726: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	91,  // 727: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	223, // 728: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	53,  // 729: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	96,  // 730: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	96,  // 731: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	224, // 732: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	96,  // 733: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	225, // 734: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	226, // 735: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	227, // 736: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	53,  // 737: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	53,  // 738: header.Pubsub.Fire:output_type -> header.Empty
	228, // 739: header.Pubsub.Poll:output_type -> header.PollResult
	99,  // 740: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	100, // 741: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	100, // 742: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	229, // 743: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	230, // 744: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	101, // 745: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	53,  // 746: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	53,  // 747: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	53,  // 748: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	7,   // 749: header.FabikonService.GenerateRefLink:output_type -> header.Id
	53,  // 750: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	231, // 751: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	53,  // 752: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	53,  // 753: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	53,  // 754: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	232, // 755: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	41,  // 756: header.ZalokonService.SendZNS:output_type -> header.Event
	53,  // 757: header.MailkonService.SendEmail:output_type -> header.Empty
	65,  // 758: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	53,  // 759: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	53,  // 760: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	233, // 761: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	234, // 762: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	105, // 763: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	53,  // 764: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	232, // 765: header.MailkonService.TrackLink:output_type -> header.Response
	232, // 766: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	107, // 767: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	232, // 768: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	232, // 769: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	232, // 770: header.MailkonService.BlockEmail:output_type -> header.Response
	232, // 771: header.MailkonService.UnblockEmail:output_type -> header.Response
	109, // 772: header.WidgetService.Read:output_type -> header.WidgetSetting
	109, // 773: header.WidgetService.Update:output_type -> header.WidgetSetting
	235, // 774: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	236, // 775: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	110, // 776: header.WidgetService.SubmitImpression:output_type -> header.Impression
	111, // 777: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	112, // 778: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	237, // 779: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	238, // 780: header.WidgetService.ListConversions:output_type -> header.Conversions
	239, // 781: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	115, // 782: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	240, // 783: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	53,  // 784: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	241, // 785: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	116, // 786: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	116, // 787: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	116, // 788: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	53,  // 789: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	116, // 790: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	241, // 791: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	53,  // 792: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	242, // 793: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	240, // 794: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	243, // 795: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	244, // 796: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	245, // 797: header.Bizbot.ListBots:output_type -> header.Bots
	119, // 798: header.Bizbot.GetBot:output_type -> header.Bot
	119, // 799: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	119, // 800: header.Bizbot.CreateBot:output_type -> header.Bot
	119, // 801: header.Bizbot.UpdateBot:output_type -> header.Bot
	53,  // 802: header.Bizbot.DeleteBot:output_type -> header.Empty
	53,  // 803: header.Bizbot.OnEvent:output_type -> header.Empty
	53,  // 804: header.Bizbot.StartBot:output_type -> header.Empty
	53,  // 805: header.Bizbot.StopBot:output_type -> header.Empty
	53,  // 806: header.Bizbot.TryAction:output_type -> header.Empty
	246, // 807: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	247, // 808: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	248, // 809: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	249, // 810: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	125, // 811: header.Sendback.CreateWebhook:output_type -> header.Webhook
	250, // 812: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	53,  // 813: header.Sendback.DeleteWebhook:output_type -> header.Empty
	251, // 814: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	125, // 815: header.Sendback.ReadWebhook:output_type -> header.Webhook
	125, // 816: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	125, // 817: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	252, // 818: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	253, // 819: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	53,  // 820: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	53,  // 821: header.Notibox.SendNoti:output_type -> header.Empty
	254, // 822: header.Notibox.ListNoties:output_type -> header.Notifications
	53,  // 823: header.Notibox.MarkReadNoti:output_type -> header.Empty
	53,  // 824: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	53,  // 825: header.Holap.UpdateUser:output_type -> header.Empty
	53,  // 826: header.Holap.UpdateConversation:output_type -> header.Empty
	53,  // 827: header.Holap.OnConversationEvent:output_type -> header.Empty
	255, // 828: header.Holap.ReportUser:output_type -> header.UserMetrics
	169, // 829: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	8,   // 830: header.Holap.ListUserIds:output_type -> header.Ids
	202, // 831: header.Holap.ListConversationIds:output_type -> header.Conversations
	256, // 832: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	8,   // 833: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	53,  // 834: header.Holap.UpdateOrder:output_type -> header.Empty
	140, // 835: header.Holap.ReportOrder:output_type -> header.Orders
	257, // 836: header.Holap.ReportCall:output_type -> header.CallMetrics
	202, // 837: header.Holap.ListCallIds:output_type -> header.Conversations
	39,  // 838: header.Proder.ReadProduct:output_type -> header.Product
	39,  // 839: header.Proder.CreateProduct:output_type -> header.Product
	39,  // 840: header.Proder.UpdateProduct:output_type -> header.Product
	53,  // 841: header.Proder.DeleteProduct:output_type -> header.Empty
	258, // 842: header.Proder.ListProducts2:output_type -> header.Products
	259, // 843: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	260, // 844: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 845: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 846: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	53,  // 847: header.Proder.DeleteProductCollection:output_type -> header.Empty
	261, // 848: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 849: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 850: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	53,  // 851: header.Proder.DeleteProductFeed:output_type -> header.Empty
	262, // 852: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	22,  // 853: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 854: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 855: header.Proder.UpdateOrder:output_type -> header.Order
	53,  // 856: header.Proder.DeleteOrder:output_type -> header.Empty
	140, // 857: header.Proder.ListOrders:output_type -> header.Orders
	263, // 858: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 859: header.Proder.ImportOrders:output_type -> header.Orders
	41,  // 860: header.Proder.MakeOrderPayment:output_type -> header.Event
	41,  // 861: header.Proder.DeleteOrderPayment:output_type -> header.Event
	41,  // 862: header.Proder.AddOrderComment:output_type -> header.Event
	41,  // 863: header.Proder.EditOrderComment:output_type -> header.Event
	41,  // 864: header.Proder.DeleteOrderComment:output_type -> header.Event
	264, // 865: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	265, // 866: header.Proder.DownloadOrder:output_type -> header.File
	7,   // 867: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	266, // 868: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	53,  // 869: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	267, // 870: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	53,  // 871: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	53,  // 872: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 873: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 874: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 875: header.Proder.UpdateShippingCode:output_type -> header.Order
	22,  // 876: header.Proder.CancelShippingOrder:output_type -> header.Order
	265, // 877: header.Proder.PrintShippingOrders:output_type -> header.File
	53,  // 878: header.Proder.SeenOrder:output_type -> header.Empty
	53,  // 879: header.Proder.FollowOrder:output_type -> header.Empty
	53,  // 880: header.Proder.UnfollowOrder:output_type -> header.Empty
	53,  // 881: header.Proder.TagOrder:output_type -> header.Empty
	53,  // 882: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 883: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 884: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 885: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	53,  // 886: header.Proder.DeletePipeline:output_type -> header.Empty
	268, // 887: header.Proder.ListPipelines:output_type -> header.Pipelines
	53,  // 888: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 889: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 890: header.Proder.ReportOrder:output_type -> header.Orders
	53,  // 891: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	44,  // 892: header.TaskMgr.ReadTask:output_type -> header.Task
	44,  // 893: header.TaskMgr.CreateTask:output_type -> header.Task
	44,  // 894: header.TaskMgr.UpdateTask:output_type -> header.Task
	53,  // 895: header.TaskMgr.DeleteTask:output_type -> header.Empty
	269, // 896: header.TaskMgr.ListTasks:output_type -> header.Tasks
	53,  // 897: header.TaskMgr.SeenTask:output_type -> header.Empty
	53,  // 898: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	53,  // 899: header.TaskMgr.MuteTask:output_type -> header.Empty
	53,  // 900: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	41,  // 901: header.TaskMgr.AddTaskComment:output_type -> header.Event
	41,  // 902: header.TaskMgr.EditTaskComment:output_type -> header.Event
	41,  // 903: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	270, // 904: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	152, // 905: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	271, // 906: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	153, // 907: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	153, // 908: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	153, // 909: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	53,  // 910: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	53,  // 911: header.CampaignMgr.OnEvent:output_type -> header.Empty
	272, // 912: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	273, // 913: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	274, // 914: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	156, // 915: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	275, // 916: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	156, // 917: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	53,  // 918: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	276, // 919: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	53,  // 920: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	277, // 921: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	278, // 922: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	279, // 923: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	232, // 924: header.CreditMgr.ListCredits:output_type -> header.Response
	232, // 925: header.CreditMgr.AddCredit:output_type -> header.Response
	232, // 926: header.CreditMgr.DeleteCredit:output_type -> header.Response
	232, // 927: header.CreditMgr.UpdateCredit:output_type -> header.Response
	280, // 928: header.FormMgr.ListForms:output_type -> header.Forms
	...
	281, // 932: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	282, // 933: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	166, // 934: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	232, // 935: header.Scheduler.UnregisterTask:output_type -> header.Response
