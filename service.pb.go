...
var file_service_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x69, 0x0a, 0x14, 0x43, 0x6f, 0x6e, 0x76,
	0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72,
	...
	0x6e, 0x73, 0x65, 0x32, 0xe8, 0x11, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x0e,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x0a,
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x11, 0x2e, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2b, 0x0a,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xab,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf2, 0x01, 0x0a, 0x07, 0x4e,
	0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x4d, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Empty)(nil),                             // 43: header.Empty
	(*AttributeDefinition)(nil),               // 44: header.AttributeDefinition
	(*AvailibilityReportRequest)(nil),         // 45: header.AvailibilityReportRequest
	...
	(*ListConversationEventsRequest)(nil),     // 55: header.ListConversationEventsRequest
	(*Integration)(nil),                       // 56: header.Integration
	(*Rule)(nil),                              // 57: header.Rule
	(*ConversationAutomation)(nil),            // 58: header.ConversationAutomation
	(*Template)(nil),                          // 59: header.Template
	(*SearchTemplate)(nil),                    // 60: header.SearchTemplate
	(*ConversationModal)(nil),                 // 61: header.ConversationModal
	(*ConversationModalPickRequest)(nil),      // 62: header.ConversationModalPickRequest
	(*Tag)(nil),                               // 63: header.Tag
	(*ListUserEventsRequest)(nil),             // 64: header.ListUserEventsRequest
	(*UserEvent)(nil),                         // 65: header.UserEvent
	(*FileHeader)(nil),                        // 66: header.FileHeader
	(*FileRequest)(nil),                       // 67: header.FileRequest
	(*FileUrlDownloadRequest)(nil),            // 68: header.FileUrlDownloadRequest
	(*noti5.Setting)(nil),                     // 69: noti5.Setting
	(*PushNoti)(nil),                          // 70: header.PushNoti
	(*noti5.Token)(nil),                       // 71: noti5.Token
	(*payment.Bill)(nil),                      // 72: payment.Bill
	(*account.SearchSubRequest)(nil),          // 73: account.SearchSubRequest
	(*payment.Subscription)(nil),              // 74: payment.Subscription
	(*payment.PaymentMethod)(nil),             // 75: payment.PaymentMethod
	(*payment.PayRequest)(nil),                // 76: payment.PayRequest
	(*payment.Invoice)(nil),                   // 77: payment.Invoice
	(*payment.ListInvoiceRequest)(nil),        // 78: payment.ListInvoiceRequest
	(*payment.DiffSubRequest)(nil),            // 79: payment.DiffSubRequest
	(*payment.ListCommentsRequest)(nil),       // 80: payment.ListCommentsRequest
	(*payment.Comment)(nil),                   // 81: payment.Comment
	(*ExchangeRate)(nil),                      // 82: header.ExchangeRate
	(*payment.ListLogsRequest)(nil),           // 83: payment.ListLogsRequest
	(*payment.PromotionCode)(nil),             // 84: payment.PromotionCode
	(*payment.String)(nil),                    // 85: payment.String
	(*payment.PromotionCodeRequest)(nil),      // 86: payment.PromotionCodeRequest
	(*payment.ListPromotionCodeRequest)(nil),  // 87: payment.ListPromotionCodeRequest
	(*payment.SearchReferredRequest)(nil),     // 88: payment.SearchReferredRequest
	(*payment.Referral)(nil),                  // 89: payment.Referral
	(*payment.LogPaidForAgentReferrer)(nil),   // 90: payment.LogPaidForAgentReferrer
	(*PublishMessage)(nil),                    // 91: header.PublishMessage
	(*FbFanpageSetting)(nil),                  // 92: header.FbFanpageSetting
	(*FacebookPost)(nil),                      // 93: header.FacebookPost
	(*Events)(nil),                            // 94: header.Events
	(*WidgetSetting)(nil),                     // 95: header.WidgetSetting
	(*Impression)(nil),                        // 96: header.Impression
	(*Conversion)(nil),                        // 97: header.Conversion
	(*UserCampaignStatus)(nil),                // 98: header.UserCampaignStatus
	(*ReportCampaignRequest)(nil),             // 99: header.ReportCampaignRequest
	(*ConversionRequest)(nil),                 // 100: header.ConversionRequest
	(*UploadedImage)(nil),                     // 101: header.UploadedImage
	(*WebPlugin)(nil),                         // 102: header.WebPlugin
	(*ReportWebPluginRequest)(nil),            // 103: header.ReportWebPluginRequest
	(*Bot)(nil),                               // 104: header.Bot
	(*BotRunRequest)(nil),                     // 105: header.BotRunRequest
	(*BotrunMetricsRequest)(nil),              // 106: header.BotrunMetricsRequest
	(*ActionrunMetricsRequest)(nil),           // 107: header.ActionrunMetricsRequest
	(*ListObjectsRequest)(nil),                // 108: header.ListObjectsRequest
	(*ReportBotRequest)(nil),                  // 109: header.ReportBotRequest
	(*Webhook)(nil),                           // 110: header.Webhook
	(*RecentIndexDeliveryRequest)(nil),        // 111: header.RecentIndexDeliveryRequest
	(*DeliveryRequest)(nil),                   // 112: header.DeliveryRequest
	(*ListNotiRequest)(nil),                   // 113: header.ListNotiRequest
	(*Notification)(nil),                      // 114: header.Notification
	(*Webpage)(nil),                           // 115: header.Webpage
	(*RecentWebpageCheckRequest)(nil),         // 116: header.RecentWebpageCheckRequest
	(*WebpageCheckRequest)(nil),               // 117: header.WebpageCheckRequest
	(*WebpageReportRequest)(nil),              // 118: header.WebpageReportRequest
	(*AccountImage)(nil),                      // 119: header.AccountImage
	(*UserMetricsRequest)(nil),                // 120: header.UserMetricsRequest
	(*ConversationMetricsRequest)(nil),        // 121: header.ConversationMetricsRequest
	(*AgentMetricsRequest)(nil),               // 122: header.AgentMetricsRequest
	(*OrderMetricsRequest)(nil),               // 123: header.OrderMetricsRequest
	(*Product)(nil),                           // 124: header.Product
	...
	(*ContactProfiles)(nil),                   // 165: header.ContactProfiles
	(*Locations)(nil),                         // 166: header.Locations
	(*LocationMetrics)(nil),                   // 167: header.LocationMetrics
	(*PageMetrics)(nil),                       // 168: header.PageMetrics
	(*SourceMetrics)(nil),                     // 169: header.SourceMetrics
	(*UserMetric)(nil),                        // 170: header.UserMetric
	(*PresencesResponse)(nil),                 // 171: header.PresencesResponse
	(*Notes)(nil),                             // 172: header.Notes
	(*AttributeDefinitions)(nil),              // 173: header.AttributeDefinitions
	(*ReportResponse)(nil),                    // 174: header.ReportResponse
	(*RouteResult)(nil),                       // 175: header.RouteResult
	(*Conversations)(nil),                     // 176: header.Conversations
	(*account.Presence)(nil),                  // 177: account.Presence
	...
	(*Templates)(nil),                         // 181: header.Templates
	(*ConversationModals)(nil),                // 182: header.ConversationModals
	(*ConversationModalPicked)(nil),           // 183: header.ConversationModalPicked
	(*Tags)(nil),                              // 184: header.Tags
	(*PresignResult)(nil),                     // 185: header.PresignResult
	(*File)(nil),                              // 186: header.File
	(*account.AccSubs)(nil),                   // 187: account.AccSubs
	(*payment.PaymentMethods)(nil),            // 188: payment.PaymentMethods
	(*payment.Invoices)(nil),                  // 189: payment.Invoices
	(*payment.Comments)(nil),                  // 190: payment.Comments
	(*payment.Plans)(nil),                     // 191: payment.Plans
	(*payment.Logs)(nil),                      // 192: payment.Logs
	(*payment.PromotionCodes)(nil),            // 193: payment.PromotionCodes
	(*payment.ReferralResponse)(nil),          // 194: payment.ReferralResponse
	(*payment.LogAccountReferreds)(nil),       // 195: payment.LogAccountReferreds
	(*payment.LogBillByAccountReferreds)(nil), // 196: payment.LogBillByAccountReferreds
	(*payment.LogPaidForAgentReferrers)(nil),  // 197: payment.LogPaidForAgentReferrers
	(*FbFanpageSettings)(nil),                 // 198: header.FbFanpageSettings
	(*FacebookPosts)(nil),                     // 199: header.FacebookPosts
	(*WidgetUserSetting)(nil),                 // 200: header.WidgetUserSetting
	(*AccountWeb)(nil),                        // 201: header.AccountWeb
	(*ReportCampaignResponse)(nil),            // 202: header.ReportCampaignResponse
	(*Conversions)(nil),                       // 203: header.Conversions
	(*ConversionsExported)(nil),               // 204: header.ConversionsExported
	(*UploadedImages)(nil),                    // 205: header.UploadedImages
	(*WebPlugins)(nil),                        // 206: header.WebPlugins
	(*ReportWebPluginResponse)(nil),           // 207: header.ReportWebPluginResponse
	(*NotifProfiles)(nil),                     // 208: header.NotifProfiles
	(*Urls)(nil),                              // 209: header.Urls
	(*Bots)(nil),                              // 210: header.Bots
	(*BotrunMetrics)(nil),                     // 211: header.BotrunMetrics
	(*ActionrunMetrics)(nil),                  // 212: header.ActionrunMetrics
	(*ListObjectsResponse)(nil),               // 213: header.ListObjectsResponse
	(*ReportBotResponse)(nil),                 // 214: header.ReportBotResponse
	(*WebhookTestResult)(nil),                 // 215: header.WebhookTestResult
	(*Webhooks)(nil),                          // 216: header.Webhooks
	(*WebhookDeliveries)(nil),                 // 217: header.WebhookDeliveries
	(*WebhookDelivery)(nil),                   // 218: header.WebhookDelivery
	(*CompactedNoties)(nil),                   // 219: header.CompactedNoties
...
var file_service_proto_depIdxs = []int32{
	...
	43,  // 127: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	44,  // 128: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	44,  // 129: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	45,  // 130: header.ConversationReporter.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	46,  // 131: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	47,  // 132: header.ConversationMgr.PongMessage:input_type -> header.Event
	48,  // 133: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	...
	49,  // 136: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	5,   // 137: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	50,  // 138: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	50,  // 139: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	51,  // 140: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	51,  // 141: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	4,   // 142: header.ConversationMgr.Typing:input_type -> header.Id
	52,  // 143: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	28,  // 144: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	52,  // 145: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	51,  // 146: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	52,  // 147: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	52,  // 148: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	53,  // 149: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	4,   // 150: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	54,  // 151: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	4,   // 152: header.ConversationMgr.UpdatePresence:input_type -> header.Id
	47,  // 153: header.ConversationMgr.SendMessage:input_type -> header.Event
	47,  // 154: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	47,  // 155: header.ConversationMgr.PinMessage:input_type -> header.Event
	47,  // 156: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	55,  // 157: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	...
	56,  // 160: header.ConversationMgr.Integrate:input_type -> header.Integration
	4,   // 161: header.ConversationMgr.GetIntegration:input_type -> header.Id
	57,  // 162: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	57,  // 163: header.ConversationMgr.CreateRule:input_type -> header.Rule
	...
	58,  // 168: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	...
	59,  // 171: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	59,  // 172: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 173: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 174: header.TemplateMgr.GetTemplate:input_type -> header.Id
	60,  // 175: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 176: header.TemplateMgr.PickTemplate:input_type -> header.Id
	61,  // 177: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	61,  // 178: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	...
	62,  // 182: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	63,  // 183: header.TagMgr.CreateTag:input_type -> header.Tag
	63,  // 184: header.TagMgr.UpdateTag:input_type -> header.Tag
	...
	64,  // 188: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	65,  // 189: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	66,  // 190: header.FileMgr.Presign:input_type -> header.FileHeader
	67,  // 191: header.FileMgr.Uploaded:input_type -> header.FileRequest
	68,  // 192: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 193: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	69,  // 194: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	70,  // 195: header.Noti5Service.Noti:input_type -> header.PushNoti
	71,  // 196: header.Noti5Service.AddToken:input_type -> noti5.Token
	71,  // 197: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	71,  // 198: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	72,  // 199: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	73,  // 200: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	74,  // 201: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	74,  // 202: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 203: header.PaymentMgr.GetSubscription:input_type -> header.Id
	75,  // 204: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	75,  // 205: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	76,  // 208: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	77,  // 209: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	77,  // 210: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	78,  // 211: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	74,  // 212: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	79,  // 213: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	80,  // 214: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	81,  // 215: header.PaymentMgr.AddComment:input_type -> payment.Comment
	43,  // 216: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 217: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	77,  // 218: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	82,  // 219: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	76,  // 220: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	83,  // 221: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	84,  // 222: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	85,  // 223: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	86,  // 224: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	86,  // 225: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	87,  // 226: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 227: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	88,  // 228: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 229: header.PaymentMgr.GetReferral:input_type -> header.Id
	43,  // 230: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	89,  // 231: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	90,  // 235: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	91,  // 236: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 237: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	92,  // 238: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	93,  // 241: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	94,  // 242: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	94,  // 243: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	94,  // 244: header.MailkonService.SendEvent:input_type -> header.Events
	...
	95,  // 249: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	96,  // 252: header.WidgetService.SubmitImpression:input_type -> header.Impression
	97,  // 253: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	98,  // 254: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	99,  // 255: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	100, // 256: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	100, // 257: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	101, // 258: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 259: header.WidgetService.ListUploadedImage:input_type -> header.Id
	101, // 260: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 261: header.WidgetService.ListWebPlugins:input_type -> header.Id
	102, // 262: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	102, // 263: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	102, // 264: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 265: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	102, // 266: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	103, // 269: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	104, // 275: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	104, // 276: header.Bizbot.CreateBot:input_type -> header.Bot
	104, // 277: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 278: header.Bizbot.DeleteBot:input_type -> header.Id
	105, // 279: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	105, // 280: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	105, // 281: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	105, // 282: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	106, // 283: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	107, // 284: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	108, // 285: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	109, // 286: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	110, // 287: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	110, // 292: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 293: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	111, // 294: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	112, // 295: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	47,  // 296: header.Sendback.SendWebhookEvent:input_type -> header.Event
	113, // 297: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	114, // 298: header.Notibox.SendNoti:input_type -> header.Notification
	113, // 299: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 300: header.Notibox.MarkReadNoti:input_type -> header.Id
	115, // 301: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 302: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 303: header.Watchhttp.ListWebpages:input_type -> header.Id
	115, // 304: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 305: header.Watchhttp.ReadWebpage:input_type -> header.Id
	116, // 306: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	117, // 307: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	118, // 308: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	118, // 309: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 310: header.Holap.AppendAgentSet:input_type -> account.Agent
	63,  // 311: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 312: header.Holap.UpdateUser:input_type -> header.User
	52,  // 313: header.Holap.UpdateConversation:input_type -> header.Conversation
	47,  // 314: header.Holap.OnConversationEvent:input_type -> header.Event
	119, // 315: header.Holap.FreeAccount:input_type -> header.AccountImage
	120, // 316: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	121, // 317: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	120, // 318: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	121, // 319: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	122, // 320: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 321: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	31,  // 322: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 323: header.Holap.UpdateOrder:input_type -> header.Order
	123, // 324: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	124, // 325: header.Proder.ReadProduct:input_type -> header.Product
	124, // 326: header.Proder.CreateProduct:input_type -> header.Product
	124, // 327: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 328: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 329: header.Proder.RestoreProduct:input_type -> header.Id
	125, // 330: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 331: header.Proder.ListProductIds:input_type -> header.Ids
	125, // 332: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	126, // 333: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 334: header.Proder.ListProductCollections:input_type -> header.Ids
	127, // 335: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	127, // 336: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 337: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 338: header.Proder.ListProductFeeds:input_type -> header.Id
	128, // 339: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	128, // 340: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 341: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 342: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 343: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 344: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 345: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 346: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 347: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 348: header.Proder.RestoreOrder:input_type -> header.Id
	129, // 349: header.Proder.ListOrders:input_type -> header.OrdersRequest
	129, // 350: header.Proder.CountOrders:input_type -> header.OrdersRequest
	130, // 351: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	131, // 352: header.Proder.MakeOrderPayment:input_type -> header.Bill
	132, // 353: header.Proder.DeleteOrderPayment:input_type -> header.Key
	47,  // 354: header.Proder.AddOrderComment:input_type -> header.Event
	47,  // 355: header.Proder.EditOrderComment:input_type -> header.Event
	132, // 356: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 357: header.Proder.ListOrderEvents:input_type -> header.Id
	133, // 358: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 359: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	134, // 360: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 361: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	135, // 362: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	136, // 363: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	137, // 364: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	138, // 365: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 366: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 367: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 368: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 369: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 370: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 371: header.Proder.UnfollowOrder:input_type -> header.Id
	139, // 372: header.Proder.VisitProductSite:input_type -> header.VisitProductSiteRequest
	4,   // 373: header.Apiece.ReadTask:input_type -> header.Id
	140, // 374: header.Apiece.CreateTask:input_type -> header.Task
	140, // 375: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 376: header.Apiece.DeleteTask:input_type -> header.Id
	141, // 377: header.Apiece.ListTasks:input_type -> header.TasksRequest
	47,  // 378: header.Apiece.AddTaskComment:input_type -> header.Event
	47,  // 379: header.Apiece.EditTaskComment:input_type -> header.Event
	132, // 380: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 381: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 382: header.Apiece.ReadPipeline:input_type -> header.Id
	142, // 383: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	142, // 384: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 385: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 386: header.Apiece.ListPipelines:input_type -> header.Ids
	143, // 387: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	43,  // 388: header.Search.Index:output_type -> header.Empty
	144, // 389: header.Search.Search:output_type -> header.DocSearchResponse
	43,  // 390: header.Search.AddOwner:output_type -> header.Empty
	145, // 391: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 392: header.Map.LookupAddress:output_type -> header.Address
	146, // 393: header.Map.PredictAddress:output_type -> header.Addresses
	146, // 394: header.Map.ListDistricts:output_type -> header.Addresses
	146, // 395: header.Map.ListProvinces:output_type -> header.Addresses
	146, // 396: header.Map.ListWards:output_type -> header.Addresses
	146, // 397: header.Map.ListStreets:output_type -> header.Addresses
	146, // 398: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 399: header.Map.ReadAddress:output_type -> header.Address
	6,   // 400: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 401: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 402: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	43,  // 403: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 404: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 405: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 406: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	43,  // 407: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 408: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 409: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 410: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 411: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 412: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 413: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 414: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 415: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 416: header.AccountMgr.CreateAccount:output_type -> account.Account
	147, // 417: header.AccountMgr.ListAgents:output_type -> account.Agents
	43,  // 418: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	148, // 419: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	43,  // 420: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	43,  // 421: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 422: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	149, // 423: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 424: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 425: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	150, // 426: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	150, // 427: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	43,  // 428: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 429: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	151, // 430: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 431: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 432: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	152, // 433: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 434: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 435: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	153, // 436: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	43,  // 437: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	146, // 438: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 439: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 440: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	43,  // 441: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	154, // 442: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 443: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 444: header.AccountMgr.UpdateTax:output_type -> header.Tax
	43,  // 445: header.AccountMgr.DeleteTax:output_type -> header.Empty
	155, // 446: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	155, // 447: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 448: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 449: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	43,  // 450: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 451: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	156, // 452: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 453: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	43,  // 454: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	157, // 455: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	25,  // 456: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	25,  // 457: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	43,  // 458: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	43,  // 459: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	158, // 460: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	43,  // 461: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	26,  // 462: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	26,  // 463: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	26,  // 464: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	159, // 465: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 466: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	43,  // 467: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	160, // 468: header.UserMgr.SearchUsers:output_type -> header.Users
	29,  // 469: header.UserMgr.MergeUser:output_type -> header.UserAlias
	...
	30,  // 474: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 475: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	161, // 476: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	160, // 477: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 478: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 479: header.UserMgr.CreateView:output_type -> header.UserView
	43,  // 480: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 481: header.UserMgr.GetView:output_type -> header.UserView
	162, // 482: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 483: header.UserMgr.UpsertLabel:output_type -> header.Label
	43,  // 484: header.UserMgr.DeleteLabel:output_type -> header.Empty
	163, // 485: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 486: header.UserMgr.GetLabel:output_type -> header.Label
	43,  // 487: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	43,  // 488: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	43,  // 489: header.UserMgr.AddUserLabel:output_type -> header.Empty
	43,  // 490: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	...
	43,  // 493: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	164, // 494: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	43,  // 495: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	160, // 496: header.UserMgr.ListLeads:output_type -> header.Users
	35,  // 497: header.UserMgr.GetContactProfile:output_type -> header.ContactProfile
	165, // 498: header.UserMgr.ListUserContactProfiles:output_type -> header.ContactProfiles
	30,  // 499: header.UserMgr.GetOrCreateUserByContactProfile:output_type -> header.User
	35,  // 500: header.UserMgr.UpsertContactProfile:output_type -> header.ContactProfile
	160, // 501: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	166, // 502: header.LiveMgr.SearchLocations:output_type -> header.Locations
	160, // 503: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	94,  // 504: header.LiveMgr.TopEvents:output_type -> header.Events
	167, // 505: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	168, // 506: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	169, // 507: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	170, // 508: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	171, // 509: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	172, // 510: header.NoteMgr.ListNotes:output_type -> header.Notes
	41,  // 511: header.NoteMgr.AddNote:output_type -> header.Note
	41,  // 512: header.NoteMgr.UpdateNote:output_type -> header.Note
	43,  // 513: header.NoteMgr.DeleteNote:output_type -> header.Empty
	173, // 514: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	44,  // 515: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	44,  // 516: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	174, // 517: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	175, // 518: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	47,  // 519: header.ConversationMgr.PongMessage:output_type -> header.Event
	52,  // 520: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	52,  // 521: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	52,  // 522: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	176, // 523: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	176, // 524: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	43,  // 525: header.ConversationMgr.TagConversation:output_type -> header.Empty
	43,  // 526: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	43,  // 527: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	43,  // 528: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	43,  // 529: header.ConversationMgr.Typing:output_type -> header.Empty
	52,  // 530: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	176, // 531: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	43,  // 532: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	43,  // 533: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	43,  // 534: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	43,  // 535: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	53,  // 536: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	53,  // 537: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	47,  // 538: header.ConversationMgr.TerminateBot:output_type -> header.Event
	177, // 539: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	47,  // 540: header.ConversationMgr.SendMessage:output_type -> header.Event
	47,  // 541: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	43,  // 542: header.ConversationMgr.PinMessage:output_type -> header.Empty
	43,  // 543: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	94,  // 544: header.ConversationMgr.ListEvents:output_type -> header.Events
	43,  // 545: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	178, // 546: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	56,  // 547: header.ConversationMgr.Integrate:output_type -> header.Integration
	56,  // 548: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	57,  // 549: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	57,  // 550: header.ConversationMgr.CreateRule:output_type -> header.Rule
	43,  // 551: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	57,  // 552: header.ConversationMgr.ReadRule:output_type -> header.Rule
	179, // 553: header.ConversationMgr.ListRules:output_type -> header.Route
	180, // 554: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	58,  // 555: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	43,  // 556: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	58,  // 557: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	59,  // 558: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	59,  // 559: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	43,  // 560: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	59,  // 561: header.TemplateMgr.GetTemplate:output_type -> header.Template
	181, // 562: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	43,  // 563: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	61,  // 564: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	61,  // 565: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	43,  // 566: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	61,  // 567: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	182, // 568: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	183, // 569: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	63,  // 570: header.TagMgr.CreateTag:output_type -> header.Tag
	63,  // 571: header.TagMgr.UpdateTag:output_type -> header.Tag
	43,  // 572: header.TagMgr.DeleteTag:output_type -> header.Empty
	184, // 573: header.TagMgr.ListTags:output_type -> header.Tags
	63,  // 574: header.TagMgr.GetTag:output_type -> header.Tag
	94,  // 575: header.EventMgr.SearchEvents:output_type -> header.Events
	47,  // 576: header.EventMgr.CreateEvent:output_type -> header.Event
	185, // 577: header.FileMgr.Presign:output_type -> header.PresignResult
	186, // 578: header.FileMgr.Uploaded:output_type -> header.File
	186, // 579: header.FileMgr.DownloadFileUrl:output_type -> header.File
	69,  // 580: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	69,  // 581: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	43,  // 582: header.Noti5Service.Noti:output_type -> header.Empty
	43,  // 583: header.Noti5Service.AddToken:output_type -> header.Empty
	43,  // 584: header.Noti5Service.RemoveToken:output_type -> header.Empty
	43,  // 585: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	72,  // 586: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	187, // 587: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	77,  // 588: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	74,  // 589: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	74,  // 590: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	75,  // 591: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	75,  // 592: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	43,  // 593: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	188, // 594: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	72,  // 595: header.PaymentMgr.Pay:output_type -> payment.Bill
	77,  // 596: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	77,  // 597: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	189, // 598: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	77,  // 599: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	77,  // 600: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	190, // 601: header.PaymentMgr.ListComments:output_type -> payment.Comments
	81,  // 602: header.PaymentMgr.AddComment:output_type -> payment.Comment
	191, // 603: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	85,  // 604: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	85,  // 605: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	82,  // 606: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	72,  // 607: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	192, // 608: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	84,  // 609: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	84,  // 610: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	43,  // 611: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	84,  // 612: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	193, // 613: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	43,  // 614: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	89,  // 615: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	89,  // 616: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	194, // 617: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	89,  // 618: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	195, // 619: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	196, // 620: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	197, // 621: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	43,  // 622: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	43,  // 623: header.Pubsub.Publish:output_type -> header.Empty
	92,  // 624: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	92,  // 625: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	198, // 626: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	199, // 627: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	93,  // 628: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	43,  // 629: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	43,  // 630: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	43,  // 631: header.MailkonService.SendEvent:output_type -> header.Empty
	43,  // 632: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	43,  // 633: header.MailkonService.BlockEmail:output_type -> header.Empty
	43,  // 634: header.MailkonService.UnblockEmail:output_type -> header.Empty
	95,  // 635: header.WidgetService.Read:output_type -> header.WidgetSetting
	95,  // 636: header.WidgetService.Update:output_type -> header.WidgetSetting
	200, // 637: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	201, // 638: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	96,  // 639: header.WidgetService.SubmitImpression:output_type -> header.Impression
	97,  // 640: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	98,  // 641: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	202, // 642: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	203, // 643: header.WidgetService.ListConversions:output_type -> header.Conversions
	204, // 644: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	101, // 645: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	205, // 646: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	43,  // 647: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	206, // 648: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	102, // 649: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	102, // 650: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	102, // 651: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	43,  // 652: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	102, // 653: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	206, // 654: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	43,  // 655: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	207, // 656: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	205, // 657: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	208, // 658: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	209, // 659: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	210, // 660: header.Bizbot.ListBots:output_type -> header.Bots
	104, // 661: header.Bizbot.GetBot:output_type -> header.Bot
	104, // 662: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	104, // 663: header.Bizbot.CreateBot:output_type -> header.Bot
	104, // 664: header.Bizbot.UpdateBot:output_type -> header.Bot
	43,  // 665: header.Bizbot.DeleteBot:output_type -> header.Empty
	43,  // 666: header.Bizbot.OnEvent:output_type -> header.Empty
	43,  // 667: header.Bizbot.StartBot:output_type -> header.Empty
	43,  // 668: header.Bizbot.StopBot:output_type -> header.Empty
	43,  // 669: header.Bizbot.TryAction:output_type -> header.Empty
	211, // 670: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	212, // 671: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	213, // 672: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	214, // 673: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	110, // 674: header.Sendback.CreateWebhook:output_type -> header.Webhook
	215, // 675: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	43,  // 676: header.Sendback.DeleteWebhook:output_type -> header.Empty
	216, // 677: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	110, // 678: header.Sendback.ReadWebhook:output_type -> header.Webhook
	110, // 679: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	110, // 680: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	217, // 681: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	218, // 682: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	43,  // 683: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	219, // 684: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	43,  // 685: header.Notibox.SendNoti:output_type -> header.Empty
	220, // 686: header.Notibox.ListNoties:output_type -> header.Notifications
	43,  // 687: header.Notibox.MarkReadNoti:output_type -> header.Empty
	115, // 688: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	43,  // 689: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	221, // 690: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	115, // 691: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	115, // 692: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	222, // 693: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	223, // 694: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	224, // 695: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	222, // 696: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	43,  // 697: header.Holap.AppendAgentSet:output_type -> header.Empty
	43,  // 698: header.Holap.AppendTagSet:output_type -> header.Empty
	43,  // 699: header.Holap.UpdateUser:output_type -> header.Empty
	43,  // 700: header.Holap.UpdateConversation:output_type -> header.Empty
	43,  // 701: header.Holap.OnConversationEvent:output_type -> header.Empty
	43,  // 702: header.Holap.FreeAccount:output_type -> header.Empty
	225, // 703: header.Holap.ReportUser:output_type -> header.UserMetrics
	226, // 704: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 705: header.Holap.ListUserIds:output_type -> header.Ids
	176, // 706: header.Holap.ListConversationIds:output_type -> header.Conversations
	227, // 707: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 708: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	161, // 709: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	43,  // 710: header.Holap.UpdateOrder:output_type -> header.Empty
	228, // 711: header.Holap.ReportOrder:output_type -> header.Orders
	124, // 712: header.Proder.ReadProduct:output_type -> header.Product
	124, // 713: header.Proder.CreateProduct:output_type -> header.Product
	124, // 714: header.Proder.UpdateProduct:output_type -> header.Product
	43,  // 715: header.Proder.DeleteProduct:output_type -> header.Empty
	124, // 716: header.Proder.RestoreProduct:output_type -> header.Product
	126, // 717: header.Proder.ListProducts:output_type -> header.Products
	5,   // 718: header.Proder.ListProductIds:output_type -> header.Ids
	126, // 719: header.Proder.ListGroupedProducts:output_type -> header.Products
	126, // 720: header.Proder.ImportProducts:output_type -> header.Products
	229, // 721: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	127, // 722: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	127, // 723: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	43,  // 724: header.Proder.DeleteProductCollection:output_type -> header.Empty
	230, // 725: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	128, // 726: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	128, // 727: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	43,  // 728: header.Proder.DeleteProductFeed:output_type -> header.Empty
	231, // 729: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	232, // 730: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 731: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 732: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 733: header.Proder.UpdateOrder:output_type -> header.Order
	43,  // 734: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 735: header.Proder.RestoreOrder:output_type -> header.Order
	228, // 736: header.Proder.ListOrders:output_type -> header.Orders
	228, // 737: header.Proder.CountOrders:output_type -> header.Orders
	43,  // 738: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	47,  // 739: header.Proder.MakeOrderPayment:output_type -> header.Event
	47,  // 740: header.Proder.DeleteOrderPayment:output_type -> header.Event
	47,  // 741: header.Proder.AddOrderComment:output_type -> header.Event
	47,  // 742: header.Proder.EditOrderComment:output_type -> header.Event
	47,  // 743: header.Proder.DeleteOrderComment:output_type -> header.Event
	233, // 744: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	186, // 745: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 746: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	234, // 747: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	43,  // 748: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	235, // 749: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	43,  // 750: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	43,  // 751: header.Proder.GHNShippingStatus:output_type -> header.Empty
	138, // 752: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 753: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 754: header.Proder.CancelShippingOrder:output_type -> header.Order
	186, // 755: header.Proder.PrintShippingOrders:output_type -> header.File
	43,  // 756: header.Proder.SeenOrder:output_type -> header.Empty
	43,  // 757: header.Proder.FollowOrder:output_type -> header.Empty
	43,  // 758: header.Proder.UnfollowOrder:output_type -> header.Empty
	126, // 759: header.Proder.VisitProductSite:output_type -> header.Products
	140, // 760: header.Apiece.ReadTask:output_type -> header.Task
	140, // 761: header.Apiece.CreateTask:output_type -> header.Task
	140, // 762: header.Apiece.UpdateTask:output_type -> header.Task
	43,  // 763: header.Apiece.DeleteTask:output_type -> header.Empty
	236, // 764: header.Apiece.ListTasks:output_type -> header.Tasks
	47,  // 765: header.Apiece.AddTaskComment:output_type -> header.Event
	47,  // 766: header.Apiece.EditTaskComment:output_type -> header.Event
	47,  // 767: header.Apiece.DeleteTaskComment:output_type -> header.Event
	237, // 768: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	142, // 769: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	142, // 770: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	142, // 771: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	43,  // 772: header.Apiece.DeletePipeline:output_type -> header.Empty
	238, // 773: header.Apiece.ListPipelines:output_type -> header.Pipelines
	387, // [387:774] is the sub-list for method output_type
	0,   // [0:387] is the sub-list for method input_type
