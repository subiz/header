...
var file_service_proto_rawDesc = []byte{
	...
	0x32, 0xbd, 0x13, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x0b, 0x52,
	...
	0x74, 0x79, 0x12, 0x35, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x46, 0x65, 0x65, 0x64, 0x73, 0x12, 0x0b, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	...
	0x72, 0x12, 0x31, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f,
	...
	0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x38, 0x0a, 0x18,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x58, 0x0a, 0x1e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x74, 0x61,
	0x67, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x1a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x53,
	0x74, 0x61, 0x67, 0x65, 0x1a, 0x1a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*RecentCompactedNotiRequest)(nil),        // 106: header.RecentCompactedNotiRequest
	...
	(*Webpages)(nil),                          // 205: header.Webpages
	(*WebpageChecks)(nil),                     // 206: header.WebpageChecks
	(*WebpageCheck)(nil),                      // 207: header.WebpageCheck
	(*WebpageReportDataSet)(nil),              // 208: header.WebpageReportDataSet
	(*UserMetrics)(nil),                       // 209: header.UserMetrics
	(*ConversationMetrics)(nil),               // 210: header.ConversationMetrics
	(*AgentMetrics)(nil),                      // 211: header.AgentMetrics
	(*Orders)(nil),                            // 212: header.Orders
	(*Products)(nil),                          // 213: header.Products
	(*ProductCollections)(nil),                // 214: header.ProductCollections
	(*ProductFeeds)(nil),                      // 215: header.ProductFeeds
	(*ProductCategories)(nil),                 // 216: header.ProductCategories
	(*ProductProps)(nil),                      // 217: header.ProductProps
	...
	(*TaskHistoryEntries)(nil),                // 222: header.TaskHistoryEntries
	(*Pipelines)(nil),                         // 223: header.Pipelines
}
var file_service_proto_depIdxs = []int32{
	...
	106, // 271: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	107, // 272: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	2,   // 273: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	2,   // 274: header.Watchhttp.ListWebpages:input_type -> header.Id
	107, // 275: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	2,   // 276: header.Watchhttp.ReadWebpage:input_type -> header.Id
	108, // 277: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	109, // 278: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	110, // 279: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	110, // 280: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	7,   // 281: header.Holap.AppendAgentSet:input_type -> account.Agent
	54,  // 282: header.Holap.AppendTagSet:input_type -> header.Tag
	26,  // 283: header.Holap.UpdateUser:input_type -> header.User
	49,  // 284: header.Holap.UpdateConversation:input_type -> header.Conversation
	44,  // 285: header.Holap.OnConversationEvent:input_type -> header.Event
	111, // 286: header.Holap.FreeAccount:input_type -> header.AccountImage
	112, // 287: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	113, // 288: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	112, // 289: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	113, // 290: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	114, // 291: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	3,   // 292: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	27,  // 293: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	20,  // 294: header.Holap.UpdateOrder:input_type -> header.Order
	115, // 295: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	116, // 296: header.Proder.ReadProduct:input_type -> header.Product
	116, // 297: header.Proder.CreateProduct:input_type -> header.Product
	116, // 298: header.Proder.UpdateProduct:input_type -> header.Product
	2,   // 299: header.Proder.DeleteProduct:input_type -> header.Id
	117, // 300: header.Proder.ListProducts:input_type -> header.ProductsRequest
	3,   // 301: header.Proder.ListProductIds:input_type -> header.Ids
	117, // 302: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	3,   // 303: header.Proder.ListProductCollections:input_type -> header.Ids
	118, // 304: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	118, // 305: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	2,   // 306: header.Proder.DeleteProductCollection:input_type -> header.Id
	3,   // 307: header.Proder.ListProductFeeds:input_type -> header.Ids
	119, // 308: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	119, // 309: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	2,   // 310: header.Proder.DeleteProductFeed:input_type -> header.Id
	3,   // 311: header.Proder.ListProductCategories:input_type -> header.Ids
	3,   // 312: header.Proder.ListProductProps:input_type -> header.Ids
	2,   // 313: header.Proder.ReadOrder:input_type -> header.Id
	20,  // 314: header.Proder.CreateOrder:input_type -> header.Order
	20,  // 315: header.Proder.UpdateOrder:input_type -> header.Order
	20,  // 316: header.Proder.UpdateOrderStatus:input_type -> header.Order
	2,   // 317: header.Proder.DeleteOrder:input_type -> header.Id
	120, // 318: header.Proder.ListOrders:input_type -> header.OrdersRequest
	120, // 319: header.Proder.CountOrders:input_type -> header.OrdersRequest
	121, // 320: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	122, // 321: header.Proder.MakeOrderPayment:input_type -> header.Bill
	123, // 322: header.Proder.DeleteOrderPayment:input_type -> header.Key
	44,  // 323: header.Proder.AddOrderComment:input_type -> header.Event
	44,  // 324: header.Proder.EditOrderComment:input_type -> header.Event
	123, // 325: header.Proder.DeleteOrderComment:input_type -> header.Key
	2,   // 326: header.Proder.ListOrderEvents:input_type -> header.Id
	124, // 327: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	2,   // 328: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	125, // 329: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	2,   // 330: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	126, // 331: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	127, // 332: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	128, // 333: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	129, // 334: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	2,   // 335: header.Proder.ShipOrder:input_type -> header.Id
	2,   // 336: header.Proder.CancelShippingOrder:input_type -> header.Id
	3,   // 337: header.Proder.PrintShippingOrders:input_type -> header.Ids
	20,  // 338: header.Proder.UpdateOrderPipelineStage:input_type -> header.Order
	130, // 339: header.Proder.UpdateOrderPipelineStageDetail:input_type -> header.OrderPipelineStage
	2,   // 340: header.Apiece.ReadTask:input_type -> header.Id
	131, // 341: header.Apiece.CreateTask:input_type -> header.Task
	131, // 342: header.Apiece.UpdateTask:input_type -> header.Task
	2,   // 343: header.Apiece.DeleteTask:input_type -> header.Id
	132, // 344: header.Apiece.ListTasks:input_type -> header.TasksRequest
	44,  // 345: header.Apiece.AddTaskComment:input_type -> header.Event
	44,  // 346: header.Apiece.EditTaskComment:input_type -> header.Event
	123, // 347: header.Apiece.DeleteTaskComment:input_type -> header.Key
	2,   // 348: header.Apiece.ListTaskComments:input_type -> header.Id
	2,   // 349: header.Apiece.ReadPipeline:input_type -> header.Id
	133, // 350: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	133, // 351: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	2,   // 352: header.Apiece.DeletePipeline:input_type -> header.Id
	3,   // 353: header.Apiece.ListPipelines:input_type -> header.Ids
	134, // 354: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	135, // 355: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	18,  // 356: header.Map.LookupAddress:output_type -> header.Address
	136, // 357: header.Map.PredictAddress:output_type -> header.Addresses
	136, // 358: header.Map.ListDistricts:output_type -> header.Addresses
	136, // 359: header.Map.ListProvinces:output_type -> header.Addresses
	136, // 360: header.Map.ListWards:output_type -> header.Addresses
	136, // 361: header.Map.ListStreets:output_type -> header.Addresses
	136, // 362: header.Map.ListAddresses:output_type -> header.Addresses
	18,  // 363: header.Map.ReadAddress:output_type -> header.Address
	4,   // 364: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	4,   // 365: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	4,   // 366: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	39,  // 367: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	7,   // 368: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	7,   // 369: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	7,   // 370: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	39,  // 371: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	7,   // 372: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	7,   // 373: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	7,   // 374: header.AccountMgr.GetInvitation:output_type -> account.Agent
	7,   // 375: header.AccountMgr.InviteAgent:output_type -> account.Agent
	7,   // 376: header.AccountMgr.GetAgent:output_type -> account.Agent
	9,   // 377: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	9,   // 378: header.AccountMgr.GetAccount:output_type -> account.Account
	9,   // 379: header.AccountMgr.UpdateAccount:output_type -> account.Account
	9,   // 380: header.AccountMgr.CreateAccount:output_type -> account.Account
	137, // 381: header.AccountMgr.ListAgents:output_type -> account.Agents
	39,  // 382: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	138, // 383: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	39,  // 384: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	39,  // 385: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	7,   // 386: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	139, // 387: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	7,   // 388: header.AccountMgr.TransferOwner:output_type -> account.Agent
	13,  // 389: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	140, // 390: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	140, // 391: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	39,  // 392: header.AccountMgr.LogoutSession:output_type -> header.Empty
	13,  // 393: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	141, // 394: header.AccountMgr.GetLanguage:output_type -> header.Lang
	14,  // 395: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	15,  // 396: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	142, // 397: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	17,  // 398: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	17,  // 399: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	143, // 400: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	39,  // 401: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	136, // 402: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	18,  // 403: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	18,  // 404: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	39,  // 405: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	144, // 406: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	19,  // 407: header.AccountMgr.CreateTax:output_type -> header.Tax
	19,  // 408: header.AccountMgr.UpdateTax:output_type -> header.Tax
	39,  // 409: header.AccountMgr.DeleteTax:output_type -> header.Empty
	145, // 410: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	145, // 411: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	21,  // 412: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	21,  // 413: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	39,  // 414: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	39,  // 415: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	146, // 416: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	22,  // 417: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	22,  // 418: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	39,  // 419: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	39,  // 420: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	147, // 421: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	39,  // 422: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	23,  // 423: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	23,  // 424: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	23,  // 425: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	148, // 426: header.UserMgr.SearchUsers:output_type -> header.Users
	25,  // 427: header.UserMgr.MergeUser:output_type -> header.UserAlias
	2,   // 428: header.UserMgr.CreateUser:output_type -> header.Id
	2,   // 429: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	2,   // 430: header.UserMgr.UpdateUser:output_type -> header.Id
	26,  // 431: header.UserMgr.ReadUser:output_type -> header.User
	149, // 432: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	148, // 433: header.UserMgr.MatchUsers:output_type -> header.Users
	28,  // 434: header.UserMgr.UpdateView:output_type -> header.UserView
	28,  // 435: header.UserMgr.CreateView:output_type -> header.UserView
	39,  // 436: header.UserMgr.DeleteView:output_type -> header.Empty
	28,  // 437: header.UserMgr.GetView:output_type -> header.UserView
	150, // 438: header.UserMgr.ListViews:output_type -> header.UserViews
	29,  // 439: header.UserMgr.UpsertLabel:output_type -> header.Label
	39,  // 440: header.UserMgr.DeleteLabel:output_type -> header.Empty
	151, // 441: header.UserMgr.ListLabels:output_type -> header.Labels
	29,  // 442: header.UserMgr.GetLabel:output_type -> header.Label
	39,  // 443: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	39,  // 444: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	39,  // 445: header.UserMgr.AddUserLabel:output_type -> header.Empty
	39,  // 446: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	18,  // 447: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	18,  // 448: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	39,  // 449: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	26,  // 450: header.UserMgr.ListShippingAddress:output_type -> header.User
	39,  // 451: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	148, // 452: header.UserMgr.ListLeads:output_type -> header.Users
	152, // 453: header.LiveMgr.SearchLocations:output_type -> header.Locations
	148, // 454: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	153, // 455: header.LiveMgr.TopEvents:output_type -> header.Events
	154, // 456: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	155, // 457: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	156, // 458: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	157, // 459: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	158, // 460: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	159, // 461: header.NoteMgr.ListNotes:output_type -> header.Notes
	36,  // 462: header.NoteMgr.AddNote:output_type -> header.Note
	36,  // 463: header.NoteMgr.UpdateNote:output_type -> header.Note
	39,  // 464: header.NoteMgr.DeleteNote:output_type -> header.Empty
	160, // 465: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	38,  // 466: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	39,  // 467: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	38,  // 468: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	161, // 469: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	40,  // 470: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	40,  // 471: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	162, // 472: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	42,  // 473: header.RuleMgr.UpdateRule:output_type -> header.Rule
	42,  // 474: header.RuleMgr.CreateRule:output_type -> header.Rule
	39,  // 475: header.RuleMgr.DeleteRule:output_type -> header.Empty
	42,  // 476: header.RuleMgr.ReadRule:output_type -> header.Rule
	163, // 477: header.RuleMgr.ListRules:output_type -> header.Route
	164, // 478: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	44,  // 479: header.ConversationMgr.PongMessage:output_type -> header.Event
	49,  // 480: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	49,  // 481: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	49,  // 482: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	165, // 483: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	165, // 484: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	39,  // 485: header.ConversationMgr.TagConversation:output_type -> header.Empty
	39,  // 486: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	39,  // 487: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	39,  // 488: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	39,  // 489: header.ConversationMgr.Typing:output_type -> header.Empty
	49,  // 490: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	165, // 491: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	39,  // 492: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	39,  // 493: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	39,  // 494: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	39,  // 495: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	50,  // 496: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	50,  // 497: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	44,  // 498: header.ConversationMgr.TerminateBot:output_type -> header.Event
	166, // 499: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	52,  // 500: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	52,  // 501: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	39,  // 502: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	52,  // 503: header.TemplateMgr.GetTemplate:output_type -> header.Template
	167, // 504: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	39,  // 505: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	54,  // 506: header.TagMgr.CreateTag:output_type -> header.Tag
	54,  // 507: header.TagMgr.UpdateTag:output_type -> header.Tag
	39,  // 508: header.TagMgr.DeleteTag:output_type -> header.Empty
	168, // 509: header.TagMgr.ListTags:output_type -> header.Tags
	54,  // 510: header.TagMgr.GetTag:output_type -> header.Tag
	39,  // 511: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	169, // 512: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	55,  // 513: header.IntegrationMgr.Integrate:output_type -> header.Integration
	153, // 514: header.EventMgr.SearchEvents:output_type -> header.Events
	44,  // 515: header.EventMgr.CreateEvent:output_type -> header.Event
	44,  // 516: header.ConversationEventReader.SendMessage:output_type -> header.Event
	44,  // 517: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	39,  // 518: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	39,  // 519: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	153, // 520: header.ConversationEventReader.ListEvents:output_type -> header.Events
	170, // 521: header.FileMgr.Presign:output_type -> header.PresignResult
	171, // 522: header.FileMgr.Uploaded:output_type -> header.File
	171, // 523: header.FileMgr.DownloadFileUrl:output_type -> header.File
	62,  // 524: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	62,  // 525: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	39,  // 526: header.Noti5Service.Noti:output_type -> header.Empty
	39,  // 527: header.Noti5Service.AddToken:output_type -> header.Empty
	39,  // 528: header.Noti5Service.RemoveToken:output_type -> header.Empty
	39,  // 529: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	65,  // 530: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	172, // 531: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	70,  // 532: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	67,  // 533: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	67,  // 534: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	68,  // 535: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	68,  // 536: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	39,  // 537: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	173, // 538: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	65,  // 539: header.PaymentMgr.Pay:output_type -> payment.Bill
	70,  // 540: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	70,  // 541: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	174, // 542: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	70,  // 543: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	70,  // 544: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	175, // 545: header.PaymentMgr.ListComments:output_type -> payment.Comments
	74,  // 546: header.PaymentMgr.AddComment:output_type -> payment.Comment
	176, // 547: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	78,  // 548: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	78,  // 549: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	75,  // 550: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	65,  // 551: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	177, // 552: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	77,  // 553: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	77,  // 554: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	39,  // 555: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	77,  // 556: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	178, // 557: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	39,  // 558: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	82,  // 559: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	82,  // 560: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	179, // 561: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	82,  // 562: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	180, // 563: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	181, // 564: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	182, // 565: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	39,  // 566: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	39,  // 567: header.Pubsub.Publish:output_type -> header.Empty
	39,  // 568: header.Realtime.ShardSend:output_type -> header.Empty
	85,  // 569: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	85,  // 570: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	183, // 571: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	184, // 572: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	86,  // 573: header.WidgetService.Read:output_type -> header.WidgetSetting
	86,  // 574: header.WidgetService.Update:output_type -> header.WidgetSetting
	185, // 575: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	186, // 576: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	87,  // 577: header.WidgetService.SubmitImpression:output_type -> header.Impression
	88,  // 578: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	89,  // 579: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	187, // 580: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	188, // 581: header.WidgetService.ListConversions:output_type -> header.Conversions
	189, // 582: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	92,  // 583: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	190, // 584: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	39,  // 585: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	191, // 586: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	93,  // 587: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	93,  // 588: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	93,  // 589: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	39,  // 590: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	93,  // 591: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	191, // 592: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	39,  // 593: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	192, // 594: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	190, // 595: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	193, // 596: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	194, // 597: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	195, // 598: header.Bizbot.ListBots:output_type -> header.Bots
	95,  // 599: header.Bizbot.GetBot:output_type -> header.Bot
	95,  // 600: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	95,  // 601: header.Bizbot.CreateBot:output_type -> header.Bot
	95,  // 602: header.Bizbot.UpdateBot:output_type -> header.Bot
	39,  // 603: header.Bizbot.DeleteBot:output_type -> header.Empty
	39,  // 604: header.Bizbot.OnEvent:output_type -> header.Empty
	39,  // 605: header.Bizbot.StartBot:output_type -> header.Empty
	39,  // 606: header.Bizbot.StopBot:output_type -> header.Empty
	39,  // 607: header.Bizbot.TryAction:output_type -> header.Empty
	196, // 608: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	197, // 609: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	198, // 610: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	199, // 611: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	101, // 612: header.Sendback.CreateWebhook:output_type -> header.Webhook
	200, // 613: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	39,  // 614: header.Sendback.DeleteWebhook:output_type -> header.Empty
	201, // 615: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	101, // 616: header.Sendback.ReadWebhook:output_type -> header.Webhook
	101, // 617: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	101, // 618: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	202, // 619: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	203, // 620: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	39,  // 621: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	39,  // 622: header.Notibox.Send:output_type -> header.Empty
	39,  // 623: header.Notibox.MarkRead:output_type -> header.Empty
	39,  // 624: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	204, // 625: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	107, // 626: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	39,  // 627: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	205, // 628: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	107, // 629: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	107, // 630: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	206, // 631: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	207, // 632: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	208, // 633: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	206, // 634: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	39,  // 635: header.Holap.AppendAgentSet:output_type -> header.Empty
	39,  // 636: header.Holap.AppendTagSet:output_type -> header.Empty
	39,  // 637: header.Holap.UpdateUser:output_type -> header.Empty
	39,  // 638: header.Holap.UpdateConversation:output_type -> header.Empty
	39,  // 639: header.Holap.OnConversationEvent:output_type -> header.Empty
	39,  // 640: header.Holap.FreeAccount:output_type -> header.Empty
	209, // 641: header.Holap.ReportUser:output_type -> header.UserMetrics
	210, // 642: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	3,   // 643: header.Holap.ListUserIds:output_type -> header.Ids
	165, // 644: header.Holap.ListConversationIds:output_type -> header.Conversations
	211, // 645: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	3,   // 646: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	149, // 647: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	39,  // 648: header.Holap.UpdateOrder:output_type -> header.Empty
	212, // 649: header.Holap.ReportOrder:output_type -> header.Orders
	116, // 650: header.Proder.ReadProduct:output_type -> header.Product
	116, // 651: header.Proder.CreateProduct:output_type -> header.Product
	116, // 652: header.Proder.UpdateProduct:output_type -> header.Product
	39,  // 653: header.Proder.DeleteProduct:output_type -> header.Empty
	213, // 654: header.Proder.ListProducts:output_type -> header.Products
	3,   // 655: header.Proder.ListProductIds:output_type -> header.Ids
	213, // 656: header.Proder.ListGroupedProducts:output_type -> header.Products
	214, // 657: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	118, // 658: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	118, // 659: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	39,  // 660: header.Proder.DeleteProductCollection:output_type -> header.Empty
	215, // 661: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	119, // 662: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	119, // 663: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	39,  // 664: header.Proder.DeleteProductFeed:output_type -> header.Empty
	216, // 665: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	217, // 666: header.Proder.ListProductProps:output_type -> header.ProductProps
	20,  // 667: header.Proder.ReadOrder:output_type -> header.Order
	20,  // 668: header.Proder.CreateOrder:output_type -> header.Order
	20,  // 669: header.Proder.UpdateOrder:output_type -> header.Order
	20,  // 670: header.Proder.UpdateOrderStatus:output_type -> header.Order
	39,  // 671: header.Proder.DeleteOrder:output_type -> header.Empty
	212, // 672: header.Proder.ListOrders:output_type -> header.Orders
	212, // 673: header.Proder.CountOrders:output_type -> header.Orders
	39,  // 674: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	44,  // 675: header.Proder.MakeOrderPayment:output_type -> header.Event
	44,  // 676: header.Proder.DeleteOrderPayment:output_type -> header.Event
	44,  // 677: header.Proder.AddOrderComment:output_type -> header.Event
	44,  // 678: header.Proder.EditOrderComment:output_type -> header.Event
	44,  // 679: header.Proder.DeleteOrderComment:output_type -> header.Event
	218, // 680: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	171, // 681: header.Proder.DownloadOrder:output_type -> header.File
	2,   // 682: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	219, // 683: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	39,  // 684: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	220, // 685: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	39,  // 686: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	39,  // 687: header.Proder.GHNShippingStatus:output_type -> header.Empty
	129, // 688: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	20,  // 689: header.Proder.ShipOrder:output_type -> header.Order
	20,  // 690: header.Proder.CancelShippingOrder:output_type -> header.Order
	171, // 691: header.Proder.PrintShippingOrders:output_type -> header.File
	39,  // 692: header.Proder.UpdateOrderPipelineStage:output_type -> header.Empty
	130, // 693: header.Proder.UpdateOrderPipelineStageDetail:output_type -> header.OrderPipelineStage
	...
	44,  // 699: header.Apiece.AddTaskComment:output_type -> header.Event
	44,  // 700: header.Apiece.EditTaskComment:output_type -> header.Event
	44,  // 701: header.Apiece.DeleteTaskComment:output_type -> header.Event
	222, // 702: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	...
	223, // 707: header.Apiece.ListPipelines:output_type -> header.Pipelines
	354, // [354:708] is the sub-list for method output_type
	0,   // [0:354] is the sub-list for method input_type
