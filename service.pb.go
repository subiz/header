...
var file_service_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0f, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x41, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xf9, 0x1e, 0x0a, 0x0a, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x63, 0x79, 0x12, 0x30, 0x0a, 0x10, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x2d, 0x0a, 0x10, 0x41, 0x75, 0x74, 0x6f, 0x53, 0x79, 0x6e, 0x63,
...
var file_service_proto_depIdxs = []int32{
	...
	11,  // 67: header.AccountMgr.HealthCheckLogin:input_type -> header.Empty
	...
	80,  // 233: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	80,  // 234: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	1,   // 235: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	1,   // 236: header.TemplateMgr.GetTemplate:input_type -> header.Id
	81,  // 237: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	1,   // 238: header.TemplateMgr.PickTemplate:input_type -> header.Id
	82,  // 239: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	82,  // 240: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	1,   // 241: header.TemplateMgr.DeleteModal:input_type -> header.Id
	1,   // 242: header.TemplateMgr.GetModal:input_type -> header.Id
	1,   // 243: header.TemplateMgr.ListModals:input_type -> header.Id
	83,  // 244: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	84,  // 245: header.TagMgr.CreateTag:input_type -> header.Tag
	84,  // 246: header.TagMgr.UpdateTag:input_type -> header.Tag
	1,   // 247: header.TagMgr.DeleteTag:input_type -> header.Id
	1,   // 248: header.TagMgr.ListTags:input_type -> header.Id
	1,   // 249: header.TagMgr.GetTag:input_type -> header.Id
	1,   // 250: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	85,  // 251: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	86,  // 252: header.Noti5Service.Noti:input_type -> header.PushNoti
	87,  // 253: header.Noti5Service.AddToken:input_type -> noti5.Token
	87,  // 254: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	87,  // 255: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	88,  // 256: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	1,   // 257: header.PaymentMgr.GetSub:input_type -> header.Id
	89,  // 258: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	89,  // 259: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	1,   // 260: header.PaymentMgr.GetSubscription:input_type -> header.Id
	90,  // 261: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	90,  // 262: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	1,   // 263: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	1,   // 264: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	91,  // 265: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	92,  // 266: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	92,  // 267: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	93,  // 268: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	89,  // 269: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	94,  // 270: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	95,  // 271: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	96,  // 272: header.PaymentMgr.AddComment:input_type -> payment.Comment
	1,   // 273: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	92,  // 274: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	97,  // 275: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	91,  // 276: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	98,  // 277: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	99,  // 278: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	1,   // 279: header.PaymentMgr.GetReferral:input_type -> header.Id
	11,  // 280: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	100, // 281: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	1,   // 282: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	1,   // 283: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	1,   // 284: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	101, // 285: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	102, // 286: header.Pubsub.Fire:input_type -> header.PsMessage
	103, // 287: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	103, // 288: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	1,   // 289: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	104, // 290: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	1,   // 291: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	1,   // 292: header.FabikonService.ListFbPosts:input_type -> header.Id
	105, // 293: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	0,   // 294: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	37,  // 295: header.FabikonService.RemoveFbUserLabel:input_type -> header.User
	37,  // 296: header.FabikonService.AddFbUserLabel:input_type -> header.User
	1,   // 297: header.FabikonService.GenerateRefLink:input_type -> header.Id
	106, // 298: header.FabikonService.LinkPageWithAccount:input_type -> header.FacebookPageLinkRequest
	1,   // 299: header.FabikonService.ListFacebookPages:input_type -> header.Id
	0,   // 300: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	1,   // 301: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	107, // 302: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	107, // 303: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	107, // 304: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	107, // 305: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	108, // 306: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	0,   // 307: header.MailkonService.SendEmail:input_type -> header.Events
	73,  // 308: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	73,  // 309: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	73,  // 310: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	73,  // 311: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	1,   // 312: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	109, // 313: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	1,   // 314: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	110, // 315: header.MailkonService.TrackLink:input_type -> header.LinkData
	111, // 316: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	111, // 317: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	1,   // 318: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	112, // 319: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	112, // 320: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	1,   // 321: header.MailkonService.UnblockEmail:input_type -> header.Id
	1,   // 322: header.WidgetService.Read:input_type -> header.Id
	113, // 323: header.WidgetService.Update:input_type -> header.WidgetSetting
	1,   // 324: header.WidgetService.ReadUserSetting:input_type -> header.Id
	1,   // 325: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	114, // 326: header.WidgetService.SubmitImpression:input_type -> header.Impression
	115, // 327: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	116, // 328: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	117, // 329: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	118, // 330: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	118, // 331: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	119, // 332: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	1,   // 333: header.WidgetService.ListUploadedImage:input_type -> header.Id
	119, // 334: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	1,   // 335: header.WidgetService.ListWebPlugins:input_type -> header.Id
	120, // 336: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	120, // 337: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	120, // 338: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	1,   // 339: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	120, // 340: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	1,   // 341: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	1,   // 342: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	121, // 343: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	1,   // 344: header.WidgetService.SearchImages:input_type -> header.Id
	1,   // 345: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	1,   // 346: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	122, // 347: header.Bizbot.ListBots:input_type -> header.BotsRequest
	1,   // 348: header.Bizbot.GetBot:input_type -> header.Id
	123, // 349: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	123, // 350: header.Bizbot.CreateBot:input_type -> header.Bot
	123, // 351: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 352: header.Bizbot.DeleteBot:input_type -> header.Id
	124, // 353: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	124, // 354: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	124, // 355: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	124, // 356: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	125, // 357: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	126, // 358: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	127, // 359: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	128, // 360: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	129, // 361: header.Sendback.CreateWebhook:input_type -> header.Webhook
	1,   // 362: header.Sendback.PingWebhook:input_type -> header.Id
	1,   // 363: header.Sendback.DeleteWebhook:input_type -> header.Id
	1,   // 364: header.Sendback.ListWebhooks:input_type -> header.Id
	1,   // 365: header.Sendback.ReadWebhook:input_type -> header.Id
	129, // 366: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 367: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	130, // 368: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	131, // 369: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	48,  // 370: header.Sendback.SendWebhookEvent:input_type -> header.Event
	132, // 371: header.Notibox.SendNoti:input_type -> header.Notification
	133, // 372: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	1,   // 373: header.Notibox.MarkReadNoti:input_type -> header.Id
	1,   // 374: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	46,  // 375: header.Proder.ReadProduct:input_type -> header.Product
	46,  // 376: header.Proder.CreateProduct:input_type -> header.Product
	46,  // 377: header.Proder.UpdateProduct:input_type -> header.Product
	1,   // 378: header.Proder.DeleteProduct:input_type -> header.Id
	134, // 379: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	135, // 380: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	16,  // 381: header.Proder.ListProductCollections:input_type -> header.Ids
	136, // 382: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	136, // 383: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	1,   // 384: header.Proder.DeleteProductCollection:input_type -> header.Id
	1,   // 385: header.Proder.ListProductFeeds:input_type -> header.Id
	137, // 386: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	137, // 387: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	1,   // 388: header.Proder.DeleteProductFeed:input_type -> header.Id
	16,  // 389: header.Proder.ListProductCategories:input_type -> header.Ids
	1,   // 390: header.Proder.ReadOrder:input_type -> header.Id
	29,  // 391: header.Proder.CreateOrder:input_type -> header.Order
	29,  // 392: header.Proder.UpdateOrder:input_type -> header.Order
	1,   // 393: header.Proder.DeleteOrder:input_type -> header.Id
	138, // 394: header.Proder.ListOrders:input_type -> header.OrdersRequest
	139, // 395: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	140, // 396: header.Proder.ImportOrders:input_type -> header.Orders
	141, // 397: header.Proder.MakeOrderPayment:input_type -> header.Bill
	142, // 398: header.Proder.DeleteOrderPayment:input_type -> header.Key
	48,  // 399: header.Proder.AddOrderComment:input_type -> header.Event
	48,  // 400: header.Proder.EditOrderComment:input_type -> header.Event
	142, // 401: header.Proder.DeleteOrderComment:input_type -> header.Key
	1,   // 402: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 403: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	1,   // 404: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 405: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	1,   // 406: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	145, // 407: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	146, // 408: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	147, // 409: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	148, // 410: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	1,   // 411: header.Proder.ShipOrder:input_type -> header.Id
	29,  // 412: header.Proder.UpdateShippingCode:input_type -> header.Order
	1,   // 413: header.Proder.CancelShippingOrder:input_type -> header.Id
	16,  // 414: header.Proder.PrintShippingOrders:input_type -> header.Ids
	1,   // 415: header.Proder.SeenOrder:input_type -> header.Id
	1,   // 416: header.Proder.FollowOrder:input_type -> header.Id
	1,   // 417: header.Proder.UnfollowOrder:input_type -> header.Id
	66,  // 418: header.Proder.TagOrder:input_type -> header.TagRequest
	66,  // 419: header.Proder.UntagOrder:input_type -> header.TagRequest
	1,   // 420: header.Proder.ReadPipeline:input_type -> header.Id
	149, // 421: header.Proder.CreatePipeline:input_type -> header.Pipeline
	149, // 422: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	1,   // 423: header.Proder.DeletePipeline:input_type -> header.Id
	16,  // 424: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 425: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	1,   // 426: header.Proder.PreselectPipeline:input_type -> header.Id
	151, // 427: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	16,  // 428: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	1,   // 429: header.TaskMgr.ReadTask:input_type -> header.Id
	51,  // 430: header.TaskMgr.CreateTask:input_type -> header.Task
	51,  // 431: header.TaskMgr.UpdateTask:input_type -> header.Task
	1,   // 432: header.TaskMgr.DeleteTask:input_type -> header.Id
	152, // 433: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	1,   // 434: header.TaskMgr.SeenTask:input_type -> header.Id
	1,   // 435: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	1,   // 436: header.TaskMgr.MuteTask:input_type -> header.Id
	1,   // 437: header.TaskMgr.UnmuteTask:input_type -> header.Id
	48,  // 438: header.TaskMgr.AddTaskComment:input_type -> header.Event
	48,  // 439: header.TaskMgr.EditTaskComment:input_type -> header.Event
	142, // 440: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	1,   // 441: header.TaskMgr.ListTaskComments:input_type -> header.Id
	153, // 442: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	16,  // 443: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	1,   // 444: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	154, // 445: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	154, // 446: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	1,   // 447: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	48,  // 448: header.CampaignMgr.OnEvent:input_type -> header.Event
	155, // 449: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	1,   // 450: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	156, // 451: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	157, // 452: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	158, // 453: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	157, // 454: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	157, // 455: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	159, // 456: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	156, // 457: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	160, // 458: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	161, // 459: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	162, // 460: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	1,   // 461: header.CreditMgr.ListCredits:input_type -> header.Id
	163, // 462: header.CreditMgr.AddCredit:input_type -> header.Credit
	1,   // 463: header.CreditMgr.DeleteCredit:input_type -> header.Id
	163, // 464: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	1,   // 465: header.FormMgr.ListForms:input_type -> header.Id
	164, // 466: header.FormMgr.CreateForm:input_type -> header.Form
	164, // 467: header.FormMgr.UpdateForm:input_type -> header.Form
	1,   // 468: header.FormMgr.DeleteForm:input_type -> header.Id
	165, // 469: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	166, // 470: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	167, // 471: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	167, // 472: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	11,  // 473: header.GooglekonService.SendEventToGoogle:output_type -> header.Empty
	2,   // 474: header.GooglekonService.ReadGoogleLocationSetting:output_type -> header.GoogleLocationSetting
	2,   // 475: header.GooglekonService.UpdateGoogleLocationSetting:output_type -> header.GoogleLocationSetting
	168, // 476: header.GooglekonService.ListGoogleLocationSettings:output_type -> header.GoogleLocationSettings
	11,  // 477: header.KafkaConsumer.Consume:output_type -> header.Empty
	169, // 478: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	11,  // 479: header.DocSearch.IndexConvo:output_type -> header.Empty
	170, // 480: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	171, // 481: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	172, // 482: header.DocSearch.Report:output_type -> header.ConvoReportResponse
	173, // 483: header.DocSearch.ListIds:output_type -> header.Conversations
	173, // 484: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	174, // 485: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	173, // 486: header.DocSearch.ListCallIds:output_type -> header.Conversations
	175, // 487: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	11,  // 488: header.DocSearch.HealthCheckReport:output_type -> header.Empty
	11,  // 489: header.DocSearch.HealthCheckIndex:output_type -> header.Empty
	13,  // 490: header.NumberRegistry.Compact:output_type -> header.Number
	12,  // 491: header.NumberRegistry.Uncompact:output_type -> header.String
	14,  // 492: header.NumberRegistry.CompactM:output_type -> header.StrNumM
	13,  // 493: header.NumberRegistry.Shorten:output_type -> header.Number
	12,  // 494: header.NumberRegistry.Lookup:output_type -> header.String
	176, // 495: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	27,  // 496: header.Map.LookupAddress:output_type -> header.Address
	177, // 497: header.Map.PredictAddress:output_type -> header.Addresses
	177, // 498: header.Map.ListDistricts:output_type -> header.Addresses
	177, // 499: header.Map.ListProvinces:output_type -> header.Addresses
	177, // 500: header.Map.ListWards:output_type -> header.Addresses
	177, // 501: header.Map.ListStreets:output_type -> header.Addresses
	177, // 502: header.Map.ListAddresses:output_type -> header.Addresses
	27,  // 503: header.Map.ReadAddress:output_type -> header.Address
	17,  // 504: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	17,  // 505: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	17,  // 506: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	11,  // 507: header.AccountMgr.RequestPassword:output_type -> header.Empty
	19,  // 508: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	19,  // 509: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	19,  // 510: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	20,  // 511: header.AccountMgr.DeleteAccount:output_type -> account.Account
	20,  // 512: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	11,  // 513: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	19,  // 514: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	19,  // 515: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	19,  // 516: header.AccountMgr.GetInvitation:output_type -> account.Agent
	19,  // 517: header.AccountMgr.InviteAgent:output_type -> account.Agent
	19,  // 518: header.AccountMgr.GetAgent:output_type -> account.Agent
	19,  // 519: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	20,  // 520: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	20,  // 521: header.AccountMgr.GetAccount:output_type -> account.Account
	20,  // 522: header.AccountMgr.UpdateAccount:output_type -> account.Account
	20,  // 523: header.AccountMgr.CreateAccount:output_type -> account.Account
	178, // 524: header.AccountMgr.ListAgents:output_type -> header.Response
	11,  // 525: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	179, // 526: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	19,  // 527: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	180, // 528: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	19,  // 529: header.AccountMgr.TransferOwner:output_type -> account.Agent
	24,  // 530: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	181, // 531: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	181, // 532: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	11,  // 533: header.AccountMgr.LogoutSession:output_type -> header.Empty
	24,  // 534: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	182, // 535: header.AccountMgr.GetLanguage:output_type -> header.Lang
	25,  // 536: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	26,  // 537: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	26,  // 538: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	183, // 539: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	11,  // 540: header.AccountMgr.HealthCheckLogin:output_type -> header.Empty
	11,  // 541: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	177, // 542: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	27,  // 543: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	27,  // 544: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	11,  // 545: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	184, // 546: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	28,  // 547: header.AccountMgr.CreateTax:output_type -> header.Tax
	28,  // 548: header.AccountMgr.UpdateTax:output_type -> header.Tax
	11,  // 549: header.AccountMgr.DeleteTax:output_type -> header.Empty
	185, // 550: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	185, // 551: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	30,  // 552: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	30,  // 553: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	11,  // 554: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	31,  // 555: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	186, // 556: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	31,  // 557: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	11,  // 558: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	187, // 559: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	32,  // 560: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	32,  // 561: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	11,  // 562: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	11,  // 563: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	188, // 564: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	11,  // 565: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	33,  // 566: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	33,  // 567: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	33,  // 568: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	34,  // 569: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	189, // 570: header.AccountMgr.ListAgentPresences:output_type -> account.Presences
	190, // 571: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	1,   // 572: header.AccountMgr.NewID:output_type -> header.Id
	1,   // 573: header.AccountMgr.LockLogin:output_type -> header.Id
	1,   // 574: header.AccountMgr.UnlockLogin:output_type -> header.Id
	191, // 575: header.AccountMgr.ListBills:output_type -> payment.Bills
	37,  // 576: header.UserMgr.MergeUser:output_type -> header.User
	11,  // 577: header.UserMgr.DetachUser:output_type -> header.Empty
	37,  // 578: header.UserMgr.CreateUser2:output_type -> header.User
	37,  // 579: header.UserMgr.UpdateUser:output_type -> header.User
	192, // 580: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	11,  // 581: header.UserMgr.RemoveUser:output_type -> header.Empty
	11,  // 582: header.UserMgr.RestoreUser:output_type -> header.Empty
	37,  // 583: header.UserMgr.ReadUser:output_type -> header.User
	37,  // 584: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	36,  // 585: header.UserMgr.MatchUsers:output_type -> header.Users
	37,  // 586: header.UserMgr.BanUser:output_type -> header.User
	37,  // 587: header.UserMgr.UnbanUser:output_type -> header.User
	36,  // 588: header.UserMgr.LookupByPhone:output_type -> header.Users
	38,  // 589: header.UserMgr.UpdateView:output_type -> header.UserView
	38,  // 590: header.UserMgr.CreateView:output_type -> header.UserView
	11,  // 591: header.UserMgr.DeleteView:output_type -> header.Empty
	38,  // 592: header.UserMgr.GetView:output_type -> header.UserView
	193, // 593: header.UserMgr.ListViews:output_type -> header.UserViews
	39,  // 594: header.UserMgr.UpdateSegment:output_type -> header.Segment
	39,  // 595: header.UserMgr.CreateSegment:output_type -> header.Segment
	11,  // 596: header.UserMgr.DeleteSegment:output_type -> header.Empty
	39,  // 597: header.UserMgr.GetSegment:output_type -> header.Segment
	194, // 598: header.UserMgr.ListSegments:output_type -> header.Segments
	36,  // 599: header.UserMgr.ListUsers:output_type -> header.Users
	11,  // 600: header.UserMgr.AddToSegment:output_type -> header.Empty
	11,  // 601: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	11,  // 602: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	43,  // 603: header.UserMgr.UpsertLabel:output_type -> header.Label
	11,  // 604: header.UserMgr.DeleteLabel:output_type -> header.Empty
	195, // 605: header.UserMgr.ListLabels:output_type -> header.Labels
	43,  // 606: header.UserMgr.GetLabel:output_type -> header.Label
	11,  // 607: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	11,  // 608: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	11,  // 609: header.UserMgr.AddUserLabel:output_type -> header.Empty
	11,  // 610: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	11,  // 611: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	27,  // 612: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	27,  // 613: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	11,  // 614: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	196, // 615: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	11,  // 616: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	36,  // 617: header.UserMgr.ListLeads:output_type -> header.Users
	197, // 618: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	46,  // 619: header.UserMgr.LinkProductUrl:output_type -> header.Product
	0,   // 620: header.UserMgr.ListUserEvents:output_type -> header.Events
	48,  // 621: header.UserMgr.CreateUserEvent:output_type -> header.Event
	49,  // 622: header.UserMgr.FillDevice:output_type -> common.Device
	198, // 623: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	11,  // 624: header.UserMgr.LinkTask:output_type -> header.Empty
	199, // 625: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	16,  // 626: header.UserMgr.ListUserIds:output_type -> header.Ids
	36,  // 627: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	170, // 628: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	200, // 629: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	201, // 630: header.LiveMgr.SearchLocations:output_type -> header.Locations
	36,  // 631: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	202, // 632: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	203, // 633: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	204, // 634: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	205, // 635: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	206, // 636: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	207, // 637: header.NoteMgr.ListNotes:output_type -> header.Notes
	58,  // 638: header.NoteMgr.AddNote:output_type -> header.Note
	58,  // 639: header.NoteMgr.UpdateNote:output_type -> header.Note
	11,  // 640: header.NoteMgr.DeleteNote:output_type -> header.Empty
	208, // 641: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	60,  // 642: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	60,  // 643: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	178, // 644: header.AutomationMgr.ListAutomations:output_type -> header.Response
	178, // 645: header.AutomationMgr.UpdateAutomation:output_type -> header.Response
	178, // 646: header.AutomationMgr.CreateAutomation:output_type -> header.Response
	178, // 647: header.AutomationMgr.DeleteAutomation:output_type -> header.Response
	178, // 648: header.AutomationMgr.ReadAutomation:output_type -> header.Response
	178, // 649: header.AutomationMgr.ListAutomationLog:output_type -> header.Response
	209, // 650: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	48,  // 651: header.ConversationMgr.PongMessage:output_type -> header.Event
	68,  // 652: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	68,  // 653: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	68,  // 654: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	173, // 655: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	173, // 656: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	11,  // 657: header.ConversationMgr.TagConversation:output_type -> header.Empty
	11,  // 658: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	11,  // 659: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	11,  // 660: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	68,  // 661: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	11,  // 662: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	11,  // 663: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	11,  // 664: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	11,  // 665: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	69,  // 666: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	69,  // 667: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	48,  // 668: header.ConversationMgr.TerminateBot:output_type -> header.Event
	48,  // 669: header.ConversationMgr.SendMessage:output_type -> header.Event
	48,  // 670: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	48,  // 671: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	11,  // 672: header.ConversationMgr.PinMessage:output_type -> header.Empty
	11,  // 673: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	0,   // 674: header.ConversationMgr.ListEvents:output_type -> header.Events
	11,  // 675: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	210, // 676: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	73,  // 677: header.ConversationMgr.Integrate:output_type -> header.Integration
	73,  // 678: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	74,  // 679: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	74,  // 680: header.ConversationMgr.CreateRule:output_type -> header.Rule
	11,  // 681: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	74,  // 682: header.ConversationMgr.ReadRule:output_type -> header.Rule
	211, // 683: header.ConversationMgr.ListRules:output_type -> header.Route
	212, // 684: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	75,  // 685: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	11,  // 686: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	75,  // 687: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	213, // 688: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	76,  // 689: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	76,  // 690: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	11,  // 691: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	76,  // 692: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	73,  // 693: header.ConversationMgr.TestNumber:output_type -> header.Integration
	73,  // 694: header.ConversationMgr.ActiveNumber:output_type -> header.Integration
	214, // 695: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	77,  // 696: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	78,  // 697: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	215, // 698: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	11,  // 699: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	216, // 700: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	79,  // 701: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	68,  // 702: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	217, // 703: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	48,  // 704: header.ConversationMgr.SaveMessage:output_type -> header.Event
	48,  // 705: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	80,  // 706: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	80,  // 707: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	11,  // 708: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	80,  // 709: header.TemplateMgr.GetTemplate:output_type -> header.Template
	218, // 710: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	11,  // 711: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	82,  // 712: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	82,  // 713: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	11,  // 714: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	82,  // 715: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	219, // 716: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	220, // 717: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	84,  // 718: header.TagMgr.CreateTag:output_type -> header.Tag
	84,  // 719: header.TagMgr.UpdateTag:output_type -> header.Tag
	11,  // 720: header.TagMgr.DeleteTag:output_type -> header.Empty
	221, // 721: header.TagMgr.ListTags:output_type -> header.Tags
	84,  // 722: header.TagMgr.GetTag:output_type -> header.Tag
	85,  // 723: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	85,  // 724: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	11,  // 725: header.Noti5Service.Noti:output_type -> header.Empty
	11,  // 726: header.Noti5Service.AddToken:output_type -> header.Empty
	11,  // 727: header.Noti5Service.RemoveToken:output_type -> header.Empty
	11,  // 728: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	222, // 729: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	223, // 730: header.PaymentMgr.GetSub:output_type -> header.AccSub
	92,  // 731: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	89,  // 732: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	89,  // 733: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	90,  // 734: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	90,  // 735: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	11,  // 736: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	224, // 737: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	225, // 738: header.PaymentMgr.Pay:output_type -> payment.Bill
	92,  // 739: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	92,  // 740: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	226, // 741: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	92,  // 742: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	92,  // 743: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	227, // 744: header.PaymentMgr.ListComments:output_type -> payment.Comments
	96,  // 745: header.PaymentMgr.AddComment:output_type -> payment.Comment
	228, // 746: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	228, // 747: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	97,  // 748: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	225, // 749: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	229, // 750: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	100, // 751: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	100, // 752: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	230, // 753: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	100, // 754: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	231, // 755: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	232, // 756: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	233, // 757: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	11,  // 758: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	11,  // 759: header.Pubsub.Fire:output_type -> header.Empty
	234, // 760: header.Pubsub.Poll:output_type -> header.PollResult
	103, // 761: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	104, // 762: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	104, // 763: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	235, // 764: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	236, // 765: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	105, // 766: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	11,  // 767: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	11,  // 768: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	11,  // 769: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	1,   // 770: header.FabikonService.GenerateRefLink:output_type -> header.Id
	11,  // 771: header.FabikonService.LinkPageWithAccount:output_type -> header.Empty
	237, // 772: header.FabikonService.ListFacebookPages:output_type -> header.FacebookPages
	11,  // 773: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	238, // 774: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	11,  // 775: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	11,  // 776: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	11,  // 777: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	178, // 778: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	48,  // 779: header.ZalokonService.SendZNS:output_type -> header.Event
	11,  // 780: header.MailkonService.SendEmail:output_type -> header.Empty
	73,  // 781: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	11,  // 782: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	11,  // 783: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	239, // 784: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	240, // 785: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	109, // 786: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	11,  // 787: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	178, // 788: header.MailkonService.TrackLink:output_type -> header.Response
	178, // 789: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	111, // 790: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	178, // 791: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	178, // 792: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	178, // 793: header.MailkonService.BlockEmail:output_type -> header.Response
	178, // 794: header.MailkonService.UnblockEmail:output_type -> header.Response
	113, // 795: header.WidgetService.Read:output_type -> header.WidgetSetting
	113, // 796: header.WidgetService.Update:output_type -> header.WidgetSetting
	241, // 797: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	242, // 798: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	114, // 799: header.WidgetService.SubmitImpression:output_type -> header.Impression
	115, // 800: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	116, // 801: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	243, // 802: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	244, // 803: header.WidgetService.ListConversions:output_type -> header.Conversions
	245, // 804: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	119, // 805: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	246, // 806: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	11,  // 807: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	247, // 808: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	120, // 809: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	120, // 810: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	120, // 811: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	11,  // 812: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	120, // 813: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	247, // 814: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	11,  // 815: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	248, // 816: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	246, // 817: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	249, // 818: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	250, // 819: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	251, // 820: header.Bizbot.ListBots:output_type -> header.Bots
	123, // 821: header.Bizbot.GetBot:output_type -> header.Bot
	123, // 822: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	123, // 823: header.Bizbot.CreateBot:output_type -> header.Bot
	123, // 824: header.Bizbot.UpdateBot:output_type -> header.Bot
	11,  // 825: header.Bizbot.DeleteBot:output_type -> header.Empty
	11,  // 826: header.Bizbot.OnEvent:output_type -> header.Empty
	11,  // 827: header.Bizbot.StartBot:output_type -> header.Empty
	11,  // 828: header.Bizbot.StopBot:output_type -> header.Empty
	11,  // 829: header.Bizbot.TryAction:output_type -> header.Empty
	252, // 830: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	253, // 831: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	254, // 832: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	255, // 833: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	129, // 834: header.Sendback.CreateWebhook:output_type -> header.Webhook
	256, // 835: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	11,  // 836: header.Sendback.DeleteWebhook:output_type -> header.Empty
	257, // 837: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	129, // 838: header.Sendback.ReadWebhook:output_type -> header.Webhook
	129, // 839: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	129, // 840: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	258, // 841: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	259, // 842: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	11,  // 843: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	11,  // 844: header.Notibox.SendNoti:output_type -> header.Empty
	260, // 845: header.Notibox.ListNoties:output_type -> header.Notifications
	11,  // 846: header.Notibox.MarkReadNoti:output_type -> header.Empty
	11,  // 847: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	46,  // 848: header.Proder.ReadProduct:output_type -> header.Product
	46,  // 849: header.Proder.CreateProduct:output_type -> header.Product
	46,  // 850: header.Proder.UpdateProduct:output_type -> header.Product
	11,  // 851: header.Proder.DeleteProduct:output_type -> header.Empty
	261, // 852: header.Proder.ListProducts2:output_type -> header.Products
	262, // 853: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	263, // 854: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 855: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 856: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	11,  // 857: header.Proder.DeleteProductCollection:output_type -> header.Empty
	264, // 858: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 859: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 860: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	11,  // 861: header.Proder.DeleteProductFeed:output_type -> header.Empty
	265, // 862: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	29,  // 863: header.Proder.ReadOrder:output_type -> header.Order
	29,  // 864: header.Proder.CreateOrder:output_type -> header.Order
	29,  // 865: header.Proder.UpdateOrder:output_type -> header.Order
	11,  // 866: header.Proder.DeleteOrder:output_type -> header.Empty
	140, // 867: header.Proder.ListOrders:output_type -> header.Orders
	266, // 868: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 869: header.Proder.ImportOrders:output_type -> header.Orders
	48,  // 870: header.Proder.MakeOrderPayment:output_type -> header.Event
	48,  // 871: header.Proder.DeleteOrderPayment:output_type -> header.Event
	48,  // 872: header.Proder.AddOrderComment:output_type -> header.Event
	48,  // 873: header.Proder.EditOrderComment:output_type -> header.Event
	48,  // 874: header.Proder.DeleteOrderComment:output_type -> header.Event
	267, // 875: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	268, // 876: header.Proder.DownloadOrder:output_type -> header.File
	1,   // 877: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	269, // 878: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	11,  // 879: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	270, // 880: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	11,  // 881: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	11,  // 882: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 883: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	29,  // 884: header.Proder.ShipOrder:output_type -> header.Order
	29,  // 885: header.Proder.UpdateShippingCode:output_type -> header.Order
	29,  // 886: header.Proder.CancelShippingOrder:output_type -> header.Order
	268, // 887: header.Proder.PrintShippingOrders:output_type -> header.File
	11,  // 888: header.Proder.SeenOrder:output_type -> header.Empty
	11,  // 889: header.Proder.FollowOrder:output_type -> header.Empty
	11,  // 890: header.Proder.UnfollowOrder:output_type -> header.Empty
	11,  // 891: header.Proder.TagOrder:output_type -> header.Empty
	11,  // 892: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 893: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 894: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 895: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	11,  // 896: header.Proder.DeletePipeline:output_type -> header.Empty
	271, // 897: header.Proder.ListPipelines:output_type -> header.Pipelines
	11,  // 898: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 899: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 900: header.Proder.ReportOrder:output_type -> header.Orders
	11,  // 901: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	51,  // 902: header.TaskMgr.ReadTask:output_type -> header.Task
	51,  // 903: header.TaskMgr.CreateTask:output_type -> header.Task
	51,  // 904: header.TaskMgr.UpdateTask:output_type -> header.Task
	11,  // 905: header.TaskMgr.DeleteTask:output_type -> header.Empty
	272, // 906: header.TaskMgr.ListTasks:output_type -> header.Tasks
	11,  // 907: header.TaskMgr.SeenTask:output_type -> header.Empty
	11,  // 908: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	11,  // 909: header.TaskMgr.MuteTask:output_type -> header.Empty
	11,  // 910: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	48,  // 911: header.TaskMgr.AddTaskComment:output_type -> header.Event
	48,  // 912: header.TaskMgr.EditTaskComment:output_type -> header.Event
	48,  // 913: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	273, // 914: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	153, // 915: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	274, // 916: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	154, // 917: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	154, // 918: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	154, // 919: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	11,  // 920: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	11,  // 921: header.CampaignMgr.OnEvent:output_type -> header.Empty
	275, // 922: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	276, // 923: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	277, // 924: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	157, // 925: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	278, // 926: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	157, // 927: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	11,  // 928: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	279, // 929: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	11,  // 930: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	280, // 931: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	281, // 932: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	282, // 933: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	178, // 934: header.CreditMgr.ListCredits:output_type -> header.Response
	178, // 935: header.CreditMgr.AddCredit:output_type -> header.Response
	178, // 936: header.CreditMgr.DeleteCredit:output_type -> header.Response
	178, // 937: header.CreditMgr.UpdateCredit:output_type -> header.Response
	283, // 938: header.FormMgr.ListForms:output_type -> header.Forms
	164, // 939: header.FormMgr.CreateForm:output_type -> header.Form
	164, // 940: header.FormMgr.UpdateForm:output_type -> header.Form
	11,  // 941: header.FormMgr.DeleteForm:output_type -> header.Empty
	284, // 942: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	285, // 943: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	167, // 944: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	178, // 945: header.Scheduler.UnregisterTask:output_type -> header.Response
	473, // [473:946] is the sub-list for method output_type
	0,   // [0:473] is the sub-list for method input_type
...
type AccountMgrClient interface {
	...
	HealthCheckLogin(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
	// internal
...
func (c *accountMgrClient) HealthCheckLogin(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/header.AccountMgr/HealthCheckLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountMgrServer interface {
	...
	HealthCheckLogin(context.Context, *Empty) (*Empty, error)
	// internal
...
func (*UnimplementedAccountMgrServer) HealthCheckLogin(context.Context, *Empty) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HealthCheckLogin not implemented")
}
...
func _AccountMgr_HealthCheckLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountMgrServer).HealthCheckLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.AccountMgr/HealthCheckLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountMgrServer).HealthCheckLogin(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccountMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HealthCheckLogin",
			Handler:    _AccountMgr_HealthCheckLogin_Handler,
		},
		{
