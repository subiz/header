...
var file_service_proto_rawDesc = []byte{
	...
	0x32, 0xf4, 0x01, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x0c, 0x4c,
	0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x0a, 0x2e, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x10, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
...
var file_service_proto_depIdxs = []int32{
	...
	1,   // 253: header.Proder.ListProducts:input_type -> header.Id
...
type ProderClient interface {
	ListProducts(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Products, error)
...
func (c *proderClient) ListProducts(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Products, error) {
	out := new(Products)
...
type ProderServer interface {
	ListProducts(context.Context, *Id) (*Products, error)
...
func (*UnimplementedProderServer) ListProducts(context.Context, *Id) (*Products, error) {
...
func _Proder_ListProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProderServer).ListProducts(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
