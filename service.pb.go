...
var file_service_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0f, 0x2e, 0x68, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xa0, 0x1e, 0x0a, 0x0a, 0x41,
	...
	0x64, 0x1a, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x32, 0xe7, 0x15,
	...
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x9a, 0x19, 0x0a, 0x0f, 0x43, 0x6f,
...
var file_service_proto_depIdxs = []int32{
	...
	33,  // 93: header.UserMgr.MergeUser:input_type -> header.Users
	12,  // 94: header.UserMgr.DetachUser:input_type -> header.Id
	34,  // 95: header.UserMgr.CreateUser2:input_type -> header.User
	34,  // 96: header.UserMgr.UpdateUser:input_type -> header.User
	34,  // 97: header.UserMgr.TryUpdateUser:input_type -> header.User
	...
	35,  // 106: header.UserMgr.UpdateView:input_type -> header.UserView
	35,  // 107: header.UserMgr.CreateView:input_type -> header.UserView
	...
	36,  // 111: header.UserMgr.UpdateSegment:input_type -> header.Segment
	36,  // 112: header.UserMgr.CreateSegment:input_type -> header.Segment
	...
	37,  // 116: header.UserMgr.ListUsers:input_type -> header.ListUserRequest
	38,  // 117: header.UserMgr.AddToSegment:input_type -> header.SegmentUsers
	38,  // 118: header.UserMgr.RemoveFromSegment:input_type -> header.SegmentUsers
	39,  // 119: header.UserMgr.UpdateUserCampaignStatus:input_type -> header.UserCampaign
	40,  // 120: header.UserMgr.UpsertLabel:input_type -> header.Label
	...
	41,  // 124: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	41,  // 125: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	41,  // 126: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	41,  // 127: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	41,  // 128: header.UserMgr.AddLeadConversionBy:input_type -> header.UserRequest
	24,  // 129: header.UserMgr.CreateShippingAddress:input_type -> header.Address
	24,  // 130: header.UserMgr.UpdateShippingAddress:input_type -> header.Address
	24,  // 131: header.UserMgr.RemoveShippingAddress:input_type -> header.Address
	12,  // 132: header.UserMgr.ListShippingAddress:input_type -> header.Id
	24,  // 133: header.UserMgr.MakeDefaultShippingAddress:input_type -> header.Address
	35,  // 134: header.UserMgr.ListLeads:input_type -> header.UserView
	42,  // 135: header.UserMgr.SuggestLeadField:input_type -> header.SuggestLeadFieldRequest
	43,  // 136: header.UserMgr.LinkProductUrl:input_type -> header.Product
	44,  // 137: header.UserMgr.ListUserEvents:input_type -> header.ListUserEventsRequest
	45,  // 138: header.UserMgr.CreateUserEvent:input_type -> header.Event
	46,  // 139: header.UserMgr.FillDevice:input_type -> common.Device
	47,  // 140: header.UserMgr.ImportLead:input_type -> header.ImportLeadRequest
	48,  // 141: header.UserMgr.LinkTask:input_type -> header.Task
	49,  // 142: header.UserMgr.CountUserProfiles:input_type -> header.UsersRequest
	49,  // 143: header.UserMgr.ListUserIds:input_type -> header.UsersRequest
	49,  // 144: header.UserMgr.ListUserIdWithPhones:input_type -> header.UsersRequest
	3,   // 145: header.UserMgr.SearchUsers:input_type -> header.DocSearchRequest
	50,  // 146: header.UserMgr.ReportUser:input_type -> header.UserReportRequest
	51,  // 147: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	52,  // 148: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	...
	53,  // 153: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	54,  // 154: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	55,  // 155: header.NoteMgr.AddNote:input_type -> header.Note
	55,  // 156: header.NoteMgr.UpdateNote:input_type -> header.Note
	56,  // 157: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	57,  // 158: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	58,  // 159: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	58,  // 160: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	59,  // 161: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	45,  // 162: header.ConversationMgr.PongMessage:input_type -> header.Event
	60,  // 163: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	...
	61,  // 166: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	13,  // 167: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	62,  // 168: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	62,  // 169: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	63,  // 170: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	63,  // 171: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	64,  // 172: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	64,  // 173: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	63,  // 174: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	64,  // 175: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	64,  // 176: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	65,  // 177: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	12,  // 178: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	66,  // 179: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	45,  // 180: header.ConversationMgr.SendMessage:input_type -> header.Event
	67,  // 181: header.ConversationMgr.SendOmniChannelMessage:input_type -> header.SendOmniChannelMessageRequest
	45,  // 182: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	45,  // 183: header.ConversationMgr.PinMessage:input_type -> header.Event
	45,  // 184: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	68,  // 185: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	12,  // 186: header.ConversationMgr.Deintegrate:input_type -> header.Id
	12,  // 187: header.ConversationMgr.ListIntegrations:input_type -> header.Id
	69,  // 188: header.ConversationMgr.Integrate:input_type -> header.Integration
	12,  // 189: header.ConversationMgr.GetIntegration:input_type -> header.Id
	70,  // 190: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	70,  // 191: header.ConversationMgr.CreateRule:input_type -> header.Rule
	12,  // 192: header.ConversationMgr.DeleteRule:input_type -> header.Id
	12,  // 193: header.ConversationMgr.ReadRule:input_type -> header.Id
	12,  // 194: header.ConversationMgr.ListRules:input_type -> header.Id
	12,  // 195: header.ConversationMgr.ListConversationAutomations:input_type -> header.Id
	71,  // 196: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	12,  // 197: header.ConversationMgr.DeleteConversationAutomation:input_type -> header.Id
	12,  // 198: header.ConversationMgr.ReadConversationAutomation:input_type -> header.Id
	12,  // 199: header.ConversationMgr.ListPhoneDevices:input_type -> header.Id
	72,  // 200: header.ConversationMgr.CreatePhoneDevice:input_type -> header.PhoneDevice
	72,  // 201: header.ConversationMgr.UpdatePhoneDevice:input_type -> header.PhoneDevice
	12,  // 202: header.ConversationMgr.DeletePhoneDevice:input_type -> header.Id
	12,  // 203: header.ConversationMgr.ReadPhoneDevice:input_type -> header.Id
	12,  // 204: header.ConversationMgr.TestNumber:input_type -> header.Id
	69,  // 205: header.ConversationMgr.ActiveNumber:input_type -> header.Integration
	12,  // 206: header.ConversationMgr.ListCallSettings:input_type -> header.Id
	73,  // 207: header.ConversationMgr.UpdateCallSetting:input_type -> header.CallSetting
	74,  // 208: header.ConversationMgr.BlockNumber:input_type -> header.BlockedNumber
	12,  // 209: header.ConversationMgr.ListBlockedNumbers:input_type -> header.Id
	74,  // 210: header.ConversationMgr.UnblockNumber:input_type -> header.BlockedNumber
	12,  // 211: header.ConversationMgr.ListGreetingAudio:input_type -> header.Id
	75,  // 212: header.ConversationMgr.CreateGreetingAudio:input_type -> header.GreetingAudio
	60,  // 213: header.ConversationMgr.OriginateCall:input_type -> header.StartRequest
	12,  // 214: header.ConversationMgr.ListMyRecentCalls:input_type -> header.Id
	45,  // 215: header.ConversationMgr.SaveMessage:input_type -> header.Event
	45,  // 216: header.ConversationMgr.ApplyMessage:input_type -> header.Event
	76,  // 217: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	76,  // 218: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	12,  // 219: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	12,  // 220: header.TemplateMgr.GetTemplate:input_type -> header.Id
	77,  // 221: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	12,  // 222: header.TemplateMgr.PickTemplate:input_type -> header.Id
	78,  // 223: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	78,  // 224: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	12,  // 225: header.TemplateMgr.DeleteModal:input_type -> header.Id
	12,  // 226: header.TemplateMgr.GetModal:input_type -> header.Id
	12,  // 227: header.TemplateMgr.ListModals:input_type -> header.Id
	79,  // 228: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	80,  // 229: header.TagMgr.CreateTag:input_type -> header.Tag
	80,  // 230: header.TagMgr.UpdateTag:input_type -> header.Tag
	12,  // 231: header.TagMgr.DeleteTag:input_type -> header.Id
	12,  // 232: header.TagMgr.ListTags:input_type -> header.Id
	12,  // 233: header.TagMgr.GetTag:input_type -> header.Id
	12,  // 234: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	81,  // 235: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	82,  // 236: header.Noti5Service.Noti:input_type -> header.PushNoti
	83,  // 237: header.Noti5Service.AddToken:input_type -> noti5.Token
	83,  // 238: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	83,  // 239: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	84,  // 240: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	12,  // 241: header.PaymentMgr.GetSub:input_type -> header.Id
	85,  // 242: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	85,  // 243: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	12,  // 244: header.PaymentMgr.GetSubscription:input_type -> header.Id
	86,  // 245: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	86,  // 246: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	12,  // 247: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	12,  // 248: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	87,  // 249: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	88,  // 250: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	88,  // 251: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	89,  // 252: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	85,  // 253: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	90,  // 254: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	91,  // 255: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	92,  // 256: header.PaymentMgr.AddComment:input_type -> payment.Comment
	57,  // 257: header.PaymentMgr.ListPlans:input_type -> header.Empty
	12,  // 258: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	88,  // 259: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	93,  // 260: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	87,  // 261: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	94,  // 262: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	95,  // 263: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	96,  // 264: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	97,  // 265: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	97,  // 266: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	98,  // 267: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	12,  // 268: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	99,  // 269: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	12,  // 270: header.PaymentMgr.GetReferral:input_type -> header.Id
	57,  // 271: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	100, // 272: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	12,  // 273: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	12,  // 274: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	12,  // 275: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	101, // 276: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	102, // 277: header.Pubsub.Fire:input_type -> header.PsMessage
	103, // 278: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	103, // 279: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	12,  // 280: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	104, // 281: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	12,  // 282: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	12,  // 283: header.FabikonService.ListFbPosts:input_type -> header.Id
	105, // 284: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	0,   // 285: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	34,  // 286: header.FabikonService.RemoveFbUserLabel:input_type -> header.User
	34,  // 287: header.FabikonService.AddFbUserLabel:input_type -> header.User
	12,  // 288: header.FabikonService.GenerateRefLink:input_type -> header.Id
	106, // 289: header.FabikonService.LinkPageWithAccount:input_type -> header.FacebookPageLinkRequest
	12,  // 290: header.FabikonService.ListFacebookPages:input_type -> header.Id
	0,   // 291: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	12,  // 292: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	107, // 293: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	107, // 294: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	107, // 295: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	107, // 296: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	108, // 297: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	0,   // 298: header.MailkonService.SendEmail:input_type -> header.Events
	69,  // 299: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	69,  // 300: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	69,  // 301: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	69,  // 302: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	12,  // 303: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	109, // 304: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	12,  // 305: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	110, // 306: header.MailkonService.TrackLink:input_type -> header.LinkData
	111, // 307: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	111, // 308: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	12,  // 309: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	112, // 310: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	112, // 311: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	12,  // 312: header.MailkonService.UnblockEmail:input_type -> header.Id
	12,  // 313: header.WidgetService.Read:input_type -> header.Id
	113, // 314: header.WidgetService.Update:input_type -> header.WidgetSetting
	12,  // 315: header.WidgetService.ReadUserSetting:input_type -> header.Id
	12,  // 316: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	114, // 317: header.WidgetService.SubmitImpression:input_type -> header.Impression
	115, // 318: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	116, // 319: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	117, // 320: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	118, // 321: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	118, // 322: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	119, // 323: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	12,  // 324: header.WidgetService.ListUploadedImage:input_type -> header.Id
	119, // 325: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	12,  // 326: header.WidgetService.ListWebPlugins:input_type -> header.Id
	120, // 327: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	120, // 328: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	120, // 329: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	12,  // 330: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	120, // 331: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	12,  // 332: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	12,  // 333: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	121, // 334: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	12,  // 335: header.WidgetService.SearchImages:input_type -> header.Id
	12,  // 336: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	12,  // 337: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	122, // 338: header.Bizbot.ListBots:input_type -> header.BotsRequest
	12,  // 339: header.Bizbot.GetBot:input_type -> header.Id
	123, // 340: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	123, // 341: header.Bizbot.CreateBot:input_type -> header.Bot
	123, // 342: header.Bizbot.UpdateBot:input_type -> header.Bot
	12,  // 343: header.Bizbot.DeleteBot:input_type -> header.Id
	124, // 344: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	124, // 345: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	124, // 346: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	124, // 347: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	125, // 348: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	126, // 349: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	127, // 350: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	128, // 351: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	129, // 352: header.Sendback.CreateWebhook:input_type -> header.Webhook
	12,  // 353: header.Sendback.PingWebhook:input_type -> header.Id
	12,  // 354: header.Sendback.DeleteWebhook:input_type -> header.Id
	12,  // 355: header.Sendback.ListWebhooks:input_type -> header.Id
	12,  // 356: header.Sendback.ReadWebhook:input_type -> header.Id
	129, // 357: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	12,  // 358: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	130, // 359: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	131, // 360: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	45,  // 361: header.Sendback.SendWebhookEvent:input_type -> header.Event
	132, // 362: header.Notibox.SendNoti:input_type -> header.Notification
	133, // 363: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	12,  // 364: header.Notibox.MarkReadNoti:input_type -> header.Id
	12,  // 365: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	43,  // 366: header.Proder.ReadProduct:input_type -> header.Product
	43,  // 367: header.Proder.CreateProduct:input_type -> header.Product
	43,  // 368: header.Proder.UpdateProduct:input_type -> header.Product
	12,  // 369: header.Proder.DeleteProduct:input_type -> header.Id
	...
	13,  // 372: header.Proder.ListProductCollections:input_type -> header.Ids
	...
	12,  // 375: header.Proder.DeleteProductCollection:input_type -> header.Id
	12,  // 376: header.Proder.ListProductFeeds:input_type -> header.Id
	...
	12,  // 379: header.Proder.DeleteProductFeed:input_type -> header.Id
	13,  // 380: header.Proder.ListProductCategories:input_type -> header.Ids
	12,  // 381: header.Proder.ReadOrder:input_type -> header.Id
	26,  // 382: header.Proder.CreateOrder:input_type -> header.Order
	26,  // 383: header.Proder.UpdateOrder:input_type -> header.Order
	12,  // 384: header.Proder.DeleteOrder:input_type -> header.Id
	...
	45,  // 390: header.Proder.AddOrderComment:input_type -> header.Event
	45,  // 391: header.Proder.EditOrderComment:input_type -> header.Event
	142, // 392: header.Proder.DeleteOrderComment:input_type -> header.Key
	12,  // 393: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 394: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	12,  // 395: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 396: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	12,  // 397: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	...
	12,  // 402: header.Proder.ShipOrder:input_type -> header.Id
	26,  // 403: header.Proder.UpdateShippingCode:input_type -> header.Order
	12,  // 404: header.Proder.CancelShippingOrder:input_type -> header.Id
	13,  // 405: header.Proder.PrintShippingOrders:input_type -> header.Ids
	12,  // 406: header.Proder.SeenOrder:input_type -> header.Id
	12,  // 407: header.Proder.FollowOrder:input_type -> header.Id
	12,  // 408: header.Proder.UnfollowOrder:input_type -> header.Id
	62,  // 409: header.Proder.TagOrder:input_type -> header.TagRequest
	62,  // 410: header.Proder.UntagOrder:input_type -> header.TagRequest
	12,  // 411: header.Proder.ReadPipeline:input_type -> header.Id
	149, // 412: header.Proder.CreatePipeline:input_type -> header.Pipeline
	149, // 413: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	12,  // 414: header.Proder.DeletePipeline:input_type -> header.Id
	13,  // 415: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 416: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	12,  // 417: header.Proder.PreselectPipeline:input_type -> header.Id
	151, // 418: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	13,  // 419: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	12,  // 420: header.TaskMgr.ReadTask:input_type -> header.Id
	48,  // 421: header.TaskMgr.CreateTask:input_type -> header.Task
	48,  // 422: header.TaskMgr.UpdateTask:input_type -> header.Task
	12,  // 423: header.TaskMgr.DeleteTask:input_type -> header.Id
	152, // 424: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	12,  // 425: header.TaskMgr.SeenTask:input_type -> header.Id
	12,  // 426: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	12,  // 427: header.TaskMgr.MuteTask:input_type -> header.Id
	12,  // 428: header.TaskMgr.UnmuteTask:input_type -> header.Id
	45,  // 429: header.TaskMgr.AddTaskComment:input_type -> header.Event
	45,  // 430: header.TaskMgr.EditTaskComment:input_type -> header.Event
	142, // 431: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	12,  // 432: header.TaskMgr.ListTaskComments:input_type -> header.Id
	153, // 433: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	13,  // 434: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	12,  // 435: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	154, // 436: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	154, // 437: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	12,  // 438: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	45,  // 439: header.CampaignMgr.OnEvent:input_type -> header.Event
	155, // 440: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	12,  // 441: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	156, // 442: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	157, // 443: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	158, // 444: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	157, // 445: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	157, // 446: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	159, // 447: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	156, // 448: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	160, // 449: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	161, // 450: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	162, // 451: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	12,  // 452: header.CreditMgr.ListCredits:input_type -> header.Id
	163, // 453: header.CreditMgr.AddCredit:input_type -> header.Credit
	12,  // 454: header.CreditMgr.DeleteCredit:input_type -> header.Id
	163, // 455: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	12,  // 456: header.FormMgr.ListForms:input_type -> header.Id
	164, // 457: header.FormMgr.CreateForm:input_type -> header.Form
	164, // 458: header.FormMgr.UpdateForm:input_type -> header.Form
	12,  // 459: header.FormMgr.DeleteForm:input_type -> header.Id
	165, // 460: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	166, // 461: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	167, // 462: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	167, // 463: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	57,  // 464: header.GooglekonService.SendEventToGoogle:output_type -> header.Empty
	168, // 465: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	57,  // 466: header.DocSearch.IndexConvo:output_type -> header.Empty
	169, // 467: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	170, // 468: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	171, // 469: header.DocSearch.Report:output_type -> header.ConvoReportResponse
	172, // 470: header.DocSearch.ListIds:output_type -> header.Conversations
	172, // 471: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	173, // 472: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	172, // 473: header.DocSearch.ListCallIds:output_type -> header.Conversations
	174, // 474: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	9,   // 475: header.NumberRegistry.Compact:output_type -> header.Number
	8,   // 476: header.NumberRegistry.Uncompact:output_type -> header.String
	10,  // 477: header.NumberRegistry.CompactM:output_type -> header.StrNumM
	175, // 478: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	24,  // 479: header.Map.LookupAddress:output_type -> header.Address
	176, // 480: header.Map.PredictAddress:output_type -> header.Addresses
	176, // 481: header.Map.ListDistricts:output_type -> header.Addresses
	176, // 482: header.Map.ListProvinces:output_type -> header.Addresses
	176, // 483: header.Map.ListWards:output_type -> header.Addresses
	176, // 484: header.Map.ListStreets:output_type -> header.Addresses
	176, // 485: header.Map.ListAddresses:output_type -> header.Addresses
	24,  // 486: header.Map.ReadAddress:output_type -> header.Address
	14,  // 487: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	14,  // 488: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	14,  // 489: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	57,  // 490: header.AccountMgr.RequestPassword:output_type -> header.Empty
	16,  // 491: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	16,  // 492: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	16,  // 493: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	17,  // 494: header.AccountMgr.DeleteAccount:output_type -> account.Account
	17,  // 495: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	57,  // 496: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	16,  // 497: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	16,  // 498: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	16,  // 499: header.AccountMgr.GetInvitation:output_type -> account.Agent
	16,  // 500: header.AccountMgr.InviteAgent:output_type -> account.Agent
	16,  // 501: header.AccountMgr.GetAgent:output_type -> account.Agent
	16,  // 502: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	17,  // 503: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	17,  // 504: header.AccountMgr.GetAccount:output_type -> account.Account
	17,  // 505: header.AccountMgr.UpdateAccount:output_type -> account.Account
	17,  // 506: header.AccountMgr.CreateAccount:output_type -> account.Account
	177, // 507: header.AccountMgr.ListAgents:output_type -> account.Agents
	57,  // 508: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	178, // 509: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	16,  // 510: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	179, // 511: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	16,  // 512: header.AccountMgr.TransferOwner:output_type -> account.Agent
	21,  // 513: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	180, // 514: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	180, // 515: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	57,  // 516: header.AccountMgr.LogoutSession:output_type -> header.Empty
	21,  // 517: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	181, // 518: header.AccountMgr.GetLanguage:output_type -> header.Lang
	22,  // 519: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	23,  // 520: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	23,  // 521: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	182, // 522: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	57,  // 523: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	176, // 524: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	24,  // 525: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	24,  // 526: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	57,  // 527: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	183, // 528: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	25,  // 529: header.AccountMgr.CreateTax:output_type -> header.Tax
	25,  // 530: header.AccountMgr.UpdateTax:output_type -> header.Tax
	57,  // 531: header.AccountMgr.DeleteTax:output_type -> header.Empty
	184, // 532: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	184, // 533: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	27,  // 534: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	27,  // 535: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	57,  // 536: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	28,  // 537: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	185, // 538: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	28,  // 539: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	57,  // 540: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	186, // 541: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	29,  // 542: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	29,  // 543: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	57,  // 544: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	57,  // 545: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	187, // 546: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	57,  // 547: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	30,  // 548: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	30,  // 549: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	30,  // 550: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	31,  // 551: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	188, // 552: header.AccountMgr.ListAgentPresences:output_type -> account.Presences
	189, // 553: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	12,  // 554: header.AccountMgr.NewID:output_type -> header.Id
	12,  // 555: header.AccountMgr.LockLogin:output_type -> header.Id
	12,  // 556: header.AccountMgr.UnlockLogin:output_type -> header.Id
	...
	190, // 561: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	...
	191, // 574: header.UserMgr.ListViews:output_type -> header.UserViews
	...
	192, // 579: header.UserMgr.ListSegments:output_type -> header.Segments
	...
	193, // 586: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	194, // 596: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	...
	195, // 599: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	...
	196, // 604: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	57,  // 605: header.UserMgr.LinkTask:output_type -> header.Empty
	197, // 606: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	...
	169, // 609: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	198, // 610: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	199, // 611: header.LiveMgr.SearchLocations:output_type -> header.Locations
	33,  // 612: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	200, // 613: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	201, // 614: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	202, // 615: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	203, // 616: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	204, // 617: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	205, // 618: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	206, // 622: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	207, // 625: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	172, // 630: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	172, // 631: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	96,  // 722: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	96,  // 723: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	...
	95,  // 727: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	95,  // 728: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	57,  // 729: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	95,  // 730: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	228, // 731: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	57,  // 732: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	100, // 733: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	100, // 734: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	229, // 735: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	100, // 736: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	...
	57,  // 740: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	57,  // 741: header.Pubsub.Fire:output_type -> header.Empty
	233, // 742: header.Pubsub.Poll:output_type -> header.PollResult
	103, // 743: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	104, // 744: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	104, // 745: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	...
	105, // 748: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	57,  // 749: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	57,  // 750: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	57,  // 751: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	12,  // 752: header.FabikonService.GenerateRefLink:output_type -> header.Id
	57,  // 753: header.FabikonService.LinkPageWithAccount:output_type -> header.Empty
	236, // 754: header.FabikonService.ListFacebookPages:output_type -> header.FacebookPages
	57,  // 755: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	237, // 756: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	57,  // 757: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	57,  // 758: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	57,  // 759: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	238, // 760: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	45,  // 761: header.ZalokonService.SendZNS:output_type -> header.Event
	57,  // 762: header.MailkonService.SendEmail:output_type -> header.Empty
	69,  // 763: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	57,  // 764: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	57,  // 765: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	239, // 766: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	240, // 767: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	109, // 768: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	57,  // 769: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	238, // 770: header.MailkonService.TrackLink:output_type -> header.Response
	238, // 771: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	111, // 772: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	238, // 773: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	238, // 774: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	238, // 775: header.MailkonService.BlockEmail:output_type -> header.Response
	238, // 776: header.MailkonService.UnblockEmail:output_type -> header.Response
	113, // 777: header.WidgetService.Read:output_type -> header.WidgetSetting
	113, // 778: header.WidgetService.Update:output_type -> header.WidgetSetting
	241, // 779: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	242, // 780: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	114, // 781: header.WidgetService.SubmitImpression:output_type -> header.Impression
	115, // 782: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	116, // 783: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	243, // 784: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	244, // 785: header.WidgetService.ListConversions:output_type -> header.Conversions
	245, // 786: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	119, // 787: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	246, // 788: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	57,  // 789: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	247, // 790: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	120, // 791: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	120, // 792: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	120, // 793: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	57,  // 794: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	120, // 795: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	247, // 796: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	57,  // 797: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	248, // 798: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	246, // 799: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	249, // 800: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	250, // 801: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	251, // 802: header.Bizbot.ListBots:output_type -> header.Bots
	123, // 803: header.Bizbot.GetBot:output_type -> header.Bot
	123, // 804: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	123, // 805: header.Bizbot.CreateBot:output_type -> header.Bot
	123, // 806: header.Bizbot.UpdateBot:output_type -> header.Bot
	57,  // 807: header.Bizbot.DeleteBot:output_type -> header.Empty
	57,  // 808: header.Bizbot.OnEvent:output_type -> header.Empty
	57,  // 809: header.Bizbot.StartBot:output_type -> header.Empty
	57,  // 810: header.Bizbot.StopBot:output_type -> header.Empty
	57,  // 811: header.Bizbot.TryAction:output_type -> header.Empty
	252, // 812: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	253, // 813: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	254, // 814: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	255, // 815: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	129, // 816: header.Sendback.CreateWebhook:output_type -> header.Webhook
	256, // 817: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	57,  // 818: header.Sendback.DeleteWebhook:output_type -> header.Empty
	257, // 819: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	129, // 820: header.Sendback.ReadWebhook:output_type -> header.Webhook
	129, // 821: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	129, // 822: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	258, // 823: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	259, // 824: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	57,  // 825: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	57,  // 826: header.Notibox.SendNoti:output_type -> header.Empty
	260, // 827: header.Notibox.ListNoties:output_type -> header.Notifications
	57,  // 828: header.Notibox.MarkReadNoti:output_type -> header.Empty
	57,  // 829: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	43,  // 830: header.Proder.ReadProduct:output_type -> header.Product
	43,  // 831: header.Proder.CreateProduct:output_type -> header.Product
	43,  // 832: header.Proder.UpdateProduct:output_type -> header.Product
	57,  // 833: header.Proder.DeleteProduct:output_type -> header.Empty
	261, // 834: header.Proder.ListProducts2:output_type -> header.Products
	262, // 835: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	263, // 836: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 837: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 838: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	57,  // 839: header.Proder.DeleteProductCollection:output_type -> header.Empty
	264, // 840: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 841: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 842: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	57,  // 843: header.Proder.DeleteProductFeed:output_type -> header.Empty
	265, // 844: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	26,  // 845: header.Proder.ReadOrder:output_type -> header.Order
	26,  // 846: header.Proder.CreateOrder:output_type -> header.Order
	26,  // 847: header.Proder.UpdateOrder:output_type -> header.Order
	57,  // 848: header.Proder.DeleteOrder:output_type -> header.Empty
	140, // 849: header.Proder.ListOrders:output_type -> header.Orders
	266, // 850: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 851: header.Proder.ImportOrders:output_type -> header.Orders
	45,  // 852: header.Proder.MakeOrderPayment:output_type -> header.Event
	45,  // 853: header.Proder.DeleteOrderPayment:output_type -> header.Event
	45,  // 854: header.Proder.AddOrderComment:output_type -> header.Event
	45,  // 855: header.Proder.EditOrderComment:output_type -> header.Event
	45,  // 856: header.Proder.DeleteOrderComment:output_type -> header.Event
	267, // 857: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	268, // 858: header.Proder.DownloadOrder:output_type -> header.File
	12,  // 859: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	269, // 860: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	57,  // 861: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	270, // 862: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	57,  // 863: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	57,  // 864: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 865: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	26,  // 866: header.Proder.ShipOrder:output_type -> header.Order
	26,  // 867: header.Proder.UpdateShippingCode:output_type -> header.Order
	26,  // 868: header.Proder.CancelShippingOrder:output_type -> header.Order
	268, // 869: header.Proder.PrintShippingOrders:output_type -> header.File
	57,  // 870: header.Proder.SeenOrder:output_type -> header.Empty
	57,  // 871: header.Proder.FollowOrder:output_type -> header.Empty
	57,  // 872: header.Proder.UnfollowOrder:output_type -> header.Empty
	57,  // 873: header.Proder.TagOrder:output_type -> header.Empty
	57,  // 874: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 875: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 876: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 877: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	57,  // 878: header.Proder.DeletePipeline:output_type -> header.Empty
	271, // 879: header.Proder.ListPipelines:output_type -> header.Pipelines
	57,  // 880: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 881: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 882: header.Proder.ReportOrder:output_type -> header.Orders
	57,  // 883: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	48,  // 884: header.TaskMgr.ReadTask:output_type -> header.Task
	48,  // 885: header.TaskMgr.CreateTask:output_type -> header.Task
	48,  // 886: header.TaskMgr.UpdateTask:output_type -> header.Task
	57,  // 887: header.TaskMgr.DeleteTask:output_type -> header.Empty
	272, // 888: header.TaskMgr.ListTasks:output_type -> header.Tasks
	57,  // 889: header.TaskMgr.SeenTask:output_type -> header.Empty
	57,  // 890: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	57,  // 891: header.TaskMgr.MuteTask:output_type -> header.Empty
	57,  // 892: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	45,  // 893: header.TaskMgr.AddTaskComment:output_type -> header.Event
	45,  // 894: header.TaskMgr.EditTaskComment:output_type -> header.Event
	45,  // 895: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	273, // 896: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	153, // 897: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	274, // 898: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	154, // 899: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	154, // 900: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	154, // 901: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	57,  // 902: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	57,  // 903: header.CampaignMgr.OnEvent:output_type -> header.Empty
	275, // 904: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	276, // 905: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	277, // 906: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	157, // 907: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	278, // 908: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	157, // 909: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	57,  // 910: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	279, // 911: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	57,  // 912: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	280, // 913: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	281, // 914: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	282, // 915: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	238, // 916: header.CreditMgr.ListCredits:output_type -> header.Response
	238, // 917: header.CreditMgr.AddCredit:output_type -> header.Response
	238, // 918: header.CreditMgr.DeleteCredit:output_type -> header.Response
	238, // 919: header.CreditMgr.UpdateCredit:output_type -> header.Response
	283, // 920: header.FormMgr.ListForms:output_type -> header.Forms
	164, // 921: header.FormMgr.CreateForm:output_type -> header.Form
	164, // 922: header.FormMgr.UpdateForm:output_type -> header.Form
	57,  // 923: header.FormMgr.DeleteForm:output_type -> header.Empty
	284, // 924: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	285, // 925: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	167, // 926: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	238, // 927: header.Scheduler.UnregisterTask:output_type -> header.Response
