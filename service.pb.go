...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x32, 0x8c, 0x03, 0x0a, 0x07, 0x4e, 0x6f, 0x74, 0x69, 0x62, 0x6f, 0x78, 0x12, 0x2b, 0x0a, 0x04,
	0x53, 0x65, 0x6e, 0x64, 0x12, 0x14, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4e, 0x6f,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x25, 0x0a, 0x08, 0x4d, 0x61, 0x72,
	...
	0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0x84, 0x14, 0x0a, 0x06, 0x50, 0x72, 0x6f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0a, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64,
	0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12,
	0x35, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65,
	0x65, 0x64, 0x73, 0x12, 0x0b, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x73,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Products)(nil),                          // 120: header.Products
	(*ProductCollection)(nil),                 // 121: header.ProductCollection
	(*ProductFeed)(nil),                       // 122: header.ProductFeed
	(*OrdersRequest)(nil),                     // 123: header.OrdersRequest
	(*DeleteDraftOrdersRequest)(nil),          // 124: header.DeleteDraftOrdersRequest
	(*Bill)(nil),                              // 125: header.Bill
	(*Key)(nil),                               // 126: header.Key
	(*DownloadOrderRequest)(nil),              // 127: header.DownloadOrderRequest
	(*AuthorizeShopeeRequest)(nil),            // 128: header.AuthorizeShopeeRequest
	(*ShopeeSyncProductRequest)(nil),          // 129: header.ShopeeSyncProductRequest
	(*GHTKOrder)(nil),                         // 130: header.GHTKOrder
	(*GHNOrder2)(nil),                         // 131: header.GHNOrder2
	(*ShippingInfo)(nil),                      // 132: header.ShippingInfo
	(*Task)(nil),                              // 133: header.Task
	(*TasksRequest)(nil),                      // 134: header.TasksRequest
	(*Pipeline)(nil),                          // 135: header.Pipeline
	(*RateLimitSyncResponse)(nil),             // 136: header.RateLimitSyncResponse
	(*DocSearchResponse)(nil),                 // 137: header.DocSearchResponse
	(*AddressAutocompleteResponses)(nil),      // 138: header.AddressAutocompleteResponses
	(*Addresses)(nil),                         // 139: header.Addresses
	(*account.Agents)(nil),                    // 140: account.Agents
	(*AgentGroups)(nil),                       // 141: header.AgentGroups
	(*account.BusinessHours)(nil),             // 142: account.BusinessHours
	(*LoginSessions)(nil),                     // 143: header.LoginSessions
	(*Lang)(nil),                              // 144: header.Lang
	(*ListChangelogsResponse)(nil),            // 145: header.ListChangelogsResponse
	(*Currency)(nil),                          // 146: header.Currency
	(*Taxes)(nil),                             // 147: header.Taxes
	(*ShippingPolicies)(nil),                  // 148: header.ShippingPolicies
	(*PaymentMethods)(nil),                    // 149: header.PaymentMethods
	(*IntegratedShippings)(nil),               // 150: header.IntegratedShippings
	(*Users)(nil),                             // 151: header.Users
	(*UserEventMetrics)(nil),                  // 152: header.UserEventMetrics
	(*UserViews)(nil),                         // 153: header.UserViews
	(*Labels)(nil),                            // 154: header.Labels
	(*Locations)(nil),                         // 155: header.Locations
	(*Events)(nil),                            // 156: header.Events
...
var file_service_proto_depIdxs = []int32{
	...
	4,   // 222: header.WidgetService.Read:input_type -> header.Id
	88,  // 223: header.WidgetService.Update:input_type -> header.WidgetSetting
	4,   // 224: header.WidgetService.ReadUserSetting:input_type -> header.Id
	4,   // 225: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	89,  // 226: header.WidgetService.SubmitImpression:input_type -> header.Impression
	90,  // 227: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	91,  // 228: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	92,  // 229: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	93,  // 230: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	93,  // 231: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	94,  // 232: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 233: header.WidgetService.ListUploadedImage:input_type -> header.Id
	94,  // 234: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 235: header.WidgetService.ListWebPlugins:input_type -> header.Id
	95,  // 236: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	95,  // 237: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	95,  // 238: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 239: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	95,  // 240: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	4,   // 241: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	4,   // 242: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	96,  // 243: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	4,   // 244: header.WidgetService.SearchImages:input_type -> header.Id
	4,   // 245: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	4,   // 246: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	4,   // 247: header.Bizbot.ListBots:input_type -> header.Id
	4,   // 248: header.Bizbot.GetBot:input_type -> header.Id
	97,  // 249: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	97,  // 250: header.Bizbot.CreateBot:input_type -> header.Bot
	97,  // 251: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 252: header.Bizbot.DeleteBot:input_type -> header.Id
	98,  // 253: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	98,  // 254: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	98,  // 255: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	98,  // 256: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	...
	101, // 259: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	102, // 260: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	103, // 261: header.Sendback.CreateWebhook:input_type -> header.Webhook
	4,   // 262: header.Sendback.PingWebhook:input_type -> header.Id
	4,   // 263: header.Sendback.DeleteWebhook:input_type -> header.Id
	4,   // 264: header.Sendback.ListWebhooks:input_type -> header.Id
	4,   // 265: header.Sendback.ReadWebhook:input_type -> header.Id
	103, // 266: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 267: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	104, // 268: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	105, // 269: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 270: header.Sendback.SendWebhookEvent:input_type -> header.Event
	106, // 271: header.Notibox.Send:input_type -> header.Notification
	4,   // 272: header.Notibox.MarkRead:input_type -> header.Id
	107, // 273: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	108, // 274: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	106, // 275: header.Notibox.SendNoti:input_type -> header.Notification
	108, // 276: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 277: header.Notibox.MarkReadNoti:input_type -> header.Id
	109, // 278: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 279: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 280: header.Watchhttp.ListWebpages:input_type -> header.Id
	109, // 281: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 282: header.Watchhttp.ReadWebpage:input_type -> header.Id
	110, // 283: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	111, // 284: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	112, // 285: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	112, // 286: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 287: header.Holap.AppendAgentSet:input_type -> account.Agent
	56,  // 288: header.Holap.AppendTagSet:input_type -> header.Tag
	28,  // 289: header.Holap.UpdateUser:input_type -> header.User
	51,  // 290: header.Holap.UpdateConversation:input_type -> header.Conversation
	46,  // 291: header.Holap.OnConversationEvent:input_type -> header.Event
	113, // 292: header.Holap.FreeAccount:input_type -> header.AccountImage
	114, // 293: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	115, // 294: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	114, // 295: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	115, // 296: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	116, // 297: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 298: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	29,  // 299: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 300: header.Holap.UpdateOrder:input_type -> header.Order
	117, // 301: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	118, // 302: header.Proder.ReadProduct:input_type -> header.Product
	118, // 303: header.Proder.CreateProduct:input_type -> header.Product
	118, // 304: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 305: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 306: header.Proder.RestoreProduct:input_type -> header.Id
	119, // 307: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 308: header.Proder.ListProductIds:input_type -> header.Ids
	119, // 309: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	120, // 310: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 311: header.Proder.ListProductCollections:input_type -> header.Ids
	121, // 312: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	121, // 313: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 314: header.Proder.DeleteProductCollection:input_type -> header.Id
	5,   // 315: header.Proder.ListProductFeeds:input_type -> header.Ids
	122, // 316: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	122, // 317: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 318: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 319: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 320: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 321: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 322: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 323: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 324: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 325: header.Proder.RestoreOrder:input_type -> header.Id
	123, // 326: header.Proder.ListOrders:input_type -> header.OrdersRequest
	123, // 327: header.Proder.CountOrders:input_type -> header.OrdersRequest
	124, // 328: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	125, // 329: header.Proder.MakeOrderPayment:input_type -> header.Bill
	126, // 330: header.Proder.DeleteOrderPayment:input_type -> header.Key
	46,  // 331: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 332: header.Proder.EditOrderComment:input_type -> header.Event
	126, // 333: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 334: header.Proder.ListOrderEvents:input_type -> header.Id
	127, // 335: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 336: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	128, // 337: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 338: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	129, // 339: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	130, // 340: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	131, // 341: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	132, // 342: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 343: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 344: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 345: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 346: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 347: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 348: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 349: header.Apiece.ReadTask:input_type -> header.Id
	133, // 350: header.Apiece.CreateTask:input_type -> header.Task
	133, // 351: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 352: header.Apiece.DeleteTask:input_type -> header.Id
	134, // 353: header.Apiece.ListTasks:input_type -> header.TasksRequest
	46,  // 354: header.Apiece.AddTaskComment:input_type -> header.Event
	46,  // 355: header.Apiece.EditTaskComment:input_type -> header.Event
	126, // 356: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 357: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 358: header.Apiece.ReadPipeline:input_type -> header.Id
	135, // 359: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	135, // 360: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 361: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 362: header.Apiece.ListPipelines:input_type -> header.Ids
	136, // 363: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	41,  // 364: header.Search.Index:output_type -> header.Empty
	137, // 365: header.Search.Search:output_type -> header.DocSearchResponse
	41,  // 366: header.Search.AddOwner:output_type -> header.Empty
	138, // 367: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 368: header.Map.LookupAddress:output_type -> header.Address
	139, // 369: header.Map.PredictAddress:output_type -> header.Addresses
	139, // 370: header.Map.ListDistricts:output_type -> header.Addresses
	139, // 371: header.Map.ListProvinces:output_type -> header.Addresses
	139, // 372: header.Map.ListWards:output_type -> header.Addresses
	139, // 373: header.Map.ListStreets:output_type -> header.Addresses
	139, // 374: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 375: header.Map.ReadAddress:output_type -> header.Address
	6,   // 376: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 377: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 378: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	41,  // 379: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 380: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 381: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 382: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	41,  // 383: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 384: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 385: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 386: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 387: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 388: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 389: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 390: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 391: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 392: header.AccountMgr.CreateAccount:output_type -> account.Account
	140, // 393: header.AccountMgr.ListAgents:output_type -> account.Agents
	41,  // 394: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	141, // 395: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	41,  // 396: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	41,  // 397: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 398: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	142, // 399: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 400: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 401: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	143, // 402: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	143, // 403: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	41,  // 404: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 405: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	144, // 406: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 407: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 408: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	145, // 409: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 410: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 411: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	146, // 412: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	41,  // 413: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	139, // 414: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 415: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 416: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	41,  // 417: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	147, // 418: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 419: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 420: header.AccountMgr.UpdateTax:output_type -> header.Tax
	41,  // 421: header.AccountMgr.DeleteTax:output_type -> header.Empty
	148, // 422: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	148, // 423: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 424: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 425: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	41,  // 426: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	41,  // 427: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	149, // 428: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 429: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 430: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	41,  // 431: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	41,  // 432: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	150, // 433: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	41,  // 434: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 435: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 436: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 437: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	151, // 438: header.UserMgr.SearchUsers:output_type -> header.Users
	27,  // 439: header.UserMgr.MergeUser:output_type -> header.UserAlias
	4,   // 440: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 441: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	4,   // 442: header.UserMgr.UpdateUser:output_type -> header.Id
	28,  // 443: header.UserMgr.ReadUser:output_type -> header.User
	152, // 444: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	151, // 445: header.UserMgr.MatchUsers:output_type -> header.Users
	30,  // 446: header.UserMgr.UpdateView:output_type -> header.UserView
	30,  // 447: header.UserMgr.CreateView:output_type -> header.UserView
	41,  // 448: header.UserMgr.DeleteView:output_type -> header.Empty
	30,  // 449: header.UserMgr.GetView:output_type -> header.UserView
	153, // 450: header.UserMgr.ListViews:output_type -> header.UserViews
	31,  // 451: header.UserMgr.UpsertLabel:output_type -> header.Label
	41,  // 452: header.UserMgr.DeleteLabel:output_type -> header.Empty
	154, // 453: header.UserMgr.ListLabels:output_type -> header.Labels
	31,  // 454: header.UserMgr.GetLabel:output_type -> header.Label
	41,  // 455: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	41,  // 456: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	41,  // 457: header.UserMgr.AddUserLabel:output_type -> header.Empty
	41,  // 458: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	20,  // 459: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	20,  // 460: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	41,  // 461: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	28,  // 462: header.UserMgr.ListShippingAddress:output_type -> header.User
	41,  // 463: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	151, // 464: header.UserMgr.ListLeads:output_type -> header.Users
	155, // 465: header.LiveMgr.SearchLocations:output_type -> header.Locations
	151, // 466: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	156, // 467: header.LiveMgr.TopEvents:output_type -> header.Events
	157, // 468: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	158, // 469: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	159, // 470: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	160, // 471: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	161, // 472: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	162, // 473: header.NoteMgr.ListNotes:output_type -> header.Notes
	38,  // 474: header.NoteMgr.AddNote:output_type -> header.Note
	38,  // 475: header.NoteMgr.UpdateNote:output_type -> header.Note
	41,  // 476: header.NoteMgr.DeleteNote:output_type -> header.Empty
	163, // 477: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	40,  // 478: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	41,  // 479: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	40,  // 480: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	164, // 481: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	42,  // 482: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	42,  // 483: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	165, // 484: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	44,  // 485: header.RuleMgr.UpdateRule:output_type -> header.Rule
	44,  // 486: header.RuleMgr.CreateRule:output_type -> header.Rule
	41,  // 487: header.RuleMgr.DeleteRule:output_type -> header.Empty
	44,  // 488: header.RuleMgr.ReadRule:output_type -> header.Rule
	166, // 489: header.RuleMgr.ListRules:output_type -> header.Route
	167, // 490: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 491: header.ConversationMgr.PongMessage:output_type -> header.Event
	51,  // 492: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	51,  // 493: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	51,  // 494: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	168, // 495: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	168, // 496: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	41,  // 497: header.ConversationMgr.TagConversation:output_type -> header.Empty
	41,  // 498: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	41,  // 499: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	41,  // 500: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	41,  // 501: header.ConversationMgr.Typing:output_type -> header.Empty
	51,  // 502: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	168, // 503: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	41,  // 504: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	41,  // 505: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	41,  // 506: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	41,  // 507: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	52,  // 508: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	52,  // 509: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 510: header.ConversationMgr.TerminateBot:output_type -> header.Event
	169, // 511: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	54,  // 512: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	54,  // 513: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	41,  // 514: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	54,  // 515: header.TemplateMgr.GetTemplate:output_type -> header.Template
	170, // 516: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	41,  // 517: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	56,  // 518: header.TagMgr.CreateTag:output_type -> header.Tag
	56,  // 519: header.TagMgr.UpdateTag:output_type -> header.Tag
	41,  // 520: header.TagMgr.DeleteTag:output_type -> header.Empty
	171, // 521: header.TagMgr.ListTags:output_type -> header.Tags
	56,  // 522: header.TagMgr.GetTag:output_type -> header.Tag
	41,  // 523: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	172, // 524: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	57,  // 525: header.IntegrationMgr.Integrate:output_type -> header.Integration
	156, // 526: header.EventMgr.SearchEvents:output_type -> header.Events
	46,  // 527: header.EventMgr.CreateEvent:output_type -> header.Event
	46,  // 528: header.ConversationEventReader.SendMessage:output_type -> header.Event
	46,  // 529: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	41,  // 530: header.ConversationEventReader.PinMessage:output_type -> header.Empty
	41,  // 531: header.ConversationEventReader.UnpinMessage:output_type -> header.Empty
	156, // 532: header.ConversationEventReader.ListEvents:output_type -> header.Events
	173, // 533: header.FileMgr.Presign:output_type -> header.PresignResult
	174, // 534: header.FileMgr.Uploaded:output_type -> header.File
	174, // 535: header.FileMgr.DownloadFileUrl:output_type -> header.File
	64,  // 536: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	64,  // 537: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	41,  // 538: header.Noti5Service.Noti:output_type -> header.Empty
	41,  // 539: header.Noti5Service.AddToken:output_type -> header.Empty
	41,  // 540: header.Noti5Service.RemoveToken:output_type -> header.Empty
	41,  // 541: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	67,  // 542: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	175, // 543: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	72,  // 544: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	69,  // 545: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	69,  // 546: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	70,  // 547: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	70,  // 548: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	41,  // 549: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	176, // 550: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	67,  // 551: header.PaymentMgr.Pay:output_type -> payment.Bill
	72,  // 552: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	72,  // 553: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	177, // 554: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	72,  // 555: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	72,  // 556: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	178, // 557: header.PaymentMgr.ListComments:output_type -> payment.Comments
	76,  // 558: header.PaymentMgr.AddComment:output_type -> payment.Comment
	179, // 559: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	80,  // 560: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	80,  // 561: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	77,  // 562: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	67,  // 563: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	180, // 564: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	79,  // 565: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	79,  // 566: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	41,  // 567: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	79,  // 568: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	181, // 569: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	41,  // 570: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	84,  // 571: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	84,  // 572: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	182, // 573: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	84,  // 574: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	183, // 575: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	184, // 576: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	185, // 577: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	41,  // 578: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	41,  // 579: header.Pubsub.Publish:output_type -> header.Empty
	41,  // 580: header.Realtime.ShardSend:output_type -> header.Empty
	87,  // 581: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	87,  // 582: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	186, // 583: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	187, // 584: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	88,  // 585: header.WidgetService.Read:output_type -> header.WidgetSetting
	88,  // 586: header.WidgetService.Update:output_type -> header.WidgetSetting
	188, // 587: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	189, // 588: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	89,  // 589: header.WidgetService.SubmitImpression:output_type -> header.Impression
	90,  // 590: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	91,  // 591: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	190, // 592: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	191, // 593: header.WidgetService.ListConversions:output_type -> header.Conversions
	192, // 594: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	94,  // 595: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	193, // 596: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	41,  // 597: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	194, // 598: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	95,  // 599: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	95,  // 600: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	95,  // 601: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	41,  // 602: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	95,  // 603: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	194, // 604: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	41,  // 605: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	195, // 606: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	193, // 607: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	196, // 608: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	197, // 609: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	198, // 610: header.Bizbot.ListBots:output_type -> header.Bots
	97,  // 611: header.Bizbot.GetBot:output_type -> header.Bot
	97,  // 612: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	97,  // 613: header.Bizbot.CreateBot:output_type -> header.Bot
	97,  // 614: header.Bizbot.UpdateBot:output_type -> header.Bot
	41,  // 615: header.Bizbot.DeleteBot:output_type -> header.Empty
	41,  // 616: header.Bizbot.OnEvent:output_type -> header.Empty
	41,  // 617: header.Bizbot.StartBot:output_type -> header.Empty
	41,  // 618: header.Bizbot.StopBot:output_type -> header.Empty
	41,  // 619: header.Bizbot.TryAction:output_type -> header.Empty
	199, // 620: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	200, // 621: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	201, // 622: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	202, // 623: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	103, // 624: header.Sendback.CreateWebhook:output_type -> header.Webhook
	203, // 625: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	41,  // 626: header.Sendback.DeleteWebhook:output_type -> header.Empty
	204, // 627: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	103, // 628: header.Sendback.ReadWebhook:output_type -> header.Webhook
	103, // 629: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	103, // 630: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	205, // 631: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	206, // 632: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	41,  // 633: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	41,  // 634: header.Notibox.Send:output_type -> header.Empty
	41,  // 635: header.Notibox.MarkRead:output_type -> header.Empty
	41,  // 636: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	207, // 637: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	41,  // 638: header.Notibox.SendNoti:output_type -> header.Empty
	208, // 639: header.Notibox.ListNoties:output_type -> header.Notifications
	41,  // 640: header.Notibox.MarkReadNoti:output_type -> header.Empty
	109, // 641: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	41,  // 642: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	209, // 643: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	109, // 644: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	109, // 645: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	210, // 646: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	211, // 647: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	212, // 648: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	210, // 649: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	41,  // 650: header.Holap.AppendAgentSet:output_type -> header.Empty
	41,  // 651: header.Holap.AppendTagSet:output_type -> header.Empty
	41,  // 652: header.Holap.UpdateUser:output_type -> header.Empty
	41,  // 653: header.Holap.UpdateConversation:output_type -> header.Empty
	41,  // 654: header.Holap.OnConversationEvent:output_type -> header.Empty
	41,  // 655: header.Holap.FreeAccount:output_type -> header.Empty
	213, // 656: header.Holap.ReportUser:output_type -> header.UserMetrics
	214, // 657: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 658: header.Holap.ListUserIds:output_type -> header.Ids
	168, // 659: header.Holap.ListConversationIds:output_type -> header.Conversations
	215, // 660: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 661: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	152, // 662: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	41,  // 663: header.Holap.UpdateOrder:output_type -> header.Empty
	216, // 664: header.Holap.ReportOrder:output_type -> header.Orders
	118, // 665: header.Proder.ReadProduct:output_type -> header.Product
	118, // 666: header.Proder.CreateProduct:output_type -> header.Product
	118, // 667: header.Proder.UpdateProduct:output_type -> header.Product
	41,  // 668: header.Proder.DeleteProduct:output_type -> header.Empty
	118, // 669: header.Proder.RestoreProduct:output_type -> header.Product
	120, // 670: header.Proder.ListProducts:output_type -> header.Products
	5,   // 671: header.Proder.ListProductIds:output_type -> header.Ids
	120, // 672: header.Proder.ListGroupedProducts:output_type -> header.Products
	120, // 673: header.Proder.ImportProducts:output_type -> header.Products
	217, // 674: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	121, // 675: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	121, // 676: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	41,  // 677: header.Proder.DeleteProductCollection:output_type -> header.Empty
	218, // 678: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	122, // 679: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	122, // 680: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	41,  // 681: header.Proder.DeleteProductFeed:output_type -> header.Empty
	219, // 682: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	220, // 683: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 684: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 685: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 686: header.Proder.UpdateOrder:output_type -> header.Order
	41,  // 687: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 688: header.Proder.RestoreOrder:output_type -> header.Order
	216, // 689: header.Proder.ListOrders:output_type -> header.Orders
	216, // 690: header.Proder.CountOrders:output_type -> header.Orders
	41,  // 691: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	46,  // 692: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 693: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 694: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 695: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 696: header.Proder.DeleteOrderComment:output_type -> header.Event
	221, // 697: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	174, // 698: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 699: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	222, // 700: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	41,  // 701: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	223, // 702: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	41,  // 703: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	41,  // 704: header.Proder.GHNShippingStatus:output_type -> header.Empty
	132, // 705: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 706: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 707: header.Proder.CancelShippingOrder:output_type -> header.Order
	174, // 708: header.Proder.PrintShippingOrders:output_type -> header.File
	41,  // 709: header.Proder.SeenOrder:output_type -> header.Empty
	41,  // 710: header.Proder.FollowOrder:output_type -> header.Empty
	41,  // 711: header.Proder.UnfollowOrder:output_type -> header.Empty
	133, // 712: header.Apiece.ReadTask:output_type -> header.Task
	133, // 713: header.Apiece.CreateTask:output_type -> header.Task
	133, // 714: header.Apiece.UpdateTask:output_type -> header.Task
	41,  // 715: header.Apiece.DeleteTask:output_type -> header.Empty
	224, // 716: header.Apiece.ListTasks:output_type -> header.Tasks
	46,  // 717: header.Apiece.AddTaskComment:output_type -> header.Event
	46,  // 718: header.Apiece.EditTaskComment:output_type -> header.Event
	46,  // 719: header.Apiece.DeleteTaskComment:output_type -> header.Event
	225, // 720: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	135, // 721: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	135, // 722: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	135, // 723: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	41,  // 724: header.Apiece.DeletePipeline:output_type -> header.Empty
	226, // 725: header.Apiece.ListPipelines:output_type -> header.Pipelines
