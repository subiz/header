...
var file_service_proto_depIdxs = []int32{
	...
	275, // 910: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	...
	276, // 913: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	52,  // 914: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	277, // 915: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	278, // 916: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	279, // 917: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	...
	280, // 922: header.FormMgr.ListForms:output_type -> header.Forms
	...
	281, // 926: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	282, // 927: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
