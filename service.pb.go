...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x49, 0x64, 0x32, 0x93, 0x16, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67,
	...
	0x2a, 0x0a, 0x0c, 0x50, 0x72, 0x65, 0x6c, 0x6f, 0x61, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	0x75, 0x74, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x9a, 0x19,
...
var file_service_proto_depIdxs = []int32{
	...
	13,  // 147: header.UserMgr.PreloadEvent:input_type -> header.Ids
	52,  // 148: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	53,  // 149: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	...
	54,  // 154: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	55,  // 155: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	56,  // 156: header.NoteMgr.AddNote:input_type -> header.Note
	56,  // 157: header.NoteMgr.UpdateNote:input_type -> header.Note
	57,  // 158: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	58,  // 159: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	59,  // 160: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	59,  // 161: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	60,  // 162: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	46,  // 163: header.ConversationMgr.PongMessage:input_type -> header.Event
	61,  // 164: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	...
	62,  // 167: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	13,  // 168: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	63,  // 169: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	63,  // 170: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	64,  // 171: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	64,  // 172: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	...
	107, // 290: header.FabikonService.LinkPageWithAccount:input_type -> header.FacebookPageLinkRequest
	...
	58,  // 612: header.UserMgr.PreloadEvent:output_type -> header.Empty
	200, // 613: header.LiveMgr.SearchLocations:output_type -> header.Locations
	34,  // 614: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	...
	56,  // 621: header.NoteMgr.AddNote:output_type -> header.Note
	56,  // 622: header.NoteMgr.UpdateNote:output_type -> header.Note
	58,  // 623: header.NoteMgr.DeleteNote:output_type -> header.Empty
	207, // 624: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	59,  // 625: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	59,  // 626: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	208, // 627: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 628: header.ConversationMgr.PongMessage:output_type -> header.Event
	65,  // 629: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	65,  // 630: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	65,  // 631: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	173, // 632: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	173, // 633: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	58,  // 634: header.ConversationMgr.TagConversation:output_type -> header.Empty
	58,  // 635: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	58,  // 636: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	58,  // 637: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	...
	58,  // 755: header.FabikonService.LinkPageWithAccount:output_type -> header.Empty
...
type UserMgrClient interface {
	...
	PreloadEvent(ctx context.Context, in *Ids, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *userMgrClient) PreloadEvent(ctx context.Context, in *Ids, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/header.UserMgr/PreloadEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserMgrServer interface {
	...
	PreloadEvent(context.Context, *Ids) (*Empty, error)
}
...
func (*UnimplementedUserMgrServer) PreloadEvent(context.Context, *Ids) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreloadEvent not implemented")
}
...
func _UserMgr_PreloadEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Ids)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserMgrServer).PreloadEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/header.UserMgr/PreloadEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserMgrServer).PreloadEvent(ctx, req.(*Ids))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UserMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreloadEvent",
			Handler:    _UserMgr_PreloadEvent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service.proto",
