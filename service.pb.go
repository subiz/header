...
var file_service_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x3b, 0x0a, 0x0e, 0x4e, 0x75,
	...
	0x2e, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0xe8, 0x03, 0x0a, 0x03, 0x4d, 0x61, 0x70, 0x12,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*UserReportRequest)(nil),                 // 44: header.UserReportRequest
...
var file_service_proto_depIdxs = []int32{
	...
	4,   // 7: header.Map.Predict:input_type -> header.AddressAutocompleteRequest
	5,   // 8: header.Map.LookupAddress:input_type -> header.Id
	4,   // 9: header.Map.PredictAddress:input_type -> header.AddressAutocompleteRequest
	5,   // 10: header.Map.ListDistricts:input_type -> header.Id
	5,   // 11: header.Map.ListProvinces:input_type -> header.Id
	5,   // 12: header.Map.ListWards:input_type -> header.Id
	5,   // 13: header.Map.ListStreets:input_type -> header.Id
	6,   // 14: header.Map.ListAddresses:input_type -> header.Ids
	5,   // 15: header.Map.ReadAddress:input_type -> header.Id
	7,   // 16: header.AccountMgr.CreateGroup:input_type -> header.AgentGroup
	7,   // 17: header.AccountMgr.UpdateGroup:input_type -> header.AgentGroup
	5,   // 18: header.AccountMgr.GetGroup:input_type -> header.Id
	8,   // 19: header.AccountMgr.RequestResetPassword:input_type -> account.ResetPasswordRequest
	9,   // 20: header.AccountMgr.UpdatePassword:input_type -> account.NewPassword
	10,  // 21: header.AccountMgr.UpdateAgent:input_type -> account.Agent
	5,   // 22: header.AccountMgr.DeleteAgent:input_type -> header.Id
	10,  // 23: header.AccountMgr.RequestChangeEmail:input_type -> account.Agent
	11,  // 24: header.AccountMgr.ConfirmChangeEmail:input_type -> account.Token
	9,   // 25: header.AccountMgr.AcceptInvitation:input_type -> account.NewPassword
	11,  // 26: header.AccountMgr.GetInvitation:input_type -> account.Token
	10,  // 27: header.AccountMgr.InviteAgent:input_type -> account.Agent
	5,   // 28: header.AccountMgr.GetAgent:input_type -> header.Id
	5,   // 29: header.AccountMgr.LookupAgentById:input_type -> header.Id
	11,  // 30: header.AccountMgr.ConfirmAccount:input_type -> account.Token
	5,   // 31: header.AccountMgr.GetAccount:input_type -> header.Id
	12,  // 32: header.AccountMgr.UpdateAccount:input_type -> account.Account
	13,  // 33: header.AccountMgr.CreateAccount:input_type -> account.CreateAccountRequest
	5,   // 34: header.AccountMgr.ListAgents:input_type -> header.Id
	5,   // 35: header.AccountMgr.DeleteGroup:input_type -> header.Id
	5,   // 36: header.AccountMgr.ListGroups:input_type -> header.Id
	10,  // 37: header.AccountMgr.ChangeEmail:input_type -> account.Agent
	14,  // 38: header.AccountMgr.SyncPublicHolidays:input_type -> account.SyncPublicHolidaysRequest
	5,   // 39: header.AccountMgr.TransferOwner:input_type -> header.Id
	15,  // 40: header.AccountMgr.CheckLoginSession:input_type -> header.LoginSession
	5,   // 41: header.AccountMgr.ListLoginSessions:input_type -> header.Id
	5,   // 42: header.AccountMgr.ListApiKeys:input_type -> header.Id
	5,   // 43: header.AccountMgr.LogoutSession:input_type -> header.Id
	15,  // 44: header.AccountMgr.CreateApiKey:input_type -> header.LoginSession
	5,   // 45: header.AccountMgr.GetLanguage:input_type -> header.Id
	16,  // 46: header.AccountMgr.UpdateLanguage:input_type -> header.LangMessage
	5,   // 47: header.AccountMgr.GetShopSetting:input_type -> header.Id
	17,  // 48: header.AccountMgr.UpdateShopSetting:input_type -> header.ShopSetting
	5,   // 49: header.AccountMgr.ReadCurrency:input_type -> header.Id
	5,   // 50: header.AccountMgr.AutoSyncCurrency:input_type -> header.Id
	5,   // 51: header.AccountMgr.ListShopAddresses:input_type -> header.Id
	18,  // 52: header.AccountMgr.CreateShopAddress:input_type -> header.Address
	18,  // 53: header.AccountMgr.UpdateShopAddress:input_type -> header.Address
	5,   // 54: header.AccountMgr.DeleteShopAddress:input_type -> header.Id
	5,   // 55: header.AccountMgr.ListTaxes:input_type -> header.Id
	19,  // 56: header.AccountMgr.CreateTax:input_type -> header.Tax
	19,  // 57: header.AccountMgr.UpdateTax:input_type -> header.Tax
	5,   // 58: header.AccountMgr.DeleteTax:input_type -> header.Id
	20,  // 59: header.AccountMgr.CheckShippingPolicy:input_type -> header.Order
	5,   // 60: header.AccountMgr.ListShippingPolicies:input_type -> header.Id
	21,  // 61: header.AccountMgr.CreateShippingPolicy:input_type -> header.ShippingPolicy
	21,  // 62: header.AccountMgr.UpdateShippingPolicy:input_type -> header.ShippingPolicy
	5,   // 63: header.AccountMgr.DeleteShippingPolicy:input_type -> header.Id
	22,  // 64: header.AccountMgr.CreateCancellationCode:input_type -> header.CancellationCode
	5,   // 65: header.AccountMgr.ListCancellationCodes:input_type -> header.Id
	22,  // 66: header.AccountMgr.UpdateCancellationCode:input_type -> header.CancellationCode
	5,   // 67: header.AccountMgr.MakeDefaultTax:input_type -> header.Id
	5,   // 68: header.AccountMgr.ListPaymentMethods:input_type -> header.Id
	23,  // 69: header.AccountMgr.CreatePaymentMethod:input_type -> header.PaymentMethod
	23,  // 70: header.AccountMgr.UpdatePaymentMethod:input_type -> header.PaymentMethod
	5,   // 71: header.AccountMgr.DeletePaymentMethod:input_type -> header.Id
	5,   // 72: header.AccountMgr.MakeDefaultPaymentMethod:input_type -> header.Id
	6,   // 73: header.AccountMgr.ListIntegratedShippingProviders:input_type -> header.Ids
	24,  // 74: header.AccountMgr.DeintegrateShippingProvider:input_type -> header.IntegratedShipping
	24,  // 75: header.AccountMgr.IntegrateShippingProvider:input_type -> header.IntegratedShipping
	24,  // 76: header.AccountMgr.SendGHNAffiliateOTP:input_type -> header.IntegratedShipping
	24,  // 77: header.AccountMgr.EnterGHNAffiliateOTP:input_type -> header.IntegratedShipping
	25,  // 78: header.AccountMgr.UpdateAgentPresence:input_type -> account.Presence
	26,  // 79: header.AccountMgr.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	5,   // 80: header.AccountMgr.NewID:input_type -> header.Id
	5,   // 81: header.AccountMgr.LockLogin:input_type -> header.Id
	5,   // 82: header.AccountMgr.UnlockLogin:input_type -> header.Id
	27,  // 83: header.UserMgr.MergeUser:input_type -> header.Users
	5,   // 84: header.UserMgr.DetachUser:input_type -> header.Id
	28,  // 85: header.UserMgr.CreateUser:input_type -> header.User
	28,  // 86: header.UserMgr.CreateUser2:input_type -> header.User
	28,  // 87: header.UserMgr.UpdateUser2:input_type -> header.User
	28,  // 88: header.UserMgr.UpdateUser:input_type -> header.User
	28,  // 89: header.UserMgr.TryUpdateUser:input_type -> header.User
	5,   // 90: header.UserMgr.RemoveUser:input_type -> header.Id
	5,   // 91: header.UserMgr.RestoreUser:input_type -> header.Id
	5,   // 92: header.UserMgr.ReadUser:input_type -> header.Id
	5,   // 93: header.UserMgr.ReadOrCreateUserByContactProfile:input_type -> header.Id
	6,   // 94: header.UserMgr.MatchUsers:input_type -> header.Ids
	5,   // 95: header.UserMgr.BanUser:input_type -> header.Id
	5,   // 96: header.UserMgr.UnbanUser:input_type -> header.Id
	5,   // 97: header.UserMgr.LookupByPhone:input_type -> header.Id
	29,  // 98: header.UserMgr.UpdateView:input_type -> header.UserView
	29,  // 99: header.UserMgr.CreateView:input_type -> header.UserView
	5,   // 100: header.UserMgr.DeleteView:input_type -> header.Id
	5,   // 101: header.UserMgr.GetView:input_type -> header.Id
	5,   // 102: header.UserMgr.ListViews:input_type -> header.Id
	30,  // 103: header.UserMgr.UpdateSegment:input_type -> header.Segment
	30,  // 104: header.UserMgr.CreateSegment:input_type -> header.Segment
	5,   // 105: header.UserMgr.DeleteSegment:input_type -> header.Id
	5,   // 106: header.UserMgr.GetSegment:input_type -> header.Id
	5,   // 107: header.UserMgr.ListSegments:input_type -> header.Id
	31,  // 108: header.UserMgr.ListUsers:input_type -> header.ListUserRequest
	32,  // 109: header.UserMgr.AddToSegment:input_type -> header.SegmentUsers
	32,  // 110: header.UserMgr.RemoveFromSegment:input_type -> header.SegmentUsers
	33,  // 111: header.UserMgr.UpdateUserCampaignStatus:input_type -> header.UserCampaign
	34,  // 112: header.UserMgr.UpsertLabel:input_type -> header.Label
	5,   // 113: header.UserMgr.DeleteLabel:input_type -> header.Id
	5,   // 114: header.UserMgr.ListLabels:input_type -> header.Id
	5,   // 115: header.UserMgr.GetLabel:input_type -> header.Id
	35,  // 116: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	35,  // 117: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	35,  // 118: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	35,  // 119: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	35,  // 120: header.UserMgr.AddLeadConversionBy:input_type -> header.UserRequest
	18,  // 121: header.UserMgr.CreateShippingAddress:input_type -> header.Address
	18,  // 122: header.UserMgr.UpdateShippingAddress:input_type -> header.Address
	18,  // 123: header.UserMgr.RemoveShippingAddress:input_type -> header.Address
	5,   // 124: header.UserMgr.ListShippingAddress:input_type -> header.Id
	18,  // 125: header.UserMgr.MakeDefaultShippingAddress:input_type -> header.Address
	29,  // 126: header.UserMgr.ListLeads:input_type -> header.UserView
	36,  // 127: header.UserMgr.SuggestLeadField:input_type -> header.SuggestLeadFieldRequest
	...
	42,  // 133: header.UserMgr.LinkTask:input_type -> header.Task
	43,  // 134: header.UserMgr.CountUserProfiles:input_type -> header.UsersRequest
	43,  // 135: header.UserMgr.ListUserIds:input_type -> header.UsersRequest
	43,  // 136: header.UserMgr.ListUserIdWithPhones:input_type -> header.UsersRequest
	2,   // 137: header.UserMgr.SearchUsers:input_type -> header.DocSearchRequest
	44,  // 138: header.UserMgr.ReportUser:input_type -> header.UserReportRequest
	45,  // 139: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	46,  // 140: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	5,   // 141: header.LiveMgr.TopLocations:input_type -> header.Id
	5,   // 142: header.LiveMgr.TopPages:input_type -> header.Id
	5,   // 143: header.LiveMgr.TopSources:input_type -> header.Id
	5,   // 144: header.LiveMgr.CountActiveUsers:input_type -> header.Id
	47,  // 145: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	48,  // 146: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	49,  // 147: header.NoteMgr.AddNote:input_type -> header.Note
	49,  // 148: header.NoteMgr.UpdateNote:input_type -> header.Note
	50,  // 149: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	51,  // 150: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	52,  // 151: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	52,  // 152: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	53,  // 153: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	39,  // 154: header.ConversationMgr.PongMessage:input_type -> header.Event
	54,  // 155: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	5,   // 156: header.ConversationMgr.EndConversation:input_type -> header.Id
	5,   // 157: header.ConversationMgr.GetConversation:input_type -> header.Id
	55,  // 158: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	6,   // 159: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	56,  // 160: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	56,  // 161: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	57,  // 162: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	57,  // 163: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	5,   // 164: header.ConversationMgr.Typing:input_type -> header.Id
	58,  // 165: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	59,  // 166: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	58,  // 167: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	57,  // 168: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	58,  // 169: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	58,  // 170: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	60,  // 171: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	5,   // 172: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	61,  // 173: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	39,  // 174: header.ConversationMgr.SendMessage:input_type -> header.Event
	62,  // 175: header.ConversationMgr.SendOmniChannelMessage:input_type -> header.SendOmniChannelMessageRequest
	39,  // 176: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	39,  // 177: header.ConversationMgr.PinMessage:input_type -> header.Event
	39,  // 178: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	63,  // 179: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	5,   // 180: header.ConversationMgr.Deintegrate:input_type -> header.Id
	5,   // 181: header.ConversationMgr.ListIntegrations:input_type -> header.Id
	64,  // 182: header.ConversationMgr.Integrate:input_type -> header.Integration
	5,   // 183: header.ConversationMgr.GetIntegration:input_type -> header.Id
	65,  // 184: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	65,  // 185: header.ConversationMgr.CreateRule:input_type -> header.Rule
	5,   // 186: header.ConversationMgr.DeleteRule:input_type -> header.Id
	5,   // 187: header.ConversationMgr.ReadRule:input_type -> header.Id
	5,   // 188: header.ConversationMgr.ListRules:input_type -> header.Id
	5,   // 189: header.ConversationMgr.ListConversationAutomations:input_type -> header.Id
	66,  // 190: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	5,   // 191: header.ConversationMgr.DeleteConversationAutomation:input_type -> header.Id
	5,   // 192: header.ConversationMgr.ReadConversationAutomation:input_type -> header.Id
	5,   // 193: header.ConversationMgr.ListPhoneDevices:input_type -> header.Id
	67,  // 194: header.ConversationMgr.CreatePhoneDevice:input_type -> header.PhoneDevice
	67,  // 195: header.ConversationMgr.UpdatePhoneDevice:input_type -> header.PhoneDevice
	5,   // 196: header.ConversationMgr.DeletePhoneDevice:input_type -> header.Id
	5,   // 197: header.ConversationMgr.ReadPhoneDevice:input_type -> header.Id
	5,   // 198: header.ConversationMgr.TestNumber:input_type -> header.Id
	5,   // 199: header.ConversationMgr.ListCallSettings:input_type -> header.Id
	68,  // 200: header.ConversationMgr.UpdateCallSetting:input_type -> header.CallSetting
	69,  // 201: header.ConversationMgr.BlockNumber:input_type -> header.BlockedNumber
	5,   // 202: header.ConversationMgr.ListBlockedNumbers:input_type -> header.Id
	69,  // 203: header.ConversationMgr.UnblockNumber:input_type -> header.BlockedNumber
	5,   // 204: header.ConversationMgr.ListGreetingAudio:input_type -> header.Id
	70,  // 205: header.ConversationMgr.CreateGreetingAudio:input_type -> header.GreetingAudio
	54,  // 206: header.ConversationMgr.OriginateCall:input_type -> header.StartRequest
	5,   // 207: header.ConversationMgr.ListMyRecentCalls:input_type -> header.Id
	39,  // 208: header.ConversationMgr.SaveMessage:input_type -> header.Event
	39,  // 209: header.ConversationMgr.ApplyMessage:input_type -> header.Event
	71,  // 210: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	71,  // 211: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	5,   // 212: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	5,   // 213: header.TemplateMgr.GetTemplate:input_type -> header.Id
	72,  // 214: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	5,   // 215: header.TemplateMgr.PickTemplate:input_type -> header.Id
	73,  // 216: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	73,  // 217: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	5,   // 218: header.TemplateMgr.DeleteModal:input_type -> header.Id
	5,   // 219: header.TemplateMgr.GetModal:input_type -> header.Id
	5,   // 220: header.TemplateMgr.ListModals:input_type -> header.Id
	74,  // 221: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	75,  // 222: header.TagMgr.CreateTag:input_type -> header.Tag
	75,  // 223: header.TagMgr.UpdateTag:input_type -> header.Tag
	5,   // 224: header.TagMgr.DeleteTag:input_type -> header.Id
	5,   // 225: header.TagMgr.ListTags:input_type -> header.Id
	5,   // 226: header.TagMgr.GetTag:input_type -> header.Id
	5,   // 227: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	76,  // 228: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	77,  // 229: header.Noti5Service.Noti:input_type -> header.PushNoti
	78,  // 230: header.Noti5Service.AddToken:input_type -> noti5.Token
	78,  // 231: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	78,  // 232: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	79,  // 233: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	5,   // 234: header.PaymentMgr.GetSub:input_type -> header.Id
	80,  // 235: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	80,  // 236: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	5,   // 237: header.PaymentMgr.GetSubscription:input_type -> header.Id
	81,  // 238: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	81,  // 239: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	5,   // 240: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	5,   // 241: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	82,  // 242: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	83,  // 243: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	83,  // 244: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	84,  // 245: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	80,  // 246: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	85,  // 247: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	86,  // 248: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	87,  // 249: header.PaymentMgr.AddComment:input_type -> payment.Comment
	51,  // 250: header.PaymentMgr.ListPlans:input_type -> header.Empty
	5,   // 251: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	83,  // 252: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	88,  // 253: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	82,  // 254: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	89,  // 255: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	90,  // 256: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	91,  // 257: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	92,  // 258: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	92,  // 259: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	93,  // 260: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	5,   // 261: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	94,  // 262: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	5,   // 263: header.PaymentMgr.GetReferral:input_type -> header.Id
	51,  // 264: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	95,  // 265: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	5,   // 266: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	5,   // 267: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	5,   // 268: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	96,  // 269: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	97,  // 270: header.Pubsub.Fire:input_type -> header.PsMessage
	98,  // 271: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	98,  // 272: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	5,   // 273: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	99,  // 274: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	5,   // 275: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	5,   // 276: header.FabikonService.ListFbPosts:input_type -> header.Id
	100, // 277: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	101, // 278: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	28,  // 279: header.FabikonService.RemoveFbUserLabel:input_type -> header.User
	28,  // 280: header.FabikonService.AddFbUserLabel:input_type -> header.User
	5,   // 281: header.FabikonService.GenerateRefLink:input_type -> header.Id
	101, // 282: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	5,   // 283: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	102, // 284: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	102, // 285: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	102, // 286: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	102, // 287: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	103, // 288: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	101, // 289: header.MailkonService.SendEmail:input_type -> header.Events
	64,  // 290: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	64,  // 291: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	64,  // 292: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	64,  // 293: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	5,   // 294: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	104, // 295: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	5,   // 296: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	105, // 297: header.MailkonService.TrackLink:input_type -> header.LinkData
	106, // 298: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	106, // 299: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	5,   // 300: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	107, // 301: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	107, // 302: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	5,   // 303: header.MailkonService.UnblockEmail:input_type -> header.Id
	5,   // 304: header.WidgetService.Read:input_type -> header.Id
	108, // 305: header.WidgetService.Update:input_type -> header.WidgetSetting
	5,   // 306: header.WidgetService.ReadUserSetting:input_type -> header.Id
	5,   // 307: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	109, // 308: header.WidgetService.SubmitImpression:input_type -> header.Impression
	110, // 309: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	111, // 310: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	112, // 311: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	113, // 312: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	113, // 313: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	114, // 314: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	5,   // 315: header.WidgetService.ListUploadedImage:input_type -> header.Id
	114, // 316: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	5,   // 317: header.WidgetService.ListWebPlugins:input_type -> header.Id
	115, // 318: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	115, // 319: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	115, // 320: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	5,   // 321: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	115, // 322: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	5,   // 323: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	5,   // 324: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	116, // 325: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	5,   // 326: header.WidgetService.SearchImages:input_type -> header.Id
	5,   // 327: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	5,   // 328: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	117, // 329: header.Bizbot.ListBots:input_type -> header.BotsRequest
	5,   // 330: header.Bizbot.GetBot:input_type -> header.Id
	118, // 331: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	118, // 332: header.Bizbot.CreateBot:input_type -> header.Bot
	118, // 333: header.Bizbot.UpdateBot:input_type -> header.Bot
	5,   // 334: header.Bizbot.DeleteBot:input_type -> header.Id
	119, // 335: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	119, // 336: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	119, // 337: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	119, // 338: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	120, // 339: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	121, // 340: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	122, // 341: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	123, // 342: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	124, // 343: header.Sendback.CreateWebhook:input_type -> header.Webhook
	5,   // 344: header.Sendback.PingWebhook:input_type -> header.Id
	5,   // 345: header.Sendback.DeleteWebhook:input_type -> header.Id
	5,   // 346: header.Sendback.ListWebhooks:input_type -> header.Id
	5,   // 347: header.Sendback.ReadWebhook:input_type -> header.Id
	124, // 348: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	5,   // 349: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	125, // 350: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	126, // 351: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	39,  // 352: header.Sendback.SendWebhookEvent:input_type -> header.Event
	127, // 353: header.Notibox.SendNoti:input_type -> header.Notification
	128, // 354: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	5,   // 355: header.Notibox.MarkReadNoti:input_type -> header.Id
	5,   // 356: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	28,  // 357: header.Holap.UpdateUser:input_type -> header.User
	58,  // 358: header.Holap.UpdateConversation:input_type -> header.Conversation
	39,  // 359: header.Holap.OnConversationEvent:input_type -> header.Event
	129, // 360: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	130, // 361: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	129, // 362: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	130, // 363: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	131, // 364: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	6,   // 365: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	20,  // 366: header.Holap.UpdateOrder:input_type -> header.Order
	...
	37,  // 370: header.Proder.ReadProduct:input_type -> header.Product
	37,  // 371: header.Proder.CreateProduct:input_type -> header.Product
	37,  // 372: header.Proder.UpdateProduct:input_type -> header.Product
	5,   // 373: header.Proder.DeleteProduct:input_type -> header.Id
	...
	6,   // 376: header.Proder.ListProductCollections:input_type -> header.Ids
	...
	5,   // 379: header.Proder.DeleteProductCollection:input_type -> header.Id
	5,   // 380: header.Proder.ListProductFeeds:input_type -> header.Id
	...
	5,   // 383: header.Proder.DeleteProductFeed:input_type -> header.Id
	6,   // 384: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 385: header.Proder.ReadOrder:input_type -> header.Id
	20,  // 386: header.Proder.CreateOrder:input_type -> header.Order
	20,  // 387: header.Proder.UpdateOrder:input_type -> header.Order
	5,   // 388: header.Proder.DeleteOrder:input_type -> header.Id
	...
	39,  // 394: header.Proder.AddOrderComment:input_type -> header.Event
	39,  // 395: header.Proder.EditOrderComment:input_type -> header.Event
	142, // 396: header.Proder.DeleteOrderComment:input_type -> header.Key
	5,   // 397: header.Proder.ListOrderEvents:input_type -> header.Id
	143, // 398: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	5,   // 399: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	144, // 400: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	5,   // 401: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	...
	5,   // 406: header.Proder.ShipOrder:input_type -> header.Id
	20,  // 407: header.Proder.UpdateShippingCode:input_type -> header.Order
	5,   // 408: header.Proder.CancelShippingOrder:input_type -> header.Id
	6,   // 409: header.Proder.PrintShippingOrders:input_type -> header.Ids
	5,   // 410: header.Proder.SeenOrder:input_type -> header.Id
	5,   // 411: header.Proder.FollowOrder:input_type -> header.Id
	5,   // 412: header.Proder.UnfollowOrder:input_type -> header.Id
	56,  // 413: header.Proder.TagOrder:input_type -> header.TagRequest
	56,  // 414: header.Proder.UntagOrder:input_type -> header.TagRequest
	5,   // 415: header.Proder.ReadPipeline:input_type -> header.Id
	...
	5,   // 418: header.Proder.DeletePipeline:input_type -> header.Id
	6,   // 419: header.Proder.ListPipelines:input_type -> header.Ids
	150, // 420: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	5,   // 421: header.Proder.PreselectPipeline:input_type -> header.Id
	132, // 422: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	6,   // 423: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	5,   // 424: header.TaskMgr.ReadTask:input_type -> header.Id
	42,  // 425: header.TaskMgr.CreateTask:input_type -> header.Task
	42,  // 426: header.TaskMgr.UpdateTask:input_type -> header.Task
	5,   // 427: header.TaskMgr.DeleteTask:input_type -> header.Id
	151, // 428: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	5,   // 429: header.TaskMgr.SeenTask:input_type -> header.Id
	5,   // 430: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	5,   // 431: header.TaskMgr.MuteTask:input_type -> header.Id
	5,   // 432: header.TaskMgr.UnmuteTask:input_type -> header.Id
	39,  // 433: header.TaskMgr.AddTaskComment:input_type -> header.Event
	39,  // 434: header.TaskMgr.EditTaskComment:input_type -> header.Event
	142, // 435: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	5,   // 436: header.TaskMgr.ListTaskComments:input_type -> header.Id
	152, // 437: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	6,   // 438: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	5,   // 439: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	...
	5,   // 442: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	39,  // 443: header.CampaignMgr.OnEvent:input_type -> header.Event
	154, // 444: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	5,   // 445: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	...
	156, // 448: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	156, // 449: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	157, // 450: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	5,   // 451: header.CampaignMgr.FindNextCall:input_type -> header.Id
	...
	51,  // 468: header.Search.Index:output_type -> header.Empty
	167, // 469: header.Search.Search:output_type -> header.DocSearchResponse
	51,  // 470: header.Search.AddOwner:output_type -> header.Empty
	51,  // 471: header.DocSearch.IndexConvo:output_type -> header.Empty
	167, // 472: header.DocSearch.Search:output_type -> header.DocSearchResponse
	168, // 473: header.NumberRegistry.Compact:output_type -> header.Number
	169, // 474: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	18,  // 475: header.Map.LookupAddress:output_type -> header.Address
	170, // 476: header.Map.PredictAddress:output_type -> header.Addresses
	170, // 477: header.Map.ListDistricts:output_type -> header.Addresses
	170, // 478: header.Map.ListProvinces:output_type -> header.Addresses
	170, // 479: header.Map.ListWards:output_type -> header.Addresses
	170, // 480: header.Map.ListStreets:output_type -> header.Addresses
	170, // 481: header.Map.ListAddresses:output_type -> header.Addresses
	18,  // 482: header.Map.ReadAddress:output_type -> header.Address
	7,   // 483: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	7,   // 484: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	7,   // 485: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	51,  // 486: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	10,  // 487: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	10,  // 488: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	10,  // 489: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	51,  // 490: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	10,  // 491: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	10,  // 492: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	10,  // 493: header.AccountMgr.GetInvitation:output_type -> account.Agent
	10,  // 494: header.AccountMgr.InviteAgent:output_type -> account.Agent
	10,  // 495: header.AccountMgr.GetAgent:output_type -> account.Agent
	10,  // 496: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	12,  // 497: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	12,  // 498: header.AccountMgr.GetAccount:output_type -> account.Account
	12,  // 499: header.AccountMgr.UpdateAccount:output_type -> account.Account
	12,  // 500: header.AccountMgr.CreateAccount:output_type -> account.Account
	171, // 501: header.AccountMgr.ListAgents:output_type -> account.Agents
	51,  // 502: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	172, // 503: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	10,  // 504: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	173, // 505: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	10,  // 506: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 507: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	174, // 508: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	174, // 509: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	51,  // 510: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 511: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	175, // 512: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 513: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 514: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	17,  // 515: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	176, // 516: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	51,  // 517: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	170, // 518: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	18,  // 519: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	18,  // 520: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	51,  // 521: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	177, // 522: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	19,  // 523: header.AccountMgr.CreateTax:output_type -> header.Tax
	19,  // 524: header.AccountMgr.UpdateTax:output_type -> header.Tax
	51,  // 525: header.AccountMgr.DeleteTax:output_type -> header.Empty
	178, // 526: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	178, // 527: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	21,  // 528: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	21,  // 529: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	51,  // 530: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	22,  // 531: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	179, // 532: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	22,  // 533: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	51,  // 534: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	180, // 535: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	23,  // 536: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	23,  // 537: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	51,  // 538: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	51,  // 539: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	181, // 540: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	51,  // 541: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	24,  // 542: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	24,  // 543: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	24,  // 544: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 545: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	182, // 546: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	5,   // 547: header.AccountMgr.NewID:output_type -> header.Id
	5,   // 548: header.AccountMgr.LockLogin:output_type -> header.Id
	5,   // 549: header.AccountMgr.UnlockLogin:output_type -> header.Id
	28,  // 550: header.UserMgr.MergeUser:output_type -> header.User
	51,  // 551: header.UserMgr.DetachUser:output_type -> header.Empty
	5,   // 552: header.UserMgr.CreateUser:output_type -> header.Id
	28,  // 553: header.UserMgr.CreateUser2:output_type -> header.User
	28,  // 554: header.UserMgr.UpdateUser2:output_type -> header.User
	28,  // 555: header.UserMgr.UpdateUser:output_type -> header.User
	183, // 556: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	51,  // 557: header.UserMgr.RemoveUser:output_type -> header.Empty
	51,  // 558: header.UserMgr.RestoreUser:output_type -> header.Empty
	28,  // 559: header.UserMgr.ReadUser:output_type -> header.User
	28,  // 560: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	27,  // 561: header.UserMgr.MatchUsers:output_type -> header.Users
	28,  // 562: header.UserMgr.BanUser:output_type -> header.User
	28,  // 563: header.UserMgr.UnbanUser:output_type -> header.User
	27,  // 564: header.UserMgr.LookupByPhone:output_type -> header.Users
	29,  // 565: header.UserMgr.UpdateView:output_type -> header.UserView
	29,  // 566: header.UserMgr.CreateView:output_type -> header.UserView
	51,  // 567: header.UserMgr.DeleteView:output_type -> header.Empty
	29,  // 568: header.UserMgr.GetView:output_type -> header.UserView
	184, // 569: header.UserMgr.ListViews:output_type -> header.UserViews
	30,  // 570: header.UserMgr.UpdateSegment:output_type -> header.Segment
	30,  // 571: header.UserMgr.CreateSegment:output_type -> header.Segment
	51,  // 572: header.UserMgr.DeleteSegment:output_type -> header.Empty
	30,  // 573: header.UserMgr.GetSegment:output_type -> header.Segment
	185, // 574: header.UserMgr.ListSegments:output_type -> header.Segments
	27,  // 575: header.UserMgr.ListUsers:output_type -> header.Users
	51,  // 576: header.UserMgr.AddToSegment:output_type -> header.Empty
	51,  // 577: header.UserMgr.RemoveFromSegment:output_type -> header.Empty
	51,  // 578: header.UserMgr.UpdateUserCampaignStatus:output_type -> header.Empty
	34,  // 579: header.UserMgr.UpsertLabel:output_type -> header.Label
	51,  // 580: header.UserMgr.DeleteLabel:output_type -> header.Empty
	186, // 581: header.UserMgr.ListLabels:output_type -> header.Labels
	34,  // 582: header.UserMgr.GetLabel:output_type -> header.Label
	51,  // 583: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	51,  // 584: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	51,  // 585: header.UserMgr.AddUserLabel:output_type -> header.Empty
	51,  // 586: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	51,  // 587: header.UserMgr.AddLeadConversionBy:output_type -> header.Empty
	18,  // 588: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	18,  // 589: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	51,  // 590: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	187, // 591: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	51,  // 592: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	27,  // 593: header.UserMgr.ListLeads:output_type -> header.Users
	188, // 594: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	37,  // 595: header.UserMgr.LinkProductUrl:output_type -> header.Product
	101, // 596: header.UserMgr.ListUserEvents:output_type -> header.Events
	39,  // 597: header.UserMgr.CreateUserEvent:output_type -> header.Event
	40,  // 598: header.UserMgr.FillDevice:output_type -> common.Device
	189, // 599: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	51,  // 600: header.UserMgr.LinkTask:output_type -> header.Empty
	190, // 601: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	6,   // 602: header.UserMgr.ListUserIds:output_type -> header.Ids
	27,  // 603: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	167, // 604: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	191, // 605: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	192, // 606: header.LiveMgr.SearchLocations:output_type -> header.Locations
	27,  // 607: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	193, // 608: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	194, // 609: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	195, // 610: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	196, // 611: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	197, // 612: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	198, // 613: header.NoteMgr.ListNotes:output_type -> header.Notes
	49,  // 614: header.NoteMgr.AddNote:output_type -> header.Note
	49,  // 615: header.NoteMgr.UpdateNote:output_type -> header.Note
	51,  // 616: header.NoteMgr.DeleteNote:output_type -> header.Empty
	199, // 617: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	52,  // 618: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	52,  // 619: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	200, // 620: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	39,  // 621: header.ConversationMgr.PongMessage:output_type -> header.Event
	58,  // 622: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	58,  // 623: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	58,  // 624: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	201, // 625: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	201, // 626: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	51,  // 627: header.ConversationMgr.TagConversation:output_type -> header.Empty
	51,  // 628: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	51,  // 629: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	51,  // 630: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	51,  // 631: header.ConversationMgr.Typing:output_type -> header.Empty
	58,  // 632: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	201, // 633: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	51,  // 634: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	51,  // 635: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	51,  // 636: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	51,  // 637: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	60,  // 638: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	60,  // 639: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	39,  // 640: header.ConversationMgr.TerminateBot:output_type -> header.Event
	39,  // 641: header.ConversationMgr.SendMessage:output_type -> header.Event
	39,  // 642: header.ConversationMgr.SendOmniChannelMessage:output_type -> header.Event
	39,  // 643: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	51,  // 644: header.ConversationMgr.PinMessage:output_type -> header.Empty
	51,  // 645: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	101, // 646: header.ConversationMgr.ListEvents:output_type -> header.Events
	51,  // 647: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	202, // 648: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	64,  // 649: header.ConversationMgr.Integrate:output_type -> header.Integration
	64,  // 650: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	65,  // 651: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	65,  // 652: header.ConversationMgr.CreateRule:output_type -> header.Rule
	51,  // 653: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	65,  // 654: header.ConversationMgr.ReadRule:output_type -> header.Rule
	203, // 655: header.ConversationMgr.ListRules:output_type -> header.Route
	204, // 656: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	66,  // 657: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	51,  // 658: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	66,  // 659: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	205, // 660: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	67,  // 661: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	67,  // 662: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	51,  // 663: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	67,  // 664: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	64,  // 665: header.ConversationMgr.TestNumber:output_type -> header.Integration
	206, // 666: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	68,  // 667: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	69,  // 668: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	207, // 669: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	51,  // 670: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	208, // 671: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	70,  // 672: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	58,  // 673: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	209, // 674: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	39,  // 675: header.ConversationMgr.SaveMessage:output_type -> header.Event
	39,  // 676: header.ConversationMgr.ApplyMessage:output_type -> header.Event
	71,  // 677: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	71,  // 678: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	51,  // 679: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	71,  // 680: header.TemplateMgr.GetTemplate:output_type -> header.Template
	210, // 681: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	51,  // 682: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	73,  // 683: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	73,  // 684: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	51,  // 685: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	73,  // 686: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	211, // 687: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	212, // 688: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	75,  // 689: header.TagMgr.CreateTag:output_type -> header.Tag
	75,  // 690: header.TagMgr.UpdateTag:output_type -> header.Tag
	51,  // 691: header.TagMgr.DeleteTag:output_type -> header.Empty
	213, // 692: header.TagMgr.ListTags:output_type -> header.Tags
	75,  // 693: header.TagMgr.GetTag:output_type -> header.Tag
	76,  // 694: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	76,  // 695: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	51,  // 696: header.Noti5Service.Noti:output_type -> header.Empty
	51,  // 697: header.Noti5Service.AddToken:output_type -> header.Empty
	51,  // 698: header.Noti5Service.RemoveToken:output_type -> header.Empty
	51,  // 699: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	214, // 700: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	215, // 701: header.PaymentMgr.GetSub:output_type -> header.AccSub
	83,  // 702: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	80,  // 703: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	80,  // 704: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	81,  // 705: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	81,  // 706: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	51,  // 707: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	216, // 708: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	217, // 709: header.PaymentMgr.Pay:output_type -> payment.Bill
	83,  // 710: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	83,  // 711: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	218, // 712: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	83,  // 713: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	83,  // 714: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	219, // 715: header.PaymentMgr.ListComments:output_type -> payment.Comments
	87,  // 716: header.PaymentMgr.AddComment:output_type -> payment.Comment
	220, // 717: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	91,  // 718: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	91,  // 719: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	88,  // 720: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	217, // 721: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	221, // 722: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	90,  // 723: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	90,  // 724: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	51,  // 725: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	90,  // 726: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	222, // 727: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	51,  // 728: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	95,  // 729: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	95,  // 730: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	223, // 731: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	95,  // 732: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	224, // 733: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	225, // 734: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	226, // 735: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	51,  // 736: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	51,  // 737: header.Pubsub.Fire:output_type -> header.Empty
	227, // 738: header.Pubsub.Poll:output_type -> header.PollResult
	98,  // 739: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	99,  // 740: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	99,  // 741: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	228, // 742: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	229, // 743: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	100, // 744: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	51,  // 745: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	51,  // 746: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	51,  // 747: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	5,   // 748: header.FabikonService.GenerateRefLink:output_type -> header.Id
	51,  // 749: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	230, // 750: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	51,  // 751: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	51,  // 752: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	51,  // 753: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	231, // 754: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	39,  // 755: header.ZalokonService.SendZNS:output_type -> header.Event
	51,  // 756: header.MailkonService.SendEmail:output_type -> header.Empty
	64,  // 757: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	51,  // 758: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	51,  // 759: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	232, // 760: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	233, // 761: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	104, // 762: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	51,  // 763: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	231, // 764: header.MailkonService.TrackLink:output_type -> header.Response
	231, // 765: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	106, // 766: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	231, // 767: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	231, // 768: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	231, // 769: header.MailkonService.BlockEmail:output_type -> header.Response
	231, // 770: header.MailkonService.UnblockEmail:output_type -> header.Response
	108, // 771: header.WidgetService.Read:output_type -> header.WidgetSetting
	108, // 772: header.WidgetService.Update:output_type -> header.WidgetSetting
	234, // 773: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	235, // 774: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	109, // 775: header.WidgetService.SubmitImpression:output_type -> header.Impression
	110, // 776: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	111, // 777: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	236, // 778: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	237, // 779: header.WidgetService.ListConversions:output_type -> header.Conversions
	238, // 780: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	114, // 781: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	239, // 782: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	51,  // 783: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	240, // 784: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	115, // 785: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	115, // 786: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	115, // 787: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	51,  // 788: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	115, // 789: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	240, // 790: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	51,  // 791: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	241, // 792: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	239, // 793: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	242, // 794: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	243, // 795: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	244, // 796: header.Bizbot.ListBots:output_type -> header.Bots
	118, // 797: header.Bizbot.GetBot:output_type -> header.Bot
	118, // 798: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	118, // 799: header.Bizbot.CreateBot:output_type -> header.Bot
	118, // 800: header.Bizbot.UpdateBot:output_type -> header.Bot
	51,  // 801: header.Bizbot.DeleteBot:output_type -> header.Empty
	51,  // 802: header.Bizbot.OnEvent:output_type -> header.Empty
	51,  // 803: header.Bizbot.StartBot:output_type -> header.Empty
	51,  // 804: header.Bizbot.StopBot:output_type -> header.Empty
	51,  // 805: header.Bizbot.TryAction:output_type -> header.Empty
	245, // 806: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	246, // 807: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	247, // 808: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	248, // 809: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	124, // 810: header.Sendback.CreateWebhook:output_type -> header.Webhook
	249, // 811: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	51,  // 812: header.Sendback.DeleteWebhook:output_type -> header.Empty
	250, // 813: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	124, // 814: header.Sendback.ReadWebhook:output_type -> header.Webhook
	124, // 815: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	124, // 816: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	251, // 817: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	252, // 818: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	51,  // 819: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	51,  // 820: header.Notibox.SendNoti:output_type -> header.Empty
	253, // 821: header.Notibox.ListNoties:output_type -> header.Notifications
	51,  // 822: header.Notibox.MarkReadNoti:output_type -> header.Empty
	51,  // 823: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	51,  // 824: header.Holap.UpdateUser:output_type -> header.Empty
	51,  // 825: header.Holap.UpdateConversation:output_type -> header.Empty
	51,  // 826: header.Holap.OnConversationEvent:output_type -> header.Empty
	254, // 827: header.Holap.ReportUser:output_type -> header.UserMetrics
	255, // 828: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	6,   // 829: header.Holap.ListUserIds:output_type -> header.Ids
	201, // 830: header.Holap.ListConversationIds:output_type -> header.Conversations
	256, // 831: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	6,   // 832: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	51,  // 833: header.Holap.UpdateOrder:output_type -> header.Empty
	140, // 834: header.Holap.ReportOrder:output_type -> header.Orders
	257, // 835: header.Holap.ReportCall:output_type -> header.CallMetrics
	201, // 836: header.Holap.ListCallIds:output_type -> header.Conversations
	37,  // 837: header.Proder.ReadProduct:output_type -> header.Product
	37,  // 838: header.Proder.CreateProduct:output_type -> header.Product
	37,  // 839: header.Proder.UpdateProduct:output_type -> header.Product
	51,  // 840: header.Proder.DeleteProduct:output_type -> header.Empty
	258, // 841: header.Proder.ListProducts2:output_type -> header.Products
	259, // 842: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	260, // 843: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	136, // 844: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	136, // 845: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	51,  // 846: header.Proder.DeleteProductCollection:output_type -> header.Empty
	261, // 847: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	137, // 848: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	137, // 849: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	51,  // 850: header.Proder.DeleteProductFeed:output_type -> header.Empty
	262, // 851: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	20,  // 852: header.Proder.ReadOrder:output_type -> header.Order
	20,  // 853: header.Proder.CreateOrder:output_type -> header.Order
	20,  // 854: header.Proder.UpdateOrder:output_type -> header.Order
	51,  // 855: header.Proder.DeleteOrder:output_type -> header.Empty
	140, // 856: header.Proder.ListOrders:output_type -> header.Orders
	263, // 857: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	140, // 858: header.Proder.ImportOrders:output_type -> header.Orders
	39,  // 859: header.Proder.MakeOrderPayment:output_type -> header.Event
	39,  // 860: header.Proder.DeleteOrderPayment:output_type -> header.Event
	39,  // 861: header.Proder.AddOrderComment:output_type -> header.Event
	39,  // 862: header.Proder.EditOrderComment:output_type -> header.Event
	39,  // 863: header.Proder.DeleteOrderComment:output_type -> header.Event
	264, // 864: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	265, // 865: header.Proder.DownloadOrder:output_type -> header.File
	5,   // 866: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	266, // 867: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	51,  // 868: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	267, // 869: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	51,  // 870: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	51,  // 871: header.Proder.GHNShippingStatus:output_type -> header.Empty
	148, // 872: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	20,  // 873: header.Proder.ShipOrder:output_type -> header.Order
	20,  // 874: header.Proder.UpdateShippingCode:output_type -> header.Order
	20,  // 875: header.Proder.CancelShippingOrder:output_type -> header.Order
	265, // 876: header.Proder.PrintShippingOrders:output_type -> header.File
	51,  // 877: header.Proder.SeenOrder:output_type -> header.Empty
	51,  // 878: header.Proder.FollowOrder:output_type -> header.Empty
	51,  // 879: header.Proder.UnfollowOrder:output_type -> header.Empty
	51,  // 880: header.Proder.TagOrder:output_type -> header.Empty
	51,  // 881: header.Proder.UntagOrder:output_type -> header.Empty
	149, // 882: header.Proder.ReadPipeline:output_type -> header.Pipeline
	149, // 883: header.Proder.CreatePipeline:output_type -> header.Pipeline
	149, // 884: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	51,  // 885: header.Proder.DeletePipeline:output_type -> header.Empty
	268, // 886: header.Proder.ListPipelines:output_type -> header.Pipelines
	51,  // 887: header.Proder.DeletePipelineStage:output_type -> header.Empty
	149, // 888: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	140, // 889: header.Proder.ReportOrder:output_type -> header.Orders
	51,  // 890: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	42,  // 891: header.TaskMgr.ReadTask:output_type -> header.Task
	42,  // 892: header.TaskMgr.CreateTask:output_type -> header.Task
	42,  // 893: header.TaskMgr.UpdateTask:output_type -> header.Task
	51,  // 894: header.TaskMgr.DeleteTask:output_type -> header.Empty
	269, // 895: header.TaskMgr.ListTasks:output_type -> header.Tasks
	51,  // 896: header.TaskMgr.SeenTask:output_type -> header.Empty
	51,  // 897: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	51,  // 898: header.TaskMgr.MuteTask:output_type -> header.Empty
	51,  // 899: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	39,  // 900: header.TaskMgr.AddTaskComment:output_type -> header.Event
	39,  // 901: header.TaskMgr.EditTaskComment:output_type -> header.Event
	39,  // 902: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	270, // 903: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	152, // 904: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	271, // 905: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	153, // 906: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	153, // 907: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	153, // 908: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	51,  // 909: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	51,  // 910: header.CampaignMgr.OnEvent:output_type -> header.Empty
	272, // 911: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	273, // 912: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	274, // 913: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	156, // 914: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	156, // 915: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	51,  // 916: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	275, // 917: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	156, // 918: header.CampaignMgr.FindNextCall:output_type -> header.OutboundCallEntry
	276, // 919: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	277, // 920: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	278, // 921: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	231, // 922: header.CreditMgr.ListCredits:output_type -> header.Response
	231, // 923: header.CreditMgr.AddCredit:output_type -> header.Response
	231, // 924: header.CreditMgr.DeleteCredit:output_type -> header.Response
	231, // 925: header.CreditMgr.UpdateCredit:output_type -> header.Response
	279, // 926: header.FormMgr.ListForms:output_type -> header.Forms
	162, // 927: header.FormMgr.CreateForm:output_type -> header.Form
	162, // 928: header.FormMgr.UpdateForm:output_type -> header.Form
	51,  // 929: header.FormMgr.DeleteForm:output_type -> header.Empty
	280, // 930: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	281, // 931: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	165, // 932: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	231, // 933: header.Scheduler.UnregisterTask:output_type -> header.Response
