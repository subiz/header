...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x84, 0x0f, 0x0a, 0x0f, 0x43, 0x6f,
	...
	0x32, 0x3e, 0x0a, 0x08, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x32, 0x0a, 0x09,
	0x53, 0x68, 0x61, 0x72, 0x64, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x16, 0x2e, 0x68, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x32, 0xc4, 0x02, 0x0a, 0x0e, 0x46, 0x61, 0x62, 0x69, 0x6b, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	...
	0x73, 0x12, 0x34, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x6f,
	...
	0x65, 0x72, 0x73, 0x32, 0x84, 0x14, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2f,
	...
	0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x46, 0x65, 0x65, 0x64, 0x73, 0x12, 0x0b,
...
var file_service_proto_depIdxs = []int32{
	...
	55,  // 152: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	55,  // 153: header.ConversationMgr.CreateRule:input_type -> header.Rule
	4,   // 154: header.ConversationMgr.DeleteRule:input_type -> header.Id
	4,   // 155: header.ConversationMgr.ReadRule:input_type -> header.Id
	4,   // 156: header.ConversationMgr.ListRules:input_type -> header.Id
	56,  // 157: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	56,  // 158: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 159: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 160: header.TemplateMgr.GetTemplate:input_type -> header.Id
	57,  // 161: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 162: header.TemplateMgr.PickTemplate:input_type -> header.Id
	58,  // 163: header.TagMgr.CreateTag:input_type -> header.Tag
	58,  // 164: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 165: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 166: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 167: header.TagMgr.GetTag:input_type -> header.Id
	59,  // 168: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	60,  // 169: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	61,  // 170: header.FileMgr.Presign:input_type -> header.FileHeader
	62,  // 171: header.FileMgr.Uploaded:input_type -> header.FileRequest
	63,  // 172: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 173: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	64,  // 174: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	65,  // 175: header.Noti5Service.Noti:input_type -> header.PushNoti
	66,  // 176: header.Noti5Service.AddToken:input_type -> noti5.Token
	66,  // 177: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	66,  // 178: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	67,  // 179: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	68,  // 180: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	69,  // 181: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	69,  // 182: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 183: header.PaymentMgr.GetSubscription:input_type -> header.Id
	70,  // 184: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	70,  // 185: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	4,   // 186: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	4,   // 187: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	71,  // 188: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	72,  // 189: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	72,  // 190: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	73,  // 191: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	69,  // 192: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	74,  // 193: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	75,  // 194: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	76,  // 195: header.PaymentMgr.AddComment:input_type -> payment.Comment
	41,  // 196: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 197: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	72,  // 198: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	77,  // 199: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	71,  // 200: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	78,  // 201: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	79,  // 202: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	80,  // 203: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	81,  // 204: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	81,  // 205: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	82,  // 206: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 207: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	83,  // 208: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 209: header.PaymentMgr.GetReferral:input_type -> header.Id
	41,  // 210: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	84,  // 211: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	4,   // 212: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	4,   // 213: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	4,   // 214: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	85,  // 215: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	86,  // 216: header.Pubsub.Publish:input_type -> header.PublishMessage
	86,  // 217: header.Realtime.ShardSend:input_type -> header.PublishMessage
	4,   // 218: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	87,  // 219: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	4,   // 220: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	4,   // 221: header.FabikonService.ListFbPosts:input_type -> header.Id
	88,  // 222: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	4,   // 223: header.WidgetService.Read:input_type -> header.Id
	89,  // 224: header.WidgetService.Update:input_type -> header.WidgetSetting
	4,   // 225: header.WidgetService.ReadUserSetting:input_type -> header.Id
	4,   // 226: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	90,  // 227: header.WidgetService.SubmitImpression:input_type -> header.Impression
	91,  // 228: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	92,  // 229: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	93,  // 230: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	94,  // 231: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	94,  // 232: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	95,  // 233: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 234: header.WidgetService.ListUploadedImage:input_type -> header.Id
	95,  // 235: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 236: header.WidgetService.ListWebPlugins:input_type -> header.Id
	96,  // 237: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	96,  // 238: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	96,  // 239: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 240: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	96,  // 241: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	4,   // 242: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	4,   // 243: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	97,  // 244: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	4,   // 245: header.WidgetService.SearchImages:input_type -> header.Id
	4,   // 246: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	4,   // 247: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	4,   // 248: header.Bizbot.ListBots:input_type -> header.Id
	4,   // 249: header.Bizbot.GetBot:input_type -> header.Id
	98,  // 250: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	98,  // 251: header.Bizbot.CreateBot:input_type -> header.Bot
	98,  // 252: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 253: header.Bizbot.DeleteBot:input_type -> header.Id
	99,  // 254: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	99,  // 255: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	99,  // 256: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	99,  // 257: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	100, // 258: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	101, // 259: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	102, // 260: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	103, // 261: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	104, // 262: header.Sendback.CreateWebhook:input_type -> header.Webhook
	4,   // 263: header.Sendback.PingWebhook:input_type -> header.Id
	4,   // 264: header.Sendback.DeleteWebhook:input_type -> header.Id
	4,   // 265: header.Sendback.ListWebhooks:input_type -> header.Id
	4,   // 266: header.Sendback.ReadWebhook:input_type -> header.Id
	104, // 267: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 268: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	105, // 269: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	106, // 270: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	45,  // 271: header.Sendback.SendWebhookEvent:input_type -> header.Event
	107, // 272: header.Notibox.Send:input_type -> header.Notification
	4,   // 273: header.Notibox.MarkRead:input_type -> header.Id
	108, // 274: header.Notibox.MarkReadCompactedNoti:input_type -> header.CompactedNotiRequest
	109, // 275: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	107, // 276: header.Notibox.SendNoti:input_type -> header.Notification
	109, // 277: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 278: header.Notibox.MarkReadNoti:input_type -> header.Id
	110, // 279: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 280: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 281: header.Watchhttp.ListWebpages:input_type -> header.Id
	110, // 282: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 283: header.Watchhttp.ReadWebpage:input_type -> header.Id
	111, // 284: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	112, // 285: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	113, // 286: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	113, // 287: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 288: header.Holap.AppendAgentSet:input_type -> account.Agent
	58,  // 289: header.Holap.AppendTagSet:input_type -> header.Tag
	28,  // 290: header.Holap.UpdateUser:input_type -> header.User
	50,  // 291: header.Holap.UpdateConversation:input_type -> header.Conversation
	45,  // 292: header.Holap.OnConversationEvent:input_type -> header.Event
	114, // 293: header.Holap.FreeAccount:input_type -> header.AccountImage
	115, // 294: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	116, // 295: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	115, // 296: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	116, // 297: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	117, // 298: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 299: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	29,  // 300: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 301: header.Holap.UpdateOrder:input_type -> header.Order
	118, // 302: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	119, // 303: header.Proder.ReadProduct:input_type -> header.Product
	119, // 304: header.Proder.CreateProduct:input_type -> header.Product
	119, // 305: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 306: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 307: header.Proder.RestoreProduct:input_type -> header.Id
	120, // 308: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 309: header.Proder.ListProductIds:input_type -> header.Ids
	120, // 310: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	121, // 311: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 312: header.Proder.ListProductCollections:input_type -> header.Ids
	122, // 313: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	122, // 314: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 315: header.Proder.DeleteProductCollection:input_type -> header.Id
	5,   // 316: header.Proder.ListProductFeeds:input_type -> header.Ids
	123, // 317: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	123, // 318: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 319: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 320: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 321: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 322: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 323: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 324: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 325: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 326: header.Proder.RestoreOrder:input_type -> header.Id
	124, // 327: header.Proder.ListOrders:input_type -> header.OrdersRequest
	124, // 328: header.Proder.CountOrders:input_type -> header.OrdersRequest
	125, // 329: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	126, // 330: header.Proder.MakeOrderPayment:input_type -> header.Bill
	127, // 331: header.Proder.DeleteOrderPayment:input_type -> header.Key
	45,  // 332: header.Proder.AddOrderComment:input_type -> header.Event
	45,  // 333: header.Proder.EditOrderComment:input_type -> header.Event
	127, // 334: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 335: header.Proder.ListOrderEvents:input_type -> header.Id
	128, // 336: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 337: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	129, // 338: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 339: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	130, // 340: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	131, // 341: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	132, // 342: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	133, // 343: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 344: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 345: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 346: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 347: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 348: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 349: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 350: header.Apiece.ReadTask:input_type -> header.Id
	134, // 351: header.Apiece.CreateTask:input_type -> header.Task
	134, // 352: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 353: header.Apiece.DeleteTask:input_type -> header.Id
	135, // 354: header.Apiece.ListTasks:input_type -> header.TasksRequest
	45,  // 355: header.Apiece.AddTaskComment:input_type -> header.Event
	45,  // 356: header.Apiece.EditTaskComment:input_type -> header.Event
	127, // 357: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 358: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 359: header.Apiece.ReadPipeline:input_type -> header.Id
	136, // 360: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	136, // 361: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 362: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 363: header.Apiece.ListPipelines:input_type -> header.Ids
	137, // 364: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	41,  // 365: header.Search.Index:output_type -> header.Empty
	138, // 366: header.Search.Search:output_type -> header.DocSearchResponse
	41,  // 367: header.Search.AddOwner:output_type -> header.Empty
	139, // 368: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 369: header.Map.LookupAddress:output_type -> header.Address
	140, // 370: header.Map.PredictAddress:output_type -> header.Addresses
	140, // 371: header.Map.ListDistricts:output_type -> header.Addresses
	140, // 372: header.Map.ListProvinces:output_type -> header.Addresses
	140, // 373: header.Map.ListWards:output_type -> header.Addresses
	140, // 374: header.Map.ListStreets:output_type -> header.Addresses
	140, // 375: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 376: header.Map.ReadAddress:output_type -> header.Address
	6,   // 377: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 378: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 379: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	41,  // 380: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 381: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 382: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 383: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	41,  // 384: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 385: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 386: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 387: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 388: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 389: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 390: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 391: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 392: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 393: header.AccountMgr.CreateAccount:output_type -> account.Account
	141, // 394: header.AccountMgr.ListAgents:output_type -> account.Agents
	41,  // 395: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	142, // 396: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	41,  // 397: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	41,  // 398: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 399: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	143, // 400: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 401: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 402: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	144, // 403: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	144, // 404: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	41,  // 405: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 406: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	145, // 407: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 408: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 409: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	146, // 410: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 411: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 412: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	147, // 413: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	41,  // 414: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	140, // 415: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 416: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 417: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	41,  // 418: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	148, // 419: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 420: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 421: header.AccountMgr.UpdateTax:output_type -> header.Tax
	41,  // 422: header.AccountMgr.DeleteTax:output_type -> header.Empty
	149, // 423: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	149, // 424: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 425: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 426: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	41,  // 427: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	41,  // 428: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	150, // 429: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 430: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 431: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	41,  // 432: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	41,  // 433: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	151, // 434: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	41,  // 435: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 436: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 437: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 438: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	152, // 439: header.UserMgr.SearchUsers:output_type -> header.Users
	27,  // 440: header.UserMgr.MergeUser:output_type -> header.UserAlias
	4,   // 441: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 442: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	4,   // 443: header.UserMgr.UpdateUser:output_type -> header.Id
	28,  // 444: header.UserMgr.ReadUser:output_type -> header.User
	153, // 445: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	152, // 446: header.UserMgr.MatchUsers:output_type -> header.Users
	30,  // 447: header.UserMgr.UpdateView:output_type -> header.UserView
	30,  // 448: header.UserMgr.CreateView:output_type -> header.UserView
	41,  // 449: header.UserMgr.DeleteView:output_type -> header.Empty
	30,  // 450: header.UserMgr.GetView:output_type -> header.UserView
	154, // 451: header.UserMgr.ListViews:output_type -> header.UserViews
	31,  // 452: header.UserMgr.UpsertLabel:output_type -> header.Label
	41,  // 453: header.UserMgr.DeleteLabel:output_type -> header.Empty
	155, // 454: header.UserMgr.ListLabels:output_type -> header.Labels
	31,  // 455: header.UserMgr.GetLabel:output_type -> header.Label
	41,  // 456: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	41,  // 457: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	41,  // 458: header.UserMgr.AddUserLabel:output_type -> header.Empty
	41,  // 459: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	20,  // 460: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	20,  // 461: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	41,  // 462: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	28,  // 463: header.UserMgr.ListShippingAddress:output_type -> header.User
	41,  // 464: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	152, // 465: header.UserMgr.ListLeads:output_type -> header.Users
	156, // 466: header.LiveMgr.SearchLocations:output_type -> header.Locations
	152, // 467: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	88,  // 468: header.LiveMgr.TopEvents:output_type -> header.Events
	157, // 469: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	158, // 470: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	159, // 471: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	160, // 472: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	161, // 473: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	162, // 474: header.NoteMgr.ListNotes:output_type -> header.Notes
	38,  // 475: header.NoteMgr.AddNote:output_type -> header.Note
	38,  // 476: header.NoteMgr.UpdateNote:output_type -> header.Note
	41,  // 477: header.NoteMgr.DeleteNote:output_type -> header.Empty
	163, // 478: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	40,  // 479: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	41,  // 480: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	40,  // 481: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	164, // 482: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	42,  // 483: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	42,  // 484: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	165, // 485: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	166, // 486: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	45,  // 487: header.ConversationMgr.PongMessage:output_type -> header.Event
	50,  // 488: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	50,  // 489: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	50,  // 490: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	167, // 491: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	167, // 492: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	41,  // 493: header.ConversationMgr.TagConversation:output_type -> header.Empty
	41,  // 494: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	41,  // 495: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	41,  // 496: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	41,  // 497: header.ConversationMgr.Typing:output_type -> header.Empty
	50,  // 498: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	167, // 499: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	41,  // 500: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	41,  // 501: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	41,  // 502: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	41,  // 503: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	51,  // 504: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	51,  // 505: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	45,  // 506: header.ConversationMgr.TerminateBot:output_type -> header.Event
	168, // 507: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	45,  // 508: header.ConversationMgr.SendMessage:output_type -> header.Event
	45,  // 509: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	41,  // 510: header.ConversationMgr.PinMessage:output_type -> header.Empty
	41,  // 511: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	88,  // 512: header.ConversationMgr.ListEvents:output_type -> header.Events
	41,  // 513: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	169, // 514: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	54,  // 515: header.ConversationMgr.Integrate:output_type -> header.Integration
	55,  // 516: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	55,  // 517: header.ConversationMgr.CreateRule:output_type -> header.Rule
	41,  // 518: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	55,  // 519: header.ConversationMgr.ReadRule:output_type -> header.Rule
	170, // 520: header.ConversationMgr.ListRules:output_type -> header.Route
	56,  // 521: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	56,  // 522: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	41,  // 523: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	56,  // 524: header.TemplateMgr.GetTemplate:output_type -> header.Template
	171, // 525: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	41,  // 526: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	58,  // 527: header.TagMgr.CreateTag:output_type -> header.Tag
	58,  // 528: header.TagMgr.UpdateTag:output_type -> header.Tag
	41,  // 529: header.TagMgr.DeleteTag:output_type -> header.Empty
	172, // 530: header.TagMgr.ListTags:output_type -> header.Tags
	58,  // 531: header.TagMgr.GetTag:output_type -> header.Tag
	88,  // 532: header.EventMgr.SearchEvents:output_type -> header.Events
	45,  // 533: header.EventMgr.CreateEvent:output_type -> header.Event
	173, // 534: header.FileMgr.Presign:output_type -> header.PresignResult
	174, // 535: header.FileMgr.Uploaded:output_type -> header.File
	174, // 536: header.FileMgr.DownloadFileUrl:output_type -> header.File
	64,  // 537: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	64,  // 538: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	41,  // 539: header.Noti5Service.Noti:output_type -> header.Empty
	41,  // 540: header.Noti5Service.AddToken:output_type -> header.Empty
	41,  // 541: header.Noti5Service.RemoveToken:output_type -> header.Empty
	41,  // 542: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	67,  // 543: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	175, // 544: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	72,  // 545: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	69,  // 546: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	69,  // 547: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	70,  // 548: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	70,  // 549: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	41,  // 550: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	176, // 551: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	67,  // 552: header.PaymentMgr.Pay:output_type -> payment.Bill
	72,  // 553: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	72,  // 554: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	177, // 555: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	72,  // 556: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	72,  // 557: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	178, // 558: header.PaymentMgr.ListComments:output_type -> payment.Comments
	76,  // 559: header.PaymentMgr.AddComment:output_type -> payment.Comment
	179, // 560: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	80,  // 561: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	80,  // 562: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	77,  // 563: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	67,  // 564: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	180, // 565: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	79,  // 566: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	79,  // 567: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	41,  // 568: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	79,  // 569: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	181, // 570: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	41,  // 571: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	84,  // 572: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	84,  // 573: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	182, // 574: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	84,  // 575: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	183, // 576: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	184, // 577: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	185, // 578: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	41,  // 579: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	41,  // 580: header.Pubsub.Publish:output_type -> header.Empty
	41,  // 581: header.Realtime.ShardSend:output_type -> header.Empty
	87,  // 582: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	87,  // 583: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	186, // 584: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	187, // 585: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	41,  // 586: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	89,  // 587: header.WidgetService.Read:output_type -> header.WidgetSetting
	89,  // 588: header.WidgetService.Update:output_type -> header.WidgetSetting
	188, // 589: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	189, // 590: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	90,  // 591: header.WidgetService.SubmitImpression:output_type -> header.Impression
	91,  // 592: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	92,  // 593: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	190, // 594: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	191, // 595: header.WidgetService.ListConversions:output_type -> header.Conversions
	192, // 596: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	95,  // 597: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	193, // 598: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	41,  // 599: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	194, // 600: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	96,  // 601: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	96,  // 602: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	96,  // 603: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	41,  // 604: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	96,  // 605: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	194, // 606: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	41,  // 607: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	195, // 608: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	193, // 609: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	196, // 610: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	197, // 611: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	198, // 612: header.Bizbot.ListBots:output_type -> header.Bots
	98,  // 613: header.Bizbot.GetBot:output_type -> header.Bot
	98,  // 614: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	98,  // 615: header.Bizbot.CreateBot:output_type -> header.Bot
	98,  // 616: header.Bizbot.UpdateBot:output_type -> header.Bot
	41,  // 617: header.Bizbot.DeleteBot:output_type -> header.Empty
	41,  // 618: header.Bizbot.OnEvent:output_type -> header.Empty
	41,  // 619: header.Bizbot.StartBot:output_type -> header.Empty
	41,  // 620: header.Bizbot.StopBot:output_type -> header.Empty
	41,  // 621: header.Bizbot.TryAction:output_type -> header.Empty
	199, // 622: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	200, // 623: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	201, // 624: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	202, // 625: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	104, // 626: header.Sendback.CreateWebhook:output_type -> header.Webhook
	203, // 627: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	41,  // 628: header.Sendback.DeleteWebhook:output_type -> header.Empty
	204, // 629: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	104, // 630: header.Sendback.ReadWebhook:output_type -> header.Webhook
	104, // 631: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	104, // 632: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	205, // 633: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	206, // 634: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	41,  // 635: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	41,  // 636: header.Notibox.Send:output_type -> header.Empty
	41,  // 637: header.Notibox.MarkRead:output_type -> header.Empty
	41,  // 638: header.Notibox.MarkReadCompactedNoti:output_type -> header.Empty
	207, // 639: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	41,  // 640: header.Notibox.SendNoti:output_type -> header.Empty
	208, // 641: header.Notibox.ListNoties:output_type -> header.Notifications
	41,  // 642: header.Notibox.MarkReadNoti:output_type -> header.Empty
	110, // 643: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	41,  // 644: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	209, // 645: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	110, // 646: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	110, // 647: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	210, // 648: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	211, // 649: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	212, // 650: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	210, // 651: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	41,  // 652: header.Holap.AppendAgentSet:output_type -> header.Empty
	41,  // 653: header.Holap.AppendTagSet:output_type -> header.Empty
	41,  // 654: header.Holap.UpdateUser:output_type -> header.Empty
	41,  // 655: header.Holap.UpdateConversation:output_type -> header.Empty
	41,  // 656: header.Holap.OnConversationEvent:output_type -> header.Empty
	41,  // 657: header.Holap.FreeAccount:output_type -> header.Empty
	213, // 658: header.Holap.ReportUser:output_type -> header.UserMetrics
	214, // 659: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 660: header.Holap.ListUserIds:output_type -> header.Ids
	167, // 661: header.Holap.ListConversationIds:output_type -> header.Conversations
	215, // 662: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 663: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	153, // 664: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	41,  // 665: header.Holap.UpdateOrder:output_type -> header.Empty
	216, // 666: header.Holap.ReportOrder:output_type -> header.Orders
	119, // 667: header.Proder.ReadProduct:output_type -> header.Product
	119, // 668: header.Proder.CreateProduct:output_type -> header.Product
	119, // 669: header.Proder.UpdateProduct:output_type -> header.Product
	41,  // 670: header.Proder.DeleteProduct:output_type -> header.Empty
	119, // 671: header.Proder.RestoreProduct:output_type -> header.Product
	121, // 672: header.Proder.ListProducts:output_type -> header.Products
	5,   // 673: header.Proder.ListProductIds:output_type -> header.Ids
	121, // 674: header.Proder.ListGroupedProducts:output_type -> header.Products
	121, // 675: header.Proder.ImportProducts:output_type -> header.Products
	217, // 676: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	122, // 677: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	122, // 678: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	41,  // 679: header.Proder.DeleteProductCollection:output_type -> header.Empty
	218, // 680: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	123, // 681: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	123, // 682: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	41,  // 683: header.Proder.DeleteProductFeed:output_type -> header.Empty
	219, // 684: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	220, // 685: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 686: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 687: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 688: header.Proder.UpdateOrder:output_type -> header.Order
	41,  // 689: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 690: header.Proder.RestoreOrder:output_type -> header.Order
	216, // 691: header.Proder.ListOrders:output_type -> header.Orders
	216, // 692: header.Proder.CountOrders:output_type -> header.Orders
	41,  // 693: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	45,  // 694: header.Proder.MakeOrderPayment:output_type -> header.Event
	45,  // 695: header.Proder.DeleteOrderPayment:output_type -> header.Event
	45,  // 696: header.Proder.AddOrderComment:output_type -> header.Event
	45,  // 697: header.Proder.EditOrderComment:output_type -> header.Event
	45,  // 698: header.Proder.DeleteOrderComment:output_type -> header.Event
	221, // 699: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	174, // 700: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 701: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	222, // 702: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	41,  // 703: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	223, // 704: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	41,  // 705: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	41,  // 706: header.Proder.GHNShippingStatus:output_type -> header.Empty
	133, // 707: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 708: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 709: header.Proder.CancelShippingOrder:output_type -> header.Order
	174, // 710: header.Proder.PrintShippingOrders:output_type -> header.File
	41,  // 711: header.Proder.SeenOrder:output_type -> header.Empty
	41,  // 712: header.Proder.FollowOrder:output_type -> header.Empty
	41,  // 713: header.Proder.UnfollowOrder:output_type -> header.Empty
	134, // 714: header.Apiece.ReadTask:output_type -> header.Task
	134, // 715: header.Apiece.CreateTask:output_type -> header.Task
	134, // 716: header.Apiece.UpdateTask:output_type -> header.Task
	41,  // 717: header.Apiece.DeleteTask:output_type -> header.Empty
	224, // 718: header.Apiece.ListTasks:output_type -> header.Tasks
	45,  // 719: header.Apiece.AddTaskComment:output_type -> header.Event
	45,  // 720: header.Apiece.EditTaskComment:output_type -> header.Event
	45,  // 721: header.Apiece.DeleteTaskComment:output_type -> header.Event
	225, // 722: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	136, // 723: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	136, // 724: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	136, // 725: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	41,  // 726: header.Apiece.DeletePipeline:output_type -> header.Empty
	226, // 727: header.Apiece.ListPipelines:output_type -> header.Pipelines
	364, // [364:728] is the sub-list for method output_type
	0,   // [0:364] is the sub-list for method input_type
