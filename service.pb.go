...
var file_service_proto_rawDesc = []byte{
	...
	0x2e, 0x57, 0x65, 0x62, 0x70, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0xbf,
...
var file_service_proto_depIdxs = []int32{
	...
	35,  // 336: header.Proder.ReadProduct:input_type -> header.Product
	35,  // 337: header.Proder.CreateProduct:input_type -> header.Product
	35,  // 338: header.Proder.UpdateProduct:input_type -> header.Product
	...
	21,  // 356: header.Proder.CreateOrder:input_type -> header.Order
	21,  // 357: header.Proder.UpdateOrder:input_type -> header.Order
	...
	37,  // 365: header.Proder.AddOrderComment:input_type -> header.Event
	37,  // 366: header.Proder.EditOrderComment:input_type -> header.Event
	...
	37,  // 388: header.Apiece.AddTaskComment:input_type -> header.Event
	37,  // 389: header.Apiece.EditTaskComment:input_type -> header.Event
	...
	46,  // 399: header.Search.Index:output_type -> header.Empty
	149, // 400: header.Search.Search:output_type -> header.DocSearchResponse
	46,  // 401: header.Search.AddOwner:output_type -> header.Empty
	150, // 402: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 403: header.Map.LookupAddress:output_type -> header.Address
	...
	19,  // 410: header.Map.ReadAddress:output_type -> header.Address
	...
	46,  // 414: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	46,  // 418: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	46,  // 429: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	...
	154, // 432: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 433: header.AccountMgr.TransferOwner:output_type -> account.Agent
	14,  // 434: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	155, // 435: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	155, // 436: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	46,  // 437: header.AccountMgr.LogoutSession:output_type -> header.Empty
	14,  // 438: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	156, // 439: header.AccountMgr.GetLanguage:output_type -> header.Lang
	15,  // 440: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	16,  // 441: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	157, // 442: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	18,  // 443: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	18,  // 444: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	158, // 445: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	46,  // 446: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	151, // 447: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	19,  // 448: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	19,  // 449: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	46,  // 450: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	159, // 451: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	20,  // 452: header.AccountMgr.CreateTax:output_type -> header.Tax
	20,  // 453: header.AccountMgr.UpdateTax:output_type -> header.Tax
	46,  // 454: header.AccountMgr.DeleteTax:output_type -> header.Empty
	160, // 455: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	160, // 456: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	22,  // 457: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	22,  // 458: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	46,  // 459: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	23,  // 460: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	161, // 461: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	23,  // 462: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	46,  // 463: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	162, // 464: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	24,  // 465: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	24,  // 466: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	46,  // 467: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	46,  // 468: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	163, // 469: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	46,  // 470: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	25,  // 471: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	25,  // 472: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	25,  // 473: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	164, // 474: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	26,  // 475: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	46,  // 476: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	27,  // 477: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	165, // 478: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	30,  // 479: header.UserMgr.MergeUser2:output_type -> header.User
	...
	30,  // 484: header.UserMgr.ReadUser:output_type -> header.User
	30,  // 485: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	166, // 486: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	29,  // 487: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 488: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 489: header.UserMgr.CreateView:output_type -> header.UserView
	46,  // 490: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 491: header.UserMgr.GetView:output_type -> header.UserView
	167, // 492: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 493: header.UserMgr.UpsertLabel:output_type -> header.Label
	46,  // 494: header.UserMgr.DeleteLabel:output_type -> header.Empty
	168, // 495: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 496: header.UserMgr.GetLabel:output_type -> header.Label
	46,  // 497: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	46,  // 498: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	46,  // 499: header.UserMgr.AddUserLabel:output_type -> header.Empty
	46,  // 500: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	19,  // 501: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	19,  // 502: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	46,  // 503: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	169, // 504: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	46,  // 505: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	29,  // 506: header.UserMgr.ListLeads:output_type -> header.Users
	29,  // 507: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	29,  // 508: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	35,  // 509: header.UserMgr.LinkProductUrl:output_type -> header.Product
	99,  // 510: header.UserMgr.ListUserEvents:output_type -> header.Events
	37,  // 511: header.UserMgr.CreateUserEvent:output_type -> header.Event
	38,  // 512: header.UserMgr.FillDevice:output_type -> common.Device
	170, // 513: header.LiveMgr.SearchLocations:output_type -> header.Locations
	29,  // 514: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	99,  // 515: header.LiveMgr.TopEvents:output_type -> header.Events
	171, // 516: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	172, // 517: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	173, // 518: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	174, // 519: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	175, // 520: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	176, // 521: header.NoteMgr.ListNotes:output_type -> header.Notes
	44,  // 522: header.NoteMgr.AddNote:output_type -> header.Note
	44,  // 523: header.NoteMgr.UpdateNote:output_type -> header.Note
	46,  // 524: header.NoteMgr.DeleteNote:output_type -> header.Empty
	177, // 525: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	47,  // 526: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	47,  // 527: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	178, // 528: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	37,  // 529: header.ConversationMgr.PongMessage:output_type -> header.Event
	53,  // 530: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	53,  // 531: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	53,  // 532: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	179, // 533: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	179, // 534: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	46,  // 535: header.ConversationMgr.TagConversation:output_type -> header.Empty
	46,  // 536: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	46,  // 537: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	46,  // 538: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	46,  // 539: header.ConversationMgr.Typing:output_type -> header.Empty
	53,  // 540: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	179, // 541: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	46,  // 542: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	46,  // 543: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	46,  // 544: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	46,  // 545: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	55,  // 546: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	55,  // 547: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	37,  // 548: header.ConversationMgr.TerminateBot:output_type -> header.Event
	37,  // 549: header.ConversationMgr.SendMessage:output_type -> header.Event
	37,  // 550: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	46,  // 551: header.ConversationMgr.PinMessage:output_type -> header.Empty
	46,  // 552: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	99,  // 553: header.ConversationMgr.ListEvents:output_type -> header.Events
	46,  // 554: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	180, // 555: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	58,  // 556: header.ConversationMgr.Integrate:output_type -> header.Integration
	58,  // 557: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	59,  // 558: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	59,  // 559: header.ConversationMgr.CreateRule:output_type -> header.Rule
	46,  // 560: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	59,  // 561: header.ConversationMgr.ReadRule:output_type -> header.Rule
	181, // 562: header.ConversationMgr.ListRules:output_type -> header.Route
	182, // 563: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	60,  // 564: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	46,  // 565: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	60,  // 566: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	183, // 567: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	61,  // 568: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	61,  // 569: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	46,  // 570: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	61,  // 571: header.ConversationMgr.ReadPhoneDevice:output_type -> header.PhoneDevice
	184, // 572: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	62,  // 573: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	63,  // 574: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	185, // 575: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	46,  // 576: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	186, // 577: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	64,  // 578: header.ConversationMgr.CreateGreetingAudio:output_type -> header.GreetingAudio
	53,  // 579: header.ConversationMgr.OriginateCall:output_type -> header.Conversation
	65,  // 580: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	65,  // 581: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	46,  // 582: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	65,  // 583: header.TemplateMgr.GetTemplate:output_type -> header.Template
	187, // 584: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	46,  // 585: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	67,  // 586: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	67,  // 587: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	46,  // 588: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	67,  // 589: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	188, // 590: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	189, // 591: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	69,  // 592: header.TagMgr.CreateTag:output_type -> header.Tag
	69,  // 593: header.TagMgr.UpdateTag:output_type -> header.Tag
	46,  // 594: header.TagMgr.DeleteTag:output_type -> header.Empty
	190, // 595: header.TagMgr.ListTags:output_type -> header.Tags
	69,  // 596: header.TagMgr.GetTag:output_type -> header.Tag
	99,  // 597: header.EventMgr.SearchEvents:output_type -> header.Events
	37,  // 598: header.EventMgr.CreateEvent:output_type -> header.Event
	191, // 599: header.FileMgr.Presign:output_type -> header.PresignResult
	192, // 600: header.FileMgr.Uploaded:output_type -> header.File
	192, // 601: header.FileMgr.DownloadFileUrl:output_type -> header.File
	74,  // 602: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	74,  // 603: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	46,  // 604: header.Noti5Service.Noti:output_type -> header.Empty
	46,  // 605: header.Noti5Service.AddToken:output_type -> header.Empty
	46,  // 606: header.Noti5Service.RemoveToken:output_type -> header.Empty
	46,  // 607: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	77,  // 608: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	193, // 609: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	82,  // 610: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	79,  // 611: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	79,  // 612: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	80,  // 613: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	80,  // 614: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	46,  // 615: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	194, // 616: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	77,  // 617: header.PaymentMgr.Pay:output_type -> payment.Bill
	82,  // 618: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	82,  // 619: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	195, // 620: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	82,  // 621: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	82,  // 622: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	196, // 623: header.PaymentMgr.ListComments:output_type -> payment.Comments
	86,  // 624: header.PaymentMgr.AddComment:output_type -> payment.Comment
	197, // 625: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	90,  // 626: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	90,  // 627: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	87,  // 628: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	77,  // 629: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	198, // 630: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	89,  // 631: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	89,  // 632: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	46,  // 633: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	89,  // 634: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	199, // 635: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	46,  // 636: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	94,  // 637: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	94,  // 638: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	200, // 639: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	94,  // 640: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	201, // 641: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	202, // 642: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	203, // 643: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	46,  // 644: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	46,  // 645: header.Pubsub.Publish:output_type -> header.Empty
	97,  // 646: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	97,  // 647: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	204, // 648: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	205, // 649: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	98,  // 650: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	46,  // 651: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	46,  // 652: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	46,  // 653: header.MailkonService.SendEvent:output_type -> header.Empty
	46,  // 654: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	46,  // 655: header.MailkonService.BlockEmail:output_type -> header.Empty
	46,  // 656: header.MailkonService.UnblockEmail:output_type -> header.Empty
	100, // 657: header.WidgetService.Read:output_type -> header.WidgetSetting
	100, // 658: header.WidgetService.Update:output_type -> header.WidgetSetting
	206, // 659: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	207, // 660: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	101, // 661: header.WidgetService.SubmitImpression:output_type -> header.Impression
	102, // 662: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	103, // 663: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	208, // 664: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	209, // 665: header.WidgetService.ListConversions:output_type -> header.Conversions
	210, // 666: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	106, // 667: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	211, // 668: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	46,  // 669: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	212, // 670: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	107, // 671: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	107, // 672: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	107, // 673: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	46,  // 674: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	107, // 675: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	212, // 676: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	46,  // 677: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	213, // 678: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	211, // 679: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	214, // 680: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	215, // 681: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	216, // 682: header.Bizbot.ListBots:output_type -> header.Bots
	109, // 683: header.Bizbot.GetBot:output_type -> header.Bot
	109, // 684: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	109, // 685: header.Bizbot.CreateBot:output_type -> header.Bot
	109, // 686: header.Bizbot.UpdateBot:output_type -> header.Bot
	46,  // 687: header.Bizbot.DeleteBot:output_type -> header.Empty
	46,  // 688: header.Bizbot.OnEvent:output_type -> header.Empty
	46,  // 689: header.Bizbot.StartBot:output_type -> header.Empty
	46,  // 690: header.Bizbot.StopBot:output_type -> header.Empty
	46,  // 691: header.Bizbot.TryAction:output_type -> header.Empty
	217, // 692: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	218, // 693: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	219, // 694: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	220, // 695: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	115, // 696: header.Sendback.CreateWebhook:output_type -> header.Webhook
	221, // 697: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	46,  // 698: header.Sendback.DeleteWebhook:output_type -> header.Empty
	222, // 699: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	115, // 700: header.Sendback.ReadWebhook:output_type -> header.Webhook
	115, // 701: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	115, // 702: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	223, // 703: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	224, // 704: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	46,  // 705: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	46,  // 706: header.Notibox.SendNoti:output_type -> header.Empty
	225, // 707: header.Notibox.ListNoties:output_type -> header.Notifications
	46,  // 708: header.Notibox.MarkReadNoti:output_type -> header.Empty
	120, // 709: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	46,  // 710: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	226, // 711: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	120, // 712: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	120, // 713: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	227, // 714: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	228, // 715: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	229, // 716: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	227, // 717: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	46,  // 718: header.Holap.AppendAgentSet:output_type -> header.Empty
	46,  // 719: header.Holap.AppendTagSet:output_type -> header.Empty
	46,  // 720: header.Holap.UpdateUser:output_type -> header.Empty
	46,  // 721: header.Holap.UpdateConversation:output_type -> header.Empty
	46,  // 722: header.Holap.OnConversationEvent:output_type -> header.Empty
	46,  // 723: header.Holap.FreeAccount:output_type -> header.Empty
	230, // 724: header.Holap.ReportUser:output_type -> header.UserMetrics
	231, // 725: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 726: header.Holap.ListUserIds:output_type -> header.Ids
	179, // 727: header.Holap.ListConversationIds:output_type -> header.Conversations
	232, // 728: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 729: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	166, // 730: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	46,  // 731: header.Holap.UpdateOrder:output_type -> header.Empty
	233, // 732: header.Holap.ReportOrder:output_type -> header.Orders
	234, // 733: header.Holap.ReportCall:output_type -> header.CallMetrics
	35,  // 734: header.Proder.ReadProduct:output_type -> header.Product
	35,  // 735: header.Proder.CreateProduct:output_type -> header.Product
	35,  // 736: header.Proder.UpdateProduct:output_type -> header.Product
	46,  // 737: header.Proder.DeleteProduct:output_type -> header.Empty
	35,  // 738: header.Proder.RestoreProduct:output_type -> header.Product
	...
	235, // 743: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	...
	46,  // 746: header.Proder.DeleteProductCollection:output_type -> header.Empty
	236, // 747: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	...
	46,  // 750: header.Proder.DeleteProductFeed:output_type -> header.Empty
	237, // 751: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	238, // 752: header.Proder.ListProductProps:output_type -> header.ProductProps
	21,  // 753: header.Proder.ReadOrder:output_type -> header.Order
	21,  // 754: header.Proder.CreateOrder:output_type -> header.Order
	21,  // 755: header.Proder.UpdateOrder:output_type -> header.Order
	46,  // 756: header.Proder.DeleteOrder:output_type -> header.Empty
	21,  // 757: header.Proder.RestoreOrder:output_type -> header.Order
	233, // 758: header.Proder.ListOrders:output_type -> header.Orders
	233, // 759: header.Proder.CountOrders:output_type -> header.Orders
	46,  // 760: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	37,  // 761: header.Proder.MakeOrderPayment:output_type -> header.Event
	37,  // 762: header.Proder.DeleteOrderPayment:output_type -> header.Event
	37,  // 763: header.Proder.AddOrderComment:output_type -> header.Event
	37,  // 764: header.Proder.EditOrderComment:output_type -> header.Event
	37,  // 765: header.Proder.DeleteOrderComment:output_type -> header.Event
	239, // 766: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	192, // 767: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 768: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	240, // 769: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	46,  // 770: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	241, // 771: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	46,  // 772: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	46,  // 773: header.Proder.GHNShippingStatus:output_type -> header.Empty
	143, // 774: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 775: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 776: header.Proder.CancelShippingOrder:output_type -> header.Order
	192, // 777: header.Proder.PrintShippingOrders:output_type -> header.File
	46,  // 778: header.Proder.SeenOrder:output_type -> header.Empty
	46,  // 779: header.Proder.FollowOrder:output_type -> header.Empty
	46,  // 780: header.Proder.UnfollowOrder:output_type -> header.Empty
	...
	46,  // 784: header.Apiece.DeleteTask:output_type -> header.Empty
	242, // 785: header.Apiece.ListTasks:output_type -> header.Tasks
	37,  // 786: header.Apiece.AddTaskComment:output_type -> header.Event
	37,  // 787: header.Apiece.EditTaskComment:output_type -> header.Event
	37,  // 788: header.Apiece.DeleteTaskComment:output_type -> header.Event
	243, // 789: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	...
	46,  // 793: header.Apiece.DeletePipeline:output_type -> header.Empty
	244, // 794: header.Apiece.ListPipelines:output_type -> header.Pipelines
