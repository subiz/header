...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb7, 0x11, 0x0a, 0x0f,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xab, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61,
	...
	0x57, 0x65, 0x62, 0x70, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0x80, 0x07,
	...
	0x32, 0x83, 0x14, 0x0a, 0x06, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x0b, 0x52,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a, 0x10, 0x4d,
	...
	0x61, 0x64, 0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xa3, 0x05, 0x0a, 0x06, 0x41, 0x70, 0x69, 0x65, 0x63,
	...
	0x2e, 0x54, 0x61, 0x73, 0x6b, 0x73, 0x12, 0x2e, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x54, 0x61, 0x73,
	...
	0x65, 0x72, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x42, 0x19, 0x5a, 0x17,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Template)(nil),                          // 62: header.Template
	(*SearchTemplate)(nil),                    // 63: header.SearchTemplate
	(*ConversationModal)(nil),                 // 64: header.ConversationModal
	(*ConversationModalPickRequest)(nil),      // 65: header.ConversationModalPickRequest
	(*Tag)(nil),                               // 66: header.Tag
	(*UserEvent)(nil),                         // 67: header.UserEvent
	(*FileHeader)(nil),                        // 68: header.FileHeader
	(*FileRequest)(nil),                       // 69: header.FileRequest
	(*FileUrlDownloadRequest)(nil),            // 70: header.FileUrlDownloadRequest
	(*noti5.Setting)(nil),                     // 71: noti5.Setting
	(*PushNoti)(nil),                          // 72: header.PushNoti
	(*noti5.Token)(nil),                       // 73: noti5.Token
	(*payment.Bill)(nil),                      // 74: payment.Bill
	(*account.SearchSubRequest)(nil),          // 75: account.SearchSubRequest
	(*payment.Subscription)(nil),              // 76: payment.Subscription
	(*payment.PaymentMethod)(nil),             // 77: payment.PaymentMethod
	(*payment.PayRequest)(nil),                // 78: payment.PayRequest
	(*payment.Invoice)(nil),                   // 79: payment.Invoice
	(*payment.ListInvoiceRequest)(nil),        // 80: payment.ListInvoiceRequest
	(*payment.DiffSubRequest)(nil),            // 81: payment.DiffSubRequest
	(*payment.ListCommentsRequest)(nil),       // 82: payment.ListCommentsRequest
	(*payment.Comment)(nil),                   // 83: payment.Comment
	(*ExchangeRate)(nil),                      // 84: header.ExchangeRate
	(*payment.ListLogsRequest)(nil),           // 85: payment.ListLogsRequest
	(*payment.PromotionCode)(nil),             // 86: payment.PromotionCode
	(*payment.String)(nil),                    // 87: payment.String
	(*payment.PromotionCodeRequest)(nil),      // 88: payment.PromotionCodeRequest
	(*payment.ListPromotionCodeRequest)(nil),  // 89: payment.ListPromotionCodeRequest
	(*payment.SearchReferredRequest)(nil),     // 90: payment.SearchReferredRequest
	(*payment.Referral)(nil),                  // 91: payment.Referral
	(*payment.LogPaidForAgentReferrer)(nil),   // 92: payment.LogPaidForAgentReferrer
	(*PublishMessage)(nil),                    // 93: header.PublishMessage
	(*FbFanpageSetting)(nil),                  // 94: header.FbFanpageSetting
	(*FacebookPost)(nil),                      // 95: header.FacebookPost
	(*Events)(nil),                            // 96: header.Events
	(*WidgetSetting)(nil),                     // 97: header.WidgetSetting
	(*Impression)(nil),                        // 98: header.Impression
	(*Conversion)(nil),                        // 99: header.Conversion
	(*UserCampaignStatus)(nil),                // 100: header.UserCampaignStatus
	(*ReportCampaignRequest)(nil),             // 101: header.ReportCampaignRequest
	(*ConversionRequest)(nil),                 // 102: header.ConversionRequest
	(*UploadedImage)(nil),                     // 103: header.UploadedImage
	(*WebPlugin)(nil),                         // 104: header.WebPlugin
	(*ReportWebPluginRequest)(nil),            // 105: header.ReportWebPluginRequest
	(*Bot)(nil),                               // 106: header.Bot
	(*BotRunRequest)(nil),                     // 107: header.BotRunRequest
	(*BotrunMetricsRequest)(nil),              // 108: header.BotrunMetricsRequest
	(*ActionrunMetricsRequest)(nil),           // 109: header.ActionrunMetricsRequest
	(*ListObjectsRequest)(nil),                // 110: header.ListObjectsRequest
	(*ReportBotRequest)(nil),                  // 111: header.ReportBotRequest
	(*Webhook)(nil),                           // 112: header.Webhook
	(*RecentIndexDeliveryRequest)(nil),        // 113: header.RecentIndexDeliveryRequest
	(*DeliveryRequest)(nil),                   // 114: header.DeliveryRequest
	(*Notification)(nil),                      // 115: header.Notification
	(*ListNotiRequest)(nil),                   // 116: header.ListNotiRequest
	(*Webpage)(nil),                           // 117: header.Webpage
	(*RecentWebpageCheckRequest)(nil),         // 118: header.RecentWebpageCheckRequest
	(*WebpageCheckRequest)(nil),               // 119: header.WebpageCheckRequest
	(*WebpageReportRequest)(nil),              // 120: header.WebpageReportRequest
	(*AccountImage)(nil),                      // 121: header.AccountImage
	(*UserMetricsRequest)(nil),                // 122: header.UserMetricsRequest
	(*ConversationMetricsRequest)(nil),        // 123: header.ConversationMetricsRequest
	(*AgentMetricsRequest)(nil),               // 124: header.AgentMetricsRequest
	(*OrderMetricsRequest)(nil),               // 125: header.OrderMetricsRequest
	...
	(*Task)(nil),                              // 140: header.Task
	(*TasksRequest)(nil),                      // 141: header.TasksRequest
	(*Pipeline)(nil),                          // 142: header.Pipeline
	(*RateLimitSyncResponse)(nil),             // 143: header.RateLimitSyncResponse
	(*DocSearchResponse)(nil),                 // 144: header.DocSearchResponse
	(*AddressAutocompleteResponses)(nil),      // 145: header.AddressAutocompleteResponses
	(*Addresses)(nil),                         // 146: header.Addresses
	(*account.Agents)(nil),                    // 147: account.Agents
	(*AgentGroups)(nil),                       // 148: header.AgentGroups
	(*account.BusinessHours)(nil),             // 149: account.BusinessHours
	(*LoginSessions)(nil),                     // 150: header.LoginSessions
	(*Lang)(nil),                              // 151: header.Lang
	(*ListChangelogsResponse)(nil),            // 152: header.ListChangelogsResponse
	(*Currency)(nil),                          // 153: header.Currency
	(*Taxes)(nil),                             // 154: header.Taxes
	(*ShippingPolicies)(nil),                  // 155: header.ShippingPolicies
	(*CancellationCodes)(nil),                 // 156: header.CancellationCodes
	(*PaymentMethods)(nil),                    // 157: header.PaymentMethods
	(*IntegratedShippings)(nil),               // 158: header.IntegratedShippings
	(*EmailBlocks)(nil),                       // 159: header.EmailBlocks
	(*ReportResponse)(nil),                    // 160: header.ReportResponse
	(*UserEventMetrics)(nil),                  // 161: header.UserEventMetrics
	(*UserViews)(nil),                         // 162: header.UserViews
	(*Labels)(nil),                            // 163: header.Labels
	(*ShippingAddresses)(nil),                 // 164: header.ShippingAddresses
	(*Locations)(nil),                         // 165: header.Locations
	(*LocationMetrics)(nil),                   // 166: header.LocationMetrics
	(*PageMetrics)(nil),                       // 167: header.PageMetrics
	(*SourceMetrics)(nil),                     // 168: header.SourceMetrics
	(*UserMetric)(nil),                        // 169: header.UserMetric
	(*PresencesResponse)(nil),                 // 170: header.PresencesResponse
	(*Notes)(nil),                             // 171: header.Notes
	(*AttributeDefinitions)(nil),              // 172: header.AttributeDefinitions
	(*RouteResult)(nil),                       // 173: header.RouteResult
	(*Conversations)(nil),                     // 174: header.Conversations
	(*Integrations)(nil),                      // 175: header.Integrations
	(*Route)(nil),                             // 176: header.Route
	(*ConversationAutomations)(nil),           // 177: header.ConversationAutomations
	(*Templates)(nil),                         // 178: header.Templates
	(*ConversationModals)(nil),                // 179: header.ConversationModals
	(*ConversationModalPicked)(nil),           // 180: header.ConversationModalPicked
	(*Tags)(nil),                              // 181: header.Tags
	(*PresignResult)(nil),                     // 182: header.PresignResult
	(*File)(nil),                              // 183: header.File
	(*account.AccSubs)(nil),                   // 184: account.AccSubs
	(*payment.PaymentMethods)(nil),            // 185: payment.PaymentMethods
	(*payment.Invoices)(nil),                  // 186: payment.Invoices
	(*payment.Comments)(nil),                  // 187: payment.Comments
	(*payment.Plans)(nil),                     // 188: payment.Plans
	(*payment.Logs)(nil),                      // 189: payment.Logs
	(*payment.PromotionCodes)(nil),            // 190: payment.PromotionCodes
	(*payment.ReferralResponse)(nil),          // 191: payment.ReferralResponse
	(*payment.LogAccountReferreds)(nil),       // 192: payment.LogAccountReferreds
	(*payment.LogBillByAccountReferreds)(nil), // 193: payment.LogBillByAccountReferreds
	(*payment.LogPaidForAgentReferrers)(nil),  // 194: payment.LogPaidForAgentReferrers
	(*FbFanpageSettings)(nil),                 // 195: header.FbFanpageSettings
	(*FacebookPosts)(nil),                     // 196: header.FacebookPosts
	(*WidgetUserSetting)(nil),                 // 197: header.WidgetUserSetting
	(*AccountWeb)(nil),                        // 198: header.AccountWeb
	(*ReportCampaignResponse)(nil),            // 199: header.ReportCampaignResponse
	(*Conversions)(nil),                       // 200: header.Conversions
	(*ConversionsExported)(nil),               // 201: header.ConversionsExported
	(*UploadedImages)(nil),                    // 202: header.UploadedImages
	(*WebPlugins)(nil),                        // 203: header.WebPlugins
	(*ReportWebPluginResponse)(nil),           // 204: header.ReportWebPluginResponse
	(*NotifProfiles)(nil),                     // 205: header.NotifProfiles
	(*Urls)(nil),                              // 206: header.Urls
	(*Bots)(nil),                              // 207: header.Bots
	(*BotrunMetrics)(nil),                     // 208: header.BotrunMetrics
	(*ActionrunMetrics)(nil),                  // 209: header.ActionrunMetrics
	(*ListObjectsResponse)(nil),               // 210: header.ListObjectsResponse
	(*ReportBotResponse)(nil),                 // 211: header.ReportBotResponse
	(*WebhookTestResult)(nil),                 // 212: header.WebhookTestResult
	(*Webhooks)(nil),                          // 213: header.Webhooks
	(*WebhookDeliveries)(nil),                 // 214: header.WebhookDeliveries
	(*WebhookDelivery)(nil),                   // 215: header.WebhookDelivery
	(*Notifications)(nil),                     // 216: header.Notifications
	(*Webpages)(nil),                          // 217: header.Webpages
	(*WebpageChecks)(nil),                     // 218: header.WebpageChecks
	(*WebpageCheck)(nil),                      // 219: header.WebpageCheck
	(*WebpageReportDataSet)(nil),              // 220: header.WebpageReportDataSet
	(*UserMetrics)(nil),                       // 221: header.UserMetrics
	(*ConversationMetrics)(nil),               // 222: header.ConversationMetrics
	(*AgentMetrics)(nil),                      // 223: header.AgentMetrics
	(*Orders)(nil),                            // 224: header.Orders
	(*ProductCollections)(nil),                // 225: header.ProductCollections
	(*ProductFeeds)(nil),                      // 226: header.ProductFeeds
	(*ProductCategories)(nil),                 // 227: header.ProductCategories
	(*ProductProps)(nil),                      // 228: header.ProductProps
	(*OrderHistoryEntries)(nil),               // 229: header.OrderHistoryEntries
	(*ShopeeShop)(nil),                        // 230: header.ShopeeShop
	(*ShopeeSyncProductResponse)(nil),         // 231: header.ShopeeSyncProductResponse
	(*Tasks)(nil),                             // 232: header.Tasks
	(*TaskHistoryEntries)(nil),                // 233: header.TaskHistoryEntries
	(*Pipelines)(nil),                         // 234: header.Pipelines
}
var file_service_proto_depIdxs = []int32{
	...
	62,  // 171: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	62,  // 172: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 173: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 174: header.TemplateMgr.GetTemplate:input_type -> header.Id
	63,  // 175: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 176: header.TemplateMgr.PickTemplate:input_type -> header.Id
	64,  // 177: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	64,  // 178: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	4,   // 179: header.TemplateMgr.DeleteModal:input_type -> header.Id
	4,   // 180: header.TemplateMgr.GetModal:input_type -> header.Id
	4,   // 181: header.TemplateMgr.ListModals:input_type -> header.Id
	65,  // 182: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	66,  // 183: header.TagMgr.CreateTag:input_type -> header.Tag
	66,  // 184: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 185: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 186: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 187: header.TagMgr.GetTag:input_type -> header.Id
	37,  // 188: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	67,  // 189: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	68,  // 190: header.FileMgr.Presign:input_type -> header.FileHeader
	69,  // 191: header.FileMgr.Uploaded:input_type -> header.FileRequest
	70,  // 192: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 193: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	71,  // 194: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	72,  // 195: header.Noti5Service.Noti:input_type -> header.PushNoti
	73,  // 196: header.Noti5Service.AddToken:input_type -> noti5.Token
	73,  // 197: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	73,  // 198: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	74,  // 199: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	75,  // 200: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	76,  // 201: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	76,  // 202: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 203: header.PaymentMgr.GetSubscription:input_type -> header.Id
	77,  // 204: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	77,  // 205: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	4,   // 206: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	4,   // 207: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	78,  // 208: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	79,  // 209: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	79,  // 210: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	80,  // 211: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	76,  // 212: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	81,  // 213: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	82,  // 214: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	83,  // 215: header.PaymentMgr.AddComment:input_type -> payment.Comment
	47,  // 216: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 217: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	79,  // 218: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	84,  // 219: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	78,  // 220: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	85,  // 221: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	86,  // 222: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	87,  // 223: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	88,  // 224: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	88,  // 225: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	89,  // 226: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 227: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	90,  // 228: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 229: header.PaymentMgr.GetReferral:input_type -> header.Id
	47,  // 230: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	91,  // 231: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	4,   // 232: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	4,   // 233: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	4,   // 234: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	92,  // 235: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	93,  // 236: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 237: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	94,  // 238: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	4,   // 239: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	4,   // 240: header.FabikonService.ListFbPosts:input_type -> header.Id
	95,  // 241: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	96,  // 242: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	96,  // 243: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	96,  // 244: header.MailkonService.SendEvent:input_type -> header.Events
	4,   // 245: header.MailkonService.ListBlockedEmails:input_type -> header.Id
	4,   // 246: header.MailkonService.BlockEmail:input_type -> header.Id
	4,   // 247: header.MailkonService.UnblockEmail:input_type -> header.Id
	4,   // 248: header.WidgetService.Read:input_type -> header.Id
	97,  // 249: header.WidgetService.Update:input_type -> header.WidgetSetting
	4,   // 250: header.WidgetService.ReadUserSetting:input_type -> header.Id
	4,   // 251: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	98,  // 252: header.WidgetService.SubmitImpression:input_type -> header.Impression
	99,  // 253: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	100, // 254: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	101, // 255: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	102, // 256: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	102, // 257: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	103, // 258: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 259: header.WidgetService.ListUploadedImage:input_type -> header.Id
	103, // 260: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 261: header.WidgetService.ListWebPlugins:input_type -> header.Id
	104, // 262: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	104, // 263: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	104, // 264: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 265: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	104, // 266: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	4,   // 267: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	4,   // 268: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	105, // 269: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	4,   // 270: header.WidgetService.SearchImages:input_type -> header.Id
	4,   // 271: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	4,   // 272: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	4,   // 273: header.Bizbot.ListBots:input_type -> header.Id
	4,   // 274: header.Bizbot.GetBot:input_type -> header.Id
	106, // 275: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	106, // 276: header.Bizbot.CreateBot:input_type -> header.Bot
	106, // 277: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 278: header.Bizbot.DeleteBot:input_type -> header.Id
	107, // 279: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	107, // 280: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	107, // 281: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	107, // 282: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	108, // 283: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	109, // 284: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	110, // 285: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	111, // 286: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	112, // 287: header.Sendback.CreateWebhook:input_type -> header.Webhook
	4,   // 288: header.Sendback.PingWebhook:input_type -> header.Id
	4,   // 289: header.Sendback.DeleteWebhook:input_type -> header.Id
	4,   // 290: header.Sendback.ListWebhooks:input_type -> header.Id
	4,   // 291: header.Sendback.ReadWebhook:input_type -> header.Id
	112, // 292: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 293: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	113, // 294: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	114, // 295: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	38,  // 296: header.Sendback.SendWebhookEvent:input_type -> header.Event
	115, // 297: header.Notibox.SendNoti:input_type -> header.Notification
	116, // 298: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 299: header.Notibox.MarkReadNoti:input_type -> header.Id
	117, // 300: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 301: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 302: header.Watchhttp.ListWebpages:input_type -> header.Id
	117, // 303: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 304: header.Watchhttp.ReadWebpage:input_type -> header.Id
	118, // 305: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	119, // 306: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	120, // 307: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	120, // 308: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 309: header.Holap.AppendAgentSet:input_type -> account.Agent
	66,  // 310: header.Holap.AppendTagSet:input_type -> header.Tag
	31,  // 311: header.Holap.UpdateUser:input_type -> header.User
	54,  // 312: header.Holap.UpdateConversation:input_type -> header.Conversation
	38,  // 313: header.Holap.OnConversationEvent:input_type -> header.Event
	121, // 314: header.Holap.FreeAccount:input_type -> header.AccountImage
	122, // 315: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	123, // 316: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	122, // 317: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	123, // 318: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	124, // 319: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 320: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	32,  // 321: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 322: header.Holap.UpdateOrder:input_type -> header.Order
	125, // 323: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	36,  // 324: header.Proder.ReadProduct:input_type -> header.Product
	36,  // 325: header.Proder.CreateProduct:input_type -> header.Product
	36,  // 326: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 327: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 328: header.Proder.RestoreProduct:input_type -> header.Id
	126, // 329: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 330: header.Proder.ListProductIds:input_type -> header.Ids
	126, // 331: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	127, // 332: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 333: header.Proder.ListProductCollections:input_type -> header.Ids
	128, // 334: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	128, // 335: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 336: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 337: header.Proder.ListProductFeeds:input_type -> header.Id
	129, // 338: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	129, // 339: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 340: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 341: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 342: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 343: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 344: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 345: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 346: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 347: header.Proder.RestoreOrder:input_type -> header.Id
	130, // 348: header.Proder.ListOrders:input_type -> header.OrdersRequest
	130, // 349: header.Proder.CountOrders:input_type -> header.OrdersRequest
	131, // 350: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	132, // 351: header.Proder.MakeOrderPayment:input_type -> header.Bill
	133, // 352: header.Proder.DeleteOrderPayment:input_type -> header.Key
	38,  // 353: header.Proder.AddOrderComment:input_type -> header.Event
	38,  // 354: header.Proder.EditOrderComment:input_type -> header.Event
	133, // 355: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 356: header.Proder.ListOrderEvents:input_type -> header.Id
	134, // 357: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 358: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	135, // 359: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 360: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	136, // 361: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	137, // 362: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	138, // 363: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	139, // 364: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 365: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 366: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 367: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 368: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 369: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 370: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 371: header.Apiece.ReadTask:input_type -> header.Id
	140, // 372: header.Apiece.CreateTask:input_type -> header.Task
	140, // 373: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 374: header.Apiece.DeleteTask:input_type -> header.Id
	141, // 375: header.Apiece.ListTasks:input_type -> header.TasksRequest
	38,  // 376: header.Apiece.AddTaskComment:input_type -> header.Event
	38,  // 377: header.Apiece.EditTaskComment:input_type -> header.Event
	...
	142, // 381: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	142, // 382: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 383: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 384: header.Apiece.ListPipelines:input_type -> header.Ids
	143, // 385: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	47,  // 386: header.Search.Index:output_type -> header.Empty
	144, // 387: header.Search.Search:output_type -> header.DocSearchResponse
	47,  // 388: header.Search.AddOwner:output_type -> header.Empty
	145, // 389: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 390: header.Map.LookupAddress:output_type -> header.Address
	146, // 391: header.Map.PredictAddress:output_type -> header.Addresses
	146, // 392: header.Map.ListDistricts:output_type -> header.Addresses
	146, // 393: header.Map.ListProvinces:output_type -> header.Addresses
	146, // 394: header.Map.ListWards:output_type -> header.Addresses
	146, // 395: header.Map.ListStreets:output_type -> header.Addresses
	146, // 396: header.Map.ListAddresses:output_type -> header.Addresses
	...
	47,  // 401: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	47,  // 405: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	147, // 415: header.AccountMgr.ListAgents:output_type -> account.Agents
	47,  // 416: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	148, // 417: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	47,  // 418: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	47,  // 419: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 420: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	149, // 421: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	150, // 424: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	150, // 425: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	47,  // 426: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 427: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	151, // 428: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	152, // 431: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	153, // 434: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	47,  // 435: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	146, // 436: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	47,  // 439: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	154, // 440: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 441: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 442: header.AccountMgr.UpdateTax:output_type -> header.Tax
	47,  // 443: header.AccountMgr.DeleteTax:output_type -> header.Empty
	155, // 444: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	155, // 445: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	47,  // 448: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 449: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	156, // 450: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 451: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	47,  // 452: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	157, // 453: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	47,  // 456: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	47,  // 457: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	158, // 458: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	47,  // 459: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	...
	159, // 463: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 464: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	47,  // 465: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	28,  // 466: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	160, // 467: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	31,  // 468: header.UserMgr.MergeUser2:output_type -> header.User
	4,   // 469: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 470: header.UserMgr.CreateUserFromWeb:output_type -> header.Id
	4,   // 471: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	4,   // 472: header.UserMgr.UpdateUser:output_type -> header.Id
	31,  // 473: header.UserMgr.ReadUser:output_type -> header.User
	31,  // 474: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	161, // 475: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	30,  // 476: header.UserMgr.MatchUsers:output_type -> header.Users
	33,  // 477: header.UserMgr.UpdateView:output_type -> header.UserView
	33,  // 478: header.UserMgr.CreateView:output_type -> header.UserView
	47,  // 479: header.UserMgr.DeleteView:output_type -> header.Empty
	33,  // 480: header.UserMgr.GetView:output_type -> header.UserView
	162, // 481: header.UserMgr.ListViews:output_type -> header.UserViews
	34,  // 482: header.UserMgr.UpsertLabel:output_type -> header.Label
	47,  // 483: header.UserMgr.DeleteLabel:output_type -> header.Empty
	163, // 484: header.UserMgr.ListLabels:output_type -> header.Labels
	34,  // 485: header.UserMgr.GetLabel:output_type -> header.Label
	47,  // 486: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	47,  // 487: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	47,  // 488: header.UserMgr.AddUserLabel:output_type -> header.Empty
	47,  // 489: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	20,  // 490: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	20,  // 491: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	47,  // 492: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	164, // 493: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	47,  // 494: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	30,  // 495: header.UserMgr.ListLeads:output_type -> header.Users
	30,  // 496: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	30,  // 497: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	36,  // 498: header.UserMgr.LinkProductUrl:output_type -> header.Product
	96,  // 499: header.UserMgr.ListUserEvents:output_type -> header.Events
	38,  // 500: header.UserMgr.CreateUserEvent:output_type -> header.Event
	39,  // 501: header.UserMgr.FillDevice:output_type -> common.Device
	165, // 502: header.LiveMgr.SearchLocations:output_type -> header.Locations
	30,  // 503: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	96,  // 504: header.LiveMgr.TopEvents:output_type -> header.Events
	166, // 505: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	167, // 506: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	168, // 507: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	169, // 508: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	170, // 509: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	171, // 510: header.NoteMgr.ListNotes:output_type -> header.Notes
	45,  // 511: header.NoteMgr.AddNote:output_type -> header.Note
	45,  // 512: header.NoteMgr.UpdateNote:output_type -> header.Note
	47,  // 513: header.NoteMgr.DeleteNote:output_type -> header.Empty
	172, // 514: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	48,  // 515: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	48,  // 516: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	173, // 517: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 518: header.ConversationMgr.PongMessage:output_type -> header.Event
	54,  // 519: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	54,  // 520: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	54,  // 521: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	174, // 522: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	174, // 523: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	47,  // 524: header.ConversationMgr.TagConversation:output_type -> header.Empty
	47,  // 525: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	47,  // 526: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	47,  // 527: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	47,  // 528: header.ConversationMgr.Typing:output_type -> header.Empty
	54,  // 529: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	174, // 530: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	47,  // 531: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	47,  // 532: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	47,  // 533: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	47,  // 534: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	56,  // 535: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	56,  // 536: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 537: header.ConversationMgr.TerminateBot:output_type -> header.Event
	38,  // 538: header.ConversationMgr.SendMessage:output_type -> header.Event
	38,  // 539: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	47,  // 540: header.ConversationMgr.PinMessage:output_type -> header.Empty
	47,  // 541: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	96,  // 542: header.ConversationMgr.ListEvents:output_type -> header.Events
	47,  // 543: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	175, // 544: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	59,  // 545: header.ConversationMgr.Integrate:output_type -> header.Integration
	59,  // 546: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	60,  // 547: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	60,  // 548: header.ConversationMgr.CreateRule:output_type -> header.Rule
	47,  // 549: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	60,  // 550: header.ConversationMgr.ReadRule:output_type -> header.Rule
	176, // 551: header.ConversationMgr.ListRules:output_type -> header.Route
	177, // 552: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	61,  // 553: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	47,  // 554: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	61,  // 555: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	62,  // 556: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	62,  // 557: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	47,  // 558: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	62,  // 559: header.TemplateMgr.GetTemplate:output_type -> header.Template
	178, // 560: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	47,  // 561: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	64,  // 562: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	64,  // 563: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	47,  // 564: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	64,  // 565: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	179, // 566: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	180, // 567: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	66,  // 568: header.TagMgr.CreateTag:output_type -> header.Tag
	66,  // 569: header.TagMgr.UpdateTag:output_type -> header.Tag
	47,  // 570: header.TagMgr.DeleteTag:output_type -> header.Empty
	181, // 571: header.TagMgr.ListTags:output_type -> header.Tags
	66,  // 572: header.TagMgr.GetTag:output_type -> header.Tag
	96,  // 573: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 574: header.EventMgr.CreateEvent:output_type -> header.Event
	182, // 575: header.FileMgr.Presign:output_type -> header.PresignResult
	183, // 576: header.FileMgr.Uploaded:output_type -> header.File
	183, // 577: header.FileMgr.DownloadFileUrl:output_type -> header.File
	71,  // 578: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	71,  // 579: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	47,  // 580: header.Noti5Service.Noti:output_type -> header.Empty
	47,  // 581: header.Noti5Service.AddToken:output_type -> header.Empty
	47,  // 582: header.Noti5Service.RemoveToken:output_type -> header.Empty
	47,  // 583: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	74,  // 584: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	184, // 585: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	79,  // 586: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	76,  // 587: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	76,  // 588: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	77,  // 589: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	77,  // 590: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	47,  // 591: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	185, // 592: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	74,  // 593: header.PaymentMgr.Pay:output_type -> payment.Bill
	79,  // 594: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	79,  // 595: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	186, // 596: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	79,  // 597: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	79,  // 598: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	187, // 599: header.PaymentMgr.ListComments:output_type -> payment.Comments
	83,  // 600: header.PaymentMgr.AddComment:output_type -> payment.Comment
	188, // 601: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	87,  // 602: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	87,  // 603: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	84,  // 604: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	74,  // 605: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	189, // 606: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	86,  // 607: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	86,  // 608: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	47,  // 609: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	86,  // 610: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	190, // 611: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	47,  // 612: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	91,  // 613: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	91,  // 614: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	191, // 615: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	91,  // 616: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	192, // 617: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	193, // 618: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	194, // 619: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	47,  // 620: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	47,  // 621: header.Pubsub.Publish:output_type -> header.Empty
	94,  // 622: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	94,  // 623: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	195, // 624: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	196, // 625: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	95,  // 626: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	47,  // 627: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	47,  // 628: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	47,  // 629: header.MailkonService.SendEvent:output_type -> header.Empty
	47,  // 630: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	47,  // 631: header.MailkonService.BlockEmail:output_type -> header.Empty
	47,  // 632: header.MailkonService.UnblockEmail:output_type -> header.Empty
	97,  // 633: header.WidgetService.Read:output_type -> header.WidgetSetting
	97,  // 634: header.WidgetService.Update:output_type -> header.WidgetSetting
	197, // 635: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	198, // 636: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	98,  // 637: header.WidgetService.SubmitImpression:output_type -> header.Impression
	99,  // 638: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	100, // 639: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	199, // 640: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	200, // 641: header.WidgetService.ListConversions:output_type -> header.Conversions
	201, // 642: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	103, // 643: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	202, // 644: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	47,  // 645: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	203, // 646: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	104, // 647: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	104, // 648: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	104, // 649: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	47,  // 650: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	104, // 651: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	203, // 652: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	47,  // 653: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	204, // 654: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	202, // 655: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	205, // 656: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	206, // 657: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	207, // 658: header.Bizbot.ListBots:output_type -> header.Bots
	106, // 659: header.Bizbot.GetBot:output_type -> header.Bot
	106, // 660: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	106, // 661: header.Bizbot.CreateBot:output_type -> header.Bot
	106, // 662: header.Bizbot.UpdateBot:output_type -> header.Bot
	47,  // 663: header.Bizbot.DeleteBot:output_type -> header.Empty
	47,  // 664: header.Bizbot.OnEvent:output_type -> header.Empty
	47,  // 665: header.Bizbot.StartBot:output_type -> header.Empty
	47,  // 666: header.Bizbot.StopBot:output_type -> header.Empty
	47,  // 667: header.Bizbot.TryAction:output_type -> header.Empty
	208, // 668: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	209, // 669: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	210, // 670: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	211, // 671: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	112, // 672: header.Sendback.CreateWebhook:output_type -> header.Webhook
	212, // 673: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	47,  // 674: header.Sendback.DeleteWebhook:output_type -> header.Empty
	213, // 675: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	112, // 676: header.Sendback.ReadWebhook:output_type -> header.Webhook
	112, // 677: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	112, // 678: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	214, // 679: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	215, // 680: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	47,  // 681: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	47,  // 682: header.Notibox.SendNoti:output_type -> header.Empty
	216, // 683: header.Notibox.ListNoties:output_type -> header.Notifications
	47,  // 684: header.Notibox.MarkReadNoti:output_type -> header.Empty
	117, // 685: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	47,  // 686: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	217, // 687: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	117, // 688: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	117, // 689: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	218, // 690: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	219, // 691: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	220, // 692: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	218, // 693: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	47,  // 694: header.Holap.AppendAgentSet:output_type -> header.Empty
	47,  // 695: header.Holap.AppendTagSet:output_type -> header.Empty
	47,  // 696: header.Holap.UpdateUser:output_type -> header.Empty
	47,  // 697: header.Holap.UpdateConversation:output_type -> header.Empty
	47,  // 698: header.Holap.OnConversationEvent:output_type -> header.Empty
	47,  // 699: header.Holap.FreeAccount:output_type -> header.Empty
	221, // 700: header.Holap.ReportUser:output_type -> header.UserMetrics
	222, // 701: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 702: header.Holap.ListUserIds:output_type -> header.Ids
	174, // 703: header.Holap.ListConversationIds:output_type -> header.Conversations
	223, // 704: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 705: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	161, // 706: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	47,  // 707: header.Holap.UpdateOrder:output_type -> header.Empty
	224, // 708: header.Holap.ReportOrder:output_type -> header.Orders
	36,  // 709: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 710: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 711: header.Proder.UpdateProduct:output_type -> header.Product
	47,  // 712: header.Proder.DeleteProduct:output_type -> header.Empty
	36,  // 713: header.Proder.RestoreProduct:output_type -> header.Product
	127, // 714: header.Proder.ListProducts:output_type -> header.Products
	5,   // 715: header.Proder.ListProductIds:output_type -> header.Ids
	127, // 716: header.Proder.ListGroupedProducts:output_type -> header.Products
	127, // 717: header.Proder.ImportProducts:output_type -> header.Products
	225, // 718: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	128, // 719: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	128, // 720: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	47,  // 721: header.Proder.DeleteProductCollection:output_type -> header.Empty
	226, // 722: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	129, // 723: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	129, // 724: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	47,  // 725: header.Proder.DeleteProductFeed:output_type -> header.Empty
	227, // 726: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	228, // 727: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 728: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 729: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 730: header.Proder.UpdateOrder:output_type -> header.Order
	47,  // 731: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 732: header.Proder.RestoreOrder:output_type -> header.Order
	224, // 733: header.Proder.ListOrders:output_type -> header.Orders
	224, // 734: header.Proder.CountOrders:output_type -> header.Orders
	47,  // 735: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	38,  // 736: header.Proder.MakeOrderPayment:output_type -> header.Event
	38,  // 737: header.Proder.DeleteOrderPayment:output_type -> header.Event
	38,  // 738: header.Proder.AddOrderComment:output_type -> header.Event
	38,  // 739: header.Proder.EditOrderComment:output_type -> header.Event
	38,  // 740: header.Proder.DeleteOrderComment:output_type -> header.Event
	229, // 741: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	183, // 742: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 743: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	230, // 744: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	47,  // 745: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	231, // 746: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	47,  // 747: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	47,  // 748: header.Proder.GHNShippingStatus:output_type -> header.Empty
	139, // 749: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 750: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 751: header.Proder.CancelShippingOrder:output_type -> header.Order
	183, // 752: header.Proder.PrintShippingOrders:output_type -> header.File
	47,  // 753: header.Proder.SeenOrder:output_type -> header.Empty
	47,  // 754: header.Proder.FollowOrder:output_type -> header.Empty
	47,  // 755: header.Proder.UnfollowOrder:output_type -> header.Empty
	140, // 756: header.Apiece.ReadTask:output_type -> header.Task
	140, // 757: header.Apiece.CreateTask:output_type -> header.Task
	140, // 758: header.Apiece.UpdateTask:output_type -> header.Task
	47,  // 759: header.Apiece.DeleteTask:output_type -> header.Empty
	232, // 760: header.Apiece.ListTasks:output_type -> header.Tasks
	38,  // 761: header.Apiece.AddTaskComment:output_type -> header.Event
	38,  // 762: header.Apiece.EditTaskComment:output_type -> header.Event
	38,  // 763: header.Apiece.DeleteTaskComment:output_type -> header.Event
	233, // 764: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	142, // 765: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	142, // 766: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	142, // 767: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	47,  // 768: header.Apiece.DeletePipeline:output_type -> header.Empty
	234, // 769: header.Apiece.ListPipelines:output_type -> header.Pipelines
