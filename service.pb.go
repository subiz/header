...
var file_service_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xdc, 0x01, 0x0a, 0x06,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*api.Response)(nil),                            // 127: api.Response
	(*account.Agents)(nil),                          // 128: account.Agents
	(*account.Count)(nil),                           // 129: account.Count
	(*account.AgentGroups)(nil),                     // 130: account.AgentGroups
	(*account.BusinessHours)(nil),                   // 131: account.BusinessHours
	(*account.Currencies)(nil),                      // 132: account.Currencies
	(*account.ExchangeRates)(nil),                   // 133: account.ExchangeRates
	(*user.UserSearchResult)(nil),                   // 134: user.UserSearchResult
	(*user.LeadSearchResult)(nil),                   // 135: user.LeadSearchResult
	(*user.UserReportResult)(nil),                   // 136: user.UserReportResult
	(*user.CountTotalResponse)(nil),                 // 137: user.CountTotalResponse
	(*common.Pong)(nil),                             // 138: common.Pong
	(*user.SearchNoteResponse)(nil),                 // 139: user.SearchNoteResponse
	(*user.Users)(nil),                              // 140: user.Users
	(*user.Locations)(nil),                          // 141: user.Locations
	(*user.Events)(nil),                             // 142: user.Events
	(*user.LocationMetrics)(nil),                    // 143: user.LocationMetrics
	(*user.PageMetrics)(nil),                        // 144: user.PageMetrics
	(*user.SourceMetrics)(nil),                      // 145: user.SourceMetrics
	(*user.UserMetric)(nil),                         // 146: user.UserMetric
	(*user.PresencesResponse)(nil),                  // 147: user.PresencesResponse
	(*user.Notes)(nil),                              // 148: user.Notes
	(*user.Automations)(nil),                        // 149: user.Automations
	(*user.AttributeDefinitions)(nil),               // 150: user.AttributeDefinitions
	(*common.Permission)(nil),                       // 151: common.Permission
	(*conversation.CountByTagsResponse)(nil),        // 152: conversation.CountByTagsResponse
	(*conversation.AvgResponseTimeResponse)(nil),    // 153: conversation.AvgResponseTimeResponse
	(*conversation.TotalConversationResponse)(nil),  // 154: conversation.TotalConversationResponse
	(*conversation.ReportResponse)(nil),             // 155: conversation.ReportResponse
	(*account.Presence)(nil),                        // 156: account.Presence
	(*conversation.Route)(nil),                      // 157: conversation.Route
	(*conversation.Conversations)(nil),              // 158: conversation.Conversations
	(*conversation.FilterUserResponse)(nil),         // 159: conversation.FilterUserResponse
	(*conversation.SearchConversationResponse)(nil), // 160: conversation.SearchConversationResponse
	(*conversation.ConversationListResponse)(nil),   // 161: conversation.ConversationListResponse
	(*conversation.Templates)(nil),                  // 162: conversation.Templates
	(*conversation.Tags)(nil),                       // 163: conversation.Tags
	(*conversation.Integrations)(nil),               // 164: conversation.Integrations
	(*user.AvailabilityCheckResult)(nil),            // 165: user.AvailabilityCheckResult
	(*conversation.ESTickets)(nil),                  // 166: conversation.ESTickets
	(*conversation.ServiceLevelAgreements)(nil),     // 167: conversation.ServiceLevelAgreements
	(*conversation.CountTicketResponse)(nil),        // 168: conversation.CountTicketResponse
	(*conversation.AvgResolveTimeResponse)(nil),     // 169: conversation.AvgResolveTimeResponse
	(*client.AuthorizedClient)(nil),                 // 170: client.AuthorizedClient
	(*content.Contents)(nil),                        // 171: content.Contents
	(*deal.Pipelines)(nil),                          // 172: deal.Pipelines
	(*file.PresignResult)(nil),                      // 173: file.PresignResult
	(*file.File)(nil),                               // 174: file.File
	(*kv.Bool)(nil),                                 // 175: kv.Bool
	(*notibox.Notifications)(nil),                   // 176: notibox.Notifications
	(*notibox.Notibox)(nil),                         // 177: notibox.Notibox
	...
	(*widget.UserSetting)(nil),                      // 189: widget.UserSetting
	(*widget.Campaigns)(nil),                        // 190: widget.Campaigns
	(*widget.ReportCampaignResponse)(nil),           // 191: widget.ReportCampaignResponse
	(*widget.Conversions)(nil),                      // 192: widget.Conversions
	(*widget.ConversionsExported)(nil),              // 193: widget.ConversionsExported
	(*widget.UploadedImages)(nil),                   // 194: widget.UploadedImages
	(*client.Webhooks)(nil),                         // 195: client.Webhooks
	(*client.WebhookTestResult)(nil),                // 196: client.WebhookTestResult
	(*search.SearchUsersResponse)(nil),              // 197: search.SearchUsersResponse
	(*search.SearchNotesResponse)(nil),              // 198: search.SearchNotesResponse
	(*search.SearchConversationsResponse)(nil),      // 199: search.SearchConversationsResponse
	(*search.SearchTicketsResponse)(nil),            // 200: search.SearchTicketsResponse
	(*bqreport.ConversationReport)(nil),             // 201: bqreport.ConversationReport
	(*bqreport.ConversationRateReport)(nil),         // 202: bqreport.ConversationRateReport
	(*bqreport.ConversationTagReport)(nil),          // 203: bqreport.ConversationTagReport
	(*bqreport.ConversationAgentReport)(nil),        // 204: bqreport.ConversationAgentReport
	(*bqreport.MessageOfAgentReport)(nil),           // 205: bqreport.MessageOfAgentReport
	(*bqreport.AgentAvailabilityReport)(nil),        // 206: bqreport.AgentAvailabilityReport
	(*bot.Bots)(nil),                                // 207: bot.Bots
}
var file_service_proto_depIdxs = []int32{
	...
	127, // 265: header.ApiServer.Call:output_type -> api.Response
	1,   // 266: header.AccountMgr.CreateGroup:output_type -> account.AgentGroup
	1,   // 267: header.AccountMgr.UpdateGroup:output_type -> account.AgentGroup
	1,   // 268: header.AccountMgr.GetGroup:output_type -> account.AgentGroup
	12,  // 269: header.AccountMgr.RequestResetPassword:output_type -> common.Empty
	5,   // 270: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	5,   // 271: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	5,   // 272: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	12,  // 273: header.AccountMgr.RequestChangeEmail:output_type -> common.Empty
	5,   // 274: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	5,   // 275: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	5,   // 276: header.AccountMgr.GetInvitation:output_type -> account.Agent
	5,   // 277: header.AccountMgr.InviteAgent:output_type -> account.Agent
	5,   // 278: header.AccountMgr.GetAgent:output_type -> account.Agent
	7,   // 279: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	7,   // 280: header.AccountMgr.GetAccount:output_type -> account.Account
	7,   // 281: header.AccountMgr.UpdateAccount:output_type -> account.Account
	7,   // 282: header.AccountMgr.CreateAccount:output_type -> account.Account
	128, // 283: header.AccountMgr.ListAgents:output_type -> account.Agents
	129, // 284: header.AccountMgr.CountAccount:output_type -> account.Count
	12,  // 285: header.AccountMgr.DeleteGroup:output_type -> common.Empty
	130, // 286: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	12,  // 287: header.AccountMgr.AddAgentToGroup:output_type -> common.Empty
	12,  // 288: header.AccountMgr.RemoveAgentFromGroup:output_type -> common.Empty
	5,   // 289: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	5,   // 290: header.AccountMgr.IntegrateBot:output_type -> account.Agent
	131, // 291: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	5,   // 292: header.AccountMgr.TransferOwner:output_type -> account.Agent
	132, // 293: header.CurrencyMgr.ListCurrencies:output_type -> account.Currencies
	13,  // 294: header.CurrencyMgr.GetCurrency:output_type -> account.Currency
	13,  // 295: header.CurrencyMgr.CreateCurrency:output_type -> account.Currency
	13,  // 296: header.CurrencyMgr.UpdateCurrency:output_type -> account.Currency
	12,  // 297: header.CurrencyMgr.DeleteCurrency:output_type -> common.Empty
	133, // 298: header.CurrencyMgr.ListExchangeRates:output_type -> account.ExchangeRates
	15,  // 299: header.CurrencyMgr.GetExchangeRate:output_type -> account.ExchangeRate
	15,  // 300: header.CurrencyMgr.CreateExchangeRate:output_type -> account.ExchangeRate
	12,  // 301: header.CurrencyMgr.DeleteExchangeRate:output_type -> common.Empty
	134, // 302: header.UserMgr.SearchUsers:output_type -> user.UserSearchResult
	135, // 303: header.UserMgr.SearchLeads:output_type -> user.LeadSearchResult
	135, // 304: header.UserMgr.ListLeads:output_type -> user.LeadSearchResult
	2,   // 305: header.UserMgr.CreateUser:output_type -> common.Id
	2,   // 306: header.UserMgr.UpdateUser:output_type -> common.Id
	18,  // 307: header.UserMgr.ReadUser:output_type -> user.User
	136, // 308: header.UserMgr.ReportUsers:output_type -> user.UserReportResult
	137, // 309: header.UserMgr.CountTotal:output_type -> user.CountTotalResponse
	138, // 310: header.UserMgr.Ping:output_type -> common.Pong
	12,  // 311: header.UserMgr.ExportUsers:output_type -> common.Empty
	139, // 312: header.UserMgr.SearchNote:output_type -> user.SearchNoteResponse
	140, // 313: header.UserMgr.MatchUsers:output_type -> user.Users
	141, // 314: header.LiveMgr.SearchLocations:output_type -> user.Locations
	140, // 315: header.LiveMgr.FilterActiveUsers:output_type -> user.Users
	142, // 316: header.LiveMgr.TopEvents:output_type -> user.Events
	143, // 317: header.LiveMgr.TopLocations:output_type -> user.LocationMetrics
	144, // 318: header.LiveMgr.TopPages:output_type -> user.PageMetrics
	145, // 319: header.LiveMgr.TopSources:output_type -> user.SourceMetrics
	146, // 320: header.LiveMgr.CountActiveUsers:output_type -> user.UserMetric
	147, // 321: header.LiveMgr.Presences:output_type -> user.PresencesResponse
	12,  // 322: header.UserSyncMgr.CreateEvent:output_type -> common.Empty
	12,  // 323: header.UserSyncMgr.FireBlockUser:output_type -> common.Empty
	12,  // 324: header.UserSyncMgr.FireUpdateUserAttribute:output_type -> common.Empty
	12,  // 325: header.UserSyncMgr.FireAddUserNote:output_type -> common.Empty
	12,  // 326: header.UserSyncMgr.CallbackAutomation:output_type -> common.Empty
	12,  // 327: header.UserSyncMgr.ExportUsers:output_type -> common.Empty
	32,  // 328: header.AutomationCreditMgr.GetAutomationCredit:output_type -> user.AutomationCredit
	12,  // 329: header.AutomationCreditMgr.AddAutomationCredit:output_type -> common.Empty
	148, // 330: header.NoteMgr.ListNotes:output_type -> user.Notes
	34,  // 331: header.NoteMgr.AddNote:output_type -> user.Note
	34,  // 332: header.NoteMgr.UpdateNote:output_type -> user.Note
	12,  // 333: header.NoteMgr.DeleteNote:output_type -> common.Empty
	34,  // 334: header.NoteMgr.GetNote:output_type -> user.Note
	139, // 335: header.NoteMgr.SearchNote:output_type -> user.SearchNoteResponse
	149, // 336: header.AutomationMgr.ListAutomations:output_type -> user.Automations
	37,  // 337: header.AutomationMgr.UpdateAutomation:output_type -> user.Automation
	12,  // 338: header.AutomationMgr.DeleteAutomation:output_type -> common.Empty
	37,  // 339: header.AutomationMgr.ReadAutomation:output_type -> user.Automation
	37,  // 340: header.AutomationMgr.CreateAutomation:output_type -> user.Automation
	150, // 341: header.AttributeMgr.ListAttributeDefinitions:output_type -> user.AttributeDefinitions
	38,  // 342: header.AttributeMgr.CreateAttributeDefinition:output_type -> user.AttributeDefinition
	38,  // 343: header.AttributeMgr.UpdateAttributeDefinition:output_type -> user.AttributeDefinition
	12,  // 344: header.AttributeMgr.DeleteAttributeDefinition:output_type -> common.Empty
	12,  // 345: header.Perm.Update:output_type -> common.Empty
	12,  // 346: header.Perm.UpdateState:output_type -> common.Empty
	151, // 347: header.Perm.ReadPerm:output_type -> common.Permission
	152, // 348: header.ConversationReporter.CountConversationsByTags:output_type -> conversation.CountByTagsResponse
	153, // 349: header.ConversationReporter.GetAvgResponseTimes:output_type -> conversation.AvgResponseTimeResponse
	154, // 350: header.ConversationReporter.GetTotalConversation:output_type -> conversation.TotalConversationResponse
	155, // 351: header.ConversationReporter.ReportConversations:output_type -> conversation.ReportResponse
	155, // 352: header.ConversationReporter.ReportConversations2:output_type -> conversation.ReportResponse
	155, // 353: header.ConversationReporter.ReportAvailibilities:output_type -> conversation.ReportResponse
	156, // 354: header.AgentPresenceMgr.ReadPresence:output_type -> account.Presence
	156, // 355: header.AgentPresenceMgr.UpdatePresence:output_type -> account.Presence
	48,  // 356: header.RuleMgr.UpdateRule:output_type -> conversation.Rule
	48,  // 357: header.RuleMgr.CreateRule:output_type -> conversation.Rule
	12,  // 358: header.RuleMgr.DeleteRule:output_type -> common.Empty
	48,  // 359: header.RuleMgr.ReadRule:output_type -> conversation.Rule
	157, // 360: header.RuleMgr.ListRules:output_type -> conversation.Route
	49,  // 361: header.ConversationMgr.PongMessage:output_type -> user.Event
	54,  // 362: header.ConversationMgr.StartConversation:output_type -> conversation.Conversation
	54,  // 363: header.ConversationMgr.EndConversation:output_type -> conversation.Conversation
	54,  // 364: header.ConversationMgr.GetConversation:output_type -> conversation.Conversation
	158, // 365: header.ConversationMgr.ListConversations:output_type -> conversation.Conversations
	158, // 366: header.ConversationMgr.MatchConversations:output_type -> conversation.Conversations
	12,  // 367: header.ConversationMgr.TagConversation:output_type -> common.Empty
	12,  // 368: header.ConversationMgr.UntagConversation:output_type -> common.Empty
	12,  // 369: header.ConversationMgr.JoinConversation:output_type -> common.Empty
	12,  // 370: header.ConversationMgr.LeftConversation:output_type -> common.Empty
	12,  // 371: header.ConversationMgr.Typing:output_type -> common.Empty
	138, // 372: header.ConversationMgr.Ping:output_type -> common.Pong
	54,  // 373: header.ConversationMgr.UpdateConversationInfo:output_type -> conversation.Conversation
	159, // 374: header.ConversationMgr.FilterUser:output_type -> conversation.FilterUserResponse
	160, // 375: header.ConversationMgr.SearchConversation:output_type -> conversation.SearchConversationResponse
	161, // 376: header.ConversationMgr.ListConversations2:output_type -> conversation.ConversationListResponse
	12,  // 377: header.ConversationMgr.ExportUsers:output_type -> common.Empty
	12,  // 378: header.ConversationMgr.UpdateMuteConversation:output_type -> common.Empty
	12,  // 379: header.ConversationMgr.UnwatchConversation:output_type -> common.Empty
	12,  // 380: header.ConversationMgr.MarkReadConversation:output_type -> common.Empty
	59,  // 381: header.ConversationMgr.UpdateEndchatSetting:output_type -> conversation.EndchatSetting
	59,  // 382: header.ConversationMgr.GetEndchatSetting:output_type -> conversation.EndchatSetting
	12,  // 383: header.ConversationSyncMgr.FireConvertTicket:output_type -> common.Empty
	12,  // 384: header.ConversationSyncMgr.FireSendChatTranscriptEmail:output_type -> common.Empty
	12,  // 385: header.ConversationSyncMgr.FireUpdateConversationState:output_type -> common.Empty
	60,  // 386: header.TemplateMgr.CreateTemplate:output_type -> conversation.Template
	60,  // 387: header.TemplateMgr.UpdateTemplate:output_type -> conversation.Template
	12,  // 388: header.TemplateMgr.DeleteTemplate:output_type -> common.Empty
	60,  // 389: header.TemplateMgr.GetTemplate:output_type -> conversation.Template
	162, // 390: header.TemplateMgr.ListTemplates:output_type -> conversation.Templates
	12,  // 391: header.TemplateMgr.PickTemplate:output_type -> common.Empty
	62,  // 392: header.TagMgr.CreateTag:output_type -> conversation.Tag
	62,  // 393: header.TagMgr.UpdateTag:output_type -> conversation.Tag
	12,  // 394: header.TagMgr.DeleteTag:output_type -> common.Empty
	163, // 395: header.TagMgr.ListTags:output_type -> conversation.Tags
	62,  // 396: header.TagMgr.GetTag:output_type -> conversation.Tag
	12,  // 397: header.IntegrationMgr.Deintegrate:output_type -> common.Empty
	164, // 398: header.IntegrationMgr.ListIntegrations:output_type -> conversation.Integrations
	63,  // 399: header.IntegrationMgr.Integrate:output_type -> conversation.Integration
	165, // 400: header.IntegrationMgr.CheckAvailability:output_type -> user.AvailabilityCheckResult
	65,  // 401: header.TicketMgr.CreateTicket:output_type -> conversation.Ticket
	65,  // 402: header.TicketMgr.UpdateTicket:output_type -> conversation.Ticket
	12,  // 403: header.TicketMgr.DeleteTicket:output_type -> common.Empty
	65,  // 404: header.TicketMgr.GetTicket:output_type -> conversation.Ticket
	166, // 405: header.TicketMgr.SearchTicket:output_type -> conversation.ESTickets
	167, // 406: header.TicketMgr.ListSLAs:output_type -> conversation.ServiceLevelAgreements
	69,  // 407: header.TicketMgr.GetSLA:output_type -> conversation.ServiceLevelAgreement
	69,  // 408: header.TicketMgr.CreateSLA:output_type -> conversation.ServiceLevelAgreement
	69,  // 409: header.TicketMgr.UpdateSLA:output_type -> conversation.ServiceLevelAgreement
	12,  // 410: header.TicketMgr.DeleteSLA:output_type -> common.Empty
	168, // 411: header.TicketMgr.CountTicket:output_type -> conversation.CountTicketResponse
	169, // 412: header.TicketMgr.GetAvgResolveTimes:output_type -> conversation.AvgResolveTimeResponse
	72,  // 413: header.ClientMgr.Create:output_type -> client.Client
	72,  // 414: header.ClientMgr.Update:output_type -> client.Client
	72,  // 415: header.ClientMgr.Read:output_type -> client.Client
	170, // 416: header.ClientMgr.ListIntegratedClients:output_type -> client.AuthorizedClient
	170, // 417: header.ClientMgr.ListAuthorizedClients:output_type -> client.AuthorizedClient
	73,  // 418: header.ServiceContentManager.UpsertContent:output_type -> content.Content
	12,  // 419: header.ServiceContentManager.DeleteContent:output_type -> common.Empty
	73,  // 420: header.ServiceContentManager.GetContent:output_type -> content.Content
	171, // 421: header.ServiceContentManager.SearchContents:output_type -> content.Contents
	171, // 422: header.ServiceContentManager.LookupContentsByUrl:output_type -> content.Contents
	12,  // 423: header.ServiceContentManager.LinkContentsToUrl:output_type -> common.Empty
	172, // 424: header.DealService.ListPipelines:output_type -> deal.Pipelines
	77,  // 425: header.DealService.GetPipeline:output_type -> deal.Pipeline
	77,  // 426: header.DealService.CreatePipeline:output_type -> deal.Pipeline
	77,  // 427: header.DealService.UpdatePipeline:output_type -> deal.Pipeline
	12,  // 428: header.DealService.DeletePipeline:output_type -> common.Empty
	142, // 429: header.EventMgr.SearchEvents:output_type -> user.Events
	49,  // 430: header.EventMgr.CreateEvent:output_type -> user.Event
	49,  // 431: header.ConversationEventReader.SendMessage:output_type -> user.Event
	49,  // 432: header.ConversationEventReader.UpdateMessage:output_type -> user.Event
	142, // 433: header.ConversationEventReader.ListEvents:output_type -> user.Events
	142, // 434: header.ConversationEventReader.SearchEvents:output_type -> user.Events
	173, // 435: header.FileMgr.Presign:output_type -> file.PresignResult
	174, // 436: header.FileMgr.Read:output_type -> file.File
	174, // 437: header.FileMgr.Uploaded:output_type -> file.File
	83,  // 438: header.KV.Set:output_type -> kv.Value
	83,  // 439: header.KV.Get:output_type -> kv.Value
	175, // 440: header.KV.Has:output_type -> kv.Bool
	85,  // 441: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	85,  // 442: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	12,  // 443: header.Noti5Service.Noti:output_type -> common.Empty
	12,  // 444: header.Noti5Service.AddToken:output_type -> common.Empty
	12,  // 445: header.Noti5Service.RemoveToken:output_type -> common.Empty
	12,  // 446: header.Noti5Service.CheckTokenExists:output_type -> common.Empty
	12,  // 447: header.NotiboxService.ReadAllNotis:output_type -> common.Empty
	176, // 448: header.NotiboxService.ListNotis:output_type -> notibox.Notifications
	177, // 449: header.NotiboxService.GetNotibox:output_type -> notibox.Notibox
	89,  // 450: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	90,  // 451: header.SubizInternalPaymentMgr.UpdateExchangeRate:output_type -> payment.ExchangeRate
	178, // 452: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	95,  // 453: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	92,  // 454: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	92,  // 455: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	93,  // 456: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	93,  // 457: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	12,  // 458: header.PaymentMgr.DeletePaymentMethod:output_type -> common.Empty
	179, // 459: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	89,  // 460: header.PaymentMgr.Pay:output_type -> payment.Bill
	180, // 461: header.PaymentMgr.ListInvoices:output_type -> payment.Invoices
	95,  // 462: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	95,  // 463: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	180, // 464: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	95,  // 465: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	95,  // 466: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	181, // 467: header.PaymentMgr.ListComments:output_type -> payment.Comments
	99,  // 468: header.PaymentMgr.AddComment:output_type -> payment.Comment
	182, // 469: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	102, // 470: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	102, // 471: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	90,  // 472: header.PaymentMgr.GetExchangeRate:output_type -> payment.ExchangeRate
	89,  // 473: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	183, // 474: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	101, // 475: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	101, // 476: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	12,  // 477: header.PaymentMgr.UsePromotionCode:output_type -> common.Empty
	101, // 478: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	184, // 479: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	12,  // 480: header.PaymentMgr.DeletePromotionCode:output_type -> common.Empty
	106, // 481: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	106, // 482: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	185, // 483: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	106, // 484: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	186, // 485: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	187, // 486: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	188, // 487: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	12,  // 488: header.PaymentMgr.PaidForAgentReferrer:output_type -> common.Empty
	12,  // 489: header.Pubsub.Publish:output_type -> common.Empty
	109, // 490: header.WidgetService.Read:output_type -> widget.Setting
	109, // 491: header.WidgetService.Update:output_type -> widget.Setting
	189, // 492: header.WidgetService.ReadUserSetting:output_type -> widget.UserSetting
	110, // 493: header.WidgetService.ReadCampaign:output_type -> widget.Campaign
	190, // 494: header.WidgetService.ListCampaigns:output_type -> widget.Campaigns
	110, // 495: header.WidgetService.CreateCampaign:output_type -> widget.Campaign
	110, // 496: header.WidgetService.UpdateCampaign:output_type -> widget.Campaign
	12,  // 497: header.WidgetService.DeleteCampaign:output_type -> common.Empty
	111, // 498: header.WidgetService.SubmitImpression:output_type -> widget.Impression
	112, // 499: header.WidgetService.SubmitConversion:output_type -> widget.Conversion
	113, // 500: header.WidgetService.SubmitUserCampaignStatus:output_type -> widget.UserCampaignStatus
	191, // 501: header.WidgetService.ReportCampaign:output_type -> widget.ReportCampaignResponse
	192, // 502: header.WidgetService.ListConversions:output_type -> widget.Conversions
	193, // 503: header.WidgetService.ExportConversions:output_type -> widget.ConversionsExported
	116, // 504: header.WidgetService.UploadImage:output_type -> widget.UploadedImage
	194, // 505: header.WidgetService.ListUploadedImage:output_type -> widget.UploadedImages
	12,  // 506: header.WidgetService.DeleteUploadedImage:output_type -> common.Empty
	117, // 507: header.WebhookService.Read:output_type -> client.Webhook
	12,  // 508: header.WebhookService.Delete:output_type -> common.Empty
	195, // 509: header.WebhookService.List:output_type -> client.Webhooks
	117, // 510: header.WebhookService.Update:output_type -> client.Webhook
	117, // 511: header.WebhookService.Create:output_type -> client.Webhook
	196, // 512: header.WebhookService.Test:output_type -> client.WebhookTestResult
	197, // 513: header.Search.SearchUsers:output_type -> search.SearchUsersResponse
	12,  // 514: header.Search.ExportUsers:output_type -> common.Empty
	198, // 515: header.Search.SearchNotes:output_type -> search.SearchNotesResponse
	199, // 516: header.Search.SearchConversations:output_type -> search.SearchConversationsResponse
	200, // 517: header.Search.SearchTickets:output_type -> search.SearchTicketsResponse
	201, // 518: header.Bqreport.AggregateConversations:output_type -> bqreport.ConversationReport
	202, // 519: header.Bqreport.AggregateConversationRates:output_type -> bqreport.ConversationRateReport
	203, // 520: header.Bqreport.AggregateConversationTags:output_type -> bqreport.ConversationTagReport
	204, // 521: header.Bqreport.AggregateConversationAgents:output_type -> bqreport.ConversationAgentReport
	205, // 522: header.Bqreport.AggregateMessageOfAgents:output_type -> bqreport.MessageOfAgentReport
	206, // 523: header.Bqreport.AggregateAgentAvailabilities:output_type -> bqreport.AgentAvailabilityReport
	207, // 524: header.Bizbot.ListBots:output_type -> bot.Bots
	126, // 525: header.Bizbot.GetBot:output_type -> bot.Bot
	126, // 526: header.Bizbot.CreateBot:output_type -> bot.Bot
	126, // 527: header.Bizbot.UpdateBot:output_type -> bot.Bot
	12,  // 528: header.Bizbot.DeleteBot:output_type -> common.Empty
	12,  // 529: header.Bizbot.OnEvent:output_type -> common.Empty
