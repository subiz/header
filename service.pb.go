...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x49, 0x64, 0x1a, 0x0d, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x32, 0x9b, 0x0c, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x67, 0x72,
	...
	0x72, 0x73, 0x32, 0xbe, 0x03, 0x0a, 0x07, 0x4c, 0x69, 0x76, 0x65, 0x4d, 0x67, 0x72, 0x12, 0x3c,
	...
	0x65, 0x32, 0xe8, 0x11, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69,
	...
	0x6e, 0x74, 0x2e, 0x50, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x0b, 0x53,
...
var file_service_proto_depIdxs = []int32{
	...
	35,  // 112: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	36,  // 113: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	37,  // 114: header.LiveMgr.TopEvents:input_type -> header.EventParams
	...
	38,  // 119: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	39,  // 120: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	40,  // 121: header.NoteMgr.AddNote:input_type -> header.Note
	40,  // 122: header.NoteMgr.UpdateNote:input_type -> header.Note
	41,  // 123: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	42,  // 124: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	43,  // 125: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	43,  // 126: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	44,  // 127: header.ConversationReporter.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	45,  // 128: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	46,  // 129: header.ConversationMgr.PongMessage:input_type -> header.Event
	47,  // 130: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	4,   // 131: header.ConversationMgr.EndConversation:input_type -> header.Id
	4,   // 132: header.ConversationMgr.GetConversation:input_type -> header.Id
	48,  // 133: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	5,   // 134: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	49,  // 135: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	49,  // 136: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	50,  // 137: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	50,  // 138: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	4,   // 139: header.ConversationMgr.Typing:input_type -> header.Id
	51,  // 140: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	28,  // 141: header.ConversationMgr.SearchConvos:input_type -> header.SearchRequest
	51,  // 142: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	50,  // 143: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	51,  // 144: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	51,  // 145: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	52,  // 146: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	4,   // 147: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	53,  // 148: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	4,   // 149: header.ConversationMgr.UpdatePresence:input_type -> header.Id
	46,  // 150: header.ConversationMgr.SendMessage:input_type -> header.Event
	46,  // 151: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	46,  // 152: header.ConversationMgr.PinMessage:input_type -> header.Event
	46,  // 153: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	54,  // 154: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	...
	55,  // 157: header.ConversationMgr.Integrate:input_type -> header.Integration
	4,   // 158: header.ConversationMgr.GetIntegration:input_type -> header.Id
	56,  // 159: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	56,  // 160: header.ConversationMgr.CreateRule:input_type -> header.Rule
	...
	57,  // 165: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	...
	58,  // 168: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	58,  // 169: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 170: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 171: header.TemplateMgr.GetTemplate:input_type -> header.Id
	59,  // 172: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 173: header.TemplateMgr.PickTemplate:input_type -> header.Id
	60,  // 174: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	60,  // 175: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	...
	61,  // 179: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	62,  // 180: header.TagMgr.CreateTag:input_type -> header.Tag
	62,  // 181: header.TagMgr.UpdateTag:input_type -> header.Tag
	...
	63,  // 185: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	64,  // 186: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	65,  // 187: header.FileMgr.Presign:input_type -> header.FileHeader
	66,  // 188: header.FileMgr.Uploaded:input_type -> header.FileRequest
	67,  // 189: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 190: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	68,  // 191: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	69,  // 192: header.Noti5Service.Noti:input_type -> header.PushNoti
	70,  // 193: header.Noti5Service.AddToken:input_type -> noti5.Token
	70,  // 194: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	70,  // 195: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	71,  // 196: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	72,  // 197: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	73,  // 198: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	73,  // 199: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 200: header.PaymentMgr.GetSubscription:input_type -> header.Id
	74,  // 201: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	74,  // 202: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	75,  // 205: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	76,  // 206: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	76,  // 207: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	77,  // 208: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	73,  // 209: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	78,  // 210: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	79,  // 211: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	80,  // 212: header.PaymentMgr.AddComment:input_type -> payment.Comment
	42,  // 213: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 214: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	76,  // 215: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	81,  // 216: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	75,  // 217: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	82,  // 218: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	83,  // 219: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	84,  // 220: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	85,  // 221: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	85,  // 222: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	86,  // 223: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 224: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	87,  // 225: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 226: header.PaymentMgr.GetReferral:input_type -> header.Id
	42,  // 227: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	88,  // 228: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	89,  // 232: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	90,  // 233: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 234: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	91,  // 235: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	92,  // 238: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	93,  // 239: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	93,  // 240: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	93,  // 241: header.MailkonService.SendEvent:input_type -> header.Events
	...
	94,  // 246: header.WidgetService.Update:input_type -> header.WidgetSetting
	...
	95,  // 249: header.WidgetService.SubmitImpression:input_type -> header.Impression
	96,  // 250: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	97,  // 251: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	98,  // 252: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	99,  // 253: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	99,  // 254: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	100, // 255: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 256: header.WidgetService.ListUploadedImage:input_type -> header.Id
	100, // 257: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 258: header.WidgetService.ListWebPlugins:input_type -> header.Id
	101, // 259: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	101, // 260: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	101, // 261: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 262: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	101, // 263: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	...
	102, // 266: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	...
	103, // 272: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	103, // 273: header.Bizbot.CreateBot:input_type -> header.Bot
	103, // 274: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 275: header.Bizbot.DeleteBot:input_type -> header.Id
	104, // 276: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	104, // 277: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	104, // 278: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	104, // 279: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	105, // 280: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	106, // 281: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	107, // 282: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	108, // 283: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	109, // 284: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	109, // 289: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 290: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	110, // 291: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	111, // 292: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 293: header.Sendback.SendWebhookEvent:input_type -> header.Event
	112, // 294: header.Notibox.ListRecentCompactedNoties:input_type -> header.ListNotiRequest
	113, // 295: header.Notibox.SendNoti:input_type -> header.Notification
	112, // 296: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 297: header.Notibox.MarkReadNoti:input_type -> header.Id
	114, // 298: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 299: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 300: header.Watchhttp.ListWebpages:input_type -> header.Id
	114, // 301: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 302: header.Watchhttp.ReadWebpage:input_type -> header.Id
	115, // 303: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	116, // 304: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	117, // 305: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	117, // 306: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 307: header.Holap.AppendAgentSet:input_type -> account.Agent
	62,  // 308: header.Holap.AppendTagSet:input_type -> header.Tag
	30,  // 309: header.Holap.UpdateUser:input_type -> header.User
	51,  // 310: header.Holap.UpdateConversation:input_type -> header.Conversation
	46,  // 311: header.Holap.OnConversationEvent:input_type -> header.Event
	118, // 312: header.Holap.FreeAccount:input_type -> header.AccountImage
	119, // 313: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	120, // 314: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	119, // 315: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	120, // 316: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	121, // 317: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	...
	122, // 321: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	123, // 322: header.Proder.ReadProduct:input_type -> header.Product
	123, // 323: header.Proder.CreateProduct:input_type -> header.Product
	123, // 324: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 325: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 326: header.Proder.RestoreProduct:input_type -> header.Id
	124, // 327: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 328: header.Proder.ListProductIds:input_type -> header.Ids
	124, // 329: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	125, // 330: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 331: header.Proder.ListProductCollections:input_type -> header.Ids
	126, // 332: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	126, // 333: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	...
	127, // 336: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	127, // 337: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	...
	128, // 346: header.Proder.ListOrders:input_type -> header.OrdersRequest
	128, // 347: header.Proder.CountOrders:input_type -> header.OrdersRequest
	129, // 348: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	130, // 349: header.Proder.MakeOrderPayment:input_type -> header.Bill
	131, // 350: header.Proder.DeleteOrderPayment:input_type -> header.Key
	46,  // 351: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 352: header.Proder.EditOrderComment:input_type -> header.Event
	131, // 353: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 354: header.Proder.ListOrderEvents:input_type -> header.Id
	132, // 355: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 356: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	133, // 357: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 358: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	134, // 359: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	135, // 360: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	136, // 361: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	137, // 362: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	...
	138, // 369: header.Proder.VisitProductSite:input_type -> header.VisitProductSiteRequest
	4,   // 370: header.Apiece.ReadTask:input_type -> header.Id
	139, // 371: header.Apiece.CreateTask:input_type -> header.Task
	139, // 372: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 373: header.Apiece.DeleteTask:input_type -> header.Id
	140, // 374: header.Apiece.ListTasks:input_type -> header.TasksRequest
	46,  // 375: header.Apiece.AddTaskComment:input_type -> header.Event
	46,  // 376: header.Apiece.EditTaskComment:input_type -> header.Event
	131, // 377: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 378: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 379: header.Apiece.ReadPipeline:input_type -> header.Id
	141, // 380: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	141, // 381: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 382: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 383: header.Apiece.ListPipelines:input_type -> header.Ids
	142, // 384: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	42,  // 385: header.Search.Index:output_type -> header.Empty
	143, // 386: header.Search.Search:output_type -> header.DocSearchResponse
	42,  // 387: header.Search.AddOwner:output_type -> header.Empty
	144, // 388: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 389: header.Map.LookupAddress:output_type -> header.Address
	145, // 390: header.Map.PredictAddress:output_type -> header.Addresses
	145, // 391: header.Map.ListDistricts:output_type -> header.Addresses
	145, // 392: header.Map.ListProvinces:output_type -> header.Addresses
	145, // 393: header.Map.ListWards:output_type -> header.Addresses
	145, // 394: header.Map.ListStreets:output_type -> header.Addresses
	145, // 395: header.Map.ListAddresses:output_type -> header.Addresses
	...
	42,  // 400: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	42,  // 404: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	146, // 414: header.AccountMgr.ListAgents:output_type -> account.Agents
	42,  // 415: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	147, // 416: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	42,  // 417: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	42,  // 418: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 419: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	148, // 420: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	149, // 423: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	149, // 424: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	42,  // 425: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 426: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	150, // 427: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	151, // 430: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	152, // 433: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	42,  // 434: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	145, // 435: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	42,  // 438: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	153, // 439: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 440: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 441: header.AccountMgr.UpdateTax:output_type -> header.Tax
	42,  // 442: header.AccountMgr.DeleteTax:output_type -> header.Empty
	154, // 443: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	154, // 444: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	42,  // 447: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 448: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	155, // 449: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 450: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	42,  // 451: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	156, // 452: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	42,  // 455: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	42,  // 456: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	157, // 457: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	42,  // 458: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	...
	158, // 462: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 463: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	42,  // 464: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	159, // 465: header.UserMgr.SearchUsers:output_type -> header.Users
	...
	30,  // 472: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	160, // 473: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	159, // 474: header.UserMgr.MatchUsers:output_type -> header.Users
	32,  // 475: header.UserMgr.UpdateView:output_type -> header.UserView
	32,  // 476: header.UserMgr.CreateView:output_type -> header.UserView
	42,  // 477: header.UserMgr.DeleteView:output_type -> header.Empty
	32,  // 478: header.UserMgr.GetView:output_type -> header.UserView
	161, // 479: header.UserMgr.ListViews:output_type -> header.UserViews
	33,  // 480: header.UserMgr.UpsertLabel:output_type -> header.Label
	42,  // 481: header.UserMgr.DeleteLabel:output_type -> header.Empty
	162, // 482: header.UserMgr.ListLabels:output_type -> header.Labels
	33,  // 483: header.UserMgr.GetLabel:output_type -> header.Label
	42,  // 484: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	42,  // 485: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	42,  // 486: header.UserMgr.AddUserLabel:output_type -> header.Empty
	42,  // 487: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	...
	42,  // 490: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	163, // 491: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	42,  // 492: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	159, // 493: header.UserMgr.ListLeads:output_type -> header.Users
	159, // 494: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	159, // 495: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	164, // 496: header.LiveMgr.SearchLocations:output_type -> header.Locations
	159, // 497: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	93,  // 498: header.LiveMgr.TopEvents:output_type -> header.Events
	165, // 499: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	166, // 500: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	167, // 501: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	168, // 502: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	169, // 503: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	170, // 504: header.NoteMgr.ListNotes:output_type -> header.Notes
	40,  // 505: header.NoteMgr.AddNote:output_type -> header.Note
	40,  // 506: header.NoteMgr.UpdateNote:output_type -> header.Note
	42,  // 507: header.NoteMgr.DeleteNote:output_type -> header.Empty
	171, // 508: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	43,  // 509: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	43,  // 510: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	172, // 511: header.ConversationReporter.ReportAvailibilities:output_type -> header.ReportResponse
	173, // 512: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	46,  // 513: header.ConversationMgr.PongMessage:output_type -> header.Event
	51,  // 514: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	51,  // 515: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	51,  // 516: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	...
	42,  // 519: header.ConversationMgr.TagConversation:output_type -> header.Empty
	42,  // 520: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	42,  // 521: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	42,  // 522: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	42,  // 523: header.ConversationMgr.Typing:output_type -> header.Empty
	51,  // 524: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	174, // 525: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	42,  // 526: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	42,  // 527: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	42,  // 528: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	42,  // 529: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	52,  // 530: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	52,  // 531: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	46,  // 532: header.ConversationMgr.TerminateBot:output_type -> header.Event
	175, // 533: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	46,  // 534: header.ConversationMgr.SendMessage:output_type -> header.Event
	46,  // 535: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	42,  // 536: header.ConversationMgr.PinMessage:output_type -> header.Empty
	42,  // 537: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	93,  // 538: header.ConversationMgr.ListEvents:output_type -> header.Events
	42,  // 539: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	176, // 540: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	55,  // 541: header.ConversationMgr.Integrate:output_type -> header.Integration
	55,  // 542: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	56,  // 543: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	56,  // 544: header.ConversationMgr.CreateRule:output_type -> header.Rule
	42,  // 545: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	56,  // 546: header.ConversationMgr.ReadRule:output_type -> header.Rule
	177, // 547: header.ConversationMgr.ListRules:output_type -> header.Route
	178, // 548: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	57,  // 549: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	42,  // 550: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	57,  // 551: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	58,  // 552: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	58,  // 553: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	42,  // 554: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	58,  // 555: header.TemplateMgr.GetTemplate:output_type -> header.Template
	179, // 556: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	42,  // 557: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	60,  // 558: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	60,  // 559: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	42,  // 560: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	60,  // 561: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	180, // 562: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	181, // 563: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	62,  // 564: header.TagMgr.CreateTag:output_type -> header.Tag
	62,  // 565: header.TagMgr.UpdateTag:output_type -> header.Tag
	42,  // 566: header.TagMgr.DeleteTag:output_type -> header.Empty
	182, // 567: header.TagMgr.ListTags:output_type -> header.Tags
	62,  // 568: header.TagMgr.GetTag:output_type -> header.Tag
	93,  // 569: header.EventMgr.SearchEvents:output_type -> header.Events
	46,  // 570: header.EventMgr.CreateEvent:output_type -> header.Event
	183, // 571: header.FileMgr.Presign:output_type -> header.PresignResult
	184, // 572: header.FileMgr.Uploaded:output_type -> header.File
	184, // 573: header.FileMgr.DownloadFileUrl:output_type -> header.File
	68,  // 574: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	68,  // 575: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	42,  // 576: header.Noti5Service.Noti:output_type -> header.Empty
	42,  // 577: header.Noti5Service.AddToken:output_type -> header.Empty
	42,  // 578: header.Noti5Service.RemoveToken:output_type -> header.Empty
	42,  // 579: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	71,  // 580: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	185, // 581: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	76,  // 582: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	73,  // 583: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	73,  // 584: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	74,  // 585: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	74,  // 586: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	42,  // 587: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	186, // 588: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	71,  // 589: header.PaymentMgr.Pay:output_type -> payment.Bill
	76,  // 590: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	76,  // 591: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	187, // 592: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	76,  // 593: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	76,  // 594: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	188, // 595: header.PaymentMgr.ListComments:output_type -> payment.Comments
	80,  // 596: header.PaymentMgr.AddComment:output_type -> payment.Comment
	189, // 597: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	84,  // 598: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	84,  // 599: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	81,  // 600: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	71,  // 601: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	190, // 602: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	83,  // 603: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	83,  // 604: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	42,  // 605: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	83,  // 606: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	191, // 607: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	42,  // 608: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	88,  // 609: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	88,  // 610: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	192, // 611: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	88,  // 612: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	193, // 613: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	194, // 614: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	195, // 615: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	42,  // 616: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	42,  // 617: header.Pubsub.Publish:output_type -> header.Empty
	91,  // 618: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	91,  // 619: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	196, // 620: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	197, // 621: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	92,  // 622: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	42,  // 623: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	42,  // 624: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	42,  // 625: header.MailkonService.SendEvent:output_type -> header.Empty
	42,  // 626: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	42,  // 627: header.MailkonService.BlockEmail:output_type -> header.Empty
	42,  // 628: header.MailkonService.UnblockEmail:output_type -> header.Empty
	94,  // 629: header.WidgetService.Read:output_type -> header.WidgetSetting
	94,  // 630: header.WidgetService.Update:output_type -> header.WidgetSetting
	198, // 631: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	199, // 632: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	95,  // 633: header.WidgetService.SubmitImpression:output_type -> header.Impression
	96,  // 634: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	97,  // 635: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	200, // 636: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	201, // 637: header.WidgetService.ListConversions:output_type -> header.Conversions
	202, // 638: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	100, // 639: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	203, // 640: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	42,  // 641: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	204, // 642: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	101, // 643: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	101, // 644: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	101, // 645: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	42,  // 646: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	101, // 647: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	204, // 648: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	42,  // 649: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	205, // 650: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	203, // 651: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	206, // 652: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	207, // 653: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	208, // 654: header.Bizbot.ListBots:output_type -> header.Bots
	103, // 655: header.Bizbot.GetBot:output_type -> header.Bot
	103, // 656: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	103, // 657: header.Bizbot.CreateBot:output_type -> header.Bot
	103, // 658: header.Bizbot.UpdateBot:output_type -> header.Bot
	42,  // 659: header.Bizbot.DeleteBot:output_type -> header.Empty
	42,  // 660: header.Bizbot.OnEvent:output_type -> header.Empty
	42,  // 661: header.Bizbot.StartBot:output_type -> header.Empty
	42,  // 662: header.Bizbot.StopBot:output_type -> header.Empty
	42,  // 663: header.Bizbot.TryAction:output_type -> header.Empty
	209, // 664: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	210, // 665: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	211, // 666: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	212, // 667: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	109, // 668: header.Sendback.CreateWebhook:output_type -> header.Webhook
	213, // 669: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	42,  // 670: header.Sendback.DeleteWebhook:output_type -> header.Empty
	214, // 671: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	109, // 672: header.Sendback.ReadWebhook:output_type -> header.Webhook
	109, // 673: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	109, // 674: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	215, // 675: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	216, // 676: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	42,  // 677: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	217, // 678: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	42,  // 679: header.Notibox.SendNoti:output_type -> header.Empty
	218, // 680: header.Notibox.ListNoties:output_type -> header.Notifications
	42,  // 681: header.Notibox.MarkReadNoti:output_type -> header.Empty
	114, // 682: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	42,  // 683: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	219, // 684: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	114, // 685: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	114, // 686: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	220, // 687: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	221, // 688: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	222, // 689: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	220, // 690: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	42,  // 691: header.Holap.AppendAgentSet:output_type -> header.Empty
	42,  // 692: header.Holap.AppendTagSet:output_type -> header.Empty
	42,  // 693: header.Holap.UpdateUser:output_type -> header.Empty
	42,  // 694: header.Holap.UpdateConversation:output_type -> header.Empty
	42,  // 695: header.Holap.OnConversationEvent:output_type -> header.Empty
	42,  // 696: header.Holap.FreeAccount:output_type -> header.Empty
	223, // 697: header.Holap.ReportUser:output_type -> header.UserMetrics
	224, // 698: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 699: header.Holap.ListUserIds:output_type -> header.Ids
	174, // 700: header.Holap.ListConversationIds:output_type -> header.Conversations
	225, // 701: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 702: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	160, // 703: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	42,  // 704: header.Holap.UpdateOrder:output_type -> header.Empty
	226, // 705: header.Holap.ReportOrder:output_type -> header.Orders
	123, // 706: header.Proder.ReadProduct:output_type -> header.Product
	123, // 707: header.Proder.CreateProduct:output_type -> header.Product
	123, // 708: header.Proder.UpdateProduct:output_type -> header.Product
	42,  // 709: header.Proder.DeleteProduct:output_type -> header.Empty
	123, // 710: header.Proder.RestoreProduct:output_type -> header.Product
	125, // 711: header.Proder.ListProducts:output_type -> header.Products
	5,   // 712: header.Proder.ListProductIds:output_type -> header.Ids
	125, // 713: header.Proder.ListGroupedProducts:output_type -> header.Products
	125, // 714: header.Proder.ImportProducts:output_type -> header.Products
	227, // 715: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	126, // 716: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	126, // 717: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	42,  // 718: header.Proder.DeleteProductCollection:output_type -> header.Empty
	228, // 719: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	127, // 720: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	127, // 721: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	42,  // 722: header.Proder.DeleteProductFeed:output_type -> header.Empty
	229, // 723: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	230, // 724: header.Proder.ListProductProps:output_type -> header.ProductProps
	...
	42,  // 728: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 729: header.Proder.RestoreOrder:output_type -> header.Order
	226, // 730: header.Proder.ListOrders:output_type -> header.Orders
	226, // 731: header.Proder.CountOrders:output_type -> header.Orders
	42,  // 732: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	46,  // 733: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 734: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 735: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 736: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 737: header.Proder.DeleteOrderComment:output_type -> header.Event
	231, // 738: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	184, // 739: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 740: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	232, // 741: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	42,  // 742: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	233, // 743: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	42,  // 744: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	42,  // 745: header.Proder.GHNShippingStatus:output_type -> header.Empty
	137, // 746: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 747: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 748: header.Proder.CancelShippingOrder:output_type -> header.Order
	184, // 749: header.Proder.PrintShippingOrders:output_type -> header.File
	42,  // 750: header.Proder.SeenOrder:output_type -> header.Empty
	42,  // 751: header.Proder.FollowOrder:output_type -> header.Empty
	42,  // 752: header.Proder.UnfollowOrder:output_type -> header.Empty
	125, // 753: header.Proder.VisitProductSite:output_type -> header.Products
	139, // 754: header.Apiece.ReadTask:output_type -> header.Task
	139, // 755: header.Apiece.CreateTask:output_type -> header.Task
	139, // 756: header.Apiece.UpdateTask:output_type -> header.Task
	42,  // 757: header.Apiece.DeleteTask:output_type -> header.Empty
	234, // 758: header.Apiece.ListTasks:output_type -> header.Tasks
	46,  // 759: header.Apiece.AddTaskComment:output_type -> header.Event
	46,  // 760: header.Apiece.EditTaskComment:output_type -> header.Event
	46,  // 761: header.Apiece.DeleteTaskComment:output_type -> header.Event
	235, // 762: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	141, // 763: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	141, // 764: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	141, // 765: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	42,  // 766: header.Apiece.DeletePipeline:output_type -> header.Empty
	236, // 767: header.Apiece.ListPipelines:output_type -> header.Pipelines
