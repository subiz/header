...
var file_service_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x73, 0x74, 0x73, 0x32, 0xbe, 0x0d, 0x0a, 0x0d, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74,
	...
	0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0x77, 0x0a, 0x05, 0x48, 0x6f, 0x6c, 0x61,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Urls)(nil),                                    // 157: header.Urls
	(*Bots)(nil),                                    // 158: header.Bots
	(*ReportBotResponse)(nil),                       // 159: header.ReportBotResponse
	(*ListObjectsResponse)(nil),                     // 160: header.ListObjectsResponse
	(*WebhookTestResult)(nil),                       // 161: header.WebhookTestResult
	(*Webhooks)(nil),                                // 162: header.Webhooks
	(*WebhookDeliveries)(nil),                       // 163: header.WebhookDeliveries
	(*WebhookDelivery)(nil),                         // 164: header.WebhookDelivery
	(*CompactedNoties)(nil),                         // 165: header.CompactedNoties
	(*CompactedNoti)(nil),                           // 166: header.CompactedNoti
	(*Webpages)(nil),                                // 167: header.Webpages
	(*WebpageChecks)(nil),                           // 168: header.WebpageChecks
	(*WebpageCheck)(nil),                            // 169: header.WebpageCheck
	(*WebpageReportDataSet)(nil),                    // 170: header.WebpageReportDataSet
}
var file_service_proto_depIdxs = []int32{
	...
	89,  // 196: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	89,  // 197: header.Bizbot.CreateBot:input_type -> header.Bot
	89,  // 198: header.Bizbot.UpdateBot:input_type -> header.Bot
	1,   // 199: header.Bizbot.DeleteBot:input_type -> header.Id
	90,  // 200: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	90,  // 201: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	90,  // 202: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	90,  // 203: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	91,  // 204: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	92,  // 205: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	89,  // 206: header.Bizbot.CreateBotRevision:input_type -> header.Bot
	1,   // 207: header.Bizbot.ListBotRevisions:input_type -> header.Id
	93,  // 208: header.Sendback.CreateWebhook:input_type -> header.Webhook
	...
	93,  // 213: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	1,   // 214: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	94,  // 215: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	95,  // 216: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	35,  // 217: header.Sendback.SendWebhookEvent:input_type -> header.Event
	96,  // 218: header.Notibox.Send:input_type -> header.Notification
	1,   // 219: header.Notibox.MarkRead:input_type -> header.Id
	97,  // 220: header.Notibox.ListRecentCompactedNoties:input_type -> header.RecentCompactedNotiRequest
	98,  // 221: header.Notibox.GetCompactedNoti:input_type -> header.CompactedNotiRequest
	99,  // 222: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	1,   // 223: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	1,   // 224: header.Watchhttp.ListWebpages:input_type -> header.Id
	99,  // 225: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	1,   // 226: header.Watchhttp.ReadWebpage:input_type -> header.Id
	100, // 227: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	101, // 228: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	102, // 229: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	102, // 230: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	40,  // 231: header.Holap.UpdateConversation:input_type -> header.Conversation
	35,  // 232: header.Holap.OnConversationEvent:input_type -> header.Event
	...
	25,  // 236: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	...
	25,  // 240: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	...
	103, // 250: header.AccountMgr.ListAgents:output_type -> account.Agents
	25,  // 251: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	104, // 252: header.AccountMgr.ListGroups:output_type -> account.AgentGroups
	25,  // 253: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	25,  // 254: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	4,   // 255: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	105, // 256: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	106, // 259: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	25,  // 260: header.AccountMgr.LogoutSession:output_type -> header.Empty
	107, // 261: header.UserMgr.SearchUsers:output_type -> header.Users
	108, // 262: header.UserMgr.SearchLeads:output_type -> header.LeadSearchResult
	108, // 263: header.UserMgr.ListLeads:output_type -> header.LeadSearchResult
	13,  // 264: header.UserMgr.MergeUser:output_type -> header.UserAlias
	1,   // 265: header.UserMgr.CreateUser:output_type -> header.Id
	1,   // 266: header.UserMgr.UpdateUser:output_type -> header.Id
	14,  // 267: header.UserMgr.ReadUser:output_type -> header.User
	109, // 268: header.UserMgr.ReportUsers:output_type -> header.UserReportResult
	107, // 269: header.UserMgr.MatchUsers:output_type -> header.Users
	110, // 270: header.LiveMgr.SearchLocations:output_type -> header.Locations
	107, // 271: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	111, // 272: header.LiveMgr.TopEvents:output_type -> header.Events
	112, // 273: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	113, // 274: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	114, // 275: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	115, // 276: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	116, // 277: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	117, // 278: header.NoteMgr.ListNotes:output_type -> header.Notes
	22,  // 279: header.NoteMgr.AddNote:output_type -> header.Note
	22,  // 280: header.NoteMgr.UpdateNote:output_type -> header.Note
	25,  // 281: header.NoteMgr.DeleteNote:output_type -> header.Empty
	118, // 282: header.AutomationMgr.ListAutomations:output_type -> header.Automations
	24,  // 283: header.AutomationMgr.UpdateAutomation:output_type -> header.Automation
	25,  // 284: header.AutomationMgr.DeleteAutomation:output_type -> header.Empty
	24,  // 285: header.AutomationMgr.ReadAutomation:output_type -> header.Automation
	24,  // 286: header.AutomationMgr.CreateAutomation:output_type -> header.Automation
	119, // 287: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	26,  // 288: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	26,  // 289: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	25,  // 290: header.AttributeMgr.DeleteAttributeDefinition:output_type -> header.Empty
	120, // 291: header.ConversationReporter.CountConversationsByTags:output_type -> conversation.CountByTagsResponse
	121, // 292: header.ConversationReporter.GetAvgResponseTimes:output_type -> conversation.AvgResponseTimeResponse
	122, // 293: header.ConversationReporter.GetTotalConversation:output_type -> conversation.TotalConversationResponse
	123, // 294: header.ConversationReporter.ReportConversations:output_type -> conversation.ReportResponse
	123, // 295: header.ConversationReporter.ReportConversations2:output_type -> conversation.ReportResponse
	123, // 296: header.ConversationReporter.ReportAvailibilities:output_type -> conversation.ReportResponse
	33,  // 297: header.RuleMgr.UpdateRule:output_type -> header.Rule
	33,  // 298: header.RuleMgr.CreateRule:output_type -> header.Rule
	25,  // 299: header.RuleMgr.DeleteRule:output_type -> header.Empty
	33,  // 300: header.RuleMgr.ReadRule:output_type -> header.Rule
	124, // 301: header.RuleMgr.ListRules:output_type -> header.Route
	125, // 302: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	35,  // 303: header.ConversationMgr.PongMessage:output_type -> header.Event
	40,  // 304: header.ConversationMgr.SeenConversation:output_type -> header.Conversation
	40,  // 305: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	40,  // 306: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	40,  // 307: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	126, // 308: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	126, // 309: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	25,  // 310: header.ConversationMgr.TagConversation:output_type -> header.Empty
	25,  // 311: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	25,  // 312: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	25,  // 313: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	25,  // 314: header.ConversationMgr.Typing:output_type -> header.Empty
	40,  // 315: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	126, // 316: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	127, // 317: header.ConversationMgr.SearchConversation:output_type -> conversation.SearchConversationResponse
	128, // 318: header.ConversationMgr.ListConversations2:output_type -> conversation.ConversationListResponse
	25,  // 319: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	25,  // 320: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	25,  // 321: header.ConversationMgr.MarkReadConversation:output_type -> header.Empty
	43,  // 322: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	43,  // 323: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	35,  // 324: header.ConversationMgr.TerminateBot:output_type -> header.Event
	129, // 325: header.ConversationMgr.UpdatePresence:output_type -> account.Presence
	45,  // 326: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	45,  // 327: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	25,  // 328: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	45,  // 329: header.TemplateMgr.GetTemplate:output_type -> header.Template
	130, // 330: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	25,  // 331: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	47,  // 332: header.TagMgr.CreateTag:output_type -> header.Tag
	47,  // 333: header.TagMgr.UpdateTag:output_type -> header.Tag
	25,  // 334: header.TagMgr.DeleteTag:output_type -> header.Empty
	131, // 335: header.TagMgr.ListTags:output_type -> header.Tags
	47,  // 336: header.TagMgr.GetTag:output_type -> header.Tag
	25,  // 337: header.IntegrationMgr.Deintegrate:output_type -> header.Empty
	132, // 338: header.IntegrationMgr.ListIntegrations:output_type -> header.Integrations
	48,  // 339: header.IntegrationMgr.Integrate:output_type -> header.Integration
	111, // 340: header.EventMgr.SearchEvents:output_type -> header.Events
	35,  // 341: header.EventMgr.CreateEvent:output_type -> header.Event
	35,  // 342: header.ConversationEventReader.SendMessage:output_type -> header.Event
	35,  // 343: header.ConversationEventReader.UpdateMessage:output_type -> header.Event
	111, // 344: header.ConversationEventReader.ListEvents:output_type -> header.Events
	111, // 345: header.ConversationEventReader.SearchEvents:output_type -> header.Events
	133, // 346: header.FileMgr.Presign:output_type -> header.PresignResult
	134, // 347: header.FileMgr.Read:output_type -> header.File
	134, // 348: header.FileMgr.Uploaded:output_type -> header.File
	55,  // 349: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	55,  // 350: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	25,  // 351: header.Noti5Service.Noti:output_type -> header.Empty
	25,  // 352: header.Noti5Service.AddToken:output_type -> header.Empty
	25,  // 353: header.Noti5Service.RemoveToken:output_type -> header.Empty
	25,  // 354: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	58,  // 355: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	135, // 356: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	63,  // 357: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	60,  // 358: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	60,  // 359: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	61,  // 360: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	61,  // 361: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	25,  // 362: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	136, // 363: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	58,  // 364: header.PaymentMgr.Pay:output_type -> payment.Bill
	63,  // 365: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	63,  // 366: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	137, // 367: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	63,  // 368: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	63,  // 369: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	138, // 370: header.PaymentMgr.ListComments:output_type -> payment.Comments
	67,  // 371: header.PaymentMgr.AddComment:output_type -> payment.Comment
	139, // 372: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	71,  // 373: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	71,  // 374: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	68,  // 375: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	58,  // 376: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	140, // 377: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	70,  // 378: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	70,  // 379: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	25,  // 380: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	70,  // 381: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	141, // 382: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	25,  // 383: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	75,  // 384: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	75,  // 385: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	142, // 386: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	75,  // 387: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	143, // 388: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	144, // 389: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	145, // 390: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	25,  // 391: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	25,  // 392: header.Pubsub.Publish:output_type -> header.Empty
	25,  // 393: header.Realtime.ShardSend:output_type -> header.Empty
	78,  // 394: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	78,  // 395: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	146, // 396: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	147, // 397: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	79,  // 398: header.WidgetService.Read:output_type -> header.WidgetSetting
	79,  // 399: header.WidgetService.Update:output_type -> header.WidgetSetting
	148, // 400: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	80,  // 401: header.WidgetService.ReadCampaign:output_type -> header.Campaign
	149, // 402: header.WidgetService.ListCampaigns:output_type -> header.Campaigns
	80,  // 403: header.WidgetService.CreateCampaign:output_type -> header.Campaign
	80,  // 404: header.WidgetService.UpdateCampaign:output_type -> header.Campaign
	25,  // 405: header.WidgetService.DeleteCampaign:output_type -> header.Empty
	81,  // 406: header.WidgetService.SubmitImpression:output_type -> header.Impression
	82,  // 407: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	83,  // 408: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	150, // 409: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	151, // 410: header.WidgetService.ListConversions:output_type -> header.Conversions
	152, // 411: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	86,  // 412: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	153, // 413: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	25,  // 414: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	154, // 415: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	87,  // 416: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	87,  // 417: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	87,  // 418: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	25,  // 419: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	87,  // 420: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	154, // 421: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	25,  // 422: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	155, // 423: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	153, // 424: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	156, // 425: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	157, // 426: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	158, // 427: header.Bizbot.ListBots:output_type -> header.Bots
	89,  // 428: header.Bizbot.GetBot:output_type -> header.Bot
	89,  // 429: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	89,  // 430: header.Bizbot.CreateBot:output_type -> header.Bot
	89,  // 431: header.Bizbot.UpdateBot:output_type -> header.Bot
	25,  // 432: header.Bizbot.DeleteBot:output_type -> header.Empty
	25,  // 433: header.Bizbot.OnEvent:output_type -> header.Empty
	25,  // 434: header.Bizbot.StartBot:output_type -> header.Empty
	25,  // 435: header.Bizbot.StopBot:output_type -> header.Empty
	25,  // 436: header.Bizbot.TryAction:output_type -> header.Empty
	159, // 437: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	160, // 438: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	89,  // 439: header.Bizbot.CreateBotRevision:output_type -> header.Bot
	158, // 440: header.Bizbot.ListBotRevisions:output_type -> header.Bots
	93,  // 441: header.Sendback.CreateWebhook:output_type -> header.Webhook
	161, // 442: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	25,  // 443: header.Sendback.DeleteWebhook:output_type -> header.Empty
	162, // 444: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	93,  // 445: header.Sendback.ReadWebhook:output_type -> header.Webhook
	93,  // 446: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	93,  // 447: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	163, // 448: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	164, // 449: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	25,  // 450: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	25,  // 451: header.Notibox.Send:output_type -> header.Empty
	25,  // 452: header.Notibox.MarkRead:output_type -> header.Empty
	165, // 453: header.Notibox.ListRecentCompactedNoties:output_type -> header.CompactedNoties
	166, // 454: header.Notibox.GetCompactedNoti:output_type -> header.CompactedNoti
	99,  // 455: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	25,  // 456: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	167, // 457: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	99,  // 458: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	99,  // 459: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	168, // 460: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	169, // 461: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	170, // 462: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	168, // 463: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	25,  // 464: header.Holap.UpdateConversation:output_type -> header.Empty
	25,  // 465: header.Holap.OnConversationEvent:output_type -> header.Empty
