...
var file_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf2, 0x03, 0x0a, 0x09, 0x44, 0x6f, 0x63, 0x53, 0x65, 0x61,
	...
	0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x50, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e,
	...
	0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3d, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x32, 0x68, 0x0a, 0x0e, 0x4e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x29, 0x0a, 0x07,
	0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x12, 0x0e, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x1a, 0x0e, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x09, 0x55, 0x6e, 0x63, 0x6f, 0x6d,
	0x70, 0x61, 0x63, 0x74, 0x12, 0x0e, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x4e, 0x75,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*account.ResetPasswordRequest)(nil),      // 15: account.ResetPasswordRequest
	...
	(*googlekon.GGListReviews)(nil),           // 169: googlekon.GGListReviews
	(*googlekon.GGReviewsInLocations)(nil),    // 170: googlekon.GGReviewsInLocations
	...
	(*account.Agents)(nil),                    // 179: account.Agents
	...
	(*Taxes)(nil),                             // 185: header.Taxes
	(*ShippingPolicies)(nil),                  // 186: header.ShippingPolicies
	(*CancellationCodes)(nil),                 // 187: header.CancellationCodes
	(*PaymentMethods)(nil),                    // 188: header.PaymentMethods
	(*IntegratedShippings)(nil),               // 189: header.IntegratedShippings
	(*account.Presences)(nil),                 // 190: account.Presences
	(*ReportResponse)(nil),                    // 191: header.ReportResponse
	...
	(*payment.Plans)(nil),                     // 228: payment.Plans
	(*payment.Logs)(nil),                      // 229: payment.Logs
	(*payment.PromotionCodes)(nil),            // 230: payment.PromotionCodes
	(*payment.ReferralResponse)(nil),          // 231: payment.ReferralResponse
	(*payment.LogAccountReferreds)(nil),       // 232: payment.LogAccountReferreds
	(*payment.LogBillByAccountReferreds)(nil), // 233: payment.LogBillByAccountReferreds
	(*payment.LogPaidForAgentReferrers)(nil),  // 234: payment.LogPaidForAgentReferrers
	(*PollResult)(nil),                        // 235: header.PollResult
	(*FbFanpageSettings)(nil),                 // 236: header.FbFanpageSettings
	(*FacebookPosts)(nil),                     // 237: header.FacebookPosts
...
var file_service_proto_depIdxs = []int32{
	...
	11,  // 15: header.Map.Predict:input_type -> header.AddressAutocompleteRequest
	12,  // 16: header.Map.LookupAddress:input_type -> header.Id
	11,  // 17: header.Map.PredictAddress:input_type -> header.AddressAutocompleteRequest
	12,  // 18: header.Map.ListDistricts:input_type -> header.Id
	12,  // 19: header.Map.ListProvinces:input_type -> header.Id
	12,  // 20: header.Map.ListWards:input_type -> header.Id
	12,  // 21: header.Map.ListStreets:input_type -> header.Id
	13,  // 22: header.Map.ListAddresses:input_type -> header.Ids
	12,  // 23: header.Map.ReadAddress:input_type -> header.Id
	14,  // 24: header.AccountMgr.CreateGroup:input_type -> header.AgentGroup
	14,  // 25: header.AccountMgr.UpdateGroup:input_type -> header.AgentGroup
	12,  // 26: header.AccountMgr.GetGroup:input_type -> header.Id
	15,  // 27: header.AccountMgr.RequestResetPassword:input_type -> account.ResetPasswordRequest
	16,  // 28: header.AccountMgr.UpdatePassword:input_type -> account.NewPassword
	17,  // 29: header.AccountMgr.UpdateAgent:input_type -> account.Agent
	12,  // 30: header.AccountMgr.DeleteAgent:input_type -> header.Id
	12,  // 31: header.AccountMgr.DeleteAccount:input_type -> header.Id
	18,  // 32: header.AccountMgr.SubizUpdateAccount:input_type -> account.Account
	17,  // 33: header.AccountMgr.RequestChangeEmail:input_type -> account.Agent
	19,  // 34: header.AccountMgr.ConfirmChangeEmail:input_type -> account.Token
	16,  // 35: header.AccountMgr.AcceptInvitation:input_type -> account.NewPassword
	19,  // 36: header.AccountMgr.GetInvitation:input_type -> account.Token
	17,  // 37: header.AccountMgr.InviteAgent:input_type -> account.Agent
	12,  // 38: header.AccountMgr.GetAgent:input_type -> header.Id
	12,  // 39: header.AccountMgr.LookupAgentById:input_type -> header.Id
	19,  // 40: header.AccountMgr.ConfirmAccount:input_type -> account.Token
	12,  // 41: header.AccountMgr.GetAccount:input_type -> header.Id
	18,  // 42: header.AccountMgr.UpdateAccount:input_type -> account.Account
	20,  // 43: header.AccountMgr.CreateAccount:input_type -> account.CreateAccountRequest
	12,  // 44: header.AccountMgr.ListAgents:input_type -> header.Id
	12,  // 45: header.AccountMgr.DeleteGroup:input_type -> header.Id
	12,  // 46: header.AccountMgr.ListGroups:input_type -> header.Id
	17,  // 47: header.AccountMgr.ChangeEmail:input_type -> account.Agent
	21,  // 48: header.AccountMgr.SyncPublicHolidays:input_type -> account.SyncPublicHolidaysRequest
	12,  // 49: header.AccountMgr.TransferOwner:input_type -> header.Id
	22,  // 50: header.AccountMgr.CheckLoginSession:input_type -> header.LoginSession
	12,  // 51: header.AccountMgr.ListLoginSessions:input_type -> header.Id
	12,  // 52: header.AccountMgr.ListApiKeys:input_type -> header.Id
	12,  // 53: header.AccountMgr.LogoutSession:input_type -> header.Id
	22,  // 54: header.AccountMgr.CreateApiKey:input_type -> header.LoginSession
	12,  // 55: header.AccountMgr.GetLanguage:input_type -> header.Id
	23,  // 56: header.AccountMgr.UpdateLanguage:input_type -> header.LangMessage
	12,  // 57: header.AccountMgr.GetShopSetting:input_type -> header.Id
	24,  // 58: header.AccountMgr.UpdateShopSetting:input_type -> header.ShopSetting
	12,  // 59: header.AccountMgr.ReadCurrency:input_type -> header.Id
	12,  // 60: header.AccountMgr.AutoSyncCurrency:input_type -> header.Id
	12,  // 61: header.AccountMgr.ListShopAddresses:input_type -> header.Id
	25,  // 62: header.AccountMgr.CreateShopAddress:input_type -> header.Address
	25,  // 63: header.AccountMgr.UpdateShopAddress:input_type -> header.Address
	12,  // 64: header.AccountMgr.DeleteShopAddress:input_type -> header.Id
	12,  // 65: header.AccountMgr.ListTaxes:input_type -> header.Id
	26,  // 66: header.AccountMgr.CreateTax:input_type -> header.Tax
	26,  // 67: header.AccountMgr.UpdateTax:input_type -> header.Tax
	12,  // 68: header.AccountMgr.DeleteTax:input_type -> header.Id
	27,  // 69: header.AccountMgr.CheckShippingPolicy:input_type -> header.Order
	12,  // 70: header.AccountMgr.ListShippingPolicies:input_type -> header.Id
	28,  // 71: header.AccountMgr.CreateShippingPolicy:input_type -> header.ShippingPolicy
	28,  // 72: header.AccountMgr.UpdateShippingPolicy:input_type -> header.ShippingPolicy
	12,  // 73: header.AccountMgr.DeleteShippingPolicy:input_type -> header.Id
	29,  // 74: header.AccountMgr.CreateCancellationCode:input_type -> header.CancellationCode
	12,  // 75: header.AccountMgr.ListCancellationCodes:input_type -> header.Id
	29,  // 76: header.AccountMgr.UpdateCancellationCode:input_type -> header.CancellationCode
	12,  // 77: header.AccountMgr.MakeDefaultTax:input_type -> header.Id
	12,  // 78: header.AccountMgr.ListPaymentMethods:input_type -> header.Id
	30,  // 79: header.AccountMgr.CreatePaymentMethod:input_type -> header.PaymentMethod
	30,  // 80: header.AccountMgr.UpdatePaymentMethod:input_type -> header.PaymentMethod
	12,  // 81: header.AccountMgr.DeletePaymentMethod:input_type -> header.Id
	12,  // 82: header.AccountMgr.MakeDefaultPaymentMethod:input_type -> header.Id
	13,  // 83: header.AccountMgr.ListIntegratedShippingProviders:input_type -> header.Ids
	31,  // 84: header.AccountMgr.DeintegrateShippingProvider:input_type -> header.IntegratedShipping
	31,  // 85: header.AccountMgr.IntegrateShippingProvider:input_type -> header.IntegratedShipping
	31,  // 86: header.AccountMgr.SendGHNAffiliateOTP:input_type -> header.IntegratedShipping
	31,  // 87: header.AccountMgr.EnterGHNAffiliateOTP:input_type -> header.IntegratedShipping
	32,  // 88: header.AccountMgr.UpdateAgentPresence:input_type -> account.Presence
	12,  // 89: header.AccountMgr.ListAgentPresences:input_type -> header.Id
	33,  // 90: header.AccountMgr.ReportAvailibilities:input_type -> header.AvailibilityReportRequest
	12,  // 91: header.AccountMgr.NewID:input_type -> header.Id
	12,  // 92: header.AccountMgr.LockLogin:input_type -> header.Id
	12,  // 93: header.AccountMgr.UnlockLogin:input_type -> header.Id
	34,  // 94: header.UserMgr.MergeUser:input_type -> header.Users
	12,  // 95: header.UserMgr.DetachUser:input_type -> header.Id
	35,  // 96: header.UserMgr.CreateUser:input_type -> header.User
	35,  // 97: header.UserMgr.CreateUser2:input_type -> header.User
	35,  // 98: header.UserMgr.UpdateUser2:input_type -> header.User
	35,  // 99: header.UserMgr.UpdateUser:input_type -> header.User
	35,  // 100: header.UserMgr.TryUpdateUser:input_type -> header.User
	...
	36,  // 109: header.UserMgr.UpdateView:input_type -> header.UserView
	36,  // 110: header.UserMgr.CreateView:input_type -> header.UserView
	...
	37,  // 114: header.UserMgr.UpdateSegment:input_type -> header.Segment
	37,  // 115: header.UserMgr.CreateSegment:input_type -> header.Segment
	...
	38,  // 119: header.UserMgr.ListUsers:input_type -> header.ListUserRequest
	39,  // 120: header.UserMgr.AddToSegment:input_type -> header.SegmentUsers
	39,  // 121: header.UserMgr.RemoveFromSegment:input_type -> header.SegmentUsers
	40,  // 122: header.UserMgr.UpdateUserCampaignStatus:input_type -> header.UserCampaign
	41,  // 123: header.UserMgr.UpsertLabel:input_type -> header.Label
	...
	42,  // 127: header.UserMgr.AddLeadOwner:input_type -> header.UserRequest
	42,  // 128: header.UserMgr.RemoveLeadOwner:input_type -> header.UserRequest
	42,  // 129: header.UserMgr.AddUserLabel:input_type -> header.UserRequest
	42,  // 130: header.UserMgr.RemoveUserLabel:input_type -> header.UserRequest
	42,  // 131: header.UserMgr.AddLeadConversionBy:input_type -> header.UserRequest
	25,  // 132: header.UserMgr.CreateShippingAddress:input_type -> header.Address
	25,  // 133: header.UserMgr.UpdateShippingAddress:input_type -> header.Address
	25,  // 134: header.UserMgr.RemoveShippingAddress:input_type -> header.Address
	12,  // 135: header.UserMgr.ListShippingAddress:input_type -> header.Id
	25,  // 136: header.UserMgr.MakeDefaultShippingAddress:input_type -> header.Address
	36,  // 137: header.UserMgr.ListLeads:input_type -> header.UserView
	43,  // 138: header.UserMgr.SuggestLeadField:input_type -> header.SuggestLeadFieldRequest
	44,  // 139: header.UserMgr.LinkProductUrl:input_type -> header.Product
	45,  // 140: header.UserMgr.ListUserEvents:input_type -> header.ListUserEventsRequest
	46,  // 141: header.UserMgr.CreateUserEvent:input_type -> header.Event
	47,  // 142: header.UserMgr.FillDevice:input_type -> common.Device
	48,  // 143: header.UserMgr.ImportLead:input_type -> header.ImportLeadRequest
	49,  // 144: header.UserMgr.LinkTask:input_type -> header.Task
	50,  // 145: header.UserMgr.CountUserProfiles:input_type -> header.UsersRequest
	50,  // 146: header.UserMgr.ListUserIds:input_type -> header.UsersRequest
	50,  // 147: header.UserMgr.ListUserIdWithPhones:input_type -> header.UsersRequest
	5,   // 148: header.UserMgr.SearchUsers:input_type -> header.DocSearchRequest
	51,  // 149: header.UserMgr.ReportUser:input_type -> header.UserReportRequest
	52,  // 150: header.LiveMgr.SearchLocations:input_type -> header.LocationParams
	53,  // 151: header.LiveMgr.FilterActiveUsers:input_type -> header.UserInfoParams
	...
	54,  // 156: header.LiveMgr.Presences:input_type -> header.PresencesRequest
	55,  // 157: header.NoteMgr.ListNotes:input_type -> header.ListNotesRequest
	56,  // 158: header.NoteMgr.AddNote:input_type -> header.Note
	56,  // 159: header.NoteMgr.UpdateNote:input_type -> header.Note
	57,  // 160: header.NoteMgr.DeleteNote:input_type -> header.DeleteNoteRequest
	58,  // 161: header.AttributeMgr.ListAttributeDefinitions:input_type -> header.Empty
	59,  // 162: header.AttributeMgr.CreateAttributeDefinition:input_type -> header.AttributeDefinition
	59,  // 163: header.AttributeMgr.UpdateAttributeDefinition:input_type -> header.AttributeDefinition
	60,  // 164: header.ConversationMgr.AssignRule:input_type -> header.AssignRequest
	46,  // 165: header.ConversationMgr.PongMessage:input_type -> header.Event
	61,  // 166: header.ConversationMgr.StartConversation:input_type -> header.StartRequest
	...
	62,  // 169: header.ConversationMgr.ListConversations:input_type -> header.ListConversationsRequest
	13,  // 170: header.ConversationMgr.MatchConversations:input_type -> header.Ids
	63,  // 171: header.ConversationMgr.TagConversation:input_type -> header.TagRequest
	63,  // 172: header.ConversationMgr.UntagConversation:input_type -> header.TagRequest
	64,  // 173: header.ConversationMgr.JoinConversation:input_type -> header.ConversationMember
	64,  // 174: header.ConversationMgr.LeftConversation:input_type -> header.ConversationMember
	12,  // 175: header.ConversationMgr.Typing:input_type -> header.Id
	65,  // 176: header.ConversationMgr.UpdateConversationInfo:input_type -> header.Conversation
	65,  // 177: header.ConversationMgr.UpdateMuteConversation:input_type -> header.Conversation
	64,  // 178: header.ConversationMgr.UpdateConversationMember:input_type -> header.ConversationMember
	65,  // 179: header.ConversationMgr.UnwatchConversation:input_type -> header.Conversation
	65,  // 180: header.ConversationMgr.UnhiddenConversation:input_type -> header.Conversation
	66,  // 181: header.ConversationMgr.UpdateEndchatSetting:input_type -> header.EndchatSetting
	12,  // 182: header.ConversationMgr.GetEndchatSetting:input_type -> header.Id
	67,  // 183: header.ConversationMgr.TerminateBot:input_type -> header.BotTerminated
	46,  // 184: header.ConversationMgr.SendMessage:input_type -> header.Event
	68,  // 185: header.ConversationMgr.SendOmniChannelMessage:input_type -> header.SendOmniChannelMessageRequest
	46,  // 186: header.ConversationMgr.UpdateMessage:input_type -> header.Event
	46,  // 187: header.ConversationMgr.PinMessage:input_type -> header.Event
	46,  // 188: header.ConversationMgr.UnpinMessage:input_type -> header.Event
	69,  // 189: header.ConversationMgr.ListEvents:input_type -> header.ListConversationEventsRequest
	12,  // 190: header.ConversationMgr.Deintegrate:input_type -> header.Id
	12,  // 191: header.ConversationMgr.ListIntegrations:input_type -> header.Id
	70,  // 192: header.ConversationMgr.Integrate:input_type -> header.Integration
	12,  // 193: header.ConversationMgr.GetIntegration:input_type -> header.Id
	71,  // 194: header.ConversationMgr.UpdateRule:input_type -> header.Rule
	71,  // 195: header.ConversationMgr.CreateRule:input_type -> header.Rule
	12,  // 196: header.ConversationMgr.DeleteRule:input_type -> header.Id
	12,  // 197: header.ConversationMgr.ReadRule:input_type -> header.Id
	12,  // 198: header.ConversationMgr.ListRules:input_type -> header.Id
	12,  // 199: header.ConversationMgr.ListConversationAutomations:input_type -> header.Id
	72,  // 200: header.ConversationMgr.UpdateConversationAutomation:input_type -> header.ConversationAutomation
	12,  // 201: header.ConversationMgr.DeleteConversationAutomation:input_type -> header.Id
	12,  // 202: header.ConversationMgr.ReadConversationAutomation:input_type -> header.Id
	12,  // 203: header.ConversationMgr.ListPhoneDevices:input_type -> header.Id
	73,  // 204: header.ConversationMgr.CreatePhoneDevice:input_type -> header.PhoneDevice
	73,  // 205: header.ConversationMgr.UpdatePhoneDevice:input_type -> header.PhoneDevice
	12,  // 206: header.ConversationMgr.DeletePhoneDevice:input_type -> header.Id
	12,  // 207: header.ConversationMgr.ReadPhoneDevice:input_type -> header.Id
	12,  // 208: header.ConversationMgr.TestNumber:input_type -> header.Id
	12,  // 209: header.ConversationMgr.ListCallSettings:input_type -> header.Id
	74,  // 210: header.ConversationMgr.UpdateCallSetting:input_type -> header.CallSetting
	75,  // 211: header.ConversationMgr.BlockNumber:input_type -> header.BlockedNumber
	12,  // 212: header.ConversationMgr.ListBlockedNumbers:input_type -> header.Id
	75,  // 213: header.ConversationMgr.UnblockNumber:input_type -> header.BlockedNumber
	12,  // 214: header.ConversationMgr.ListGreetingAudio:input_type -> header.Id
	76,  // 215: header.ConversationMgr.CreateGreetingAudio:input_type -> header.GreetingAudio
	61,  // 216: header.ConversationMgr.OriginateCall:input_type -> header.StartRequest
	12,  // 217: header.ConversationMgr.ListMyRecentCalls:input_type -> header.Id
	46,  // 218: header.ConversationMgr.SaveMessage:input_type -> header.Event
	46,  // 219: header.ConversationMgr.ApplyMessage:input_type -> header.Event
	77,  // 220: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	77,  // 221: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	12,  // 222: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	12,  // 223: header.TemplateMgr.GetTemplate:input_type -> header.Id
	78,  // 224: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	12,  // 225: header.TemplateMgr.PickTemplate:input_type -> header.Id
	79,  // 226: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	79,  // 227: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	...
	80,  // 231: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	81,  // 232: header.TagMgr.CreateTag:input_type -> header.Tag
	81,  // 233: header.TagMgr.UpdateTag:input_type -> header.Tag
	...
	82,  // 238: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	83,  // 239: header.Noti5Service.Noti:input_type -> header.PushNoti
	84,  // 240: header.Noti5Service.AddToken:input_type -> noti5.Token
	84,  // 241: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	84,  // 242: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	85,  // 243: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	12,  // 244: header.PaymentMgr.GetSub:input_type -> header.Id
	86,  // 245: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	86,  // 246: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	12,  // 247: header.PaymentMgr.GetSubscription:input_type -> header.Id
	87,  // 248: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	87,  // 249: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	...
	88,  // 252: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	89,  // 253: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	89,  // 254: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	90,  // 255: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	86,  // 256: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	91,  // 257: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	92,  // 258: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	93,  // 259: header.PaymentMgr.AddComment:input_type -> payment.Comment
	58,  // 260: header.PaymentMgr.ListPlans:input_type -> header.Empty
	12,  // 261: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	89,  // 262: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	94,  // 263: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	88,  // 264: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	95,  // 265: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	96,  // 266: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	97,  // 267: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	98,  // 268: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	98,  // 269: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	99,  // 270: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	12,  // 271: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	100, // 272: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	...
	101, // 275: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	...
	102, // 279: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	103, // 280: header.Pubsub.Fire:input_type -> header.PsMessage
	104, // 281: header.Pubsub.Poll:input_type -> header.RealtimeSubscription
	104, // 282: header.Pubsub.Subscribe:input_type -> header.RealtimeSubscription
	12,  // 283: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	105, // 284: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	...
	106, // 287: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	107, // 288: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	...
	107, // 292: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	12,  // 293: header.ZalokonService.ListZnsTemplates:input_type -> header.Id
	108, // 294: header.ZalokonService.RequestZaloUserInfo:input_type -> header.ZaloUserRequest
	108, // 295: header.ZalokonService.RequestZaloUserToMakeCall:input_type -> header.ZaloUserRequest
	108, // 296: header.ZalokonService.MakeSureZaloUser:input_type -> header.ZaloUserRequest
	108, // 297: header.ZalokonService.GetZaloUserCallConsent:input_type -> header.ZaloUserRequest
	109, // 298: header.ZalokonService.SendZNS:input_type -> header.ZnsRequest
	107, // 299: header.MailkonService.SendEmail:input_type -> header.Events
	70,  // 300: header.MailkonService.CreateEmailIdentity:input_type -> header.Integration
	70,  // 301: header.MailkonService.DeleteEmailIdentity:input_type -> header.Integration
	70,  // 302: header.MailkonService.ResendSenderVerificationEmail:input_type -> header.Integration
	70,  // 303: header.MailkonService.VerifySenderDomain:input_type -> header.Integration
	12,  // 304: header.MailkonService.ListBusinessEmailAddresses:input_type -> header.Id
	110, // 305: header.MailkonService.UpsertBusinessEmailAddress:input_type -> header.BusinessEmailAddress
	12,  // 306: header.MailkonService.DeleteBusinessEmailAddress:input_type -> header.Id
	111, // 307: header.MailkonService.TrackLink:input_type -> header.LinkData
	112, // 308: header.MailkonService.ListBouncedEmails:input_type -> header.BouncedEmail
	112, // 309: header.MailkonService.UpsertBouncedEmail:input_type -> header.BouncedEmail
	12,  // 310: header.MailkonService.DeleteBouncedEmail:input_type -> header.Id
	113, // 311: header.MailkonService.ListBlockedEmails:input_type -> header.BlockedEmail
	113, // 312: header.MailkonService.BlockEmail:input_type -> header.BlockedEmail
	12,  // 313: header.MailkonService.UnblockEmail:input_type -> header.Id
	12,  // 314: header.WidgetService.Read:input_type -> header.Id
	114, // 315: header.WidgetService.Update:input_type -> header.WidgetSetting
	12,  // 316: header.WidgetService.ReadUserSetting:input_type -> header.Id
	12,  // 317: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	115, // 318: header.WidgetService.SubmitImpression:input_type -> header.Impression
	116, // 319: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	117, // 320: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	118, // 321: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	119, // 322: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	119, // 323: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	120, // 324: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	12,  // 325: header.WidgetService.ListUploadedImage:input_type -> header.Id
	120, // 326: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	12,  // 327: header.WidgetService.ListWebPlugins:input_type -> header.Id
	121, // 328: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	121, // 329: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	121, // 330: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	12,  // 331: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	121, // 332: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	12,  // 333: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	12,  // 334: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	122, // 335: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	12,  // 336: header.WidgetService.SearchImages:input_type -> header.Id
	12,  // 337: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	12,  // 338: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	123, // 339: header.Bizbot.ListBots:input_type -> header.BotsRequest
	12,  // 340: header.Bizbot.GetBot:input_type -> header.Id
	124, // 341: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	124, // 342: header.Bizbot.CreateBot:input_type -> header.Bot
	124, // 343: header.Bizbot.UpdateBot:input_type -> header.Bot
	12,  // 344: header.Bizbot.DeleteBot:input_type -> header.Id
	125, // 345: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	125, // 346: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	125, // 347: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	125, // 348: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	126, // 349: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	127, // 350: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	128, // 351: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	129, // 352: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	130, // 353: header.Sendback.CreateWebhook:input_type -> header.Webhook
	12,  // 354: header.Sendback.PingWebhook:input_type -> header.Id
	12,  // 355: header.Sendback.DeleteWebhook:input_type -> header.Id
	12,  // 356: header.Sendback.ListWebhooks:input_type -> header.Id
	12,  // 357: header.Sendback.ReadWebhook:input_type -> header.Id
	130, // 358: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	12,  // 359: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	131, // 360: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	132, // 361: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	46,  // 362: header.Sendback.SendWebhookEvent:input_type -> header.Event
	133, // 363: header.Notibox.SendNoti:input_type -> header.Notification
	134, // 364: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	12,  // 365: header.Notibox.MarkReadNoti:input_type -> header.Id
	12,  // 366: header.Notibox.MarkReadNotiTopic:input_type -> header.Id
	44,  // 367: header.Proder.ReadProduct:input_type -> header.Product
	44,  // 368: header.Proder.CreateProduct:input_type -> header.Product
	44,  // 369: header.Proder.UpdateProduct:input_type -> header.Product
	12,  // 370: header.Proder.DeleteProduct:input_type -> header.Id
	135, // 371: header.Proder.ListProducts2:input_type -> header.ProductsRequest
	136, // 372: header.Proder.ImportProduct:input_type -> header.ImportProductRequest
	13,  // 373: header.Proder.ListProductCollections:input_type -> header.Ids
	137, // 374: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	137, // 375: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	12,  // 376: header.Proder.DeleteProductCollection:input_type -> header.Id
	12,  // 377: header.Proder.ListProductFeeds:input_type -> header.Id
	138, // 378: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	138, // 379: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	12,  // 380: header.Proder.DeleteProductFeed:input_type -> header.Id
	13,  // 381: header.Proder.ListProductCategories:input_type -> header.Ids
	12,  // 382: header.Proder.ReadOrder:input_type -> header.Id
	27,  // 383: header.Proder.CreateOrder:input_type -> header.Order
	27,  // 384: header.Proder.UpdateOrder:input_type -> header.Order
	12,  // 385: header.Proder.DeleteOrder:input_type -> header.Id
	139, // 386: header.Proder.ListOrders:input_type -> header.OrdersRequest
	140, // 387: header.Proder.CountOrders2:input_type -> header.CountOrdersRequest
	141, // 388: header.Proder.ImportOrders:input_type -> header.Orders
	142, // 389: header.Proder.MakeOrderPayment:input_type -> header.Bill
	143, // 390: header.Proder.DeleteOrderPayment:input_type -> header.Key
	46,  // 391: header.Proder.AddOrderComment:input_type -> header.Event
	46,  // 392: header.Proder.EditOrderComment:input_type -> header.Event
	143, // 393: header.Proder.DeleteOrderComment:input_type -> header.Key
	12,  // 394: header.Proder.ListOrderEvents:input_type -> header.Id
	144, // 395: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	12,  // 396: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	145, // 397: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	12,  // 398: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	146, // 399: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	147, // 400: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	148, // 401: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	149, // 402: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	12,  // 403: header.Proder.ShipOrder:input_type -> header.Id
	27,  // 404: header.Proder.UpdateShippingCode:input_type -> header.Order
	12,  // 405: header.Proder.CancelShippingOrder:input_type -> header.Id
	13,  // 406: header.Proder.PrintShippingOrders:input_type -> header.Ids
	12,  // 407: header.Proder.SeenOrder:input_type -> header.Id
	12,  // 408: header.Proder.FollowOrder:input_type -> header.Id
	12,  // 409: header.Proder.UnfollowOrder:input_type -> header.Id
	63,  // 410: header.Proder.TagOrder:input_type -> header.TagRequest
	63,  // 411: header.Proder.UntagOrder:input_type -> header.TagRequest
	12,  // 412: header.Proder.ReadPipeline:input_type -> header.Id
	150, // 413: header.Proder.CreatePipeline:input_type -> header.Pipeline
	150, // 414: header.Proder.UpdatePipeline:input_type -> header.Pipeline
	12,  // 415: header.Proder.DeletePipeline:input_type -> header.Id
	13,  // 416: header.Proder.ListPipelines:input_type -> header.Ids
	151, // 417: header.Proder.DeletePipelineStage:input_type -> header.PipelineStage
	12,  // 418: header.Proder.PreselectPipeline:input_type -> header.Id
	152, // 419: header.Proder.ReportOrder:input_type -> header.OrderMetricsRequest
	13,  // 420: header.Proder.MoveOrderToPrimary:input_type -> header.Ids
	12,  // 421: header.TaskMgr.ReadTask:input_type -> header.Id
	49,  // 422: header.TaskMgr.CreateTask:input_type -> header.Task
	49,  // 423: header.TaskMgr.UpdateTask:input_type -> header.Task
	12,  // 424: header.TaskMgr.DeleteTask:input_type -> header.Id
	153, // 425: header.TaskMgr.ListTasks:input_type -> header.TasksRequest
	12,  // 426: header.TaskMgr.SeenTask:input_type -> header.Id
	12,  // 427: header.TaskMgr.CloseTaskReminder:input_type -> header.Id
	12,  // 428: header.TaskMgr.MuteTask:input_type -> header.Id
	12,  // 429: header.TaskMgr.UnmuteTask:input_type -> header.Id
	46,  // 430: header.TaskMgr.AddTaskComment:input_type -> header.Event
	46,  // 431: header.TaskMgr.EditTaskComment:input_type -> header.Event
	143, // 432: header.TaskMgr.DeleteTaskComment:input_type -> header.Key
	12,  // 433: header.TaskMgr.ListTaskComments:input_type -> header.Id
	154, // 434: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	13,  // 435: header.CampaignMgr.ListCampaigns:input_type -> header.Ids
	12,  // 436: header.CampaignMgr.ReadCampaign:input_type -> header.Id
	155, // 437: header.CampaignMgr.CreateCampaign:input_type -> header.Campaign
	155, // 438: header.CampaignMgr.UpdateCampaign:input_type -> header.Campaign
	12,  // 439: header.CampaignMgr.DeleteCampaign:input_type -> header.Id
	46,  // 440: header.CampaignMgr.OnEvent:input_type -> header.Event
	156, // 441: header.CampaignMgr.ListCampaignSendLog:input_type -> header.CampaignSendLogRequest
	12,  // 442: header.CampaignMgr.ReportBroadcastCampaign:input_type -> header.Id
	157, // 443: header.CampaignMgr.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	158, // 444: header.CampaignMgr.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	159, // 445: header.CampaignMgr.ImportOutboundCall:input_type -> header.ImportOutboundCallEntryRequest
	158, // 446: header.CampaignMgr.GetOutboundCall:input_type -> header.OutboundCallEntry
	158, // 447: header.CampaignMgr.RemoveOutboudCall:input_type -> header.OutboundCallEntry
	160, // 448: header.CampaignMgr.ReportOutboundCalls:input_type -> header.OutboundCallReportRequest
	157, // 449: header.CampaignMgr.ReassignOutboundCall:input_type -> header.ListOutboundCallRequest
	161, // 450: header.CreditMgr.TrySpendCredit:input_type -> header.CreditSpendEntry
	162, // 451: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	163, // 452: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	12,  // 453: header.CreditMgr.ListCredits:input_type -> header.Id
	164, // 454: header.CreditMgr.AddCredit:input_type -> header.Credit
	12,  // 455: header.CreditMgr.DeleteCredit:input_type -> header.Id
	164, // 456: header.CreditMgr.UpdateCredit:input_type -> header.Credit
	12,  // 457: header.FormMgr.ListForms:input_type -> header.Id
	165, // 458: header.FormMgr.CreateForm:input_type -> header.Form
	165, // 459: header.FormMgr.UpdateForm:input_type -> header.Form
	12,  // 460: header.FormMgr.DeleteForm:input_type -> header.Id
	166, // 461: header.FormMgr.ReportForm:input_type -> header.FormReportRequest
	167, // 462: header.FormMgr.ListFormSubmissions:input_type -> header.ListFormSubmissionRequest
	168, // 463: header.Scheduler.RegisterTask:input_type -> header.SchedulerTask
	168, // 464: header.Scheduler.UnregisterTask:input_type -> header.SchedulerTask
	58,  // 465: header.GooglekonService.DeleteRely:output_type -> header.Empty
	0,   // 466: header.GooglekonService.GetReview:output_type -> googlekon.GGReview
	169, // 467: header.GooglekonService.ListReviews:output_type -> googlekon.GGListReviews
	2,   // 468: header.GooglekonService.UpdateRely:output_type -> googlekon.GGReviewReply
	170, // 469: header.GooglekonService.ListReviewsLocations:output_type -> googlekon.GGReviewsInLocations
	171, // 470: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	58,  // 471: header.DocSearch.IndexConvo:output_type -> header.Empty
	172, // 472: header.DocSearch.SearchConvos:output_type -> header.DocSearchResponse
	173, // 473: header.DocSearch.ReportConversation:output_type -> header.ConversationMetrics
	174, // 474: header.DocSearch.ListConversationIds:output_type -> header.Conversations
	175, // 475: header.DocSearch.ReportCall:output_type -> header.CallMetrics
	174, // 476: header.DocSearch.ListCallIds:output_type -> header.Conversations
	176, // 477: header.DocSearch.ReportAgent:output_type -> header.AgentMetrics
	10,  // 478: header.NumberRegistry.Compact:output_type -> header.Number
	9,   // 479: header.NumberRegistry.Uncompact:output_type -> header.String
	177, // 480: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	25,  // 481: header.Map.LookupAddress:output_type -> header.Address
	178, // 482: header.Map.PredictAddress:output_type -> header.Addresses
	178, // 483: header.Map.ListDistricts:output_type -> header.Addresses
	178, // 484: header.Map.ListProvinces:output_type -> header.Addresses
	178, // 485: header.Map.ListWards:output_type -> header.Addresses
	178, // 486: header.Map.ListStreets:output_type -> header.Addresses
	178, // 487: header.Map.ListAddresses:output_type -> header.Addresses
	25,  // 488: header.Map.ReadAddress:output_type -> header.Address
	14,  // 489: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	14,  // 490: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	14,  // 491: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	58,  // 492: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	17,  // 493: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	17,  // 494: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	17,  // 495: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	18,  // 496: header.AccountMgr.DeleteAccount:output_type -> account.Account
	18,  // 497: header.AccountMgr.SubizUpdateAccount:output_type -> account.Account
	58,  // 498: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	17,  // 499: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	17,  // 500: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	17,  // 501: header.AccountMgr.GetInvitation:output_type -> account.Agent
	17,  // 502: header.AccountMgr.InviteAgent:output_type -> account.Agent
	17,  // 503: header.AccountMgr.GetAgent:output_type -> account.Agent
	17,  // 504: header.AccountMgr.LookupAgentById:output_type -> account.Agent
	18,  // 505: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	18,  // 506: header.AccountMgr.GetAccount:output_type -> account.Account
	18,  // 507: header.AccountMgr.UpdateAccount:output_type -> account.Account
	18,  // 508: header.AccountMgr.CreateAccount:output_type -> account.Account
	179, // 509: header.AccountMgr.ListAgents:output_type -> account.Agents
	58,  // 510: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	180, // 511: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	17,  // 512: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	181, // 513: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	17,  // 514: header.AccountMgr.TransferOwner:output_type -> account.Agent
	22,  // 515: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	182, // 516: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	182, // 517: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	58,  // 518: header.AccountMgr.LogoutSession:output_type -> header.Empty
	22,  // 519: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	183, // 520: header.AccountMgr.GetLanguage:output_type -> header.Lang
	23,  // 521: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	24,  // 522: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	24,  // 523: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	184, // 524: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	58,  // 525: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	178, // 526: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	25,  // 527: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	25,  // 528: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	58,  // 529: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	185, // 530: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	26,  // 531: header.AccountMgr.CreateTax:output_type -> header.Tax
	26,  // 532: header.AccountMgr.UpdateTax:output_type -> header.Tax
	58,  // 533: header.AccountMgr.DeleteTax:output_type -> header.Empty
	186, // 534: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	186, // 535: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	28,  // 536: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	28,  // 537: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	58,  // 538: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	29,  // 539: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	187, // 540: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	29,  // 541: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	58,  // 542: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	188, // 543: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	30,  // 544: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	30,  // 545: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	58,  // 546: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	58,  // 547: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	189, // 548: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	58,  // 549: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	31,  // 550: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	31,  // 551: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	31,  // 552: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	32,  // 553: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	190, // 554: header.AccountMgr.ListAgentPresences:output_type -> account.Presences
	191, // 555: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	12,  // 556: header.AccountMgr.NewID:output_type -> header.Id
	12,  // 557: header.AccountMgr.LockLogin:output_type -> header.Id
	12,  // 558: header.AccountMgr.UnlockLogin:output_type -> header.Id
	35,  // 559: header.UserMgr.MergeUser:output_type -> header.User
	58,  // 560: header.UserMgr.DetachUser:output_type -> header.Empty
	12,  // 561: header.UserMgr.CreateUser:output_type -> header.Id
	35,  // 562: header.UserMgr.CreateUser2:output_type -> header.User
	35,  // 563: header.UserMgr.UpdateUser2:output_type -> header.User
	35,  // 564: header.UserMgr.UpdateUser:output_type -> header.User
	192, // 565: header.UserMgr.TryUpdateUser:output_type -> header.TryUpdateUserResult
	...
	193, // 578: header.UserMgr.ListViews:output_type -> header.UserViews
	...
	194, // 583: header.UserMgr.ListSegments:output_type -> header.Segments
	...
	195, // 590: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	196, // 600: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	...
	197, // 603: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	44,  // 604: header.UserMgr.LinkProductUrl:output_type -> header.Product
	107, // 605: header.UserMgr.ListUserEvents:output_type -> header.Events
	46,  // 606: header.UserMgr.CreateUserEvent:output_type -> header.Event
	47,  // 607: header.UserMgr.FillDevice:output_type -> common.Device
	198, // 608: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	58,  // 609: header.UserMgr.LinkTask:output_type -> header.Empty
	199, // 610: header.UserMgr.CountUserProfiles:output_type -> header.CountTouchpointResponse
	13,  // 611: header.UserMgr.ListUserIds:output_type -> header.Ids
	34,  // 612: header.UserMgr.ListUserIdWithPhones:output_type -> header.Users
	172, // 613: header.UserMgr.SearchUsers:output_type -> header.DocSearchResponse
	200, // 614: header.UserMgr.ReportUser:output_type -> header.UserReportResponse
	201, // 615: header.LiveMgr.SearchLocations:output_type -> header.Locations
	34,  // 616: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	202, // 617: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	203, // 618: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	204, // 619: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	205, // 620: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	206, // 621: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	207, // 622: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	208, // 626: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	209, // 629: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	174, // 634: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	174, // 635: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	58,  // 640: header.ConversationMgr.Typing:output_type -> header.Empty
	...
	107, // 654: header.ConversationMgr.ListEvents:output_type -> header.Events
	58,  // 655: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	210, // 656: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	211, // 663: header.ConversationMgr.ListRules:output_type -> header.Route
	212, // 664: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	213, // 668: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	214, // 674: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	215, // 677: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	58,  // 678: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	216, // 679: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	217, // 682: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	218, // 689: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	219, // 695: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	220, // 696: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	221, // 700: header.TagMgr.ListTags:output_type -> header.Tags
	...
	222, // 708: header.PaymentMgr.SearchSub:output_type -> header.AccSubs
	223, // 709: header.PaymentMgr.GetSub:output_type -> header.AccSub
	...
	224, // 716: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	225, // 717: header.PaymentMgr.Pay:output_type -> payment.Bill
	...
	226, // 720: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	227, // 723: header.PaymentMgr.ListComments:output_type -> payment.Comments
	93,  // 724: header.PaymentMgr.AddComment:output_type -> payment.Comment
	228, // 725: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	97,  // 726: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	97,  // 727: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	94,  // 728: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	225, // 729: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	229, // 730: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	96,  // 731: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	96,  // 732: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	58,  // 733: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	96,  // 734: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	230, // 735: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	58,  // 736: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	101, // 737: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	101, // 738: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	231, // 739: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	101, // 740: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	232, // 741: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	233, // 742: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	234, // 743: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	58,  // 744: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	58,  // 745: header.Pubsub.Fire:output_type -> header.Empty
	235, // 746: header.Pubsub.Poll:output_type -> header.PollResult
	104, // 747: header.Pubsub.Subscribe:output_type -> header.RealtimeSubscription
	105, // 748: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	105, // 749: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	236, // 750: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	237, // 751: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	106, // 752: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	58,  // 753: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	58,  // 754: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	58,  // 755: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	12,  // 756: header.FabikonService.GenerateRefLink:output_type -> header.Id
	58,  // 757: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	238, // 758: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	58,  // 759: header.ZalokonService.RequestZaloUserInfo:output_type -> header.Empty
	58,  // 760: header.ZalokonService.RequestZaloUserToMakeCall:output_type -> header.Empty
	58,  // 761: header.ZalokonService.MakeSureZaloUser:output_type -> header.Empty
	239, // 762: header.ZalokonService.GetZaloUserCallConsent:output_type -> header.Response
	46,  // 763: header.ZalokonService.SendZNS:output_type -> header.Event
	58,  // 764: header.MailkonService.SendEmail:output_type -> header.Empty
	70,  // 765: header.MailkonService.CreateEmailIdentity:output_type -> header.Integration
	58,  // 766: header.MailkonService.DeleteEmailIdentity:output_type -> header.Empty
	58,  // 767: header.MailkonService.ResendSenderVerificationEmail:output_type -> header.Empty
	240, // 768: header.MailkonService.VerifySenderDomain:output_type -> header.EmailSenderVerificationResult
	241, // 769: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	110, // 770: header.MailkonService.UpsertBusinessEmailAddress:output_type -> header.BusinessEmailAddress
	58,  // 771: header.MailkonService.DeleteBusinessEmailAddress:output_type -> header.Empty
	239, // 772: header.MailkonService.TrackLink:output_type -> header.Response
	239, // 773: header.MailkonService.ListBouncedEmails:output_type -> header.Response
	112, // 774: header.MailkonService.UpsertBouncedEmail:output_type -> header.BouncedEmail
	239, // 775: header.MailkonService.DeleteBouncedEmail:output_type -> header.Response
	239, // 776: header.MailkonService.ListBlockedEmails:output_type -> header.Response
	239, // 777: header.MailkonService.BlockEmail:output_type -> header.Response
	239, // 778: header.MailkonService.UnblockEmail:output_type -> header.Response
	114, // 779: header.WidgetService.Read:output_type -> header.WidgetSetting
	114, // 780: header.WidgetService.Update:output_type -> header.WidgetSetting
	242, // 781: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	243, // 782: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	115, // 783: header.WidgetService.SubmitImpression:output_type -> header.Impression
	116, // 784: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	117, // 785: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	244, // 786: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	245, // 787: header.WidgetService.ListConversions:output_type -> header.Conversions
	246, // 788: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	120, // 789: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	247, // 790: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	58,  // 791: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	248, // 792: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	121, // 793: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	121, // 794: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	121, // 795: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	58,  // 796: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	121, // 797: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	248, // 798: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	58,  // 799: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	249, // 800: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	247, // 801: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	250, // 802: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	251, // 803: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	252, // 804: header.Bizbot.ListBots:output_type -> header.Bots
	124, // 805: header.Bizbot.GetBot:output_type -> header.Bot
	124, // 806: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	124, // 807: header.Bizbot.CreateBot:output_type -> header.Bot
	124, // 808: header.Bizbot.UpdateBot:output_type -> header.Bot
	58,  // 809: header.Bizbot.DeleteBot:output_type -> header.Empty
	58,  // 810: header.Bizbot.OnEvent:output_type -> header.Empty
	58,  // 811: header.Bizbot.StartBot:output_type -> header.Empty
	58,  // 812: header.Bizbot.StopBot:output_type -> header.Empty
	58,  // 813: header.Bizbot.TryAction:output_type -> header.Empty
	253, // 814: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	254, // 815: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	255, // 816: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	256, // 817: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	130, // 818: header.Sendback.CreateWebhook:output_type -> header.Webhook
	257, // 819: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	58,  // 820: header.Sendback.DeleteWebhook:output_type -> header.Empty
	258, // 821: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	130, // 822: header.Sendback.ReadWebhook:output_type -> header.Webhook
	130, // 823: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	130, // 824: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	259, // 825: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	260, // 826: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	58,  // 827: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	58,  // 828: header.Notibox.SendNoti:output_type -> header.Empty
	261, // 829: header.Notibox.ListNoties:output_type -> header.Notifications
	58,  // 830: header.Notibox.MarkReadNoti:output_type -> header.Empty
	58,  // 831: header.Notibox.MarkReadNotiTopic:output_type -> header.Empty
	44,  // 832: header.Proder.ReadProduct:output_type -> header.Product
	44,  // 833: header.Proder.CreateProduct:output_type -> header.Product
	44,  // 834: header.Proder.UpdateProduct:output_type -> header.Product
	58,  // 835: header.Proder.DeleteProduct:output_type -> header.Empty
	...
	137, // 839: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	137, // 840: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	58,  // 841: header.Proder.DeleteProductCollection:output_type -> header.Empty
	265, // 842: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	138, // 843: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	138, // 844: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	58,  // 845: header.Proder.DeleteProductFeed:output_type -> header.Empty
	266, // 846: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	27,  // 847: header.Proder.ReadOrder:output_type -> header.Order
	27,  // 848: header.Proder.CreateOrder:output_type -> header.Order
	27,  // 849: header.Proder.UpdateOrder:output_type -> header.Order
	58,  // 850: header.Proder.DeleteOrder:output_type -> header.Empty
	141, // 851: header.Proder.ListOrders:output_type -> header.Orders
	267, // 852: header.Proder.CountOrders2:output_type -> header.CountOrdersResponse
	141, // 853: header.Proder.ImportOrders:output_type -> header.Orders
	46,  // 854: header.Proder.MakeOrderPayment:output_type -> header.Event
	46,  // 855: header.Proder.DeleteOrderPayment:output_type -> header.Event
	46,  // 856: header.Proder.AddOrderComment:output_type -> header.Event
	46,  // 857: header.Proder.EditOrderComment:output_type -> header.Event
	46,  // 858: header.Proder.DeleteOrderComment:output_type -> header.Event
	268, // 859: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	269, // 860: header.Proder.DownloadOrder:output_type -> header.File
	12,  // 861: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	270, // 862: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	58,  // 863: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	271, // 864: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	58,  // 865: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	58,  // 866: header.Proder.GHNShippingStatus:output_type -> header.Empty
	149, // 867: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	27,  // 868: header.Proder.ShipOrder:output_type -> header.Order
	27,  // 869: header.Proder.UpdateShippingCode:output_type -> header.Order
	27,  // 870: header.Proder.CancelShippingOrder:output_type -> header.Order
	269, // 871: header.Proder.PrintShippingOrders:output_type -> header.File
	58,  // 872: header.Proder.SeenOrder:output_type -> header.Empty
	58,  // 873: header.Proder.FollowOrder:output_type -> header.Empty
	58,  // 874: header.Proder.UnfollowOrder:output_type -> header.Empty
	58,  // 875: header.Proder.TagOrder:output_type -> header.Empty
	58,  // 876: header.Proder.UntagOrder:output_type -> header.Empty
	150, // 877: header.Proder.ReadPipeline:output_type -> header.Pipeline
	150, // 878: header.Proder.CreatePipeline:output_type -> header.Pipeline
	150, // 879: header.Proder.UpdatePipeline:output_type -> header.Pipeline
	58,  // 880: header.Proder.DeletePipeline:output_type -> header.Empty
	272, // 881: header.Proder.ListPipelines:output_type -> header.Pipelines
	58,  // 882: header.Proder.DeletePipelineStage:output_type -> header.Empty
	150, // 883: header.Proder.PreselectPipeline:output_type -> header.Pipeline
	141, // 884: header.Proder.ReportOrder:output_type -> header.Orders
	58,  // 885: header.Proder.MoveOrderToPrimary:output_type -> header.Empty
	49,  // 886: header.TaskMgr.ReadTask:output_type -> header.Task
	49,  // 887: header.TaskMgr.CreateTask:output_type -> header.Task
	49,  // 888: header.TaskMgr.UpdateTask:output_type -> header.Task
	58,  // 889: header.TaskMgr.DeleteTask:output_type -> header.Empty
	273, // 890: header.TaskMgr.ListTasks:output_type -> header.Tasks
	58,  // 891: header.TaskMgr.SeenTask:output_type -> header.Empty
	58,  // 892: header.TaskMgr.CloseTaskReminder:output_type -> header.Empty
	58,  // 893: header.TaskMgr.MuteTask:output_type -> header.Empty
	58,  // 894: header.TaskMgr.UnmuteTask:output_type -> header.Empty
	46,  // 895: header.TaskMgr.AddTaskComment:output_type -> header.Event
	46,  // 896: header.TaskMgr.EditTaskComment:output_type -> header.Event
	46,  // 897: header.TaskMgr.DeleteTaskComment:output_type -> header.Event
	274, // 898: header.TaskMgr.ListTaskComments:output_type -> header.TaskHistoryEntries
	154, // 899: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	275, // 900: header.CampaignMgr.ListCampaigns:output_type -> header.Campaigns
	155, // 901: header.CampaignMgr.ReadCampaign:output_type -> header.Campaign
	155, // 902: header.CampaignMgr.CreateCampaign:output_type -> header.Campaign
	155, // 903: header.CampaignMgr.UpdateCampaign:output_type -> header.Campaign
	58,  // 904: header.CampaignMgr.DeleteCampaign:output_type -> header.Empty
	58,  // 905: header.CampaignMgr.OnEvent:output_type -> header.Empty
	276, // 906: header.CampaignMgr.ListCampaignSendLog:output_type -> header.CampaignSendLog
	277, // 907: header.CampaignMgr.ReportBroadcastCampaign:output_type -> header.BroadcastCampaignMetrics
	278, // 908: header.CampaignMgr.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	158, // 909: header.CampaignMgr.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	279, // 910: header.CampaignMgr.ImportOutboundCall:output_type -> header.ImportOutboundCallEntryResponse
	158, // 911: header.CampaignMgr.GetOutboundCall:output_type -> header.OutboundCallEntry
	58,  // 912: header.CampaignMgr.RemoveOutboudCall:output_type -> header.Empty
	280, // 913: header.CampaignMgr.ReportOutboundCalls:output_type -> header.OutboundCallReportResponse
	58,  // 914: header.CampaignMgr.ReassignOutboundCall:output_type -> header.Empty
	281, // 915: header.CreditMgr.TrySpendCredit:output_type -> header.TrySpendCreditResponse
	282, // 916: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	283, // 917: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	239, // 918: header.CreditMgr.ListCredits:output_type -> header.Response
	239, // 919: header.CreditMgr.AddCredit:output_type -> header.Response
	239, // 920: header.CreditMgr.DeleteCredit:output_type -> header.Response
	239, // 921: header.CreditMgr.UpdateCredit:output_type -> header.Response
	284, // 922: header.FormMgr.ListForms:output_type -> header.Forms
	165, // 923: header.FormMgr.CreateForm:output_type -> header.Form
	165, // 924: header.FormMgr.UpdateForm:output_type -> header.Form
	58,  // 925: header.FormMgr.DeleteForm:output_type -> header.Empty
	285, // 926: header.FormMgr.ReportForm:output_type -> header.FormReportResponse
	286, // 927: header.FormMgr.ListFormSubmissions:output_type -> header.FormSubmissions
	168, // 928: header.Scheduler.RegisterTask:output_type -> header.SchedulerTask
	239, // 929: header.Scheduler.UnregisterTask:output_type -> header.Response
