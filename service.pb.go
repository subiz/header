...
var file_service_proto_rawDesc = []byte{
	...
	0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x88, 0x16, 0x0a, 0x0f,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xab, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x6d, 0x70, 0x6c,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x2e, 0x57, 0x65, 0x62, 0x70, 0x61, 0x67, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x32, 0x80,
...
var file_service_proto_depIdxs = []int32{
	...
	65,  // 178: header.ConversationMgr.BlockNumber:input_type -> header.BlockedNumber
	4,   // 179: header.ConversationMgr.ListBlockedNumbers:input_type -> header.Id
	65,  // 180: header.ConversationMgr.UnblockNumber:input_type -> header.BlockedNumber
	66,  // 181: header.TemplateMgr.CreateTemplate:input_type -> header.Template
	66,  // 182: header.TemplateMgr.UpdateTemplate:input_type -> header.Template
	4,   // 183: header.TemplateMgr.DeleteTemplate:input_type -> header.Id
	4,   // 184: header.TemplateMgr.GetTemplate:input_type -> header.Id
	67,  // 185: header.TemplateMgr.ListTemplates:input_type -> header.SearchTemplate
	4,   // 186: header.TemplateMgr.PickTemplate:input_type -> header.Id
	68,  // 187: header.TemplateMgr.CreateModal:input_type -> header.ConversationModal
	68,  // 188: header.TemplateMgr.UpdateModal:input_type -> header.ConversationModal
	4,   // 189: header.TemplateMgr.DeleteModal:input_type -> header.Id
	4,   // 190: header.TemplateMgr.GetModal:input_type -> header.Id
	4,   // 191: header.TemplateMgr.ListModals:input_type -> header.Id
	69,  // 192: header.TemplateMgr.PickModal:input_type -> header.ConversationModalPickRequest
	70,  // 193: header.TagMgr.CreateTag:input_type -> header.Tag
	70,  // 194: header.TagMgr.UpdateTag:input_type -> header.Tag
	4,   // 195: header.TagMgr.DeleteTag:input_type -> header.Id
	4,   // 196: header.TagMgr.ListTags:input_type -> header.Id
	4,   // 197: header.TagMgr.GetTag:input_type -> header.Id
	37,  // 198: header.EventMgr.SearchEvents:input_type -> header.ListUserEventsRequest
	71,  // 199: header.EventMgr.CreateEvent:input_type -> header.UserEvent
	72,  // 200: header.FileMgr.Presign:input_type -> header.FileHeader
	73,  // 201: header.FileMgr.Uploaded:input_type -> header.FileRequest
	74,  // 202: header.FileMgr.DownloadFileUrl:input_type -> header.FileUrlDownloadRequest
	4,   // 203: header.Noti5Service.ReadNotificationSetting:input_type -> header.Id
	75,  // 204: header.Noti5Service.UpdateNotificationSetting:input_type -> noti5.Setting
	76,  // 205: header.Noti5Service.Noti:input_type -> header.PushNoti
	77,  // 206: header.Noti5Service.AddToken:input_type -> noti5.Token
	77,  // 207: header.Noti5Service.RemoveToken:input_type -> noti5.Token
	77,  // 208: header.Noti5Service.CheckTokenExists:input_type -> noti5.Token
	78,  // 209: header.SubizInternalPaymentMgr.CreateBill:input_type -> payment.Bill
	79,  // 210: header.PaymentMgr.SearchSub:input_type -> account.SearchSubRequest
	80,  // 211: header.PaymentMgr.Purchase:input_type -> payment.Subscription
	80,  // 212: header.PaymentMgr.UpdateSubscription:input_type -> payment.Subscription
	4,   // 213: header.PaymentMgr.GetSubscription:input_type -> header.Id
	81,  // 214: header.PaymentMgr.AddPaymentMethod:input_type -> payment.PaymentMethod
	81,  // 215: header.PaymentMgr.UpdatePaymentMethod:input_type -> payment.PaymentMethod
	4,   // 216: header.PaymentMgr.DeletePaymentMethod:input_type -> header.Id
	4,   // 217: header.PaymentMgr.ListPaymentMethods:input_type -> header.Id
	82,  // 218: header.PaymentMgr.Pay:input_type -> payment.PayRequest
	83,  // 219: header.PaymentMgr.CreateInvoice:input_type -> payment.Invoice
	83,  // 220: header.PaymentMgr.UpdateInvoice:input_type -> payment.Invoice
	84,  // 221: header.PaymentMgr.FilterInvoices:input_type -> payment.ListInvoiceRequest
	80,  // 222: header.PaymentMgr.DraftInvoice:input_type -> payment.Subscription
	85,  // 223: header.PaymentMgr.DiffSubscriptions:input_type -> payment.DiffSubRequest
	86,  // 224: header.PaymentMgr.ListComments:input_type -> payment.ListCommentsRequest
	87,  // 225: header.PaymentMgr.AddComment:input_type -> payment.Comment
	47,  // 226: header.PaymentMgr.ListPlans:input_type -> header.Empty
	4,   // 227: header.PaymentMgr.ExportInvoice:input_type -> header.Id
	83,  // 228: header.PaymentMgr.ConvertInvoiceToHtml:input_type -> payment.Invoice
	88,  // 229: header.PaymentMgr.GetExchangeRate:input_type -> header.ExchangeRate
	82,  // 230: header.PaymentMgr.TransferMoney:input_type -> payment.PayRequest
	89,  // 231: header.PaymentMgr.ListLogs:input_type -> payment.ListLogsRequest
	90,  // 232: header.PaymentMgr.CreatePromotionCode:input_type -> payment.PromotionCode
	91,  // 233: header.PaymentMgr.GetPromotionCode:input_type -> payment.String
	92,  // 234: header.PaymentMgr.UsePromotionCode:input_type -> payment.PromotionCodeRequest
	92,  // 235: header.PaymentMgr.ValidatePromotionCode:input_type -> payment.PromotionCodeRequest
	93,  // 236: header.PaymentMgr.ListPromotionCode:input_type -> payment.ListPromotionCodeRequest
	4,   // 237: header.PaymentMgr.DeletePromotionCode:input_type -> header.Id
	94,  // 238: header.PaymentMgr.SearchReferral:input_type -> payment.SearchReferredRequest
	4,   // 239: header.PaymentMgr.GetReferral:input_type -> header.Id
	47,  // 240: header.PaymentMgr.ListTopReferral:input_type -> header.Empty
	95,  // 241: header.PaymentMgr.UpdateReferral:input_type -> payment.Referral
	4,   // 242: header.PaymentMgr.ListAccountReferred:input_type -> header.Id
	4,   // 243: header.PaymentMgr.ListBillByAccountReferred:input_type -> header.Id
	4,   // 244: header.PaymentMgr.ListPaidForAgentReferrer:input_type -> header.Id
	96,  // 245: header.PaymentMgr.PaidForAgentReferrer:input_type -> payment.LogPaidForAgentReferrer
	97,  // 246: header.Pubsub.Publish:input_type -> header.PublishMessage
	4,   // 247: header.FabikonService.ReadFbFanpageSetting:input_type -> header.Id
	98,  // 248: header.FabikonService.UpdateFbFanpageSetting:input_type -> header.FbFanpageSetting
	4,   // 249: header.FabikonService.ListFbFanpageSettings:input_type -> header.Id
	4,   // 250: header.FabikonService.ListFbPosts:input_type -> header.Id
	99,  // 251: header.FabikonService.GetFbPost:input_type -> header.FacebookPost
	100, // 252: header.FabikonService.SendEventToFacebook:input_type -> header.Events
	100, // 253: header.ZalokonService.SendEventToZalo:input_type -> header.Events
	100, // 254: header.MailkonService.SendEvent:input_type -> header.Events
	4,   // 255: header.MailkonService.ListBlockedEmails:input_type -> header.Id
	4,   // 256: header.MailkonService.BlockEmail:input_type -> header.Id
	4,   // 257: header.MailkonService.UnblockEmail:input_type -> header.Id
	4,   // 258: header.WidgetService.Read:input_type -> header.Id
	101, // 259: header.WidgetService.Update:input_type -> header.WidgetSetting
	4,   // 260: header.WidgetService.ReadUserSetting:input_type -> header.Id
	4,   // 261: header.WidgetService.ReadAccountSetting:input_type -> header.Id
	102, // 262: header.WidgetService.SubmitImpression:input_type -> header.Impression
	103, // 263: header.WidgetService.SubmitConversion:input_type -> header.Conversion
	104, // 264: header.WidgetService.SubmitUserCampaignStatus:input_type -> header.UserCampaignStatus
	105, // 265: header.WidgetService.ReportCampaign:input_type -> header.ReportCampaignRequest
	106, // 266: header.WidgetService.ListConversions:input_type -> header.ConversionRequest
	106, // 267: header.WidgetService.ExportConversions:input_type -> header.ConversionRequest
	107, // 268: header.WidgetService.UploadImage:input_type -> header.UploadedImage
	4,   // 269: header.WidgetService.ListUploadedImage:input_type -> header.Id
	107, // 270: header.WidgetService.DeleteUploadedImage:input_type -> header.UploadedImage
	4,   // 271: header.WidgetService.ListWebPlugins:input_type -> header.Id
	108, // 272: header.WidgetService.UpdateWebPlugin:input_type -> header.WebPlugin
	108, // 273: header.WidgetService.UpdateWebPluginEnabled:input_type -> header.WebPlugin
	108, // 274: header.WidgetService.CreateWebPlugin:input_type -> header.WebPlugin
	4,   // 275: header.WidgetService.DeleteWebPlugin:input_type -> header.Id
	108, // 276: header.WidgetService.UpdateWebPluginTemplate:input_type -> header.WebPlugin
	4,   // 277: header.WidgetService.ListWebPluginTemplates:input_type -> header.Id
	4,   // 278: header.WidgetService.DeleteWebPluginTemplate:input_type -> header.Id
	109, // 279: header.WidgetService.ReportWebPlugin:input_type -> header.ReportWebPluginRequest
	4,   // 280: header.WidgetService.SearchImages:input_type -> header.Id
	4,   // 281: header.WidgetService.ListNotifProfiles:input_type -> header.Id
	4,   // 282: header.WidgetService.ListNotifBackgrounds:input_type -> header.Id
	4,   // 283: header.Bizbot.ListBots:input_type -> header.Id
	4,   // 284: header.Bizbot.GetBot:input_type -> header.Id
	110, // 285: header.Bizbot.UpdateBotRunState:input_type -> header.Bot
	110, // 286: header.Bizbot.CreateBot:input_type -> header.Bot
	110, // 287: header.Bizbot.UpdateBot:input_type -> header.Bot
	4,   // 288: header.Bizbot.DeleteBot:input_type -> header.Id
	111, // 289: header.Bizbot.OnEvent:input_type -> header.BotRunRequest
	111, // 290: header.Bizbot.StartBot:input_type -> header.BotRunRequest
	111, // 291: header.Bizbot.StopBot:input_type -> header.BotRunRequest
	111, // 292: header.Bizbot.TryAction:input_type -> header.BotRunRequest
	112, // 293: header.Bizbot.ReportBot2:input_type -> header.BotrunMetricsRequest
	113, // 294: header.Bizbot.ReportAction:input_type -> header.ActionrunMetricsRequest
	114, // 295: header.Bizbot.ListObjects:input_type -> header.ListObjectsRequest
	115, // 296: header.Bizbot.ReportBot:input_type -> header.ReportBotRequest
	116, // 297: header.Sendback.CreateWebhook:input_type -> header.Webhook
	4,   // 298: header.Sendback.PingWebhook:input_type -> header.Id
	4,   // 299: header.Sendback.DeleteWebhook:input_type -> header.Id
	4,   // 300: header.Sendback.ListWebhooks:input_type -> header.Id
	4,   // 301: header.Sendback.ReadWebhook:input_type -> header.Id
	116, // 302: header.Sendback.UpdateWebhook:input_type -> header.Webhook
	4,   // 303: header.Sendback.UpdateWebhookSecret:input_type -> header.Id
	117, // 304: header.Sendback.ListRecentIndexDeliveries:input_type -> header.RecentIndexDeliveryRequest
	118, // 305: header.Sendback.GetDelivery:input_type -> header.DeliveryRequest
	38,  // 306: header.Sendback.SendWebhookEvent:input_type -> header.Event
	119, // 307: header.Notibox.SendNoti:input_type -> header.Notification
	120, // 308: header.Notibox.ListNoties:input_type -> header.ListNotiRequest
	4,   // 309: header.Notibox.MarkReadNoti:input_type -> header.Id
	121, // 310: header.Watchhttp.CreateWebpage:input_type -> header.Webpage
	4,   // 311: header.Watchhttp.DeleteWebpage:input_type -> header.Id
	4,   // 312: header.Watchhttp.ListWebpages:input_type -> header.Id
	121, // 313: header.Watchhttp.UpdateWebpage:input_type -> header.Webpage
	4,   // 314: header.Watchhttp.ReadWebpage:input_type -> header.Id
	122, // 315: header.Watchhttp.ListRecentWebpageChecks:input_type -> header.RecentWebpageCheckRequest
	123, // 316: header.Watchhttp.ReadWebpageCheck:input_type -> header.WebpageCheckRequest
	124, // 317: header.Watchhttp.ReportWebpageChecks:input_type -> header.WebpageReportRequest
	124, // 318: header.Watchhttp.SummaryWebpageChecks:input_type -> header.WebpageReportRequest
	9,   // 319: header.Holap.AppendAgentSet:input_type -> account.Agent
	70,  // 320: header.Holap.AppendTagSet:input_type -> header.Tag
	31,  // 321: header.Holap.UpdateUser:input_type -> header.User
	54,  // 322: header.Holap.UpdateConversation:input_type -> header.Conversation
	38,  // 323: header.Holap.OnConversationEvent:input_type -> header.Event
	125, // 324: header.Holap.FreeAccount:input_type -> header.AccountImage
	126, // 325: header.Holap.ReportUser:input_type -> header.UserMetricsRequest
	127, // 326: header.Holap.ReportConversation:input_type -> header.ConversationMetricsRequest
	126, // 327: header.Holap.ListUserIds:input_type -> header.UserMetricsRequest
	127, // 328: header.Holap.ListConversationIds:input_type -> header.ConversationMetricsRequest
	128, // 329: header.Holap.ReportAgent:input_type -> header.AgentMetricsRequest
	5,   // 330: header.Holap.ListChannelTouchpoints:input_type -> header.Ids
	32,  // 331: header.Holap.ReportUserEvent:input_type -> header.UserEventMetricsRequest
	22,  // 332: header.Holap.UpdateOrder:input_type -> header.Order
	129, // 333: header.Holap.ReportOrder:input_type -> header.OrderMetricsRequest
	36,  // 334: header.Proder.ReadProduct:input_type -> header.Product
	36,  // 335: header.Proder.CreateProduct:input_type -> header.Product
	36,  // 336: header.Proder.UpdateProduct:input_type -> header.Product
	4,   // 337: header.Proder.DeleteProduct:input_type -> header.Id
	4,   // 338: header.Proder.RestoreProduct:input_type -> header.Id
	130, // 339: header.Proder.ListProducts:input_type -> header.ProductsRequest
	5,   // 340: header.Proder.ListProductIds:input_type -> header.Ids
	130, // 341: header.Proder.ListGroupedProducts:input_type -> header.ProductsRequest
	131, // 342: header.Proder.ImportProducts:input_type -> header.Products
	5,   // 343: header.Proder.ListProductCollections:input_type -> header.Ids
	132, // 344: header.Proder.CreateProductCollection:input_type -> header.ProductCollection
	132, // 345: header.Proder.UpdateProductCollection:input_type -> header.ProductCollection
	4,   // 346: header.Proder.DeleteProductCollection:input_type -> header.Id
	4,   // 347: header.Proder.ListProductFeeds:input_type -> header.Id
	133, // 348: header.Proder.CreateProductFeed:input_type -> header.ProductFeed
	133, // 349: header.Proder.UpdateProductFeed:input_type -> header.ProductFeed
	4,   // 350: header.Proder.DeleteProductFeed:input_type -> header.Id
	5,   // 351: header.Proder.ListProductCategories:input_type -> header.Ids
	5,   // 352: header.Proder.ListProductProps:input_type -> header.Ids
	4,   // 353: header.Proder.ReadOrder:input_type -> header.Id
	22,  // 354: header.Proder.CreateOrder:input_type -> header.Order
	22,  // 355: header.Proder.UpdateOrder:input_type -> header.Order
	4,   // 356: header.Proder.DeleteOrder:input_type -> header.Id
	4,   // 357: header.Proder.RestoreOrder:input_type -> header.Id
	134, // 358: header.Proder.ListOrders:input_type -> header.OrdersRequest
	134, // 359: header.Proder.CountOrders:input_type -> header.OrdersRequest
	135, // 360: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	136, // 361: header.Proder.MakeOrderPayment:input_type -> header.Bill
	137, // 362: header.Proder.DeleteOrderPayment:input_type -> header.Key
	38,  // 363: header.Proder.AddOrderComment:input_type -> header.Event
	38,  // 364: header.Proder.EditOrderComment:input_type -> header.Event
	137, // 365: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 366: header.Proder.ListOrderEvents:input_type -> header.Id
	138, // 367: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 368: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	139, // 369: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 370: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	140, // 371: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	141, // 372: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	142, // 373: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	143, // 374: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 375: header.Proder.ShipOrder:input_type -> header.Id
	4,   // 376: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 377: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 378: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 379: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 380: header.Proder.UnfollowOrder:input_type -> header.Id
	4,   // 381: header.Apiece.ReadTask:input_type -> header.Id
	144, // 382: header.Apiece.CreateTask:input_type -> header.Task
	144, // 383: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 384: header.Apiece.DeleteTask:input_type -> header.Id
	145, // 385: header.Apiece.ListTasks:input_type -> header.TasksRequest
	38,  // 386: header.Apiece.AddTaskComment:input_type -> header.Event
	38,  // 387: header.Apiece.EditTaskComment:input_type -> header.Event
	137, // 388: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 389: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 390: header.Apiece.ReadPipeline:input_type -> header.Id
	146, // 391: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	146, // 392: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 393: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 394: header.Apiece.ListPipelines:input_type -> header.Ids
	147, // 395: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	47,  // 396: header.Search.Index:output_type -> header.Empty
	148, // 397: header.Search.Search:output_type -> header.DocSearchResponse
	47,  // 398: header.Search.AddOwner:output_type -> header.Empty
	149, // 399: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	20,  // 400: header.Map.LookupAddress:output_type -> header.Address
	150, // 401: header.Map.PredictAddress:output_type -> header.Addresses
	150, // 402: header.Map.ListDistricts:output_type -> header.Addresses
	150, // 403: header.Map.ListProvinces:output_type -> header.Addresses
	150, // 404: header.Map.ListWards:output_type -> header.Addresses
	150, // 405: header.Map.ListStreets:output_type -> header.Addresses
	150, // 406: header.Map.ListAddresses:output_type -> header.Addresses
	20,  // 407: header.Map.ReadAddress:output_type -> header.Address
	6,   // 408: header.AccountMgr.CreateGroup:output_type -> header.AgentGroup
	6,   // 409: header.AccountMgr.UpdateGroup:output_type -> header.AgentGroup
	6,   // 410: header.AccountMgr.GetGroup:output_type -> header.AgentGroup
	47,  // 411: header.AccountMgr.RequestResetPassword:output_type -> header.Empty
	9,   // 412: header.AccountMgr.UpdatePassword:output_type -> account.Agent
	9,   // 413: header.AccountMgr.UpdateAgent:output_type -> account.Agent
	9,   // 414: header.AccountMgr.DeleteAgent:output_type -> account.Agent
	47,  // 415: header.AccountMgr.RequestChangeEmail:output_type -> header.Empty
	9,   // 416: header.AccountMgr.ConfirmChangeEmail:output_type -> account.Agent
	9,   // 417: header.AccountMgr.AcceptInvitation:output_type -> account.Agent
	9,   // 418: header.AccountMgr.GetInvitation:output_type -> account.Agent
	9,   // 419: header.AccountMgr.InviteAgent:output_type -> account.Agent
	9,   // 420: header.AccountMgr.GetAgent:output_type -> account.Agent
	11,  // 421: header.AccountMgr.ConfirmAccount:output_type -> account.Account
	11,  // 422: header.AccountMgr.GetAccount:output_type -> account.Account
	11,  // 423: header.AccountMgr.UpdateAccount:output_type -> account.Account
	11,  // 424: header.AccountMgr.CreateAccount:output_type -> account.Account
	151, // 425: header.AccountMgr.ListAgents:output_type -> account.Agents
	47,  // 426: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	152, // 427: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	47,  // 428: header.AccountMgr.AddAgentToGroup:output_type -> header.Empty
	47,  // 429: header.AccountMgr.RemoveAgentFromGroup:output_type -> header.Empty
	9,   // 430: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	153, // 431: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	9,   // 432: header.AccountMgr.TransferOwner:output_type -> account.Agent
	15,  // 433: header.AccountMgr.CheckLoginSession:output_type -> header.LoginSession
	154, // 434: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	154, // 435: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	47,  // 436: header.AccountMgr.LogoutSession:output_type -> header.Empty
	15,  // 437: header.AccountMgr.CreateApiKey:output_type -> header.LoginSession
	155, // 438: header.AccountMgr.GetLanguage:output_type -> header.Lang
	16,  // 439: header.AccountMgr.UpdateLanguage:output_type -> header.LangMessage
	17,  // 440: header.AccountMgr.CreateChangelog:output_type -> header.Changelog
	156, // 441: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	19,  // 442: header.AccountMgr.GetShopSetting:output_type -> header.ShopSetting
	19,  // 443: header.AccountMgr.UpdateShopSetting:output_type -> header.ShopSetting
	157, // 444: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	47,  // 445: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	150, // 446: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	20,  // 447: header.AccountMgr.CreateShopAddress:output_type -> header.Address
	20,  // 448: header.AccountMgr.UpdateShopAddress:output_type -> header.Address
	47,  // 449: header.AccountMgr.DeleteShopAddress:output_type -> header.Empty
	158, // 450: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	21,  // 451: header.AccountMgr.CreateTax:output_type -> header.Tax
	21,  // 452: header.AccountMgr.UpdateTax:output_type -> header.Tax
	47,  // 453: header.AccountMgr.DeleteTax:output_type -> header.Empty
	159, // 454: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	159, // 455: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	23,  // 456: header.AccountMgr.CreateShippingPolicy:output_type -> header.ShippingPolicy
	23,  // 457: header.AccountMgr.UpdateShippingPolicy:output_type -> header.ShippingPolicy
	47,  // 458: header.AccountMgr.DeleteShippingPolicy:output_type -> header.Empty
	24,  // 459: header.AccountMgr.CreateCancellationCode:output_type -> header.CancellationCode
	160, // 460: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	24,  // 461: header.AccountMgr.UpdateCancellationCode:output_type -> header.CancellationCode
	47,  // 462: header.AccountMgr.MakeDefaultTax:output_type -> header.Empty
	161, // 463: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	25,  // 464: header.AccountMgr.CreatePaymentMethod:output_type -> header.PaymentMethod
	25,  // 465: header.AccountMgr.UpdatePaymentMethod:output_type -> header.PaymentMethod
	47,  // 466: header.AccountMgr.DeletePaymentMethod:output_type -> header.Empty
	47,  // 467: header.AccountMgr.MakeDefaultPaymentMethod:output_type -> header.Empty
	162, // 468: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	47,  // 469: header.AccountMgr.DeintegrateShippingProvider:output_type -> header.Empty
	26,  // 470: header.AccountMgr.IntegrateShippingProvider:output_type -> header.IntegratedShipping
	26,  // 471: header.AccountMgr.SendGHNAffiliateOTP:output_type -> header.IntegratedShipping
	26,  // 472: header.AccountMgr.EnterGHNAffiliateOTP:output_type -> header.IntegratedShipping
	163, // 473: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	27,  // 474: header.AccountMgr.CreateEmailBlock:output_type -> header.EmailBlock
	47,  // 475: header.AccountMgr.DeleteEmailBlock:output_type -> header.Empty
	28,  // 476: header.AccountMgr.UpdateAgentPresence:output_type -> account.Presence
	164, // 477: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	31,  // 478: header.UserMgr.MergeUser2:output_type -> header.User
	4,   // 479: header.UserMgr.CreateUser:output_type -> header.Id
	4,   // 480: header.UserMgr.CreateUserFromWeb:output_type -> header.Id
	4,   // 481: header.UserMgr.CreateSbzUserByAgent:output_type -> header.Id
	4,   // 482: header.UserMgr.UpdateUser:output_type -> header.Id
	31,  // 483: header.UserMgr.ReadUser:output_type -> header.User
	31,  // 484: header.UserMgr.ReadOrCreateUserByContactProfile:output_type -> header.User
	165, // 485: header.UserMgr.ReportUserEvents:output_type -> header.UserEventMetrics
	30,  // 486: header.UserMgr.MatchUsers:output_type -> header.Users
	33,  // 487: header.UserMgr.UpdateView:output_type -> header.UserView
	33,  // 488: header.UserMgr.CreateView:output_type -> header.UserView
	47,  // 489: header.UserMgr.DeleteView:output_type -> header.Empty
	33,  // 490: header.UserMgr.GetView:output_type -> header.UserView
	166, // 491: header.UserMgr.ListViews:output_type -> header.UserViews
	34,  // 492: header.UserMgr.UpsertLabel:output_type -> header.Label
	47,  // 493: header.UserMgr.DeleteLabel:output_type -> header.Empty
	167, // 494: header.UserMgr.ListLabels:output_type -> header.Labels
	34,  // 495: header.UserMgr.GetLabel:output_type -> header.Label
	47,  // 496: header.UserMgr.AddLeadOwner:output_type -> header.Empty
	47,  // 497: header.UserMgr.RemoveLeadOwner:output_type -> header.Empty
	47,  // 498: header.UserMgr.AddUserLabel:output_type -> header.Empty
	47,  // 499: header.UserMgr.RemoveUserLabel:output_type -> header.Empty
	20,  // 500: header.UserMgr.CreateShippingAddress:output_type -> header.Address
	20,  // 501: header.UserMgr.UpdateShippingAddress:output_type -> header.Address
	47,  // 502: header.UserMgr.RemoveShippingAddress:output_type -> header.Empty
	168, // 503: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	47,  // 504: header.UserMgr.MakeDefaultShippingAddress:output_type -> header.Empty
	30,  // 505: header.UserMgr.ListLeads:output_type -> header.Users
	30,  // 506: header.UserMgr.ListSecondaryUsers:output_type -> header.Users
	30,  // 507: header.UserMgr.RecommendRelatedUsers:output_type -> header.Users
	36,  // 508: header.UserMgr.LinkProductUrl:output_type -> header.Product
	100, // 509: header.UserMgr.ListUserEvents:output_type -> header.Events
	38,  // 510: header.UserMgr.CreateUserEvent:output_type -> header.Event
	39,  // 511: header.UserMgr.FillDevice:output_type -> common.Device
	169, // 512: header.LiveMgr.SearchLocations:output_type -> header.Locations
	30,  // 513: header.LiveMgr.FilterActiveUsers:output_type -> header.Users
	100, // 514: header.LiveMgr.TopEvents:output_type -> header.Events
	170, // 515: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	171, // 516: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	172, // 517: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	173, // 518: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	174, // 519: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	175, // 520: header.NoteMgr.ListNotes:output_type -> header.Notes
	45,  // 521: header.NoteMgr.AddNote:output_type -> header.Note
	45,  // 522: header.NoteMgr.UpdateNote:output_type -> header.Note
	47,  // 523: header.NoteMgr.DeleteNote:output_type -> header.Empty
	176, // 524: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	48,  // 525: header.AttributeMgr.CreateAttributeDefinition:output_type -> header.AttributeDefinition
	48,  // 526: header.AttributeMgr.UpdateAttributeDefinition:output_type -> header.AttributeDefinition
	177, // 527: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	38,  // 528: header.ConversationMgr.PongMessage:output_type -> header.Event
	54,  // 529: header.ConversationMgr.StartConversation:output_type -> header.Conversation
	54,  // 530: header.ConversationMgr.EndConversation:output_type -> header.Conversation
	54,  // 531: header.ConversationMgr.GetConversation:output_type -> header.Conversation
	178, // 532: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	178, // 533: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	47,  // 534: header.ConversationMgr.TagConversation:output_type -> header.Empty
	47,  // 535: header.ConversationMgr.UntagConversation:output_type -> header.Empty
	47,  // 536: header.ConversationMgr.JoinConversation:output_type -> header.Empty
	47,  // 537: header.ConversationMgr.LeftConversation:output_type -> header.Empty
	47,  // 538: header.ConversationMgr.Typing:output_type -> header.Empty
	54,  // 539: header.ConversationMgr.UpdateConversationInfo:output_type -> header.Conversation
	178, // 540: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	47,  // 541: header.ConversationMgr.UpdateMuteConversation:output_type -> header.Empty
	47,  // 542: header.ConversationMgr.UpdateConversationMember:output_type -> header.Empty
	47,  // 543: header.ConversationMgr.UnwatchConversation:output_type -> header.Empty
	47,  // 544: header.ConversationMgr.UnhiddenConversation:output_type -> header.Empty
	56,  // 545: header.ConversationMgr.UpdateEndchatSetting:output_type -> header.EndchatSetting
	56,  // 546: header.ConversationMgr.GetEndchatSetting:output_type -> header.EndchatSetting
	38,  // 547: header.ConversationMgr.TerminateBot:output_type -> header.Event
	38,  // 548: header.ConversationMgr.SendMessage:output_type -> header.Event
	38,  // 549: header.ConversationMgr.UpdateMessage:output_type -> header.Event
	47,  // 550: header.ConversationMgr.PinMessage:output_type -> header.Empty
	47,  // 551: header.ConversationMgr.UnpinMessage:output_type -> header.Empty
	100, // 552: header.ConversationMgr.ListEvents:output_type -> header.Events
	47,  // 553: header.ConversationMgr.Deintegrate:output_type -> header.Empty
	179, // 554: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	59,  // 555: header.ConversationMgr.Integrate:output_type -> header.Integration
	59,  // 556: header.ConversationMgr.GetIntegration:output_type -> header.Integration
	60,  // 557: header.ConversationMgr.UpdateRule:output_type -> header.Rule
	60,  // 558: header.ConversationMgr.CreateRule:output_type -> header.Rule
	47,  // 559: header.ConversationMgr.DeleteRule:output_type -> header.Empty
	60,  // 560: header.ConversationMgr.ReadRule:output_type -> header.Rule
	180, // 561: header.ConversationMgr.ListRules:output_type -> header.Route
	181, // 562: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	61,  // 563: header.ConversationMgr.UpdateConversationAutomation:output_type -> header.ConversationAutomation
	47,  // 564: header.ConversationMgr.DeleteConversationAutomation:output_type -> header.Empty
	61,  // 565: header.ConversationMgr.ReadConversationAutomation:output_type -> header.ConversationAutomation
	182, // 566: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	62,  // 567: header.ConversationMgr.CreatePhoneDevice:output_type -> header.PhoneDevice
	62,  // 568: header.ConversationMgr.UpdatePhoneDevice:output_type -> header.PhoneDevice
	47,  // 569: header.ConversationMgr.DeletePhoneDevice:output_type -> header.Empty
	183, // 570: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	63,  // 571: header.ConversationMgr.UpdateCallSetting:output_type -> header.CallSetting
	184, // 572: header.ConversationMgr.IncommingCall:output_type -> header.CallRoutingResponse
	65,  // 573: header.ConversationMgr.BlockNumber:output_type -> header.BlockedNumber
	185, // 574: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	47,  // 575: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	66,  // 576: header.TemplateMgr.CreateTemplate:output_type -> header.Template
	66,  // 577: header.TemplateMgr.UpdateTemplate:output_type -> header.Template
	47,  // 578: header.TemplateMgr.DeleteTemplate:output_type -> header.Empty
	66,  // 579: header.TemplateMgr.GetTemplate:output_type -> header.Template
	186, // 580: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	47,  // 581: header.TemplateMgr.PickTemplate:output_type -> header.Empty
	68,  // 582: header.TemplateMgr.CreateModal:output_type -> header.ConversationModal
	68,  // 583: header.TemplateMgr.UpdateModal:output_type -> header.ConversationModal
	47,  // 584: header.TemplateMgr.DeleteModal:output_type -> header.Empty
	68,  // 585: header.TemplateMgr.GetModal:output_type -> header.ConversationModal
	187, // 586: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	188, // 587: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	70,  // 588: header.TagMgr.CreateTag:output_type -> header.Tag
	70,  // 589: header.TagMgr.UpdateTag:output_type -> header.Tag
	47,  // 590: header.TagMgr.DeleteTag:output_type -> header.Empty
	189, // 591: header.TagMgr.ListTags:output_type -> header.Tags
	70,  // 592: header.TagMgr.GetTag:output_type -> header.Tag
	100, // 593: header.EventMgr.SearchEvents:output_type -> header.Events
	38,  // 594: header.EventMgr.CreateEvent:output_type -> header.Event
	190, // 595: header.FileMgr.Presign:output_type -> header.PresignResult
	191, // 596: header.FileMgr.Uploaded:output_type -> header.File
	191, // 597: header.FileMgr.DownloadFileUrl:output_type -> header.File
	75,  // 598: header.Noti5Service.ReadNotificationSetting:output_type -> noti5.Setting
	75,  // 599: header.Noti5Service.UpdateNotificationSetting:output_type -> noti5.Setting
	47,  // 600: header.Noti5Service.Noti:output_type -> header.Empty
	47,  // 601: header.Noti5Service.AddToken:output_type -> header.Empty
	47,  // 602: header.Noti5Service.RemoveToken:output_type -> header.Empty
	47,  // 603: header.Noti5Service.CheckTokenExists:output_type -> header.Empty
	78,  // 604: header.SubizInternalPaymentMgr.CreateBill:output_type -> payment.Bill
	192, // 605: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	83,  // 606: header.PaymentMgr.Purchase:output_type -> payment.Invoice
	80,  // 607: header.PaymentMgr.UpdateSubscription:output_type -> payment.Subscription
	80,  // 608: header.PaymentMgr.GetSubscription:output_type -> payment.Subscription
	81,  // 609: header.PaymentMgr.AddPaymentMethod:output_type -> payment.PaymentMethod
	81,  // 610: header.PaymentMgr.UpdatePaymentMethod:output_type -> payment.PaymentMethod
	47,  // 611: header.PaymentMgr.DeletePaymentMethod:output_type -> header.Empty
	193, // 612: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	78,  // 613: header.PaymentMgr.Pay:output_type -> payment.Bill
	83,  // 614: header.PaymentMgr.CreateInvoice:output_type -> payment.Invoice
	83,  // 615: header.PaymentMgr.UpdateInvoice:output_type -> payment.Invoice
	194, // 616: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	83,  // 617: header.PaymentMgr.DraftInvoice:output_type -> payment.Invoice
	83,  // 618: header.PaymentMgr.DiffSubscriptions:output_type -> payment.Invoice
	195, // 619: header.PaymentMgr.ListComments:output_type -> payment.Comments
	87,  // 620: header.PaymentMgr.AddComment:output_type -> payment.Comment
	196, // 621: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	91,  // 622: header.PaymentMgr.ExportInvoice:output_type -> payment.String
	91,  // 623: header.PaymentMgr.ConvertInvoiceToHtml:output_type -> payment.String
	88,  // 624: header.PaymentMgr.GetExchangeRate:output_type -> header.ExchangeRate
	78,  // 625: header.PaymentMgr.TransferMoney:output_type -> payment.Bill
	197, // 626: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	90,  // 627: header.PaymentMgr.CreatePromotionCode:output_type -> payment.PromotionCode
	90,  // 628: header.PaymentMgr.GetPromotionCode:output_type -> payment.PromotionCode
	47,  // 629: header.PaymentMgr.UsePromotionCode:output_type -> header.Empty
	90,  // 630: header.PaymentMgr.ValidatePromotionCode:output_type -> payment.PromotionCode
	198, // 631: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	47,  // 632: header.PaymentMgr.DeletePromotionCode:output_type -> header.Empty
	95,  // 633: header.PaymentMgr.SearchReferral:output_type -> payment.Referral
	95,  // 634: header.PaymentMgr.GetReferral:output_type -> payment.Referral
	199, // 635: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	95,  // 636: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	200, // 637: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	201, // 638: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	202, // 639: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	47,  // 640: header.PaymentMgr.PaidForAgentReferrer:output_type -> header.Empty
	47,  // 641: header.Pubsub.Publish:output_type -> header.Empty
	98,  // 642: header.FabikonService.ReadFbFanpageSetting:output_type -> header.FbFanpageSetting
	98,  // 643: header.FabikonService.UpdateFbFanpageSetting:output_type -> header.FbFanpageSetting
	203, // 644: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	204, // 645: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	99,  // 646: header.FabikonService.GetFbPost:output_type -> header.FacebookPost
	47,  // 647: header.FabikonService.SendEventToFacebook:output_type -> header.Empty
	47,  // 648: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	47,  // 649: header.MailkonService.SendEvent:output_type -> header.Empty
	47,  // 650: header.MailkonService.ListBlockedEmails:output_type -> header.Empty
	47,  // 651: header.MailkonService.BlockEmail:output_type -> header.Empty
	47,  // 652: header.MailkonService.UnblockEmail:output_type -> header.Empty
	101, // 653: header.WidgetService.Read:output_type -> header.WidgetSetting
	101, // 654: header.WidgetService.Update:output_type -> header.WidgetSetting
	205, // 655: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	206, // 656: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	102, // 657: header.WidgetService.SubmitImpression:output_type -> header.Impression
	103, // 658: header.WidgetService.SubmitConversion:output_type -> header.Conversion
	104, // 659: header.WidgetService.SubmitUserCampaignStatus:output_type -> header.UserCampaignStatus
	207, // 660: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	208, // 661: header.WidgetService.ListConversions:output_type -> header.Conversions
	209, // 662: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	107, // 663: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	210, // 664: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	47,  // 665: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	211, // 666: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	108, // 667: header.WidgetService.UpdateWebPlugin:output_type -> header.WebPlugin
	108, // 668: header.WidgetService.UpdateWebPluginEnabled:output_type -> header.WebPlugin
	108, // 669: header.WidgetService.CreateWebPlugin:output_type -> header.WebPlugin
	47,  // 670: header.WidgetService.DeleteWebPlugin:output_type -> header.Empty
	108, // 671: header.WidgetService.UpdateWebPluginTemplate:output_type -> header.WebPlugin
	211, // 672: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	47,  // 673: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	212, // 674: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	210, // 675: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	213, // 676: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	214, // 677: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	215, // 678: header.Bizbot.ListBots:output_type -> header.Bots
	110, // 679: header.Bizbot.GetBot:output_type -> header.Bot
	110, // 680: header.Bizbot.UpdateBotRunState:output_type -> header.Bot
	110, // 681: header.Bizbot.CreateBot:output_type -> header.Bot
	110, // 682: header.Bizbot.UpdateBot:output_type -> header.Bot
	47,  // 683: header.Bizbot.DeleteBot:output_type -> header.Empty
	47,  // 684: header.Bizbot.OnEvent:output_type -> header.Empty
	47,  // 685: header.Bizbot.StartBot:output_type -> header.Empty
	47,  // 686: header.Bizbot.StopBot:output_type -> header.Empty
	47,  // 687: header.Bizbot.TryAction:output_type -> header.Empty
	216, // 688: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	217, // 689: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	218, // 690: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	219, // 691: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	116, // 692: header.Sendback.CreateWebhook:output_type -> header.Webhook
	220, // 693: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	47,  // 694: header.Sendback.DeleteWebhook:output_type -> header.Empty
	221, // 695: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	116, // 696: header.Sendback.ReadWebhook:output_type -> header.Webhook
	116, // 697: header.Sendback.UpdateWebhook:output_type -> header.Webhook
	116, // 698: header.Sendback.UpdateWebhookSecret:output_type -> header.Webhook
	222, // 699: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	223, // 700: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	47,  // 701: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	47,  // 702: header.Notibox.SendNoti:output_type -> header.Empty
	224, // 703: header.Notibox.ListNoties:output_type -> header.Notifications
	47,  // 704: header.Notibox.MarkReadNoti:output_type -> header.Empty
	121, // 705: header.Watchhttp.CreateWebpage:output_type -> header.Webpage
	47,  // 706: header.Watchhttp.DeleteWebpage:output_type -> header.Empty
	225, // 707: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	121, // 708: header.Watchhttp.UpdateWebpage:output_type -> header.Webpage
	121, // 709: header.Watchhttp.ReadWebpage:output_type -> header.Webpage
	226, // 710: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	227, // 711: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	228, // 712: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	226, // 713: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	47,  // 714: header.Holap.AppendAgentSet:output_type -> header.Empty
	47,  // 715: header.Holap.AppendTagSet:output_type -> header.Empty
	47,  // 716: header.Holap.UpdateUser:output_type -> header.Empty
	47,  // 717: header.Holap.UpdateConversation:output_type -> header.Empty
	47,  // 718: header.Holap.OnConversationEvent:output_type -> header.Empty
	47,  // 719: header.Holap.FreeAccount:output_type -> header.Empty
	229, // 720: header.Holap.ReportUser:output_type -> header.UserMetrics
	230, // 721: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 722: header.Holap.ListUserIds:output_type -> header.Ids
	178, // 723: header.Holap.ListConversationIds:output_type -> header.Conversations
	231, // 724: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 725: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	165, // 726: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	47,  // 727: header.Holap.UpdateOrder:output_type -> header.Empty
	232, // 728: header.Holap.ReportOrder:output_type -> header.Orders
	36,  // 729: header.Proder.ReadProduct:output_type -> header.Product
	36,  // 730: header.Proder.CreateProduct:output_type -> header.Product
	36,  // 731: header.Proder.UpdateProduct:output_type -> header.Product
	47,  // 732: header.Proder.DeleteProduct:output_type -> header.Empty
	36,  // 733: header.Proder.RestoreProduct:output_type -> header.Product
	131, // 734: header.Proder.ListProducts:output_type -> header.Products
	5,   // 735: header.Proder.ListProductIds:output_type -> header.Ids
	131, // 736: header.Proder.ListGroupedProducts:output_type -> header.Products
	131, // 737: header.Proder.ImportProducts:output_type -> header.Products
	233, // 738: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	132, // 739: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	132, // 740: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	47,  // 741: header.Proder.DeleteProductCollection:output_type -> header.Empty
	234, // 742: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	133, // 743: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	133, // 744: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	47,  // 745: header.Proder.DeleteProductFeed:output_type -> header.Empty
	235, // 746: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	236, // 747: header.Proder.ListProductProps:output_type -> header.ProductProps
	22,  // 748: header.Proder.ReadOrder:output_type -> header.Order
	22,  // 749: header.Proder.CreateOrder:output_type -> header.Order
	22,  // 750: header.Proder.UpdateOrder:output_type -> header.Order
	47,  // 751: header.Proder.DeleteOrder:output_type -> header.Empty
	22,  // 752: header.Proder.RestoreOrder:output_type -> header.Order
	232, // 753: header.Proder.ListOrders:output_type -> header.Orders
	232, // 754: header.Proder.CountOrders:output_type -> header.Orders
	47,  // 755: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	38,  // 756: header.Proder.MakeOrderPayment:output_type -> header.Event
	38,  // 757: header.Proder.DeleteOrderPayment:output_type -> header.Event
	38,  // 758: header.Proder.AddOrderComment:output_type -> header.Event
	38,  // 759: header.Proder.EditOrderComment:output_type -> header.Event
	38,  // 760: header.Proder.DeleteOrderComment:output_type -> header.Event
	237, // 761: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	191, // 762: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 763: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	238, // 764: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	47,  // 765: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	239, // 766: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	47,  // 767: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	47,  // 768: header.Proder.GHNShippingStatus:output_type -> header.Empty
	143, // 769: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	22,  // 770: header.Proder.ShipOrder:output_type -> header.Order
	22,  // 771: header.Proder.CancelShippingOrder:output_type -> header.Order
	191, // 772: header.Proder.PrintShippingOrders:output_type -> header.File
	47,  // 773: header.Proder.SeenOrder:output_type -> header.Empty
	47,  // 774: header.Proder.FollowOrder:output_type -> header.Empty
	47,  // 775: header.Proder.UnfollowOrder:output_type -> header.Empty
	144, // 776: header.Apiece.ReadTask:output_type -> header.Task
	144, // 777: header.Apiece.CreateTask:output_type -> header.Task
	144, // 778: header.Apiece.UpdateTask:output_type -> header.Task
	47,  // 779: header.Apiece.DeleteTask:output_type -> header.Empty
	240, // 780: header.Apiece.ListTasks:output_type -> header.Tasks
	38,  // 781: header.Apiece.AddTaskComment:output_type -> header.Event
	38,  // 782: header.Apiece.EditTaskComment:output_type -> header.Event
	38,  // 783: header.Apiece.DeleteTaskComment:output_type -> header.Event
	241, // 784: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	146, // 785: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	146, // 786: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	146, // 787: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	47,  // 788: header.Apiece.DeletePipeline:output_type -> header.Empty
	242, // 789: header.Apiece.ListPipelines:output_type -> header.Pipelines
	395, // [395:790] is the sub-list for method output_type
	0,   // [0:395] is the sub-list for method input_type
