...
var file_service_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0xe1, 0x13,
	...
	0x6f, 0x69, 0x63, 0x65, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xee, 0x05,
	...
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x48, 0x0a, 0x10, 0x4c, 0x6f, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x62,
	...
	0x62, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x61, 0x6c, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x32, 0xe1,
...
var file_service_proto_depIdxs = []int32{
	...
	148, // 393: header.Proder.CountOrders:input_type -> header.OrdersRequest
	149, // 394: header.Proder.DeleteDraftOrders:input_type -> header.DeleteDraftOrdersRequest
	150, // 395: header.Proder.ImportOrders:input_type -> header.Orders
	151, // 396: header.Proder.MakeOrderPayment:input_type -> header.Bill
	152, // 397: header.Proder.DeleteOrderPayment:input_type -> header.Key
	41,  // 398: header.Proder.AddOrderComment:input_type -> header.Event
	41,  // 399: header.Proder.EditOrderComment:input_type -> header.Event
	152, // 400: header.Proder.DeleteOrderComment:input_type -> header.Key
	4,   // 401: header.Proder.ListOrderEvents:input_type -> header.Id
	153, // 402: header.Proder.DownloadOrder:input_type -> header.DownloadOrderRequest
	4,   // 403: header.Proder.GetShopeeAuthUrl:input_type -> header.Id
	154, // 404: header.Proder.AuthorizeShopeeShop:input_type -> header.AuthorizeShopeeRequest
	4,   // 405: header.Proder.DeauthorizeShopeeShop:input_type -> header.Id
	155, // 406: header.Proder.SyncShopeeProducts:input_type -> header.ShopeeSyncProductRequest
	156, // 407: header.Proder.GHTKShippingStatus:input_type -> header.GHTKOrder
	157, // 408: header.Proder.GHNShippingStatus:input_type -> header.GHNOrder2
	158, // 409: header.Proder.ShippingFee:input_type -> header.ShippingInfo
	4,   // 410: header.Proder.ShipOrder:input_type -> header.Id
	21,  // 411: header.Proder.UpdateShippingCode:input_type -> header.Order
	4,   // 412: header.Proder.CancelShippingOrder:input_type -> header.Id
	5,   // 413: header.Proder.PrintShippingOrders:input_type -> header.Ids
	4,   // 414: header.Proder.SeenOrder:input_type -> header.Id
	4,   // 415: header.Proder.FollowOrder:input_type -> header.Id
	4,   // 416: header.Proder.UnfollowOrder:input_type -> header.Id
	59,  // 417: header.Proder.TagOrder:input_type -> header.TagRequest
	59,  // 418: header.Proder.UntagOrder:input_type -> header.TagRequest
	4,   // 419: header.Apiece.ReadTask:input_type -> header.Id
	46,  // 420: header.Apiece.CreateTask:input_type -> header.Task
	46,  // 421: header.Apiece.UpdateTask:input_type -> header.Task
	4,   // 422: header.Apiece.DeleteTask:input_type -> header.Id
	159, // 423: header.Apiece.ListTasks:input_type -> header.TasksRequest
	4,   // 424: header.Apiece.SeenTask:input_type -> header.Id
	4,   // 425: header.Apiece.CloseTaskReminder:input_type -> header.Id
	4,   // 426: header.Apiece.MuteTask:input_type -> header.Id
	4,   // 427: header.Apiece.UnmuteTask:input_type -> header.Id
	41,  // 428: header.Apiece.AddTaskComment:input_type -> header.Event
	41,  // 429: header.Apiece.EditTaskComment:input_type -> header.Event
	152, // 430: header.Apiece.DeleteTaskComment:input_type -> header.Key
	4,   // 431: header.Apiece.ListTaskComments:input_type -> header.Id
	4,   // 432: header.Apiece.ReadPipeline:input_type -> header.Id
	160, // 433: header.Apiece.CreatePipeline:input_type -> header.Pipeline
	160, // 434: header.Apiece.UpdatePipeline:input_type -> header.Pipeline
	4,   // 435: header.Apiece.DeletePipeline:input_type -> header.Id
	5,   // 436: header.Apiece.ListPipelines:input_type -> header.Ids
	161, // 437: header.Apiece.DeletePipelineStage:input_type -> header.PipelineStage
	4,   // 438: header.Apiece.PreselectPipeline:input_type -> header.Id
	162, // 439: header.Speex.TextToSpeech:input_type -> header.TTSVoiceSelection
	5,   // 440: header.Campion.ListCampaigns:input_type -> header.Ids
	4,   // 441: header.Campion.ReadCampaign:input_type -> header.Id
	163, // 442: header.Campion.CreateCampaign:input_type -> header.Campaign
	163, // 443: header.Campion.UpdateCampaign:input_type -> header.Campaign
	4,   // 444: header.Campion.DeleteCampaign:input_type -> header.Id
	41,  // 445: header.Campion.OnEvent:input_type -> header.Event
	164, // 446: header.Campion.ListCampaignSendMessages:input_type -> header.CampaignSendMessagesRequest
	4,   // 447: header.Campion.ReportCampaign:input_type -> header.Id
	165, // 448: header.Campion.ListOutboundCallEntries:input_type -> header.ListOutboundCallRequest
	166, // 449: header.Campion.UpdateOutboundCall:input_type -> header.OutboundCallEntry
	166, // 450: header.Campion.RemoveOutboutCall:input_type -> header.OutboundCallEntry
	166, // 451: header.Campion.LockOutboundCall:input_type -> header.OutboundCallEntry
	167, // 452: header.CreditMgr.ReportCreditSpend:input_type -> header.CreditSpendReportRequest
	168, // 453: header.CreditMgr.ListCreditSpendLog:input_type -> header.CreditSpendLogRequest
	86,  // 454: header.CreditMgr.AddCredit:input_type -> payment.Bill
	169, // 455: header.RateLimit.SyncRateLimit:output_type -> header.RateLimitSyncResponse
	54,  // 456: header.Search.Index:output_type -> header.Empty
	170, // 457: header.Search.Search:output_type -> header.DocSearchResponse
	54,  // 458: header.Search.AddOwner:output_type -> header.Empty
	171, // 459: header.Map.Predict:output_type -> header.AddressAutocompleteResponses
	19,  // 460: header.Map.LookupAddress:output_type -> header.Address
	172, // 461: header.Map.PredictAddress:output_type -> header.Addresses
	172, // 462: header.Map.ListDistricts:output_type -> header.Addresses
	172, // 463: header.Map.ListProvinces:output_type -> header.Addresses
	172, // 464: header.Map.ListWards:output_type -> header.Addresses
	172, // 465: header.Map.ListStreets:output_type -> header.Addresses
	172, // 466: header.Map.ListAddresses:output_type -> header.Addresses
	...
	173, // 485: header.AccountMgr.ListAgents:output_type -> account.Agents
	54,  // 486: header.AccountMgr.DeleteGroup:output_type -> header.Empty
	174, // 487: header.AccountMgr.ListGroups:output_type -> header.AgentGroups
	9,   // 488: header.AccountMgr.ChangeEmail:output_type -> account.Agent
	175, // 489: header.AccountMgr.SyncPublicHolidays:output_type -> account.BusinessHours
	...
	176, // 492: header.AccountMgr.ListLoginSessions:output_type -> header.LoginSessions
	176, // 493: header.AccountMgr.ListApiKeys:output_type -> header.LoginSessions
	...
	177, // 496: header.AccountMgr.GetLanguage:output_type -> header.Lang
	...
	178, // 499: header.AccountMgr.ListChangelogs:output_type -> header.ListChangelogsResponse
	...
	179, // 502: header.AccountMgr.ReadCurrency:output_type -> header.Currency
	54,  // 503: header.AccountMgr.AutoSyncCurrency:output_type -> header.Empty
	172, // 504: header.AccountMgr.ListShopAddresses:output_type -> header.Addresses
	...
	180, // 508: header.AccountMgr.ListTaxes:output_type -> header.Taxes
	...
	181, // 512: header.AccountMgr.CheckShippingPolicy:output_type -> header.ShippingPolicies
	181, // 513: header.AccountMgr.ListShippingPolicies:output_type -> header.ShippingPolicies
	...
	182, // 518: header.AccountMgr.ListCancellationCodes:output_type -> header.CancellationCodes
	...
	183, // 521: header.AccountMgr.ListPaymentMethods:output_type -> header.PaymentMethods
	...
	184, // 526: header.AccountMgr.ListIntegratedShippingProviders:output_type -> header.IntegratedShippings
	...
	185, // 531: header.AccountMgr.ListEmailBlocks:output_type -> header.EmailBlocks
	...
	186, // 535: header.AccountMgr.ReportAvailibilities:output_type -> header.ReportResponse
	...
	187, // 555: header.UserMgr.ListViews:output_type -> header.UserViews
	...
	188, // 560: header.UserMgr.ListSegments:output_type -> header.Segments
	...
	189, // 569: header.UserMgr.ListLabels:output_type -> header.Labels
	...
	190, // 579: header.UserMgr.ListShippingAddress:output_type -> header.ShippingAddresses
	...
	191, // 582: header.UserMgr.SuggestLeadField:output_type -> header.SuggestLeadFieldResponse
	...
	192, // 589: header.UserMgr.ImportLead:output_type -> header.ImportLeadResponse
	193, // 590: header.UserMgr.ListEventTypes:output_type -> header.EventTypes
	...
	194, // 593: header.LiveMgr.SearchLocations:output_type -> header.Locations
	...
	195, // 596: header.LiveMgr.TopLocations:output_type -> header.LocationMetrics
	196, // 597: header.LiveMgr.TopPages:output_type -> header.PageMetrics
	197, // 598: header.LiveMgr.TopSources:output_type -> header.SourceMetrics
	198, // 599: header.LiveMgr.CountActiveUsers:output_type -> header.UserMetric
	199, // 600: header.LiveMgr.Presences:output_type -> header.PresencesResponse
	200, // 601: header.NoteMgr.ListNotes:output_type -> header.Notes
	...
	201, // 605: header.AttributeMgr.ListAttributeDefinitions:output_type -> header.AttributeDefinitions
	...
	202, // 608: header.ConversationMgr.AssignRule:output_type -> header.RouteResult
	...
	203, // 613: header.ConversationMgr.ListConversations:output_type -> header.Conversations
	203, // 614: header.ConversationMgr.MatchConversations:output_type -> header.Conversations
	...
	203, // 621: header.ConversationMgr.SearchConvos:output_type -> header.Conversations
	...
	204, // 636: header.ConversationMgr.ListIntegrations:output_type -> header.Integrations
	...
	205, // 643: header.ConversationMgr.ListRules:output_type -> header.Route
	206, // 644: header.ConversationMgr.ListConversationAutomations:output_type -> header.ConversationAutomations
	...
	207, // 648: header.ConversationMgr.ListPhoneDevices:output_type -> header.PhoneDevices
	...
	208, // 654: header.ConversationMgr.ListCallSettings:output_type -> header.CallSettings
	...
	209, // 657: header.ConversationMgr.ListBlockedNumbers:output_type -> header.BlockedNumbers
	54,  // 658: header.ConversationMgr.UnblockNumber:output_type -> header.Empty
	210, // 659: header.ConversationMgr.ListGreetingAudio:output_type -> header.GreetingAudios
	...
	211, // 662: header.ConversationMgr.ListMyRecentCalls:output_type -> header.RecentCallRecords
	...
	212, // 668: header.TemplateMgr.ListTemplates:output_type -> header.Templates
	...
	213, // 674: header.TemplateMgr.ListModals:output_type -> header.ConversationModals
	214, // 675: header.TemplateMgr.PickModal:output_type -> header.ConversationModalPicked
	...
	215, // 679: header.TagMgr.ListTags:output_type -> header.Tags
	78,  // 680: header.TagMgr.GetTag:output_type -> header.Tag
	216, // 681: header.FileMgr.Presign:output_type -> header.PresignResult
	...
	217, // 692: header.PaymentMgr.SearchSub:output_type -> account.AccSubs
	...
	218, // 699: header.PaymentMgr.ListPaymentMethods:output_type -> payment.PaymentMethods
	...
	219, // 703: header.PaymentMgr.FilterInvoices:output_type -> payment.Invoices
	...
	220, // 706: header.PaymentMgr.ListComments:output_type -> payment.Comments
	95,  // 707: header.PaymentMgr.AddComment:output_type -> payment.Comment
	221, // 708: header.PaymentMgr.ListPlans:output_type -> payment.Plans
	...
	222, // 713: header.PaymentMgr.ListLogs:output_type -> payment.Logs
	...
	223, // 718: header.PaymentMgr.ListPromotionCode:output_type -> payment.PromotionCodes
	...
	224, // 722: header.PaymentMgr.ListTopReferral:output_type -> payment.ReferralResponse
	103, // 723: header.PaymentMgr.UpdateReferral:output_type -> payment.Referral
	225, // 724: header.PaymentMgr.ListAccountReferred:output_type -> payment.LogAccountReferreds
	226, // 725: header.PaymentMgr.ListBillByAccountReferred:output_type -> payment.LogBillByAccountReferreds
	227, // 726: header.PaymentMgr.ListPaidForAgentReferrer:output_type -> payment.LogPaidForAgentReferrers
	...
	228, // 731: header.FabikonService.ListFbFanpageSettings:output_type -> header.FbFanpageSettings
	229, // 732: header.FabikonService.ListFbPosts:output_type -> header.FacebookPosts
	...
	54,  // 735: header.FabikonService.RemoveFbUserLabel:output_type -> header.Empty
	54,  // 736: header.FabikonService.AddFbUserLabel:output_type -> header.Empty
	54,  // 737: header.ZalokonService.SendEventToZalo:output_type -> header.Empty
	230, // 738: header.ZalokonService.ListZnsTemplates:output_type -> zalokon.ZnsTemplates
	...
	231, // 745: header.MailkonService.VerifySenderDomain:output_type -> header.VerificationResult
	232, // 746: header.MailkonService.ListBusinessEmailAddresses:output_type -> header.BusinessEmailAddresses
	...
	233, // 751: header.WidgetService.ReadUserSetting:output_type -> header.WidgetUserSetting
	234, // 752: header.WidgetService.ReadAccountSetting:output_type -> header.AccountWeb
	...
	235, // 756: header.WidgetService.ReportCampaign:output_type -> header.ReportCampaignResponse
	236, // 757: header.WidgetService.ListConversions:output_type -> header.Conversions
	237, // 758: header.WidgetService.ExportConversions:output_type -> header.ConversionsExported
	118, // 759: header.WidgetService.UploadImage:output_type -> header.UploadedImage
	238, // 760: header.WidgetService.ListUploadedImage:output_type -> header.UploadedImages
	54,  // 761: header.WidgetService.DeleteUploadedImage:output_type -> header.Empty
	239, // 762: header.WidgetService.ListWebPlugins:output_type -> header.WebPlugins
	...
	239, // 768: header.WidgetService.ListWebPluginTemplates:output_type -> header.WebPlugins
	54,  // 769: header.WidgetService.DeleteWebPluginTemplate:output_type -> header.Empty
	240, // 770: header.WidgetService.ReportWebPlugin:output_type -> header.ReportWebPluginResponse
	238, // 771: header.WidgetService.SearchImages:output_type -> header.UploadedImages
	241, // 772: header.WidgetService.ListNotifProfiles:output_type -> header.NotifProfiles
	242, // 773: header.WidgetService.ListNotifBackgrounds:output_type -> header.Urls
	243, // 774: header.Bizbot.ListBots:output_type -> header.Bots
	...
	244, // 784: header.Bizbot.ReportBot2:output_type -> header.BotrunMetrics
	245, // 785: header.Bizbot.ReportAction:output_type -> header.ActionrunMetrics
	246, // 786: header.Bizbot.ListObjects:output_type -> header.ListObjectsResponse
	247, // 787: header.Bizbot.ReportBot:output_type -> header.ReportBotResponse
	128, // 788: header.Sendback.CreateWebhook:output_type -> header.Webhook
	248, // 789: header.Sendback.PingWebhook:output_type -> header.WebhookTestResult
	54,  // 790: header.Sendback.DeleteWebhook:output_type -> header.Empty
	249, // 791: header.Sendback.ListWebhooks:output_type -> header.Webhooks
	...
	250, // 795: header.Sendback.ListRecentIndexDeliveries:output_type -> header.WebhookDeliveries
	251, // 796: header.Sendback.GetDelivery:output_type -> header.WebhookDelivery
	54,  // 797: header.Sendback.SendWebhookEvent:output_type -> header.Empty
	54,  // 798: header.Notibox.SendNoti:output_type -> header.Empty
	252, // 799: header.Notibox.ListNoties:output_type -> header.Notifications
	...
	253, // 804: header.Watchhttp.ListWebpages:output_type -> header.Webpages
	...
	254, // 807: header.Watchhttp.ListRecentWebpageChecks:output_type -> header.WebpageChecks
	255, // 808: header.Watchhttp.ReadWebpageCheck:output_type -> header.WebpageCheck
	256, // 809: header.Watchhttp.ReportWebpageChecks:output_type -> header.WebpageReportDataSet
	254, // 810: header.Watchhttp.SummaryWebpageChecks:output_type -> header.WebpageChecks
	...
	257, // 817: header.Holap.ReportUser:output_type -> header.UserMetrics
	258, // 818: header.Holap.ReportConversation:output_type -> header.ConversationMetrics
	5,   // 819: header.Holap.ListUserIds:output_type -> header.Ids
	203, // 820: header.Holap.ListConversationIds:output_type -> header.Conversations
	259, // 821: header.Holap.ReportAgent:output_type -> header.AgentMetrics
	5,   // 822: header.Holap.ListChannelTouchpoints:output_type -> header.Ids
	260, // 823: header.Holap.ReportUserEvent:output_type -> header.UserEventMetrics
	54,  // 824: header.Holap.UpdateOrder:output_type -> header.Empty
	150, // 825: header.Holap.ReportOrder:output_type -> header.Orders
	261, // 826: header.Holap.ReportCall:output_type -> header.CallMetrics
	203, // 827: header.Holap.ListCallIds:output_type -> header.Conversations
	...
	262, // 832: header.Proder.ListProducts2:output_type -> header.Products
	263, // 833: header.Proder.ImportProduct:output_type -> header.ImportProductResponse
	264, // 834: header.Proder.ListProductCollections:output_type -> header.ProductCollections
	146, // 835: header.Proder.CreateProductCollection:output_type -> header.ProductCollection
	146, // 836: header.Proder.UpdateProductCollection:output_type -> header.ProductCollection
	54,  // 837: header.Proder.DeleteProductCollection:output_type -> header.Empty
	265, // 838: header.Proder.ListProductFeeds:output_type -> header.ProductFeeds
	147, // 839: header.Proder.CreateProductFeed:output_type -> header.ProductFeed
	147, // 840: header.Proder.UpdateProductFeed:output_type -> header.ProductFeed
	54,  // 841: header.Proder.DeleteProductFeed:output_type -> header.Empty
	266, // 842: header.Proder.ListProductCategories:output_type -> header.ProductCategories
	21,  // 843: header.Proder.ReadOrder:output_type -> header.Order
	21,  // 844: header.Proder.CreateOrder:output_type -> header.Order
	21,  // 845: header.Proder.UpdateOrder:output_type -> header.Order
	54,  // 846: header.Proder.DeleteOrder:output_type -> header.Empty
	150, // 847: header.Proder.ListOrders:output_type -> header.Orders
	150, // 848: header.Proder.CountOrders:output_type -> header.Orders
	54,  // 849: header.Proder.DeleteDraftOrders:output_type -> header.Empty
	150, // 850: header.Proder.ImportOrders:output_type -> header.Orders
	41,  // 851: header.Proder.MakeOrderPayment:output_type -> header.Event
	41,  // 852: header.Proder.DeleteOrderPayment:output_type -> header.Event
	41,  // 853: header.Proder.AddOrderComment:output_type -> header.Event
	41,  // 854: header.Proder.EditOrderComment:output_type -> header.Event
	41,  // 855: header.Proder.DeleteOrderComment:output_type -> header.Event
	267, // 856: header.Proder.ListOrderEvents:output_type -> header.OrderHistoryEntries
	82,  // 857: header.Proder.DownloadOrder:output_type -> header.File
	4,   // 858: header.Proder.GetShopeeAuthUrl:output_type -> header.Id
	268, // 859: header.Proder.AuthorizeShopeeShop:output_type -> header.ShopeeShop
	54,  // 860: header.Proder.DeauthorizeShopeeShop:output_type -> header.Empty
	269, // 861: header.Proder.SyncShopeeProducts:output_type -> header.ShopeeSyncProductResponse
	54,  // 862: header.Proder.GHTKShippingStatus:output_type -> header.Empty
	54,  // 863: header.Proder.GHNShippingStatus:output_type -> header.Empty
	158, // 864: header.Proder.ShippingFee:output_type -> header.ShippingInfo
	21,  // 865: header.Proder.ShipOrder:output_type -> header.Order
	21,  // 866: header.Proder.UpdateShippingCode:output_type -> header.Order
	21,  // 867: header.Proder.CancelShippingOrder:output_type -> header.Order
	82,  // 868: header.Proder.PrintShippingOrders:output_type -> header.File
	54,  // 869: header.Proder.SeenOrder:output_type -> header.Empty
	54,  // 870: header.Proder.FollowOrder:output_type -> header.Empty
	54,  // 871: header.Proder.UnfollowOrder:output_type -> header.Empty
	54,  // 872: header.Proder.TagOrder:output_type -> header.Empty
	54,  // 873: header.Proder.UntagOrder:output_type -> header.Empty
	46,  // 874: header.Apiece.ReadTask:output_type -> header.Task
	46,  // 875: header.Apiece.CreateTask:output_type -> header.Task
	46,  // 876: header.Apiece.UpdateTask:output_type -> header.Task
	54,  // 877: header.Apiece.DeleteTask:output_type -> header.Empty
	270, // 878: header.Apiece.ListTasks:output_type -> header.Tasks
	54,  // 879: header.Apiece.SeenTask:output_type -> header.Empty
	54,  // 880: header.Apiece.CloseTaskReminder:output_type -> header.Empty
	54,  // 881: header.Apiece.MuteTask:output_type -> header.Empty
	54,  // 882: header.Apiece.UnmuteTask:output_type -> header.Empty
	41,  // 883: header.Apiece.AddTaskComment:output_type -> header.Event
	41,  // 884: header.Apiece.EditTaskComment:output_type -> header.Event
	41,  // 885: header.Apiece.DeleteTaskComment:output_type -> header.Event
	271, // 886: header.Apiece.ListTaskComments:output_type -> header.TaskHistoryEntries
	160, // 887: header.Apiece.ReadPipeline:output_type -> header.Pipeline
	160, // 888: header.Apiece.CreatePipeline:output_type -> header.Pipeline
	160, // 889: header.Apiece.UpdatePipeline:output_type -> header.Pipeline
	54,  // 890: header.Apiece.DeletePipeline:output_type -> header.Empty
	272, // 891: header.Apiece.ListPipelines:output_type -> header.Pipelines
	54,  // 892: header.Apiece.DeletePipelineStage:output_type -> header.Empty
	160, // 893: header.Apiece.PreselectPipeline:output_type -> header.Pipeline
	162, // 894: header.Speex.TextToSpeech:output_type -> header.TTSVoiceSelection
	273, // 895: header.Campion.ListCampaigns:output_type -> header.Campaigns
	163, // 896: header.Campion.ReadCampaign:output_type -> header.Campaign
	163, // 897: header.Campion.CreateCampaign:output_type -> header.Campaign
	163, // 898: header.Campion.UpdateCampaign:output_type -> header.Campaign
	54,  // 899: header.Campion.DeleteCampaign:output_type -> header.Empty
	54,  // 900: header.Campion.OnEvent:output_type -> header.Empty
	274, // 901: header.Campion.ListCampaignSendMessages:output_type -> header.CampaignSendMessages
	275, // 902: header.Campion.ReportCampaign:output_type -> header.CampaignMetrics
	276, // 903: header.Campion.ListOutboundCallEntries:output_type -> header.OutboundCallEntries
	166, // 904: header.Campion.UpdateOutboundCall:output_type -> header.OutboundCallEntry
	54,  // 905: header.Campion.RemoveOutboutCall:output_type -> header.Empty
	166, // 906: header.Campion.LockOutboundCall:output_type -> header.OutboundCallEntry
	277, // 907: header.CreditMgr.ReportCreditSpend:output_type -> header.CreditSpendReportResponse
	278, // 908: header.CreditMgr.ListCreditSpendLog:output_type -> header.CreditSpendEntries
	86,  // 909: header.CreditMgr.AddCredit:output_type -> payment.Bill
