...
func (x *Avatar) GetCtx() *common.Context {
	if x != nil {
		return x.Ctx
	}
	return nil
...
func (x *Avatar) GetAutoUpdate() bool {
	if x != nil {
		return x.AutoUpdate
	}
	return false
...
var file_avatar_proto_rawDesc = []byte{
	...
	0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x1a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7d, 0x0a, 0x06, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x21,
	...
	0x6b, 0x65, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x75, 0x72,
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x55,
	0x72, 0x6c, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x75, 0x74, 0x6f, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x61, 0x75, 0x74, 0x6f, 0x55, 0x70, 0x64,
...
var file_avatar_proto_goTypes = []interface{}{
	(*Avatar)(nil),         // 0: avatar.Avatar
	(*common.Context)(nil), // 1: common.Context
}
var file_avatar_proto_depIdxs = []int32{
	1, // 0: avatar.Avatar.ctx:type_name -> common.Context
