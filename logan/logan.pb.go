...
func (Level) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_logan_9bf643bb6b9e55d3, []int{0}
}
...
func (Event) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_logan_9bf643bb6b9e55d3, []int{1}
}
...
func (dst *KafkaInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KafkaInfo.Merge(dst, src)
}
...
func (*Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_logan_9bf643bb6b9e55d3, []int{2}
}
...
func init() { proto.RegisterFile("logan/logan.proto", fileDescriptor_logan_9bf643bb6b9e55d3) }

var fileDescriptor_logan_9bf643bb6b9e55d3 = []byte{
