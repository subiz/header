...
func (x *EndchatConnectorSetting) GetAfterAgentMessage() int64 {
...
func (x *EndchatConnectorSetting) GetAfterAnyMessage() int64 {
...
func (x *EndchatConnectorSetting) GetAfterUserMessage() int64 {
...
func (x *EndchatConnectorSetting) GetAge() int64 {
	if x != nil && x.Age != nil {
		return *x.Age
	}
	return 0
...
var file_conversation_proto_rawDesc = []byte{
	...
	0x07, 0x64, 0x61, 0x79, 0x5f, 0x61, 0x67, 0x6f, 0x10, 0x03, 0x22, 0x93, 0x02, 0x0a, 0x17, 0x45,
	...
	,
	...
	0x2a, 0x89, 0x01, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x6e, 0x6f,
	...
	0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x10, 0x0f, 0x2a, 0xe1, 0x01, 0x0a,
...
var file_conversation_proto_goTypes = []interface{}{
	...
	(*common.I18NText)(nil),                           // 114: common.I18nText
}
var file_conversation_proto_depIdxs = []int32{
	...
	111, // 7: conversation.Route.ctx:type_name -> common.Context
	23,  // 8: conversation.Route.rules:type_name -> conversation.Rule
	111, // 9: conversation.Member.ctx:type_name -> common.Context
	42,  // 10: conversation.Member.fields:type_name -> conversation.Field
	112, // 11: conversation.Member.invited_by:type_name -> common.By
	111, // 12: conversation.Conversation.ctx:type_name -> common.Context
	...
	111, // 21: conversation.Conversations.ctx:type_name -> common.Context
	31,  // 22: conversation.Conversations.conversations:type_name -> conversation.Conversation
	113, // 23: conversation.Conversations.errors:type_name -> common.Error
	111, // 24: conversation.Search.ctx:type_name -> common.Context
	111, // 25: conversation.ListConversationsRequest.ctx:type_name -> common.Context
	111, // 26: conversation.ListEventsRequest.ctx:type_name -> common.Context
	111, // 27: conversation.Message.ctx:type_name -> common.Context
	114, // 28: conversation.Message.i18n_text:type_name -> common.I18nText
	...
	111, // 49: conversation.Tag.ctx:type_name -> common.Context
	111, // 50: conversation.Template.ctx:type_name -> common.Context
	...
	111, // 53: conversation.SearchTemplate.ctx:type_name -> common.Context
	111, // 54: conversation.Templates.ctx:type_name -> common.Context
	55,  // 55: conversation.Templates.templates:type_name -> conversation.Template
	111, // 56: conversation.Tags.ctx:type_name -> common.Context
	...
	111, // 60: conversation.Integrations.ctx:type_name -> common.Context
	61,  // 61: conversation.Integrations.integrations:type_name -> conversation.Integration
	111, // 62: conversation.Integration.ctx:type_name -> common.Context
	111, // 63: conversation.SearchMessageRequest.ctx:type_name -> common.Context
	111, // 64: conversation.TagRequest.ctx:type_name -> common.Context
	65,  // 65: conversation.CountByTagsResponse.data:type_name -> conversation.CountByTag
	111, // 66: conversation.Ticket.ctx:type_name -> common.Context
	75,  // 67: conversation.Ticket.attributes:type_name -> conversation.TicketAttributeData
	111, // 68: conversation.TicketListRequest.ctx:type_name -> common.Context
	92,  // 69: conversation.TicketListRequest.created:type_name -> conversation.FilterCondition
	111, // 70: conversation.Tickets.ctx:type_name -> common.Context
	71,  // 71: conversation.Tickets.tickets:type_name -> conversation.Ticket
	111, // 72: conversation.ESTickets.ctx:type_name -> common.Context
	100, // 73: conversation.ESTickets.tickets:type_name -> conversation.ESTicket
	111, // 74: conversation.TicketAttributeData.ctx:type_name -> common.Context
	111, // 75: conversation.ServiceLevelAgreement.ctx:type_name -> common.Context
	76,  // 76: conversation.ServiceLevelAgreement.targets:type_name -> conversation.ServiceLevelAgreementTarget
	111, // 77: conversation.ServiceLevelAgreements.ctx:type_name -> common.Context
	77,  // 78: conversation.ServiceLevelAgreements.service_level_agreements:type_name -> conversation.ServiceLevelAgreement
	111, // 79: conversation.DeleteTicketAttrRequest.ctx:type_name -> common.Context
	111, // 80: conversation.GetTicketRequest.ctx:type_name -> common.Context
	111, // 81: conversation.DeleteTicketRequest.ctx:type_name -> common.Context
	111, // 82: conversation.AvailibilityReportRequest.ctx:type_name -> common.Context
	111, // 83: conversation.CountReportRequest.ctx:type_name -> common.Context
	111, // 84: conversation.ReportResponse.ctx:type_name -> common.Context
	111, // 85: conversation.ConversationAgg.ctx:type_name -> common.Context
	108, // 86: conversation.ConversationMetadata.first_agent_replied:type_name -> conversation.ConversationMetadata.FirstAgentRepliedEntry
	109, // 87: conversation.ConversationMetadata.agent_joined:type_name -> conversation.ConversationMetadata.AgentJoinedEntry
	...
	110, // 91: conversation.ESConversation.response_times:type_name -> conversation.ESConversation.ResponseTime
	111, // 92: conversation.UpdateUserSegmentRequest.ctx:type_name -> common.Context
	111, // 93: conversation.ESTicket.ctx:type_name -> common.Context
	111, // 94: conversation.ConversationListRequest.ctx:type_name -> common.Context
	...
	111, // 102: conversation.UserExportRequest.ctx:type_name -> common.Context
	...
	111, // 109: conversation.ReportConversationsRequest.ctx:type_name -> common.Context
