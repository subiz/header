...
var file_conversation_proto_rawDesc = []byte{
	...
	0x07, 0x64, 0x61, 0x79, 0x5f, 0x61, 0x67, 0x6f, 0x10, 0x03, 0x2a, 0x89, 0x01, 0x0a, 0x05, 0x53,
...
var file_conversation_proto_goTypes = []interface{}{
	...
	(*common.I18NText)(nil),                           // 112: common.I18nText
}
var file_conversation_proto_depIdxs = []int32{
	...
	112, // 28: conversation.Message.i18n_text:type_name -> common.I18nText
	...
	109, // 49: conversation.Tag.ctx:type_name -> common.Context
	109, // 50: conversation.Template.ctx:type_name -> common.Context
	...
	109, // 53: conversation.SearchTemplate.ctx:type_name -> common.Context
	109, // 54: conversation.Templates.ctx:type_name -> common.Context
	55,  // 55: conversation.Templates.templates:type_name -> conversation.Template
	109, // 56: conversation.Tags.ctx:type_name -> common.Context
	...
	109, // 60: conversation.Integrations.ctx:type_name -> common.Context
	61,  // 61: conversation.Integrations.integrations:type_name -> conversation.Integration
	109, // 62: conversation.Integration.ctx:type_name -> common.Context
	109, // 63: conversation.SearchMessageRequest.ctx:type_name -> common.Context
	109, // 64: conversation.TagRequest.ctx:type_name -> common.Context
	65,  // 65: conversation.CountByTagsResponse.data:type_name -> conversation.CountByTag
	109, // 66: conversation.Ticket.ctx:type_name -> common.Context
	75,  // 67: conversation.Ticket.attributes:type_name -> conversation.TicketAttributeData
	109, // 68: conversation.TicketListRequest.ctx:type_name -> common.Context
	92,  // 69: conversation.TicketListRequest.created:type_name -> conversation.FilterCondition
	109, // 70: conversation.Tickets.ctx:type_name -> common.Context
	71,  // 71: conversation.Tickets.tickets:type_name -> conversation.Ticket
	109, // 72: conversation.ESTickets.ctx:type_name -> common.Context
	100, // 73: conversation.ESTickets.tickets:type_name -> conversation.ESTicket
	109, // 74: conversation.TicketAttributeData.ctx:type_name -> common.Context
	109, // 75: conversation.ServiceLevelAgreement.ctx:type_name -> common.Context
	76,  // 76: conversation.ServiceLevelAgreement.targets:type_name -> conversation.ServiceLevelAgreementTarget
	109, // 77: conversation.ServiceLevelAgreements.ctx:type_name -> common.Context
	77,  // 78: conversation.ServiceLevelAgreements.service_level_agreements:type_name -> conversation.ServiceLevelAgreement
	109, // 79: conversation.DeleteTicketAttrRequest.ctx:type_name -> common.Context
	109, // 80: conversation.GetTicketRequest.ctx:type_name -> common.Context
	109, // 81: conversation.DeleteTicketRequest.ctx:type_name -> common.Context
	109, // 82: conversation.AvailibilityReportRequest.ctx:type_name -> common.Context
	109, // 83: conversation.CountReportRequest.ctx:type_name -> common.Context
	109, // 84: conversation.ReportResponse.ctx:type_name -> common.Context
	109, // 85: conversation.ConversationAgg.ctx:type_name -> common.Context
	106, // 86: conversation.ConversationMetadata.first_agent_replied:type_name -> conversation.ConversationMetadata.FirstAgentRepliedEntry
	107, // 87: conversation.ConversationMetadata.agent_joined:type_name -> conversation.ConversationMetadata.AgentJoinedEntry
	...
	108, // 91: conversation.ESConversation.response_times:type_name -> conversation.ESConversation.ResponseTime
	109, // 92: conversation.UpdateUserSegmentRequest.ctx:type_name -> common.Context
	109, // 93: conversation.ESTicket.ctx:type_name -> common.Context
	109, // 94: conversation.ConversationListRequest.ctx:type_name -> common.Context
	...
	109, // 102: conversation.UserExportRequest.ctx:type_name -> common.Context
	...
	109, // 109: conversation.ReportConversationsRequest.ctx:type_name -> common.Context
