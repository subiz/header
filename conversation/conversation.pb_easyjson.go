		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v78)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Users = append(out.Users, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation43(out *jwriter.Writer, in Message) {
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v91, v92 := range in.Attachments {
				if v91 > 0 {
					out.RawByte(',')
				}
				if v92 == nil {
	...
	if len(in.Reactions) != 0 {
		...
		{
			out.RawByte('[')
			for v93, v94 := range in.Reactions {
				if v93 > 0 {
					out.RawByte(',')
				}
				if v94 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "integrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v100 *Integration
					if in.IsNull() {
						in.Skip()
						v100 = nil
					} else {
						if v100 == nil {
							v100 = new(Integration)
						}
						(*v100).UnmarshalEasyJSON(in)
					}
					out.Integrations = append(out.Integrations, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation50(out *jwriter.Writer, in Integrations) {
	...
	if len(in.Integrations) != 0 {
		...
		{
			out.RawByte('[')
			for v101, v102 := range in.Integrations {
				if v101 > 0 {
					out.RawByte(',')
				}
				if v102 == nil {
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v103)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation53(out *jwriter.Writer, in GenericElementTemplate) {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v104, v105 := range in.Buttons {
				if v104 > 0 {
					out.RawByte(',')
				}
				if v105 == nil {
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v106)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "member_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MemberIds = append(out.MemberIds, v115)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "attachments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Attachments = append(out.Attachments, v116)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v117)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation58(out *jwriter.Writer, in EsMessage) {
	...
	if len(in.MemberIds) != 0 {
		...
		{
			out.RawByte('[')
			for v118, v119 := range in.MemberIds {
				if v118 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v120, v121 := range in.Attachments {
				if v120 > 0 {
					out.RawByte(',')
				}
		...
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v130)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "data":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v139 *CountByAgent
					if in.IsNull() {
						in.Skip()
						v139 = nil
					} else {
						if v139 == nil {
							v139 = new(CountByAgent)
						}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v142)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation69(out *jwriter.Writer, in CountByAgentsRequest) {
	...
	if len(in.AgentIds) != 0 {
		...
		{
			out.RawByte('[')
			for v143, v144 := range in.AgentIds {
				if v143 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "conversations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v148 *Conversation
					if in.IsNull() {
						in.Skip()
						v148 = nil
					} else {
						if v148 == nil {
							v148 = new(Conversation)
						}
						(*v148).UnmarshalEasyJSON(in)
					}
					out.Conversations = append(out.Conversations, v148)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v149)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation72(out *jwriter.Writer, in Conversations) {
	...
	if len(in.Conversations) != 0 {
		...
		{
			out.RawByte('[')
			for v150, v151 := range in.Conversations {
				if v150 > 0 {
					out.RawByte(',')
				}
				if v151 == nil {
	...
	if len(in.UserIds) != 0 {
		...
		{
			out.RawByte('[')
			for v152, v153 := range in.UserIds {
				if v152 > 0 {
					out.RawByte(',')
				}
		...
		case "left_members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LeftMembers = append(out.LeftMembers, v156)
					in.WantComma()
				}
				in.Delim(']')
			}
