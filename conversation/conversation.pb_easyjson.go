	...
	for !in.IsDelim('}') {
		...
		case "service_level_agreements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v55 *ServiceLevelAgreement
					if in.IsNull() {
						in.Skip()
						v55 = nil
					} else {
						if v55 == nil {
							v55 = new(ServiceLevelAgreement)
						}
						(*v55).UnmarshalEasyJSON(in)
					}
					out.ServiceLevelAgreements = append(out.ServiceLevelAgreements, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation25(out *jwriter.Writer, in ServiceLevelAgreements) {
	...
	if len(in.ServiceLevelAgreements) != 0 {
		...
		{
			out.RawByte('[')
			for v56, v57 := range in.ServiceLevelAgreements {
				if v56 > 0 {
					out.RawByte(',')
				}
				if v57 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "targets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v58 *ServiceLevelAgreementTarget
					if in.IsNull() {
						in.Skip()
						v58 = nil
					} else {
						if v58 == nil {
							v58 = new(ServiceLevelAgreementTarget)
						}
						(*v58).UnmarshalEasyJSON(in)
					}
					out.Targets = append(out.Targets, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "assign_tos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AssignTos = append(out.AssignTos, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "conditions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Conditions = append(out.Conditions, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation32(out *jwriter.Writer, in Rule) {
	...
	if len(in.AssignTos) != 0 {
		...
		{
			out.RawByte('[')
			for v66, v67 := range in.AssignTos {
				if v66 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Conditions) != 0 {
		...
		{
			out.RawByte('[')
			for v68, v69 := range in.Conditions {
				if v68 > 0 {
					out.RawByte(',')
				}
				if v69 == nil {
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "rules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Rules = append(out.Rules, v73)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v77)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Users = append(out.Users, v82)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Reactions = append(out.Reactions, v86)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation43(out *jwriter.Writer, in Message) {
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v88, v89 := range in.Attachments {
				if v88 > 0 {
					out.RawByte(',')
				}
				if v89 == nil {
	...
	if len(in.Reactions) != 0 {
		...
		{
			out.RawByte('[')
			for v90, v91 := range in.Reactions {
				if v90 > 0 {
					out.RawByte(',')
				}
				if v91 == nil {
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "integrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Integrations = append(out.Integrations, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation50(out *jwriter.Writer, in Integrations) {
	...
	if len(in.Integrations) != 0 {
		...
		{
			out.RawByte('[')
			for v98, v99 := range in.Integrations {
				if v98 > 0 {
					out.RawByte(',')
				}
				if v99 == nil {
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation53(out *jwriter.Writer, in GenericElementTemplate) {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v101, v102 := range in.Buttons {
				if v101 > 0 {
					out.RawByte(',')
				}
				if v102 == nil {
		...
		case "member_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MemberIds = append(out.MemberIds, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "attachments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Attachments = append(out.Attachments, v113)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v114)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation58(out *jwriter.Writer, in EsMessage) {
	...
	if len(in.MemberIds) != 0 {
		...
		{
			out.RawByte('[')
			for v115, v116 := range in.MemberIds {
				if v115 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v117, v118 := range in.Attachments {
				if v117 > 0 {
					out.RawByte(',')
				}
		...
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v127)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "data":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v136 *CountByAgent
					if in.IsNull() {
						in.Skip()
						v136 = nil
					} else {
						if v136 == nil {
							v136 = new(CountByAgent)
						}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v139)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation69(out *jwriter.Writer, in CountByAgentsRequest) {
	...
	if len(in.AgentIds) != 0 {
		...
		{
			out.RawByte('[')
			for v140, v141 := range in.AgentIds {
				if v140 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "conversations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v145 *Conversation
					if in.IsNull() {
						in.Skip()
						v145 = nil
					} else {
						if v145 == nil {
							v145 = new(Conversation)
						}
						(*v145).UnmarshalEasyJSON(in)
					}
					out.Conversations = append(out.Conversations, v145)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v146)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation72(out *jwriter.Writer, in Conversations) {
	...
	if len(in.Conversations) != 0 {
		...
		{
			out.RawByte('[')
			for v147, v148 := range in.Conversations {
				if v147 > 0 {
					out.RawByte(',')
				}
				if v148 == nil {
	...
	if len(in.UserIds) != 0 {
		...
		{
			out.RawByte('[')
			for v149, v150 := range in.UserIds {
				if v149 > 0 {
					out.RawByte(',')
				}
		...
		case "members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Members = append(out.Members, v151)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "left_members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LeftMembers = append(out.LeftMembers, v153)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation73(out *jwriter.Writer, in Conversation) {
	...
	if len(in.LeftMembers) != 0 {
		...
		{
			out.RawByte('[')
			for v158, v159 := range in.LeftMembers {
				if v158 > 0 {
					out.RawByte(',')
				}
				if v159 == nil {
		...
		case "labels":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Labels = append(out.Labels, v160)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "categories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Categories = append(out.Categories, v161)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "attachment_urls":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttachmentUrls = append(out.AttachmentUrls, v162)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "related_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RelatedIds = append(out.RelatedIds, v163)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v164)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation74(out *jwriter.Writer, in ContentTemplate) {
	...
	if len(in.Categories) != 0 {
		...
		{
			out.RawByte('[')
			for v167, v168 := range in.Categories {
				if v167 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttachmentUrls) != 0 {
		...
		{
			out.RawByte('[')
			for v169, v170 := range in.AttachmentUrls {
				if v169 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RelatedIds) != 0 {
		...
		{
			out.RawByte('[')
			for v171, v172 := range in.RelatedIds {
				if v171 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v173, v174 := range in.Buttons {
				if v173 > 0 {
					out.RawByte(',')
				}
				if v174 == nil {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						(*v176).UnmarshalEasyJSON(in)
					}
					out.Ack = append(out.Ack, v176)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "received":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Received = append(out.Received, v177)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation76(out *jwriter.Writer, in Computed) {
	...
	if len(in.Received) != 0 {
		...
		{
			out.RawByte('[')
			for v182, v183 := range in.Received {
				if v182 > 0 {
					out.RawByte(',')
				}
				if v183 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "elements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v184 *GenericElementTemplate
					if in.IsNull() {
						in.Skip()
						v184 = nil
					} else {
						if v184 == nil {
							v184 = new(GenericElementTemplate)
						}
						(*v184).UnmarshalEasyJSON(in)
					}
					out.Elements = append(out.Elements, v184)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v185)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "contents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v186 *ContentTemplate
					if in.IsNull() {
						in.Skip()
						v186 = nil
					} else {
						if v186 == nil {
							v186 = new(ContentTemplate)
						}
						(*v186).UnmarshalEasyJSON(in)
					}
					out.Contents = append(out.Contents, v186)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "quick_replies":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.QuickReplies = append(out.QuickReplies, v187)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation85(out *jwriter.Writer, in Attachment) {
	...
	if len(in.Elements) != 0 {
		...
		{
			out.RawByte('[')
			for v188, v189 := range in.Elements {
				if v188 > 0 {
					out.RawByte(',')
				}
				if v189 == nil {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v190, v191 := range in.Buttons {
				if v190 > 0 {
					out.RawByte(',')
				}
				if v191 == nil {
	...
	if len(in.Contents) != 0 {
		...
		{
			out.RawByte('[')
			for v192, v193 := range in.Contents {
				if v192 > 0 {
					out.RawByte(',')
				}
				if v193 == nil {
	...
	if len(in.QuickReplies) != 0 {
		...
		{
			out.RawByte('[')
			for v194, v195 := range in.QuickReplies {
				if v194 > 0 {
					out.RawByte(',')
				}
				if v195 == nil {
