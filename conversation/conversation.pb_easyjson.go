	...
	for !in.IsDelim('}') {
		...
		case "starter_id":
			if in.IsNull() {
				...
				if out.StarterId == nil {
					out.StarterId = new(string)
				}
				*out.StarterId = string(in.String())
			}
		case "starter_type":
			if in.IsNull() {
				in.Skip()
				...
				if out.StarterType == nil {
					out.StarterType = new(string)
				}
				*out.StarterType = string(in.String())
			}
		case "agent_ids":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v38)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation24(out *jwriter.Writer, in StartRequest) {
	...
	if in.StarterId != nil {
		...
		out.String(string(*in.StarterId))
	}
	if in.StarterType != nil {
		const prefix string = ",\"starter_type\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		out.String(string(*in.StarterType))
	}
	if len(in.AgentIds) != 0 {
		const prefix string = ",\"agent_ids\":"
		if first {
	...
	for !in.IsDelim('}') {
		...
		case "service_level_agreements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v43 *ServiceLevelAgreement
					if in.IsNull() {
						in.Skip()
						v43 = nil
					} else {
						if v43 == nil {
							v43 = new(ServiceLevelAgreement)
						}
						(*v43).UnmarshalEasyJSON(in)
					}
					out.ServiceLevelAgreements = append(out.ServiceLevelAgreements, v43)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation25(out *jwriter.Writer, in ServiceLevelAgreements) {
	...
	if len(in.ServiceLevelAgreements) != 0 {
		...
		{
			out.RawByte('[')
			for v44, v45 := range in.ServiceLevelAgreements {
				if v44 > 0 {
					out.RawByte(',')
				}
				if v45 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "targets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v46 *ServiceLevelAgreementTarget
					if in.IsNull() {
						in.Skip()
						v46 = nil
					} else {
						if v46 == nil {
							v46 = new(ServiceLevelAgreementTarget)
						}
		...
		case "assign_tos":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AssignTos = append(out.AssignTos, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation32(out *jwriter.Writer, in Rule) {
	...
	if len(in.AssignTos) != 0 {
		...
		{
			out.RawByte('[')
			for v54, v55 := range in.AssignTos {
				if v54 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Conditions) != 0 {
		...
		{
			out.RawByte('[')
			for v56, v57 := range in.Conditions {
				if v56 > 0 {
					out.RawByte(',')
				}
				if v57 == nil {
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "rules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Rules = append(out.Rules, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Users = append(out.Users, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Reactions = append(out.Reactions, v74)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v75)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation43(out *jwriter.Writer, in Message) {
	...
	if len(in.Reactions) != 0 {
		...
		{
			out.RawByte('[')
			for v78, v79 := range in.Reactions {
				if v78 > 0 {
					out.RawByte(',')
				}
				if v79 == nil {
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v82)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "integrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Integrations = append(out.Integrations, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation50(out *jwriter.Writer, in Integrations) {
	...
	if len(in.Integrations) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.Integrations {
				if v86 > 0 {
					out.RawByte(',')
				}
				if v87 == nil {
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v88)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v91)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "member_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MemberIds = append(out.MemberIds, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation58(out *jwriter.Writer, in EsMessage) {
	...
	if len(in.MemberIds) != 0 {
		...
		{
			out.RawByte('[')
			for v103, v104 := range in.MemberIds {
				if v103 > 0 {
					out.RawByte(',')
				}
		...
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v115)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "data":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v124 *CountByAgent
					if in.IsNull() {
						in.Skip()
						v124 = nil
					} else {
						if v124 == nil {
							v124 = new(CountByAgent)
						}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v127)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation69(out *jwriter.Writer, in CountByAgentsRequest) {
	...
	if len(in.AgentIds) != 0 {
		...
		{
			out.RawByte('[')
			for v128, v129 := range in.AgentIds {
				if v128 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "conversations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v133 *Conversation
					if in.IsNull() {
						in.Skip()
						v133 = nil
					} else {
						if v133 == nil {
							v133 = new(Conversation)
						}
						(*v133).UnmarshalEasyJSON(in)
					}
					out.Conversations = append(out.Conversations, v133)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v134)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation72(out *jwriter.Writer, in Conversations) {
	...
	if len(in.Conversations) != 0 {
		...
		{
			out.RawByte('[')
			for v135, v136 := range in.Conversations {
				if v135 > 0 {
					out.RawByte(',')
				}
				if v136 == nil {
	...
	if len(in.UserIds) != 0 {
		...
		{
			out.RawByte('[')
			for v137, v138 := range in.UserIds {
				if v137 > 0 {
					out.RawByte(',')
				}
		...
		case "members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Members = append(out.Members, v139)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "left_members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LeftMembers = append(out.LeftMembers, v141)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation73(out *jwriter.Writer, in Conversation) {
	...
	if len(in.Members) != 0 {
		...
		{
			out.RawByte('[')
			for v142, v143 := range in.Members {
				if v142 > 0 {
					out.RawByte(',')
				}
				if v143 == nil {
	...
	if len(in.LeftMembers) != 0 {
		...
		{
			out.RawByte('[')
			for v146, v147 := range in.LeftMembers {
				if v146 > 0 {
					out.RawByte(',')
				}
				if v147 == nil {
		...
		case "labels":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Labels = append(out.Labels, v148)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "categories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Categories = append(out.Categories, v149)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "attachment_urls":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttachmentUrls = append(out.AttachmentUrls, v150)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "related_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RelatedIds = append(out.RelatedIds, v151)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v152)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation74(out *jwriter.Writer, in ContentTemplate) {
	...
	if len(in.Categories) != 0 {
		...
		{
			out.RawByte('[')
			for v155, v156 := range in.Categories {
				if v155 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttachmentUrls) != 0 {
		...
		{
			out.RawByte('[')
			for v157, v158 := range in.AttachmentUrls {
				if v157 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RelatedIds) != 0 {
		...
		{
			out.RawByte('[')
			for v159, v160 := range in.RelatedIds {
				if v159 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v161, v162 := range in.Buttons {
				if v161 > 0 {
					out.RawByte(',')
				}
				if v162 == nil {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						(*v165).UnmarshalEasyJSON(in)
					}
					out.Received = append(out.Received, v165)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation76(out *jwriter.Writer, in Computed) {
	...
	if len(in.Received) != 0 {
		...
		{
			out.RawByte('[')
			for v170, v171 := range in.Received {
				if v170 > 0 {
					out.RawByte(',')
				}
				if v171 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "elements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v172 *GenericElementTemplate
					if in.IsNull() {
						in.Skip()
						v172 = nil
					} else {
						if v172 == nil {
							v172 = new(GenericElementTemplate)
						}
						(*v172).UnmarshalEasyJSON(in)
					}
					out.Elements = append(out.Elements, v172)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "contents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v174 *ContentTemplate
					if in.IsNull() {
						in.Skip()
						v174 = nil
					} else {
						if v174 == nil {
							v174 = new(ContentTemplate)
						}
						(*v174).UnmarshalEasyJSON(in)
					}
					out.Contents = append(out.Contents, v174)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "quick_replies":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.QuickReplies = append(out.QuickReplies, v175)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGitSubizNetHeaderConversation85(out *jwriter.Writer, in Attachment) {
	...
	if len(in.Elements) != 0 {
		...
		{
			out.RawByte('[')
			for v176, v177 := range in.Elements {
				if v176 > 0 {
					out.RawByte(',')
				}
				if v177 == nil {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v178, v179 := range in.Buttons {
				if v178 > 0 {
					out.RawByte(',')
				}
				if v179 == nil {
	...
	if len(in.Contents) != 0 {
		...
		{
			out.RawByte('[')
			for v180, v181 := range in.Contents {
				if v180 > 0 {
					out.RawByte(',')
				}
				if v181 == nil {
	...
	if len(in.QuickReplies) != 0 {
		...
		{
			out.RawByte('[')
			for v182, v183 := range in.QuickReplies {
				if v182 > 0 {
					out.RawByte(',')
				}
				if v183 == nil {
