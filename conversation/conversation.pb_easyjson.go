		...
		case "users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Users = append(out.Users, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Reactions = append(out.Reactions, v98)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation35(out *jwriter.Writer, in Message) {
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v100, v101 := range in.Attachments {
				if v100 > 0 {
					out.RawByte(',')
				}
				if v101 == nil {
	...
	if len(in.Reactions) != 0 {
		...
		{
			out.RawByte('[')
			for v102, v103 := range in.Reactions {
				if v102 > 0 {
					out.RawByte(',')
				}
				if v103 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "integrations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v109 *Integration
					if in.IsNull() {
						in.Skip()
						v109 = nil
					} else {
						if v109 == nil {
							v109 = new(Integration)
						}
						(*v109).UnmarshalEasyJSON(in)
					}
					out.Integrations = append(out.Integrations, v109)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation42(out *jwriter.Writer, in Integrations) {
	...
	if len(in.Integrations) != 0 {
		...
		{
			out.RawByte('[')
			for v110, v111 := range in.Integrations {
				if v110 > 0 {
					out.RawByte(',')
				}
				if v111 == nil {
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation45(out *jwriter.Writer, in GenericElementTemplate) {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v113, v114 := range in.Buttons {
				if v113 > 0 {
					out.RawByte(',')
				}
				if v114 == nil {
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v121)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "member_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MemberIds = append(out.MemberIds, v124)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "attachments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Attachments = append(out.Attachments, v125)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v126)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation50(out *jwriter.Writer, in EsMessage) {
	...
	if len(in.MemberIds) != 0 {
		...
		{
			out.RawByte('[')
			for v127, v128 := range in.MemberIds {
				if v127 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Attachments) != 0 {
		...
		{
			out.RawByte('[')
			for v129, v130 := range in.Attachments {
				if v129 > 0 {
					out.RawByte(',')
				}
		...
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v139)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "data":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v148 *CountByAgent
					if in.IsNull() {
						in.Skip()
						v148 = nil
					} else {
						if v148 == nil {
							v148 = new(CountByAgent)
						}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v151)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation62(out *jwriter.Writer, in CountByAgentsRequest) {
	...
	if len(in.AgentIds) != 0 {
		...
		{
			out.RawByte('[')
			for v152, v153 := range in.AgentIds {
				if v152 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "conversations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v157 *Conversation
					if in.IsNull() {
						in.Skip()
						v157 = nil
					} else {
						if v157 == nil {
							v157 = new(Conversation)
						}
						(*v157).UnmarshalEasyJSON(in)
					}
					out.Conversations = append(out.Conversations, v157)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "user_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.UserIds = append(out.UserIds, v158)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation65(out *jwriter.Writer, in Conversations) {
	...
	if len(in.Conversations) != 0 {
		...
		{
			out.RawByte('[')
			for v159, v160 := range in.Conversations {
				if v159 > 0 {
					out.RawByte(',')
				}
				if v160 == nil {
	...
	if len(in.UserIds) != 0 {
		...
		{
			out.RawByte('[')
			for v161, v162 := range in.UserIds {
				if v161 > 0 {
					out.RawByte(',')
				}
		...
		case "first_agent_replied":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					var v163 int64
					v163 = int64(in.Int64())
					(out.FirstAgentReplied)[key] = v163
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation66(out *jwriter.Writer, in ConversationMetadata) {
	...
	if len(in.FirstAgentReplied) != 0 {
		...
		}
		{
			out.RawByte('{')
			v165First := true
			for v165Name, v165Value := range in.FirstAgentReplied {
				if v165First {
					v165First = false
				} else {
					out.RawByte(',')
	...
	if len(in.AgentJoined) != 0 {
		...
		}
		{
			out.RawByte('{')
			v166First := true
			for v166Name, v166Value := range in.AgentJoined {
				if v166First {
					v166First = false
				} else {
					out.RawByte(',')
		...
		case "members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Members = append(out.Members, v167)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						(*v168).UnmarshalEasyJSON(in)
					}
					out.Tags = append(out.Tags, v168)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "left_members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LeftMembers = append(out.LeftMembers, v169)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation68(out *jwriter.Writer, in Conversation) {
	...
	if len(in.Members) != 0 {
		...
		{
			out.RawByte('[')
			for v170, v171 := range in.Members {
				if v170 > 0 {
					out.RawByte(',')
				}
				if v171 == nil {
	...
	if len(in.LeftMembers) != 0 {
		...
		{
			out.RawByte('[')
			for v174, v175 := range in.LeftMembers {
				if v174 > 0 {
					out.RawByte(',')
				}
				if v175 == nil {
		...
		case "labels":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Labels = append(out.Labels, v176)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "categories":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Categories = append(out.Categories, v177)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "attachment_urls":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttachmentUrls = append(out.AttachmentUrls, v178)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "related_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RelatedIds = append(out.RelatedIds, v179)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v180)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation69(out *jwriter.Writer, in ContentTemplate) {
	...
	if len(in.Categories) != 0 {
		...
		{
			out.RawByte('[')
			for v183, v184 := range in.Categories {
				if v183 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttachmentUrls) != 0 {
		...
		{
			out.RawByte('[')
			for v185, v186 := range in.AttachmentUrls {
				if v185 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RelatedIds) != 0 {
		...
		{
			out.RawByte('[')
			for v187, v188 := range in.RelatedIds {
				if v187 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v189, v190 := range in.Buttons {
				if v189 > 0 {
					out.RawByte(',')
				}
				if v190 == nil {
		...
		case "received":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Received = append(out.Received, v193)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation71(out *jwriter.Writer, in Computed) {
	...
	if len(in.Received) != 0 {
		...
		{
			out.RawByte('[')
			for v198, v199 := range in.Received {
				if v198 > 0 {
					out.RawByte(',')
				}
				if v199 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "elements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v200 *GenericElementTemplate
					if in.IsNull() {
						in.Skip()
						v200 = nil
					} else {
						if v200 == nil {
							v200 = new(GenericElementTemplate)
						}
						(*v200).UnmarshalEasyJSON(in)
					}
					out.Elements = append(out.Elements, v200)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "buttons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Buttons = append(out.Buttons, v201)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "contents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v202 *ContentTemplate
					if in.IsNull() {
						in.Skip()
						v202 = nil
					} else {
						if v202 == nil {
							v202 = new(ContentTemplate)
						}
						(*v202).UnmarshalEasyJSON(in)
					}
					out.Contents = append(out.Contents, v202)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "quick_replies":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.QuickReplies = append(out.QuickReplies, v203)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonB8de26a5EncodeGithubComSubizHeaderConversation81(out *jwriter.Writer, in Attachment) {
	...
	if len(in.Elements) != 0 {
		...
		{
			out.RawByte('[')
			for v204, v205 := range in.Elements {
				if v204 > 0 {
					out.RawByte(',')
				}
				if v205 == nil {
	...
	if len(in.Buttons) != 0 {
		...
		{
			out.RawByte('[')
			for v206, v207 := range in.Buttons {
				if v206 > 0 {
					out.RawByte(',')
				}
				if v207 == nil {
	...
	if len(in.Contents) != 0 {
		...
		{
			out.RawByte('[')
			for v208, v209 := range in.Contents {
				if v208 > 0 {
					out.RawByte(',')
				}
				if v209 == nil {
	...
	if len(in.QuickReplies) != 0 {
		...
		{
			out.RawByte('[')
			for v210, v211 := range in.QuickReplies {
				if v210 > 0 {
					out.RawByte(',')
				}
				if v211 == nil {
