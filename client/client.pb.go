...
type WebhookPayload struct {
	...
	WebhookAccountId     *string         `protobuf:"bytes,7,opt,name=webhook_account_id,json=webhookAccountId" json:"webhook_account_id,omitempty"`
...
func (m *WebhookPayload) GetWebhookAccountId() string {
	if m != nil && m.WebhookAccountId != nil {
		return *m.WebhookAccountId
	}
	return ""
}
...
type WebhookBackoff struct {
	...
	WebhookAccountId     *string         `protobuf:"bytes,8,opt,name=webhook_account_id,json=webhookAccountId" json:"webhook_account_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *WebhookBackoff) GetWebhookAccountId() string {
	if m != nil && m.WebhookAccountId != nil {
		return *m.WebhookAccountId
	}
	return ""
...
var fileDescriptor_014de31d7ac8c57c = []byte{
	...
	,
}
