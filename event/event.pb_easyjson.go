...
func easyjson524579e4DecodeGithubComSubizHeaderEvent(in *jlexer.Lexer, out *UserEvent) {
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent(out *jwriter.Writer, in UserEvent) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent1(in *jlexer.Lexer, out *SubscriptionResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent1(out *jwriter.Writer, in SubscriptionResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent2(in *jlexer.Lexer, out *Subscription) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent2(out *jwriter.Writer, in Subscription) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent3(in *jlexer.Lexer, out *RawEventCreatedPayload) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent3(out *jwriter.Writer, in RawEventCreatedPayload) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent4(in *jlexer.Lexer, out *ListEventsRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent4(out *jwriter.Writer, in ListEventsRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent5(in *jlexer.Lexer, out *Events) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "events":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Events = append(out.Events, v28)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent5(out *jwriter.Writer, in Events) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEventEvent(in *jlexer.Lexer, out *Event_Data) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEventEvent(out *jwriter.Writer, in Event_Data) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Account != nil {
...
// MarshalJSON supports json.Marshaler interface
func (v Event_Data) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson524579e4EncodeGithubComSubizHeaderEventEvent(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v Event_Data) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson524579e4EncodeGithubComSubizHeaderEventEvent(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *Event_Data) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson524579e4DecodeGithubComSubizHeaderEventEvent(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Event_Data) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson524579e4DecodeGithubComSubizHeaderEventEvent(l, v)
}
	...
	for !in.IsDelim('}') {
		...
		case "links":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v31 *user.NoteLink
					if in.IsNull() {
						in.Skip()
						v31 = nil
					} else {
						if v31 == nil {
							v31 = new(user.NoteLink)
						}
						easyjson524579e4DecodeGithubComSubizHeaderUser10(in, &*v31)
					}
					out.Links = append(out.Links, v31)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		}
		{
			...
			for v32, v33 := range in.Links {
				...
				if v33 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser10(out, *v33)
				}
			}
			out.RawByte(']')
		}
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent6(in *jlexer.Lexer, out *Event) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent6(out *jwriter.Writer, in Event) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent7(in *jlexer.Lexer, out *By) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent7(out *jwriter.Writer, in By) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Device != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent8(in *jlexer.Lexer, out *Automations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "automations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Automations = append(out.Automations, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent8(out *jwriter.Writer, in Automations) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
	...
	if len(in.Automations) != 0 {
		...
		{
			out.RawByte('[')
			for v38, v39 := range in.Automations {
				if v38 > 0 {
					out.RawByte(',')
				}
				if v39 == nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent9(in *jlexer.Lexer, out *AutomationEvent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "action":
			if in.IsNull() {
				...
				if out.Action == nil {
					out.Action = new(AutomationAction)
				}
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent9(out *jwriter.Writer, in AutomationEvent) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent10(in *jlexer.Lexer, out *AutomationCreditsAggregate) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent10(out *jwriter.Writer, in AutomationCreditsAggregate) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent11(in *jlexer.Lexer, out *AutomationCredit) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent11(out *jwriter.Writer, in AutomationCredit) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent12(in *jlexer.Lexer, out *AutomationCheck) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent12(out *jwriter.Writer, in AutomationCheck) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccountId != "" {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent13(in *jlexer.Lexer, out *AutomationAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "user_note":
			if in.IsNull() {
				...
				if out.UserNote == nil {
					out.UserNote = new(user.Note)
				}
				easyjson524579e4DecodeGithubComSubizHeaderUser9(in, &*out.UserNote)
			}
		case "event":
			if in.IsNull() {
				in.Skip()
		...
		case "events":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Events = append(out.Events, v40)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "agent_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AgentIds = append(out.AgentIds, v41)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "tag_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TagIds = append(out.TagIds, v42)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent13(out *jwriter.Writer, in AutomationAction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Type != "" {
	...
	if in.UserNote != nil {
		...
		easyjson524579e4EncodeGithubComSubizHeaderUser9(out, *in.UserNote)
	}
	if in.Event != nil {
		const prefix string = ",\"event\":"
		if first {
...
// MarshalJSON supports json.Marshaler interface
func (v AutomationAction) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v AutomationAction) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson524579e4EncodeGithubComSubizHeaderEvent13(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *AutomationAction) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AutomationAction) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson524579e4DecodeGithubComSubizHeaderEvent13(l, v)
}
func easyjson524579e4DecodeGithubComSubizHeaderEvent14(in *jlexer.Lexer, out *Automation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "conditions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v49 *user.Condition
					if in.IsNull() {
						in.Skip()
						v49 = nil
					} else {
						if v49 == nil {
							v49 = new(user.Condition)
						}
						easyjson524579e4DecodeGithubComSubizHeaderUser11(in, &*v49)
					}
		...
		case "condition":
			if in.IsNull() {
				...
				easyjson524579e4DecodeGithubComSubizHeaderUser12(in, &*out.Condition)
			}
		case "created":
			out.Created = int64(in.Int64())
		case "modified":
		...
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v50 *AutomationAction
					if in.IsNull() {
						in.Skip()
						v50 = nil
					} else {
						if v50 == nil {
							v50 = new(AutomationAction)
						}
						(*v50).UnmarshalEasyJSON(in)
					}
					out.Actions = append(out.Actions, v50)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent14(out *jwriter.Writer, in Automation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
	...
	if len(in.Conditions) != 0 {
		...
		{
			out.RawByte('[')
			for v51, v52 := range in.Conditions {
				if v51 > 0 {
					out.RawByte(',')
				}
				if v52 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser11(out, *v52)
				}
			}
			out.RawByte(']')
		}
	...
	if in.Condition != nil {
		...
		easyjson524579e4EncodeGithubComSubizHeaderUser12(out, *in.Condition)
	}
	if in.Created != 0 {
		const prefix string = ",\"created\":"
		if first {
...
func (v Automation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson524579e4EncodeGithubComSubizHeaderEvent14(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Automation) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson524579e4DecodeGithubComSubizHeaderEvent14(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Automation) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson524579e4DecodeGithubComSubizHeaderEvent14(l, v)
}
func easyjson524579e4DecodeGithubComSubizHeaderUser12(in *jlexer.Lexer, out *user.SCondition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "conditions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v55 *user.SCondition
					if in.IsNull() {
						in.Skip()
						v55 = nil
					} else {
						if v55 == nil {
							v55 = new(user.SCondition)
						}
						easyjson524579e4DecodeGithubComSubizHeaderUser12(in, &*v55)
					}
					out.Conditions = append(out.Conditions, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderUser12(out *jwriter.Writer, in user.SCondition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Id != nil {
		...
		}
		{
			...
			for v56, v57 := range in.Conditions {
				...
				if v57 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser12(out, *v57)
				}
			}
			out.RawByte(']')
		}
...
func easyjson524579e4DecodeGithubComSubizHeaderUser11(in *jlexer.Lexer, out *user.Condition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderUser11(out *jwriter.Writer, in user.Condition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Join != nil {
