...
func easyjson524579e4DecodeGithubComSubizHeaderEvent4(in *jlexer.Lexer, out *SubscriptionResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent4(out *jwriter.Writer, in SubscriptionResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent5(in *jlexer.Lexer, out *Subscription) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent5(out *jwriter.Writer, in Subscription) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent6(in *jlexer.Lexer, out *RawEvents) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent6(out *jwriter.Writer, in RawEvents) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
	...
	for !in.IsDelim('}') {
		...
		case "conditions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v25 *user.Condition
					if in.IsNull() {
						in.Skip()
						v25 = nil
					} else {
						if v25 == nil {
							v25 = new(user.Condition)
						}
						easyjson524579e4DecodeGithubComSubizHeaderUser11(in, &*v25)
					}
...
func easyjson524579e4EncodeGithubComSubizHeaderUser10(out *jwriter.Writer, in user.Automation) {
	...
	if len(in.Conditions) != 0 {
		...
		{
			out.RawByte('[')
			for v26, v27 := range in.Conditions {
				if v26 > 0 {
					out.RawByte(',')
				}
				if v27 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser11(out, *v27)
				}
			}
			out.RawByte(']')
		}
	...
	for !in.IsDelim('}') {
		...
		case "conditions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v28 *user.SCondition
					if in.IsNull() {
						in.Skip()
						v28 = nil
					} else {
						if v28 == nil {
							v28 = new(user.SCondition)
						}
						easyjson524579e4DecodeGithubComSubizHeaderUser12(in, &*v28)
					}
					out.Conditions = append(out.Conditions, v28)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4EncodeGithubComSubizHeaderUser12(out *jwriter.Writer, in user.SCondition) {
	...
	if len(in.Conditions) != 0 {
		...
		{
			out.RawByte('[')
			for v29, v30 := range in.Conditions {
				if v29 > 0 {
					out.RawByte(',')
				}
				if v30 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser12(out, *v30)
				}
			}
			out.RawByte(']')
		}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson524579e4DecodeGithubComSubizHeaderUser13(in, &*v31)
					}
		...
		}
		{
			...
			for v32, v33 := range in.Links {
				...
				if v33 == nil {
					...
					easyjson524579e4EncodeGithubComSubizHeaderUser13(out, *v33)
				}
			}
			out.RawByte(']')
		}
		...
		case "payloads":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Payloads = append(out.Payloads, v35)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent8(in *jlexer.Lexer, out *RawEvent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent8(out *jwriter.Writer, in RawEvent) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent9(in *jlexer.Lexer, out *ListEventsRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent9(out *jwriter.Writer, in ListEventsRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent10(in *jlexer.Lexer, out *By) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent10(out *jwriter.Writer, in By) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Device != nil {
...
func easyjson524579e4DecodeGithubComSubizHeaderEvent11(in *jlexer.Lexer, out *AutomationEvent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson524579e4EncodeGithubComSubizHeaderEvent11(out *jwriter.Writer, in AutomationEvent) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ctx != nil {
