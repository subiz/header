...
var file_event_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x63, 0x68, 0x6f, 0x72, 0x22, 0xeb, 0x08, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x28, 0x09, 0x52, 0x0a, 0x61, 0x64, 0x73, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x2f,
	0x0a, 0x09, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x73, 0x18, 0x1d, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x11, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x61, 0x43, 0x61, 0x6d, 0x70,
	...
	0x6e, 0x67, 0x10, 0x04, 0x22, 0x7e, 0x0a, 0x0a, 0x47, 0x61, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69,
	...
	0x74, 0x65, 0x6e, 0x74, 0x2a, 0xd1, 0x0e, 0x0a, 0x0c, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x10, 0x57, 0x2a, 0x27, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x50,
	...
	0x73, 0x75, 0x62, 0x69, 0x7a, 0x2f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2f, 0x65, 0x76, 0x65,
...
var file_event_proto_goTypes = []interface{}{
	...
	(*Event_Data)(nil),                 // 33: event.Event.Data
	(*common.Context)(nil),             // 34: common.Context
	(*common.By)(nil),                  // 35: common.By
	(*user.User)(nil),                  // 36: user.User
	(*user.Condition)(nil),             // 37: user.Condition
	(*user.SCondition)(nil),            // 38: user.SCondition
	(*email.Email)(nil),                // 39: email.Email
	(*user.Note)(nil),                  // 40: user.Note
	(*conversation.Ticket)(nil),        // 41: conversation.Ticket
	(*account.Account)(nil),            // 42: account.Account
	(*account.Agent)(nil),              // 43: account.Agent
	(*conversation.Message)(nil),       // 44: conversation.Message
	(*conversation.Conversation)(nil),  // 45: conversation.Conversation
	(*conversation.Postback)(nil),      // 46: conversation.Postback
	(*content.Content)(nil),            // 47: content.Content
	(*account.Presence)(nil),           // 48: account.Presence
	(*user.MyUser)(nil),                // 49: user.MyUser
	(*notibox.Notification)(nil),       // 50: notibox.Notification
	(*account.AgentPerm)(nil),          // 51: account.AgentPerm
	(*account.GroupMember)(nil),        // 52: account.GroupMember
	(*account.AgentGroup)(nil),         // 53: account.AgentGroup
	(*payment.Limit)(nil),              // 54: payment.Limit
	(*user.Identification)(nil),        // 55: user.Identification
	(*notibox.Notibox)(nil),            // 56: notibox.Notibox
	(*noti5.Setting)(nil),              // 57: noti5.Setting
	(*conversation.Rule)(nil),          // 58: conversation.Rule
	(*user.AttributeDefinition)(nil),   // 59: user.AttributeDefinition
	(*conversation.Tag)(nil),           // 60: conversation.Tag
	(*user.UserMetric)(nil),            // 61: user.UserMetric
}
var file_event_proto_depIdxs = []int32{
	34, // 0: event.RawEventCreatedPayload.ctx:type_name -> common.Context
	34, // 1: event.Events.ctx:type_name -> common.Context
	12, // 2: event.Events.events:type_name -> event.Event
	34, // 3: event.Event.ctx:type_name -> common.Context
	35, // 4: event.Event.by:type_name -> common.By
	33, // 5: event.Event.data:type_name -> event.Event.Data
	34, // 6: event.Subscription.ctx:type_name -> common.Context
	34, // 7: event.ListEventsRequest.ctx:type_name -> common.Context
	34, // 8: event.UserEvent.ctx:type_name -> common.Context
	12, // 9: event.UserEvent.event:type_name -> event.Event
	36, // 10: event.UserEvent.user:type_name -> user.User
	34, // 11: event.SubscriptionResponse.ctx:type_name -> common.Context
	34, // 12: event.AutomationCalledback.ctx:type_name -> common.Context
	...
	34, // 15: event.AutomationEvent.ctx:type_name -> common.Context
	20, // 16: event.AutomationEvent.automation:type_name -> event.Automation
	36, // 17: event.AutomationEvent.user:type_name -> user.User
	...
	34, // 20: event.Automation.ctx:type_name -> common.Context
	37, // 21: event.Automation.conditions:type_name -> user.Condition
	38, // 22: event.Automation.condition:type_name -> user.SCondition
	21, // 23: event.Automation.actions:type_name -> event.AutomationAction
	36, // 24: event.AutomationAction.user:type_name -> user.User
	39, // 25: event.AutomationAction.email:type_name -> email.Email
	40, // 26: event.AutomationAction.user_note:type_name -> user.Note
	12, // 27: event.AutomationAction.event:type_name -> event.Event
	12, // 28: event.AutomationAction.events:type_name -> event.Event
	41, // 29: event.AutomationAction.ticket:type_name -> conversation.Ticket
	22, // 30: event.AutomationAction.webhook_setting:type_name -> event.AutomationWebhookSetting
	34, // 31: event.Automations.ctx:type_name -> common.Context
	20, // 32: event.Automations.automations:type_name -> event.Automation
	34, // 33: event.AutomationCreditsAggregate.ctx:type_name -> common.Context
	34, // 34: event.AutomationCredit.ctx:type_name -> common.Context
	34, // 35: event.Topic.ctx:type_name -> common.Context
	12, // 36: event.Topic.by_event:type_name -> event.Event
	34, // 37: event.UnreadTopic.ctx:type_name -> common.Context
	12, // 38: event.UnreadTopic.by_event:type_name -> event.Event
	34, // 39: event.ListTopicsRequest.ctx:type_name -> common.Context
	34, // 40: event.ListTopicsResult.ctx:type_name -> common.Context
	27, // 41: event.ListTopicsResult.topics:type_name -> event.Topic
	34, // 42: event.UserSession.ctx:type_name -> common.Context
	...
	42, // 46: event.Event.Data.account:type_name -> account.Account
	43, // 47: event.Event.Data.agent:type_name -> account.Agent
	44, // 48: event.Event.Data.message:type_name -> conversation.Message
	45, // 49: event.Event.Data.conversation:type_name -> conversation.Conversation
	46, // 50: event.Event.Data.postback:type_name -> conversation.Postback
	47, // 51: event.Event.Data.content:type_name -> content.Content
	27, // 52: event.Event.Data.topic:type_name -> event.Topic
	48, // 53: event.Event.Data.presence:type_name -> account.Presence
	36, // 54: event.Event.Data.user:type_name -> user.User
	28, // 55: event.Event.Data.unread_topic:type_name -> event.UnreadTopic
	49, // 56: event.Event.Data.my_user:type_name -> user.MyUser
	50, // 57: event.Event.Data.notification:type_name -> notibox.Notification
	51, // 58: event.Event.Data.agent_perm:type_name -> account.AgentPerm
	52, // 59: event.Event.Data.group_member:type_name -> account.GroupMember
	53, // 60: event.Event.Data.group:type_name -> account.AgentGroup
	54, // 61: event.Event.Data.limit:type_name -> payment.Limit
	55, // 62: event.Event.Data.alias:type_name -> user.Identification
	40, // 63: event.Event.Data.note:type_name -> user.Note
	41, // 64: event.Event.Data.ticket:type_name -> conversation.Ticket
	20, // 65: event.Event.Data.automation:type_name -> event.Automation
	12, // 66: event.Event.Data.event:type_name -> event.Event
	19, // 67: event.Event.Data.automation_event:type_name -> event.AutomationEvent
	56, // 68: event.Event.Data.notibox:type_name -> notibox.Notibox
	57, // 69: event.Event.Data.notification_setting:type_name -> noti5.Setting
	55, // 70: event.Event.Data.identification:type_name -> user.Identification
	58, // 71: event.Event.Data.rule:type_name -> conversation.Rule
	59, // 72: event.Event.Data.user_attribute:type_name -> user.AttributeDefinition
	60, // 73: event.Event.Data.tag:type_name -> conversation.Tag
	61, // 74: event.Event.Data.total_user:type_name -> user.UserMetric
