...
func TestBlockToPlainTextMessages1(t *testing.T) {
  ...
  "content": [
	...
	if string(b) != `[{"text":"Hi Lee Kei,"},{"text":"Paragraph 1"},{"text":"Paragraph 2"},{"text":"* Item 1\n* Item 2"},{"text":"Layout căn hộ 2 phòng ngủ","attachments":[{"type":"file","mimetype":"image/jpeg","file":{"url":"https://vcdn.subiz-cdn.com/file/fisngqthasgopsfzknqh_acsnacgjwhgvoxzijjhi/Can_ho_2_ngu.png"}}]},{"text":"Hình ảnh căn hộ 1","attachments":[{"type":"file","mimetype":"image/jpeg","file":{"url":"https://vcdn.subiz-cdn.com/file/fisnhkihmsgffykeboei_acsnacgjwhgvoxzijjhi/hinh_can_ho_7.jpg"}}]},{"text":"Hình ảnh căn hộ 2","attachments":[{"type":"file","mimetype":"image/jpeg","file":{"url":"https://vcdn.subiz-cdn.com/file/fisnhkiiqsmzpxyamezx_acsnacgjwhgvoxzijjhi/hinh_can_ho_2.jpg"}}]},{"text":"Para 3"},{"text":"Para4"},{"text":"Para5"}]` {
...
func TestBlockToPlainTextMessages2(t *testing.T) {
  ...
  "content": [{
	...
	b, _ := json.Marshal(messes)
	if string(b) != `[{"attachments":[{"type":"file","mimetype":"image/jpeg","file":{"url":"https://vcdn.subiz-cdn.com/file/fisnhkiiqsmzpxyamezx_acsnacgjwhgvoxzijjhi/hinh_can_ho_2.jpg"}}]}]` {
		t.Fatalf("should eq, but got %s", string(b))
	}
}
