...
func makeScopeMap2() map[string]string {
	// scope => permission
	var m = map[string]string{}
	m["agent"] = "account:read conversation:read:own conversation:create conversation:update:own agent_group:read rule:read integration:read message_template:read message_template:update:own message_template:create tag:read user:delete:own" +
	...
	m["account_setting"] = m["agent"] + " ticket:read user:read user:delete live:read auto_segment:create account:update agent:update agent:create agent_group:delete agent_group:update agent_group:create rule:update rule:create integration:update integration:create message_template:update tag:update tag:create widget:update attribute:update attribute:create bot:update bot:delete bot:create conversation_setting:update web_plugin:update web_plugin:create web_plugin:delete webhook:read webhook:update webhook:create webhook:delete lang:create lang:update user_label:create user_label:update shop_setting:update shop_setting:create conversation_modal:update conversation_modal:create conversation_automation:update conversation_automation:create phone_device:read phone_device:create phone_device:update phone_device:delete call_setting:update greeting_audio:create greeting_audio:update greeting_audio:delete ticket:update order:read order:update product:update product:delete order:delete ticket_type:create ticket_type:update ticket:delete user_view:update segment:update ticket_template:update ticket:invite user:update file:delete"
