...
const PROMOTION_PROGRAM ObjectType = "promotion_program"
const FORM ObjectType = "form"
const RULE ObjectType = "rule"
const INTEGRATION ObjectType = "integration"
const MESSAGE_TEMPLATE ObjectType = "message_template"
...
func singleBlockToPlainText2(block *Block) (string, []*Attachment) {
	...
	if block.Type == "image" {
		return block.AltText, []*Attachment{{Type: "file", Mimetype: "image/jpeg", File: &File{Url: block.GetImage().GetUrl()}}}
	}
